...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBCidade
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBCidadeUpdateAdvancedTests : IDisposable
{
    private readonly DBCidade _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBCidadeUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBCidade
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBCidade).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBCidade).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBCidade instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBCidade).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBCidade.PTabelaNome.Should().Be("Cidade");
        DBCidade.CampoCodigo.Should().Be("cidCodigo");
    }
