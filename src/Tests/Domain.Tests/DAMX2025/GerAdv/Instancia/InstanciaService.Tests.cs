...
public class InstanciaServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task AddAndUpdate_WithValidInstancia_ShouldExerciseWorkflow()
    {
        // Arrange
        var validInstancia = new Models.Instancia
        {
            Id = 0, // New instancia
    ...
    {
        var method = typeof(InstanciaService).GetMethod(methodName, BindingFlags.NonPublic | BindingFlags.Instance);
        if (method == null)
            return null;
