...
public partial class DBTipoOrigemSucumbencia : XCodeIdBase, ICadastros
{
#if (DEBUG)
#if (!shadowsDisabled && !shadows_MenphisSI_GerAdv && !shadows_MenphisSI_GerAdv_TipoOrigemSucumbencia)
#pragma warning disable CA1822 // Mark members as static

//public bool CertSignature() => DicionarioDeDadosManagedDatabaseCode.CodeSigntature_DBTipoOrigemSucumbencia();
#pragma warning restore CA1822 // Mark members as static

#endif
#endif
#region TableDefinition_TipoOrigemSucumbencia
    [XmlIgnore]
    public string TabelaNome => "TipoOrigemSucumbencia";

    public DBTipoOrigemSucumbencia()
    {
    }

#endregion
    public DBTipoOrigemSucumbencia(in int nCodigo, MsiSqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBTipoOrigemSucumbencia(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        // Tracking: 250605-0
        if (oCnn is null)
            return;
    ...
    public DBTipoOrigemSucumbencia(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
...
#endif
#region GravarDados_TipoOrigemSucumbencia
#if (forWeb)
...
#endif
    {
        ...
        {
            throw new Exception("Campo 'tosNome' está vazio!");
        }
        ...
        if (pFldFNome)
            clsW.Fields(DBTipoOrigemSucumbenciaDicInfo.Nome, m_FNome, ETiposCampos.FString);
        if (insertId != 0)
            return GravaNewId();
