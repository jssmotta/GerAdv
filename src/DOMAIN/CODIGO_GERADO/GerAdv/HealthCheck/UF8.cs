                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ufCodigo) FROM {"UF".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ufDDD,ufID,ufPais,ufTop,ufDescricao,ufGuid FROM {"UF".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
