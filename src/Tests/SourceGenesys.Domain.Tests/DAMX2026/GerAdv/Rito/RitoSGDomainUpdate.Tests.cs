...
public class DBRitoUpdate : IDisposable
{
...
#region Testes de Guid
    ...
    public void FDescricao_Property_ShouldAcceptValidNames(string Descricao)
    {
        ...
        // Assert
        rito.FDescricao.Should().Be(Descricao);
    }
    ...
    public void FDescricao_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        rito.FDescricao.Should().Be(string.Empty);
    }
    ...
    public void FDescricao_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        rito.FDescricao = longName;
        // Assert
        rito.FDescricao.Should().HaveLength(20);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBRito).GetField("pFldFDescricao", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FDescricao = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var rito = new DBRito();
        // Act & Assert
        rito.TabelaNome.Should().Be("Rito");
    }
