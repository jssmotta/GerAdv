...
#pragma warning restore CA1822 // Mark members as static
    ...
    public static ImmutableArray<DBInfoSystem> List => [DBProPartesDicInfo.OppParte, DBProPartesDicInfo.OppProcesso];
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBProPartesDicInfo.OppParte, DBProPartesDicInfo.OppProcesso];

    public static ImmutableArray<DBInfoSystem> ListPk()
    {
        ImmutableArray<string> campos = ImmutableArray.CreateRange(["oppCodigo"]);
