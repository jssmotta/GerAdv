...
// useInstanciaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Instancia
"use client";
...
interface UseInstanciaGridProps {
  data: IInstancia[];
...
export const useInstanciaGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IInstancia, filters: Record<string, any>) => {
      const nroprocessoMatches = applyFilter(
        data,
        "nroprocesso",
        filters.nroprocesso,
      );
