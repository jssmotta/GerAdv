...
const ParceriaProcInc: React.FC<IParceriaProcFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedParceriaProc =
        await parceriaprocService.saveParceriaProc(data);
