...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProcessOutputEngine
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProcessOutputEngineUpdateAdvancedTests : IDisposable
{
    private readonly DBProcessOutputEngine _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProcessOutputEngineUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBProcessOutputEngine
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBProcessOutputEngine).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProcessOutputEngine).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProcessOutputEngine instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProcessOutputEngine).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProcessOutputEngine.PTabelaNome.Should().Be("ProcessOutputEngine");
        DBProcessOutputEngine.CampoCodigo.Should().Be("poeCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBProcessOutputEngine();
        dbRec.ID = 1;
