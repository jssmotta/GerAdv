...
interface Auditor4KGridProps {
  data: IAuditor4K[];
  onRowClick: (auditor4k: IAuditor4K) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const Auditor4KGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAuditor4K, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-auditor4k'
