...
// useViaRecebimentoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ViaRecebimento
"use client";
...
interface UseViaRecebimentoGridProps {
...
export const useViaRecebimentoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IViaRecebimento, filters: Record<string, any>) => {
