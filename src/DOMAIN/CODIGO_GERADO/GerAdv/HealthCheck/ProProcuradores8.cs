                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(papCodigo) FROM {"ProProcuradores".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) papAdvogado,papNome,papProcesso,papData,papSubstabelecimento,papProcuracao,papBold,papGuid FROM {"ProProcuradores".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
