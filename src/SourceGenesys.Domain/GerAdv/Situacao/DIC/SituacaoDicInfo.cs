...
#region PropriedadesDaTabela
    public static DBInfoSystem SitParte_Int => new(0, PTabelaNome, CampoCodigo, Parte_Int, 30, "Parte_Int", "Parte_Int", ETipoDadosSysteminfo.SysteminfoText, true, false, false)
    {
        Prefixo = "sit"
    };
    ...
    public static DBInfoSystem SitGUID => new(0, PTabelaNome, CampoCodigo, GUID, 100, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "sit"
    };
