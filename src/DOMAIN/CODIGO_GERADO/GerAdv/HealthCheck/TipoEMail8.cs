                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tmlCodigo) FROM {"TipoEMail".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tmlNome FROM {"TipoEMail".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
