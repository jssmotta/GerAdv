                ...
                try
                {
                    ...
                    try
                    {
                        if (DBGUTAtividadesDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) agtNome,agtObservacao,agtGUTGrupo,agtGUTPeriodicidade,agtOperador,agtGUID,agtConcluido,agtDataConcluido,agtDiasParaIniciar,agtMinutosParaRealizar FROM {"GUTAtividades".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
