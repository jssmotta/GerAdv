...
public class DBProProcuradoresUpdate : IDisposable
{
    private readonly DBProProcuradores _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProProcuradoresUpdate()
    {
    ...
    {
        // Act
        var proprocuradores = new DBProProcuradores();
        // Assert
        proprocuradores.Should().NotBeNull();
        proprocuradores.ITableName().Should().Be("ProProcuradores");
        proprocuradores.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set proprocuradores.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        proprocuradores.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        proprocuradores.FNome = longString; // MAX: 255
        proprocuradores.FGuid = longString; // MAX: 100
        // Assert - All properties should be set proprocuradores.FNome.Should().HaveLength(255);
        proprocuradores.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        proprocuradores.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        proprocuradores.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "papCodigo = 1";
        // Act & Assert
        var ProProcuradores = new DBProProcuradores(sqlWhere, null);
        ProProcuradores.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var proprocuradores = new DBProProcuradores(parameters, nome, null);
        // Assert
        proprocuradores.Should().NotBeNull();
        proprocuradores.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        proprocuradores.FNome = longName;
        // Assert
        proprocuradores.FNome.Should().HaveLength(255);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBProProcuradores).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var proprocuradores = new DBProProcuradores();
        // Act & Assert
        proprocuradores.TabelaNome.Should().Be("ProProcuradores");
    }
