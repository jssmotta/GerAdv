                ...
                try
                {
                    ...
                    try
                    {
                        if (DBUltimosProcessosDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(ultCodigo) FROM dbo.UltimosProcessos (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) ultProcesso,ultQuando,ultQuem FROM dbo.UltimosProcessos (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
