...
public class StatusHTrabServiceTests : IDisposable
{
    ...
    public StatusHTrabServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new StatusHTrabService(_mockAppSettings.Object, _mockStatusHTrabFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
