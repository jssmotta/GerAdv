...
const TipoEnderecoSistemaComboBox: React.FC<DadosSelectProps> = ({
  ...
  const [editRecord, setEditRecord] = useState<ITipoEnderecoSistema | null>(
    null,
  );
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await tipoenderecosistemaService.fetchTipoEnderecoSistemaById(id);
  ...
  const handleSuccess = (newTipoEnderecoSistema?: ITipoEnderecoSistema) => {
    if (newTipoEnderecoSistema) {
      setValue({
        id: newTipoEnderecoSistema.id,
        nome: newTipoEnderecoSistema.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <TipoEnderecoSistemaWindow
          ...
          selectedTipoEnderecoSistema={
            editRecord || addRecord || TipoEnderecoSistemaEmpty()
          }
        />
      )}
