...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBPrepostos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBPrepostosUpdateAdvancedTests : IDisposable
{
    private readonly DBPrepostos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBPrepostosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBPrepostos
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBPrepostos).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBPrepostos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBPrepostos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBPrepostos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBPrepostos.PTabelaNome.Should().Be("Prepostos");
        DBPrepostos.CampoCodigo.Should().Be("preCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBPrepostos();
        dbRec.ID = 1;
