...
interface BensMateriaisGridProps {
  data: IBensMateriais[];
  onRowClick: (bensmateriais: IBensMateriais) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const BensMateriaisGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IBensMateriais, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nomebensclassificacao' title='Bens Classificacao' sortable={false} filterable={false} />, /* Track G.01 */

  <GridColumn field='nomefornecedores' title='Fornecedor' sortable={false} filterable={false} />, /* Track G.01 */
...
{initialized && (
  ...
  className='grid-desktop-bensmateriais'
