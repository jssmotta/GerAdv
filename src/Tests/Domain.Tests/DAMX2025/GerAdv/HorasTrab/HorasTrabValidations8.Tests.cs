...
#region Class Structure Tests
    ...
    private static GerAdv.Models.HorasTrab CreateValidHorasTrab()
    {
        return new GerAdv.Models.HorasTrab
        {
            Id = 1,
            IDContatoCRM = 0,
            Honorario = false,
    ...
    private void SetupValidMocks()
    {
        ...
        _ = _mockServicosReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<ServicosResponse?>(new ServicosResponse { Id = id }));
    }
    ...
    private void SetupValidMocksInvalid()
    {
        ...
        _ = _mockServicosReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<ServicosResponse?>(new ServicosResponse { Id = 0 }));
    }
...
#region Foreign Key Validation Tests - Servicos
    ...
    public async Task ValidateReg_WithInvalidServicos_ShouldThrowSGValidationException()
    {
        ...
        _mockServicosReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.ServicosResponse?>(null !));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(horastrab, _mockHorasTrabService.Object, _mockClientesReader.Object, _mockAdvogadosReader.Object, _mockFuncionariosReader.Object, _mockServicosReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithMismatchedServicosId_ShouldThrowSGValidationException()
    {
        ...
        var horastrab = CreateValidHorasTrab();
        horastrab.Servico = 999;
        var reg888 = new GerAdv.Models.Response.ServicosResponse
        {
            Id = 888
        }; // Different ID
        _mockServicosReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.ServicosResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(horastrab, _mockHorasTrabService.Object, _mockClientesReader.Object, _mockAdvogadosReader.Object, _mockFuncionariosReader.Object, _mockServicosReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidServicos_ShouldPass()
    {
        ...
        var reg123 = new GerAdv.Models.Response.ServicosResponse
        {
            Id = 123
        };
        _mockServicosReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.ServicosResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(horastrab, _mockHorasTrabService.Object, _mockClientesReader.Object, _mockAdvogadosReader.Object, _mockFuncionariosReader.Object, _mockServicosReader.Object, _validUri, _mockConnection.Object);
        // Assert
