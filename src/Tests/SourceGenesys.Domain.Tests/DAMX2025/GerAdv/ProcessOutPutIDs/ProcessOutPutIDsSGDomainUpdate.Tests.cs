...
public class DBProcessOutPutIDsUpdate : IDisposable
{
    private readonly DBProcessOutPutIDs _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProcessOutPutIDsUpdate()
    {
    ...
    {
        // Act
        var processoutputids = new DBProcessOutPutIDs();
        // Assert
        processoutputids.Should().NotBeNull();
        processoutputids.ITableName().Should().Be("ProcessOutPutIDs");
        processoutputids.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set processoutputids.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        processoutputids.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        processoutputids.FNome = longString; // MAX: 80
        processoutputids.FGuid = longString; // MAX: 100
        // Assert - All properties should be set processoutputids.FNome.Should().HaveLength(80);
        processoutputids.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        processoutputids.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        processoutputids.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "poiCodigo = 1";
        // Act & Assert
        var ProcessOutPutIDs = new DBProcessOutPutIDs(sqlWhere, null);
        ProcessOutPutIDs.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var processoutputids = new DBProcessOutPutIDs(parameters, nome, null);
        // Assert
        processoutputids.Should().NotBeNull();
        processoutputids.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        processoutputids.FNome = longName;
        // Assert
        processoutputids.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBProcessOutPutIDs).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var processoutputids = new DBProcessOutPutIDs();
        // Act & Assert
        processoutputids.TabelaNome.Should().Be("ProcessOutPutIDs");
    }
