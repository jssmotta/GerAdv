...
import { TiposAcaoApi, TiposAcaoApiError } from "../Apis/TiposAcaoApi";
...
export class TiposAcaoValidator {
  static validateTiposAcao(tiposacao: ITiposAcao): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface ITiposAcaoService {
  ...
  validateTiposAcao: (tiposacao: ITiposAcao) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
