...
public class FSituacaoFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FSituacao>();
    }
    ...
    {
        // Arrange
        var factory = new FSituacaoFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("sitCodigo", typeof(int));
        mockDataTable.Columns.Add("sitParte_Int", typeof(string));
        var row = mockDataTable.NewRow();
        row["sitCodigo"] = testId;
        row["sitParte_Int"] = "Test Situacao";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["sitCodigo"] = 123;
        row["sitParte_Int"] = "Test Situacao Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FSituacao properties
        }
    }
