...
public partial class FFornecedores : MenphisSI.SG.GerAdv.DBFornecedores, IDBFornecedores
{
    // DI-compatible default constructor
    public FFornecedores() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FFornecedores CreateFromReader(SqlDataReader? dbRec)
    {
        return new FFornecedores(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FFornecedores CreateFromDataRow(DataRow? dbRec)
    {
        return new FFornecedores(dbRec);
    }

    private FFornecedores(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FFornecedores(DataRow? dbRec) : base(dbRec)
    {
    }

    private FFornecedores(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FFornecedores CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FFornecedores(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FFornecedores> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fFornecedores = new FFornecedores();
        await fFornecedores.CarregarAsync(id, oCnn);
        return fFornecedores;
    }
