...
public class FilterAndamentosMDWithVoiceRequest
{
    /// <summary>
    /// Filtro de AndamentosMD padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterAndamentosMD Filter { get; set; } = new();
