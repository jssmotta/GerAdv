...
const {
  ...
  fetchData, 
  refreshData
} = useProDespesasList(prodespesasService);
...
const handleFetchWithFilter = async (filtro?: FilterProDespesas | undefined | null) => {
  setCurrFilter(filtro);
  await fetchData(filtro ?? {} as FilterProDespesas);
};
