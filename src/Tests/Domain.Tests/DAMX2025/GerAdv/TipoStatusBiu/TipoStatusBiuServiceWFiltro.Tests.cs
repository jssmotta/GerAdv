...
{
    public class TipoStatusBiuServiceWFiltroTests : IDisposable
    {
        ...
        private readonly TipoStatusBiuServiceS _serviceS;
        public TipoStatusBiuServiceWFiltroTests()
        {
            ...
            _serviceS = new TipoStatusBiuServiceS();
        ...
        {
            // Arrange
            FilterTipoStatusBiu? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterTipoStatusBiu(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_NomeTipoStatusBiu_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoStatusBiu
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoStatusBiu_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoStatusBiu
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoStatusBiu_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoStatusBiu = "João Silva";
            var filtro = new FilterTipoStatusBiu
            {
                Nome = nomeTipoStatusBiu,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeTipoStatusBiu_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoStatusBiu
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoStatusBiu_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoStatusBiu
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeTipoStatusBiu_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoStatusBiu)
        {
            // Arrange
            var filtro = new FilterTipoStatusBiu
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoStatusBiu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoStatusBiu
            {
            ...
            resultado.Value.where.Should().Contain("@tsbNome");
            resultado.Value.where.Should().Contain($"@{DBTipoStatusBiu.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @tsbNome");
            resultado.Value.where.Should().Contain($"= @{DBTipoStatusBiu.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeTipoStatusBiu_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoStatusBiu = "João Silva";
            var filtro = new FilterTipoStatusBiu
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoStatusBiuDicInfo.PTabelaNome}].[{DBTipoStatusBiuDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @tsbNome");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@tsbNome");
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoStatusBiuDicInfo.PTabelaNome}].[{DBTipoStatusBiuDicInfo.CampoCodigo}] = @{DBTipoStatusBiuDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoStatusBiuDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoStatusBiuDicInfo.PTabelaNome}].{DBTipoStatusBiuDicInfo.CampoCodigo} BETWEEN @{DBTipoStatusBiuDicInfo.CampoCodigo} AND @{DBTipoStatusBiuDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoStatusBiuDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoStatusBiuDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoStatusBiuDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoStatusBiuDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoStatusBiuDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBTipoStatusBiuDicInfo.Nome}");
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoStatusBiuDicInfo.PTabelaNome}].{DBTipoStatusBiuDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoStatusBiuDicInfo.PTabelaNome}].{DBTipoStatusBiuDicInfo.CampoCodigo} BETWEEN @{DBTipoStatusBiuDicInfo.CampoCodigo} AND @{DBTipoStatusBiuDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoStatusBiuDicInfo.PTabelaNome}].[{DBTipoStatusBiuDicInfo.CampoCodigo}] = @{DBTipoStatusBiuDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoStatusBiuDicInfo.PTabelaNome}].[{DBTipoStatusBiuDicInfo.CampoCodigo}]");
        }
