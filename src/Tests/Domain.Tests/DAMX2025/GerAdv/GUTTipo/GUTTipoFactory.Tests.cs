...
public class FGUTTipoFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FGUTTipo>();
    }
    ...
    {
        // Arrange
        var factory = new FGUTTipoFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("gttCodigo", typeof(int));
        mockDataTable.Columns.Add("gttNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["gttCodigo"] = testId;
        row["gttNome"] = "Test GUTTipo";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["gttCodigo"] = 123;
        row["gttNome"] = "Test GUTTipo Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FGUTTipo properties
        }
    }
