...
#region Test Data Setup Helpers
    ...
    private void SetupMockFOperador(string? EMail = "test@email.com", string? Pasta = "", bool? Telefonista = false, bool? Master = true, string? Nome = "João", string? Nick = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? Ramal = "AAAAAAAAAAAAAAAAAA", bool? Excluido = false, bool? Situacao = true, int? Computador = 1, string? MinhaDescricao = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? UltimoLogoff = "24/04/1975", string? EMailNet = "test@email.com", string? OnlineIP = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", bool? OnLine = false, bool? SysOp = true, int? StatusId = 1, string? StatusMessage = "", bool? IsFinanceiro = false, bool? Top = true, bool? Sexo = false, bool? Basico = true, bool? Externo = false, bool? EMailConfirmado = true, string? DataLimiteReset = "24/04/1975", string? SuporteMaxAge = "24/04/1975", string? SuporteNomeSolicitante = "João", string? SuporteUltimoAcesso = "24/04/1975", string? SuporteIpUltimoAcesso = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
    {
        ...
        if (string.IsNullOrEmpty(UltimoLogoff))
        {
            _mockFOperador.Setup(f => f.FUltimoLogoff).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(UltimoLogoff, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(UltimoLogoff, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFOperador.Setup(f => f.FUltimoLogoff).Returns(dateOnly);
        }
        ...
        if (string.IsNullOrEmpty(DataLimiteReset))
        {
            _mockFOperador.Setup(f => f.FDataLimiteReset).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(DataLimiteReset, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(DataLimiteReset, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFOperador.Setup(f => f.FDataLimiteReset).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(SuporteMaxAge))
        {
            _mockFOperador.Setup(f => f.FSuporteMaxAge).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(SuporteMaxAge, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(SuporteMaxAge, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFOperador.Setup(f => f.FSuporteMaxAge).Returns(dateOnly);
        }

        _mockFOperador.Setup(f => f.FSuporteNomeSolicitante).Returns(SuporteNomeSolicitante ?? string.Empty);
        if (string.IsNullOrEmpty(SuporteUltimoAcesso))
        {
            _mockFOperador.Setup(f => f.FSuporteUltimoAcesso).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(SuporteUltimoAcesso, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(SuporteUltimoAcesso, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFOperador.Setup(f => f.FSuporteUltimoAcesso).Returns(dateOnly);
        }
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_UltimoLogoff_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _operadorWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.UltimoLogoff.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDate_DataLimiteReset_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _operadorWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DataLimiteReset.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDate_SuporteMaxAge_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _operadorWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.SuporteMaxAge.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDate_SuporteUltimoAcesso_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _operadorWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.SuporteUltimoAcesso.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
#endregion
#endregion
}