...
public class Diario2ControllerTests
{
    private readonly Mock<IDiario2Service> _mockService;
    private readonly Diario2Controller _controller;
    public Diario2ControllerTests()
    {
        _mockService = new Mock<IDiario2Service>();
        _controller = new Diario2Controller(_mockService.Object);
    ...
    public async Task GetAll_WithValidParameters_ReturnsOkWithData()
    {
        // Arrange
        var max = 10;
        var expectedData = new List<RespAll.Diario2ResponseAll>
        {
            new()
            {
                Id = 1
    ...
    public async Task GetById_WithExistingId_ReturnsOkWithData()
    {
        // Arrange
        int id = 1;
        var expectedData = new Resp.Diario2Response
        {
            Id = id
        };
    ...
    public async Task GetById_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.GetById(id, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync((Resp.Diario2Response? )null);
        // Act
        var result = await _controller.GetById(id, "test-uri");
        // Assert
    ...
    {
        // Arrange
        var model = new Models.Diario2
        {
            Id = 0,
        // Set other required properties
        };
        var expectedResult = new Resp.Diario2Response
        {
            Id = 1
        };
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Diario2>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task AddAndUpdate_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Diario2();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Diario2>(), "test-uri")).ReturnsAsync((Resp.Diario2Response? )null);
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task AddAndUpdate_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.Diario2();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Diario2>(), "test-uri")).ThrowsAsync(new Exception("Test exception"));
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task Delete_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.Delete(id, "test-uri")).ReturnsAsync((Resp.Diario2Response? )null);
        // Act
        var result = await _controller.Delete(id, "test-uri");
        // Assert
        result.Should().BeOfType<NotFoundResult>();
    ...
    public async Task Validation_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Diario2>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task Validation_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Diario2();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Diario2>(), "test-uri")).ReturnsAsync((Resp.Diario2Response? )null);
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<BadRequestResult>();
    ...
    public async Task Validation_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.Diario2();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Diario2>(), "test-uri")).ThrowsAsync(new Exception("Validation error"));
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<ObjectResult>();
