...
// useDadosProcuracaoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de DadosProcuracao
'use client';
...
interface UseDadosProcuracaoGridProps {
...
export const useDadosProcuracaoGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('dadosprocuracao-columns-order'), JSON.stringify(reorderableFields));
