...
public partial class DBTipoStatusBiu
{
    ...
    /// </summary>
    public static async Task<DBTipoStatusBiu> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBTipoStatusBiu();
    ...
    {
        if (pFldFNome)
            updateTool.Fields(DBTipoStatusBiuDicInfo.Nome, FNome, EGenericTypeFields.FString);
    }
