...
public class ProObservacoesServiceTests : IDisposable
{
    ...
    public ProObservacoesServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new ProObservacoesService(_mockAppSettings.Object, _mockProObservacoesFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
