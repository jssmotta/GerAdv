...
public partial class FProValores : MenphisSI.SG.GerAdv.DBProValores, IDBProValores
{
    ...
    private FProValores(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FProValores CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FProValores(parameters, oCnn, fullSql, sqlWhere, join);
    }
