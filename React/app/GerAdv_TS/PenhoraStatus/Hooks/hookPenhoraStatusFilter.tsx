...
interface UsePenhoraStatusFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterPenhoraStatus | undefined | null,
  ) => Promise<void>;
}
...
interface UsePenhoraStatusFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterPenhoraStatus>,
  ) => React.ReactNode;
...
export const usePenhoraStatusFilter = ({
  handleFetchWithFilter,
}: UsePenhoraStatusFilterProps): UsePenhoraStatusFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterPenhoraStatus>(
