...
interface UseLigacoesFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterLigacoes | undefined | null,
  ) => Promise<void>;
}
...
interface UseLigacoesFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterLigacoes>,
  ) => React.ReactNode;
...
export const useLigacoesFilter = ({
  handleFetchWithFilter,
}: UseLigacoesFilterProps): UseLigacoesFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterLigacoes>(
    {} as FilterLigacoes,
  );
    ...
    <>
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datarealizada", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datarealizada_end", value)
        }
      />
      <InputInput
        type="text"
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("ultimoaviso", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("ultimoaviso_end", value)
        }
      />
      <InputDate
        type="text"
