...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class StatusInstanciaServiceWFiltroTests : IDisposable
    {
        ...
        private readonly StatusInstanciaServiceS _serviceS;
        public StatusInstanciaServiceWFiltroTests()
        {
            ...
            _serviceS = new StatusInstanciaServiceS();
            _service = new StatusInstanciaService(_mockAppSettings.Object, _mockStatusInstanciaFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidStatusInstancia_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeStatusInstancia = "João Silva";
            var filtro = new FilterStatusInstancia
            {
                Guid = nomeStatusInstancia,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidStatusInstancia_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
        ...
        [Fact]
        public void WFiltro_GuidStatusInstancia_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidStatusInstancia_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeStatusInstancia)
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
        ...
        [Fact]
        public void WFiltro_GuidStatusInstancia_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
            ...
            resultado.Value.where.Should().Contain("@istGuid");
            resultado.Value.where.Should().Contain($"@{DBStatusInstancia.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @istGuid");
            resultado.Value.where.Should().Contain($"= @{DBStatusInstancia.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidStatusInstancia_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeStatusInstancia = "João Silva";
            var filtro = new FilterStatusInstancia
            ...
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @istGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@istGuid");
        ...
        [Fact]
        public void WFiltro_NomeStatusInstancia_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeStatusInstancia = "João Silva";
            var filtro = new FilterStatusInstancia
            {
                Nome = nomeStatusInstancia,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeStatusInstancia_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
        ...
        [Fact]
        public void WFiltro_NomeStatusInstancia_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeStatusInstancia_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeStatusInstancia)
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
        ...
        [Fact]
        public void WFiltro_NomeStatusInstancia_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterStatusInstancia
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@istNome");
            resultado.Value.where.Should().Contain($"@{DBStatusInstancia.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @istNome");
            resultado.Value.where.Should().Contain($"= @{DBStatusInstancia.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeStatusInstancia_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeStatusInstancia = "João Silva";
            var filtro = new FilterStatusInstancia
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @istNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@istNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemCad}] = @{DBStatusInstanciaDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBStatusInstanciaDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.QuemCad} BETWEEN @{DBStatusInstanciaDicInfo.QuemCad} AND @{DBStatusInstanciaDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.QuemCad} BETWEEN @{DBStatusInstanciaDicInfo.QuemCad} AND @{DBStatusInstanciaDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemCad}] = @{DBStatusInstanciaDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemCad}] = @istQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@istQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@istQuemCad");
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemAtu}] = @{DBStatusInstanciaDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBStatusInstanciaDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.QuemAtu} BETWEEN @{DBStatusInstanciaDicInfo.QuemAtu} AND @{DBStatusInstanciaDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.QuemAtu} BETWEEN @{DBStatusInstanciaDicInfo.QuemAtu} AND @{DBStatusInstanciaDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemAtu}] = @{DBStatusInstanciaDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.QuemAtu}] = @istQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@istQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@istQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.CampoCodigo}] = @{DBStatusInstanciaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBStatusInstanciaDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.CampoCodigo} BETWEEN @{DBStatusInstanciaDicInfo.CampoCodigo} AND @{DBStatusInstanciaDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBStatusInstanciaDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.CampoCodigo} BETWEEN @{DBStatusInstanciaDicInfo.CampoCodigo} AND @{DBStatusInstanciaDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.CampoCodigo}] = @{DBStatusInstanciaDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBStatusInstanciaDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBStatusInstanciaDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.DtCad} BETWEEN @{DBStatusInstanciaDicInfo.DtCad} AND @{DBStatusInstanciaDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBStatusInstanciaDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBStatusInstanciaDicInfo.PTabelaNome}].[{DBStatusInstanciaDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBStatusInstanciaDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBStatusInstanciaDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBStatusInstanciaDicInfo.PTabelaNome}].{DBStatusInstanciaDicInfo.DtAtu} BETWEEN @{DBStatusInstanciaDicInfo.DtAtu} AND @{DBStatusInstanciaDicInfo.DtAtu}_end");
        }
