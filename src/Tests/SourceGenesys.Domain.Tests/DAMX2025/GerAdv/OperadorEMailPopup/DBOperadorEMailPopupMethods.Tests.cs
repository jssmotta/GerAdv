...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBOperadorEMailPopup
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBOperadorEMailPopupUpdateAdvancedTests : IDisposable
{
    private readonly DBOperadorEMailPopup _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBOperadorEMailPopupUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBOperadorEMailPopup
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBOperadorEMailPopup).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBOperadorEMailPopup).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBOperadorEMailPopup instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBOperadorEMailPopup).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBOperadorEMailPopup.PTabelaNome.Should().Be("OperadorEMailPopup");
        DBOperadorEMailPopup.CampoCodigo.Should().Be("oepCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBOperadorEMailPopup();
        dbRec.ID = 1;
