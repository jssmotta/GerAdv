...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBGUTTipo
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBGUTTipoUpdateAdvancedTests : IDisposable
{
    private readonly DBGUTTipo _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBGUTTipoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBGUTTipo
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBGUTTipo).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBGUTTipo).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBGUTTipo instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBGUTTipo).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBGUTTipo.PTabelaNome.Should().Be("GUTTipo");
        DBGUTTipo.CampoCodigo.Should().Be("gttCodigo");
    }
