...
public static class FilterOutrasPartesClienteTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar OutrasPartesCliente em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterOutrasPartesCliente:

- O filter irá filtrar os OutrasPartesCliente conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterOutrasPartesCliente:(Outras Partes Cliente)
- nome: _nome ou descrição para Outras Partes Cliente;
- terceirizado: Terceirizado;
- clienteprincipal: número ou IDs;
- tipo: Tipo;
- sexo: sexo do OutrasPartesCliente: 1=Homem; 0=Mulher; -2147483648=ambos;
- dtnasc: DtNasc;
...
- Se ouvir "todos os OutrasPartesCliente" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterOutrasPartesCliente? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt OutrasPartesCliente length: {result.Length}");
#endif
