...
#region TableDefinition_StatusBiu
...
#endregion
    public DBStatusBiu(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBStatusBiu(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBStatusBiu(in string? sqlWhere, SqlConnection? oCnn)
    {
