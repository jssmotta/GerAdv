...
#region Class Structure Tests
    ...
    private static GerAdv.Models.TipoRecurso CreateValidTipoRecurso()
    {
    ...
    private void SetupValidMocks()
    {
        ...
        _mockTipoRecursoService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterTipoRecurso>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<TipoRecursoResponseAll>>.Ok([]));
