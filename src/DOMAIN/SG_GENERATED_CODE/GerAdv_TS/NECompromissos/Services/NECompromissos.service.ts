...
export interface INECompromissosService {
  ...
  filterVoice: (filtro?: FilterNECompromissos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class NECompromissosService implements INECompromissosService {
  ...
  async filterVoice(filtro?: FilterNECompromissos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
