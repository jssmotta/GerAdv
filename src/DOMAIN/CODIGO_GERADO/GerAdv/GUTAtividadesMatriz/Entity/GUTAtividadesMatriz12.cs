...
public partial class FGUTAtividadesMatriz : MenphisSI.SG.GerAdv.DBGUTAtividadesMatriz, IDBGUTAtividadesMatriz
{
    ...
    private FGUTAtividadesMatriz(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FGUTAtividadesMatriz CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FGUTAtividadesMatriz(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
