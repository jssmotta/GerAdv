...
interface ProPartesGridProps {
  data: IProPartes[];
  onRowClick: (propartes: IProPartes) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProPartesGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProPartes, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-propartes'
