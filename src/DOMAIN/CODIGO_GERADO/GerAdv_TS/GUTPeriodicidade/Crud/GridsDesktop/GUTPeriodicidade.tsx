...
export const GUTPeriodicidadeGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IGUTPeriodicidade, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-gutperiodicidade'
