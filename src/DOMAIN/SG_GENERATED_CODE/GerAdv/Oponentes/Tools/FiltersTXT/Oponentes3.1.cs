...
public static class FilterOponentesTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar Oponentes em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterOponentes:

- O filter irá filtrar os Oponentes conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
- Se ouvir "todos os Oponentes" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterOponentes? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt Oponentes length: {result.Length}");
#endif
