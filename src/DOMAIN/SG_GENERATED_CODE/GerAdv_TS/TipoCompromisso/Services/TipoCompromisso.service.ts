...
export interface ITipoCompromissoService {
  ...
  filterVoice: (filtro?: FilterTipoCompromisso, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class TipoCompromissoService implements ITipoCompromissoService {
  ...
  async filterVoice(filtro?: FilterTipoCompromisso, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
