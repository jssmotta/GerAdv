...
#if (!NOTSTORED_DadosProcuracao)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFCliente || pFldFGUID || pFldFEstadoCivil || pFldFNacionalidade || pFldFProfissao || pFldFCTPS || pFldFPisPasep || pFldFRemuneracao || pFldFObjeto;
