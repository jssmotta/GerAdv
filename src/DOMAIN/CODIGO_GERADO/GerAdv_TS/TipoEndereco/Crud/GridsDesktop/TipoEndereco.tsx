...
interface TipoEnderecoGridProps {
  data: ITipoEndereco[];
  onRowClick: (tipoendereco: ITipoEndereco) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const TipoEnderecoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ITipoEndereco, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-tipoendereco'
