...
{
    Task<TipoOrigemSucumbenciaResponse?> ReadAsync(int id, MsiSqlConnection? oCnn);
    Task<Models.TipoOrigemSucumbencia?> ReadMAsync(int id, MsiSqlConnection? oCnn);
    ...
    Task<IEnumerable<TipoOrigemSucumbenciaResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}