...
public class FTipoProDespositoFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FTipoProDespositoFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FTipoProDespositoFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FTipoProDespositoFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTipoProDesposito>();
    }
    ...
    {
        // Arrange
        var factory = new FTipoProDespositoFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        row["tpdNome"] = "Test TipoProDesposito";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["tpdCodigo"] = 123;
        row["tpdNome"] = "Test TipoProDesposito Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTipoProDesposito properties
        }
    }
