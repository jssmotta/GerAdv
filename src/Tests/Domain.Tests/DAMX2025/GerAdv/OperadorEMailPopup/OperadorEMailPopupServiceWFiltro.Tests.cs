...
#region String Tests
        ...
        [InlineData("\n\n\n")] // Apenas quebras de linha
        [InlineData("\r\n\r\n")] // Carriage return + line feed
        public void WFiltro_Senha_ComStringComApenasWhitespace_NaoDeveIncluirNoFiltro(string senhaComWhitespace)
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
                Senha = senhaComWhitespace,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _service.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_Senha_ComStringMuitoLonga_DeveProcessarCorretamente()
        {
            // Arrange
            var senhaGigante = new string ('A', 1000);
            var filtro = new FilterOperadorEMailPopup
            {
                Senha = senhaGigante,
                WildcardChar = '%',
            ...
            resultado.Value.parametros.Should().HaveCount(1);
            var parametro = resultado.Value.parametros.First();
            parametro.Value.Should().Be($"%{senhaGigante}%");
        }
        ...
        [InlineData("João;DROP%TABLE--")] // SQL injection attempt
        [InlineData("João<script>alert('xss')</script>")] // XSS attempt
        public void WFiltro_Senha_ComCaracteresEspeciais_DeveProcessarCorretamente(string senhaComCaracteresEspeciais)
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
                Senha = senhaComCaracteresEspeciais,
                WildcardChar = '%',
                LogicalOperator = " AND "
            };
            // Act
            ...
            resultado.Value.parametros.Should().HaveCount(1);
            var parametro = resultado.Value.parametros.First();
            parametro.Value.ToString().Should().Contain(senhaComCaracteresEspeciais);
        }

        [Fact]
        public void WFiltro_SenhaOperadorEMailPopup_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
        ...
        [Fact]
        public void WFiltro_SenhaOperadorEMailPopup_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
        ...
        [Fact]
        public void WFiltro_SenhaOperadorEMailPopup_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeOperadorEMailPopup = "João Silva";
            var filtro = new FilterOperadorEMailPopup
            {
                Senha = nomeOperadorEMailPopup,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "João Silva")]
        [InlineData(' ', "João Silva", "João Silva")]
        public void WFiltro_SenhaOperadorEMailPopup_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
        ...
        [Fact]
        public void WFiltro_SenhaOperadorEMailPopup_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_SenhaOperadorEMailPopup_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeOperadorEMailPopup)
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
        ...
        [Fact]
        public void WFiltro_SenhaOperadorEMailPopup_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterOperadorEMailPopup
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@oepSenha");
            resultado.Value.where.Should().Contain("@oepPortaSmtp");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @oepSenha");
            resultado.Value.where.Should().Contain("= @oepPortaSmtp");
        }

        [Fact]
        public void WFiltro_SenhaOperadorEMailPopup_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeOperadorEMailPopup = "João Silva";
            var filtro = new FilterOperadorEMailPopup
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBOperadorEMailPopupDicInfo.PTabelaNome}].[{DBOperadorEMailPopupDicInfo.Senha}]");
            resultado.Value.where.Should().Contain("like @oepSenha");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@oepSenha");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
