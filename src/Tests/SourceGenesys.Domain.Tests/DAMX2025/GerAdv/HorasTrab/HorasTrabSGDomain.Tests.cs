...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void Honorario_ShouldAcceptIntegerValues(int value)
{
    _instance.FHonorario = value;
    Assert.Equal(value, _instance.FHonorario);
}
...
[Fact]
public void Honorario_DefaultValue_ShouldBeZero()
{
    var instance = new DBHorasTrab();
    Assert.Equal(0, instance.Honorario);
}
*/
    /*
...
public void Honorario_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FHonorario = dateString;
    Assert.Equal(dateString, _instance.FHonorario);
}

[Fact]
public void Honorario_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBHorasTrab();
    Assert.Equal(string.Empty, instance.Honorario);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("", "")]
public void Honorario_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FHonorario = input;
        Assert.Equal(expected, _instance.FHonorario);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FHonorario = input);
    }
}
*/
    /*
...
public void Honorario_ValidEmail_ShouldAccept(string email)
{
    _instance.FHonorario = email;
    Assert.Equal(email, _instance.FHonorario);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void Honorario_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FHonorario = email);
}
*/
    [Theory]
    [InlineData(0)]
