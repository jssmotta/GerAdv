...
public class FPaisesFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FPaises>();
    }
    ...
    {
        // Arrange
        var factory = new FPaisesFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("paiCodigo", typeof(int));
        mockDataTable.Columns.Add("paiNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["paiCodigo"] = testId;
        row["paiNome"] = "Test Paises";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["paiCodigo"] = 123;
        row["paiNome"] = "Test Paises Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FPaises properties
        }
    }
