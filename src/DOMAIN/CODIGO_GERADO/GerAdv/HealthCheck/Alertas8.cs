                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(altCodigo) FROM {"Alertas".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) altNome,altData,altOperador,altDataAte FROM {"Alertas".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
