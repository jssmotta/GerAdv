...
public partial interface IGUTAtividadesReader
{
    ...
    Task<IEnumerable<GUTAtividadesResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}