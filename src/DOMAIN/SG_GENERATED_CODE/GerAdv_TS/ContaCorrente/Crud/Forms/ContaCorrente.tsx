  ...
  <>      
        ...
        <div className={isMobile ? 'form-container form-container-ContaCorrente' : 'form-container form-container-ContaCorrente'}>
            ...
            <form className='formInputCadInc' id={`ContaCorrenteForm-${contacorrenteData.id}`} onSubmit={onConfirm}>
                ...
                {!isMobile && (
                    <ButtonSalvarCrud isMobile={false} validationForm={validationForm} entity='ContaCorrente' data={contacorrenteData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`ContaCorrenteForm-${contacorrenteData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                 )}
...
maxLength={2048}
            ...
            {isMobile && (
                <ButtonSalvarCrud isMobile={true} validationForm={validationForm} entity='ContaCorrente' data={contacorrenteData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`ContaCorrenteForm-${contacorrenteData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                )}

                <FooterIncDocker>

                   <CopyButton
                    formId={`ContaCorrenteForm-${contacorrenteData.id}`}
                  />
                   ...
                   <AuditorButton
                        ...
                        coolName='Conta Corrente'        
                        id={contacorrenteData.id}    
                      />

                    <DeleteButton page={'/pages/contacorrente'} id={contacorrenteData.id} dadoApi={dadoApi} />
