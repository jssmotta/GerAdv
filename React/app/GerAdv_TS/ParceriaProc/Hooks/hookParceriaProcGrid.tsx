...
// useParceriaProcGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ParceriaProc
"use client";
...
interface UseParceriaProcGridProps {
  data: IParceriaProc[];
...
export const useParceriaProcGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IParceriaProc, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
