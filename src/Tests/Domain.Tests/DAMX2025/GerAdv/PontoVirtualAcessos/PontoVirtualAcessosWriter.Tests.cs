...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFPontoVirtualAcessos.VerifySet(x => x.FDataHora = DateOnly.Parse(pontovirtualacessos.DataHora), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_DataHora_ShouldNotSetFDataHora()
    {
        // Arrange
        var pontovirtualacessos = CreateValidPontoVirtualAcessosModel();
        ...
        // Assert
        _mockFPontoVirtualAcessos.VerifySet(x => x.FDataHora = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new PontoVirtualAcessosWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.PontoVirtualAcessos CreateValidPontoVirtualAcessosModel()
    {
