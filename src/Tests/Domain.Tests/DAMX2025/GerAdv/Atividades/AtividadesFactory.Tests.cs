...
public class FAtividadesFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FAtividades>();
    }
    ...
    {
        // Arrange
        var factory = new FAtividadesFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("atvCodigo", typeof(int));
        mockDataTable.Columns.Add("atvDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["atvCodigo"] = testId;
        row["atvDescricao"] = "Test Atividades";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["atvCodigo"] = 123;
        row["atvDescricao"] = "Test Atividades Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FAtividades properties
        }
    }
