...
{
    public class TipoContatoCRMServiceWFiltroTests : IDisposable
    {
        ...
        private readonly TipoContatoCRMServiceS _serviceS;
        public TipoContatoCRMServiceWFiltroTests()
        {
            ...
            _serviceS = new TipoContatoCRMServiceS();
            _service = new TipoContatoCRMService(_mockAppSettings.Object, _mockTipoContatoCRMFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
        ...
        {
            // Arrange
            FilterTipoContatoCRM? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidTipoContatoCRM_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoContatoCRM_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoContatoCRM_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoContatoCRM = "João Silva";
            var filtro = new FilterTipoContatoCRM
            {
                Guid = nomeTipoContatoCRM,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidTipoContatoCRM_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoContatoCRM_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidTipoContatoCRM_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoContatoCRM)
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoContatoCRM_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
            ...
            resultado.Value.where.Should().Contain("@tccGuid");
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRM.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @tccGuid");
            resultado.Value.where.Should().Contain($"= @{DBTipoContatoCRM.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidTipoContatoCRM_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoContatoCRM = "João Silva";
            var filtro = new FilterTipoContatoCRM
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @tccGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@tccGuid");
        ...
        [Fact]
        public void WFiltro_NomeTipoContatoCRM_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoContatoCRM_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoContatoCRM_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoContatoCRM = "João Silva";
            var filtro = new FilterTipoContatoCRM
            {
                Nome = nomeTipoContatoCRM,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeTipoContatoCRM_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoContatoCRM_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeTipoContatoCRM_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoContatoCRM)
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoContatoCRM_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoContatoCRM
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@tccNome");
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRM.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @tccNome");
            resultado.Value.where.Should().Contain($"= @{DBTipoContatoCRM.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeTipoContatoCRM_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoContatoCRM = "João Silva";
            var filtro = new FilterTipoContatoCRM
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @tccNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@tccNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemCad}] = @{DBTipoContatoCRMDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoContatoCRMDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.QuemCad} BETWEEN @{DBTipoContatoCRMDicInfo.QuemCad} AND @{DBTipoContatoCRMDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.QuemCad} BETWEEN @{DBTipoContatoCRMDicInfo.QuemCad} AND @{DBTipoContatoCRMDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemCad}] = @{DBTipoContatoCRMDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemCad}] = @tccQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@tccQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@tccQuemCad");
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemAtu}] = @{DBTipoContatoCRMDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoContatoCRMDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.QuemAtu} BETWEEN @{DBTipoContatoCRMDicInfo.QuemAtu} AND @{DBTipoContatoCRMDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.QuemAtu} BETWEEN @{DBTipoContatoCRMDicInfo.QuemAtu} AND @{DBTipoContatoCRMDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemAtu}] = @{DBTipoContatoCRMDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.QuemAtu}] = @tccQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@tccQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@tccQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.CampoCodigo}] = @{DBTipoContatoCRMDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoContatoCRMDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.CampoCodigo} BETWEEN @{DBTipoContatoCRMDicInfo.CampoCodigo} AND @{DBTipoContatoCRMDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBTipoContatoCRMDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.CampoCodigo} BETWEEN @{DBTipoContatoCRMDicInfo.CampoCodigo} AND @{DBTipoContatoCRMDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.CampoCodigo}] = @{DBTipoContatoCRMDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBTipoContatoCRMDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBTipoContatoCRMDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.DtCad} BETWEEN @{DBTipoContatoCRMDicInfo.DtCad} AND @{DBTipoContatoCRMDicInfo.DtCad}_end");
        }
        ...
        public void WFiltro_DtCad_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.DtCad}], 103)");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBTipoContatoCRMDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBTipoContatoCRMDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].{DBTipoContatoCRMDicInfo.DtAtu} BETWEEN @{DBTipoContatoCRMDicInfo.DtAtu} AND @{DBTipoContatoCRMDicInfo.DtAtu}_end");
        }
        ...
        public void WFiltro_DtAtu_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.DtAtu}], 103)");
        }
...
#region Visto Filter Tests
        ...
        public void WFiltro_VistoEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBTipoContatoCRMDicInfo.Visto));
            result.Value.where.Should().NotContain(DBTipoContatoCRMDicInfo.Visto);
        }
        ...
        public void WFiltro_VistoHasValidValue_ShouldAddParameterAndWhereClause()
        {
            ...
            result.Should().NotBeNull();
            // Check parameter
            var VistoParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.Visto}");
            VistoParameter.Should().NotBeNull();
            VistoParameter.Value.Should().Be(VistoValue);
            // Check where clause
            result.Value.where.Should().Contain($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.Visto}] = @{DBTipoContatoCRMDicInfo.Visto}");
        }
        ...
        public void WFiltro_VistoWithDifferentValues_ShouldAddCorrectParameterValue()
        {
            ...
            var filtroFemale = new FilterTipoContatoCRM
            {
                Visto = 0
            };
            var resultFemale = _serviceS.WFiltro(filtroFemale);
            resultFemale.Should().NotBeNull();
            var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.Visto}");
            femaleParam.Should().NotBeNull();
            femaleParam.Value.Should().Be(0);
            // Arrange & Act & Assert for Visto = 1 (typically male)
            var filtroMale = new FilterTipoContatoCRM
            {
                Visto = 1
            };
            var resultMale = _serviceS.WFiltro(filtroMale);
            resultMale.Should().NotBeNull();
            var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoContatoCRMDicInfo.Visto}");
        ...
        public void WFiltro_VistoAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.where.Should().StartWith($"[{DBTipoContatoCRMDicInfo.PTabelaNome}].[{DBTipoContatoCRMDicInfo.Visto}] = @{DBTipoContatoCRMDicInfo.Visto}");
