                ...
                try
                {
                    ...
                    try
                    {
                        if (DBEscritoriosDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) escGUID,escCNPJ,escCasa,escParceria,escNome,escOAB,escEndereco,escCidade,escBairro,escCEP,escFone,escFax,escSite,escEMail,escOBS,escAdvResponsavel,escSecretaria,escInscEst,escCorrespondente,escTop FROM {"Escritorios".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
