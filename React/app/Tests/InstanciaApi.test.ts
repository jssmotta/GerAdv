...
import { InstanciaApiError } from '@/app/GerAdv_TS/Instancia/Apis/InstanciaApi';
...
import { InstanciaTestEmpty } from '@/app/GerAdv_TS/Models/Instancia';
...
zkeyia: 'AAAAAAAAAAAAAAAAAAAAAAA'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterInstancia = { : 1 };
