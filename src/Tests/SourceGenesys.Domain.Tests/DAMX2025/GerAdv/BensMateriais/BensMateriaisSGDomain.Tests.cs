...
public class DBBensMateriaisTests : IDisposable
{
    ...
    private DataTable CreateTestDataTable()
    {
        ...
        dt.Columns.Add("bmtBold", typeof(string));
...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("BensMateriais", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("BensMateriais", cadastro.ITableName());
        Assert.Equal("bmtCodigo", cadastro.IFieldId());
        Assert.Equal("bmtNome", cadastro.IFieldNameDescription());
        Assert.Equal("bmt", cadastro.IPrefix());
    }
...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FDataCompra = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataCompra?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBBensMateriais();
        Assert.Equal(null !, instance.FDataCompra);
    }
    ...
    {
        _instance.FDataFimDaGarantia = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataFimDaGarantia?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBBensMateriais();
        Assert.Equal(null !, instance.FDataFimDaGarantia);
    }
    ...
    {
        _instance.FDataTerminoDaGarantiaDaLoja = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataTerminoDaGarantiaDaLoja?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBBensMateriais();
        Assert.Equal(null !, instance.FDataTerminoDaGarantiaDaLoja);
    }
