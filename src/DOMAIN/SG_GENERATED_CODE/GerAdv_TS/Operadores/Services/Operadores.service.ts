...
export interface IOperadoresService {
  ...
  filterVoice: (filtro?: FilterOperadores, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class OperadoresService implements IOperadoresService {
  ...
  async filterVoice(filtro?: FilterOperadores, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
