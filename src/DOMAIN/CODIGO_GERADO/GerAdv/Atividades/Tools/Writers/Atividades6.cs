...
public class AtividadesWriter(IFAtividadesFactory atividadesFactory) : IAtividadesWriter
{
    ...
    public async Task Delete(AtividadesResponse atividades, int operadorId, MsiSqlConnection oCnn)
    {
        await _atividadesFactory.DeleteAsync(operadorId, atividades.Id, oCnn);
    }

    public async Task<FAtividades> WriteAsync(Models.Atividades atividades, int auditorQuem, MsiSqlConnection oCnn)
    {
