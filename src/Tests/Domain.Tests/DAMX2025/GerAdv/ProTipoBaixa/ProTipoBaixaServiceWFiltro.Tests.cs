...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class ProTipoBaixaServiceWFiltroTests : IDisposable
    {
        ...
        private readonly ProTipoBaixaServiceS _serviceS;
        public ProTipoBaixaServiceWFiltroTests()
        {
            ...
            _serviceS = new ProTipoBaixaServiceS();
            _service = new ProTipoBaixaService(_mockAppSettings.Object, _mockProTipoBaixaFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidProTipoBaixa_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeProTipoBaixa = "João Silva";
            var filtro = new FilterProTipoBaixa
            {
                Guid = nomeProTipoBaixa,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidProTipoBaixa_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
        ...
        [Fact]
        public void WFiltro_GuidProTipoBaixa_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidProTipoBaixa_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeProTipoBaixa)
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
        ...
        [Fact]
        public void WFiltro_GuidProTipoBaixa_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
            ...
            resultado.Value.where.Should().Contain("@ptxGuid");
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixa.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @ptxGuid");
            resultado.Value.where.Should().Contain($"= @{DBProTipoBaixa.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidProTipoBaixa_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeProTipoBaixa = "João Silva";
            var filtro = new FilterProTipoBaixa
            ...
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @ptxGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@ptxGuid");
        ...
        [Fact]
        public void WFiltro_NomeProTipoBaixa_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeProTipoBaixa = "João Silva";
            var filtro = new FilterProTipoBaixa
            {
                Nome = nomeProTipoBaixa,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeProTipoBaixa_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
        ...
        [Fact]
        public void WFiltro_NomeProTipoBaixa_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeProTipoBaixa_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeProTipoBaixa)
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
        ...
        [Fact]
        public void WFiltro_NomeProTipoBaixa_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterProTipoBaixa
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@ptxNome");
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixa.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @ptxNome");
            resultado.Value.where.Should().Contain($"= @{DBProTipoBaixa.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeProTipoBaixa_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeProTipoBaixa = "João Silva";
            var filtro = new FilterProTipoBaixa
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @ptxNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@ptxNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemCad}] = @{DBProTipoBaixaDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBProTipoBaixaDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.QuemCad} BETWEEN @{DBProTipoBaixaDicInfo.QuemCad} AND @{DBProTipoBaixaDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.QuemCad} BETWEEN @{DBProTipoBaixaDicInfo.QuemCad} AND @{DBProTipoBaixaDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemCad}] = @{DBProTipoBaixaDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemCad}] = @ptxQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@ptxQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@ptxQuemCad");
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemAtu}] = @{DBProTipoBaixaDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBProTipoBaixaDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.QuemAtu} BETWEEN @{DBProTipoBaixaDicInfo.QuemAtu} AND @{DBProTipoBaixaDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.QuemAtu} BETWEEN @{DBProTipoBaixaDicInfo.QuemAtu} AND @{DBProTipoBaixaDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemAtu}] = @{DBProTipoBaixaDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.QuemAtu}] = @ptxQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@ptxQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@ptxQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.CampoCodigo}] = @{DBProTipoBaixaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBProTipoBaixaDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.CampoCodigo} BETWEEN @{DBProTipoBaixaDicInfo.CampoCodigo} AND @{DBProTipoBaixaDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBProTipoBaixaDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.CampoCodigo} BETWEEN @{DBProTipoBaixaDicInfo.CampoCodigo} AND @{DBProTipoBaixaDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.CampoCodigo}] = @{DBProTipoBaixaDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBProTipoBaixaDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBProTipoBaixaDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.DtCad} BETWEEN @{DBProTipoBaixaDicInfo.DtCad} AND @{DBProTipoBaixaDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBProTipoBaixaDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBProTipoBaixaDicInfo.PTabelaNome}].[{DBProTipoBaixaDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBProTipoBaixaDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProTipoBaixaDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBProTipoBaixaDicInfo.PTabelaNome}].{DBProTipoBaixaDicInfo.DtAtu} BETWEEN @{DBProTipoBaixaDicInfo.DtAtu} AND @{DBProTipoBaixaDicInfo.DtAtu}_end");
        }
