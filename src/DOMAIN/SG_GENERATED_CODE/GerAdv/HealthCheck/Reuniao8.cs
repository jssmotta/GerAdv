                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(renCodigo) FROM {"Reuniao".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) renCliente,renIDAgenda,renData,renPauta,renATA,renHoraInicial,renHoraFinal,renExterna,renHoraSaida,renHoraRetorno,renPrincipaisDecisoes,renBold,renGuid FROM {"Reuniao".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
