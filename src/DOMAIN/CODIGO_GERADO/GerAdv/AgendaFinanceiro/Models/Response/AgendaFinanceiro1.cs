...
[Serializable]
public partial class AgendaFinanceiroResponse
{
    [JsonPropertyName("id")]
    ...
    /// <summary>
    /// Sem descrição - agePrazoProvisionado  
    /// </summary>
    ...
    /// <summary>
    /// Sem descrição - ageCompromissoHTML  
    /// </summary>
...
[Serializable]
public partial class AgendaFinanceiroResponseAll
{
    [JsonPropertyName("id")]
    public int Id { get; set; }
