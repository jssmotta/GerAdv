...
// useProcessOutPutIDsGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProcessOutPutIDs
"use client";
...
interface UseProcessOutPutIDsGridProps {
...
export const useProcessOutPutIDsGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IProcessOutPutIDs, filters: Record<string, any>) => {
