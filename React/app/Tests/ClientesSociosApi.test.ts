...
// Source:SOLIDTestesApiTSGeneratorTests
...
import { ClientesSociosApiError } from '@/app/GerAdv_TS/ClientesSocios/Apis/ClientesSociosApi';
import { ClientesSociosApi } from '@/app/GerAdv_TS/ClientesSocios/Apis/ClientesSociosApi';
...
import { ClientesSociosTestEmpty } from '@/app/GerAdv_TS/Models/ClientesSocios';
...
class: 'A'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterClientesSocios = { : 1 };
