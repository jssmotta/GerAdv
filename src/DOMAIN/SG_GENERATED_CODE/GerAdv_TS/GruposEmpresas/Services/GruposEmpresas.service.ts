...
export interface IGruposEmpresasService {
  ...
  filterVoice: (filtro?: FilterGruposEmpresas, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class GruposEmpresasService implements IGruposEmpresasService {
  ...
  async filterVoice(filtro?: FilterGruposEmpresas, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
