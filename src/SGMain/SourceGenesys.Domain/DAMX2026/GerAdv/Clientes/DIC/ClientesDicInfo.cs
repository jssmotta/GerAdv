...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem CliEndereco => new(0, PTabelaNome, CampoCodigo, Endereco, 80, "Endereco", "Endereço, Rua, Avenida, etc.", EDataTypeSystemInfo.SystemInfoTextAddress, true, false, false, prefixo: "cli");
    ...
    public static DBInfoSystem CliEnquadramentoEmpresa => new(0, PTabelaNome, CampoCodigo, EnquadramentoEmpresa, "EnquadramentoEmpresa", "EnquadramentoEmpresa", EDataTypeSystemInfo.SystemInfoNumber, prefixo: "cli");
