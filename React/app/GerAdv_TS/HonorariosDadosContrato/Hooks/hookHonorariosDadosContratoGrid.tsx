...
// useHonorariosDadosContratoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de HonorariosDadosContrato
"use client";
...
interface UseHonorariosDadosContratoGridProps {
...
export const useHonorariosDadosContratoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IHonorariosDadosContrato, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
