...
public class FilterEventoPrazoAgendaWithVoiceRequest
{
    /// <summary>
    /// Filtro de EventoPrazoAgenda padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterEventoPrazoAgenda Filter { get; set; } = new();
...
[Serializable]
public partial record FilterEventoPrazoAgenda
{
