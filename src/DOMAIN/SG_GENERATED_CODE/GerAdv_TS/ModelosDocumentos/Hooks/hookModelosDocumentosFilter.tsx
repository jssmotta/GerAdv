...
<InputGuid
                      ...
                      handlers.handleInputChange({ target: { name: 'guid', value } } as any)
                        ...
                        />
<FilterDialogButton        
        filter={handlers.windowFilter.filterTipoModeloDocumento ?? ({} as any) as any}
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({ ...prev, filterTipoModeloDocumento: f }))
        }        
...
<InputInput
    ...
    const { renderInputFilters: renderTipoModeloDocumentoInputs } = useTipoModeloDocumentoFilter({
