                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(axrCodigo) FROM {"AnexamentoRegistros".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) axrCliente,axrGUIDReg,axrCodigoReg,axrIDReg,axrData,axrGUID FROM {"AnexamentoRegistros".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
