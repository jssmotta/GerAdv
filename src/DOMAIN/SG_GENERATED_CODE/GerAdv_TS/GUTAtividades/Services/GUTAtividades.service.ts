...
export interface IGUTAtividadesService {
  ...
  filterVoice: (filtro?: FilterGUTAtividades, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class GUTAtividadesService implements IGUTAtividadesService {
  ...
  async filterVoice(filtro?: FilterGUTAtividades, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
