...
// useTipoCompromissoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoCompromisso
"use client";
...
interface UseTipoCompromissoGridProps {
...
export const useTipoCompromissoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ITipoCompromisso, filters: Record<string, any>) => {
