...
import FuncionariosHelpCrudButton from "../../Help/FuncionariosHelpCrudButton";
  ...
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("funcionarios-columns-order-mobile"),
        );
        if (savedOrder) {
    ...
    useEffect(() => {
      const cleanup = useIOSScrollFallback({
        scrollSelector:
          ".grid-mobile-crud.grid-mobile-funcionarios .k-grid-content",
        waitForDOM: true,
        retryDelay: 100,
      ...
      <>
        {initialized && (
          <>
            <PageTitle
              title="Colaboradores"
              helpButton={<FuncionariosHelpCrudButton isMobile={true} />}
            />
                ...
                <>
                  ...
                  {typeView === "grid" && (
                    <Grid
                      ...
                      onRowClick={(e) => {
                        if (selectItem) {
                          selectItem(e.dataItem as IFuncionarios);
