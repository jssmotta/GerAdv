                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(posCodigo) FROM {"PosicaoOutrasPartes".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) posDescricao,posBold,posGuid FROM {"PosicaoOutrasPartes".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
