...
#region TableDefinition_StatusHTrab
...
#endregion
    public DBStatusHTrab(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBStatusHTrab(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBStatusHTrab(in string? sqlWhere, SqlConnection? oCnn)
    {
