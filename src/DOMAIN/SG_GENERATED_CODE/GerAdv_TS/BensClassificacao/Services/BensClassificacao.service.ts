...
export interface IBensClassificacaoService {
  ...
  filterVoice: (filtro?: FilterBensClassificacao, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class BensClassificacaoService implements IBensClassificacaoService {
  ...
  async filterVoice(filtro?: FilterBensClassificacao, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
