...
// useAtividadesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Atividades
"use client";
...
interface UseAtividadesGridProps {
  data: IAtividades[];
...
export const useAtividadesGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("atividades-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IAtividades, filters: Record<string, any>) => {
