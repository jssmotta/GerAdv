...
export const PontoVirtualAcessosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IPontoVirtualAcessos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-pontovirtualacessos'
