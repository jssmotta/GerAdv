...
export interface IAgendaRelatorioService {
  ...
  filterVoice: (filtro?: FilterAgendaRelatorio, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class AgendaRelatorioService implements IAgendaRelatorioService {
  ...
  async filterVoice(filtro?: FilterAgendaRelatorio, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
