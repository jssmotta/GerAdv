...
#region Test Data Setup Helpers
    ...
    private void SetupMockFEnderecos(bool? TopIndex = false, string? Descricao = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? Contato = "", string? DtNasc = "24/04/1975", string? Endereco = "Rua das Flores, 123", string? Bairro = "Centro", bool? Privativo = true, bool? AddContato = false, string? CEP = "01234-567", string? OAB = "AAAAAAAAAAAAAAAAAA", string? OBS = "", string? Fone = "(11) 99999-9999", string? Fax = "(11) 88888-9999", string? Tratamento = "AAAAAAAAAAAAAAAAAA", int? Cidade = 1, string? Site = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? EMail = "test@email.com", int? Quem = 1, string? QuemIndicou = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", bool? ReportECBOnly = true)
    {
        ...
        {
            _mockFEnderecos.Setup(f => f.FDtNasc).Returns((DateOnly? )null);
        }
        else
        {
            ...
            _mockFEnderecos.Setup(f => f.FDtNasc).Returns(dateOnly);
        }
