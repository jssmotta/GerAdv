                ...
                try
                {
                    ...
                    try
                    {
                        if (DBProDespesasDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) desGUID,desLigacaoID,desCliente,desCorrigido,desData,desValorOriginal,desProcesso,desQuitado,desDataCorrecao,desValor,desTipo,desHistorico,desLivroCaixa FROM {"ProDespesas".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
