...
export const ContratosForm: React.FC<ContratosFormProps> = ({
  ...
  const dadoApi = new ContratosApi(
    systemContext?.Uri ?? "",
    systemContext?.Token ?? "",
  );
  ...
  useEffect(() => {
    ...
    if (el) {
      el.textContent =
        contratosData?.id == 0 ? "Editar Contratos" : "Adicionar Contratos";
    }
  }, [contratosData.id]);
  ...
  return (
    <>
      <div
        className={
          isMobile
            ? "form-container form-container-Contratos"
            : "form-container form-container-Contratos"
        }
      >
        <form
          className="formInputCadInc"
          id={`ContratosForm-${contratosData.id}`}
          onSubmit={onConfirm}
        >
          {!isMobile && (
            <ButtonSalvarCrud
              ...
              onClose={onClose}
              formId={`ContratosForm-${contratosData.id}`}
          ...
          <div className="grid-container">
            ...
            <InputCheckbox
              ...
              checked={contratosData.ocultarrelatorio}
              onChange={onChange}
            />
          </div>
          <div className="grid-container">
          ...
          <div className="grid-container">
            <InputCheckbox
              ...
              label="Suspenso"
              name="suspenso"
              checked={contratosData.suspenso}
              onChange={onChange}
            />
        ...
        <FooterIncDocker>
          <CopyButton formId={`ContratosForm-${contratosData.id}`} />

          <PrintButton formId={`ContratosForm-${contratosData.id}`} />
