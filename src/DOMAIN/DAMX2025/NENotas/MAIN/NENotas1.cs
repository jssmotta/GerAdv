...
#region TableDefinition_NENotas
...
#endregion
    public DBNENotas(in int nCodigo, MsiSqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBNENotas(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        // Tracking: 250605-0
        if (oCnn is null)
            return;
    ...
    public DBNENotas(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
