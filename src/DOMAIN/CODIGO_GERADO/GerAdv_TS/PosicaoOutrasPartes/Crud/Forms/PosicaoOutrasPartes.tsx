  ...
  <>
    ...
    <Input
          ...
          />
          							...
          							<div className='relacionamentosLinks' onClick={()=> router.push(`/pages/terceiros${process.env.NEXT_PUBLIC_PAGE_HTML ?? ''}?posicaooutraspartes=${posicaooutraspartesData.id}`)}>Terceiros</div>
