                ...
                try
                {
                    ...
                    try
                    {
                        if (DBDocsRecebidosItensDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(driCodigo) FROM {"DocsRecebidosItens".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) driContatoCRM,driNome,driDevolvido,driSeraDevolvido,driObservacoes,driGUID FROM {"DocsRecebidosItens".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
