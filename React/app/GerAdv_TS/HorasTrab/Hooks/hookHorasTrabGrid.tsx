...
// useHorasTrabGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de HorasTrab
"use client";
...
interface UseHorasTrabGridProps {
  data: IHorasTrab[];
...
export const useHorasTrabGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("horastrab-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IHorasTrab, filters: Record<string, any>) => {
