...
// useServicosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Servicos
"use client";
...
interface UseServicosGridProps {
  data: IServicos[];
...
export const useServicosGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IServicos, filters: Record<string, any>) => {
