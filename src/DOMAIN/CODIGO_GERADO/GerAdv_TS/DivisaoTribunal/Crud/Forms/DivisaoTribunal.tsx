 ...
 const addValorTribunal = (e: any) => {
    ...
    if (!isSubmitting) {
      ...
      try {
        ...
        console.error("Erro ao submeter formulário de DivisaoTribunal:", error);
  ...
  const handleDirectSave = () => {
    if (!isSubmitting) {
      ...
      try {
        ...
        console.error("Erro ao salvar DivisaoTribunal diretamente:", error);
        setIsSubmitting(false);
        if (onError) onError();
      }
    }
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-DivisaoTribunal' : 'form-container form-container-DivisaoTribunal'}>
       
            <form className='formInputCadInc' id={`DivisaoTribunalForm-${divisaotribunalData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={divisaotribunalData} isSubmitting={isSubmitting} onClose={onClose} formId={`DivisaoTribunalForm-${divisaotribunalData.id}`} preventPropagation={true} onSave={handleDirectSave} />
