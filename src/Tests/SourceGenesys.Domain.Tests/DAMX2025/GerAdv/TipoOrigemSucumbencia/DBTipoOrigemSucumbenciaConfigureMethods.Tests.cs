...
/// <summary>
/// Comprehensive unit tests for ConfigureUpdateFields and ConfigureAuditorFields methods in DBTipoOrigemSucumbencia class
...
/// </summary>
public class DBTipoOrigemSucumbenciaConfigureMethodsTests : IDisposable
{
    private readonly DBTipoOrigemSucumbencia _tipoorigemsucumbencia;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoOrigemSucumbenciaConfigureMethodsTests()
    {
        _tipoorigemsucumbencia = new DBTipoOrigemSucumbencia();
    ...
    public void ConfigureUpdateFields_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        // Arrange
        ResetAllFieldFlags();
        _tipoorigemsucumbencia.ID = 1; // Update scenario
        // Act
        var result = _tipoorigemsucumbencia.Update(_mockConnection.Object);
    ...
    public async Task ConfigureUpdateFieldsAsync_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        ...
        try
        {
            var result = await _tipoorigemsucumbencia.UpdateAsync(_mockConnection.Object);
...
#region Helper Methods
    ...
    {
        var field = typeof(DBTipoOrigemSucumbencia).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
        field?.SetValue(_tipoorigemsucumbencia, value);
    }
    ...
    private void SetFieldValue(string fieldName, object? value)
    {
        ...
        {
            field?.SetValue(_tipoorigemsucumbencia, Convert.ToDateTime(value));
        }
    }
...
#region Fields_All
    ...
    public void ConfigureUpdateFields_WithNomeFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _tipoorigemsucumbencia.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _tipoorigemsucumbencia.Update(_mockConnection.Object));
    ...
    public async Task ConfigureUpdateFieldsAsync_WithNomeFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _tipoorigemsucumbencia.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _tipoorigemsucumbencia.UpdateAsync(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncNome_WithCancellationToken_ShouldRespectCancellation()
    {
        ...
        var exception = await Record.ExceptionAsync(async () => await _tipoorigemsucumbencia.UpdateAsync(_mockConnection.Object, cancellationToken: cts.Token));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncNome_WithTimeout_ShouldRespectTimeout()
    {
        ...
        _tipoorigemsucumbencia.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _tipoorigemsucumbencia.UpdateAsync(_mockConnection.Object, timeoutSeconds: 1));
        exception.Should().NotBeNull();
    }
    ...
    {
        // Arrange
        _tipoorigemsucumbencia.ID = 123; // Update scenario
        _tipoorigemsucumbencia.AuditorQuem = 7;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection but audit fields should be set
        var exception = Record.Exception(() => _tipoorigemsucumbencia.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _tipoorigemsucumbencia.AuditorQuem.Should().Be(7);
    }
    ...
    public void ConfigureAuditorFieldsNome_WhenAuditorQuemIsZero_ShouldSetToDefaultValue()
    {
        // Arrange
        _tipoorigemsucumbencia.ID = 0; // Insert scenario
        _tipoorigemsucumbencia.AuditorQuem = 0; // Should be set to 1
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _tipoorigemsucumbencia.Update(_mockConnection.Object));
        ...
        _tipoorigemsucumbencia.AuditorQuem.Should().Be(1);
    }
    ...
    public void ConfigureAuditorFieldsNome_WhenAuditorQuemHasValue_ShouldPreserveValue(int auditorValue)
    {
        // Arrange
        _tipoorigemsucumbencia.ID = 0; // Insert scenario
        _tipoorigemsucumbencia.AuditorQuem = auditorValue;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _tipoorigemsucumbencia.Update(_mockConnection.Object));
        ...
        _tipoorigemsucumbencia.AuditorQuem.Should().Be(auditorValue);
    }
    ...
    {
        // Arrange
        _tipoorigemsucumbencia.ID = 0;
        _tipoorigemsucumbencia.AuditorQuem = 10;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _tipoorigemsucumbencia.Update(_mockConnection.Object));
        ...
        _tipoorigemsucumbencia.AuditorQuem.Should().Be(10);
    }
    ...
    {
        // Arrange
        _tipoorigemsucumbencia.ID = id;
        _tipoorigemsucumbencia.AuditorQuem = 15;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _tipoorigemsucumbencia.Update(_mockConnection.Object));
        ...
        _tipoorigemsucumbencia.AuditorQuem.Should().Be(15);
    }
    ...
    public void ConfigureMethodsNome_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        SetAllFieldValues();
        _tipoorigemsucumbencia.ID = 123;
        _tipoorigemsucumbencia.AuditorQuem = 99;
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _tipoorigemsucumbencia.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _tipoorigemsucumbencia.FNome.Should().Be("");
        _tipoorigemsucumbencia.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureFieldsNome_Integration_FieldChangeTracking_ShouldWorkCorrectly()
    {
        ...
        var result1 = _tipoorigemsucumbencia.Update(_mockConnection.Object);
    ...
    {
        _tipoorigemsucumbencia?.Dispose();
    }
}