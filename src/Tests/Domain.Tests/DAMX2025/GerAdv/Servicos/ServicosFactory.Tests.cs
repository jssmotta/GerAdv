...
public class FServicosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FServicos>();
    }
    ...
    {
        // Arrange
        var factory = new FServicosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("serCodigo", typeof(int));
        mockDataTable.Columns.Add("serDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["serCodigo"] = testId;
        row["serDescricao"] = "Test Servicos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["serCodigo"] = 123;
        row["serDescricao"] = "Test Servicos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FServicos properties
        }
    }
