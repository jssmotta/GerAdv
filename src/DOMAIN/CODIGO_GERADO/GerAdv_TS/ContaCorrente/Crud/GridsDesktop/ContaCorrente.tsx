...
interface ContaCorrenteGridProps {
  data: IContaCorrente[];
  onRowClick: (contacorrente: IContaCorrente) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ContaCorrenteGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IContaCorrente, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-contacorrente'
