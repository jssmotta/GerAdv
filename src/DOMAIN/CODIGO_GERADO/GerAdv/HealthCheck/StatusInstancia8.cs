                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(istCodigo) FROM {"StatusInstancia".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) istNome,istBold,istGuid FROM {"StatusInstancia".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
