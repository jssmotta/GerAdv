                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(pobCodigo) FROM {"ProObservacoes".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) pobProcesso,pobNome,pobObservacoes,pobData,pobGuid FROM {"ProObservacoes".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
