...
interface UseGruposEmpresasFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterGruposEmpresas | undefined | null,
  ) => Promise<void>;
}
...
interface UseGruposEmpresasFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterGruposEmpresas>,
  ) => React.ReactNode;
...
export const useGruposEmpresasFilter = ({
  handleFetchWithFilter,
}: UseGruposEmpresasFilterProps): UseGruposEmpresasFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterGruposEmpresas>(
