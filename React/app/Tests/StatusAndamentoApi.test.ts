...
import { StatusAndamentoApiError } from '@/app/GerAdv_TS/StatusAndamento/Apis/ApiStatusAndamento';
...
import { StatusAndamentoTestEmpty } from '@/app/GerAdv_TS/Models/StatusAndamento';
...
icone: 0
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterStatusAndamento = { : 1 };
