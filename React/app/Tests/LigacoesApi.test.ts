...
import { LigacoesApiError } from '@/app/GerAdv_TS/Ligacoes/Apis/ApiLigacoes';
...
import { LigacoesTestEmpty } from '@/app/GerAdv_TS/Models/Ligacoes';
...
emotion: 0
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterLigacoes = { : 1 };
