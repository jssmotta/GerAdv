...
// useStatusAndamentoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de StatusAndamento
"use client";
...
interface UseStatusAndamentoGridProps {
...
export const useStatusAndamentoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IStatusAndamento, filters: Record<string, any>) => {
