...
public class AreaServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task AddAndUpdate_WithValidArea_ShouldExerciseWorkflow()
    {
        // Arrange
        var validArea = new Models.Area
        {
            Id = 0, // New area
    ...
    {
        var method = typeof(AreaService).GetMethod(methodName, BindingFlags.NonPublic | BindingFlags.Instance);
        if (method == null)
            return null;
