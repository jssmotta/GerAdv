  ...
  const renderInputFilters = (handlers: FilterHandlers<FilterProValores>) => (
    <>
      ...
      <InputValor
        ...
        disabled={
          handlers.windowFilter?.valororiginalcorrigidoindice != 0
            ? false
            : true
        }
        onChange={handlers.handleInputValorChange}
      ...
      <InputValor
        ...
        disabled={
          handlers.windowFilter?.valormultacorrigido != 0 ? false : true
        }
        onChange={handlers.handleInputValorChange}
      ...
      <InputValor
        ...
        disabled={
          handlers.windowFilter?.valorjuroscorrigido != 0 ? false : true
        }
        onChange={handlers.handleInputValorChange}
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("dataultimacorrecao", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("dataultimacorrecao_end", value)
        }
      />
      <InputInput
        type="text"
