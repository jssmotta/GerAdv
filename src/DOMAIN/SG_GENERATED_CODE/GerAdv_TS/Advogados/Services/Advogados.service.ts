...
export interface IAdvogadosService {
  ...
  filterVoice: (filtro?: FilterAdvogados, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class AdvogadosService implements IAdvogadosService {
  ...
  async filterVoice(filtro?: FilterAdvogados, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
