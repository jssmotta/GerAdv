...
export const AlertasEnviadosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAlertasEnviados, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nomealertas' title='Alertas' sortable={false} filterable={false} />, /* Track G.01 */
  <GridColumn
  field='id'
  width={'55px'}
  title='Excluir'
...
{initialized && (
  ...
  className='grid-desktop-alertasenviados'
