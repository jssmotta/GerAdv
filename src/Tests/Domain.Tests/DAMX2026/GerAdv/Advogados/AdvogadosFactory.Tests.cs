...
public class FAdvogadosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FAdvogados>();
    }
    ...
    {
        // Arrange
        var factory = new FAdvogadosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("advCodigo", typeof(int));
        mockDataTable.Columns.Add("advNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["advCodigo"] = testId;
        row["advNome"] = "Test Advogados";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["advCodigo"] = 123;
        row["advNome"] = "Test Advogados Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FAdvogados properties
        }
    }
