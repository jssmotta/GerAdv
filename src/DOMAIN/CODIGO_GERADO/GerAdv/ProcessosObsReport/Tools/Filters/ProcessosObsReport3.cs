...
public class FilterProcessosObsReportWithVoiceRequest
{
    /// <summary>
    /// Filtro de ProcessosObsReport padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterProcessosObsReport Filter { get; set; } = new();
...
public partial record FilterProcessosObsReport
{
    ...
    [Description("Historico -2147483648 para nada ou id")]
    public int Historico { get; set; } = int.MinValue;

    [JsonPropertyName("historico_end")]
    [Description("Historico -2147483648 para nada ou id para final do intervalo")]
