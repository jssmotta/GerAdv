...
#region Test Data Setup Helpers
    ...
    private void SetupMockFClientesSocios(bool? SomenteRepresentante = false, int? Idade = 1, bool? IsRepresentanteLegal = true, string? Qualificacao = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", bool? Sexo = false, string? DtNasc = "24/04/1975", string? Nome = "João", string? Site = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? RepresentanteLegal = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", int? Cliente = 1, string? Endereco = "Rua das Flores, 123", string? Bairro = "Centro", string? CEP = "01234-567", int? Cidade = 1, string? RG = "12.345.678-9", string? CPF = "544.506.718-13", string? Fone = "(11) 99999-9999", string? Participacao = "AAAAAAAA", string? Cargo = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? EMail = "test@email.com", string? Obs = "", string? CNH = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? DataContrato = "24/04/1975", string? CNPJ = "93016944000138", string? InscEst = "AAAAAAAAAAAAA", string? SocioEmpresaAdminNome = "João", string? EnderecoSocio = "Rua das Flores, 123", string? BairroSocio = "Centro", string? CEPSocio = "01234-567", int? CidadeSocio = 1, string? RGDataExp = "24/04/1975", bool? SocioEmpresaAdminSomente = true, bool? Tipo = false, string? Fax = "(11) 88888-9999", string? Class = "A")
    {
        ...
        {
            _mockFClientesSocios.Setup(f => f.FDtNasc).Returns((DateOnly? )null);
        }
        else
        {
            ...
            _mockFClientesSocios.Setup(f => f.FDtNasc).Returns(dateOnly);
        }
        ...
        {
            _mockFClientesSocios.Setup(f => f.FDataContrato).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(DataContrato, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(DataContrato, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFClientesSocios.Setup(f => f.FDataContrato).Returns(dateOnly);
        }
        ...
        {
            _mockFClientesSocios.Setup(f => f.FRGDataExp).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            ...
            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFClientesSocios.Setup(f => f.FRGDataExp).Returns(dateOnly);
        }
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_DataContrato_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _clientessociosWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DataContrato.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
