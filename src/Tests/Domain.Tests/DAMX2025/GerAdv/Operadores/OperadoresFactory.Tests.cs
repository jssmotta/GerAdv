...
public class FOperadoresFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FOperadores>();
    }
    ...
    {
        // Arrange
        var factory = new FOperadoresFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("operCodigo", typeof(int));
        mockDataTable.Columns.Add("operNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["operCodigo"] = testId;
        row["operNome"] = "Test Operadores";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["operCodigo"] = 123;
        row["operNome"] = "Test Operadores Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FOperadores properties
        }
    }
