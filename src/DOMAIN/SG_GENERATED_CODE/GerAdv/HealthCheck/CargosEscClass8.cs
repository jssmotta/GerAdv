                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(cecCodigo) FROM {"CargosEscClass".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) cecNome,cecGuid FROM {"CargosEscClass".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
