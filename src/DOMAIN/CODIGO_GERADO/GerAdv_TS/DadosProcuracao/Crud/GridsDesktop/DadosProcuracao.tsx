...
interface DadosProcuracaoGridProps {
  data: IDadosProcuracao[];
  onRowClick: (dadosprocuracao: IDadosProcuracao) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const DadosProcuracaoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
{initialized && (
  ...
  className='grid-desktop-dadosprocuracao'
