  ...
  <>
    ...
    <Input
          ...
          />
          							...
          							<div className='relacionamentosLinks' onClick={()=> router.push(`/pages/statusbiu${process.env.NEXT_PUBLIC_PAGE_HTML ?? ''}?tipostatusbiu=${tipostatusbiuData.id}`)}>Status Biu</div>
