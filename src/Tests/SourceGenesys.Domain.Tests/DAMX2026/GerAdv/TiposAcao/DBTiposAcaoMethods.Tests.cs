...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTiposAcao
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTiposAcaoUpdateAdvancedTests : IDisposable
{
    private readonly DBTiposAcao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTiposAcaoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTiposAcao
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTiposAcao).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTiposAcao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTiposAcao instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTiposAcao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTiposAcao.PTabelaNome.Should().Be("TiposAcao");
        DBTiposAcao.CampoCodigo.Should().Be("tacCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTiposAcao();
        dbRec.ID = 1;
