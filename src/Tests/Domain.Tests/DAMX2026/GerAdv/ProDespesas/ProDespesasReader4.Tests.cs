...
#region Tests Generics
    ...
    public void Read_WhenWhereIsNullOrEmptyOrWhitespace_ReturnsNull(string? where)
    {
        ...
        _mockProDespesasFactory.Setup(f => f.CreateFromParameters(It.IsAny<List<SqlParameter>?>(), It.IsAny<MsiSqlConnection?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string>(), It.IsAny<string>())).Returns(new FProDespesas { ID = 0, FData = null });
        // Act
        var result = _prodespesasReader.Read(where!, null, null);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FProDespesas_NullInput_ReturnsNull()
    {
        // Act
        var result = _prodespesasReader.Read((FProDespesas)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FProDespesas_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
    ...
    [Fact]
    public void Read_DBProDespesas_NullInput_ReturnsNull()
    {
        // Act
        var result = _prodespesasReader.Read((SG.GerAdv.DBProDespesas)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_DBProDespesas_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBProDespesas
        {
            ID = 20,
            FData = null
        };
    ...
    [Fact]
    public void ReadAll_FProDespesas_NullInput_ReturnsNull()
    {
        // Act
        var result = _prodespesasReader.ReadAll((FProDespesas)null !, (IDataRecord)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_FProDespesas_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
        var dbRec = new FProDespesas
        {
        ...
        // Act
        var result = _prodespesasReader.ReadAll(dbRec, (IDataRecord)new Mock<IDataRecord>().Object);
        // Assert
        result.Should().NotBeNull();
    ...
    [Fact]
    public void ReadAll_DBProDespesas_NullInput_ReturnsNull()
    {
        // Act
        var result = _prodespesasReader.ReadAll((SG.GerAdv.DBProDespesas)null !, (DataRow)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_DBProDespesas_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBProDespesas
        {
        ...
        // Act
        var result = _prodespesasReader.ReadAll(dbRec, (DataRow)null !);
        // Assert
        result.Should().NotBeNull();
...
#region ListarN Tests
    ...
    public async Task ListarN_WithEmptyParameters_ShouldThrowInvalidOperationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => _prodespesasReader.ListarNAsync(max, uri, cWhere, parameters, order));
    }
