...
public partial class FStatusHTrab : MenphisSI.SG.GerAdv.DBStatusHTrab, IDBStatusHTrab
{
    // DI-compatible default constructor
    public FStatusHTrab() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FStatusHTrab CreateFromReader(SqlDataReader? dbRec)
    {
        return new FStatusHTrab(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FStatusHTrab CreateFromDataRow(DataRow? dbRec)
    {
        return new FStatusHTrab(dbRec);
    }

    private FStatusHTrab(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FStatusHTrab(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FStatusHTrab> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
