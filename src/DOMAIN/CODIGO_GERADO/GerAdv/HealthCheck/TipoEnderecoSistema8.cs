                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tesCodigo) FROM {"TipoEnderecoSistema".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tesNome,tesGuid FROM {"TipoEnderecoSistema".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
