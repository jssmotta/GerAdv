...
public partial class FAdvogados : MenphisSI.SG.GerAdv.DBAdvogados, IDBAdvogados
{
    // DI-compatible default constructor
    public FAdvogados() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FAdvogados CreateFromReader(SqlDataReader? dbRec)
    {
        return new FAdvogados(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FAdvogados CreateFromDataRow(DataRow? dbRec)
    {
        return new FAdvogados(dbRec);
    }

    private FAdvogados(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FAdvogados(DataRow? dbRec) : base(dbRec)
    {
    }

    private FAdvogados(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FAdvogados CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FAdvogados(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FAdvogados> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fAdvogados = new FAdvogados();
        await fAdvogados.CarregarAsync(id, oCnn);
        return fAdvogados;
    }
