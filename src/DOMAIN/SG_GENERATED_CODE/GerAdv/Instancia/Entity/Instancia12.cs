...
public partial class FInstancia : MenphisSI.SG.GerAdv.DBInstancia, IDBInstancia
{
    // DI-compatible default constructor
    public FInstancia() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FInstancia CreateFromReader(SqlDataReader? dbRec)
    {
        return new FInstancia(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FInstancia CreateFromDataRow(DataRow? dbRec)
    {
        return new FInstancia(dbRec);
    }

    private FInstancia(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FInstancia(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FInstancia> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
