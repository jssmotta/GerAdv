...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class TipoProDespositoServiceWFiltroTests : IDisposable
    {
        ...
        private readonly TipoProDespositoServiceS _serviceS;
        public TipoProDespositoServiceWFiltroTests()
        {
            ...
            _serviceS = new TipoProDespositoServiceS();
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_NomeTipoProDesposito_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoProDesposito = "João Silva";
            var filtro = new FilterTipoProDesposito
            {
                Nome = nomeTipoProDesposito,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeTipoProDesposito_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoProDesposito
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoProDesposito_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoProDesposito
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeTipoProDesposito_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoProDesposito)
        {
            // Arrange
            var filtro = new FilterTipoProDesposito
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoProDesposito_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoProDesposito
            {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoProDesposito.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
        ...
        [Fact]
        public void WFiltro_NomeTipoProDesposito_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoProDesposito = "João Silva";
            var filtro = new FilterTipoProDesposito
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoProDespositoDicInfo.PTabelaNome}].[{DBTipoProDespositoDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @tpdNome");
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoProDespositoDicInfo.PTabelaNome}].[{DBTipoProDespositoDicInfo.CampoCodigo}] = @{DBTipoProDespositoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoProDespositoDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoProDespositoDicInfo.PTabelaNome}].{DBTipoProDespositoDicInfo.CampoCodigo} BETWEEN @{DBTipoProDespositoDicInfo.CampoCodigo} AND @{DBTipoProDespositoDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoProDespositoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoProDespositoDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoProDespositoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoProDespositoDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoProDespositoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBTipoProDespositoDicInfo.Nome}");
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoProDespositoDicInfo.PTabelaNome}].{DBTipoProDespositoDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoProDespositoDicInfo.PTabelaNome}].{DBTipoProDespositoDicInfo.CampoCodigo} BETWEEN @{DBTipoProDespositoDicInfo.CampoCodigo} AND @{DBTipoProDespositoDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoProDespositoDicInfo.PTabelaNome}].[{DBTipoProDespositoDicInfo.CampoCodigo}] = @{DBTipoProDespositoDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoProDespositoDicInfo.PTabelaNome}].[{DBTipoProDespositoDicInfo.CampoCodigo}]");
        }
