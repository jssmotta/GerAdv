...
public partial class DBToolWTable
{
    ...
    {
        if (oCnn == null)
            throw new ArgumentException("Connection is null = BuildSqlCommand()");
        if (oTrans == null)
            throw new ArgumentException("Transaction is null = BuildSqlCommand()");
        if (string.IsNullOrEmpty(Table.Trim()))
            throw new ArgumentException("Table name is empty = BuildSqlCommand()");
    ...
    {
        if (oCnn == null)
            throw new ArgumentException("Connection is null = ExecuteCommand()");
        if (oTrans == null)
            throw new ArgumentException("oTrans is null = ExecuteCommand()");
    ...
    {
        var executor = new UpdateExecutor64(this, oCnn);
    ...
    {
        if (conn == null)
            throw new ArgumentException("Connection is null = ObtemUltimoIDInserido()");

        if (trans == null) throw new ArgumentException("trans is null = ObtemUltimoIDInserido");
