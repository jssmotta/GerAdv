...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTipoOrigemSucumbencia
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTipoOrigemSucumbenciaUpdateAdvancedTests : IDisposable
{
    private readonly DBTipoOrigemSucumbencia _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoOrigemSucumbenciaUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTipoOrigemSucumbencia
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTipoOrigemSucumbencia).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTipoOrigemSucumbencia).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTipoOrigemSucumbencia instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTipoOrigemSucumbencia).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTipoOrigemSucumbencia.PTabelaNome.Should().Be("TipoOrigemSucumbencia");
        DBTipoOrigemSucumbencia.CampoCodigo.Should().Be("tosCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTipoOrigemSucumbencia();
        dbRec.ID = 1;
