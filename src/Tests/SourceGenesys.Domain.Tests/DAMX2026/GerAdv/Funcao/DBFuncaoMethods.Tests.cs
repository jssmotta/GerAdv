...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBFuncao
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBFuncaoUpdateAdvancedTests : IDisposable
{
    private readonly DBFuncao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBFuncaoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBFuncao
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBFuncao).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBFuncao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBFuncao instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBFuncao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBFuncao.PTabelaNome.Should().Be("Funcao");
        DBFuncao.CampoCodigo.Should().Be("funCodigo");
    }
