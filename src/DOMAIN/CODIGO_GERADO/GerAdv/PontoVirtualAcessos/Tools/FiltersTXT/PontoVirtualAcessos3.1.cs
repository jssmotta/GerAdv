...
public static class FilterPontoVirtualAcessosTXT
{ 
    ...
    public static (string, string) GetPrompt(FilterPontoVirtualAcessos? existingFilter, JsonSerializerOptions options)
...
Você é um assistente que ajuda a preencher filtros para buscar PontoVirtualAcessos em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterPontoVirtualAcessos:

- O filter irá filtrar os PontoVirtualAcessos conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterPontoVirtualAcessos:(Ponto Virtual Acessos)
...
- Se ouvir "todos os PontoVirtualAcessos" ou similar, deixe todos os campos com valores padrão;
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt PontoVirtualAcessos length: {result.Length}");
#endif
