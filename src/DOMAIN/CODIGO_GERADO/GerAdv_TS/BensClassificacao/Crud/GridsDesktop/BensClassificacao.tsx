...
export const BensClassificacaoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IBensClassificacao, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-bensclassificacao'
