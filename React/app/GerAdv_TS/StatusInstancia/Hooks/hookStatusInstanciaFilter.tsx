...
interface UseStatusInstanciaFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterStatusInstancia | undefined | null,
  ) => Promise<void>;
}
...
interface UseStatusInstanciaFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterStatusInstancia>,
  ) => React.ReactNode;
...
export const useStatusInstanciaFilter = ({
  handleFetchWithFilter,
}: UseStatusInstanciaFilterProps): UseStatusInstanciaFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterStatusInstancia>(
