...
interface PreClientesGridProps {
  data: IPreClientes[];
  onRowClick: (preclientes: IPreClientes) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const PreClientesGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IPreClientes, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-preclientes'
