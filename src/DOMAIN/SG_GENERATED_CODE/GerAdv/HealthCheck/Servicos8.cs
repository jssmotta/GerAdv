                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(serCodigo) FROM {"Servicos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) serCobrar,serDescricao,serBasico,serGuid FROM {"Servicos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
