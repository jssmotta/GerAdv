...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class ProCDAServiceWFiltroTests : IDisposable
    {
        ...
        public ProCDAServiceWFiltroTests()
        {
            ...
            _service = new ProCDAService(_mockAppSettings.Object, _mockProCDAFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        }
...
#region filtro.Processo_end Tests
        ...
        public void WFiltro_Processo_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBProCDADicInfo.Nome}");
