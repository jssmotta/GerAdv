...
interface ReuniaoPessoasGridProps {
  data: IReuniaoPessoas[];
  onRowClick: (reuniaopessoas: IReuniaoPessoas) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ReuniaoPessoasGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IReuniaoPessoas, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-reuniaopessoas'
