...
import { ColaboradoresApiError } from '@/app/GerAdv_TS/Colaboradores/Apis/ColaboradoresApi';
import { ColaboradoresApi } from '@/app/GerAdv_TS/Colaboradores/Apis/ColaboradoresApi';
...
import { ColaboradoresTestEmpty } from '@/app/GerAdv_TS/Models/Colaboradores';
...
class: 'A'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterColaboradores = { : 1 };
