...
// useOperadorGruposAgendaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de OperadorGruposAgenda
"use client";
...
interface UseOperadorGruposAgendaGridProps {
...
export const useOperadorGruposAgendaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseOperadorGruposAgendaGridProps) => {
  ...
  const filterLogic = useCallback(
    (data: IOperadorGruposAgenda, filters: Record<string, any>) => {
