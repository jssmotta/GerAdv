                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(prrCodigo) FROM {"ProcessosObsReport".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) prrData,prrProcesso,prrObservacao,prrHistorico FROM {"ProcessosObsReport".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
