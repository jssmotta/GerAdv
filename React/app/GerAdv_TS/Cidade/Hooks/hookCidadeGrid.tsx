...
// useCidadeGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Cidade
"use client";
...
export const useCidadeGrid = ({
  ...
  const defaultColumnsOrder = useMemo(() => ["nome", "duf"], []);
  ...
  const filterLogic = useCallback(
    (data: ICidade, filters: Record<string, any>) => {
