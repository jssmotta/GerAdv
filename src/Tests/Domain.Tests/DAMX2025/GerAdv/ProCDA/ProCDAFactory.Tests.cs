...
public class FProCDAFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FProCDA>();
    }
    ...
    {
        // Arrange
        var factory = new FProCDAFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("pcdCodigo", typeof(int));
        mockDataTable.Columns.Add("pcdNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["pcdCodigo"] = testId;
        row["pcdNome"] = "Test ProCDA";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["pcdCodigo"] = 123;
        row["pcdNome"] = "Test ProCDA Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FProCDA properties
        }
    }
