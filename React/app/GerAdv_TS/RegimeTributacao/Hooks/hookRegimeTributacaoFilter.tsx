...
interface UseRegimeTributacaoFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterRegimeTributacao | undefined | null,
  ) => Promise<void>;
}
...
interface UseRegimeTributacaoFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterRegimeTributacao>,
  ) => React.ReactNode;
...
export const useRegimeTributacaoFilter = ({
  handleFetchWithFilter,
}: UseRegimeTributacaoFilterProps): UseRegimeTributacaoFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterRegimeTributacao>(
