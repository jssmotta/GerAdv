...
interface NEPalavrasChavesGridProps {
  data: INEPalavrasChaves[];
  onRowClick: (nepalavraschaves: INEPalavrasChaves) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const NEPalavrasChavesGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: INEPalavrasChaves, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-nepalavraschaves'
