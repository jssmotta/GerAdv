...
public partial interface IAtividadesReader
{
    ...
    Task<IEnumerable<AtividadesResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}