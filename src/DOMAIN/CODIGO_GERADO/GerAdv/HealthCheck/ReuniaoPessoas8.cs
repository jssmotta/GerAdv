                ...
                try
                {
                    ...
                    try
                    {
                        if (DBReuniaoPessoasDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(rnpCodigo) FROM dbo.ReuniaoPessoas (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) rnpReuniao,rnpOperador FROM dbo.ReuniaoPessoas (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
