...
public class FTribEnderecosFactoryTests : IDisposable
{
    private FTribEnderecosFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FTribEnderecosFactoryTests()
    {
        _factory = new FTribEnderecosFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTribEnderecos>();
    }
    ...
    {
        // Arrange
        var factory = new FTribEnderecosFactory();
        // Act
        factory.Dispose();
