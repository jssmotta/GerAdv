...
public partial class DBTipoCompromisso
{
    ...
    private protected bool pFldFGUID, pFldFIcone, pFldFDescricao, pFldFFinanceiro, pFldFBold;
    [XmlIgnore]
    [EditorBrowsable(EditorBrowsableState.Never)]
    private protected int m_FIcone;
    [XmlIgnore]
    [EditorBrowsable(EditorBrowsableState.Never)]
    private protected string? m_FGUID, m_FDescricao;
    [XmlIgnore]
    [EditorBrowsable(EditorBrowsableState.Never)]
    private protected bool m_FFinanceiro, m_FBold;
    // Tracking Code: 20250503
    [StringLength(100, ErrorMessage = "A propriedade FGUID da tabela TipoCompromisso deve ter no máximo 100 caracteres.")]
    ...
    public virtual bool FFinanceiro
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => m_FFinanceiro;
        set
