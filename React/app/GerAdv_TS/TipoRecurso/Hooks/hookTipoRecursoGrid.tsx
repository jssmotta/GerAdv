...
// useTipoRecursoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoRecurso
"use client";
...
interface UseTipoRecursoGridProps {
  data: ITipoRecurso[];
...
export const useTipoRecursoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ITipoRecurso, filters: Record<string, any>) => {
