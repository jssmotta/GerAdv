...
const ContatoCRMViewInc: React.FC<IContatoCRMViewFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedContatoCRMView =
        await contatocrmviewService.saveContatoCRMView(data);
