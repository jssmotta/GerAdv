...
import { EMPClassRiscosApiError } from '../GerAdv_TS/EMPClassRiscos/Apis/ApiEMPClassRiscos';
import { EMPClassRiscosApi } from '@/app/GerAdv_TS/EMPClassRiscos/Apis/ApiEMPClassRiscos';
import { FilterEMPClassRiscos } from '../GerAdv_TS/EMPClassRiscos/Filters/EMPClassRiscos';
...
describe('EMPClassRiscosApi', () => {
  let empclassriscosApi: EMPClassRiscosApi;
  ...
  beforeEach(() => {
    ...
    empclassriscosApi = new EMPClassRiscosApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(empclassriscosApi).toBeInstanceOf(EMPClassRiscosApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new EMPClassRiscosApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(EMPClassRiscosApi);
    });
  });
  ...
  describe('getAll', () => {
    ...
    it('should fetch all empclassriscos items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await empclassriscosApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(empclassriscosApi.getAll()).rejects.toThrow(EMPClassRiscosApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await empclassriscosApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-EMPClassRiscos_last_getAll_${200}`)));
    });
    ...
    it('should decode and return offline data if present in localStorage', async () => {
      ...
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'EMPClassRiscos',
          action: NotifySystemActions.INFO,
        })
      );
    });

    it('should throw EMPClassRiscosApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockEMPClassRiscos = EMPClassRiscosTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockEMPClassRiscos,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch empclassriscos by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await empclassriscosApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockEMPClassRiscos));
      ...
      expect(result.data).toEqual(mockEMPClassRiscos);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'EMPClassRiscos',
          id: 1,
  ...
  describe('filter', () => {
    const mockFilter: FilterEMPClassRiscos = {
      funcionario: 1,
      data: '2024-01-01',
    };
    ...
    it('should filter empclassriscos items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await empclassriscosApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    const mockEMPClassRiscos: IEMPClassRiscos = {
      id: 0,
      funcionario: 1,
      tipocompromisso: 1,
      fornecedor: 1,
    ...
    it('should add new empclassriscos successfully', async () => {
      const responseEMPClassRiscos = { ...mockEMPClassRiscos, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responseEMPClassRiscos,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await empclassriscosApi.addAndUpdate(mockEMPClassRiscos);
    ...
    it('should update existing empclassriscos successfully', async () => {
      const existingEMPClassRiscos = { ...mockEMPClassRiscos, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingEMPClassRiscos,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await empclassriscosApi.addAndUpdate(existingEMPClassRiscos);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(empclassriscosApi.addAndUpdate(mockEMPClassRiscos)).rejects.toThrow(EMPClassRiscosApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'EMPClassRiscos',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete empclassriscos successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await empclassriscosApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(empclassriscosApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'EMPClassRiscos',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(empclassriscosApi.delete(1)).rejects.toThrow(EMPClassRiscosApiError);
    });
  });

  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterEMPClassRiscos = { funcionario: 1 };
      
      const result = empclassriscosApi.useFilter(mockFilter);
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await empclassriscosApi.delete(1);
  ...
  describe('EMPClassRiscosApiError', () => {
    it('should create error with correct properties', () => {
      const error = new EMPClassRiscosApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('EMPClassRiscosApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new EMPClassRiscosApiError('Test message', 500);
