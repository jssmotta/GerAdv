...
// useTipoValorProcessoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoValorProcesso
'use client';
...
interface UseTipoValorProcessoGridProps {
...
export const useTipoValorProcessoGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('tipovalorprocesso-columns-order'), JSON.stringify(reorderableFields));
