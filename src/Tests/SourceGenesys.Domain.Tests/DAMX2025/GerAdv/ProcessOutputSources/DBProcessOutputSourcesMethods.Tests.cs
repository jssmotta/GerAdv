...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProcessOutputSources
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProcessOutputSourcesUpdateAdvancedTests : IDisposable
{
    private readonly DBProcessOutputSources _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProcessOutputSourcesUpdateAdvancedTests()
    {
...
#region Business Logic Tests
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBProcessOutputSources
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBProcessOutputSources).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void Update_AfterMultiplePropertyChanges_ShouldTrackChangesCorrectly()
    {
        ...
        _instance.FNome = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
        _instance.FNome = "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB";
        _instance.FNome = "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCc";
        // Act & Assert
...
#region State Management Tests
    ...
    public void Update_StateManagement_ShouldPreserveInstanceState()
    {
        ...
        // Assert
        _instance.FNome.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProcessOutputSources).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProcessOutputSources instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProcessOutputSources).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProcessOutputSources.PTabelaNome.Should().Be("ProcessOutputSources");
        DBProcessOutputSources.CampoCodigo.Should().Be("posCodigo");
    }
...
#region Integration-like Tests
    ...
    public void Update_CompleteWorkflow_Insert_ShouldExecuteAllSteps()
    {
        ...
        // Assert
        result.Should().Be(null);
        dbRec.FNome.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    public void Update_Boundary_MaxLengthNome()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FNome = new string ('A', 80); // Maximum length
        SetFieldChanged("pFldFNome", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FNome.Length.Should().Be(80);
    }
    ...
    public void Update_ComplexScenario_MultipleChangesInSequence()
    {
        ...
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FNome.Should().Be("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCc");
    }
    ...
    {
        // Arrange
        using var dbRec = new DBProcessOutputSources();
        dbRec.ID = 1;
    ...
    public void Update_WithMaxLengthNome_ShouldBeHandledCorrectly()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FNome = new string ('A', 80); // Max length for Nome
        int? result = null;
        // Act
        var exception = Record.Exception(() => result = _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
...
#region Integration-Style Tests
    ...
    public void Update_Integration_FullCRUDCycle()
    {
        ...
        exception.Should().NotBeNull();
        // UPDATE
        dbRec.FNome = "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB";
        dbRec.ID = 1;
        ...
        dbRec.FNome.Should().Be("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
    }
