...
const TipoProDespositoComboBox: React.FC<DadosSelectProps> = ({
  ...
  const selecItem = (item: ITipoProDesposito) => {
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await tipoprodespositoService.fetchTipoProDespositoById(id);
    ...
    <>
      ...
      {(editRecord || addRecord) && isOpen && (
        <TipoProDespositoWindow
          ...
          selectedTipoProDesposito={
            editRecord || addRecord || TipoProDespositoEmpty()
          }
        />
      )}
      ...
      {cadIsOpen && (
        <EditWindow
          ...
          crud={true}
        >
          <TipoProDespositoPage selectItem={selecItem} noLayout={true} />
        </EditWindow>
      )}
