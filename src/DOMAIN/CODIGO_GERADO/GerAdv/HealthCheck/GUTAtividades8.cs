                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(agtCodigo) FROM {"GUTAtividades".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) agtNome,agtObservacao,agtGUTGrupo,agtGUTPeriodicidade,agtOperador,agtConcluido,agtDataConcluido,agtDiasParaIniciar,agtMinutosParaRealizar,agtGuid FROM {"GUTAtividades".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
