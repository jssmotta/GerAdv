...
export interface ITipoEnderecoSistemaService {
  ...
  filterVoice: (filtro?: FilterTipoEnderecoSistema, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class TipoEnderecoSistemaService implements ITipoEnderecoSistemaService {
  ...
  async filterVoice(filtro?: FilterTipoEnderecoSistema, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
