                ...
                try
                {
                    ...
                    try
                    {
                        if (DBReuniaoDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) renCliente,renIDAgenda,renData,renPauta,renATA,renHoraInicial,renHoraFinal,renExterna,renHoraSaida,renHoraRetorno,renPrincipaisDecisoes,renGUID FROM {"Reuniao".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
