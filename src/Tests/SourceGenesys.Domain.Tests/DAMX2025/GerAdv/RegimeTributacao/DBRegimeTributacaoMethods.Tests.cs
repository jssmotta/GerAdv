...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBRegimeTributacao
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBRegimeTributacaoUpdateAdvancedTests : IDisposable
{
    private readonly DBRegimeTributacao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBRegimeTributacaoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBRegimeTributacao
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBRegimeTributacao).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBRegimeTributacao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBRegimeTributacao instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBRegimeTributacao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBRegimeTributacao.PTabelaNome.Should().Be("RegimeTributacao");
        DBRegimeTributacao.CampoCodigo.Should().Be("rdtCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBRegimeTributacao();
        dbRec.ID = 1;
