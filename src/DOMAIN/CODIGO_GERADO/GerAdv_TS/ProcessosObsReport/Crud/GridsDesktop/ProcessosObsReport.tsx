...
interface ProcessosObsReportGridProps {
  data: IProcessosObsReport[];
  onRowClick: (processosobsreport: IProcessosObsReport) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProcessosObsReportGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProcessosObsReport, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-processosobsreport'
