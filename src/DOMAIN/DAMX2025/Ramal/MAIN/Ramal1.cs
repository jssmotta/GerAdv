...
#region TableDefinition_Ramal
    ...
    public DBRamal(in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBRamal(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
