...
export interface IFuncionariosService {
  ...
  filterVoice: (filtro?: FilterFuncionarios, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class FuncionariosService implements IFuncionariosService {
  ...
  async filterVoice(filtro?: FilterFuncionarios, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
