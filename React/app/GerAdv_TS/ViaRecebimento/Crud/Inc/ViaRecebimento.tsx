...
const ViaRecebimentoInc: React.FC<IViaRecebimentoFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedViaRecebimento =
        await viarecebimentoService.saveViaRecebimento(data);
