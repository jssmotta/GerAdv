                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(cgeCodigo) FROM {"CargosEsc".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) cgePercentual,cgeNome,cgeClassificacao,cgeGuid FROM {"CargosEsc".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
