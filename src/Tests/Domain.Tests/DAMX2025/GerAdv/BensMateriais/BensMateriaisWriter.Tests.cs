...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFBensMateriais.VerifySet(x => x.FDataCompra = DateOnly.Parse(bensmateriais.DataCompra), Times.Once);
        _mockFBensMateriais.VerifySet(x => x.FDataFimDaGarantia = DateOnly.Parse(bensmateriais.DataFimDaGarantia), Times.Once);
        ...
        _mockFBensMateriais.VerifySet(x => x.FDataTerminoDaGarantiaDaLoja = DateOnly.Parse(bensmateriais.DataTerminoDaGarantiaDaLoja), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_DataCompra_ShouldNotSetFDataCompra()
    {
        // Arrange
        var bensmateriais = CreateValidBensMateriaisModel();
        ...
        // Assert
        _mockFBensMateriais.VerifySet(x => x.FDataCompra = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DataFimDaGarantia_ShouldNotSetFDataFimDaGarantia()
    {
        // Arrange
        var bensmateriais = CreateValidBensMateriaisModel();
        ...
        await _bensmateriaisWriter.WriteAsync(bensmateriais, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFBensMateriais.VerifySet(x => x.FDataFimDaGarantia = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DataTerminoDaGarantiaDaLoja_ShouldNotSetFDataTerminoDaGarantiaDaLoja()
    {
        // Arrange
        var bensmateriais = CreateValidBensMateriaisModel();
        ...
        await _bensmateriaisWriter.WriteAsync(bensmateriais, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFBensMateriais.VerifySet(x => x.FDataTerminoDaGarantiaDaLoja = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new BensMateriaisWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.BensMateriais CreateValidBensMateriaisModel()
    {
