...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBOponentesRepLegal
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBOponentesRepLegalUpdateAdvancedTests : IDisposable
{
    private readonly DBOponentesRepLegal _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBOponentesRepLegalUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBOponentesRepLegal
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBOponentesRepLegal).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBOponentesRepLegal).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBOponentesRepLegal instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBOponentesRepLegal).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBOponentesRepLegal.PTabelaNome.Should().Be("OponentesRepLegal");
        DBOponentesRepLegal.CampoCodigo.Should().Be("oprCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBOponentesRepLegal();
        dbRec.ID = 1;
