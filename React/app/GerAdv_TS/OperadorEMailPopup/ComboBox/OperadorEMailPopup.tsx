...
const OperadorEMailPopupComboBox: React.FC<DadosSelectProps> = ({
  ...
  const [editRecord, setEditRecord] = useState<IOperadorEMailPopup | null>(
    null,
  );
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await operadoremailpopupService.fetchOperadorEMailPopupById(id);
  ...
  const handleSuccess = (newOperadorEMailPopup?: IOperadorEMailPopup) => {
    if (newOperadorEMailPopup) {
      setValue({
        id: newOperadorEMailPopup.id,
        nome: newOperadorEMailPopup.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <OperadorEMailPopupWindow
          ...
          selectedOperadorEMailPopup={
            editRecord || addRecord || OperadorEMailPopupEmpty()
          }
        />
      )}
