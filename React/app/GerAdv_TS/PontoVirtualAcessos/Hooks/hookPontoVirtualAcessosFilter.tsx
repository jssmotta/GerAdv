...
interface UsePontoVirtualAcessosFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterPontoVirtualAcessos | undefined | null,
  ) => Promise<void>;
}
...
interface UsePontoVirtualAcessosFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterPontoVirtualAcessos>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterPontoVirtualAcessos>,
  ) => React.ReactNode;
...
export const usePontoVirtualAcessosFilter = ({
  handleFetchWithFilter,
}: UsePontoVirtualAcessosFilterProps): UsePontoVirtualAcessosFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterPontoVirtualAcessos>(
    ...
    <>
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datahora", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datahora_end", value)
        }
      />
