...
public partial interface ITipoOrigemSucumbenciaReader
{
    ...
    Task<IEnumerable<TipoOrigemSucumbenciaResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}