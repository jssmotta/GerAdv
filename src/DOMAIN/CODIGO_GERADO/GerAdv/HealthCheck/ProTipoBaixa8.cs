                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ptxCodigo) FROM {"ProTipoBaixa".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ptxNome,ptxBold,ptxGuid FROM {"ProTipoBaixa".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
