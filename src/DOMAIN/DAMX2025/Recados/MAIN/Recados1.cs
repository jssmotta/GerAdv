...
//public bool CertSignature() => DicionarioDeDadosManagedDatabaseCode.CodeSigntature_DBRecados();
...
#endregion
    public DBRecados(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    // REF. 250325
    public DBRecados(SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
