...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBHorasTrab
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBHorasTrabUpdateAdvancedTests : IDisposable
{
    private readonly DBHorasTrab _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBHorasTrabUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBHorasTrab).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBHorasTrab instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBHorasTrab).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBHorasTrab).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBHorasTrab.PTabelaNome.Should().Be("HorasTrab");
        DBHorasTrab.CampoCodigo.Should().Be("htbCodigo");
    }
