...
interface TerceirosGridProps {
  data: ITerceiros[];
  onRowClick: (terceiros: ITerceiros) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const TerceirosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ITerceiros, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='descricaoposicaooutraspartes' title='Posicao Outras Partes' sortable={false} filterable={false} />, /* Track G.01 */
...
{initialized && (
  ...
  className='grid-desktop-terceiros'
