...
interface RegimeTributacaoGridProps {
  data: IRegimeTributacao[];
  onRowClick: (regimetributacao: IRegimeTributacao) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const RegimeTributacaoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IRegimeTributacao, filters: Record<string, any>) => {
...
const openConsultaClientes = (id: number) => {
  router.push(`/pages/clientes/?regimetributacao=${id}`);
};
...
{initialized && (
  ...
  className='grid-desktop-regimetributacao'
