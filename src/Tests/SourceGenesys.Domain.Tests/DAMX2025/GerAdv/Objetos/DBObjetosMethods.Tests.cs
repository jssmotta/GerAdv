...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBObjetos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBObjetosUpdateAdvancedTests : IDisposable
{
    private readonly DBObjetos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBObjetosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBObjetos
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBObjetos).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBObjetos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBObjetos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBObjetos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBObjetos.PTabelaNome.Should().Be("Objetos");
        DBObjetos.CampoCodigo.Should().Be("ojtCodigo");
    }
