                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ritCodigo) FROM {"Rito".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ritDescricao,ritTop,ritBold,ritGuid FROM {"Rito".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
