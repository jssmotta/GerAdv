...
[Serializable]
public partial record FilterEndTit
{
    ...
    public int Endereco { get; set; } = int.MinValue;

    [JsonPropertyName("endereco_end")]
    public int Endereco_end { get; set; } = int.MinValue;

    [JsonPropertyName("titulo")]
    public int Titulo { get; set; } = int.MinValue;

    [JsonPropertyName("titulo_end")]
    public int Titulo_end { get; set; } = int.MinValue;
