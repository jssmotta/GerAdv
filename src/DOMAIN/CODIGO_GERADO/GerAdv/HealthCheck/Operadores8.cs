                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(operCodigo) FROM {"Operadores".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) operEnviado,operCasa,operCasaID,operCasaCodigo,operIsNovo,operCliente,operGrupo,operNome,operEMail,operSenha,operAtivado,operAtualizarSenha,operSenha256,operSuporteSenha256,operSuporteMaxAge FROM {"Operadores".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
