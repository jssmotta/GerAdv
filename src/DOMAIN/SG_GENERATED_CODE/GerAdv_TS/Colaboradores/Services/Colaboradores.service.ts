...
export interface IColaboradoresService {
  ...
  filterVoice: (filtro?: FilterColaboradores, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ColaboradoresService implements IColaboradoresService {
  ...
  async filterVoice(filtro?: FilterColaboradores, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
