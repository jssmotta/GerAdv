                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(prsCodigo) FROM {"ProResumos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) prsProcesso,prsData,prsResumo,prsTipoResumo,prsBold,prsGuid FROM {"ProResumos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
