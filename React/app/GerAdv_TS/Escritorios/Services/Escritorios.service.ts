...
import { EscritoriosApi, EscritoriosApiError } from "../Apis/EscritoriosApi";
...
export class EscritoriosValidator {
  static validateEscritorios(escritorios: IEscritorios): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IEscritoriosService {
  ...
  validateEscritorios: (escritorios: IEscritorios) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
