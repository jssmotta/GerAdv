...
export const AgendaRelatorioGridDesktopComponent = React.memo(
  ({
    ...
    const [columnsOrder, setColumnsOrder] = useState<string[]>([
      "advnome",
      "pronropastaprocessos",
    ]);

    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("agendarelatorio-columns-order"),
        );
        if (savedOrder) {
    ...
    const basicColumnMap: Record<string, React.ReactElement> = useMemo(
      () => ({
        ...
        pronropastaprocessos: (
          <GridColumn
            key="pronropastaprocessos"
            field="pronropastaprocessos"
            title="Processos"
            sortable={false}
            filterable={false}
          />
      ...
      <>
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-agendarelatorio"
          ...
          >
            <GridToolbar>
              ...
              <PageTitle
                ...
                helpButton={<AgendaRelatorioHelpCrudButton isMobile={false} />}
              />
            </GridToolbar>
            {finalGridColumns}
          </Grid>
