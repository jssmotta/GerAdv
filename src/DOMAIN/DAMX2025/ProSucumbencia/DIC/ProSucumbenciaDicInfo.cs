...
#region PropriedadesDaTabela
    public static DBInfoSystem ScbProcesso => new(0, PTabelaNome, CampoCodigo, Processo, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false); // DBI 11 
    public static DBInfoSystem ScbInstancia => new(0, PTabelaNome, CampoCodigo, Instancia, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBInstanciaDicInfo.CampoCodigo, DBInstanciaDicInfo.TabelaNome, new DBInstanciaODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem ScbQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem ScbQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string TipoOrigemSucumbenciaDiff(int id) => TipoOrigemSucumbencia.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string TipoOrigemSucumbenciaSql(int id) => TipoOrigemSucumbencia.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string TipoOrigemSucumbenciaIsNull => TipoOrigemSucumbencia.SqlCmdIsNull() ?? string.Empty;
    public static string TipoOrigemSucumbenciaNotIsNull => TipoOrigemSucumbencia.SqlCmdNotIsNull() ?? string.Empty;
