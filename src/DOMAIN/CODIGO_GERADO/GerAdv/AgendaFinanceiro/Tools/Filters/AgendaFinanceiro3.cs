...
[Serializable]
public partial record FilterAgendaFinanceiro
{
    ...
    public int PrazoProvisionado { get; set; } = int.MinValue;

    [JsonPropertyName("prazoprovisionado_end")]
    public int PrazoProvisionado_end { get; set; } = int.MinValue;
    ...
    public int RepetirDias { get; set; } = int.MinValue;

    [JsonPropertyName("repetirdias_end")]
    public int RepetirDias_end { get; set; } = int.MinValue;
    ...
    public int Repetir { get; set; } = int.MinValue;

    [JsonPropertyName("repetir_end")]
    public int Repetir_end { get; set; } = int.MinValue;
    ...
    [JsonPropertyName("ddias_end")]
    public string DDias_end { get; set; } = string.Empty;

    [JsonPropertyName("dias")]
    public int Dias { get; set; } = int.MinValue;

    [JsonPropertyName("dias_end")]
    public int Dias_end { get; set; } = int.MinValue;
    ...
    [JsonPropertyName("compromissohtml_end")]
    public string CompromissoHTML_end { get; set; } = string.Empty;
