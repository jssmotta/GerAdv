...
import {
  ITipoCompromisso,
  ITipoCompromissoFormProps,
} from "../../Interfaces/interface.TipoCompromisso";
...
const TipoCompromissoInc: React.FC<ITipoCompromissoFormProps> = ({
  ...
  const { data, handleChange, setData } = useTipoCompromissoForm(
    TipoCompromissoEmpty(),
    tipocompromissoService,
  );

  const originalRef = useRef<ITipoCompromisso>(TipoCompromissoEmpty());
  ...
  const handleLoad = async (loadId: number) => {
    ...
    try {
      let record =
        await tipocompromissoService.fetchTipoCompromissoById(loadId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const savedTipoCompromisso =
        await tipocompromissoService.saveTipoCompromisso(currentRecord);
