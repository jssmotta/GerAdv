...
const TipoStatusBiuGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <TipoStatusBiuGridMobileComponent data={tipostatusbiu} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <TipoStatusBiuGridDesktopComponent data={tipostatusbiu} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
