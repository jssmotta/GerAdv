...
public class FilterGUTAtividadesMatrizWithVoiceRequest
{
    /// <summary>
    /// Filtro de GUTAtividadesMatriz padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterGUTAtividadesMatriz Filter { get; set; } = new();
...
[Serializable]
public partial record FilterGUTAtividadesMatriz
{
    [JsonPropertyName("filterGUTMatriz")]
    [Description("Filtro para a _tabela GUTMatriz")]
    public FilterGUTMatriz? FilterGUTMatriz { get; set; } = new();

    [JsonPropertyName("filterGUTAtividades")]
    [Description("Filtro para a _tabela GUTAtividades")]
    public FilterGUTAtividades? FilterGUTAtividades { get; set; } = new();
    ...
    [Description("GUTMatriz -2147483648 para nada ou id")]
    public int GUTMatriz { get; set; } = int.MinValue;

    [JsonPropertyName("gutmatriz_end")]
    [Description("GUTMatriz -2147483648 para nada ou id para final do intervalo")]
    public int GUTMatriz_end { get; set; } = int.MinValue;

    [JsonPropertyName("gutatividade")]
    [Description("GUTAtividade -2147483648 para nada ou id")]
    public int GUTAtividade { get; set; } = int.MinValue;

    [JsonPropertyName("gutatividade_end")]
    [Description("GUTAtividade -2147483648 para nada ou id para final do intervalo")]
    public int GUTAtividade_end { get; set; } = int.MinValue;
