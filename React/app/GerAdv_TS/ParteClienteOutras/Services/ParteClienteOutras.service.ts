...
export class ParteClienteOutrasService implements IParteClienteOutrasService {
  ...
  async saveParteClienteOutras(parteclienteoutras: IParteClienteOutras): Promise<IParteClienteOutras> {    
   ...
   async getAll(
    filtro?: FilterParteClienteOutras,
    onOnlineData?: (data: IParteClienteOutras[]) => void
  ): Promise<IParteClienteOutras[]> {
    try {
      ...
      if (onOnlineData) {
        ...
        this.api.filter(0, filtro ?? {})
          ...
          .catch(error => {
            console.log('Error fetching online ParteClienteOutras');
          });
      ...
      console.log('Error fetching all ParteClienteOutras:');
      return [];
    }
  }
