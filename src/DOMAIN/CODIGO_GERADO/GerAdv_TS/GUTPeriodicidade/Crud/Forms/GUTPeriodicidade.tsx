...
interface GUTPeriodicidadeFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-GUTPeriodicidade' : 'form-container5 form-container-GUTPeriodicidade'}>
       
            <form className='formInputCadInc' id={`GUTPeriodicidadeForm-${gutperiodicidadeData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={gutperiodicidadeData} isSubmitting={isSubmitting} onClose={onClose} formId={`GUTPeriodicidadeForm-${gutperiodicidadeData.id}`} preventPropagation={true} onSave={handleDirectSave} />
