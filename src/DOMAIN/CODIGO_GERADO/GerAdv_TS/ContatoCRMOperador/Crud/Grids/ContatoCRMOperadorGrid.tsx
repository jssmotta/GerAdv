...
const ContatoCRMOperadorGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ContatoCRMOperadorGridMobileComponent data={contatocrmoperador} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <ContatoCRMOperadorGridDesktopComponent data={contatocrmoperador} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
