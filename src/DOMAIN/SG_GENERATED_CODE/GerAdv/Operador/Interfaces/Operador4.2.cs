...
public partial interface IOperadorReader
{
    ...
    Task<IEnumerable<OperadorResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}