...
#region Helper Methods
    ...
    private void SetAllFieldValues()
    {
        ...
        SetFieldValue("m_FZKeyQuando", DateTime.Today.AddDays(8));
...
#region Fields_All
    ...
    public void ConfigureMethodsLiminarPedida_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        _instancia.FLiminarPedida.Should().Be("");
    ...
    [Fact]
    public void ConfigureUpdateFields_LiminarPedida_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
        ...
        _instancia.FLiminarPedida.Should().Be("");
        _instancia.FStatusResultado.Should().Be(0);
    }
    ...
    public void ConfigureMethodsLiminarResultado_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _instancia.FLiminarResultado.Should().Be("");
        _instancia.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_LiminarResultado_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsNroProcesso_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _instancia.FNroProcesso.Should().Be("");
        _instancia.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_NroProcesso_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    [Fact]
    public void ConfigureUpdateFields_ZKey_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsNroAntigo_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _instancia.FNroAntigo.Should().Be("");
        _instancia.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_NroAntigo_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsAccessCode_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _instancia.FAccessCode.Should().Be("");
        _instancia.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_AccessCode_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    [Fact]
    public void ConfigureUpdateFields_ZKeyIA_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
