...
public class FilterServicosWithVoiceRequest
{
    /// <summary>
    /// Filtro de Servicos padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterServicos Filter { get; set; } = new();
...
public partial record FilterServicos
{
    ...
    [Description("Cobrar -2147483648 para nada; 0 para não, 1 para sim")]
