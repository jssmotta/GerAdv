...
public partial class DBTipoProDesposito : XCodeIdBase, ICadastros
{
#if (DEBUG)
#if (!shadowsDisabled && !shadows_MenphisSI_GerAdv && !shadows_MenphisSI_GerAdv_TipoProDesposito)
#pragma warning disable CA1822 // Mark members as static

//public bool CertSignature() => DicionarioDeDadosManagedDatabaseCode.CodeSigntature_DBTipoProDesposito();
...
#region TableDefinition_TipoProDesposito
    ...
    public DBTipoProDesposito(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        // Tracking: 250605-0
        if (oCnn is null)
            return;
...
#region GravarDados_TipoProDesposito
...
#endif
    {
        ...
        if (pFldFNome)
            clsW.Fields(DBTipoProDespositoDicInfo.Nome, m_FNome, ETiposCampos.FString);
        if (insertId != 0)
            return GravaNewId();
