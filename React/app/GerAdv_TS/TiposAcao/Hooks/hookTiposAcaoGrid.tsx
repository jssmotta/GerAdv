...
// useTiposAcaoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TiposAcao
"use client";
...
interface UseTiposAcaoGridProps {
  data: ITiposAcao[];
...
export const useTiposAcaoGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("tiposacao-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: ITiposAcao, filters: Record<string, any>) => {
