...
// useTipoModeloDocumentoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoModeloDocumento
"use client";
...
interface UseTipoModeloDocumentoGridProps {
...
export const useTipoModeloDocumentoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseTipoModeloDocumentoGridProps) => {
  ...
  const filterLogic = useCallback(
    (data: ITipoModeloDocumento, filters: Record<string, any>) => {
