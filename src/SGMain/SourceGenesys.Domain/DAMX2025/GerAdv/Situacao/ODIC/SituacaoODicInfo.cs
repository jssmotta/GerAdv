...
public partial class DBSituacaoODicInfo : IODicInfo
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldId() => DBSituacaoDicInfo.CampoCodigo;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string ITypeFieldCode() => "int";
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IPrefix() => DBSituacaoDicInfo.TablePrefix;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldNameDescription() => DBSituacaoDicInfo.CampoNome;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBSituacaoDicInfo.SitParte_Int, DBSituacaoDicInfo.SitParte_Opo, DBSituacaoDicInfo.SitTop, DBSituacaoDicInfo.SitBold, DBSituacaoDicInfo.SitGuid];
