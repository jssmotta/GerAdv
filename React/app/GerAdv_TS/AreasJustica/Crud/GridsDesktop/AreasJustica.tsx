...
interface AreasJusticaGridProps {
  data: IAreasJustica[];
  onRowClick: (areasjustica: IAreasJustica) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AreasJusticaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAreasJustica, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-areasjustica'
