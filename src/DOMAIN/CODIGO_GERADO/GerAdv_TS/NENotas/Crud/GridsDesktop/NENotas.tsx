...
interface NENotasGridProps {
  data: INENotas[];
  onRowClick: (nenotas: INENotas) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const NENotasGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: INENotas, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-nenotas'
