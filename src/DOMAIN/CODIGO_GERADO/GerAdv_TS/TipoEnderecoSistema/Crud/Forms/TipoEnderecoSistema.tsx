...
interface TipoEnderecoSistemaFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-TipoEnderecoSistema' : 'form-container5 form-container-TipoEnderecoSistema'}>
       
            <form className='formInputCadInc' id={`TipoEnderecoSistemaForm-${tipoenderecosistemaData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={tipoenderecosistemaData} isSubmitting={isSubmitting} onClose={onClose} formId={`TipoEnderecoSistemaForm-${tipoenderecosistemaData.id}`} preventPropagation={true} onSave={handleDirectSave} />
