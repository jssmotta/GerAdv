...
Instruções para preenchimento do FilterAdvogados:

- O filter irá filtrar os Advogados conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
- filterEscritorios: filtro específico para Escritorios
...
- Se ouvir "todos os Advogados" ou similar, deixe todos os campos com valores padrão;
