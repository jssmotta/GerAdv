...
const BensClassificacaoComboBox: React.FC<DadosSelectProps> = ({
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await bensclassificacaoService.fetchBensClassificacaoById(id);
  ...
  const handleSuccess = (newBensClassificacao?: IBensClassificacao) => {
    if (newBensClassificacao) {
      setValue({
        id: newBensClassificacao.id,
        nome: newBensClassificacao.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <BensClassificacaoWindow
          ...
          selectedBensClassificacao={
            editRecord || addRecord || BensClassificacaoEmpty()
          }
        />
      )}
