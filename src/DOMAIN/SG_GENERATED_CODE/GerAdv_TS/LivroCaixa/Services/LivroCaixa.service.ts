...
export interface ILivroCaixaService {
  ...
  filterVoice: (filtro?: FilterLivroCaixa, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class LivroCaixaService implements ILivroCaixaService {
  ...
  async filterVoice(filtro?: FilterLivroCaixa, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
