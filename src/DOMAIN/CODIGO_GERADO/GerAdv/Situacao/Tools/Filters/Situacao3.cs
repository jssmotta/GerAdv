...
public class FilterSituacaoWithVoiceRequest
{
    /// <summary>
    /// Filtro de Situacao padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterSituacao Filter { get; set; } = new();
