...
export const NENotasForm: React.FC<NENotasFormProps> = ({
  ...
  useEffect(() => {
    ...
    if (el) {
      el.textContent =
        nenotasData?.id == 0 ? "Editar NENotas" : "Adicionar N E Notas";
    }
  }, [nenotasData.id]);
  ...
  return (
    <>
      <div
        className={
          isMobile
            ? "form-container form-container-NENotas"
            : "form-container form-container-NENotas"
        }
      >
        <form
          className="formInputCadInc"
          id={`NENotasForm-${nenotasData.id}`}
          onSubmit={onConfirm}
        >
          {!isMobile && (
            <ButtonSalvarCrud
          ...
          <div className="grid-container">
            ...
            <InputCheckbox
              ...
              label="NotaExpedida"
              name="notaexpedida"
              checked={nenotasData.notaexpedida}
              onChange={onChange}
            />
            <InputCheckbox
              dataForm={nenotasData}
        ...
        <FooterIncDocker>
          <CopyButton formId={`NENotasForm-${nenotasData.id}`} />

          <PrintButton formId={`NENotasForm-${nenotasData.id}`} />
