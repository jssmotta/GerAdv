...
#region PropriedadesDaTabela
    public static DBInfoSystem Ap2Processo => new(0, PTabelaNome, CampoCodigo, Processo, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem Ap2QuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem Ap2QuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string ApensadoDiff(int id) => Apensado.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string ApensadoSql(int id) => Apensado.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string ApensadoIsNull => Apensado.SqlCmdIsNull() ?? string.Empty;
    public static string ApensadoNotIsNull => Apensado.SqlCmdNotIsNull() ?? string.Empty;
