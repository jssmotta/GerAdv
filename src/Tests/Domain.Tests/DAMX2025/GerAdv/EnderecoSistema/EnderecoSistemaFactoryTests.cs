...
public class FEnderecoSistemaFactoryTests : IDisposable
{
    private FEnderecoSistemaFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FEnderecoSistemaFactoryTests()
    {
        _factory = new FEnderecoSistemaFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FEnderecoSistema>();
    }
    ...
    {
        // Arrange
        var factory = new FEnderecoSistemaFactory();
        // Act
        factory.Dispose();
