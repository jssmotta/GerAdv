...
public partial class DBTerceiros : VSexo, ICadastrosAuditor, IAuditor
{
...
#endregion
    public DBTerceiros(in int nCodigo, MsiSqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
