...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBCargosEsc
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBCargosEscUpdateAdvancedTests : IDisposable
{
    private readonly DBCargosEsc _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBCargosEscUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBCargosEsc
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBCargosEsc).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBCargosEsc).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBCargosEsc instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBCargosEsc).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBCargosEsc.PTabelaNome.Should().Be("CargosEsc");
        DBCargosEsc.CampoCodigo.Should().Be("cgeCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBCargosEsc();
        dbRec.ID = 1;
