...
// useGUTAtividadesMatrizGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GUTAtividadesMatriz
"use client";
...
interface UseGUTAtividadesMatrizGridProps {
...
export const useGUTAtividadesMatrizGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IGUTAtividadesMatriz, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
