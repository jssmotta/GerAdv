...
const ProTipoBaixaGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ProTipoBaixaGridMobileComponent data={protipobaixa} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <ProTipoBaixaGridDesktopComponent data={protipobaixa} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
