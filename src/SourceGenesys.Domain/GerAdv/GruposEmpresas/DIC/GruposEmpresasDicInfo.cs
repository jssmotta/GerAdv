...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem GrpGUID => new(0, PTabelaNome, CampoCodigo, GUID, 100, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "grp"
    };
