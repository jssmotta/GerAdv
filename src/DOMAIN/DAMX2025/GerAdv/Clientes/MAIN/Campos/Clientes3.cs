...
public partial class DBClientes
{
    ...
    [XmlIgnore]
    private protected string? m_FIcone, m_FNomeMae, m_FQuemIndicou, m_FNome, m_FNomeFantasia, m_FClass, m_FInscEst, m_FQualificacao, m_FCNPJ, m_FCPF, m_FRG, m_FObservacao, m_FEndereco, m_FBairro, m_FCEP, m_FFax, m_FFone, m_FHomePage, m_FEMail, m_FNomePai, m_FRGOExpeditor, m_FCNH, m_FPessoaContato;
    [XmlIgnore]
