...
interface UseSetorFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterSetor | undefined | null,
  ) => Promise<void>;
}
...
interface UseSetorFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterSetor>,
  ) => React.ReactNode;
...
export const useSetorFilter = ({
  handleFetchWithFilter,
}: UseSetorFilterProps): UseSetorFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterSetor>(
    {} as FilterSetor,
  );
