...
public partial interface IUFReader
{
    ...
    Task<IEnumerable<UFResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}