                ...
                try
                {
                    ...
                    try
                    {
                        if (DBFornecedoresDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) forGrupo,forNome,forSubGrupo,forTipo,forSexo,forCNPJ,forInscEst,forCPF,forRG,forEndereco,forBairro,forCEP,forCidade,forFone,forFax,forEmail,forSite,forObs,forProdutos,forContatos,forGUID FROM {"Fornecedores".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
