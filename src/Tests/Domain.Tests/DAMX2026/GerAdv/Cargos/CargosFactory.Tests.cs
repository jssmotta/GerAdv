...
public class FCargosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FCargos>();
    }
    ...
    {
        // Arrange
        var factory = new FCargosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("carCodigo", typeof(int));
        mockDataTable.Columns.Add("carNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["carCodigo"] = testId;
        row["carNome"] = "Test Cargos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["carCodigo"] = 123;
        row["carNome"] = "Test Cargos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FCargos properties
        }
    }
