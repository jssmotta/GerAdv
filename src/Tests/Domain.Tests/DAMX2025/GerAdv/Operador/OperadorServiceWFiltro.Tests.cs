...
public class OperadorServiceWFiltroTests : IDisposable
{
    ...
    private readonly Mock<IGenericVoiceFilterService<Filters.FilterOperador>> _mockVoiceFilterService;
    ...
    public OperadorServiceWFiltroTests()
    {
        ...
        _mockVoiceFilterService = new Mock<IGenericVoiceFilterService<Filters.FilterOperador>>();
...
#region Computador Filter Tests
    ...
    public void WFiltro_ComputadorWithOtherFilters_ShouldIncludeLogicalOperatorInWhereClause()
    {
        ...
        var filtro = new FilterOperador
        {
            Pasta = "Pasta", // Campo string para testar combinação
            Computador = 1,
            LogicalOperator = " AND "
        };
        // Act
