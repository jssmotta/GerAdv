...
public class FPoderJudiciarioAssociadoFactoryTests : IDisposable
{
    private FPoderJudiciarioAssociadoFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FPoderJudiciarioAssociadoFactoryTests()
    {
        _factory = new FPoderJudiciarioAssociadoFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FPoderJudiciarioAssociado>();
    }
    ...
    {
        // Arrange
        var factory = new FPoderJudiciarioAssociadoFactory();
        // Act
        factory.Dispose();
