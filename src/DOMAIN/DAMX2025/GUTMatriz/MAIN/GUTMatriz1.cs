...
#region TableDefinition_GUTMatriz
...
#endregion
    public DBGUTMatriz(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBGUTMatriz(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBGUTMatriz(in string? sqlWhere, SqlConnection? oCnn)
    {
