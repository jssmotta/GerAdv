                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(pgsCodigo) FROM {"GUTPeriodicidadeStatus".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) pgsGUTAtividade,pgsDataRealizado,pgsGuid FROM {"GUTPeriodicidadeStatus".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
