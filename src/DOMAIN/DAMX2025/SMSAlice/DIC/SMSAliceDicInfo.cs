...
#region PropriedadesDaTabela
    public static DBInfoSystem SmaOperador => new(0, PTabelaNome, CampoCodigo, Operador, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem SmaTipoEMail => new(0, PTabelaNome, CampoCodigo, TipoEMail, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBTipoEMailDicInfo.CampoCodigo, DBTipoEMailDicInfo.TabelaNome, new DBTipoEMailODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem SmaQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem SmaQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string TipoEMailDiff(int id) => TipoEMail.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string TipoEMailSql(int id) => TipoEMail.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string TipoEMailIsNull => TipoEMail.SqlCmdIsNull() ?? string.Empty;
    public static string TipoEMailNotIsNull => TipoEMail.SqlCmdNotIsNull() ?? string.Empty;
