...
interface UseNEPalavrasChavesFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterNEPalavrasChaves | undefined | null,
  ) => Promise<void>;
}
...
interface UseNEPalavrasChavesFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterNEPalavrasChaves>,
  ) => React.ReactNode;
...
export const useNEPalavrasChavesFilter = ({
  handleFetchWithFilter,
}: UseNEPalavrasChavesFilterProps): UseNEPalavrasChavesFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterNEPalavrasChaves>(
