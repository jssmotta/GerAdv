...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBEventoPrazoAgenda
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBEventoPrazoAgendaUpdateAdvancedTests : IDisposable
{
    private readonly DBEventoPrazoAgenda _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBEventoPrazoAgendaUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBEventoPrazoAgenda
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBEventoPrazoAgenda).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBEventoPrazoAgenda).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBEventoPrazoAgenda instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBEventoPrazoAgenda).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBEventoPrazoAgenda.PTabelaNome.Should().Be("EventoPrazoAgenda");
        DBEventoPrazoAgenda.CampoCodigo.Should().Be("epaCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBEventoPrazoAgenda();
        dbRec.ID = 1;
