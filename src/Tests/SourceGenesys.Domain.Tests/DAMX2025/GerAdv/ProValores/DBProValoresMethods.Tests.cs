...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProValores
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProValoresUpdateAdvancedTests : IDisposable
{
    private readonly DBProValores _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProValoresUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProValores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProValores instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProValores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBProValores).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProValores.PTabelaNome.Should().Be("ProValores");
        DBProValores.CampoCodigo.Should().Be("prvCodigo");
    }
