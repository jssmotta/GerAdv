...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem CidUF => new(0, PTabelaNome, CampoCodigo, UF, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBUFDicInfo.CampoCodigo, DBUFDicInfo.TabelaNome, new DBUFODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem CidQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem CidQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string UFDiff(int id) => UF.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string UFSql(int id) => UF.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string UFIsNull => UF.SqlCmdIsNull() ?? string.Empty;
    public static string UFNotIsNull => UF.SqlCmdNotIsNull() ?? string.Empty;
