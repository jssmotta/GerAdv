...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBDiario2
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBDiario2UpdateAdvancedTests : IDisposable
{
    private readonly DBDiario2 _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBDiario2UpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBDiario2).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBDiario2 instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBDiario2).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBDiario2).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBDiario2.PTabelaNome.Should().Be("Diario2");
        DBDiario2.CampoCodigo.Should().Be("diaCodigo");
    }
