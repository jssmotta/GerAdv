...
interface UseEMPClassRiscosFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterEMPClassRiscos | undefined | null,
  ) => Promise<void>;
}
...
interface UseEMPClassRiscosFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterEMPClassRiscos>,
  ) => React.ReactNode;
...
export const useEMPClassRiscosFilter = ({
  handleFetchWithFilter,
}: UseEMPClassRiscosFilterProps): UseEMPClassRiscosFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterEMPClassRiscos>(
