                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ecrCodigo) FROM {"EMPClassRiscos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ecrNome,ecrBold,ecrGuid FROM {"EMPClassRiscos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
