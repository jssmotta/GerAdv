...
// useOperadorGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Operador
"use client";
...
interface UseOperadorGridProps {
  data: IOperador[];
...
export const useOperadorGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IOperador, filters: Record<string, any>) => {
