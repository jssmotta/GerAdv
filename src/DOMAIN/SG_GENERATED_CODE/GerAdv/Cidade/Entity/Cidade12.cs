...
public partial class FCidade : MenphisSI.SG.GerAdv.DBCidade, IDBCidade
{
    ...
    public static FCidade CreateFromReader(SqlDataReader? dbRec)
    {
        return new FCidade(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FCidade CreateFromDataRow(DataRow? dbRec)
    {
        return new FCidade(dbRec);
    }

    private FCidade(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FCidade(DataRow? dbRec) : base(dbRec)
    {
    }

    private FCidade(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FCidade CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FCidade(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FCidade> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fCidade = new FCidade();
        await fCidade.CarregarAsync(id, oCnn);
        return fCidade;
    }
