...
public class FPreClientesFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FPreClientes>();
    }
    ...
    {
        // Arrange
        var factory = new FPreClientesFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("cliCodigo", typeof(int));
        mockDataTable.Columns.Add("cliNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["cliCodigo"] = testId;
        row["cliNome"] = "Test PreClientes";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["cliCodigo"] = 123;
        row["cliNome"] = "Test PreClientes Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FPreClientes properties
        }
    }
