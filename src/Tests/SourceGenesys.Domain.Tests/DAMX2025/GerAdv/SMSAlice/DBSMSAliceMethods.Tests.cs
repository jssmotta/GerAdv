...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBSMSAlice
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBSMSAliceUpdateAdvancedTests : IDisposable
{
    private readonly DBSMSAlice _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBSMSAliceUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBSMSAlice
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBSMSAlice).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBSMSAlice).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBSMSAlice instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBSMSAlice).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBSMSAlice.PTabelaNome.Should().Be("SMSAlice");
        DBSMSAlice.CampoCodigo.Should().Be("smaCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBSMSAlice();
        dbRec.ID = 1;
