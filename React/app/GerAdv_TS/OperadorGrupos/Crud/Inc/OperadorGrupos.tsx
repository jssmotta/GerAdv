...
const OperadorGruposInc: React.FC<IOperadorGruposFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedOperadorGrupos =
        await operadorgruposService.saveOperadorGrupos(data);
