...
const CargosEscClassInc: React.FC<ICargosEscClassFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedCargosEscClass =
        await cargosescclassService.saveCargosEscClass(data);
