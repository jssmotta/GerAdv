...
const ViaRecebimentoGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ViaRecebimentoGridMobileComponent data={viarecebimento} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <ViaRecebimentoGridDesktopComponent data={viarecebimento} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
