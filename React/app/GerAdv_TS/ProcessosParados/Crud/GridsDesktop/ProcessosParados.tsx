...
interface ProcessosParadosGridProps {
  data: IProcessosParados[];
  onRowClick: (processosparados: IProcessosParados) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProcessosParadosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProcessosParados, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-processosparados'
