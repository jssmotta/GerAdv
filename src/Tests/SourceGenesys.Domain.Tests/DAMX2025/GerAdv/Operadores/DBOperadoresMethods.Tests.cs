...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBOperadores
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBOperadoresUpdateAdvancedTests : IDisposable
{
    private readonly DBOperadores _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBOperadoresUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBOperadores
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBOperadores).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBOperadores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBOperadores instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBOperadores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBOperadores.PTabelaNome.Should().Be("Operadores");
        DBOperadores.CampoCodigo.Should().Be("operCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBOperadores();
        dbRec.ID = 1;
