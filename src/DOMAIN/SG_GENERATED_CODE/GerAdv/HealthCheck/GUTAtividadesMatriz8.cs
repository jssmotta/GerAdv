                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(amgCodigo) FROM {"GUTAtividadesMatriz".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) amgGUTMatriz,amgGUTAtividade,amgGuid FROM {"GUTAtividadesMatriz".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
