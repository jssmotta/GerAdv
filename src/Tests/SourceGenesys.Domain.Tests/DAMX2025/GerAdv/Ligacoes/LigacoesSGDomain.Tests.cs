...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FDataRealizada = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataRealizada?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBLigacoes();
        Assert.Equal(null !, instance.FDataRealizada);
    }
    ...
    {
        _instance.FUltimoAviso = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FUltimoAviso?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBLigacoes();
        Assert.Equal(null !, instance.FUltimoAviso);
    }
