...
export class HorasTrabValidator {
  static validateHorasTrab(horastrab: IHorasTrab): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IHorasTrabService {
  ...
  validateHorasTrab: (horastrab: IHorasTrab) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
