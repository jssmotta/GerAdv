...
export const PaisesGridDesktopComponent: React.FC<PaisesGridProps> = ({
	data,
	onRowClick,
	onDeleteClick
}) => {
...
const EditarCellUF = (props: any) => {
    return (
      <>
        <td>
            <div onClick={() => openConsultaUF(props.dataItem.id)}><img width='16' height='16' src='https://cdn.menphis.com.br/msi/v20/editar.webp' title='Editar UF' />&nbsp;</div>
        </td>
      </>
    );
};
