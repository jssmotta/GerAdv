...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBGUTAtividades
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBGUTAtividadesUpdateAdvancedTests : IDisposable
{
    private readonly DBGUTAtividades _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBGUTAtividadesUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBGUTAtividades
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBGUTAtividades).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBGUTAtividades).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBGUTAtividades instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBGUTAtividades).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBGUTAtividades.PTabelaNome.Should().Be("GUTAtividades");
        DBGUTAtividades.CampoCodigo.Should().Be("agtCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBGUTAtividades();
        dbRec.ID = 1;
