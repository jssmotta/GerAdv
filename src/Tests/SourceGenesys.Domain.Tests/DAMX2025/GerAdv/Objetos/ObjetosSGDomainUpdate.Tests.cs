...
public class DBObjetosUpdate : IDisposable
{
    private readonly DBObjetos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBObjetosUpdate()
    {
    ...
    {
        // Act
        var objetos = new DBObjetos();
        // Assert
        objetos.Should().NotBeNull();
        objetos.ITableName().Should().Be("Objetos");
        objetos.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set objetos.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        objetos.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        objetos.FNome = longString; // MAX: 255
        objetos.FGuid = longString; // MAX: 100
        // Assert - All properties should be set objetos.FNome.Should().HaveLength(255);
        objetos.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        objetos.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "ojtCodigo = 1";
        // Act & Assert
        var Objetos = new DBObjetos(sqlWhere, null);
        Objetos.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var objetos = new DBObjetos(parameters, nome, null);
        // Assert
        objetos.Should().NotBeNull();
        objetos.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        objetos.FNome = longName;
        // Assert
        objetos.FNome.Should().HaveLength(255);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBObjetos).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var objetos = new DBObjetos();
        // Act & Assert
        objetos.TabelaNome.Should().Be("Objetos");
    }
