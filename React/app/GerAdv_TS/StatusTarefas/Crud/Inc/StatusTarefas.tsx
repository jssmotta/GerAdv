...
const StatusTarefasInc: React.FC<IStatusTarefasFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedStatusTarefas =
        await statustarefasService.saveStatusTarefas(data);
