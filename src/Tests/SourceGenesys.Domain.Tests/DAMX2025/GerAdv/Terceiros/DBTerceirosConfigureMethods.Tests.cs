...
#region Fields_All
    ...
    public void ConfigureUpdateFields_Nome_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        _terceiros.FNome.Should().Be("");
        _terceiros.FProcesso.Should().Be(0);
    }
    ...
    public void ConfigureMethodsEndereco_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _terceiros.FEndereco.Should().Be("");
        _terceiros.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsVaraForoComarca_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _terceiros.FVaraForoComarca.Should().Be("");
        _terceiros.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_VaraForoComarca_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
