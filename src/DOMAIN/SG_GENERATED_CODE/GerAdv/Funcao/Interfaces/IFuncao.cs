...
{
    Task<IEnumerable<FuncaoResponseAll>> Filter([FromQuery] int max, [FromBody] Filters.FilterFuncao filter, [FromRoute, Required] string uri = "");
    Task<Filters.FilterFuncao> FilterVoice([FromBody] Filters.FilterFuncao filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
