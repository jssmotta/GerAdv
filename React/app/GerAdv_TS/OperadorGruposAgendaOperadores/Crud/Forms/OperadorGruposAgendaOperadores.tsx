...
const addValorOperadorGruposAgenda = (e: any) => {
  if (e?.id>0)
    onChange({ target: { name: 'operadorgruposagenda', value: e.id } });
  };
  const addValorOperador = (e: any) => {
    ...
    const onConfirm = (e: React.FormEvent) => {
      ...
      if (e.stopPropagation) e.stopPropagation();
        ...
        if (!isSubmitting) {
          ...
          console.log('Erro ao submeter formulário de OperadorGruposAgendaOperadores:');
    ...
    const handleDirectSave = () => {
      if (!isSubmitting) {
        ...
        console.log('Erro ao salvar OperadorGruposAgendaOperadores diretamente');
        setIsSubmitting(false);
        if (onError) onError();
        }
      }
