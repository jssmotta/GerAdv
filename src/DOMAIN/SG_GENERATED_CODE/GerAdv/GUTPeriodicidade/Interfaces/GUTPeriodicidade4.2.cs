...
public partial interface IGUTPeriodicidadeReader
{
    ...
    Task<IEnumerable<GUTPeriodicidadeResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}