...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTipoCompromisso
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTipoCompromissoUpdateAdvancedTests : IDisposable
{
    private readonly DBTipoCompromisso _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoCompromissoUpdateAdvancedTests()
    {
...
#region Business Logic Tests
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTipoCompromisso
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBTipoCompromisso).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void Update_AfterMultiplePropertyChanges_ShouldTrackChangesCorrectly()
    {
        ...
        _instance.FDescricao = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
        _instance.FDescricao = "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB";
        _instance.FDescricao = "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCc";
        // Act & Assert
...
#region State Management Tests
    ...
    public void Update_StateManagement_ShouldPreserveInstanceState()
    {
        ...
        // Assert
        _instance.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTipoCompromisso).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTipoCompromisso instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTipoCompromisso).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTipoCompromisso.PTabelaNome.Should().Be("TipoCompromisso");
        DBTipoCompromisso.CampoCodigo.Should().Be("tipCodigo");
    }
...
#region Integration-like Tests
    ...
    public void Update_CompleteWorkflow_Insert_ShouldExecuteAllSteps()
    {
        ...
        // Assert
        result.Should().Be(null);
        dbRec.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    public void Update_Boundary_MaxLengthDescricao()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FDescricao = new string ('A', 100); // Maximum length
        SetFieldChanged("pFldFDescricao", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FDescricao.Length.Should().Be(100);
    }
    ...
    public void Update_ComplexScenario_MultipleChangesInSequence()
    {
        ...
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FDescricao.Should().Be("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCc");
    }
    ...
    {
        // Arrange
        using var dbRec = new DBTipoCompromisso();
        dbRec.ID = 1;
    ...
    public void Update_WithMaxLengthDescricao_ShouldBeHandledCorrectly()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FDescricao = new string ('A', 100); // Max length for Descricao
        int? result = null;
        // Act
        var exception = Record.Exception(() => result = _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
...
#region Integration-Style Tests
    ...
    public void Update_Integration_FullCRUDCycle()
    {
        ...
        exception.Should().NotBeNull();
        // UPDATE
        dbRec.FDescricao = "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB";
        dbRec.ID = 1;
        ...
        dbRec.FDescricao.Should().Be("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
    }
