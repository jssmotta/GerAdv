...
interface UseTipoEnderecoSistemaFilterProps {
    handleFetchWithFilter: (filtro?: FilterTipoEnderecoSistema | undefined | null) => Promise<void>;
}
...
interface UseTipoEnderecoSistemaFilterReturn {
    ...
    setWindowFilter: React.Dispatch<React.SetStateAction<FilterTipoEnderecoSistema>>;
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterTipoEnderecoSistema>) => React.ReactNode;
...
export const useTipoEnderecoSistemaFilter = ({ handleFetchWithFilter }: UseTipoEnderecoSistemaFilterProps): UseTipoEnderecoSistemaFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterTipoEnderecoSistema>({} as FilterTipoEnderecoSistema);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterTipoEnderecoSistema;
    ...
    const renderInputFilters = (handlers: FilterHandlers<FilterTipoEnderecoSistema>) => (        
        <>
        <InputInput
                        type='text'
                        id='nome'
