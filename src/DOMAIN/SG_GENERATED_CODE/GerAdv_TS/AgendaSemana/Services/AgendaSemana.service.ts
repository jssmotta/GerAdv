...
export interface IAgendaSemanaService {
  ...
  filterVoice: (filtro?: FilterAgendaSemana, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class AgendaSemanaService implements IAgendaSemanaService {
  ...
  async filterVoice(filtro?: FilterAgendaSemana, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
