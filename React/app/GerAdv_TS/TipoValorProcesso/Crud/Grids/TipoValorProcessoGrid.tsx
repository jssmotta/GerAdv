...
const {
  ...
  fetchData, 
  refreshData
} = useTipoValorProcessoList(tipovalorprocessoService);
...
const handleFetchWithFilter = async (filtro?: FilterTipoValorProcesso | undefined | null) => {
  setCurrFilter(filtro);
  await fetchData(filtro ?? {} as FilterTipoValorProcesso);
};
