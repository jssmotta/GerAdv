...
// useLigacoesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Ligacoes
"use client";
...
interface UseLigacoesGridProps {
  data: ILigacoes[];
...
export const useLigacoesGrid = ({
  ...
  const filterLogic = useCallback(
    (data: ILigacoes, filters: Record<string, any>) => {
