...
public class DBDocumentosUpdate : IDisposable
{
    ...
    public void DefaultConstructor_ShouldCreateInstance_WithDefaultValues()
    {
        ...
        documentos.ITableName().Should().Be("Documentos");
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set documentos.FObservacao.Should().Be( "");
        documentos.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
