...
interface DocsRecebidosItensGridProps {
  data: IDocsRecebidosItens[];
  onRowClick: (docsrecebidositens: IDocsRecebidosItens) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const DocsRecebidosItensGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IDocsRecebidosItens, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-docsrecebidositens'
