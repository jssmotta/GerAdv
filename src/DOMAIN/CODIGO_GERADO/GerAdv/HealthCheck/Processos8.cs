                ...
                try
                {
                    ...
                    try
                    {
                        if (DBProcessosDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(proCodigo) FROM {"Processos".dbo(connection)};";
