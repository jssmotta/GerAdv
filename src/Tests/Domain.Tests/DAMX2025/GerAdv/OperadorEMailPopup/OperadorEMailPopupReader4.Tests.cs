...
public class OperadorEMailPopupReaderTests : IDisposable
{
    ...
    public OperadorEMailPopupReaderTests(ITestOutputHelper output)
    {
        _output = output;
        ...
        _operadoremailpopupReader = new OperadorEMailPopupReader(_mockOperadorEMailPopupFactory.Object); //, _mockConnectionService.Object);
    }
...
#region Tests Generics
    ...
    public void Read_WhenWhereIsNullOrEmptyOrWhitespace_ReturnsNull(string? where)
    {
        ...
        _mockOperadorEMailPopupFactory.Setup(f => f.CreateFromParameters(It.IsAny<List<SqlParameter>?>(), It.IsAny<MsiSqlConnection?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string>(), It.IsAny<string>())).Returns(new FOperadorEMailPopup { ID = 0, FNome = null });
        // Act
        var result = _operadoremailpopupReader.Read(where!, null, null);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FOperadorEMailPopup_NullInput_ReturnsNull()
    {
        // Act
        var result = _operadoremailpopupReader.Read((FOperadorEMailPopup)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FOperadorEMailPopup_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
    ...
    [Fact]
    public void Read_DBOperadorEMailPopup_NullInput_ReturnsNull()
    {
        // Act
        var result = _operadoremailpopupReader.Read((SG.GerAdv.DBOperadorEMailPopup)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_DBOperadorEMailPopup_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBOperadorEMailPopup
        {
            ID = 20,
            FNome = null
        };
    ...
    [Fact]
    public void ReadAll_FOperadorEMailPopup_NullInput_ReturnsNull()
    {
        // Act
        var result = _operadoremailpopupReader.ReadAll((FOperadorEMailPopup)null !, (IDataRecord)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_FOperadorEMailPopup_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
        var dbRec = new FOperadorEMailPopup
        {
        ...
        // Act
        var result = _operadoremailpopupReader.ReadAll(dbRec, (IDataRecord)new Mock<IDataRecord>().Object);
        // Assert
        result.Should().NotBeNull();
    ...
    [Fact]
    public void ReadAll_DBOperadorEMailPopup_NullInput_ReturnsNull()
    {
        // Act
        var result = _operadoremailpopupReader.ReadAll((SG.GerAdv.DBOperadorEMailPopup)null !, (DataRow)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_DBOperadorEMailPopup_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBOperadorEMailPopup
        {
        ...
        // Act
        var result = _operadoremailpopupReader.ReadAll(dbRec, (DataRow)null !);
        // Assert
        result.Should().NotBeNull();
...
#region ListarN Tests
    ...
    public async Task ListarN_WithValidParameters_ShouldReturnResults()
    {
        ...
        try
        {
            var result = await _operadoremailpopupReader.ListarNAsync(max, uri, cWhere, parameters, order);
    ...
    public async Task ListarN_WithEmptyParameters_ShouldThrowInvalidOperationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => _operadoremailpopupReader.ListarNAsync(max, uri, cWhere, parameters, order));
    }
...
#region Read Tests with ID and Connection
    ...
    public async Task Read_WithValidId_ShouldReturnOperadorEMailPopupResponse()
    {
        ...
        // Act
        var result = await _operadoremailpopupReader.ReadAsync(id, _mockConnection.Object);
        // Assert
        result.Should().NotBeNull();
...
#region ReadM Tests
    ...
    public async Task ReadM_WithValidId_ShouldReturnOperadorEMailPopupModel()
    {
        ...
        // Act
        var result = await _operadoremailpopupReader.ReadMAsync(id, _mockConnection.Object);
        // Assert
        result.Should().NotBeNull();
        result?.Id.Should().Be(id);
        result?.Nome.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
#region Edge Cases and Error Handling Tests
    ...
    public async Task Read_WithFactoryException_ShouldPropagateException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() => _operadoremailpopupReader.ReadAsync(id, _mockConnection.Object));
    ...
    public async Task ReadM_WithFactoryException_ShouldPropagateException()
    {
        ...
        _mockOperadorEMailPopupFactory.Setup(x => x.CreateFromIdAsync(id, _mockConnection.Object)).ThrowsAsync(expectedException);
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() => _operadoremailpopupReader.ReadMAsync(id, _mockConnection.Object));
        exception.Should().Be(expectedException);
    }
...
#region Async Behavior Tests
    ...
    public async Task AsyncMethods_ShouldCompleteWithoutBlocking()
    {
        ...
        var readTask = _operadoremailpopupReader.ReadAsync(id, _mockConnection.Object);
        var readMTask = _operadoremailpopupReader.ReadMAsync(id, _mockConnection.Object);
...
#region Parameter Validation Tests
    ...
    public async Task Read_WithNullConnection_ShouldHandleGracefully()
    {
        ...
        try
        {
            await _operadoremailpopupReader.ReadAsync(id, null !);
        }
        catch (Exception ex)
        {
            ex.Should().NotBeNull();
    ...
    public async Task ReadM_WithNullConnection_ShouldHandleGracefully()
    {
        ...
        try
        {
            await _operadoremailpopupReader.ReadMAsync(id, null !);
        }
        catch (Exception ex)
        {
            ex.Should().NotBeNull();
