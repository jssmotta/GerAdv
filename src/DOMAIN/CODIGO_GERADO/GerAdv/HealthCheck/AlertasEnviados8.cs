                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAlertasEnviadosDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(aloCodigo) FROM {"AlertasEnviados".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) aloOperador,aloAlerta,aloDataAlertado,aloVisualizado FROM {"AlertasEnviados".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
