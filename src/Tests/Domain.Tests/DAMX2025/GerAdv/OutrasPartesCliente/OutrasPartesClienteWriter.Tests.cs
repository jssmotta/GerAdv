...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFOutrasPartesCliente.VerifySet(x => x.FDtNasc = DateOnly.Parse(outraspartescliente.DtNasc), Times.Once);
    ...
    public async Task WriteAsync_WithNull_DtNasc_ShouldNotSetFDtNasc()
    {
        ...
        // Assert
        _mockFOutrasPartesCliente.VerifySet(x => x.FDtNasc = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new OutrasPartesClienteWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.OutrasPartesCliente CreateValidOutrasPartesClienteModel()
    {
