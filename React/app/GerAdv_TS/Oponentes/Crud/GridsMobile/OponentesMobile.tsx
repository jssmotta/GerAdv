...
import OponentesHelpCrudButton from "../../Help/OponentesHelpCrudButton";
  ...
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("oponentes-columns-order-mobile"),
        );
        if (savedOrder) {
    ...
    useEffect(() => {
      const cleanup = useIOSScrollFallback({
        scrollSelector:
          ".grid-mobile-crud.grid-mobile-oponentes .k-grid-content",
        waitForDOM: true,
        retryDelay: 100,
      ...
      <>
        {initialized && (
          <>
            <PageTitle
              title="Oponentes"
              helpButton={<OponentesHelpCrudButton isMobile={true} />}
            />
                ...
                <>
                  ...
                  {typeView === "grid" && (
                    <Grid
                      ...
                      onRowClick={(e) => {
                        if (selectItem) {
                          selectItem(e.dataItem as IOponentes);
