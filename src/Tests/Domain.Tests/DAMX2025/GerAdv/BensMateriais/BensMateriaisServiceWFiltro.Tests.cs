...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class BensMateriaisServiceWFiltroTests : IDisposable
    {
        ...
        private readonly BensMateriaisServiceS _serviceS;
        public BensMateriaisServiceWFiltroTests()
        {
            ...
            _serviceS = new BensMateriaisServiceS();
...
#region String Tests
        ...
        public void WFiltro_GuidBensMateriais_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBBensMateriais.CampoCodigo}");
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemCad}] = @{DBBensMateriaisDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBBensMateriaisDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.QuemCad} BETWEEN @{DBBensMateriaisDicInfo.QuemCad} AND @{DBBensMateriaisDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBBensMateriaisDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBBensMateriaisDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.QuemCad} BETWEEN @{DBBensMateriaisDicInfo.QuemCad} AND @{DBBensMateriaisDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemCad}] = @{DBBensMateriaisDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemCad}] = @bmtQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@bmtQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@bmtQuemCad");
            resultado.Value.where.Should().Contain($"@{DBBensMateriaisDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemAtu}] = @{DBBensMateriaisDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBBensMateriaisDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.QuemAtu} BETWEEN @{DBBensMateriaisDicInfo.QuemAtu} AND @{DBBensMateriaisDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBBensMateriaisDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBBensMateriaisDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.QuemAtu} BETWEEN @{DBBensMateriaisDicInfo.QuemAtu} AND @{DBBensMateriaisDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemAtu}] = @{DBBensMateriaisDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.QuemAtu}] = @bmtQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@bmtQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@bmtQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBBensMateriaisDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.ValorBem_end Tests
        ...
        public void WFiltro_ValorBem_end_QuandoDecimalMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterBensMateriais
            {
                ValorBem_end = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorBem_end_QuandoTemValorPositivo_SemValorBemInicial_DeveAdicionarParametroMasNaoCondicionaWhere()
        {
            ...
            var filtro = new FilterBensMateriais
            {
                ValorBem = int.MinValue, // Não define salário inicial
        ...
        public void WFiltro_ValorBem_end_QuandoSomenteValorInicial_SemValorBemEnd_DeveUsarOperadorIgualdade()
        {
            ...
            var filtro = new FilterBensMateriais
            {
                ...
                ValorBem_end = int.MinValue, // Não define salário final
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorBem_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Assert
            resultado.Should().NotBeNull();
            // Verifica a lógica exata: !(filtro.ValorBem == int.MinValue) && !(filtro.ValorBem_end == int.MinValue)
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
...
#region filtro.ValorBem Isolated Tests
        ...
        public void WFiltro_ValorBem_QuandoIntMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterBensMateriais
            {
                ValorBem = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorBem_QuandoValorMinValue_NaoDeveIncluirNoFiltro()
        {
            ...
            var filtro = new FilterBensMateriais
            {
                ValorBem = int.MinValue, // Valor que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBBensMateriaisDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBBensMateriaisDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.DtCad} BETWEEN @{DBBensMateriaisDicInfo.DtCad} AND @{DBBensMateriaisDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBBensMateriaisDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBBensMateriaisDicInfo.PTabelaNome}].[{DBBensMateriaisDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBBensMateriaisDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBBensMateriaisDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBBensMateriaisDicInfo.PTabelaNome}].{DBBensMateriaisDicInfo.DtAtu} BETWEEN @{DBBensMateriaisDicInfo.DtAtu} AND @{DBBensMateriaisDicInfo.DtAtu}_end");
        }
