...
import { usePrepostosFilter } from "@/app/GerAdv_TS/Prepostos/Hooks/hookPrepostosFilter";
...
export const useAgendaFilter = ({
  ...
  const renderInputFilters = (handlers: FilterHandlers<FilterAgenda>) => (
    <>
      ...
      <FilterDialogButton
        // passa o objeto nested (pode ser undefined => cast para objeto vazio)
        filter={handlers.windowFilter.filterPrepostos ?? ({} as any as any)}
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({ ...prev, filterPrepostos: f }))
        }
        // ao confirmar, NÃO precisa fazer nada - o setFilter já atualizou
        onConfirm={async (f: any) => {}}
        title="Filtrar Prepostos"
        buttonText="Prepostos"
        renderInputFilters={renderPrepostosInputs}
      />
  ...
  const { renderInputFilters: renderPrepostosInputs } = usePrepostosFilter({
    handleFetchWithFilter: async () => {},
  });
