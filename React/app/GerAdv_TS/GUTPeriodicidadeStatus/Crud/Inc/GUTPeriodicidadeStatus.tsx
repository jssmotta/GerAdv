...
import {
  useGUTPeriodicidadeStatusForm,
  useValidationsGUTPeriodicidadeStatus,
} from "../../Hooks/hookGUTPeriodicidadeStatus";
...
const GUTPeriodicidadeStatusInc: React.FC<IGUTPeriodicidadeStatusFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadGUTPeriodicidadeStatus } =
    useGUTPeriodicidadeStatusForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedGUTPeriodicidadeStatus =
        await gutperiodicidadestatusService.saveGUTPeriodicidadeStatus(data);
