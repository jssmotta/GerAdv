...
interface AgendaRepetirDiasGridProps {
  data: IAgendaRepetirDias[];
  onRowClick: (agendarepetirdias: IAgendaRepetirDias) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AgendaRepetirDiasGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAgendaRepetirDias, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-agendarepetirdias'
