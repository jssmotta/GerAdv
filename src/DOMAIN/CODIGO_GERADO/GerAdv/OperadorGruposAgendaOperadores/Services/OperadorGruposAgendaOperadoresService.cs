...
public partial class OperadorGruposAgendaOperadoresService(IOptions<AppSettings> appSettings, IFOperadorGruposAgendaOperadoresFactory operadorgruposagendaoperadoresFactory, IOperadorGruposAgendaOperadoresReader reader, IOperadorGruposAgendaOperadoresValidation validation, IOperadorGruposAgendaOperadoresWriter writer, IOperadorGruposAgendaReader operadorgruposagendaReader, IOperadorReader operadorReader, IHttpContextAccessor httpContextAccessor, HybridCache cache, IMemoryCache memory) : IOperadorGruposAgendaOperadoresService, IDisposable
{
    ...
    private readonly IFOperadorGruposAgendaOperadoresFactory operadorgruposagendaoperadoresFactory = operadorgruposagendaoperadoresFactory;
    private readonly IOperadorGruposAgendaOperadoresReader reader = reader;
    private readonly IOperadorGruposAgendaOperadoresValidation validation = validation;
    private readonly IOperadorGruposAgendaOperadoresWriter writer = writer;
    private readonly IOperadorGruposAgendaReader operadorgruposagendaReader = operadorgruposagendaReader;
    ...
    public async Task<IEnumerable<OperadorGruposAgendaOperadoresResponseAll>> GetAll(int max, [FromRoute, Required] string uri, CancellationToken token = default)
    {
        ...
        var cacheKey = $"{uri}-OperadorGruposAgendaOperadores-Filter-{keyCache}";
    ...
    private async Task<OperadorGruposAgendaOperadoresResponse?> GetDataByIdAsync(int id, MsiSqlConnection oCnn, CancellationToken token) => await reader.Read(id, oCnn);
    public async Task<OperadorGruposAgendaOperadoresResponse?> AddAndUpdate([FromBody] Models.OperadorGruposAgendaOperadores regOperadorGruposAgendaOperadores, [FromRoute, Required] string uri)
    {
        ...
        int operadorId = _httpContextAccessor.HttpContext == null ? regOperadorGruposAgendaOperadores.Operador : UserTools.GetAuthenticatedUserId(_httpContextAccessor);
        using var saved = await writer.WriteAsync(regOperadorGruposAgendaOperadores, operadorId, oCnn);
    ...
    public async Task<OperadorGruposAgendaOperadoresResponse?> Validation([FromBody] Models.OperadorGruposAgendaOperadores regOperadorGruposAgendaOperadores, [FromRoute, Required] string uri)
    {
        ...
        return await reader.Read(regOperadorGruposAgendaOperadores.Id, oCnn);
    }
    ...
    public async Task<OperadorGruposAgendaOperadoresResponse?> Delete([FromQuery] int id, [FromRoute, Required] string uri)
    {
        ...
        var operadorgruposagendaoperadores = await reader.Read(id, oCnn);
        try
        {
            if (operadorgruposagendaoperadores != null)
            {
                await writer.Delete(operadorgruposagendaoperadores, nOperador, oCnn);
