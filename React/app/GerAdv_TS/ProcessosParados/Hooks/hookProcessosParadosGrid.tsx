...
// useProcessosParadosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProcessosParados
'use client';
...
interface UseProcessosParadosGridProps {
...
export const useProcessosParadosGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('processosparados-columns-order'), JSON.stringify(reorderableFields));
