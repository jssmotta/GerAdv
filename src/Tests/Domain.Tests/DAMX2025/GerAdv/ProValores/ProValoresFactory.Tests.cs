...
public class FProValoresFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FProValores>();
    }
    ...
    {
        // Arrange
        var factory = new FProValoresFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("prvCodigo", typeof(int));
        mockDataTable.Columns.Add("prvGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["prvCodigo"] = testId;
        row["prvGuid"] = "Test ProValores";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["prvCodigo"] = 123;
        row["prvGuid"] = "Test ProValores Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FProValores properties
        }
    }
