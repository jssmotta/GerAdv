...
// useOperadoresGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Operadores
"use client";
...
interface UseOperadoresGridProps {
  data: IOperadores[];
...
export const useOperadoresGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("operadores-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IOperadores, filters: Record<string, any>) => {
