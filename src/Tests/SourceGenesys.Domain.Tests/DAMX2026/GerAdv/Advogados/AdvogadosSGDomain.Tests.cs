...
public class DBAdvogadosTests : IDisposable
{
    ...
    private DataTable CreateTestDataTable()
    {
        ...
        dt.Columns.Add("advEtiqueta", typeof(string));
        dt.Columns.Add("advAni", typeof(string));
        dt.Columns.Add("advBold", typeof(string));
...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("Advogados", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("Advogados", cadastro.ITableName());
        Assert.Equal("advCodigo", cadastro.IFieldId());
        Assert.Equal("advNome", cadastro.IFieldNameDescription());
        Assert.Equal("adv", cadastro.IPrefix());
    }
...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FDtInicio = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDtInicio?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBAdvogados();
        Assert.Equal(null !, instance.FDtInicio);
    }
    ...
    {
        _instance.FDtFim = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDtFim?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBAdvogados();
        Assert.Equal(null !, instance.FDtFim);
    }
