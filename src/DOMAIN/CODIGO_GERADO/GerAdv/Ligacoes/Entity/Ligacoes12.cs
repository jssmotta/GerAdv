...
public partial class FLigacoes : MenphisSI.SG.GerAdv.DBLigacoes, IDBLigacoes
{
    // DI-compatible default constructor
    public FLigacoes() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FLigacoes CreateFromReader(SqlDataReader? dbRec)
    {
        return new FLigacoes(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FLigacoes CreateFromDataRow(DataRow? dbRec)
    {
        return new FLigacoes(dbRec);
    }

    private FLigacoes(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FLigacoes(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FLigacoes> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
