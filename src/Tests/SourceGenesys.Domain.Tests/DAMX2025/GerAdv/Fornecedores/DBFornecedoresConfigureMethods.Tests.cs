...
#region Fields_All
    ...
    public void ConfigureUpdateFields_Nome_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        _fornecedores.FNome.Should().Be("");
        _fornecedores.FGrupo.Should().Be(0);
    }
    ...
    public void ConfigureMethodsInscEst_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _fornecedores.FInscEst.Should().Be("");
        _fornecedores.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsEndereco_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _fornecedores.FEndereco.Should().Be("");
        _fornecedores.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsBairro_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _fornecedores.FBairro.Should().Be("");
        _fornecedores.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureUpdateFields_Email_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - All field values should not be preserved
        _fornecedores.FEmail.Should().Be("");
        _fornecedores.FGrupo.Should().Be(0);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_Site_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    [Fact]
    public void ConfigureUpdateFields_Obs_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsProdutos_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _fornecedores.FProdutos.Should().Be("");
        _fornecedores.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_Produtos_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsContatos_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _fornecedores.FContatos.Should().Be("");
        _fornecedores.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_Contatos_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
