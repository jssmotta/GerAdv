...
const ProObservacoesInc: React.FC<IProObservacoesFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedProObservacoes =
        await proobservacoesService.saveProObservacoes(data);
