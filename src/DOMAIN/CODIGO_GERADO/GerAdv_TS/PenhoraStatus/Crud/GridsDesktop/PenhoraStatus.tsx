...
export const PenhoraStatusGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IPenhoraStatus, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-penhorastatus'
