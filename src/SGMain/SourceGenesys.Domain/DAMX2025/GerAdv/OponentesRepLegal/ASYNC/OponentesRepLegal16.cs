...
public partial class DBOponentesRepLegal
{
    ...
    /// </summary>
    public static async Task<DBOponentesRepLegal> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBOponentesRepLegal();
