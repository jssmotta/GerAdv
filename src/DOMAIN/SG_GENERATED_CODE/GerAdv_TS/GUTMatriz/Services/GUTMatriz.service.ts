...
export interface IGUTMatrizService {
  ...
  filterVoice: (filtro?: FilterGUTMatriz, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class GUTMatrizService implements IGUTMatrizService {
  ...
  async filterVoice(filtro?: FilterGUTMatriz, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
