  ...
  return (
    <>
      <div
        className={
          isMobile
            ? "form-container form-container-Fase"
            : "form-container5 form-container-Fase"
        }
      >
        <form
          className="formInputCadInc"
          id={`FaseForm-${faseData.id}`}
          onSubmit={onConfirm}
        >
          {!isMobile && (
            <ButtonSalvarCrud
        ...
        <FooterIncDocker>
          <CopyButton formId={`FaseForm-${faseData.id}`} />

          <PrintButton formId={`FaseForm-${faseData.id}`} />

          <AuditorButton tableName="Fase" coolName="Fase" id={faseData.id} />
