...
describe('OutrasPartesClienteApi', () => {
  let outraspartesclienteApi: OutrasPartesClienteApi;
  ...
  beforeEach(() => {
    ...
    outraspartesclienteApi = new OutrasPartesClienteApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(outraspartesclienteApi).toBeInstanceOf(OutrasPartesClienteApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new OutrasPartesClienteApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(OutrasPartesClienteApi);
    });
  });
  ...
  describe('getAll', () => {
    const mockResponse: AxiosResponse = {
      data: [OutrasPartesClienteTestEmpty()],
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch all outraspartescliente items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await outraspartesclienteApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(outraspartesclienteApi.getAll()).rejects.toThrow(OutrasPartesClienteApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await outraspartesclienteApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-OutrasPartesCliente_last_getAll_${200}`)));
    });
    ...
    it('should throw OutrasPartesClienteApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockOutrasPartesCliente = OutrasPartesClienteTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockOutrasPartesCliente,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch outraspartescliente by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await outraspartesclienteApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockOutrasPartesCliente));
      ...
      expect(result.data).toEqual(mockOutrasPartesCliente);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'OutrasPartesCliente',
          id: 1,
  ...
  describe('filter', () => {
    ...
    it('should filter outraspartescliente items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await outraspartesclienteApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    ...
    it('should add new outraspartescliente successfully', async () => {
      const responseOutrasPartesCliente = { ...mockOutrasPartesCliente, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responseOutrasPartesCliente,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await outraspartesclienteApi.addAndUpdate(mockOutrasPartesCliente);

      expect(mockedAxios.post).toHaveBeenCalledWith(
        expect.stringContaining('/AddAndUpdate'),
        mockOutrasPartesCliente,
        expect.any(Object)
      );
      expect(result).toEqual(mockResponse);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
    ...
    it('should update existing outraspartescliente successfully', async () => {
      const existingOutrasPartesCliente = { ...mockOutrasPartesCliente, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingOutrasPartesCliente,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await outraspartesclienteApi.addAndUpdate(existingOutrasPartesCliente);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(outraspartesclienteApi.addAndUpdate(mockOutrasPartesCliente)).rejects.toThrow(OutrasPartesClienteApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'OutrasPartesCliente',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete outraspartescliente successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await outraspartesclienteApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(outraspartesclienteApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'OutrasPartesCliente',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(outraspartesclienteApi.delete(1)).rejects.toThrow(OutrasPartesClienteApiError);
    });
  });
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await outraspartesclienteApi.delete(1);
  ...
  describe('OutrasPartesClienteApiError', () => {
    it('should create error with correct properties', () => {
      const error = new OutrasPartesClienteApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('OutrasPartesClienteApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new OutrasPartesClienteApiError('Test message', 500);
