...
interface OperadorGruposAgendaOperadoresGridProps {
  data: IOperadorGruposAgendaOperadores[];
  onRowClick: (operadorgruposagendaoperadores: IOperadorGruposAgendaOperadores) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const OperadorGruposAgendaOperadoresGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
}: OperadorGruposAgendaOperadoresGridProps) => {
...
const filterLogic = useCallback((data: IOperadorGruposAgendaOperadores, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nomeoperadorgruposagenda' title='Operador Grupos Agenda' sortable={false} filterable={false} />, /* Track G.01 */
  ...
  tableName: 'operadorgruposagendaoperadores'
});
...
{initialized && (
  ...
  className='grid-desktop-operadorgruposagendaoperadores'
