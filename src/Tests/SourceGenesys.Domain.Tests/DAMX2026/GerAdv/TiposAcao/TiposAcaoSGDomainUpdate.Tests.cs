...
public class DBTiposAcaoUpdate : IDisposable
{
    private readonly DBTiposAcao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTiposAcaoUpdate()
    {
    ...
    {
        // Act
        var tiposacao = new DBTiposAcao();
        // Assert
        tiposacao.Should().NotBeNull();
        tiposacao.ITableName().Should().Be("TiposAcao");
        tiposacao.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set tiposacao.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        tiposacao.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        tiposacao.FNome = longString; // MAX: 80
        tiposacao.FGuid = longString; // MAX: 100
        // Assert - All properties should be set tiposacao.FNome.Should().HaveLength(80);
        tiposacao.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        tiposacao.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        tiposacao.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "tacCodigo = 1";
        // Act & Assert
        var TiposAcao = new DBTiposAcao(sqlWhere, null);
        TiposAcao.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var tiposacao = new DBTiposAcao(parameters, nome, null);
        // Assert
        tiposacao.Should().NotBeNull();
        tiposacao.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        tiposacao.FNome = longName;
        // Assert
        tiposacao.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBTiposAcao).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var tiposacao = new DBTiposAcao();
        // Act & Assert
        tiposacao.TabelaNome.Should().Be("TiposAcao");
    }
