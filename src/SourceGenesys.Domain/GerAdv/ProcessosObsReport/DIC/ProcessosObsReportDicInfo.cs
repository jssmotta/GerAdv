...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem PrrProcesso => new(0, PTabelaNome, CampoCodigo, Processo, "Processo", "Processo", ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false)
    {
        IsRequired = true,
        Prefixo = "prr"
    }; // DBI 11 
    ...
    public static DBInfoSystem PrrHistorico => new(0, PTabelaNome, CampoCodigo, Historico, "Historico", "Historico", ETipoDadosSysteminfo.SysteminfoForeingkey, DBHistoricoDicInfo.CampoCodigo, DBHistoricoDicInfo.TabelaNome, new DBHistoricoODicInfo(), false)
    {
        Prefixo = "prr"
    }; // DBI 11 
