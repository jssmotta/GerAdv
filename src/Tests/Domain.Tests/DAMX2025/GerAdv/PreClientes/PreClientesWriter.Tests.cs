...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFPreClientes.VerifySet(x => x.FDtNasc = DateOnly.Parse(preclientes.DtNasc), Times.Once);
        ...
        _mockFPreClientes.VerifySet(x => x.FData = DateOnly.Parse(preclientes.Data), Times.Once);
    ...
    public async Task WriteAsync_WithNull_DtNasc_ShouldNotSetFDtNasc()
    {
        ...
        // Assert
        _mockFPreClientes.VerifySet(x => x.FDtNasc = It.IsAny<DateOnly>(), Times.Never);
    }
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        await _preclientesWriter.WriteAsync(preclientes, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFPreClientes.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new PreClientesWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.PreClientes CreateValidPreClientesModel()
    {
