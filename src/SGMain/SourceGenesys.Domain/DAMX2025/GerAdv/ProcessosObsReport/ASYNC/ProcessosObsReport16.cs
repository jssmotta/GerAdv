...
public partial class DBProcessosObsReport
{
    ...
    /// </summary>
    public static async Task<DBProcessosObsReport> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBProcessosObsReport();
...
#if (!NOTSTORED_ProcessosObsReport)
    /// <summary>
...
#if (!NOTSTORED_ProcessosObsReport)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFData || pFldFProcesso || pFldFObservacao || pFldFHistorico;
