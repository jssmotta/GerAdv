...
#region DateTime Tests
        ...
        public void WFiltro_HoraInicial_ComDatasExtremas_DeveProcessarCorretamente(string dataExtrema)
        {
            // Arrange
            var filtro = new FilterReuniao
            {
                HoraInicial = dataExtrema,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _service.WFiltro(filtro);
        ...
        public void WFiltro_HoraInicial_ComDatasInvalidas_NaoDeveAdicionarParametros(string dataInvalida)
        {
            // Arrange
            var filtro = new FilterReuniao
            {
                HoraInicial = dataInvalida,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _service.WFiltro(filtro);
...
#region HoraInicial Tests
        [Fact]
        public void WFiltro_HoraInicial_WhenEmptyOrNull_ShouldNotAddParameters()
        {
            // Arrange
            var filtro = new FilterReuniao
            {
        ...
        [Fact]
        public void WFiltro_HoraInicial_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            // Arrange
            ...
            parameter.ParameterName.Should().Be($"@{DBReuniaoDicInfo.HoraInicial}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraInicial}], 103) = CONVERT(DATE, @{DBReuniaoDicInfo.HoraInicial}, 103)");
        }

        [Fact]
        public void WFiltro_HoraInicial_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            // Arrange
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBReuniaoDicInfo.HoraInicial}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBReuniaoDicInfo.HoraInicial}_end");
            ...
            result.Value.where.Should().Contain($"[{DBReuniaoDicInfo.PTabelaNome}].{DBReuniaoDicInfo.HoraInicial} BETWEEN @{DBReuniaoDicInfo.HoraInicial} AND @{DBReuniaoDicInfo.HoraInicial}_end");
        }

        [Fact]
        public void WFiltro_HoraInicial_WhenInvalidDateFormat_ShouldNotAddParameter()
        {
            // Arrange
            var invalidDate = "invalid-date";
            var filtro = new FilterReuniao
            {
                HoraInicial = invalidDate,
                HoraInicial_end = string.Empty,
                LogicalOperator = TSql.And
            };
            // Act
        ...
        [Fact]
        public void WFiltro_HoraInicial_WhenStartDateValidButEndDateInvalid_ShouldOnlyAddStartParameterAndGenerateSingleDateClause()
        {
            // Arrange
            ...
            var filtro = new FilterReuniao
            {
                HoraInicial = validStartDate,
                HoraInicial_end = invalidEndDate,
                LogicalOperator = TSql.And
            };
            // Act
            var result = _service.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_HoraInicial_WhenStartDateInvalidButEndDateValid_ShouldNotAddAnyParameters()
        {
            // Arrange
            ...
            var filtro = new FilterReuniao
            {
                HoraInicial = invalidStartDate,
                HoraInicial_end = validEndDate,
                LogicalOperator = TSql.And
            };
            // Act
            var result = _service.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_HoraInicial_WhenWhitespaceOnlyDates_ShouldNotAddParameters()
        {
            // Arrange
            var filtro = new FilterReuniao
            {
        ...
        [Fact]
        public void WFiltro_HoraInicial_WithOtherFilters_ShouldIncludeLogicalOperatorInWhereClause()
        {
            // Arrange
            var testDate = "15/06/2023";
            var filtro = new FilterReuniao
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2); // Nome + HoraInicial
            result.Value.where.Should().Contain(TSql.And);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraInicial}], 103) = CONVERT(DATE, @{DBReuniaoDicInfo.HoraInicial}, 103)");
        }

        [Fact]
        public void WFiltro_HoraInicial_WithORLogicalOperator_ShouldUseORInWhereClause()
        {
            // Arrange
            var testDate = "15/06/2023";
            var filtro = new FilterReuniao
        ...
        [Fact]
        public void WFiltro_HoraInicial_WhenOnlyEndDateProvided_ShouldNotAddParameters()
        {
            // Arrange
            var filtro = new FilterReuniao
            {
                HoraInicial = string.Empty,
                HoraInicial_end = "30/06/2023",
                LogicalOperator = TSql.And
            };
            // Act
            var result = _service.WFiltro(filtro);
        ...
        public void WFiltro_HoraInicial_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraInicial}], 103)");
        }
...
#region HoraSaida Tests
        ...
        public void WFiltro_HoraSaida_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBReuniaoDicInfo.HoraSaida}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraSaida}], 103) = CONVERT(DATE, @{DBReuniaoDicInfo.HoraSaida}, 103)");
        }
        ...
        public void WFiltro_HoraSaida_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBReuniaoDicInfo.HoraSaida}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBReuniaoDicInfo.HoraSaida}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBReuniaoDicInfo.PTabelaNome}].{DBReuniaoDicInfo.HoraSaida} BETWEEN @{DBReuniaoDicInfo.HoraSaida} AND @{DBReuniaoDicInfo.HoraSaida}_end");
        }
        ...
        public void WFiltro_HoraSaida_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraSaida}], 103)");
        }
        ...
        [InlineData("01/01/1900")] // Data muito antiga
        [InlineData("29/02/2024")] // Ano bissexto
        public void WFiltro_HoraRetorno_ComDatasExtremas_DeveProcessarCorretamente(string dataExtrema)
        {
            // Arrange
            var filtro = new FilterReuniao
            {
                HoraRetorno = dataExtrema,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _service.WFiltro(filtro);
        ...
        [InlineData("29/02/2023")] // Não é ano bissexto
        [InlineData("abc/def/ghij")] // Formato completamente inválido
        public void WFiltro_HoraRetorno_ComDatasInvalidas_NaoDeveAdicionarParametros(string dataInvalida)
        {
            // Arrange
            var filtro = new FilterReuniao
            {
                HoraRetorno = dataInvalida,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _service.WFiltro(filtro);
...
#region HoraRetorno Tests
        [Fact]
        public void WFiltro_HoraRetorno_WhenEmptyOrNull_ShouldNotAddParameters()
        {
            // Arrange
            var filtro = new FilterReuniao
            {
        ...
        [Fact]
        public void WFiltro_HoraRetorno_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            // Arrange
            var testDate = "15/06/2023";
            var filtro = new FilterReuniao
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBReuniaoDicInfo.HoraRetorno}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraRetorno}], 103) = CONVERT(DATE, @{DBReuniaoDicInfo.HoraRetorno}, 103)");
        }

        [Fact]
        public void WFiltro_HoraRetorno_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            // Arrange
            var startDate = "01/06/2023";
            var endDate = "30/06/2023";
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBReuniaoDicInfo.HoraRetorno}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBReuniaoDicInfo.HoraRetorno}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBReuniaoDicInfo.PTabelaNome}].{DBReuniaoDicInfo.HoraRetorno} BETWEEN @{DBReuniaoDicInfo.HoraRetorno} AND @{DBReuniaoDicInfo.HoraRetorno}_end");
        }

        [Fact]
        public void WFiltro_HoraRetorno_WhenInvalidDateFormat_ShouldNotAddParameter()
        {
            // Arrange
            var invalidDate = "invalid-date";
            var filtro = new FilterReuniao
            {
                HoraRetorno = invalidDate,
                HoraRetorno_end = string.Empty,
                LogicalOperator = TSql.And
            };
            // Act
        ...
        [Fact]
        public void WFiltro_HoraRetorno_WhenStartDateValidButEndDateInvalid_ShouldOnlyAddStartParameterAndGenerateSingleDateClause()
        {
            // Arrange
            var validStartDate = "15/06/2023";
            var invalidEndDate = "invalid-date";
            var filtro = new FilterReuniao
            {
                HoraRetorno = validStartDate,
                HoraRetorno_end = invalidEndDate,
                LogicalOperator = TSql.And
            };
            // Act
            var result = _service.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_HoraRetorno_WhenStartDateInvalidButEndDateValid_ShouldNotAddAnyParameters()
        {
            // Arrange
            var invalidStartDate = "invalid-date";
            var validEndDate = "30/06/2023";
            var filtro = new FilterReuniao
            {
                HoraRetorno = invalidStartDate,
                HoraRetorno_end = validEndDate,
                LogicalOperator = TSql.And
            };
            // Act
            var result = _service.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_HoraRetorno_WhenWhitespaceOnlyDates_ShouldNotAddParameters()
        {
            // Arrange
            var filtro = new FilterReuniao
            {
        ...
        [Fact]
        public void WFiltro_HoraRetorno_WithOtherFilters_ShouldIncludeLogicalOperatorInWhereClause()
        {
            // Arrange
            var testDate = "15/06/2023";
            var filtro = new FilterReuniao
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2); // Nome + HoraRetorno
            result.Value.where.Should().Contain(TSql.And);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraRetorno}], 103) = CONVERT(DATE, @{DBReuniaoDicInfo.HoraRetorno}, 103)");
        }

        [Fact]
        public void WFiltro_HoraRetorno_WithORLogicalOperator_ShouldUseORInWhereClause()
        {
            // Arrange
            var testDate = "15/06/2023";
            var filtro = new FilterReuniao
        ...
        [Fact]
        public void WFiltro_HoraRetorno_WhenOnlyEndDateProvided_ShouldNotAddParameters()
        {
            // Arrange
            var filtro = new FilterReuniao
            {
                HoraRetorno = string.Empty,
                HoraRetorno_end = "30/06/2023",
                LogicalOperator = TSql.And
            };
            // Act
            var result = _service.WFiltro(filtro);
        ...
        public void WFiltro_HoraRetorno_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.HoraRetorno}], 103)");
        }
