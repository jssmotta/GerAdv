                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(pcdCodigo) FROM {"ProCDA".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) pcdProcesso,pcdNome,pcdNroInterno,pcdBold,pcdGuid FROM {"ProCDA".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
