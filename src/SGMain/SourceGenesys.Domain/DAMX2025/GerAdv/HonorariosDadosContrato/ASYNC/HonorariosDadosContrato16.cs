...
public partial class DBHonorariosDadosContrato
{
    ...
    /// </summary>
    public static async Task<DBHonorariosDadosContrato> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBHonorariosDadosContrato();
