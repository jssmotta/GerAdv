...
interface UseProObservacoesFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterProObservacoes | undefined | null,
  ) => Promise<void>;
}
...
interface UseProObservacoesFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterProObservacoes>,
  ) => React.ReactNode;
...
export const useProObservacoesFilter = ({
  handleFetchWithFilter,
}: UseProObservacoesFilterProps): UseProObservacoesFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterProObservacoes>(
