...
export interface IPontoVirtualAcessosService {
  ...
  filterVoice: (filtro?: FilterPontoVirtualAcessos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class PontoVirtualAcessosService implements IPontoVirtualAcessosService {
  ...
  async filterVoice(filtro?: FilterPontoVirtualAcessos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
