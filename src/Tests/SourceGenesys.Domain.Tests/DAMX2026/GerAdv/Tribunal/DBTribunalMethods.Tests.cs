...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTribunal
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTribunalUpdateAdvancedTests : IDisposable
{
    private readonly DBTribunal _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTribunalUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTribunal
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTribunal).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTribunal).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTribunal instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTribunal).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTribunal.PTabelaNome.Should().Be("Tribunal");
        DBTribunal.CampoCodigo.Should().Be("triCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTribunal();
        dbRec.ID = 1;
