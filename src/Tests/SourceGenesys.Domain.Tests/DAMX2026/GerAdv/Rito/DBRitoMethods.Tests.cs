...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBRito
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBRitoUpdateAdvancedTests : IDisposable
{
    private readonly DBRito _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBRitoUpdateAdvancedTests()
    {
...
#region Business Logic Tests
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBRito
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBRito).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void Update_AfterMultiplePropertyChanges_ShouldTrackChangesCorrectly()
    {
        ...
        _instance.FDescricao = "AAAAAAAAAAAAAAAAAA";
        _instance.FDescricao = "BBBBBBBBBBBBBBBBB";
        _instance.FDescricao = "CCCCCCCCCCCCCCCCCCc";
        // Act & Assert
...
#region State Management Tests
    ...
    public void Update_StateManagement_ShouldPreserveInstanceState()
    {
        ...
        // Assert
        _instance.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAA");
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBRito).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBRito instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBRito).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBRito.PTabelaNome.Should().Be("Rito");
        DBRito.CampoCodigo.Should().Be("ritCodigo");
    }
...
#region Integration-like Tests
    ...
    public void Update_CompleteWorkflow_Insert_ShouldExecuteAllSteps()
    {
        ...
        // Assert
        result.Should().Be(null);
        dbRec.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAA");
    ...
    public void Update_Boundary_MaxLengthDescricao()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FDescricao = new string ('A', 20); // Maximum length
        SetFieldChanged("pFldFDescricao", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FDescricao.Length.Should().Be(20);
    }
    ...
    public void Update_ComplexScenario_MultipleChangesInSequence()
    {
        ...
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FDescricao.Should().Be("CCCCCCCCCCCCCCCCCCc");
    }
    ...
    public void Update_WithMaxLengthDescricao_ShouldBeHandledCorrectly()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FDescricao = new string ('A', 20); // Max length for Descricao
        int? result = null;
        // Act
        var exception = Record.Exception(() => result = _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
...
#region Integration-Style Tests
    ...
    public void Update_Integration_FullCRUDCycle()
    {
        ...
        exception.Should().NotBeNull();
        // UPDATE
        dbRec.FDescricao = "BBBBBBBBBBBBBBBBB";
        dbRec.ID = 1;
        ...
        dbRec.FDescricao.Should().Be("BBBBBBBBBBBBBBBBB");
    }
