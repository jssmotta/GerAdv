...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class CargosEscClassServiceWFiltroTests : IDisposable
    {
        ...
        private readonly CargosEscClassServiceS _serviceS;
        public CargosEscClassServiceWFiltroTests()
        {
            ...
            _serviceS = new CargosEscClassServiceS();
            _service = new CargosEscClassService(_mockAppSettings.Object, _mockCargosEscClassFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidCargosEscClass_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeCargosEscClass = "João Silva";
            var filtro = new FilterCargosEscClass
            {
                Guid = nomeCargosEscClass,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidCargosEscClass_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
        ...
        [Fact]
        public void WFiltro_GuidCargosEscClass_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidCargosEscClass_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeCargosEscClass)
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
        ...
        [Fact]
        public void WFiltro_GuidCargosEscClass_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
            ...
            resultado.Value.where.Should().Contain("@cecGuid");
            resultado.Value.where.Should().Contain($"@{DBCargosEscClass.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @cecGuid");
            resultado.Value.where.Should().Contain($"= @{DBCargosEscClass.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidCargosEscClass_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeCargosEscClass = "João Silva";
            var filtro = new FilterCargosEscClass
            ...
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @cecGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@cecGuid");
        ...
        [Fact]
        public void WFiltro_NomeCargosEscClass_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeCargosEscClass = "João Silva";
            var filtro = new FilterCargosEscClass
            {
                Nome = nomeCargosEscClass,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeCargosEscClass_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
        ...
        [Fact]
        public void WFiltro_NomeCargosEscClass_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeCargosEscClass_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeCargosEscClass)
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
        ...
        [Fact]
        public void WFiltro_NomeCargosEscClass_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterCargosEscClass
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@cecNome");
            resultado.Value.where.Should().Contain($"@{DBCargosEscClass.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @cecNome");
            resultado.Value.where.Should().Contain($"= @{DBCargosEscClass.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeCargosEscClass_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeCargosEscClass = "João Silva";
            var filtro = new FilterCargosEscClass
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @cecNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@cecNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemCad}] = @{DBCargosEscClassDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBCargosEscClassDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.QuemCad} BETWEEN @{DBCargosEscClassDicInfo.QuemCad} AND @{DBCargosEscClassDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.QuemCad} BETWEEN @{DBCargosEscClassDicInfo.QuemCad} AND @{DBCargosEscClassDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemCad}] = @{DBCargosEscClassDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemCad}] = @cecQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@cecQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@cecQuemCad");
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemAtu}] = @{DBCargosEscClassDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBCargosEscClassDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.QuemAtu} BETWEEN @{DBCargosEscClassDicInfo.QuemAtu} AND @{DBCargosEscClassDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.QuemAtu} BETWEEN @{DBCargosEscClassDicInfo.QuemAtu} AND @{DBCargosEscClassDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemAtu}] = @{DBCargosEscClassDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.QuemAtu}] = @cecQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@cecQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@cecQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.CampoCodigo}] = @{DBCargosEscClassDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBCargosEscClassDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.CampoCodigo} BETWEEN @{DBCargosEscClassDicInfo.CampoCodigo} AND @{DBCargosEscClassDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBCargosEscClassDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.CampoCodigo} BETWEEN @{DBCargosEscClassDicInfo.CampoCodigo} AND @{DBCargosEscClassDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.CampoCodigo}] = @{DBCargosEscClassDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBCargosEscClassDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBCargosEscClassDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.DtCad} BETWEEN @{DBCargosEscClassDicInfo.DtCad} AND @{DBCargosEscClassDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBCargosEscClassDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBCargosEscClassDicInfo.PTabelaNome}].[{DBCargosEscClassDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBCargosEscClassDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCargosEscClassDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBCargosEscClassDicInfo.PTabelaNome}].{DBCargosEscClassDicInfo.DtAtu} BETWEEN @{DBCargosEscClassDicInfo.DtAtu} AND @{DBCargosEscClassDicInfo.DtAtu}_end");
        }
