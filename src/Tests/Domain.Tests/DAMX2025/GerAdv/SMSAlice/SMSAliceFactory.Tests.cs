...
public class FSMSAliceFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FSMSAlice>();
    }
    ...
    {
        // Arrange
        var factory = new FSMSAliceFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("smaCodigo", typeof(int));
        mockDataTable.Columns.Add("smaNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["smaCodigo"] = testId;
        row["smaNome"] = "Test SMSAlice";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["smaCodigo"] = 123;
        row["smaNome"] = "Test SMSAlice Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FSMSAlice properties
        }
    }
