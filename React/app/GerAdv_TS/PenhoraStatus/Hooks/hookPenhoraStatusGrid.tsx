...
// usePenhoraStatusGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de PenhoraStatus
"use client";
...
interface UsePenhoraStatusGridProps {
  data: IPenhoraStatus[];
...
export const usePenhoraStatusGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IPenhoraStatus, filters: Record<string, any>) => {
