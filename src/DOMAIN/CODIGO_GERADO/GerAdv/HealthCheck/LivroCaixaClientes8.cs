                ...
                try
                {
                    ...
                    try
                    {
                        if (DBLivroCaixaClientesDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(lccCodigo) FROM {"LivroCaixaClientes".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) lccLivroCaixa,lccCliente,lccLancado FROM {"LivroCaixaClientes".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
