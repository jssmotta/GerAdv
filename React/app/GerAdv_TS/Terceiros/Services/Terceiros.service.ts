...
export class TerceirosValidator {
  static validateTerceiros(terceiros: ITerceiros): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface ITerceirosService {
  ...
  validateTerceiros: (terceiros: ITerceiros) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
