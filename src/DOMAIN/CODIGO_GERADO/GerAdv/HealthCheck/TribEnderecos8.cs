                ...
                try
                {
                    ...
                    try
                    {
                        if (DBTribEnderecosDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(treCodigo) FROM {"TribEnderecos".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) treTribunal,treCidade,treEndereco,treCEP,treFone,treFax,treOBS FROM {"TribEnderecos".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
