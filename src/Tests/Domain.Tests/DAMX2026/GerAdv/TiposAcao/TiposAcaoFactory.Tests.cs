...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("tacCodigo", typeof(int));
        mockDataTable.Columns.Add("tacNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["tacCodigo"] = testId;
        row["tacNome"] = "Test TiposAcao";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["tacCodigo"] = 123;
        row["tacNome"] = "Test TiposAcao Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTiposAcao properties
        }
    }
