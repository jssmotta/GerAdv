...
import { GruposEmpresasApiError } from '@/app/GerAdv_TS/GruposEmpresas/Apis/ApiGruposEmpresas';
...
import { GruposEmpresasTestEmpty } from '@/app/GerAdv_TS/Models/GruposEmpresas';
...
despesaunificada: true
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterGruposEmpresas = { : 1 };
