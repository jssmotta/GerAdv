...
public partial class FHistorico : MenphisSI.SG.GerAdv.DBHistorico, IDBHistorico
{
    ...
    private FHistorico(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FHistorico CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FHistorico(parameters, oCnn, fullSql, sqlWhere, join);
    }
