                ...
                try
                {
                    ...
                    try
                    {
                        if (DBProProcuradoresDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) papAdvogado,papNome,papProcesso,papData,papSubstabelecimento,papProcuracao,papGUID FROM {"ProProcuradores".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
