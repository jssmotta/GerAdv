...
[Serializable]
internal class VSexoShadows : XCodeIdBaseShadows
{
    ...
    public string Tratamento => (m_FSexo ? "Sr." : "Sra."); // + " " + m_FNome.FirstLastName();
    /// <summary>
    ...
    //  public string NomeNegritarWeb => m_FBold ? $"<b>{m_FNome}</b>" : m_FNome;
}
