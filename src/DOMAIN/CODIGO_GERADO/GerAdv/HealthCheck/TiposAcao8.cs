                ...
                try
                {
                    ...
                    try
                    {
                        if (DBTiposAcaoDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(tacCodigo) FROM dbo.TiposAcao (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) tacNome,tacInativo,tacBold,tacGUID FROM dbo.TiposAcao (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
