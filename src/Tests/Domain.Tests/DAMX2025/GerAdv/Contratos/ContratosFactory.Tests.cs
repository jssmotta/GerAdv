...
public class FContratosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FContratos>();
    }
    ...
    {
        // Arrange
        var factory = new FContratosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("cttCodigo", typeof(int));
        mockDataTable.Columns.Add("cttGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["cttCodigo"] = testId;
        row["cttGuid"] = "Test Contratos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["cttCodigo"] = 123;
        row["cttGuid"] = "Test Contratos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FContratos properties
        }
    }
