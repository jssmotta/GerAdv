...
export interface IProcessOutPutIDsService {
  ...
  filterVoice: (filtro?: FilterProcessOutPutIDs, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ProcessOutPutIDsService implements IProcessOutPutIDsService {
  ...
  async filterVoice(filtro?: FilterProcessOutPutIDs, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
