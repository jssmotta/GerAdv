...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFProResumos.VerifySet(x => x.FData = DateOnly.Parse(proresumos.Data), Times.Once);
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        // Assert
        _mockFProResumos.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ProResumosWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.ProResumos CreateValidProResumosModel()
    {
