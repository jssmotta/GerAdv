...
interface UseParceriaProcFilterReturn {
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterParceriaProc>) => React.ReactNode;
...
export const useParceriaProcFilter = ({ handleFetchWithFilter }: UseParceriaProcFilterProps): UseParceriaProcFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterParceriaProc>({} as FilterParceriaProc);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterParceriaProc;
