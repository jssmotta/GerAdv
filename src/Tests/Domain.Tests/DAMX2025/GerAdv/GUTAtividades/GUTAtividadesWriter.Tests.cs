...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFGUTAtividades.VerifySet(x => x.FDataConcluido = DateOnly.Parse(gutatividades.DataConcluido), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_DataConcluido_ShouldNotSetFDataConcluido()
    {
        // Arrange
        var gutatividades = CreateValidGUTAtividadesModel();
        ...
        // Assert
        _mockFGUTAtividades.VerifySet(x => x.FDataConcluido = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new GUTAtividadesWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.GUTAtividades CreateValidGUTAtividadesModel()
    {
