...
import { InstanciaApi, InstanciaApiError } from "../Apis/InstanciaApi";
...
export class InstanciaValidator {
  static validateInstancia(instancia: IInstancia): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IInstanciaService {
  ...
  validateInstancia: (instancia: IInstancia) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
