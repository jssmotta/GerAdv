                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(funCodigo) FROM {"Funcao".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) funDescricao FROM {"Funcao".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
