...
public partial class DBNENotas
{
    ...
    /// </summary>
    public static async Task<DBNENotas> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBNENotas();
...
#if (!NOTSTORED_NENotas)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFApenso || pFldFPrecatoria || pFldFInstancia || pFldFMovPro || pFldFNome || pFldFNotaExpedida || pFldFRevisada || pFldFProcesso || pFldFPalavraChave || pFldFData || pFldFNotaPublicada;
