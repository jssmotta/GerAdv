...
describe('OperadorGruposAgendaApi', () => {
  let operadorgruposagendaApi: OperadorGruposAgendaApi;
  ...
  beforeEach(() => {
    ...
    operadorgruposagendaApi = new OperadorGruposAgendaApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(operadorgruposagendaApi).toBeInstanceOf(OperadorGruposAgendaApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new OperadorGruposAgendaApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(OperadorGruposAgendaApi);
    });
  });
  ...
  describe('getAll', () => {
    const mockResponse: AxiosResponse = {
      data: [OperadorGruposAgendaTestEmpty()],
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch all operadorgruposagenda items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await operadorgruposagendaApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(operadorgruposagendaApi.getAll()).rejects.toThrow(OperadorGruposAgendaApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await operadorgruposagendaApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-OperadorGruposAgenda_last_getAll_${200}`)));
    });
    ...
    it('should throw OperadorGruposAgendaApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockOperadorGruposAgenda = OperadorGruposAgendaTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockOperadorGruposAgenda,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch operadorgruposagenda by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await operadorgruposagendaApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockOperadorGruposAgenda));
      ...
      expect(result.data).toEqual(mockOperadorGruposAgenda);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'OperadorGruposAgenda',
          id: 1,
  ...
  describe('filter', () => {
    ...
    it('should filter operadorgruposagenda items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await operadorgruposagendaApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    ...
    it('should add new operadorgruposagenda successfully', async () => {
      const responseOperadorGruposAgenda = { ...mockOperadorGruposAgenda, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responseOperadorGruposAgenda,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await operadorgruposagendaApi.addAndUpdate(mockOperadorGruposAgenda);

      expect(mockedAxios.post).toHaveBeenCalledWith(
        expect.stringContaining('/AddAndUpdate'),
        mockOperadorGruposAgenda,
        expect.any(Object)
      );
      expect(result).toEqual(mockResponse);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
    ...
    it('should update existing operadorgruposagenda successfully', async () => {
      const existingOperadorGruposAgenda = { ...mockOperadorGruposAgenda, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingOperadorGruposAgenda,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await operadorgruposagendaApi.addAndUpdate(existingOperadorGruposAgenda);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(operadorgruposagendaApi.addAndUpdate(mockOperadorGruposAgenda)).rejects.toThrow(OperadorGruposAgendaApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'OperadorGruposAgenda',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete operadorgruposagenda successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await operadorgruposagendaApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(operadorgruposagendaApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'OperadorGruposAgenda',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(operadorgruposagendaApi.delete(1)).rejects.toThrow(OperadorGruposAgendaApiError);
    });
  });
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await operadorgruposagendaApi.delete(1);
  ...
  describe('OperadorGruposAgendaApiError', () => {
    it('should create error with correct properties', () => {
      const error = new OperadorGruposAgendaApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('OperadorGruposAgendaApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new OperadorGruposAgendaApiError('Test message', 500);
