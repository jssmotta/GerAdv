...
public class AgendaServiceTests : IDisposable
{
    ...
    public async Task GetById_WithValidId_ShouldExerciseReaderAndMapping()
    {
        ...
        try
        {
            ...
            _output?.WriteLine($"GetById returned agenda with ID: {result.Id}");
        }
        catch (Exception ex)
        {
    ...
    [Fact]
    public async Task AddAndUpdate_WithValidAgenda_ShouldExerciseWorkflow()
    {
        // Arrange
        var validAgenda = new Models.Agenda
        {
            Id = 0, // New agenda
            Data = "27/05/2022"
        };
        try
        {
            ...
            var result = await _service.AddAndUpdate(validAgenda, _validUri);
            // Assert
            if (result != null)
            {
                _output?.WriteLine($"AddAndUpdate processed agenda and returned ID: {result.Id}");
            }
        }
        catch (Exception ex)
        {
    ...
    public async Task Filter_WithValidFilter_ShouldExerciseFilteringLogic()
    {
        // Arrange
        var max = 10;
        var validFilter = new Filters.FilterAgenda
        {
            Data = "27/05/2022"
        };
        try
    ...
    public async Task Delete_WithValidId_ShouldExerciseDeleteWorkflow()
    {
        ...
        try
        {
            ...
            if (result != null)
            {
                _output?.WriteLine($"Delete processed agenda ID: {result.Id}");
            }
        }
        catch (Exception ex)
        {
