                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(cliCodigo) FROM {"PreClientes".dbo(connection)};";
