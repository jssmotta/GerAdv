...
export const CargosGridDesktopComponent = React.memo(
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(btoa("cargos-columns-order"));
        if (savedOrder) {
      ...
      <>
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-cargos"
          ...
          >
            <GridToolbar>
              ...
              <PageTitle
                title="Cargos"
                helpButton={<CargosHelpCrudButton isMobile={false} />}
              />
            </GridToolbar>
            {finalGridColumns}
          </Grid>
