...
// useStatusHTrabGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de StatusHTrab
"use client";
...
interface UseStatusHTrabGridProps {
  data: IStatusHTrab[];
...
export const useStatusHTrabGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IStatusHTrab, filters: Record<string, any>) => {
