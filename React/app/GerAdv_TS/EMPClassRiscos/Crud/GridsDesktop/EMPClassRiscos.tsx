...
export const EMPClassRiscosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IEMPClassRiscos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-empclassriscos'
