...
export interface ITipoContatoCRMService {
  ...
  filterVoice: (filtro?: FilterTipoContatoCRM, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class TipoContatoCRMService implements ITipoContatoCRMService {
  ...
  async filterVoice(filtro?: FilterTipoContatoCRM, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
