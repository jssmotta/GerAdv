...
export interface IOperadorGruposAgendaService {
  ...
  filterVoice: (filtro?: FilterOperadorGruposAgenda, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class OperadorGruposAgendaService implements IOperadorGruposAgendaService {
  ...
  async filterVoice(filtro?: FilterOperadorGruposAgenda, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
