...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class ProcessOutPutIDsServiceWFiltroTests : IDisposable
    {
        ...
        private readonly ProcessOutPutIDsServiceS _serviceS;
        public ProcessOutPutIDsServiceWFiltroTests()
        {
            ...
            _serviceS = new ProcessOutPutIDsServiceS();
            _service = new ProcessOutPutIDsService(_mockAppSettings.Object, _mockProcessOutPutIDsFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidProcessOutPutIDs_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeProcessOutPutIDs = "João Silva";
            var filtro = new FilterProcessOutPutIDs
            {
                Guid = nomeProcessOutPutIDs,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidProcessOutPutIDs_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
        ...
        [Fact]
        public void WFiltro_GuidProcessOutPutIDs_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidProcessOutPutIDs_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeProcessOutPutIDs)
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
        ...
        [Fact]
        public void WFiltro_GuidProcessOutPutIDs_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
            ...
            resultado.Value.where.Should().Contain("@poiGuid");
            resultado.Value.where.Should().Contain($"@{DBProcessOutPutIDs.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @poiGuid");
            resultado.Value.where.Should().Contain($"= @{DBProcessOutPutIDs.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidProcessOutPutIDs_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeProcessOutPutIDs = "João Silva";
            var filtro = new FilterProcessOutPutIDs
            ...
            resultado.Value.where.Should().Contain($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].[{DBProcessOutPutIDsDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @poiGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@poiGuid");
        ...
        [Fact]
        public void WFiltro_NomeProcessOutPutIDs_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeProcessOutPutIDs = "João Silva";
            var filtro = new FilterProcessOutPutIDs
            {
                Nome = nomeProcessOutPutIDs,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeProcessOutPutIDs_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
        ...
        [Fact]
        public void WFiltro_NomeProcessOutPutIDs_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeProcessOutPutIDs_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeProcessOutPutIDs)
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
        ...
        [Fact]
        public void WFiltro_NomeProcessOutPutIDs_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterProcessOutPutIDs
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@poiNome");
            resultado.Value.where.Should().Contain($"@{DBProcessOutPutIDs.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @poiNome");
            resultado.Value.where.Should().Contain($"= @{DBProcessOutPutIDs.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeProcessOutPutIDs_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeProcessOutPutIDs = "João Silva";
            var filtro = new FilterProcessOutPutIDs
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].[{DBProcessOutPutIDsDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @poiNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@poiNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].[{DBProcessOutPutIDsDicInfo.CampoCodigo}] = @{DBProcessOutPutIDsDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBProcessOutPutIDsDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].{DBProcessOutPutIDsDicInfo.CampoCodigo} BETWEEN @{DBProcessOutPutIDsDicInfo.CampoCodigo} AND @{DBProcessOutPutIDsDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProcessOutPutIDsDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBProcessOutPutIDsDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProcessOutPutIDsDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBProcessOutPutIDsDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBProcessOutPutIDsDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBProcessOutPutIDsDicInfo.Nome}");
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].{DBProcessOutPutIDsDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].{DBProcessOutPutIDsDicInfo.CampoCodigo} BETWEEN @{DBProcessOutPutIDsDicInfo.CampoCodigo} AND @{DBProcessOutPutIDsDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].[{DBProcessOutPutIDsDicInfo.CampoCodigo}] = @{DBProcessOutPutIDsDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBProcessOutPutIDsDicInfo.PTabelaNome}].[{DBProcessOutPutIDsDicInfo.CampoCodigo}]");
        }
