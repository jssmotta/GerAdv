...
#region Class Structure Tests
    ...
    private void SetupValidMocks()
    {
        ...
        _mockAgendaService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterAgenda>(), It.IsAny<string>())).ReturnsAsync([]);
        ...
        _ = _mockPrepostosReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<PrepostosResponse?>(new PrepostosResponse { Id = id }));
    }
    ...
    private void SetupValidMocksInvalid()
    {
        ...
        _ = _mockPrepostosReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<PrepostosResponse?>(new PrepostosResponse { Id = 0 }));
    }
...
#region HrFinal Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithEmptyHrFinal_ShouldPass()
    {
        // Arrange
        var agenda = CreateValidAgenda();
        agenda.HrFinal = "";
...
#region Foreign Key Validation Tests - Prepostos
    ...
    public async Task ValidateReg_WithInvalidPrepostos_ShouldThrowSGValidationException()
    {
        ...
        var agenda = CreateValidAgenda();
        agenda.Preposto = 999;
        _mockPrepostosReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.PrepostosResponse?>(null !));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(agenda, _mockAgendaService.Object, _mockCidadeReader.Object, _mockAdvogadosReader.Object, _mockFuncionariosReader.Object, _mockTipoCompromissoReader.Object, _mockClientesReader.Object, _mockAreaReader.Object, _mockJusticaReader.Object, _mockOperadorReader.Object, _mockPrepostosReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithMismatchedPrepostosId_ShouldThrowSGValidationException()
    {
        ...
        var agenda = CreateValidAgenda();
        agenda.Preposto = 999;
        var reg888 = new GerAdv.Models.Response.PrepostosResponse
        {
            Id = 888
        }; // Different ID
        _mockPrepostosReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.PrepostosResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(agenda, _mockAgendaService.Object, _mockCidadeReader.Object, _mockAdvogadosReader.Object, _mockFuncionariosReader.Object, _mockTipoCompromissoReader.Object, _mockClientesReader.Object, _mockAreaReader.Object, _mockJusticaReader.Object, _mockOperadorReader.Object, _mockPrepostosReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidPrepostos_ShouldPass()
    {
        ...
        var agenda = CreateValidAgenda();
        agenda.Preposto = 123;
        var reg123 = new GerAdv.Models.Response.PrepostosResponse
        {
            Id = 123
        };
        _mockPrepostosReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.PrepostosResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(agenda, _mockAgendaService.Object, _mockCidadeReader.Object, _mockAdvogadosReader.Object, _mockFuncionariosReader.Object, _mockTipoCompromissoReader.Object, _mockClientesReader.Object, _mockAreaReader.Object, _mockJusticaReader.Object, _mockOperadorReader.Object, _mockPrepostosReader.Object, _validUri, _mockConnection.Object);
        // Assert
    ...
    public async Task ValidateReg_WithEmptyPrepostos_ShouldPass()
    {
        ...
        // Assert
        result.Should().BeTrue();
        _mockPrepostosReader.Verify(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>()), Times.Never);
    }
