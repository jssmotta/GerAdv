...
export const Diario2Form: React.FC<Diario2FormProps> = ({
  ...
  useEffect(() => {
    ...
    if (el) {
      el.textContent =
        diario2Data?.id == 0 ? "Editar Diario2" : "Adicionar Diário";
    }
  }, [diario2Data.id]);
  ...
  return (
    <>
      <div
        className={
          isMobile
            ? "form-container form-container-Diario2"
            : "form-container5 form-container-Diario2"
        }
      >
        <form
          className="formInputCadInc"
          id={`Diario2Form-${diario2Data.id}`}
          onSubmit={onConfirm}
        >
          {!isMobile && (
            <ButtonSalvarCrud
              ...
              onClose={onClose}
              formId={`Diario2Form-${diario2Data.id}`}
        ...
        <FooterIncDocker>
          <CopyButton formId={`Diario2Form-${diario2Data.id}`} />

          <PrintButton formId={`Diario2Form-${diario2Data.id}`} />
