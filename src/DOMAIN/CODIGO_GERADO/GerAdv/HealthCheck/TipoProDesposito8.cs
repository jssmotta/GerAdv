                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tpdCodigo) FROM {"TipoProDesposito".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tpdNome FROM {"TipoProDesposito".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
