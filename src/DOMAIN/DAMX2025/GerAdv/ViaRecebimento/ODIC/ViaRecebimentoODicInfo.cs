...
#pragma warning restore CA1822 // Mark members as static
    ...
    public static ImmutableArray<DBInfoSystem> List => [DBViaRecebimentoDicInfo.VrbNome];
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBViaRecebimentoDicInfo.VrbNome];

    public static ImmutableArray<DBInfoSystem> ListPk()
    {
        ImmutableArray<string> campos = ImmutableArray.CreateRange(["vrbCodigo"]);
