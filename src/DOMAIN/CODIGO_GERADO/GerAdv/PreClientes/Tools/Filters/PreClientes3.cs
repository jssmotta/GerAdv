...
public class FilterPreClientesWithVoiceRequest
{
    /// <summary>
    /// Filtro de PreClientes padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterPreClientes Filter { get; set; } = new();
...
[Serializable]
public partial record FilterPreClientes
{
