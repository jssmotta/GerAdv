...
public partial interface IGUTAtividadesMatrizReader
{
    ...
    Task<IEnumerable<GUTAtividadesMatrizResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}