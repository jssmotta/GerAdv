                ...
                try
                {
                    ...
                    try
                    {
                        if (DBProcessOutputRequestDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(porCodigo) FROM {"ProcessOutputRequest".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) porProcessOutputEngine,porOperador,porProcesso,porUltimoIdTabelaExo,porGUID FROM {"ProcessOutputRequest".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
