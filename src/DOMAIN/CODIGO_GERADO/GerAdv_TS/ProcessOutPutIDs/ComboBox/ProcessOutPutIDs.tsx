...
<style jsx global>{`
  .processoutputids-dropdown-popup-msi {
  ...
  .processoutputids-dropdown-popup-msi .k-list {
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
    background: white !important;
  ...
  .processoutputids-dropdown-popup-msi .k-list-item {
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
  ...
  .processoutputids-dropdown-popup-msi .k-list-item: hover {
    ...
    <div className={`${cssDado} inputCombobox input-container`}>
      <div className='comboboxLabel'>
        ...
        <div className='comboboxBox'>
          ...
          suggest={true}
          popupSettings={{
            className: 'processoutputids-dropdown-popup-msi'
          }}
          />
