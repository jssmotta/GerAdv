...
const addValorOperador = (e: any) => {
  ...
  const addValorAlerta = (e: any) => {
    if (e?.id>0)
      onChange({ target: { name: 'alerta', value: e.id } });
    };
    const onConfirm = (e: React.FormEvent) => {
      ...
      if (e.stopPropagation) e.stopPropagation();
        ...
        if (!isSubmitting) {
          ...
          console.log('Erro ao submeter formulário de AlertasEnviados:');
    ...
    const handleDirectSave = () => {
      if (!isSubmitting) {
        ...
        console.log('Erro ao salvar AlertasEnviados diretamente');
        setIsSubmitting(false);
        if (onError) onError();
        }
      }
