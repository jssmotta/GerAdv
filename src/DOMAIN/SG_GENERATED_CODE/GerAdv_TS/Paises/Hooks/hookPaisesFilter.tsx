...
interface UsePaisesFilterProps {
    handleFetchWithFilter: (filtro?: FilterPaises | undefined | null) => Promise<void>;
}
...
interface UsePaisesFilterReturn {
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterPaises>) => React.ReactNode;
...
export const usePaisesFilter = ({ handleFetchWithFilter }: UsePaisesFilterProps): UsePaisesFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterPaises>({} as FilterPaises);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterPaises;
