...
export const FornecedoresGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IFornecedores, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-fornecedores'
