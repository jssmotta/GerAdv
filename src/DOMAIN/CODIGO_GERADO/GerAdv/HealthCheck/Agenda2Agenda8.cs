                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAgenda2AgendaDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(ag2Codigo) FROM {"Agenda2Agenda".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) ag2Master,ag2Agenda FROM {"Agenda2Agenda".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
