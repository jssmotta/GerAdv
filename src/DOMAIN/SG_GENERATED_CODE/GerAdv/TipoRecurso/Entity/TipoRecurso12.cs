...
public partial class FTipoRecurso : MenphisSI.SG.GerAdv.DBTipoRecurso, IDBTipoRecurso
{
    // DI-compatible default constructor
    public FTipoRecurso() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FTipoRecurso CreateFromReader(SqlDataReader? dbRec)
    {
        return new FTipoRecurso(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FTipoRecurso CreateFromDataRow(DataRow? dbRec)
    {
        return new FTipoRecurso(dbRec);
    }

    private FTipoRecurso(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FTipoRecurso(DataRow? dbRec) : base(dbRec)
    {
    }

    private FTipoRecurso(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FTipoRecurso CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FTipoRecurso(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FTipoRecurso> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fTipoRecurso = new FTipoRecurso();
        await fTipoRecurso.CarregarAsync(id, oCnn);
        return fTipoRecurso;
    }
