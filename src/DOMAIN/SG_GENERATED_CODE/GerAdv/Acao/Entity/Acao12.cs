...
public partial class FAcao : MenphisSI.SG.GerAdv.DBAcao, IDBAcao
{
    ...
    public static FAcao CreateFromReader(SqlDataReader? dbRec)
    {
        return new FAcao(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FAcao CreateFromDataRow(DataRow? dbRec)
    {
        return new FAcao(dbRec);
    }

    private FAcao(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FAcao(DataRow? dbRec) : base(dbRec)
    {
    }

    private FAcao(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FAcao CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FAcao(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FAcao> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fAcao = new FAcao();
        await fAcao.CarregarAsync(id, oCnn);
        return fAcao;
    }
