...
// useOutrasPartesClienteGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de OutrasPartesCliente
"use client";
...
interface UseOutrasPartesClienteGridProps {
...
export const useOutrasPartesClienteGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IOutrasPartesCliente, filters: Record<string, any>) => {
