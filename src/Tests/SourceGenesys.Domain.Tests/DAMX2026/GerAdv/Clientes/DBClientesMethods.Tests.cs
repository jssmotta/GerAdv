...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBClientes
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBClientesUpdateAdvancedTests : IDisposable
{
    private readonly DBClientes _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBClientesUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBClientes
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBClientes).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBClientes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBClientes instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBClientes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBClientes.PTabelaNome.Should().Be("Clientes");
        DBClientes.CampoCodigo.Should().Be("cliCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBClientes();
        dbRec.ID = 1;
