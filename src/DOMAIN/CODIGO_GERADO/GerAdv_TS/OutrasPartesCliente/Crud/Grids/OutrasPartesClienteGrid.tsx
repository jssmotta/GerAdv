...
const OutrasPartesClienteGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <OutrasPartesClienteGridMobileComponent data={outraspartescliente} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <OutrasPartesClienteGridDesktopComponent data={outraspartescliente} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
