...
#region TableDefinition_Justica
...
#endregion
    public DBJustica(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBJustica(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBJustica(in string? sqlWhere, SqlConnection? oCnn)
    {
