...
import { TipoRecursoApi, TipoRecursoApiError } from "../Apis/TipoRecursoApi";
...
export class TipoRecursoValidator {
  static validateTipoRecurso(tiporecurso: ITipoRecurso): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface ITipoRecursoService {
  ...
  validateTipoRecurso: (tiporecurso: ITipoRecurso) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
