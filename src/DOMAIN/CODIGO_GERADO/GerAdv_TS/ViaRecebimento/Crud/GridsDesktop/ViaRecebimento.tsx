...
interface ViaRecebimentoGridProps {
  data: IViaRecebimento[];
  onRowClick: (viarecebimento: IViaRecebimento) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ViaRecebimentoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IViaRecebimento, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-viarecebimento'
