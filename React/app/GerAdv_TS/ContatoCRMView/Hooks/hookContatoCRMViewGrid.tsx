...
// useContatoCRMViewGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ContatoCRMView
"use client";
...
interface UseContatoCRMViewGridProps {
...
export const useContatoCRMViewGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IContatoCRMView, filters: Record<string, any>) => {
