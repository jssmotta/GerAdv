                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(epaCodigo) FROM {"EventoPrazoAgenda".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) epaNome,epaBold FROM {"EventoPrazoAgenda".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
