...
interface UseProTipoBaixaFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterProTipoBaixa | undefined | null,
  ) => Promise<void>;
}
...
interface UseProTipoBaixaFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterProTipoBaixa>,
  ) => React.ReactNode;
...
export const useProTipoBaixaFilter = ({
  handleFetchWithFilter,
}: UseProTipoBaixaFilterProps): UseProTipoBaixaFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterProTipoBaixa>(
