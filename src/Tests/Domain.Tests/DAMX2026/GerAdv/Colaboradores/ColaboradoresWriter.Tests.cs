...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFColaboradores.VerifySet(x => x.FDtNasc = DateOnly.Parse(colaboradores.DtNasc), Times.Once);
    ...
    public async Task WriteAsync_WithNull_DtNasc_ShouldNotSetFDtNasc()
    {
        ...
        // Assert
        _mockFColaboradores.VerifySet(x => x.FDtNasc = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Delete Tests
    ...
    public async Task Delete_ShouldCallFactoryDeleteAsync()
    {
        ...
        // Act
        await _colaboradoresWriter.DeleteAsync(colaboradoresResponse, operadorId, _mockConnection.Object);
        // Assert
    ...
    public async Task Delete_WithValidParameters_ShouldCompleteSuccessfully()
    {
        ...
        _mockColaboradoresFactory.Setup(x => x.DeleteAsync(operadorId, colaboradoresResponse.Id, _mockConnection.Object)).Returns(Task.CompletedTask);
        // Act
        Func<Task> act = async () => await _colaboradoresWriter.DeleteAsync(colaboradoresResponse, operadorId, _mockConnection.Object);
        // Assert
    ...
    public async Task Delete_WhenFactoryDeleteAsyncFails_ShouldPropagateException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() => _colaboradoresWriter.DeleteAsync(colaboradoresResponse, operadorId, _mockConnection.Object));
        exception.Should().Be(expectedException);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ColaboradoresWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Colaboradores CreateValidColaboradoresModel()
    {
