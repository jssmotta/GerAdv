...
public class FilterGUTPeriodicidadeStatusWithVoiceRequest
{
    /// <summary>
    /// Filtro de GUTPeriodicidadeStatus padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterGUTPeriodicidadeStatus Filter { get; set; } = new();
...
[Serializable]
public partial record FilterGUTPeriodicidadeStatus
{
    ...
    [Description("DataRealizado")]
    public string? DataRealizado { get; set; } = string.Empty;

    [JsonPropertyName("datarealizado_end")]
    [Description("DataRealizado final para intervalo")]
    public string? DataRealizado_end { get; set; } = string.Empty;
