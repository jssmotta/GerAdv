    ...
    []
        ...
        if (isInitialized) return; // Evita múltiplas chamadas    
         ...
         const filtro = {} as FilterEscritorios; 
              ...
              const filtroMem = sessionStorage.getItem(btoa('EscritoriosFilter')) ? JSON.parse(atob(sessionStorage.getItem(btoa('EscritoriosFilter')) ?? '') || '{}') : {} as FilterEscritorios;
      ...
      try {
        ...
        if (response.data) {
          ...
          if (response.data.items && Array.isArray(response.data.items)) {
            ...
            processedFilter = response.data.filter || response.data as FilterEscritorios;
