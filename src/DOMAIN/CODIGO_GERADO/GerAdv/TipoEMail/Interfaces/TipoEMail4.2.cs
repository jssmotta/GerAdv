...
public partial interface ITipoEMailReader
{
    ...
    Task<IEnumerable<TipoEMailResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}