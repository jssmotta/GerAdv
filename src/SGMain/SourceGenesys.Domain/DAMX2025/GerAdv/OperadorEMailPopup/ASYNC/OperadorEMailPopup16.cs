...
public partial class DBOperadorEMailPopup
{
    ...
    /// </summary>
    public static async Task<DBOperadorEMailPopup> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBOperadorEMailPopup();
