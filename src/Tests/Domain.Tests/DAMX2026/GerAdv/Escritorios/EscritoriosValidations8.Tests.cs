...
#region Class Structure Tests
    ...
    private static GerAdv.Models.Escritorios CreateValidEscritorios()
    {
        return new GerAdv.Models.Escritorios
        {
            Id = 1,
            CNPJ = "93016944000138",
            Casa = false,
    ...
    private void SetupValidMocks()
    {
        ...
        _mockEscritoriosService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterEscritorios>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<EscritoriosResponseAll>>.Ok([]));
...
#region CNPJ Validation Tests
    ...
    public async Task ValidateReg_WithDuplicateCNPJ_ShouldThrowSGValidationException()
    {
        ...
        _mockEscritoriosService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterEscritorios>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<EscritoriosResponseAll>>.Ok([existingEscritorios]));
        // Setup other mocks but don't override the Escritorioss service mock
        _ = _mockCidadeReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<CidadeResponse?>(new CidadeResponse { Id = id }));
        // Act & Assert
