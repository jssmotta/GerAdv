...
// useSituacaoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Situacao
"use client";
...
interface UseSituacaoGridProps {
  data: ISituacao[];
...
export const useSituacaoGrid = ({
  ...
  const filterLogic = useCallback(
    (data: ISituacao, filters: Record<string, any>) => {
      const parte_intMatches = applyFilter(
        data,
        "parte_int",
        filters.parte_int,
      );
