...
public partial class FContratos : MenphisSI.SG.GerAdv.DBContratos, IDBContratos
{
    // DI-compatible default constructor
    public FContratos() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FContratos CreateFromReader(SqlDataReader? dbRec)
    {
        return new FContratos(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FContratos CreateFromDataRow(DataRow? dbRec)
    {
        return new FContratos(dbRec);
    }

    private FContratos(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FContratos(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    private FContratos(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FContratos CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FContratos(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
