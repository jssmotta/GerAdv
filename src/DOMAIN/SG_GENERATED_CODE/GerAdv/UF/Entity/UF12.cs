...
public partial class FUF : MenphisSI.SG.GerAdv.DBUF, IDBUF
{
    ...
    public static FUF CreateFromReader(SqlDataReader? dbRec)
    {
        return new FUF(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FUF CreateFromDataRow(DataRow? dbRec)
    {
        return new FUF(dbRec);
    }

    private FUF(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FUF(DataRow? dbRec) : base(dbRec)
    {
    }

    private FUF(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FUF CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FUF(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FUF> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fUF = new FUF();
        await fUF.CarregarAsync(id, oCnn);
        return fUF;
    }
