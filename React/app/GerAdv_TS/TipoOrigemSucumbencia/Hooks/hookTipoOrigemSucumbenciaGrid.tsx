...
// useTipoOrigemSucumbenciaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoOrigemSucumbencia
"use client";
...
interface UseTipoOrigemSucumbenciaGridProps {
...
export const useTipoOrigemSucumbenciaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ITipoOrigemSucumbencia, filters: Record<string, any>) => {
