...
interface OutrasPartesClienteGridProps {
  data: IOutrasPartesCliente[];
  onRowClick: (outraspartescliente: IOutrasPartesCliente) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const OutrasPartesClienteGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IOutrasPartesCliente, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-outraspartescliente'
