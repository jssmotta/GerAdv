...
interface UseContaCorrenteFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterContaCorrente | undefined | null,
  ) => Promise<void>;
}
...
interface UseContaCorrenteFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterContaCorrente>,
  ) => React.ReactNode;
...
export const useContaCorrenteFilter = ({
  handleFetchWithFilter,
}: UseContaCorrenteFilterProps): UseContaCorrenteFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterContaCorrente>(
    ...
    <>
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("dtoriginal", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("dtoriginal_end", value)
        }
      />
      <InputInput
        type="text"
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datapgto", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datapgto_end", value)
        }
      />
      <InputInput
        type="text"
