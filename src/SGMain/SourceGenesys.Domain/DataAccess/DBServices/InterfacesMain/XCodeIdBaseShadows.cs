...
[Serializable]
internal class XCodeIdBaseShadows   //: StylesCad - Deixou o Sistema lento, muitas heranças.
{
    private protected int m_IdRegistro;//, shadowCodigo;26-06-2019
    ...
    public string FShadowDataHora
    {
        ...
        set { (var setUpNow, var changed, var data) = DevourerOne.DateUp12(pFldFShadowDataHora, m_FShadowDataHora, value); if (!setUpNow) return; pFldFShadowDataHora = changed; m_FShadowDataHora = data; }
    }
    /// <summary>
    ...
    public string FShadowVistoDataHora
    {
        ...
        set { (var setUpNow, var changed, var data) = DevourerOne.DateUp12(pFldFShadowVistoDataHora, m_FShadowVistoDataHora, value); if (!setUpNow) return; pFldFShadowVistoDataHora = changed; m_FShadowVistoDataHora = data; }
    }
    /// <summary>
    ...
    public string FShadowViewDataHoraInicio
    {
        ...
        set { (var setUpNow, var changed, var data) = DevourerOne.DateUp12(pFldFShadowViewDataHoraInicio, m_FShadowViewDataHoraInicio, value); if (!setUpNow) return; pFldFShadowViewDataHoraInicio = changed; m_FShadowViewDataHoraInicio = data; }
    }
    /// <summary>
    ...
    public string FShadowViewDataHoraTermino
    {
        ...
        set { (var setUpNow, var changed, var data) = DevourerOne.DateUp12(pFldFShadowViewDataHoraTermino, m_FShadowViewDataHoraTermino, value); if (!setUpNow) return; pFldFShadowViewDataHoraTermino = changed; m_FShadowViewDataHoraTermino = data; }
    }
