...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBAdvogados
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBAdvogadosUpdateAdvancedTests : IDisposable
{
    private readonly DBAdvogados _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBAdvogadosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBAdvogados
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBAdvogados).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBAdvogados).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBAdvogados instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBAdvogados).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBAdvogados.PTabelaNome.Should().Be("Advogados");
        DBAdvogados.CampoCodigo.Should().Be("advCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBAdvogados();
        dbRec.ID = 1;
