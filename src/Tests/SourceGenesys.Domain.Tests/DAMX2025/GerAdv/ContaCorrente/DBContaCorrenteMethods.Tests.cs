...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBContaCorrente
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBContaCorrenteUpdateAdvancedTests : IDisposable
{
    private readonly DBContaCorrente _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBContaCorrenteUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBContaCorrente).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBContaCorrente instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBContaCorrente).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBContaCorrente).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBContaCorrente.PTabelaNome.Should().Be("ContaCorrente");
        DBContaCorrente.CampoCodigo.Should().Be("ctoCodigo");
    }
