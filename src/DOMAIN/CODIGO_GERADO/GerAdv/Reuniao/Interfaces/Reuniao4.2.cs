...
public partial interface IReuniaoReader
{
    ...
    Task<IEnumerable<ReuniaoResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}