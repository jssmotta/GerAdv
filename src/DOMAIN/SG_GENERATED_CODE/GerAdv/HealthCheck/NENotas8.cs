                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(nepCodigo) FROM {"NENotas".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) nepApenso,nepPrecatoria,nepInstancia,nepMovPro,nepNome,nepNotaExpedida,nepRevisada,nepProcesso,nepPalavraChave,nepData,nepNotaPublicada FROM {"NENotas".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
