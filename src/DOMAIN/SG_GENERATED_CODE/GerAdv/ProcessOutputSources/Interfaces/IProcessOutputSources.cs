...
public partial interface IProcessOutputSourcesService
{
    ...
    Task<Filters.FilterProcessOutputSources> FilterVoice([FromBody] Filters.FilterProcessOutputSources filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
