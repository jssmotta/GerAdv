...
#region TableDefinition_ProcessOutputSources
...
#endregion
    public DBProcessOutputSources(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBProcessOutputSources(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBProcessOutputSources(in string? sqlWhere, SqlConnection? oCnn)
    {
