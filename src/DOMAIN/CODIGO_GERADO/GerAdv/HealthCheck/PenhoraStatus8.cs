                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(phsCodigo) FROM {"PenhoraStatus".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) phsNome,phsGuid FROM {"PenhoraStatus".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
