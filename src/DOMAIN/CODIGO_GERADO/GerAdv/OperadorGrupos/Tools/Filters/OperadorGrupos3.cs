...
public class FilterOperadorGruposWithVoiceRequest
{
    /// <summary>
    /// Filtro de OperadorGrupos padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterOperadorGrupos Filter { get; set; } = new();
...
[Serializable]
public partial record FilterOperadorGrupos
{
