...
public partial class AgendaQuemController(IAgendaQuemService agendaquemService) : ControllerBase
{
    ...
    [HttpPost]
    [Authorize]
    public async Task<IActionResult> Filter([FromQuery] int max, [FromBody] Filters.FilterAgendaQuem filtro, [FromRoute, Required] string uri)
    {
        ...
        //_logger.Info("AgendaQuem: Filter called max {0} with filtro = {1}, {2}", max, filtro, uri);
        var result = await _agendaquemService.Filter(max, filtro, uri);
        return Ok(result);
    }
