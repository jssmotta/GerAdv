...
interface OponentesRepLegalGridProps {
  data: IOponentesRepLegal[];
  onRowClick: (oponentesreplegal: IOponentesRepLegal) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const OponentesRepLegalGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IOponentesRepLegal, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-oponentesreplegal'
