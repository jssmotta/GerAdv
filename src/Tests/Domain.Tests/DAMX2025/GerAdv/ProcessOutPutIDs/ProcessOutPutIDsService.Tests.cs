...
public class ProcessOutPutIDsServiceTests : IDisposable
{
    ...
    public ProcessOutPutIDsServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new ProcessOutPutIDsService(_mockAppSettings.Object, _mockProcessOutPutIDsFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
