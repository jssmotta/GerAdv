...
public partial class AgendaRepetirDiasReader
{
    private static string BuildSqlQuery(string campos, string whereClause, string orderClause, int max, MsiSqlConnection? oCnn = null)
    {
        ...
        var orderQuery = $"{TSql.OrderBy} {DBAgendaRepetirDiasDicInfo.CampoCodigo}";
        ...
        var query = $@"SELECT TOP ({max})
                   {campos}
                   FROM {DBAgendaRepetirDias.PTabelaNome.dbo(oCnn)}
