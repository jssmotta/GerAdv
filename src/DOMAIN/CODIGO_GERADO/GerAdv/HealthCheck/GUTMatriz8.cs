                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(gutCodigo) FROM {"GUTMatriz".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) gutDescricao,gutGUTTipo,gutValor FROM {"GUTMatriz".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
