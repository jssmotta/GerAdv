...
// usePreClientesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de PreClientes
"use client";
...
interface UsePreClientesGridProps {
  data: IPreClientes[];
...
export const usePreClientesGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IPreClientes, filters: Record<string, any>) => {
