...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem EqeGUID => new(0, PTabelaNome, CampoCodigo, GUID, 100, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        IsRequired = true,
        Prefixo = "eqe"
    };
