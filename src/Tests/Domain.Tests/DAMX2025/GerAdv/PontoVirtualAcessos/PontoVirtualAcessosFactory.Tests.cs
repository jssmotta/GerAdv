...
public class FPontoVirtualAcessosFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FPontoVirtualAcessosFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FPontoVirtualAcessosFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FPontoVirtualAcessosFactory();
        _mockConnection = new Mock<MsiSqlConnection>();
        _mockReader = new Mock<SqlDataReader>();
        // Prepare a real DataRow with the expected schema (at minimum CampoCodigo: "pvaCodigo")
        var dt = new DataTable();
        dt.Columns.Add("pvaCodigo", typeof(int));
        var row = dt.NewRow();
        // Set as DBNull to allow constructor to return early without requiring all columns
        row["pvaCodigo"] = DBNull.Value;
        dt.Rows.Add(row);
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FPontoVirtualAcessos>();
    }
    ...
    {
        // Arrange
        var factory = new FPontoVirtualAcessosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("pvaCodigo", typeof(int));
        mockDataTable.Columns.Add("pvaOrigem", typeof(string));
        var row = mockDataTable.NewRow();
        row["pvaCodigo"] = testId;
        row["pvaOrigem"] = "Test PontoVirtualAcessos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["pvaCodigo"] = 123;
        row["pvaOrigem"] = "Test PontoVirtualAcessos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FPontoVirtualAcessos properties
        }
    }
