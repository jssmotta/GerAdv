...
interface UseRamalFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterRamal | undefined | null,
  ) => Promise<void>;
}
...
interface UseRamalFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterRamal>,
  ) => React.ReactNode;
...
export const useRamalFilter = ({
  handleFetchWithFilter,
}: UseRamalFilterProps): UseRamalFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterRamal>(
    {} as FilterRamal,
  );
