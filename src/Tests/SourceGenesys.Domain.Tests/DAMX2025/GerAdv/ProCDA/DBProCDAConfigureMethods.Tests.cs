...
#region Fields_All
    ...
    [Fact]
    public void ConfigureUpdateFields_NroInterno_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
