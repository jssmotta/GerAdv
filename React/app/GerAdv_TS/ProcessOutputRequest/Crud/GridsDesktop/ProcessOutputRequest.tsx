...
interface ProcessOutputRequestGridProps {
  data: IProcessOutputRequest[];
  onRowClick: (processoutputrequest: IProcessOutputRequest) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProcessOutputRequestGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProcessOutputRequest, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nomeprocessoutputengine' title='Process Output Engine' sortable={false} filterable={false} />, /* Track G.01 */
  ...
  tableName: 'processoutputrequest'
});
...
{initialized && (
  ...
  className='grid-desktop-processoutputrequest'
