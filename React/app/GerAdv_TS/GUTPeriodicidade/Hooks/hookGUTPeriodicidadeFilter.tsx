...
interface UseGUTPeriodicidadeFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterGUTPeriodicidade | undefined | null,
  ) => Promise<void>;
}
...
interface UseGUTPeriodicidadeFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterGUTPeriodicidade>,
  ) => React.ReactNode;
...
export const useGUTPeriodicidadeFilter = ({
  handleFetchWithFilter,
}: UseGUTPeriodicidadeFilterProps): UseGUTPeriodicidadeFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterGUTPeriodicidade>(
