                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(pcoCodigo) FROM {"ParteClienteOutras".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) pcoCliente,pcoProcesso,pcoPrimeiraReclamada FROM {"ParteClienteOutras".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
