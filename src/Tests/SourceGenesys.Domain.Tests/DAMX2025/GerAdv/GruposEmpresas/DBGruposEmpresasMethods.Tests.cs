...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBGruposEmpresas
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBGruposEmpresasUpdateAdvancedTests : IDisposable
{
    private readonly DBGruposEmpresas _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBGruposEmpresasUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBGruposEmpresas
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBGruposEmpresas).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBGruposEmpresas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBGruposEmpresas instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBGruposEmpresas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBGruposEmpresas.PTabelaNome.Should().Be("GruposEmpresas");
        DBGruposEmpresas.CampoCodigo.Should().Be("grpCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBGruposEmpresas();
        dbRec.ID = 1;
