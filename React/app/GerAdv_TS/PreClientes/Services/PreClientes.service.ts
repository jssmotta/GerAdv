...
export class PreClientesValidator {
  static validatePreClientes(preclientes: IPreClientes): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IPreClientesService {
  ...
  validatePreClientes: (preclientes: IPreClientes) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
