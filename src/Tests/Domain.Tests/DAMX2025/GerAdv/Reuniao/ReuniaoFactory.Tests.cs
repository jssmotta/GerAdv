...
public class FReuniaoFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FReuniao>();
    }
    ...
    {
        // Arrange
        var factory = new FReuniaoFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("renCodigo", typeof(int));
        mockDataTable.Columns.Add("renGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["renCodigo"] = testId;
        row["renGuid"] = "Test Reuniao";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["renCodigo"] = 123;
        row["renGuid"] = "Test Reuniao Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FReuniao properties
        }
    }
