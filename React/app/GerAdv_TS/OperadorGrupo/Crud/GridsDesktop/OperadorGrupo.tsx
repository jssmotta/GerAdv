...
interface OperadorGrupoGridProps {
  data: IOperadorGrupo[];
  onRowClick: (operadorgrupo: IOperadorGrupo) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const OperadorGrupoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IOperadorGrupo, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-operadorgrupo'
