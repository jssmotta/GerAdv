...
interface UseProSucumbenciaFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterProSucumbencia | undefined | null,
  ) => Promise<void>;
}
...
interface UseProSucumbenciaFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterProSucumbencia>,
  ) => React.ReactNode;
...
export const useProSucumbenciaFilter = ({
  handleFetchWithFilter,
}: UseProSucumbenciaFilterProps): UseProSucumbenciaFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterProSucumbencia>(
  ...
  const renderInputFilters = (
    ...
    <>
      ...
      <TipoOrigemSucumbenciaComboBox
        ...
        setValue={(e: any) =>
          handlers.handleComboChange(e, "tipoorigemsucumbencia")
        }
        className="inputSearch inputSearchComboboxTab"
      ...
      <FilterDialogButton
        // passa o objeto nested (pode ser undefined => cast para objeto vazio)
        filter={
          handlers.windowFilter.filterTipoOrigemSucumbencia ??
          ({} as any as any)
        }
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({
            ...prev,
            filterTipoOrigemSucumbencia: f,
          }))
        }
        // ao confirmar, NÃO precisa fazer nada - o setFilter já atualizou
        onConfirm={async (f: any) => {}}
  ...
  const { renderInputFilters: renderTipoOrigemSucumbenciaInputs } =
