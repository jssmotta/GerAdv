...
export interface IGUTAtividadesMatrizService {
  ...
  filterVoice: (filtro?: FilterGUTAtividadesMatriz, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class GUTAtividadesMatrizService implements IGUTAtividadesMatrizService {
  ...
  async filterVoice(filtro?: FilterGUTAtividadesMatriz, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
