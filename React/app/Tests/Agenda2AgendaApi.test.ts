...
import { Agenda2AgendaApiError } from '../GerAdv_TS/Agenda2Agenda/Apis/ApiAgenda2Agenda';
import { Agenda2AgendaApi } from '@/app/GerAdv_TS/Agenda2Agenda/Apis/ApiAgenda2Agenda';
import { FilterAgenda2Agenda } from '../GerAdv_TS/Agenda2Agenda/Filters/Agenda2Agenda';
...
describe('Agenda2AgendaApi', () => {
  let agenda2agendaApi: Agenda2AgendaApi;
  ...
  beforeEach(() => {
    ...
    agenda2agendaApi = new Agenda2AgendaApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(agenda2agendaApi).toBeInstanceOf(Agenda2AgendaApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new Agenda2AgendaApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(Agenda2AgendaApi);
    });
  });
  ...
  describe('getAll', () => {
    ...
    it('should fetch all agenda2agenda items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await agenda2agendaApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(agenda2agendaApi.getAll()).rejects.toThrow(Agenda2AgendaApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await agenda2agendaApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-Agenda2Agenda_last_getAll_${200}`)));
    });
    ...
    it('should decode and return offline data if present in localStorage', async () => {
      ...
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'Agenda2Agenda',
          action: NotifySystemActions.INFO,
        })
      );
    });

    it('should throw Agenda2AgendaApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockAgenda2Agenda = Agenda2AgendaTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockAgenda2Agenda,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch agenda2agenda by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await agenda2agendaApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockAgenda2Agenda));
      ...
      expect(result.data).toEqual(mockAgenda2Agenda);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'Agenda2Agenda',
          id: 1,
  ...
  describe('filter', () => {
    const mockFilter: FilterAgenda2Agenda = {
      funcionario: 1,
      data: '2024-01-01',
    };
    ...
    it('should filter agenda2agenda items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await agenda2agendaApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    const mockAgenda2Agenda: IAgenda2Agenda = {
      id: 0,
      funcionario: 1,
      tipocompromisso: 1,
      fornecedor: 1,
    ...
    it('should add new agenda2agenda successfully', async () => {
      const responseAgenda2Agenda = { ...mockAgenda2Agenda, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responseAgenda2Agenda,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await agenda2agendaApi.addAndUpdate(mockAgenda2Agenda);
    ...
    it('should update existing agenda2agenda successfully', async () => {
      const existingAgenda2Agenda = { ...mockAgenda2Agenda, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingAgenda2Agenda,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await agenda2agendaApi.addAndUpdate(existingAgenda2Agenda);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(agenda2agendaApi.addAndUpdate(mockAgenda2Agenda)).rejects.toThrow(Agenda2AgendaApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'Agenda2Agenda',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete agenda2agenda successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await agenda2agendaApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(agenda2agendaApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'Agenda2Agenda',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(agenda2agendaApi.delete(1)).rejects.toThrow(Agenda2AgendaApiError);
    });
  });

  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterAgenda2Agenda = { funcionario: 1 };
      
      const result = agenda2agendaApi.useFilter(mockFilter);
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await agenda2agendaApi.delete(1);
  ...
  describe('Agenda2AgendaApiError', () => {
    it('should create error with correct properties', () => {
      const error = new Agenda2AgendaApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('Agenda2AgendaApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new Agenda2AgendaApiError('Test message', 500);
