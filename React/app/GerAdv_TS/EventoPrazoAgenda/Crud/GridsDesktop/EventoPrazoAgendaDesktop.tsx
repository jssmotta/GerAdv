...
export const EventoPrazoAgendaGridDesktopComponent = React.memo(
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("eventoprazoagenda-columns-order"),
        );
        if (savedOrder) {
    ...
    const resetColumnsOrder = useCallback(() => {
      ...
      localStorage.removeItem(btoa("eventoprazoagenda-columns-order"));
    }, []);
      ...
      <>
        ...
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-eventoprazoagenda"
