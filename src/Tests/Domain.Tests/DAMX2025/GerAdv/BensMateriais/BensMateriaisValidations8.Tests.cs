...
#region Class Structure Tests
    ...
    private static GerAdv.Models.BensMateriais CreateValidBensMateriais()
    {
        return new GerAdv.Models.BensMateriais
        {
            Id = 1,
            Nome = "João",
            BensClassificacao = 0,
    ...
    private void SetupValidMocks()
    {
        ...
        _ = _mockBensClassificacaoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<BensClassificacaoResponse?>(new BensClassificacaoResponse { Id = id }));
        _ = _mockFornecedoresReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<FornecedoresResponse?>(new FornecedoresResponse { Id = id }));
    ...
    private void SetupValidMocksInvalid()
    {
        ...
        _mockBensMateriaisService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterBensMateriais>(), It.IsAny<string>())).ReturnsAsync([]);
        // Setup other mocks but don't override the BensMateriaiss service mock
        _ = _mockBensClassificacaoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<BensClassificacaoResponse?>(new BensClassificacaoResponse { Id = 0 }));
        _ = _mockFornecedoresReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<FornecedoresResponse?>(new FornecedoresResponse { Id = 0 }));
...
#region DataCompra Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_DataCompra_ShouldPass()
    {
        // Arrange
        var bensmateriais = CreateValidBensMateriais();
...
#region DataFimDaGarantia Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_DataFimDaGarantia_ShouldPass()
    {
        // Arrange
        var bensmateriais = CreateValidBensMateriais();
...
#region DataTerminoDaGarantiaDaLoja Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_DataTerminoDaGarantiaDaLoja_ShouldPass()
    {
        // Arrange
        var bensmateriais = CreateValidBensMateriais();
...
#region Foreign Key Validation Tests - BensClassificacao
    ...
    public async Task ValidateReg_WithInvalidBensClassificacao_ShouldThrowSGValidationException()
    {
        ...
        _mockBensClassificacaoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.BensClassificacaoResponse?>(null !));
    ...
    public async Task ValidateReg_WithMismatchedBensClassificacaoId_ShouldThrowSGValidationException()
    {
        ...
        var bensmateriais = CreateValidBensMateriais();
        bensmateriais.BensClassificacao = 999;
        var reg888 = new GerAdv.Models.Response.BensClassificacaoResponse
        {
            Id = 888
        }; // Different ID
        _mockBensClassificacaoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.BensClassificacaoResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(bensmateriais, _mockBensMateriaisService.Object, _mockBensClassificacaoReader.Object, _mockFornecedoresReader.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidBensClassificacao_ShouldPass()
    {
        ...
        var reg123 = new GerAdv.Models.Response.BensClassificacaoResponse
        {
            Id = 123
        };
        _mockBensClassificacaoReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.BensClassificacaoResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(bensmateriais, _mockBensMateriaisService.Object, _mockBensClassificacaoReader.Object, _mockFornecedoresReader.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object);
        // Assert
...
#region Foreign Key Validation Tests - Fornecedores
    ...
    public async Task ValidateReg_WithInvalidFornecedores_ShouldThrowSGValidationException()
    {
        ...
        _mockFornecedoresReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.FornecedoresResponse?>(null !));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(bensmateriais, _mockBensMateriaisService.Object, _mockBensClassificacaoReader.Object, _mockFornecedoresReader.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithMismatchedFornecedoresId_ShouldThrowSGValidationException()
    {
        ...
        var bensmateriais = CreateValidBensMateriais();
        bensmateriais.Fornecedor = 999;
        var reg888 = new GerAdv.Models.Response.FornecedoresResponse
        {
            Id = 888
        }; // Different ID
        _mockFornecedoresReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.FornecedoresResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(bensmateriais, _mockBensMateriaisService.Object, _mockBensClassificacaoReader.Object, _mockFornecedoresReader.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidFornecedores_ShouldPass()
    {
        ...
        var reg123 = new GerAdv.Models.Response.FornecedoresResponse
        {
            Id = 123
        };
        _mockFornecedoresReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.FornecedoresResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(bensmateriais, _mockBensMateriaisService.Object, _mockBensClassificacaoReader.Object, _mockFornecedoresReader.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object);
        // Assert
