...
export interface IForoService {
  ...
  filterVoice: (filtro?: FilterForo, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ForoService implements IForoService {
  ...
  async filterVoice(filtro?: FilterForo, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
