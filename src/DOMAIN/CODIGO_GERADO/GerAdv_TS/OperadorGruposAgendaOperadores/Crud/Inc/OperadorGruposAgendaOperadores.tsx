...
import { useOperadorGruposAgendaOperadoresForm, useValidationsOperadorGruposAgendaOperadores } from '../../Hooks/hookOperadorGruposAgendaOperadores';
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (savedOperadorGruposAgendaOperadores.id) {
      ...
      setTimeout(() => {
        if (onSuccess) {
          onSuccess(savedOperadorGruposAgendaOperadores);
        }
      }, PDelayApiWrite);
    } else {
    if (onError) {
