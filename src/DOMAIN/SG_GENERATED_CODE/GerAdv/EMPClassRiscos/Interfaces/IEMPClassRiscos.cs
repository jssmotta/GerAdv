...
{
    Task<IEnumerable<EMPClassRiscosResponseAll>> Filter([FromQuery] int max, [FromBody] Filters.FilterEMPClassRiscos filter, [FromRoute, Required] string uri = "");
    Task<Filters.FilterEMPClassRiscos> FilterVoice([FromBody] Filters.FilterEMPClassRiscos filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
