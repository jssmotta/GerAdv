    ...
    public async validation(regPontoVirtualAcessos: IPontoVirtualAcessos): Promise<{ isValid: boolean; message: string } | null> {
        ...
        try {
            await this.circuitBreaker.execute(async () => {
              return await axios.post(`${this.baseUrl}/validation`, regPontoVirtualAcessos as PontoVirtualAcessos, this.getHeaders());
            });
    ...
    public async addAndUpdate(regPontoVirtualAcessos: IPontoVirtualAcessos): Promise<AxiosResponse> {
        ...
        try {
            const result = await this.circuitBreaker.execute(async () => {
              return await axios.post(`${this.baseUrl}/AddAndUpdate`, regPontoVirtualAcessos as PontoVirtualAcessos, this.getHeaders());
            });
