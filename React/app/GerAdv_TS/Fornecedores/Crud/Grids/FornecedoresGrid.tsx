...
const {
  ...
  fetchData, 
  refreshData
} = useFornecedoresList(fornecedoresService);
...
const handleFetchWithFilter = async (filtro?: FilterFornecedores | undefined | null) => {
  setCurrFilter(filtro);
  await fetchData(filtro ?? {} as FilterFornecedores);
};
