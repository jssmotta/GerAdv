                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(forCodigo) FROM {"Fornecedores".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) forGrupo,forNome,forSubGrupo,forTipo,forSexo,forCNPJ,forInscEst,forCPF,forRG,forEndereco,forBairro,forCEP,forCidade,forFone,forFax,forEmail,forSite,forObs,forProdutos,forContatos,forEtiqueta,forBold,forGuid FROM {"Fornecedores".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
