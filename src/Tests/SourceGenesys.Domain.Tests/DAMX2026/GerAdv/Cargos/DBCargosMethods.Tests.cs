...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBCargos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBCargosUpdateAdvancedTests : IDisposable
{
    private readonly DBCargos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBCargosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBCargos
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBCargos).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBCargos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBCargos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBCargos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBCargos.PTabelaNome.Should().Be("Cargos");
        DBCargos.CampoCodigo.Should().Be("carCodigo");
    }
