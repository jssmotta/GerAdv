...
useEffect(() => {
  try {
    const savedOrder = localStorage.getItem(btoa('clientes-columns-order-mobile'));
    if (savedOrder) {
  ...
  if (event.columns) {
    ...
    setColumnsOrder(prevOrder => {
      if (newOrder.length > 0 && JSON.stringify(newOrder) !== JSON.stringify(prevOrder)) {
        ...
        try {
          localStorage.setItem(btoa('clientes-columns-order-mobile'), JSON.stringify(newOrder));
        } catch (error) {
