...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProcessosObsReport
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProcessosObsReportUpdateAdvancedTests : IDisposable
{
    private readonly DBProcessosObsReport _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProcessosObsReportUpdateAdvancedTests()
    {
...
#region Business Logic Tests
    ...
    public void Update_BusinessRule_ValidData_ShouldPassValidation()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FData = TConstantes.TestData;
...
#region State Management Tests
    ...
    public void Update_StateManagement_ShouldPreserveInstanceState()
    {
        ...
        // Assert
        _instance.FData.Should().Be(TConstantes.TestData);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProcessosObsReport).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProcessosObsReport instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProcessosObsReport).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBProcessosObsReport).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProcessosObsReport.PTabelaNome.Should().Be("ProcessosObsReport");
        DBProcessosObsReport.CampoCodigo.Should().Be("prrCodigo");
    }
...
#region Integration-like Tests
    ...
    public void Update_CompleteWorkflow_Insert_ShouldExecuteAllSteps()
    {
        ...
        // Assert
        result.Should().Be(null);
        dbRec.FData.Should().Be(TConstantes.TestData);
