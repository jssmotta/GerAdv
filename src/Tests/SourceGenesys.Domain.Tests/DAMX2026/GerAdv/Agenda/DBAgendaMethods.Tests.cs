...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBAgenda
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBAgendaUpdateAdvancedTests : IDisposable
{
    private readonly DBAgenda _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBAgendaUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBAgenda).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBAgenda instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBAgenda).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBAgenda).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBAgenda.PTabelaNome.Should().Be("Agenda");
        DBAgenda.CampoCodigo.Should().Be("ageCodigo");
    }
