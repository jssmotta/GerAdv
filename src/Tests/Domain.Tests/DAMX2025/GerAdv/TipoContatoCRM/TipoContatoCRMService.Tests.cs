...
public class TipoContatoCRMServiceTests : IDisposable
{
    ...
    public TipoContatoCRMServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new TipoContatoCRMService(_mockAppSettings.Object, _mockTipoContatoCRMFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
