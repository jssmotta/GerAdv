...
export interface IContatoCRMViewService {
  ...
  filterVoice: (filtro?: FilterContatoCRMView, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ContatoCRMViewService implements IContatoCRMViewService {
  ...
  async filterVoice(filtro?: FilterContatoCRMView, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
