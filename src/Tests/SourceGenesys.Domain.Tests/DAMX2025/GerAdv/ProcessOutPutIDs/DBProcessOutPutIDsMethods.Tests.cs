...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProcessOutPutIDs
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProcessOutPutIDsUpdateAdvancedTests : IDisposable
{
    private readonly DBProcessOutPutIDs _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProcessOutPutIDsUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBProcessOutPutIDs
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBProcessOutPutIDs).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProcessOutPutIDs).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProcessOutPutIDs instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProcessOutPutIDs).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProcessOutPutIDs.PTabelaNome.Should().Be("ProcessOutPutIDs");
        DBProcessOutPutIDs.CampoCodigo.Should().Be("poiCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBProcessOutPutIDs();
        dbRec.ID = 1;
