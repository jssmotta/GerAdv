...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem ForEndereco => new(0, PTabelaNome, CampoCodigo, Endereco, 80, "Endereço", "Endereço", EDataTypeSystemInfo.SystemInfoTextAddress, true, false, false, prefixo: "for");
