                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAlarmSMSDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(alrCodigo) FROM {"AlarmSMS".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) alrDescricao,alrHora,alrMinuto,alrD1,alrD2,alrD3,alrD4,alrD5,alrD6,alrD7,alrEMail,alrDesativar,alrToday,alrExcetoDiasFelizes,alrDesktop,alrAlertarDataHora,alrOperador,alrGuidExo,alrAgenda,alrRecado,alrEmocao,alrGUID FROM {"AlarmSMS".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
