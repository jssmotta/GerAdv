...
export const StatusAndamentoGridMobileComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IStatusAndamento, filters: Record<string, any>) => {
...
<>
<Grid
className='grid-mobile-statusandamento'
