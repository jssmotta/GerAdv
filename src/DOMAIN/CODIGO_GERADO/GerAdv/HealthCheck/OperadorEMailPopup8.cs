                ...
                try
                {
                    ...
                    try
                    {
                        if (DBOperadorEMailPopupDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) oepOperador,oepNome,oepSenha,oepSMTP,oepPOP3,oepAutenticacao,oepDescricao,oepUsuario,oepGUID,oepPortaSmtp,oepPortaPop3,oepAssinatura,oepSenha256 FROM {"OperadorEMailPopup".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
