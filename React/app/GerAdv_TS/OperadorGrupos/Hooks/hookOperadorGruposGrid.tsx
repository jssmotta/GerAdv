...
// useOperadorGruposGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de OperadorGrupos
"use client";
...
interface UseOperadorGruposGridProps {
...
export const useOperadorGruposGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IOperadorGrupos, filters: Record<string, any>) => {
