...
#region Test Data Setup Helpers
    ...
    private void SetupMockFAgendaSemana(string? ParaNome = "João", string? Data = "24/04/1975", int? Funcionario = 1, int? Advogado = 1, string? Hora = "04:04", int? TipoCompromisso = 1, string? Compromisso = "", bool? Concluido = false, bool? Liberado = true, bool? Importante = false, string? HoraFinal = "04:04", string? Nome = "João", int? Cliente = 1, string? NomeCliente = "João", string? Tipo = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
    {
        ...
        {
            _mockFAgendaSemana.Setup(f => f.FData).Returns((DateOnly? )null);
        }
        else
        {
            ...
            _mockFAgendaSemana.Setup(f => f.FData).Returns(dateOnly);
        }
        ...
        {
            _mockFAgendaSemana.Setup(f => f.FHora).Returns((TimeOnly? )null);
        }
        else
        {
            TimeOnly horaValue;
            ...
            _mockFAgendaSemana.Setup(f => f.FHora).Returns(horaValue);
        }
        ...
        {
            _mockFAgendaSemana.Setup(f => f.FHoraFinal).Returns((TimeOnly? )null);
        }
        else
        {
            TimeOnly horaValue;
            ...
            _mockFAgendaSemana.Setup(f => f.FHoraFinal).Returns(horaValue);
        }
