...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBStatusAndamento
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBStatusAndamentoUpdateAdvancedTests : IDisposable
{
    private readonly DBStatusAndamento _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusAndamentoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBStatusAndamento
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBStatusAndamento).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBStatusAndamento).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBStatusAndamento instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBStatusAndamento).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBStatusAndamento.PTabelaNome.Should().Be("StatusAndamento");
        DBStatusAndamento.CampoCodigo.Should().Be("sanCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBStatusAndamento();
        dbRec.ID = 1;
