                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(vrbCodigo) FROM {"ViaRecebimento".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) vrbNome FROM {"ViaRecebimento".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
