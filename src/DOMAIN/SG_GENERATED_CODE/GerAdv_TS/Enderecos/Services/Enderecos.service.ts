...
export interface IEnderecosService {
  ...
  filterVoice: (filtro?: FilterEnderecos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class EnderecosService implements IEnderecosService {
  ...
  async filterVoice(filtro?: FilterEnderecos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
