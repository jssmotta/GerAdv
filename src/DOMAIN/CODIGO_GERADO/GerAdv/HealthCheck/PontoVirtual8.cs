                ...
                try
                {
                    ...
                    try
                    {
                        if (DBPontoVirtualDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(pvtCodigo) FROM {"PontoVirtual".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) pvtHoraEntrada,pvtHoraSaida,pvtOperador,pvtKey FROM {"PontoVirtual".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
