...
import { LivroCaixaApiError } from '@/app/GerAdv_TS/LivroCaixa/Apis/ApiLivroCaixa';
...
import { LivroCaixaTestEmpty } from '@/app/GerAdv_TS/Models/LivroCaixa';
...
grupo: 0
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterLivroCaixa = { : 1 };
