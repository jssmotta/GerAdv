...
// useDocumentosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Documentos
"use client";
...
interface UseDocumentosGridProps {
  data: IDocumentos[];
...
export const useDocumentosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("documentos-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IDocumentos, filters: Record<string, any>) => {
