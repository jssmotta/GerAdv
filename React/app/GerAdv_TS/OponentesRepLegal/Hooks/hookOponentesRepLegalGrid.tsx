...
// useOponentesRepLegalGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de OponentesRepLegal
"use client";
...
interface UseOponentesRepLegalGridProps {
...
export const useOponentesRepLegalGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IOponentesRepLegal, filters: Record<string, any>) => {
