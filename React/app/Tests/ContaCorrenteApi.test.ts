...
import { ContaCorrenteApiError } from '@/app/GerAdv_TS/ContaCorrente/Apis/ApiContaCorrente';
...
import { ContaCorrenteTestEmpty } from '@/app/GerAdv_TS/Models/ContaCorrente';
...
datapgto: '24/04/1975'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterContaCorrente = { : 1 };
