...
interface AlarmSMSGridProps {
  data: IAlarmSMS[];
  onRowClick: (alarmsms: IAlarmSMS) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AlarmSMSGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAlarmSMS, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-alarmsms'
