...
public partial interface IBensClassificacaoService
{
    ...
    Task<Filters.FilterBensClassificacao> FilterVoice([FromBody] Filters.FilterBensClassificacao filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
