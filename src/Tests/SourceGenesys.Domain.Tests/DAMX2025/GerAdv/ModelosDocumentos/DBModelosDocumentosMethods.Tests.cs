...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBModelosDocumentos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBModelosDocumentosUpdateAdvancedTests : IDisposable
{
    private readonly DBModelosDocumentos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBModelosDocumentosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBModelosDocumentos
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBModelosDocumentos).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBModelosDocumentos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBModelosDocumentos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBModelosDocumentos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBModelosDocumentos.PTabelaNome.Should().Be("ModelosDocumentos");
        DBModelosDocumentos.CampoCodigo.Should().Be("mdcCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBModelosDocumentos();
        dbRec.ID = 1;
