...
#region Class Structure Tests
    ...
    private void SetupValidMocks()
    {
        ...
        _mockClientesService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterClientes>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<ClientesResponseAll>>.Ok([]));
    ...
    public async Task ValidateReg_WithNullStringFields_ShouldNotThrow()
    {
        ...
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object);
        // Assert
    ...
    {
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(null !, _mockClientesService.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object));
...
#region ValidateReg Required Nome Method Tests 
    ...
    public async Task ValidateReg_WithEmpty_Nome_ShouldThrowSGValidationException()
    {
        ...
        clientes.Nome = "";
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object));
...
#region CPF Validation Tests
    ...
    public async Task ValidateReg_WithDuplicateCPF_ShouldThrowSGValidationException()
    {
        ...
        _mockClientesService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterClientes>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<ClientesResponseAll>>.Ok([existingClientes]));
        // Setup other mocks but don't override the Clientess service mock
        _ = _mockCidadeReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<CidadeResponse?>(new CidadeResponse { Id = id }));
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _validUri, _mockConnection.Object));
