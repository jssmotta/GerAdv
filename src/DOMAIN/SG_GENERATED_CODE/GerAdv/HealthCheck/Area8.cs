                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(areCodigo) FROM {"Area".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) areDescricao,areTop,areGuid FROM {"Area".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
