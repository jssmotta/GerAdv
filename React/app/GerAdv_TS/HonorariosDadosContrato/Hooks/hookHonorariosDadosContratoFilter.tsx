...
interface UseHonorariosDadosContratoFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterHonorariosDadosContrato | undefined | null,
  ) => Promise<void>;
}
...
interface UseHonorariosDadosContratoFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterHonorariosDadosContrato>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterHonorariosDadosContrato>,
  ) => React.ReactNode;
...
export const useHonorariosDadosContratoFilter = ({
  handleFetchWithFilter,
}: UseHonorariosDadosContratoFilterProps): UseHonorariosDadosContratoFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] =
    useState<FilterHonorariosDadosContrato>(
