...
public class TribunalServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task AddAndUpdate_WithValidTribunal_ShouldExerciseWorkflow()
    {
        // Arrange
        var validTribunal = new Models.Tribunal
        {
            Id = 0, // New tribunal
    ...
    {
        var method = typeof(TribunalService).GetMethod(methodName, BindingFlags.NonPublic | BindingFlags.Instance);
        if (method == null)
            return null;
