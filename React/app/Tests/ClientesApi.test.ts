...
import { ClientesApiError } from '@/app/GerAdv_TS/Clientes/Apis/ClientesApi';
...
import { ClientesTestEmpty } from '@/app/GerAdv_TS/Models/Clientes';
...
pessoacontato: 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterClientes = { : 1 };
