...
export interface ICargosService {
  ...
  filterVoice: (filtro?: FilterCargos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class CargosService implements ICargosService {
  ...
  async filterVoice(filtro?: FilterCargos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
