...
import {
  AgendaRelatorioApi,
  AgendaRelatorioApiError,
} from "../Apis/AgendaRelatorioApi";
...
export class AgendaRelatorioValidator {
  static validateAgendaRelatorio(agendarelatorio: IAgendaRelatorio): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IAgendaRelatorioService {
  ...
  saveAgendaRelatorio: (
    agendarelatorio: IAgendaRelatorio,
  ...
  validateAgendaRelatorio: (agendarelatorio: IAgendaRelatorio) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
...
export class AgendaRelatorioService implements IAgendaRelatorioService {
  ...
  async fetchAgendaRelatorioById(id: number): Promise<IAgendaRelatorio> {
    ...
    try {
      ...
      throw new AgendaRelatorioApiError(
        "Erro ao buscar agendarelatorio",
        500,
        "FETCH_ERROR",
        error,
      );
  ...
  async saveAgendaRelatorio(
    ...
    try {
      ...
      throw new AgendaRelatorioApiError(
        "Erro ao salvar agendarelatorio",
        500,
        "SAVE_ERROR",
        error,
      );
  ...
  async deleteAgendaRelatorio(id: number): Promise<void> {
    ...
    try {
      ...
      throw new AgendaRelatorioApiError(
        "Erro ao excluir agendarelatorio",
        500,
        "DELETE_ERROR",
        error,
      );
