...
#region Test Data Setup Helpers
    ...
    private void SetupMockFAdvogados(int? Cargo = 1, string? EMailPro = "test@email.com", string? CPF = "544.506.718-13", string? Nome = "João", string? RG = "12.345.678-9", bool? Casa = false, string? NomeMae = "João", int? Escritorio = 1, bool? Estagiario = true, string? OAB = "AAAAAAAAAA", string? NomeCompleto = "João", string? Endereco = "Rua das Flores, 123", int? Cidade = 1, string? CEP = "01234-567", bool? Sexo = false, string? Bairro = "Centro", string? CTPSSerie = "AAAAAAAA", string? CTPS = "AAAAAAAAAAAAA", string? Fone = "(11) 99999-9999", string? Fax = "(11) 88888-9999", int? Comissao = 1, string? DtInicio = "24/04/1975", string? DtFim = "24/04/1975", string? DtNasc = "24/04/1975", decimal? Salario = 1m, string? Secretaria = "AAAAAAAAAAAAAAAAAA", string? TextoProcuracao = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? EMail = "test@email.com", string? Especializacao = "", string? Pasta = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? Observacao = "Observação teste", string? ContaBancaria = "", bool? ParcTop = true, string? Class = "A", bool? Top = false)
    {
        ...
        {
            _mockFAdvogados.Setup(f => f.FDtInicio).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(DtInicio, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(DtInicio, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFAdvogados.Setup(f => f.FDtInicio).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(DtFim))
        {
            _mockFAdvogados.Setup(f => f.FDtFim).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(DtFim, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(DtFim, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFAdvogados.Setup(f => f.FDtFim).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(DtNasc))
        {
            _mockFAdvogados.Setup(f => f.FDtNasc).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            ...
            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFAdvogados.Setup(f => f.FDtNasc).Returns(dateOnly);
        }
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_DtInicio_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _advogadosWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DtInicio.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDate_DtFim_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _advogadosWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DtFim.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
