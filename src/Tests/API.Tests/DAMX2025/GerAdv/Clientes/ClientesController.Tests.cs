...
#region FilterVoice Tests
    ...
    {
        // Arrange
        var request = new Filters.FilterClientesWithVoiceRequest
        {
            Filter = new Filters.FilterClientes
            {
                Nome = "Test"
            },
            VoiceCommand = new CommandSpeakerRequest
            {
                Message = "buscar clientes com _nome test"
            }
        };
        var expectedFilter = new Filters.FilterClientes
        {
            Nome = "Test"
        };
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterClientes>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ReturnsAsync(expectedFilter);
        // Act
        ...
        _mockService.Verify(x => x.FilterVoice(It.IsAny<Filters.FilterClientes>(), It.IsAny<CommandSpeakerRequest>(), "test-uri"), Times.Once);
    }
    ...
    public async Task FilterVoice_WithNullVoiceCommand_ReturnsOkWithOriginalFilter()
    {
        ...
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterClientes>(), null, "test-uri")).ReturnsAsync(expectedFilter);
        // Act
        var result = await _controller.FilterVoice(request, "test-uri");
        // Assert
        result.Should().BeOfType<OkObjectResult>();
    ...
    public async Task FilterVoice_WithValidVoiceCommand_ProcessesCommand()
    {
        ...
        var request = new Filters.FilterClientesWithVoiceRequest
        {
            ...
            VoiceCommand = new CommandSpeakerRequest
            {
                Message = "buscar clientes gerente"
            }
        };
        var processedFilter = new Filters.FilterClientes
        {
            Nome = "Gerente"
        };
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterClientes>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ReturnsAsync(processedFilter);
        // Act
        var result = await _controller.FilterVoice(request, "test-uri");
        // Assert
        result.Should().BeOfType<OkObjectResult>();
    ...
    public async Task FilterVoice_WhenBulkheadRejects_ReturnsServiceUnavailable()
    {
        ...
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterClientes>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ThrowsAsync(new Polly.Bulkhead.BulkheadRejectedException());
        // Act
        var result = await _controller.FilterVoice(request, "test-uri");
        // Assert
        result.Should().BeOfType<ObjectResult>();
    ...
    public async Task FilterVoice_WhenExceptionOccurs_Rethrows()
    {
        ...
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterClientes>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ThrowsAsync(new Exception("Test exception"));
        // Act & Assert
