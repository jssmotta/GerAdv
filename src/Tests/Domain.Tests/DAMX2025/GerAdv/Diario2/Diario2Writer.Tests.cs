...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFDiario2.VerifySet(x => x.FData = DateOnly.Parse(diario2.Data), Times.Once);
        _mockFDiario2.VerifySet(x => x.FHora = TimeOnly.Parse(diario2.Hora), Times.Once);
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        // Assert
        _mockFDiario2.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new Diario2Writer(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Diario2 CreateValidDiario2Model()
    {
