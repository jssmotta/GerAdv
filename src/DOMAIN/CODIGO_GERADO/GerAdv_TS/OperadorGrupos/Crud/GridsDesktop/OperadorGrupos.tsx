...
interface OperadorGruposGridProps {
  data: IOperadorGrupos[];
  onRowClick: (operadorgrupos: IOperadorGrupos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const OperadorGruposGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IOperadorGrupos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-operadorgrupos'
