...
public partial interface IGUTMatrizReader
{
    ...
    Task<IEnumerable<GUTMatrizResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}