...
export interface IHonorariosDadosContratoService {
  ...
  filterVoice: (filtro?: FilterHonorariosDadosContrato, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class HonorariosDadosContratoService implements IHonorariosDadosContratoService {
  ...
  async filterVoice(filtro?: FilterHonorariosDadosContrato, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
