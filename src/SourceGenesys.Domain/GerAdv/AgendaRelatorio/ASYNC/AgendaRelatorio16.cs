...
if (pFldFParaNome) updateTool.Fields(DBAgendaRelatorioDicInfo.ParaNome, m_FParaNome, ETiposCampos.FString);
if (pFldFParaPessoas) updateTool.Fields(DBAgendaRelatorioDicInfo.ParaPessoas, m_FParaPessoas, ETiposCampos.FString);
if (pFldFBoxAudiencia) updateTool.Fields(DBAgendaRelatorioDicInfo.BoxAudiencia, m_FBoxAudiencia, ETiposCampos.FString);
if (pFldFBoxAudienciaMobile) updateTool.Fields(DBAgendaRelatorioDicInfo.BoxAudienciaMobile, m_FBoxAudienciaMobile, ETiposCampos.FString);
if (pFldFNomeAdvogado) updateTool.Fields(DBAgendaRelatorioDicInfo.NomeAdvogado, m_FNomeAdvogado, ETiposCampos.FString);
if (pFldFNomeForo) updateTool.Fields(DBAgendaRelatorioDicInfo.NomeForo, m_FNomeForo, ETiposCampos.FString);
if (pFldFNomeJustica) updateTool.Fields(DBAgendaRelatorioDicInfo.NomeJustica, m_FNomeJustica, ETiposCampos.FString);
if (pFldFNomeArea) updateTool.Fields(DBAgendaRelatorioDicInfo.NomeArea, m_FNomeArea, ETiposCampos.FString);
