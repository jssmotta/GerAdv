...
import { AgendaApiError } from '@/app/GerAdv_TS/Agenda/Apis/AgendaApi';
import { AgendaApi } from '@/app/GerAdv_TS/Agenda/Apis/AgendaApi';
...
import { AgendaTestEmpty } from '@/app/GerAdv_TS/Models/Agenda';
...
usuariociente: false
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterAgenda = { : 1 };
