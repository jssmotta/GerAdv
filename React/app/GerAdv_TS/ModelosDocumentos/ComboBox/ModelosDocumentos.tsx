...
const ModelosDocumentosComboBox: React.FC<DadosSelectProps> = ({
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await modelosdocumentosService.fetchModelosDocumentosById(id);
  ...
  const handleSuccess = (newModelosDocumentos?: IModelosDocumentos) => {
    if (newModelosDocumentos) {
      setValue({
        id: newModelosDocumentos.id,
        nome: newModelosDocumentos.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <ModelosDocumentosWindow
          ...
          selectedModelosDocumentos={
            editRecord || addRecord || ModelosDocumentosEmpty()
          }
        />
      )}
