...
interface UseEventoPrazoAgendaFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterEventoPrazoAgenda | undefined | null,
  ) => Promise<void>;
}
...
interface UseEventoPrazoAgendaFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterEventoPrazoAgenda>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterEventoPrazoAgenda>,
  ) => React.ReactNode;
...
export const useEventoPrazoAgendaFilter = ({
  handleFetchWithFilter,
}: UseEventoPrazoAgendaFilterProps): UseEventoPrazoAgendaFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterEventoPrazoAgenda>(
