...
export interface IAtividadesService {
  ...
  filterVoice: (filtro?: FilterAtividades, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class AtividadesService implements IAtividadesService {
  ...
  async filterVoice(filtro?: FilterAtividades, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
