...
public class DBProObservacoesUpdate : IDisposable
{
    private readonly DBProObservacoes _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProObservacoesUpdate()
    {
    ...
    {
        // Act
        var proobservacoes = new DBProObservacoes();
        // Assert
        proobservacoes.Should().NotBeNull();
        proobservacoes.ITableName().Should().Be("ProObservacoes");
        proobservacoes.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set proobservacoes.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        proobservacoes.FObservacoes.Should().Be("");
        proobservacoes.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        proobservacoes.FNome = longString; // MAX: 255
        proobservacoes.FGuid = longString; // MAX: 100
        // Assert - All properties should be set proobservacoes.FNome.Should().HaveLength(255);
        proobservacoes.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        proobservacoes.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        proobservacoes.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "pobCodigo = 1";
        // Act & Assert
        var ProObservacoes = new DBProObservacoes(sqlWhere, null);
        ProObservacoes.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var proobservacoes = new DBProObservacoes(parameters, nome, null);
        // Assert
        proobservacoes.Should().NotBeNull();
        proobservacoes.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        proobservacoes.FNome = longName;
        // Assert
        proobservacoes.FNome.Should().HaveLength(255);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBProObservacoes).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void FObservacoes_Property_ShouldAcceptValidNames(string Observacoes)
    {
        ...
        // Assert
        proobservacoes.FObservacoes.Should().Be(Observacoes);
    }
    ...
    public void FObservacoes_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        proobservacoes.FObservacoes.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBProObservacoes).GetField("pFldFObservacoes", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FObservacoes = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var proobservacoes = new DBProObservacoes();
        // Act & Assert
        proobservacoes.TabelaNome.Should().Be("ProObservacoes");
    }
