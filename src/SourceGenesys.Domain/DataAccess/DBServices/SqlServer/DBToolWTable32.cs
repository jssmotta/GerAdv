...
{ 
    ...
    internal StringBuilder BuildSqlCommand(MsiSqlConnection oCnn, bool insertConvertedId)
    {
    ...
    private class UpdateExecutor
    {
        ...
        public UpdateExecutor(DBToolWTable32 parent, MsiSqlConnection connection)
        {
            _parent = parent;
    ...
    private class SqlCommandBuilder
    {
        ...
        public SqlCommandBuilder(DBToolWTable32 parent, MsiSqlConnection connection)
        {
            _parent = parent;
            _connection = connection;
        }
