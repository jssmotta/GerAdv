...
import { CargosEscApiError } from '@/app/GerAdv_TS/CargosEsc/Apis/ApiCargosEsc';
...
import { CargosEscTestEmpty } from '@/app/GerAdv_TS/Models/CargosEsc';
...
classificacao: 0
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterCargosEsc = { : 1 };
