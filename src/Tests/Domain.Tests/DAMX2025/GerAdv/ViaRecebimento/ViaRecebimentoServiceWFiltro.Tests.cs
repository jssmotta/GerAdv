...
{
    public class ViaRecebimentoServiceWFiltroTests : IDisposable
    {
        ...
        private readonly ViaRecebimentoServiceS _serviceS;
        public ViaRecebimentoServiceWFiltroTests()
        {
            ...
            _serviceS = new ViaRecebimentoServiceS();
        ...
        {
            // Arrange
            FilterViaRecebimento? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterViaRecebimento(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_NomeViaRecebimento_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterViaRecebimento
            {
        ...
        [Fact]
        public void WFiltro_NomeViaRecebimento_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterViaRecebimento
            {
        ...
        [Fact]
        public void WFiltro_NomeViaRecebimento_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeViaRecebimento = "João Silva";
            var filtro = new FilterViaRecebimento
            {
                Nome = nomeViaRecebimento,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeViaRecebimento_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterViaRecebimento
            {
        ...
        [Fact]
        public void WFiltro_NomeViaRecebimento_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterViaRecebimento
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeViaRecebimento_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeViaRecebimento)
        {
            // Arrange
            var filtro = new FilterViaRecebimento
            {
        ...
        [Fact]
        public void WFiltro_NomeViaRecebimento_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterViaRecebimento
            {
            ...
            resultado.Value.where.Should().Contain("@vrbNome");
            resultado.Value.where.Should().Contain($"@{DBViaRecebimento.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @vrbNome");
            resultado.Value.where.Should().Contain($"= @{DBViaRecebimento.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeViaRecebimento_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeViaRecebimento = "João Silva";
            var filtro = new FilterViaRecebimento
            ...
            resultado.Value.where.Should().Contain($"[{DBViaRecebimentoDicInfo.PTabelaNome}].[{DBViaRecebimentoDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @vrbNome");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@vrbNome");
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBViaRecebimentoDicInfo.PTabelaNome}].[{DBViaRecebimentoDicInfo.CampoCodigo}] = @{DBViaRecebimentoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBViaRecebimentoDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBViaRecebimentoDicInfo.PTabelaNome}].{DBViaRecebimentoDicInfo.CampoCodigo} BETWEEN @{DBViaRecebimentoDicInfo.CampoCodigo} AND @{DBViaRecebimentoDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBViaRecebimentoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBViaRecebimentoDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBViaRecebimentoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBViaRecebimentoDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBViaRecebimentoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBViaRecebimentoDicInfo.Nome}");
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBViaRecebimentoDicInfo.PTabelaNome}].{DBViaRecebimentoDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBViaRecebimentoDicInfo.PTabelaNome}].{DBViaRecebimentoDicInfo.CampoCodigo} BETWEEN @{DBViaRecebimentoDicInfo.CampoCodigo} AND @{DBViaRecebimentoDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBViaRecebimentoDicInfo.PTabelaNome}].[{DBViaRecebimentoDicInfo.CampoCodigo}] = @{DBViaRecebimentoDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBViaRecebimentoDicInfo.PTabelaNome}].[{DBViaRecebimentoDicInfo.CampoCodigo}]");
        }
