...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void OcultarRelatorio_ShouldAcceptIntegerValues(int value)
{
    _instance.FOcultarRelatorio = value;
    Assert.Equal(value, _instance.FOcultarRelatorio);
}
...
[Fact]
public void OcultarRelatorio_DefaultValue_ShouldBeZero()
{
    var instance = new DBContratos();
    Assert.Equal(0, instance.OcultarRelatorio);
}
*/
    /*
...
[InlineData("31/12/2023")]
[InlineData("15/08/2024")]
public void OcultarRelatorio_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FOcultarRelatorio = dateString;
    Assert.Equal(dateString, _instance.FOcultarRelatorio);
}

[Fact]
public void OcultarRelatorio_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBContratos();
    Assert.Equal(string.Empty, instance.OcultarRelatorio);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("", "")]
public void OcultarRelatorio_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FOcultarRelatorio = input;
        Assert.Equal(expected, _instance.FOcultarRelatorio);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FOcultarRelatorio = input);
    }
}
*/
    /*
...
public void OcultarRelatorio_ValidEmail_ShouldAccept(string email)
{
    _instance.FOcultarRelatorio = email;
    Assert.Equal(email, _instance.FOcultarRelatorio);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void OcultarRelatorio_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FOcultarRelatorio = email);
}
*/
    [Theory]
    [InlineData("", "")]
...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void Avulso_ShouldAcceptIntegerValues(int value)
{
    _instance.FAvulso = value;
    Assert.Equal(value, _instance.FAvulso);
}
...
[Fact]
public void Avulso_DefaultValue_ShouldBeZero()
{
    var instance = new DBContratos();
    Assert.Equal(0, instance.Avulso);
}
*/
    /*
TEMPLATE_DATETIME_FIELD:
...
[InlineData("31/12/2023")]
[InlineData("15/08/2024")]
public void Avulso_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FAvulso = dateString;
    Assert.Equal(dateString, _instance.FAvulso);
}

[Fact]
public void Avulso_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBContratos();
    Assert.Equal(string.Empty, instance.Avulso);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("384.004.020-57", "38400402057")]
[InlineData("", "")]
public void Avulso_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FAvulso = input;
        Assert.Equal(expected, _instance.FAvulso);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FAvulso = input);
    }
}
*/
    /*
...
[InlineData("test@example.com")]
[InlineData("user.name@domain.co.uk")]
public void Avulso_ValidEmail_ShouldAccept(string email)
{
    _instance.FAvulso = email;
    Assert.Equal(email, _instance.FAvulso);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void Avulso_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FAvulso = email);
}
*/
    [Theory]
    [InlineData(true)]
...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void Suspenso_ShouldAcceptIntegerValues(int value)
{
    _instance.FSuspenso = value;
    Assert.Equal(value, _instance.FSuspenso);
}
...
[Fact]
public void Suspenso_DefaultValue_ShouldBeZero()
{
    var instance = new DBContratos();
    Assert.Equal(0, instance.Suspenso);
}
*/
    /*
TEMPLATE_DATETIME_FIELD:
...
[InlineData("31/12/2023")]
[InlineData("15/08/2024")]
public void Suspenso_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FSuspenso = dateString;
    Assert.Equal(dateString, _instance.FSuspenso);
}

[Fact]
public void Suspenso_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBContratos();
    Assert.Equal(string.Empty, instance.Suspenso);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("384.004.020-57", "38400402057")]
[InlineData("", "")]
public void Suspenso_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FSuspenso = input;
        Assert.Equal(expected, _instance.FSuspenso);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FSuspenso = input);
    }
}
*/
    /*
...
[InlineData("test@example.com")]
[InlineData("user.name@domain.co.uk")]
public void Suspenso_ValidEmail_ShouldAccept(string email)
{
    _instance.FSuspenso = email;
    Assert.Equal(email, _instance.FSuspenso);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void Suspenso_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FSuspenso = email);
}
*/
    [Theory]
    [InlineData("", "")]
