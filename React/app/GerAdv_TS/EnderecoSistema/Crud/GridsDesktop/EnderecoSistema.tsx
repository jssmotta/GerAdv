...
interface EnderecoSistemaGridProps {
  data: IEnderecoSistema[];
  onRowClick: (enderecosistema: IEnderecoSistema) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const EnderecoSistemaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nometipoenderecosistema' title='Tipo Endereco Sistema' sortable={false} filterable={false} />, /* Track G.01 */
...
{initialized && (
  ...
  className='grid-desktop-enderecosistema'
