...
public class GUTPeriodicidadeStatusServiceTests : IDisposable
{
    ...
    public GUTPeriodicidadeStatusServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new GUTPeriodicidadeStatusService(_mockAppSettings.Object, _mockGUTPeriodicidadeStatusFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockGUTAtividadesReader.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
