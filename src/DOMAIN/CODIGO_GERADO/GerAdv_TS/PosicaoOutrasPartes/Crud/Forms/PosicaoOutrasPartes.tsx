...
interface PosicaoOutrasPartesFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-PosicaoOutrasPartes' : 'form-container5 form-container-PosicaoOutrasPartes'}>
       
            <form className='formInputCadInc' id={`PosicaoOutrasPartesForm-${posicaooutraspartesData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={posicaooutraspartesData} isSubmitting={isSubmitting} onClose={onClose} formId={`PosicaoOutrasPartesForm-${posicaooutraspartesData.id}`} preventPropagation={true} onSave={handleDirectSave} />
