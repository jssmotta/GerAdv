                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ap2Codigo) FROM {"Apenso2".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ap2Processo,ap2Apensado FROM {"Apenso2".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
