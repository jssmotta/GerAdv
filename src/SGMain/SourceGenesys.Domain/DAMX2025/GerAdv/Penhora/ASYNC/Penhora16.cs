...
public partial class DBPenhora
{
    ...
    /// </summary>
    public static async Task<DBPenhora> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBPenhora();
