...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem AgeFuncionario => new(0, PTabelaNome, CampoCodigo, Funcionario, "Colaborador", "Colaborador", EDataTypeSystemInfo.SystemInfoForeingkey, DBFuncionariosDicInfo.CampoCodigo, DBFuncionariosDicInfo.TabelaNome, new DBFuncionariosODicInfo(), false, prefixo: "age"); // DBI 11 
    ...
    public static DBInfoSystem AgeArea => new(0, PTabelaNome, CampoCodigo, Area, "Área", "Área", EDataTypeSystemInfo.SystemInfoForeingkey, DBAreaDicInfo.CampoCodigo, DBAreaDicInfo.TabelaNome, new DBAreaODicInfo(), false, prefixo: "age"); // DBI 11 
    public static DBInfoSystem AgeJustica => new(0, PTabelaNome, CampoCodigo, Justica, "Justiça", "Justiça", EDataTypeSystemInfo.SystemInfoForeingkey, DBJusticaDicInfo.CampoCodigo, DBJusticaDicInfo.TabelaNome, new DBJusticaODicInfo(), false, prefixo: "age"); // DBI 11 
    ...
    public static DBInfoSystem AgePreposto => new(0, PTabelaNome, CampoCodigo, Preposto, "Preposto", "Preposto", EDataTypeSystemInfo.SystemInfoNumber, prefixo: "age");
