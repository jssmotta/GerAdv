...
public partial class FParceriaProc : MenphisSI.SG.GerAdv.DBParceriaProc, IDBParceriaProc
{
    // DI-compatible default constructor
    public FParceriaProc() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FParceriaProc CreateFromReader(SqlDataReader? dbRec)
    {
        return new FParceriaProc(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FParceriaProc CreateFromDataRow(DataRow? dbRec)
    {
        return new FParceriaProc(dbRec);
    }

    private FParceriaProc(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FParceriaProc(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    private FParceriaProc(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FParceriaProc CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FParceriaProc(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
