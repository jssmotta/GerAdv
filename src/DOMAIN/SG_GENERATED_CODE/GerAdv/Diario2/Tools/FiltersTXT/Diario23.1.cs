...
public static class FilterDiario2TXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar Diario2 em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterDiario2:

- O filter irá filtrar os Diario2 conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterDiario2:(Diario2)
- data: não é a data de cadastramento é a data do Diario2;
- hora: Hora;
...
- Se ouvir "todos os Diario2" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterDiario2? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt Diario2 length: {result.Length}");
#endif
