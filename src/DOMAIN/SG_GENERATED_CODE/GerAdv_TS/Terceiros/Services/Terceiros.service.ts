...
export interface ITerceirosService {
  ...
  filterVoice: (filtro?: FilterTerceiros, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class TerceirosService implements ITerceirosService {
  ...
  async filterVoice(filtro?: FilterTerceiros, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
