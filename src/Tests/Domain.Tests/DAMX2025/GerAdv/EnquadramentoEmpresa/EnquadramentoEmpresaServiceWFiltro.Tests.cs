...
{
    public class EnquadramentoEmpresaServiceWFiltroTests : IDisposable
    {
        ...
        private readonly EnquadramentoEmpresaServiceS _serviceS;
        public EnquadramentoEmpresaServiceWFiltroTests()
        {
            ...
            _serviceS = new EnquadramentoEmpresaServiceS();
            _service = new EnquadramentoEmpresaService(_mockAppSettings.Object, _mockEnquadramentoEmpresaFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockClientesService.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
        ...
        {
            // Arrange
            FilterEnquadramentoEmpresa? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidEnquadramentoEmpresa_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_GuidEnquadramentoEmpresa_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_GuidEnquadramentoEmpresa_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeEnquadramentoEmpresa = "João Silva";
            var filtro = new FilterEnquadramentoEmpresa
            {
                Guid = nomeEnquadramentoEmpresa,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidEnquadramentoEmpresa_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_GuidEnquadramentoEmpresa_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidEnquadramentoEmpresa_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeEnquadramentoEmpresa)
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_GuidEnquadramentoEmpresa_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
            ...
            resultado.Value.where.Should().Contain("@eqeGuid");
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresa.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @eqeGuid");
            resultado.Value.where.Should().Contain($"= @{DBEnquadramentoEmpresa.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidEnquadramentoEmpresa_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeEnquadramentoEmpresa = "João Silva";
            var filtro = new FilterEnquadramentoEmpresa
            ...
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @eqeGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@eqeGuid");
        ...
        [Fact]
        public void WFiltro_NomeEnquadramentoEmpresa_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_NomeEnquadramentoEmpresa_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_NomeEnquadramentoEmpresa_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeEnquadramentoEmpresa = "João Silva";
            var filtro = new FilterEnquadramentoEmpresa
            {
                Nome = nomeEnquadramentoEmpresa,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeEnquadramentoEmpresa_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_NomeEnquadramentoEmpresa_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeEnquadramentoEmpresa_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeEnquadramentoEmpresa)
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
        ...
        [Fact]
        public void WFiltro_NomeEnquadramentoEmpresa_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterEnquadramentoEmpresa
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@eqeNome");
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresa.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @eqeNome");
            resultado.Value.where.Should().Contain($"= @{DBEnquadramentoEmpresa.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeEnquadramentoEmpresa_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeEnquadramentoEmpresa = "João Silva";
            var filtro = new FilterEnquadramentoEmpresa
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @eqeNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@eqeNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemCad}] = @{DBEnquadramentoEmpresaDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBEnquadramentoEmpresaDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.QuemCad} BETWEEN @{DBEnquadramentoEmpresaDicInfo.QuemCad} AND @{DBEnquadramentoEmpresaDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.QuemCad} BETWEEN @{DBEnquadramentoEmpresaDicInfo.QuemCad} AND @{DBEnquadramentoEmpresaDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemCad}] = @{DBEnquadramentoEmpresaDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemCad}] = @eqeQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@eqeQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@eqeQuemCad");
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemAtu}] = @{DBEnquadramentoEmpresaDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBEnquadramentoEmpresaDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.QuemAtu} BETWEEN @{DBEnquadramentoEmpresaDicInfo.QuemAtu} AND @{DBEnquadramentoEmpresaDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.QuemAtu} BETWEEN @{DBEnquadramentoEmpresaDicInfo.QuemAtu} AND @{DBEnquadramentoEmpresaDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemAtu}] = @{DBEnquadramentoEmpresaDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.QuemAtu}] = @eqeQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@eqeQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@eqeQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.CampoCodigo}] = @{DBEnquadramentoEmpresaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBEnquadramentoEmpresaDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.CampoCodigo} BETWEEN @{DBEnquadramentoEmpresaDicInfo.CampoCodigo} AND @{DBEnquadramentoEmpresaDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBEnquadramentoEmpresaDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.CampoCodigo} BETWEEN @{DBEnquadramentoEmpresaDicInfo.CampoCodigo} AND @{DBEnquadramentoEmpresaDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.CampoCodigo}] = @{DBEnquadramentoEmpresaDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBEnquadramentoEmpresaDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBEnquadramentoEmpresaDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.DtCad} BETWEEN @{DBEnquadramentoEmpresaDicInfo.DtCad} AND @{DBEnquadramentoEmpresaDicInfo.DtCad}_end");
        }
        ...
        public void WFiltro_DtCad_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.DtCad}], 103)");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBEnquadramentoEmpresaDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBEnquadramentoEmpresaDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].{DBEnquadramentoEmpresaDicInfo.DtAtu} BETWEEN @{DBEnquadramentoEmpresaDicInfo.DtAtu} AND @{DBEnquadramentoEmpresaDicInfo.DtAtu}_end");
        }
        ...
        public void WFiltro_DtAtu_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.DtAtu}], 103)");
        }
...
#region Visto Filter Tests
        ...
        public void WFiltro_VistoEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBEnquadramentoEmpresaDicInfo.Visto));
            result.Value.where.Should().NotContain(DBEnquadramentoEmpresaDicInfo.Visto);
        }
        ...
        public void WFiltro_VistoHasValidValue_ShouldAddParameterAndWhereClause()
        {
            ...
            result.Should().NotBeNull();
            // Check parameter
            var VistoParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.Visto}");
            VistoParameter.Should().NotBeNull();
            VistoParameter.Value.Should().Be(VistoValue);
            // Check where clause
            result.Value.where.Should().Contain($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.Visto}] = @{DBEnquadramentoEmpresaDicInfo.Visto}");
        }
        ...
        public void WFiltro_VistoWithDifferentValues_ShouldAddCorrectParameterValue()
        {
            ...
            var filtroFemale = new FilterEnquadramentoEmpresa
            {
                Visto = 0
            };
            var resultFemale = _serviceS.WFiltro(filtroFemale);
            resultFemale.Should().NotBeNull();
            var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.Visto}");
            femaleParam.Should().NotBeNull();
            femaleParam.Value.Should().Be(0);
            // Arrange & Act & Assert for Visto = 1 (typically male)
            var filtroMale = new FilterEnquadramentoEmpresa
            {
                Visto = 1
            };
            var resultMale = _serviceS.WFiltro(filtroMale);
            resultMale.Should().NotBeNull();
            var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEnquadramentoEmpresaDicInfo.Visto}");
        ...
        public void WFiltro_VistoAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.where.Should().StartWith($"[{DBEnquadramentoEmpresaDicInfo.PTabelaNome}].[{DBEnquadramentoEmpresaDicInfo.Visto}] = @{DBEnquadramentoEmpresaDicInfo.Visto}");
