...
#region Helper Methods
    ...
    private void SetAllFieldValues()
    {
        ...
        SetFieldValue("m_FData", DateTime.Today.AddDays(10));
        SetFieldValue("m_FHora", DateTime.Today.AddDays(11));
...
#region Fields_All
    ...
    [Fact]
    public void ConfigureUpdateFields_Assunto_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
        ...
        _ligacoes.FAssunto.Should().Be("");
        _ligacoes.FAgeClienteAvisado.Should().Be(0);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_Para_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    [Fact]
    public void ConfigureUpdateFields_Status_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsLigarPara_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _ligacoes.FLigarPara.Should().Be("");
        _ligacoes.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_LigarPara_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
