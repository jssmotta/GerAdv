...
// useProCDAGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProCDA
"use client";
...
export const useProCDAGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IProCDA, filters: Record<string, any>) => {
