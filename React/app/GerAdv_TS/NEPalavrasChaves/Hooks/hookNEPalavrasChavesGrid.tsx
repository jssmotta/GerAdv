...
// useNEPalavrasChavesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de NEPalavrasChaves
"use client";
...
interface UseNEPalavrasChavesGridProps {
...
export const useNEPalavrasChavesGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: INEPalavrasChaves, filters: Record<string, any>) => {
