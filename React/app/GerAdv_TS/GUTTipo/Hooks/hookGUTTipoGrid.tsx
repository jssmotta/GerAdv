...
// useGUTTipoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GUTTipo
"use client";
...
export const useGUTTipoGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IGUTTipo, filters: Record<string, any>) => {
