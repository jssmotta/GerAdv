...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class TipoRecursoServiceWFiltroTests : IDisposable
    {
        ...
        private readonly TipoRecursoServiceS _serviceS;
        public TipoRecursoServiceWFiltroTests()
        {
            ...
            _serviceS = new TipoRecursoServiceS();
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidTipoRecurso_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoRecurso = "João Silva";
            var filtro = new FilterTipoRecurso
            {
                Guid = nomeTipoRecurso,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidTipoRecurso_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoRecurso_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidTipoRecurso_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoRecurso)
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoRecurso_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
            ...
            resultado.Value.where.Should().Contain("@trcGuid");
            resultado.Value.where.Should().Contain($"@{DBTipoRecurso.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @trcGuid");
            resultado.Value.where.Should().Contain($"= @{DBTipoRecurso.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidTipoRecurso_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoRecurso = "João Silva";
            var filtro = new FilterTipoRecurso
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @trcGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@trcGuid");
        ...
        [Fact]
        public void WFiltro_DescricaoTipoRecurso_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoRecurso = "João Silva";
            var filtro = new FilterTipoRecurso
            {
                Descricao = nomeTipoRecurso,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_DescricaoTipoRecurso_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
        ...
        [Fact]
        public void WFiltro_DescricaoTipoRecurso_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_DescricaoTipoRecurso_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoRecurso)
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
        ...
        [Fact]
        public void WFiltro_DescricaoTipoRecurso_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoRecurso
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@trcDescricao");
            resultado.Value.where.Should().Contain($"@{DBTipoRecurso.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @trcDescricao");
            resultado.Value.where.Should().Contain($"= @{DBTipoRecurso.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_DescricaoTipoRecurso_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoRecurso = "João Silva";
            var filtro = new FilterTipoRecurso
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Descricao}]");
            resultado.Value.where.Should().Contain("like @trcDescricao");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@trcDescricao");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemCad}] = @{DBTipoRecursoDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoRecursoDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.QuemCad} BETWEEN @{DBTipoRecursoDicInfo.QuemCad} AND @{DBTipoRecursoDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.QuemCad} BETWEEN @{DBTipoRecursoDicInfo.QuemCad} AND @{DBTipoRecursoDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemCad}] = @{DBTipoRecursoDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemCad}] = @trcQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@trcQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@trcQuemCad");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemAtu}] = @{DBTipoRecursoDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoRecursoDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.QuemAtu} BETWEEN @{DBTipoRecursoDicInfo.QuemAtu} AND @{DBTipoRecursoDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.QuemAtu} BETWEEN @{DBTipoRecursoDicInfo.QuemAtu} AND @{DBTipoRecursoDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemAtu}] = @{DBTipoRecursoDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.QuemAtu}] = @trcQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@trcQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@trcQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Justica_end Tests
        ...
        public void WFiltro_Justica_end_QuandoSomenteValorInicial_SemJusticaEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Justica}] = @{DBTipoRecursoDicInfo.Justica}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoRecursoDicInfo.Justica}");
        ...
        public void WFiltro_Justica_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.Justica} BETWEEN @{DBTipoRecursoDicInfo.Justica} AND @{DBTipoRecursoDicInfo.Justica}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Justica}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Justica}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Justica_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Justica}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Justica}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Justica_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Justica}");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Justica_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.Justica} BETWEEN");
        }
        ...
        public void WFiltro_Justica_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.Justica} BETWEEN @{DBTipoRecursoDicInfo.Justica} AND @{DBTipoRecursoDicInfo.Justica}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Justica_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Justica}] = @{DBTipoRecursoDicInfo.Justica}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Justica Isolated Tests
        ...
        public void WFiltro_Justica_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Justica}]");
        }
        ...
        public void WFiltro_Justica_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Justica}] = @trcJustica");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@trcJustica");
            parametro.Value.Should().Be(valorJustica);
        }
        ...
        public void WFiltro_Justica_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@trcJustica");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Area_end Tests
        ...
        public void WFiltro_Area_end_QuandoSomenteValorInicial_SemAreaEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Area}] = @{DBTipoRecursoDicInfo.Area}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoRecursoDicInfo.Area}");
        ...
        public void WFiltro_Area_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.Area} BETWEEN @{DBTipoRecursoDicInfo.Area} AND @{DBTipoRecursoDicInfo.Area}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Area}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Area}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Area_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Area}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.Area}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Area_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Area}");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Area_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.Area} BETWEEN");
        }
        ...
        public void WFiltro_Area_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.Area} BETWEEN @{DBTipoRecursoDicInfo.Area} AND @{DBTipoRecursoDicInfo.Area}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Area_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Area}] = @{DBTipoRecursoDicInfo.Area}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Area Isolated Tests
        ...
        public void WFiltro_Area_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Area}]");
        }
        ...
        public void WFiltro_Area_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.Area}] = @trcArea");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@trcArea");
            parametro.Value.Should().Be(valorArea);
        }
        ...
        public void WFiltro_Area_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@trcArea");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.CampoCodigo}] = @{DBTipoRecursoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoRecursoDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.CampoCodigo} BETWEEN @{DBTipoRecursoDicInfo.CampoCodigo} AND @{DBTipoRecursoDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBTipoRecursoDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.CampoCodigo} BETWEEN @{DBTipoRecursoDicInfo.CampoCodigo} AND @{DBTipoRecursoDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.CampoCodigo}] = @{DBTipoRecursoDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBTipoRecursoDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBTipoRecursoDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.DtCad} BETWEEN @{DBTipoRecursoDicInfo.DtCad} AND @{DBTipoRecursoDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBTipoRecursoDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBTipoRecursoDicInfo.PTabelaNome}].[{DBTipoRecursoDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBTipoRecursoDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoRecursoDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBTipoRecursoDicInfo.PTabelaNome}].{DBTipoRecursoDicInfo.DtAtu} BETWEEN @{DBTipoRecursoDicInfo.DtAtu} AND @{DBTipoRecursoDicInfo.DtAtu}_end");
        }
