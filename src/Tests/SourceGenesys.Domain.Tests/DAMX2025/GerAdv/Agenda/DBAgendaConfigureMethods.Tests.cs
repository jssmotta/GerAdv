...
#region Helper Methods
    ...
    private void SetAllFieldValues()
    {
        ...
        SetFieldValue("m_FHrFinal", DateTime.Today.AddDays(7));
        SetFieldValue("m_FAdvogado", 123);
        SetFieldValue("m_FEventoGerador", 123);
        SetFieldValue("m_FEventoData", DateTime.Today.AddDays(8));
        SetFieldValue("m_FFuncionario", 123);
        SetFieldValue("m_FData", DateTime.Today.AddDays(9));
        SetFieldValue("m_FEventoPrazo", 123);
        SetFieldValue("m_FHora", DateTime.Today.AddDays(10));
        ...
        SetFieldValue("m_FDataInicioPrazo", DateTime.Today.AddDays(11));
