...
public class ClientesControllerTests
{
    ...
    public async Task GetAll_WithValidParameters_ReturnsOkWithData()
    {
        ...
        _mockService.Setup(x => x.GetAll(max, "test-tenantKey", It.IsAny<CancellationToken>())).ReturnsAsync(ResultApi<IEnumerable<RespAll.ClientesResponseAll>>.Ok(expectedData));
        // Act
        ...
        var resultApi = objectResult?.Value as ResultApi<IEnumerable<RespAll.ClientesResponseAll>>;
    ...
    public async Task Filter_WithValidFilter_ReturnsFilteredData()
    {
        ...
        _mockService.Setup(x => x.Filter(max, filter, "test-tenantKey")).ReturnsAsync(ResultApi<IEnumerable<RespAll.ClientesResponseAll>>.Ok(expectedData));
        // Act
    ...
    public async Task GetById_WithExistingId_ReturnsOkWithData()
    {
        ...
        _mockService.Setup(x => x.GetById(id, "test-tenantKey", It.IsAny<CancellationToken>())).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Ok(expectedData));
        // Act
        ...
        objectResult.Should().NotBeNull();
        objectResult?.StatusCode.Should().Be(200);
        var resultApi = objectResult?.Value as ResultApi<Resp.ClientesResponse>;
        resultApi?.Data.Should().BeEquivalentTo(expectedData);
    }
    ...
    public async Task GetById_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.GetById(id, "test-tenantKey", It.IsAny<CancellationToken>())).ReturnsAsync(ResultApi<Resp.ClientesResponse>.NotFound($"Registro não encontrado para id {id}"));
        // Act
        var actionResult = await _controller.GetById(id, "test-tenantKey");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task AddAndUpdate_WithValidData_ReturnsCreatedWithResult()
    {
        ...
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Clientes>(), "test-tenantKey")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Created(expectedResult));
        // Act
    ...
    public async Task AddAndUpdate_WhenServiceReturnsFail_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Clientes();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Clientes>(), "test-tenantKey")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Fail("Falha ao processar", 400));
        // Act
        var actionResult = await _controller.AddAndUpdate(model, "test-tenantKey");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task AddAndUpdate_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.Clientes();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Clientes>(), "test-tenantKey")).ThrowsAsync(new Exception("Test exception"));
        // Act
        var actionResult = await _controller.AddAndUpdate(model, "test-tenantKey");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task Delete_WithExistingId_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Delete(id, "test-tenantKey")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Ok(expectedResult));
        // Act
    ...
    public async Task Delete_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.Delete(id, "test-tenantKey")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.NotFound("Registro não encontrado"));
        // Act
        var actionResult = await _controller.Delete(id, "test-tenantKey");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task Validation_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Clientes>(), "test-tenantKey")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Ok(expectedResult));
        // Act
    ...
    public async Task Validation_WhenServiceReturnsFail_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Clientes();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Clientes>(), "test-tenantKey")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Fail("Falha na validação", 400));
        // Act
        var actionResult = await _controller.Validation(model, "test-tenantKey");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task Validation_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.Clientes();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Clientes>(), "test-tenantKey")).ThrowsAsync(new Exception("Validation error"));
        // Act
        var actionResult = await _controller.Validation(model, "test-tenantKey");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
