...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTipoRecurso
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTipoRecursoUpdateAdvancedTests : IDisposable
{
    private readonly DBTipoRecurso _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoRecursoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTipoRecurso
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBTipoRecurso).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTipoRecurso).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTipoRecurso instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTipoRecurso).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTipoRecurso.PTabelaNome.Should().Be("TipoRecurso");
        DBTipoRecurso.CampoCodigo.Should().Be("trcCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTipoRecurso();
        dbRec.ID = 1;
