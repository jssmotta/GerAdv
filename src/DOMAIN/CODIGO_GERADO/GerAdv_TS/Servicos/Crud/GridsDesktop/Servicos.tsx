...
interface ServicosGridProps {
  data: IServicos[];
  onRowClick: (servicos: IServicos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ServicosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IServicos, filters: Record<string, any>) => {
...
const openConsultaHorasTrab = (id: number) => {
  router.push(`/pages/horastrab/?servicos=${id}`);
};
...
{initialized && (
  ...
  className='grid-desktop-servicos'
