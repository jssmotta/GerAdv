...
{
    public class FuncaoServiceWFiltroTests : IDisposable
    {
        ...
        private readonly FuncaoServiceS _serviceS;
        public FuncaoServiceWFiltroTests()
        {
        ...
        {
            // Arrange
            var filtro = new FilterFuncao(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_DescricaoFuncao_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterFuncao
            {
        ...
        [Fact]
        public void WFiltro_DescricaoFuncao_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterFuncao
            {
        ...
        [Fact]
        public void WFiltro_DescricaoFuncao_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeFuncao = "João Silva";
            var filtro = new FilterFuncao
            {
                Descricao = nomeFuncao,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_DescricaoFuncao_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterFuncao
            {
        ...
        [Fact]
        public void WFiltro_DescricaoFuncao_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterFuncao
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_DescricaoFuncao_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeFuncao)
        {
            // Arrange
            var filtro = new FilterFuncao
            {
        ...
        [Fact]
        public void WFiltro_DescricaoFuncao_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterFuncao
            {
            ...
            resultado.Value.where.Should().Contain("@funDescricao");
            resultado.Value.where.Should().Contain($"@{DBFuncao.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @funDescricao");
            resultado.Value.where.Should().Contain($"= @{DBFuncao.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_DescricaoFuncao_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeFuncao = "João Silva";
            var filtro = new FilterFuncao
            ...
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.Descricao}]");
            resultado.Value.where.Should().Contain("like @funDescricao");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@funDescricao");
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemCad}] = @{DBFuncaoDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBFuncaoDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.QuemCad} BETWEEN @{DBFuncaoDicInfo.QuemCad} AND @{DBFuncaoDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBFuncaoDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBFuncaoDicInfo.Descricao}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.QuemCad} BETWEEN @{DBFuncaoDicInfo.QuemCad} AND @{DBFuncaoDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemCad}] = @{DBFuncaoDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemCad}] = @funQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemAtu}] = @{DBFuncaoDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBFuncaoDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.QuemAtu} BETWEEN @{DBFuncaoDicInfo.QuemAtu} AND @{DBFuncaoDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBFuncaoDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBFuncaoDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBFuncaoDicInfo.Descricao}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.QuemAtu} BETWEEN @{DBFuncaoDicInfo.QuemAtu} AND @{DBFuncaoDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemAtu}] = @{DBFuncaoDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.QuemAtu}] = @funQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.CampoCodigo}] = @{DBFuncaoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBFuncaoDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.CampoCodigo} BETWEEN @{DBFuncaoDicInfo.CampoCodigo} AND @{DBFuncaoDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBFuncaoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBFuncaoDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBFuncaoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBFuncaoDicInfo.Descricao}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.CampoCodigo} BETWEEN @{DBFuncaoDicInfo.CampoCodigo} AND @{DBFuncaoDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.CampoCodigo}] = @{DBFuncaoDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBFuncaoDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBFuncaoDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.DtCad} BETWEEN @{DBFuncaoDicInfo.DtCad} AND @{DBFuncaoDicInfo.DtCad}_end");
        }
        ...
        public void WFiltro_DtCad_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.DtCad}], 103)");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBFuncaoDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBFuncaoDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].{DBFuncaoDicInfo.DtAtu} BETWEEN @{DBFuncaoDicInfo.DtAtu} AND @{DBFuncaoDicInfo.DtAtu}_end");
        }
        ...
        public void WFiltro_DtAtu_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.DtAtu}], 103)");
        }
...
#region Visto Filter Tests
        ...
        public void WFiltro_VistoEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBFuncaoDicInfo.Visto));
            result.Value.where.Should().NotContain(DBFuncaoDicInfo.Visto);
        }
        ...
        public void WFiltro_VistoHasValidValue_ShouldAddParameterAndWhereClause()
        {
            ...
            result.Should().NotBeNull();
            // Check parameter
            var VistoParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.Visto}");
            VistoParameter.Should().NotBeNull();
            VistoParameter.Value.Should().Be(VistoValue);
            // Check where clause
            result.Value.where.Should().Contain($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.Visto}] = @{DBFuncaoDicInfo.Visto}");
        }
        ...
        public void WFiltro_VistoWithDifferentValues_ShouldAddCorrectParameterValue()
        {
            ...
            var filtroFemale = new FilterFuncao
            {
                Visto = 0
            };
            var resultFemale = _serviceS.WFiltro(filtroFemale);
            resultFemale.Should().NotBeNull();
            var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.Visto}");
            femaleParam.Should().NotBeNull();
            femaleParam.Value.Should().Be(0);
            // Arrange & Act & Assert for Visto = 1 (typically male)
            var filtroMale = new FilterFuncao
            {
                Visto = 1
            };
            var resultMale = _serviceS.WFiltro(filtroMale);
            resultMale.Should().NotBeNull();
            var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBFuncaoDicInfo.Visto}");
        ...
        public void WFiltro_VistoAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.where.Should().StartWith($"[{DBFuncaoDicInfo.PTabelaNome}].[{DBFuncaoDicInfo.Visto}] = @{DBFuncaoDicInfo.Visto}");
