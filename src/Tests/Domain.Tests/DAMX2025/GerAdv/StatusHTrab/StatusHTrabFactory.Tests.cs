...
public class FStatusHTrabFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FStatusHTrab>();
    }
    ...
    {
        // Arrange
        var factory = new FStatusHTrabFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("shtCodigo", typeof(int));
        mockDataTable.Columns.Add("shtDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["shtCodigo"] = testId;
        row["shtDescricao"] = "Test StatusHTrab";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["shtCodigo"] = 123;
        row["shtDescricao"] = "Test StatusHTrab Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FStatusHTrab properties
        }
    }
