...
// useObjetosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Objetos
"use client";
...
export const useObjetosGrid = ({
  ...
  const defaultColumnsOrder = useMemo(
    () => ["nome", "nomejustica", "descricaoarea"],
    [],
  );
  ...
  const filterLogic = useCallback(
    (data: IObjetos, filters: Record<string, any>) => {
