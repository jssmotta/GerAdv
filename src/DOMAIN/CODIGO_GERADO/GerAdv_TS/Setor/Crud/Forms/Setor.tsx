...
interface SetorFormProps {
  ...
  const onPressSalvar = (e: any) => {
    e.preventDefault();
    if (!isSubmitting) {
      const formElement = document.getElementById('SetorForm');
  ...
  <>
        ...
        <div className="form-container5">
            ...
            <form id={`SetorForm-${setorData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={setorData} isSubmitting={isSubmitting} onClose={onClose} formId={`SetorForm-${setorData.id}`} />
