...
// useStatusInstanciaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de StatusInstancia
"use client";
...
interface UseStatusInstanciaGridProps {
...
export const useStatusInstanciaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IStatusInstancia, filters: Record<string, any>) => {
