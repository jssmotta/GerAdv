...
export interface IStatusTarefasService {
  ...
  filterVoice: (filtro?: FilterStatusTarefas, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class StatusTarefasService implements IStatusTarefasService {
  ...
  async filterVoice(filtro?: FilterStatusTarefas, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
