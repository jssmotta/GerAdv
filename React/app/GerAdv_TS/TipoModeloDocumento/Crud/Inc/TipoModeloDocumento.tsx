...
import {
  useTipoModeloDocumentoForm,
  useValidationsTipoModeloDocumento,
} from "../../Hooks/hookTipoModeloDocumento";
...
const TipoModeloDocumentoInc: React.FC<ITipoModeloDocumentoFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadTipoModeloDocumento } =
    useTipoModeloDocumentoForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedTipoModeloDocumento =
        await tipomodelodocumentoService.saveTipoModeloDocumento(data);
