...
import {
  usePosicaoOutrasPartesForm,
  useValidationsPosicaoOutrasPartes,
} from "../../Hooks/hookPosicaoOutrasPartes";
...
const PosicaoOutrasPartesInc: React.FC<IPosicaoOutrasPartesFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadPosicaoOutrasPartes } =
    usePosicaoOutrasPartesForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedPosicaoOutrasPartes =
        await posicaooutraspartesService.savePosicaoOutrasPartes(data);
