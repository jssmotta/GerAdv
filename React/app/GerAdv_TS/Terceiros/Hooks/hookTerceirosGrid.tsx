...
// useTerceirosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Terceiros
"use client";
...
interface UseTerceirosGridProps {
  data: ITerceiros[];
...
export const useTerceirosGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("terceiros-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: ITerceiros, filters: Record<string, any>) => {
