...
{
    public class TipoModeloDocumentoServiceWFiltroTests : IDisposable
    {
        ...
        private readonly TipoModeloDocumentoServiceS _serviceS;
        public TipoModeloDocumentoServiceWFiltroTests()
        {
            ...
            _serviceS = new TipoModeloDocumentoServiceS();
        ...
        {
            // Arrange
            FilterTipoModeloDocumento? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidTipoModeloDocumento_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoModeloDocumento_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoModeloDocumento_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoModeloDocumento = "João Silva";
            var filtro = new FilterTipoModeloDocumento
            {
                Guid = nomeTipoModeloDocumento,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidTipoModeloDocumento_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoModeloDocumento_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidTipoModeloDocumento_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoModeloDocumento)
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_GuidTipoModeloDocumento_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
            ...
            resultado.Value.where.Should().Contain("@tpdGuid");
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumento.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @tpdGuid");
            resultado.Value.where.Should().Contain($"= @{DBTipoModeloDocumento.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidTipoModeloDocumento_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoModeloDocumento = "João Silva";
            var filtro = new FilterTipoModeloDocumento
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @tpdGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@tpdGuid");
        ...
        [Fact]
        public void WFiltro_NomeTipoModeloDocumento_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoModeloDocumento_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoModeloDocumento_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoModeloDocumento = "João Silva";
            var filtro = new FilterTipoModeloDocumento
            {
                Nome = nomeTipoModeloDocumento,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeTipoModeloDocumento_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoModeloDocumento_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeTipoModeloDocumento_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoModeloDocumento)
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoModeloDocumento_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoModeloDocumento
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@tpdNome");
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumento.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @tpdNome");
            resultado.Value.where.Should().Contain($"= @{DBTipoModeloDocumento.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeTipoModeloDocumento_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoModeloDocumento = "João Silva";
            var filtro = new FilterTipoModeloDocumento
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @tpdNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@tpdNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemCad}] = @{DBTipoModeloDocumentoDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoModeloDocumentoDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.QuemCad} BETWEEN @{DBTipoModeloDocumentoDicInfo.QuemCad} AND @{DBTipoModeloDocumentoDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.QuemCad} BETWEEN @{DBTipoModeloDocumentoDicInfo.QuemCad} AND @{DBTipoModeloDocumentoDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemCad}] = @{DBTipoModeloDocumentoDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemCad}] = @tpdQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@tpdQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@tpdQuemCad");
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemAtu}] = @{DBTipoModeloDocumentoDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoModeloDocumentoDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.QuemAtu} BETWEEN @{DBTipoModeloDocumentoDicInfo.QuemAtu} AND @{DBTipoModeloDocumentoDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.QuemAtu} BETWEEN @{DBTipoModeloDocumentoDicInfo.QuemAtu} AND @{DBTipoModeloDocumentoDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemAtu}] = @{DBTipoModeloDocumentoDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.QuemAtu}] = @tpdQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@tpdQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@tpdQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.CampoCodigo}] = @{DBTipoModeloDocumentoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoModeloDocumentoDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.CampoCodigo} BETWEEN @{DBTipoModeloDocumentoDicInfo.CampoCodigo} AND @{DBTipoModeloDocumentoDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBTipoModeloDocumentoDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.CampoCodigo} BETWEEN @{DBTipoModeloDocumentoDicInfo.CampoCodigo} AND @{DBTipoModeloDocumentoDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.CampoCodigo}] = @{DBTipoModeloDocumentoDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBTipoModeloDocumentoDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBTipoModeloDocumentoDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.DtCad} BETWEEN @{DBTipoModeloDocumentoDicInfo.DtCad} AND @{DBTipoModeloDocumentoDicInfo.DtCad}_end");
        }
        ...
        public void WFiltro_DtCad_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.DtCad}], 103)");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBTipoModeloDocumentoDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBTipoModeloDocumentoDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].{DBTipoModeloDocumentoDicInfo.DtAtu} BETWEEN @{DBTipoModeloDocumentoDicInfo.DtAtu} AND @{DBTipoModeloDocumentoDicInfo.DtAtu}_end");
        }
        ...
        public void WFiltro_DtAtu_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.DtAtu}], 103)");
        }
...
#region Visto Filter Tests
        ...
        public void WFiltro_VistoEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBTipoModeloDocumentoDicInfo.Visto));
            result.Value.where.Should().NotContain(DBTipoModeloDocumentoDicInfo.Visto);
        }
        ...
        public void WFiltro_VistoHasValidValue_ShouldAddParameterAndWhereClause()
        {
            ...
            result.Should().NotBeNull();
            // Check parameter
            var VistoParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.Visto}");
            VistoParameter.Should().NotBeNull();
            VistoParameter.Value.Should().Be(VistoValue);
            // Check where clause
            result.Value.where.Should().Contain($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.Visto}] = @{DBTipoModeloDocumentoDicInfo.Visto}");
        }
        ...
        public void WFiltro_VistoWithDifferentValues_ShouldAddCorrectParameterValue()
        {
            ...
            var filtroFemale = new FilterTipoModeloDocumento
            {
                Visto = 0
            };
            var resultFemale = _serviceS.WFiltro(filtroFemale);
            resultFemale.Should().NotBeNull();
            var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.Visto}");
            femaleParam.Should().NotBeNull();
            femaleParam.Value.Should().Be(0);
            // Arrange & Act & Assert for Visto = 1 (typically male)
            var filtroMale = new FilterTipoModeloDocumento
            {
                Visto = 1
            };
            var resultMale = _serviceS.WFiltro(filtroMale);
            resultMale.Should().NotBeNull();
            var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoModeloDocumentoDicInfo.Visto}");
        ...
        public void WFiltro_VistoAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.where.Should().StartWith($"[{DBTipoModeloDocumentoDicInfo.PTabelaNome}].[{DBTipoModeloDocumentoDicInfo.Visto}] = @{DBTipoModeloDocumentoDicInfo.Visto}");
