...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProSucumbencia
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProSucumbenciaUpdateAdvancedTests : IDisposable
{
    private readonly DBProSucumbencia _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProSucumbenciaUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProSucumbencia).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProSucumbencia instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProSucumbencia).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBProSucumbencia).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProSucumbencia.PTabelaNome.Should().Be("ProSucumbencia");
        DBProSucumbencia.CampoCodigo.Should().Be("scbCodigo");
    }
