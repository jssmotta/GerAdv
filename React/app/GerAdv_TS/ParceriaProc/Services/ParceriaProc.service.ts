...
export class ParceriaProcValidator {
  static validateParceriaProc(parceriaproc: IParceriaProc): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IParceriaProcService {
  ...
  validateParceriaProc: (parceriaproc: IParceriaProc) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
