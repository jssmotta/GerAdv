...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem DivJustica => new(0, PTabelaNome, CampoCodigo, Justica, "Justiça", "Justiça", EDataTypeSystemInfo.SystemInfoForeingkey, DBJusticaDicInfo.CampoCodigo, DBJusticaDicInfo.TabelaNome, new DBJusticaODicInfo(), false, prefixo: "div"); // DBI 11 
    ...
    public static DBInfoSystem DivArea => new(0, PTabelaNome, CampoCodigo, Area, "Área", "Área", EDataTypeSystemInfo.SystemInfoForeingkey, DBAreaDicInfo.CampoCodigo, DBAreaDicInfo.TabelaNome, new DBAreaODicInfo(), false, prefixo: "div", isRequired: true); // DBI 11 
    ...
    public static DBInfoSystem DivEndereco => new(0, PTabelaNome, CampoCodigo, Endereco, 40, "Endereço", "Endereço", EDataTypeSystemInfo.SystemInfoTextAddress, true, false, false, prefixo: "div");
