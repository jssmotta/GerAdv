                ...
                try
                {
                    ...
                    try
                    {
                        if (DBTipoValorProcessoDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(ptvCodigo) FROM {"TipoValorProcesso".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) ptvDescricao,ptvGUID FROM {"TipoValorProcesso".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
