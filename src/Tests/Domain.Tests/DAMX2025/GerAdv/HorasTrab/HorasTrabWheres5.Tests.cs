...
#region Test Data Setup Helpers
    ...
    private void SetupMockFHorasTrab(int? IDContatoCRM = 1, bool? Honorario = false, int? IDAgenda = 1, string? Data = "24/04/1975", int? Cliente = 1, int? Status = 1, int? Processo = 1, int? Advogado = 1, int? Funcionario = 1, string? HrIni = "AAA", string? HrFim = "AAA", decimal? Tempo = 1m, decimal? Valor = 1m, string? OBS = "", string? Anexo = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? AnexoComp = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? AnexoUNC = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", int? Servico = 1)
    {
        ...
        {
            _mockFHorasTrab.Setup(f => f.FData).Returns((DateOnly? )null);
        }
        else
        {
            ...
            _mockFHorasTrab.Setup(f => f.FData).Returns(dateOnly);
        }
...
#region Integration Tests
    ...
    public void Read_ShouldPassCorrectParametersToFactory()
    {
        ...
        var parameters = new List<SqlParameter>
        {
            new SqlParameter($"@{DBHorasTrabDicInfo.CampoNome}", TConstantes.TestData),
        };
        SetupMockFHorasTrab();
        _mockHorasTrabFactory.Setup(f => f.CreateFromParameters(parameters, _mockConnection.Object, "", "", where, "")).Returns(_mockFHorasTrab.Object);
        // Act
...
#region DateTime Tests
    ...
    public void Read_WithValidDateDataFields_ShouldParseAndSetDateProperties()
    {
        ...
        SetupMockFHorasTrab(Data: testDate);
        _mockHorasTrabFactory.Setup(f => f.CreateFromParameters(parameters, _mockConnection.Object, "", "", where, "")).Returns(_mockFHorasTrab.Object);
        // Act
        var result = _horastrabWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
    ...
    public void Read_WithValidDate_Data_Formats_ShouldParseCorrectly(string dateString)
    {
        ...
        SetupMockFHorasTrab(Data: dateString);
        _mockHorasTrabFactory.Setup(f => f.CreateFromParameters(parameters, _mockConnection.Object, "", "", where, "")).Returns(_mockFHorasTrab.Object);
        // Act
        var result = _horastrabWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
