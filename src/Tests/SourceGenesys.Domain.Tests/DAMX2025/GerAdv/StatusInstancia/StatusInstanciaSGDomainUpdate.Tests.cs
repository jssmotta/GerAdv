...
public class DBStatusInstanciaUpdate : IDisposable
{
    private readonly DBStatusInstancia _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusInstanciaUpdate()
    {
    ...
    {
        // Act
        var statusinstancia = new DBStatusInstancia();
        // Assert
        statusinstancia.Should().NotBeNull();
        statusinstancia.ITableName().Should().Be("StatusInstancia");
        statusinstancia.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set statusinstancia.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        statusinstancia.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        statusinstancia.FNome = longString; // MAX: 80
        statusinstancia.FGuid = longString; // MAX: 100
        // Assert - All properties should be set statusinstancia.FNome.Should().HaveLength(80);
        statusinstancia.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        statusinstancia.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        statusinstancia.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "istCodigo = 1";
        // Act & Assert
        var StatusInstancia = new DBStatusInstancia(sqlWhere, null);
        StatusInstancia.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var statusinstancia = new DBStatusInstancia(parameters, nome, null);
        // Assert
        statusinstancia.Should().NotBeNull();
        statusinstancia.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        statusinstancia.FNome = longName;
        // Assert
        statusinstancia.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBStatusInstancia).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var statusinstancia = new DBStatusInstancia();
        // Act & Assert
        statusinstancia.TabelaNome.Should().Be("StatusInstancia");
    }
