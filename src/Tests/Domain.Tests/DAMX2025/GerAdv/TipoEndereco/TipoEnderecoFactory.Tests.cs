...
public class FTipoEnderecoFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FTipoEnderecoFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FTipoEnderecoFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FTipoEnderecoFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTipoEndereco>();
    }
    ...
    {
        // Arrange
        var factory = new FTipoEnderecoFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        row["tipDescricao"] = "Test TipoEndereco";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["tipCodigo"] = 123;
        row["tipDescricao"] = "Test TipoEndereco Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTipoEndereco properties
        }
    }
