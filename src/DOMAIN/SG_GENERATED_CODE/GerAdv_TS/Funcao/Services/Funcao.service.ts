...
export interface IFuncaoService {
  ...
  filterVoice: (filtro?: FilterFuncao, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class FuncaoService implements IFuncaoService {
  ...
  async filterVoice(filtro?: FilterFuncao, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
