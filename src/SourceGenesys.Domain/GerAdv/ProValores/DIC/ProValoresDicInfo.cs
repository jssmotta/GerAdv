...
#region PropriedadesDaTabela
    public static DBInfoSystem PrvProcesso => new(0, PTabelaNome, CampoCodigo, Processo, "Processo", "Processo", ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false)
    {
        IsRequired = true,
        Prefixo = "prv"
    }; // DBI 11 
    ...
    public static DBInfoSystem PrvGUID => new(0, PTabelaNome, CampoCodigo, GUID, 50, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "prv"
    };
