...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class ProcessOutputSourcesServiceWFiltroTests : IDisposable
    {
        ...
        private readonly ProcessOutputSourcesServiceS _serviceS;
        public ProcessOutputSourcesServiceWFiltroTests()
        {
            ...
            _serviceS = new ProcessOutputSourcesServiceS();
            _service = new ProcessOutputSourcesService(_mockAppSettings.Object, _mockProcessOutputSourcesFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBProcessOutputSourcesDicInfo.Nome}");
