...
Instruções para preenchimento do FilterGruposEmpresas:

- O filter irá filtrar os GruposEmpresas conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterGruposEmpresas:(Grupos Empresas)
- email: EMail;
- inativo: Inativo;
...
- Se ouvir "todos os GruposEmpresas" ou similar, deixe todos os campos com valores padrão;
