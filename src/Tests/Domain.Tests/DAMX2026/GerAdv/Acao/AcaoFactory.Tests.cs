...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("acaCodigo", typeof(int));
        mockDataTable.Columns.Add("acaDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["acaCodigo"] = testId;
        row["acaDescricao"] = "Test Acao";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["acaCodigo"] = 123;
        row["acaDescricao"] = "Test Acao Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FAcao properties
        }
    }
