...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBSituacao
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBSituacaoUpdateAdvancedTests : IDisposable
{
    private readonly DBSituacao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBSituacaoUpdateAdvancedTests()
    {
...
#region Business Logic Tests
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBSituacao
            {
                ID = 0,
                FParte_Int = $"N{i}"};
            var fieldInfo = typeof(DBSituacao).GetField("pFldFParte_Int", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void Update_WithValid_Parte_Int_Values_ShouldNotThrow(string nome)
    {
        // Arrange
        _instance.ID = 0;
        _instance.FParte_Int = nome;
        int? result = null;
        // Act
    ...
    [Fact]
    public void Update_BusinessRule_Empty_Parte_Int_ShouldEnforceValidation()
    {
        // Arrange
        _instance.ID = 1;
    ...
    public void Update_WithMinimumValidData_ShouldWork()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FParte_Int = "A"; // Minimum valid name
    ...
    public void Update_AfterMultiplePropertyChanges_ShouldTrackChangesCorrectly()
    {
        // Arrange
        _instance.ID = 1;
        _instance.FParte_Int = "Initial Name";
        // Change the name multiple times
        _instance.FParte_Int = "AAAAAAAAAAAAAAAAAAAAAAAAAAAA";
        _instance.FParte_Int = "BBBBBBBBBBBBBBBBBBBBBBBBBBB";
        _instance.FParte_Int = "CCCCCCCCCCCCCCCCCCCCCCCCCCCCc";
        // Act & Assert
    ...
    [Fact]
    public void Update_BusinessRule_ValidParte_Int_ShouldPassValidation()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FParte_Int = "AAAAAAAAAAAAAAAAAAAAAAAAAAAA";
        SetFieldChanged("pFldFParte_Int", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
...
#region State Management Tests
    ...
    public void Update_StateManagement_ShouldPreserveInstanceState()
    {
        ...
        // Assert
        _instance.FParte_Int.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBSituacao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBSituacao instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBSituacao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#endregion
#region Empty Parte_Int Validation Tests
#endregion
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        _instance.ID = 1;
        _instance.FParte_Int = "AAAAAAAAAAAAAAAAAAAAAAAAAAAA";
        // Ensure pFldFParte_Int is false (no changes)
        var fieldInfo = typeof(DBSituacao).GetField("pFldFParte_Int", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBSituacao.PTabelaNome.Should().Be("Situacao");
        DBSituacao.CampoCodigo.Should().Be("sitCodigo");
    }
...
#region Integration-like Tests
    ...
    public void Update_CompleteWorkflow_Insert_ShouldExecuteAllSteps()
    {
        ...
        // Assert
        result.Should().Be(null);
        dbRec.FParte_Int.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
#endregion
    [Fact]
    public void Update_Boundary_MaxLengthParte_Int()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FParte_Int = new string ('A', 30); // Maximum length
        SetFieldChanged("pFldFParte_Int", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FParte_Int.Length.Should().Be(30);
    }

    [Fact]
    public void Update_Boundary_MinimumValidParte_Int()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FParte_Int = "A"; // Minimum valid length
        SetFieldChanged("pFldFParte_Int", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FParte_Int.Should().Be("A");
    }
    ...
    public void Update_ComplexScenario_MultipleChangesInSequence()
    {
        ...
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FParte_Int.Should().Be("CCCCCCCCCCCCCCCCCCCCCCCCCCCCc");
    }
    ...
    [InlineData("\t", null)]
    [InlineData("\n", null)]
    public void Update_ErrorScenario_InvalidParte_IntValues_ShouldThrowException(string? invalidParte_Int, int? retValue)
    {
        // Arrange
        using var dbRec = new DBSituacao();
        dbRec.ID = 1;
        dbRec.FParte_Int = invalidParte_Int;
        int? result = null;
        // Act & Assert
        if (retValue == null)
        {
    ...
    [Fact]
    public void Update_WithMaxLengthParte_Int_ShouldBeHandledCorrectly()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FParte_Int = new string ('A', 30); // Max length for Parte_Int
        int? result = null;
        // Act
        var exception = Record.Exception(() => result = _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    ...
    [Fact]
    public void Update_WithWhitespaceOnlyParte_Int_ShouldThrowException()
    {
        // Arrange
        _instance.FParte_Int = "   ";
        _instance.ID = 1;
    ...
    [Fact]
    public void Update_WithEmptyParte_Int_ShouldThrowException()
    {
        // Arrange
        _instance.FParte_Int = "";
        _instance.ID = 1;
...
#region Integration-Style Tests
    ...
    public void Update_Integration_FullCRUDCycle()
    {
        ...
        exception.Should().NotBeNull();
        // UPDATE
        dbRec.FParte_Int = "BBBBBBBBBBBBBBBBBBBBBBBBBBB";
        dbRec.ID = 1;
        ...
        dbRec.FParte_Int.Should().Be("BBBBBBBBBBBBBBBBBBBBBBBBBBB");
    }

#endregion
    [Fact]
    public void Update_WithNullParte_Int_ShouldThrowException()
    {
        // Arrange
