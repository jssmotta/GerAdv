...
interface AreaFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-Area' : 'form-container5 form-container-Area'}>
       
            <form className='formInputCadInc' id={`AreaForm-${areaData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={areaData} isSubmitting={isSubmitting} onClose={onClose} formId={`AreaForm-${areaData.id}`} preventPropagation={true} onSave={handleDirectSave} />
