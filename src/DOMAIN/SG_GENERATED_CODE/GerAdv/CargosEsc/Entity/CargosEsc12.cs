...
public partial class FCargosEsc : MenphisSI.SG.GerAdv.DBCargosEsc, IDBCargosEsc
{
    // DI-compatible default constructor
    public FCargosEsc() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FCargosEsc CreateFromReader(SqlDataReader? dbRec)
    {
        return new FCargosEsc(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FCargosEsc CreateFromDataRow(DataRow? dbRec)
    {
        return new FCargosEsc(dbRec);
    }

    private FCargosEsc(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FCargosEsc(DataRow? dbRec) : base(dbRec)
    {
    }

    private FCargosEsc(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FCargosEsc CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FCargosEsc(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FCargosEsc> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fCargosEsc = new FCargosEsc();
        await fCargosEsc.CarregarAsync(id, oCnn);
        return fCargosEsc;
    }
