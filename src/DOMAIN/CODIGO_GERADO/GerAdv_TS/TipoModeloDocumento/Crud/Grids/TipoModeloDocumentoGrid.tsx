...
const TipoModeloDocumentoGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <TipoModeloDocumentoGridMobileComponent data={tipomodelodocumento} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <TipoModeloDocumentoGridDesktopComponent data={tipomodelodocumento} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
