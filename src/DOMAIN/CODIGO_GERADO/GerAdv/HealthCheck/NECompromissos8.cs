                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ncpCodigo) FROM {"NECompromissos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ncpPalavraChave,ncpProvisionar,ncpTipoCompromisso,ncpTextoCompromisso,ncpBold FROM {"NECompromissos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
