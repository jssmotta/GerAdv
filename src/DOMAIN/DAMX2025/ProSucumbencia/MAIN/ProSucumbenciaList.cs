...
#region ListarDados_ProSucumbencia
    public static async IAsyncEnumerable<DBProSucumbencia> ListarAsync(string? cSqlMain, string? cWhere, string? cOrder, string? cCnn)
    {
        ...
        {
            yield return new DBProSucumbencia(dbRec);
        }
    }

    public static IEnumerable<DBProSucumbencia> Listar(string? cSqlMain, string? cWhere, string? cOrder, string? cCnn)
    {
        var cSql = new StringBuilder(); // checkpoint 0x3
        if (!cSqlMain.IsEmpty())
        {
