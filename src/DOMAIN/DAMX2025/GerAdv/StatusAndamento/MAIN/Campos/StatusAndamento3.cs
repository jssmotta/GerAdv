...
{
    [XmlIgnore]
    private protected bool pFldFNome, pFldFIcone, pFldFBold;
    [XmlIgnore]
    ...
    [StringLength(80, ErrorMessage = "A propriedade FNome da tabela StatusAndamento deve ter no máximo 80 caracteres.")]
    public string? FNome
    {
