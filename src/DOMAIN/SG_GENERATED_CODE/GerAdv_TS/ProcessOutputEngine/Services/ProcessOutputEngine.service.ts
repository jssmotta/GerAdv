...
export interface IProcessOutputEngineService {
  ...
  filterVoice: (filtro?: FilterProcessOutputEngine, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ProcessOutputEngineService implements IProcessOutputEngineService {
  ...
  async filterVoice(filtro?: FilterProcessOutputEngine, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
