...
// useUltimosProcessosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de UltimosProcessos
'use client';
...
interface UseUltimosProcessosGridProps {
...
export const useUltimosProcessosGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('ultimosprocessos-columns-order'), JSON.stringify(reorderableFields));
