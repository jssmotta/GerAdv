...
export interface IEMPClassRiscosService {
  ...
  filterVoice: (filtro?: FilterEMPClassRiscos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class EMPClassRiscosService implements IEMPClassRiscosService {
  ...
  async filterVoice(filtro?: FilterEMPClassRiscos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
