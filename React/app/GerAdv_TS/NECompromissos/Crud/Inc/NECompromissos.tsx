...
const NECompromissosInc: React.FC<INECompromissosFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedNECompromissos =
        await necompromissosService.saveNECompromissos(data);
