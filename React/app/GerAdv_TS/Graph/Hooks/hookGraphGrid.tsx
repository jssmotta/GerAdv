...
// useGraphGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Graph
"use client";
...
export const useGraphGrid = ({
  ...
  const defaultColumnsOrder = useMemo(() => ["id"], []);
  ...
  const filterLogic = useCallback(
    (data: IGraph, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
