...
const TipoOrigemSucumbenciaComboBox: React.FC<DadosSelectProps> = ({
  ...
  const [editRecord, setEditRecord] = useState<ITipoOrigemSucumbencia | null>(
    null,
  );
  const [addRecord, setAddRecord] = useState<ITipoOrigemSucumbencia | null>(
    null,
  );
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await tipoorigemsucumbenciaService.fetchTipoOrigemSucumbenciaById(id);
  ...
  const handleSuccess = (newTipoOrigemSucumbencia?: ITipoOrigemSucumbencia) => {
    if (newTipoOrigemSucumbencia) {
      setValue({
        id: newTipoOrigemSucumbencia.id,
        nome: newTipoOrigemSucumbencia.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <TipoOrigemSucumbenciaWindow
          ...
          selectedTipoOrigemSucumbencia={
            editRecord || addRecord || TipoOrigemSucumbenciaEmpty()
          }
        />
      )}
