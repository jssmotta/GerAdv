...
#region TableDefinition_ModelosDocumentos
...
#endregion
    public DBModelosDocumentos(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBModelosDocumentos(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBModelosDocumentos(in string? sqlWhere, SqlConnection? oCnn)
    {
