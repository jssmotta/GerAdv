...
interface UseCargosEscClassFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterCargosEscClass | undefined | null,
  ) => Promise<void>;
}
...
interface UseCargosEscClassFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterCargosEscClass>,
  ) => React.ReactNode;
...
export const useCargosEscClassFilter = ({
  handleFetchWithFilter,
}: UseCargosEscClassFilterProps): UseCargosEscClassFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterCargosEscClass>(
