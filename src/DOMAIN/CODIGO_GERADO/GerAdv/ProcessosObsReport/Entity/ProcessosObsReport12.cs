...
public partial class FProcessosObsReport : MenphisSI.SG.GerAdv.DBProcessosObsReport, IDBProcessosObsReport
{
    ...
    private FProcessosObsReport(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FProcessosObsReport CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FProcessosObsReport(parameters, oCnn, fullSql, sqlWhere, join);
    }
