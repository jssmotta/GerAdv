...
public static class FilterTipoEnderecoSistemaTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar TipoEnderecoSistema em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterTipoEnderecoSistema:

- O filter irá filtrar os TipoEnderecoSistema conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterTipoEnderecoSistema:(Tipo Endereco Sistema)
- nome: _nome ou descrição para Tipo Endereco Sistema;
...
- Se ouvir "todos os TipoEnderecoSistema" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterTipoEnderecoSistema? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt TipoEnderecoSistema length: {result.Length}");
#endif
