...
const EventoPrazoAgendaInc: React.FC<IEventoPrazoAgendaFormProps> = ({
  ...
  const { data, handleChange, loadEventoPrazoAgenda } =
    useEventoPrazoAgendaForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedEventoPrazoAgenda =
        await eventoprazoagendaService.saveEventoPrazoAgenda(data);
