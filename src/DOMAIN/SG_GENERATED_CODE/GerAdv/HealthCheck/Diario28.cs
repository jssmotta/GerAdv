                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(diaCodigo) FROM {"Diario2".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) diaData,diaHora,diaOperador,diaNome,diaOcorrencia,diaCliente,diaBold,diaGuid FROM {"Diario2".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
