...
public partial interface ITipoProDespositoReader
{
    ...
    Task<IEnumerable<TipoProDespositoResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}