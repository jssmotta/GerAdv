                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ojtCodigo) FROM {"Objetos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ojtJustica,ojtArea,ojtNome,ojtBold,ojtGuid FROM {"Objetos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
