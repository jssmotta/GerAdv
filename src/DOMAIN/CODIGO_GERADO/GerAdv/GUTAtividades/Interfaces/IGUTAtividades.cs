...
public partial interface IGUTAtividadesService
{
    ...
    Task<Filters.FilterGUTAtividades> FilterVoice([FromBody] Filters.FilterGUTAtividades filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
