...
public partial class DBDiario2
{
    ...
    /// </summary>
    public static async Task<DBDiario2> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBDiario2();
