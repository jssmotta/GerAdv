...
#region SMART_SQLServices 
    ...
    public static string CompletedDiff(int id) => Completed.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string CompletedSql(int id) => Completed.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string CompletedIsNull => Completed.SqlCmdIsNull() ?? string.Empty;
    public static string CompletedNotIsNull => Completed.SqlCmdNotIsNull() ?? string.Empty;
