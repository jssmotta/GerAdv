...
interface EndTitGridProps {
  data: IEndTit[];
  onRowClick: (endtit: IEndTit) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const EndTitGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IEndTit, filters: Record<string, any>) => {
