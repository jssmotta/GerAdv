...
// useGUTMatrizGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GUTMatriz
"use client";
...
interface UseGUTMatrizGridProps {
  data: IGUTMatriz[];
...
export const useGUTMatrizGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IGUTMatriz, filters: Record<string, any>) => {
