...
public class FilterTerceirosWithVoiceRequest
{
    /// <summary>
    /// Filtro de Terceiros padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterTerceiros Filter { get; set; } = new();
...
{
    [JsonPropertyName("filterPosicaoOutrasPartes")]
    [Description("Filtro para a _tabela PosicaoOutrasPartes")]
    public FilterPosicaoOutrasPartes? FilterPosicaoOutrasPartes { get; set; } = new();
    ...
    [Description("Situacao -2147483648 para nada ou id")]
    public int Situacao { get; set; } = int.MinValue;

    [JsonPropertyName("situacao_end")]
    [Description("Situacao -2147483648 para nada ou id para final do intervalo")]
    public int Situacao_end { get; set; } = int.MinValue;
