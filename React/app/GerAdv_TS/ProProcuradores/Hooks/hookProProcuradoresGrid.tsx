...
// useProProcuradoresGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProProcuradores
"use client";
...
interface UseProProcuradoresGridProps {
...
export const useProProcuradoresGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IProProcuradores, filters: Record<string, any>) => {
