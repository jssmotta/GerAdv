...
#region SMART_SQLServices 
    ...
    public static string TabelaIdDiff(int id) => TabelaId.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string TabelaIdSql(int id) => TabelaId.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string TabelaIdIsNull => TabelaId.SqlCmdIsNull() ?? string.Empty;
    public static string TabelaIdNotIsNull => TabelaId.SqlCmdNotIsNull() ?? string.Empty;
