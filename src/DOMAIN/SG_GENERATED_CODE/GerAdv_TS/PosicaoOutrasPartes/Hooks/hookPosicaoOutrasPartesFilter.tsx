...
interface UsePosicaoOutrasPartesFilterProps {
    handleFetchWithFilter: (filtro?: FilterPosicaoOutrasPartes | undefined | null) => Promise<void>;
}
...
interface UsePosicaoOutrasPartesFilterReturn {
    ...
    setWindowFilter: React.Dispatch<React.SetStateAction<FilterPosicaoOutrasPartes>>;
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterPosicaoOutrasPartes>) => React.ReactNode;
...
export const usePosicaoOutrasPartesFilter = ({ handleFetchWithFilter }: UsePosicaoOutrasPartesFilterProps): UsePosicaoOutrasPartesFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterPosicaoOutrasPartes>({} as FilterPosicaoOutrasPartes);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterPosicaoOutrasPartes;
    ...
    const renderInputFilters = (handlers: FilterHandlers<FilterPosicaoOutrasPartes>) => (        
        <>
        <InputInput
                        type='text'
                        id='descricao'
