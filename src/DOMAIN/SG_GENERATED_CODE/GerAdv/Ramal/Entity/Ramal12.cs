...
public partial class FRamal : MenphisSI.SG.GerAdv.DBRamal, IDBRamal
{
    ...
    public static FRamal CreateFromReader(SqlDataReader? dbRec)
    {
        return new FRamal(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FRamal CreateFromDataRow(DataRow? dbRec)
    {
        return new FRamal(dbRec);
    }

    private FRamal(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FRamal(DataRow? dbRec) : base(dbRec)
    {
    }

    private FRamal(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FRamal CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FRamal(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FRamal> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fRamal = new FRamal();
        await fRamal.CarregarAsync(id, oCnn);
        return fRamal;
    }
