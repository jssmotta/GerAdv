...
public class FilterTipoStatusBiuWithVoiceRequest
{
    /// <summary>
    /// Filtro de TipoStatusBiu padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterTipoStatusBiu Filter { get; set; } = new();
...
[Serializable]
public partial record FilterTipoStatusBiu
{
