...
export const EnquadramentoEmpresaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IEnquadramentoEmpresa, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  tableName: 'enquadramentoempresa'
});
...
{initialized && (
  ...
  className='grid-desktop-enquadramentoempresa'
