...
#region TableDefinition_TipoOrigemSucumbencia
...
#endregion
    public DBTipoOrigemSucumbencia(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBTipoOrigemSucumbencia(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBTipoOrigemSucumbencia(in string? sqlWhere, SqlConnection? oCnn)
    {
