...
// useBensMateriaisGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de BensMateriais
"use client";
...
interface UseBensMateriaisGridProps {
  data: IBensMateriais[];
...
export const useBensMateriaisGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IBensMateriais, filters: Record<string, any>) => {
