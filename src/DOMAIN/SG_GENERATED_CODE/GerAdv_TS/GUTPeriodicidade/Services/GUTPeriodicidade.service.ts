...
export interface IGUTPeriodicidadeService {
  ...
  filterVoice: (filtro?: FilterGUTPeriodicidade, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class GUTPeriodicidadeService implements IGUTPeriodicidadeService {
  ...
  async filterVoice(filtro?: FilterGUTPeriodicidade, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
