...
public static partial class ConfiguracoesSys
{
    ...
    public static string ConnectionString(string uri)
    {
        ...
        lock (_lockObject)
        {
            ...
            var connectionString = $"{PCmdReadOnly}Packet Size=512;MultipleActiveResultSets=true;Enlist=false;encrypt=true;Data Source={dbRec.DataSource};Initial Catalog={dbRec.InitialCatalog};User Id={dbRec.UserID};Password={dbRec.Pwd256.Decrypt()};Max Pool Size=100;Pooling=true;Integrated Security=false;Connect Timeout=30;Persist Security Info=False;TrustServerCertificate=True;";
