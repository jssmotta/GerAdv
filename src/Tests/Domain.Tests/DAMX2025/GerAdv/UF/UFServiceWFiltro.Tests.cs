...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class UFServiceWFiltroTests : IDisposable
    {
        ...
        public UFServiceWFiltroTests()
        {
            ...
            _service = new UFService(_mockAppSettings.Object, _mockUFFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockPaisesReader.Object, _mockCidadeService.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        }
...
#region filtro.Pais_end Tests
        ...
        public void WFiltro_Pais_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBUFDicInfo.Descricao}");
