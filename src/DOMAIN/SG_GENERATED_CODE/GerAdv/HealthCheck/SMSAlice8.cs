                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(smaCodigo) FROM {"SMSAlice".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) smaOperador,smaNome,smaTipoEMail,smaGuid FROM {"SMSAlice".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
