...
public partial class DBJusticaODicInfo : IODicInfo
{
    ...
    public static ImmutableArray<DBInfoSystem> List => [DBJusticaDicInfo.JusGUID, DBJusticaDicInfo.JusNome, DBJusticaDicInfo.JusBold, DBJusticaDicInfo.JusQuemCad, DBJusticaDicInfo.JusDtCad, DBJusticaDicInfo.JusQuemAtu, DBJusticaDicInfo.JusDtAtu, DBJusticaDicInfo.JusVisto];
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBJusticaDicInfo.JusGUID, DBJusticaDicInfo.JusNome];
