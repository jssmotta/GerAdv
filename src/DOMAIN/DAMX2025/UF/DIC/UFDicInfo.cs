...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem UfPais => new(0, PTabelaNome, CampoCodigo, Pais, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBPaisesDicInfo.CampoCodigo, DBPaisesDicInfo.TabelaNome, new DBPaisesODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem UfQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem UfQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string PaisDiff(int id) => Pais.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string PaisSql(int id) => Pais.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string PaisIsNull => Pais.SqlCmdIsNull() ?? string.Empty;
    public static string PaisNotIsNull => Pais.SqlCmdNotIsNull() ?? string.Empty;
