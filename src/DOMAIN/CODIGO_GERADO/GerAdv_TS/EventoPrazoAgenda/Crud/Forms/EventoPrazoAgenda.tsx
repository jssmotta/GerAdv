...
interface EventoPrazoAgendaFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-EventoPrazoAgenda' : 'form-container5 form-container-EventoPrazoAgenda'}>
       
            <form className='formInputCadInc' id={`EventoPrazoAgendaForm-${eventoprazoagendaData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={eventoprazoagendaData} isSubmitting={isSubmitting} onClose={onClose} formId={`EventoPrazoAgendaForm-${eventoprazoagendaData.id}`} preventPropagation={true} onSave={handleDirectSave} />
