...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBNENotas
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBNENotasUpdateAdvancedTests : IDisposable
{
    private readonly DBNENotas _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBNENotasUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBNENotas
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBNENotas).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBNENotas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBNENotas instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBNENotas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBNENotas.PTabelaNome.Should().Be("NENotas");
        DBNENotas.CampoCodigo.Should().Be("nepCodigo");
    }
