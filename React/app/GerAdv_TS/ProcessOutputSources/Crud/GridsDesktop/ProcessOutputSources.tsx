...
interface ProcessOutputSourcesGridProps {
  data: IProcessOutputSources[];
  onRowClick: (processoutputsources: IProcessOutputSources) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProcessOutputSourcesGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProcessOutputSources, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  tableName: 'processoutputsources'
});
...
{initialized && (
  ...
  className='grid-desktop-processoutputsources'
