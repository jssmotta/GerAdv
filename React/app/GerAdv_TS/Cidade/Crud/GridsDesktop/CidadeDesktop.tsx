  ...
  ({
    ...
    const SearchFromCellBensMateriais = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellBensMateriais(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Bens Materiais">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellDivisaoTribunal = (props: any) => {
      return (
        <>
          <td>
            <div
              onClick={() => openSearchCellDivisaoTribunal(props.dataItem.id)}
            >
    ...
    const SearchFromCellEnderecos = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellEnderecos(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Endereços">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellFornecedores = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellFornecedores(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Fornecedores">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellOponentesRepLegal = (props: any) => {
      return (
        <>
          <td>
            <div
              onClick={() => openSearchCellOponentesRepLegal(props.dataItem.id)}
            >
              <span title="Pesquisar relacionados em Oponentes Rep Legal">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
      ...
      return (
        <>
          <td>
            <div
              onClick={() =>
                openSearchCellOutrasPartesCliente(props.dataItem.id)
              }
            >
              <span title="Pesquisar relacionados em Outras Partes Cliente">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellPreClientes = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellPreClientes(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Pre Clientes">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellPrepostos = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellPrepostos(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Prepostos">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellTerceiros = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellTerceiros(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Terceiros">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
