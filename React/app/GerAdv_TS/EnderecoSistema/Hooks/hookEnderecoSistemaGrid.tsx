...
// useEnderecoSistemaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de EnderecoSistema
'use client';
...
interface UseEnderecoSistemaGridProps {
...
export const useEnderecoSistemaGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('enderecosistema-columns-order'), JSON.stringify(reorderableFields));
