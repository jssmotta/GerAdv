...
// useReuniaoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Reuniao
"use client";
...
export const useReuniaoGrid = ({
  ...
  const defaultColumnsOrder = useMemo(() => ["data", "nomeclientes"], []);
  ...
  const filterLogic = useCallback(
    (data: IReuniao, filters: Record<string, any>) => {
