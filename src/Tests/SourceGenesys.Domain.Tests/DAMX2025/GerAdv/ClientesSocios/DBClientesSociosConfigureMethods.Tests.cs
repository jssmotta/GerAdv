...
#region Fields_All
    ...
    public void ConfigureMethodsQualificacao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        _clientessocios.FQualificacao.Should().Be("");
    ...
    public void ConfigureUpdateFields_Qualificacao_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        _clientessocios.FQualificacao.Should().Be("");
        _clientessocios.FIdade.Should().Be(0);
    }
    ...
    public void ConfigureMethodsNome_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FNome.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsSite_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FSite.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsRepresentanteLegal_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FRepresentanteLegal.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_RepresentanteLegal_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsEndereco_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FEndereco.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsBairro_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FBairro.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureUpdateFields_CEP_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - All field values should not be preserved
        _clientessocios.FCEP.Should().Be("");
        _clientessocios.FIdade.Should().Be(0);
    }
    ...
    public void ConfigureUpdateFields_CPF_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - All field values should not be preserved
        _clientessocios.FCPF.Should().Be("");
        _clientessocios.FIdade.Should().Be(0);
    }
    ...
    public void ConfigureMethodsFone_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FFone.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsParticipacao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FParticipacao.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_Participacao_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsCargo_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FCargo.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_Cargo_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureUpdateFields_EMail_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - All field values should not be preserved
        _clientessocios.FEMail.Should().Be("");
        _clientessocios.FIdade.Should().Be(0);
    }
    ...
    public void ConfigureMethodsObs_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FObs.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsCNH_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FCNH.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureUpdateFields_CNPJ_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - All field values should not be preserved
        _clientessocios.FCNPJ.Should().Be("");
        _clientessocios.FIdade.Should().Be(0);
    }
    ...
    public void ConfigureMethodsInscEst_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FInscEst.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsSocioEmpresaAdminNome_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FSocioEmpresaAdminNome.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_SocioEmpresaAdminNome_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsEnderecoSocio_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FEnderecoSocio.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_EnderecoSocio_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsBairroSocio_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FBairroSocio.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_BairroSocio_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsCEPSocio_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientessocios.FCEPSocio.Should().Be("");
        _clientessocios.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_CEPSocio_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureUpdateFields_Class_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - All field values should not be preserved
        _clientessocios.FClass.Should().Be("");
        _clientessocios.FIdade.Should().Be(0);
    }
