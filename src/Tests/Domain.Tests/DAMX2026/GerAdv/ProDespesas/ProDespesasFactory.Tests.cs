...
public class FProDespesasFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FProDespesas>();
    }
    ...
    {
        // Arrange
        var factory = new FProDespesasFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("desCodigo", typeof(int));
        mockDataTable.Columns.Add("desGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["desCodigo"] = testId;
        row["desGuid"] = "Test ProDespesas";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["desCodigo"] = 123;
        row["desGuid"] = "Test ProDespesas Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FProDespesas properties
        }
    }
