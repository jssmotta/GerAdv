                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(escCodigo) FROM {"Escritorios".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) escCNPJ,escCasa,escParceria,escNome,escOAB,escEndereco,escCidade,escBairro,escCEP,escFone,escFax,escSite,escEMail,escOBS,escAdvResponsavel,escSecretaria,escInscEst,escCorrespondente,escTop,escEtiqueta,escBold,escGuid FROM {"Escritorios".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
