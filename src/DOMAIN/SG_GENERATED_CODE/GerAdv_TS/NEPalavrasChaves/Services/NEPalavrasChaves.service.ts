...
export interface INEPalavrasChavesService {
  ...
  filterVoice: (filtro?: FilterNEPalavrasChaves, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class NEPalavrasChavesService implements INEPalavrasChavesService {
  ...
  async filterVoice(filtro?: FilterNEPalavrasChaves, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
