...
public partial class DBAndamentosMD
{
    ...
    /// </summary>
    public static async Task<DBAndamentosMD> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBAndamentosMD();
