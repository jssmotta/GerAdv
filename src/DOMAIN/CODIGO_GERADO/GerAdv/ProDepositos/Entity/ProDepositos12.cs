...
public partial class FProDepositos : MenphisSI.SG.GerAdv.DBProDepositos, IDBProDepositos
{
    ...
    private FProDepositos(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FProDepositos CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FProDepositos(parameters, oCnn, fullSql, sqlWhere, join);
    }
