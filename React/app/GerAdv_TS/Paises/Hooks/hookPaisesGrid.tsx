...
// usePaisesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Paises
"use client";
...
export const usePaisesGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IPaises, filters: Record<string, any>) => {
