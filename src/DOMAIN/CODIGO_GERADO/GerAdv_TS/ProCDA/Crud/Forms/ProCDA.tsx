...
if (getParamFromUrl("processos") > 0) {
 ...
 const addValorProcesso = (e: any) => {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-ProCDA' : 'form-container5 form-container-ProCDA'}>
       
            <form className='formInputCadInc' id={`ProCDAForm-${procdaData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={procdaData} isSubmitting={isSubmitting} onClose={onClose} formId={`ProCDAForm-${procdaData.id}`} preventPropagation={true} onSave={handleDirectSave} />
