...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFClientes.VerifySet(x => x.FRGDataExp = DateOnly.Parse(clientes.RGDataExp), Times.Once);
        ...
        _mockFClientes.VerifySet(x => x.FDtNasc = DateOnly.Parse(clientes.DtNasc), Times.Once);
        ...
        _mockFClientes.VerifySet(x => x.FData = DateOnly.Parse(clientes.Data), Times.Once);
    ...
    public async Task WriteAsync_WithNull_RGDataExp_ShouldNotSetFRGDataExp()
    {
        ...
        // Assert
        _mockFClientes.VerifySet(x => x.FRGDataExp = It.IsAny<DateOnly>(), Times.Never);
    }
    ...
    public async Task WriteAsync_WithNull_DtNasc_ShouldNotSetFDtNasc()
    {
        ...
        await _clientesWriter.WriteAsync(clientes, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFClientes.VerifySet(x => x.FDtNasc = It.IsAny<DateOnly>(), Times.Never);
    }
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        await _clientesWriter.WriteAsync(clientes, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFClientes.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ClientesWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Clientes CreateValidClientesModel()
    {
