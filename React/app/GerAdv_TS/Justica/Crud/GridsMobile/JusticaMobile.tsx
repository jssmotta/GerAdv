  ...
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("justica-columns-order-mobile"),
        );
        if (savedOrder) {
    ...
    useEffect(() => {
      const cleanup = useIOSScrollFallback({
        scrollSelector: ".grid-mobile-crud.grid-mobile-justica .k-grid-content",
        waitForDOM: true,
        retryDelay: 100,
      ...
      <>
        {initialized && (
          <>
            <PageTitle
              title="Justiças"
              helpButton={<JusticaHelpCrudButton isMobile={true} />}
            />
                        ...
                        <>
                          {sortedData.map((data) => (
                            <ViewMobile
                              ...
                              name={data.nome}
                              data={data}
                              related={SearchFromCellAcaoMobile({
                                dataItem: data,
                              })}
                            />
                          ))}
