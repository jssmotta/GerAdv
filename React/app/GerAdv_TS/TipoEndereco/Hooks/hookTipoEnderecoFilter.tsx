...
interface UseTipoEnderecoFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterTipoEndereco | undefined | null,
  ) => Promise<void>;
}
...
interface UseTipoEnderecoFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterTipoEndereco>,
  ) => React.ReactNode;
...
export const useTipoEnderecoFilter = ({
  handleFetchWithFilter,
}: UseTipoEnderecoFilterProps): UseTipoEnderecoFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterTipoEndereco>(
