...
#region Class Structure Tests
    ...
    private static GerAdv.Models.Instancia CreateValidInstancia()
    {
        return new GerAdv.Models.Instancia
        {
            Id = 1,
    ...
    private void SetupValidMocks()
    {
        ...
        _mockInstanciaService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterInstancia>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<InstanciaResponseAll>>.Ok([]));
        // Setup other mocks but don't override the Instancias service mock
        _ = _mockAcaoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<AcaoResponse?>(new AcaoResponse { Id = id }));
        ...
        _ = _mockTipoRecursoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<TipoRecursoResponse?>(new TipoRecursoResponse { Id = id }));
    }
    ...
    private void SetupValidMocksInvalid()
    {
        ...
        _mockInstanciaService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterInstancia>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<InstanciaResponseAll>>.Ok([]));
        // Setup other mocks but don't override the Instancias service mock
        _ = _mockAcaoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<AcaoResponse?>(new AcaoResponse { Id = 0 }));
        ...
        _ = _mockTipoRecursoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<TipoRecursoResponse?>(new TipoRecursoResponse { Id = 0 }));
    }
...
#region ZKeyQuando Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_ZKeyQuando_ShouldPass()
    {
        // Arrange
        var instancia = CreateValidInstancia();
    ...
    [Fact]
    public async Task ValidateReg_WithEmpty_ZKeyQuando_ShouldPass()
    {
        // Arrange
        var instancia = CreateValidInstancia();
...
#region Foreign Key Validation Tests - Acao
    ...
    public async Task ValidateReg_WithInvalidAcao_ShouldThrowSGValidationException()
    {
        ...
        var instancia = CreateValidInstancia();
        instancia.Acao = 999;
        _mockAcaoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.AcaoResponse?>(null !));
    ...
    public async Task ValidateReg_WithMismatchedAcaoId_ShouldThrowSGValidationException()
    {
        ...
        var instancia = CreateValidInstancia();
        instancia.Acao = 999;
        var reg888 = new GerAdv.Models.Response.AcaoResponse
        {
            Id = 888
        }; // Different ID
        _mockAcaoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.AcaoResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(instancia, _mockInstanciaService.Object, _mockAcaoReader.Object, _mockForoReader.Object, _mockTipoRecursoReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidAcao_ShouldPass()
    {
        ...
        var instancia = CreateValidInstancia();
        instancia.Acao = 123;
        var reg123 = new GerAdv.Models.Response.AcaoResponse
        {
            Id = 123
        };
        _mockAcaoReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.AcaoResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(instancia, _mockInstanciaService.Object, _mockAcaoReader.Object, _mockForoReader.Object, _mockTipoRecursoReader.Object, _validUri, _mockConnection.Object);
        // Assert
...
#endregion
    [Fact]
    public async Task ValidateReg_WithEmpty_Acao_ShouldPass()
    {
        // Arrange
        var instancia = CreateValidInstancia();
...
#region Foreign Key Validation Tests - TipoRecurso
    ...
    public async Task ValidateReg_WithInvalidTipoRecurso_ShouldThrowSGValidationException()
    {
        ...
        _mockTipoRecursoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.TipoRecursoResponse?>(null !));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(instancia, _mockInstanciaService.Object, _mockAcaoReader.Object, _mockForoReader.Object, _mockTipoRecursoReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithMismatchedTipoRecursoId_ShouldThrowSGValidationException()
    {
        ...
        var instancia = CreateValidInstancia();
        instancia.TipoRecurso = 999;
        var reg888 = new GerAdv.Models.Response.TipoRecursoResponse
        {
            Id = 888
        }; // Different ID
        _mockTipoRecursoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.TipoRecursoResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(instancia, _mockInstanciaService.Object, _mockAcaoReader.Object, _mockForoReader.Object, _mockTipoRecursoReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidTipoRecurso_ShouldPass()
    {
        ...
        var reg123 = new GerAdv.Models.Response.TipoRecursoResponse
        {
            Id = 123
        };
        _mockTipoRecursoReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.TipoRecursoResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(instancia, _mockInstanciaService.Object, _mockAcaoReader.Object, _mockForoReader.Object, _mockTipoRecursoReader.Object, _validUri, _mockConnection.Object);
        // Assert
...
#endregion
    [Fact]
    public async Task ValidateReg_WithEmpty_TipoRecurso_ShouldPass()
    {
        // Arrange
        var instancia = CreateValidInstancia();
