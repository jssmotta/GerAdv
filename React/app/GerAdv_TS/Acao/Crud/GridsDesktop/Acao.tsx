...
interface AcaoGridProps {
  data: IAcao[];
  onRowClick: (acao: IAcao) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AcaoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAcao, filters: Record<string, any>) => {
...
const openConsultaInstancia = (id: number) => {
  router.push(`/pages/instancia/?acao=${id}`);
};
