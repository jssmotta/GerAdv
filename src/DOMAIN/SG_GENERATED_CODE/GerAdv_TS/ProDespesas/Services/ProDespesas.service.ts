...
export interface IProDespesasService {
  ...
  filterVoice: (filtro?: FilterProDespesas, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ProDespesasService implements IProDespesasService {
  ...
  async filterVoice(filtro?: FilterProDespesas, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
