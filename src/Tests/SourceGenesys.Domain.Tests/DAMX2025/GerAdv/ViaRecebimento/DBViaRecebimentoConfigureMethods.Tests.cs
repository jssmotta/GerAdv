...
/// <summary>
/// Comprehensive unit tests for ConfigureUpdateFields and ConfigureAuditorFields methods in DBViaRecebimento class
...
/// </summary>
public class DBViaRecebimentoConfigureMethodsTests : IDisposable
{
    private readonly DBViaRecebimento _viarecebimento;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBViaRecebimentoConfigureMethodsTests()
    {
        _viarecebimento = new DBViaRecebimento();
    ...
    public void ConfigureUpdateFields_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        // Arrange
        ResetAllFieldFlags();
        _viarecebimento.ID = 1; // Update scenario
        // Act
        var result = _viarecebimento.Update(_mockConnection.Object);
    ...
    public async Task ConfigureUpdateFieldsAsync_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        ...
        try
        {
            var result = await _viarecebimento.UpdateAsync(_mockConnection.Object);
...
#region Helper Methods
    ...
    {
        var field = typeof(DBViaRecebimento).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
        field?.SetValue(_viarecebimento, value);
    }
    ...
    private void SetFieldValue(string fieldName, object? value)
    {
        ...
        {
            field?.SetValue(_viarecebimento, Convert.ToDateTime(value));
        }
    }
...
#region Fields_All
    ...
    public void ConfigureUpdateFields_WithNomeFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _viarecebimento.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _viarecebimento.Update(_mockConnection.Object));
    ...
    public async Task ConfigureUpdateFieldsAsync_WithNomeFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _viarecebimento.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _viarecebimento.UpdateAsync(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncNome_WithCancellationToken_ShouldRespectCancellation()
    {
        ...
        var exception = await Record.ExceptionAsync(async () => await _viarecebimento.UpdateAsync(_mockConnection.Object, cancellationToken: cts.Token));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncNome_WithTimeout_ShouldRespectTimeout()
    {
        ...
        _viarecebimento.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _viarecebimento.UpdateAsync(_mockConnection.Object, timeoutSeconds: 1));
        exception.Should().NotBeNull();
    }
    ...
    {
        // Arrange
        _viarecebimento.ID = 123; // Update scenario
        _viarecebimento.AuditorQuem = 7;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection but audit fields should be set
        var exception = Record.Exception(() => _viarecebimento.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _viarecebimento.AuditorQuem.Should().Be(7);
    }
    ...
    public void ConfigureAuditorFieldsNome_WhenAuditorQuemIsZero_ShouldSetToDefaultValue()
    {
        // Arrange
        _viarecebimento.ID = 0; // Insert scenario
        _viarecebimento.AuditorQuem = 0; // Should be set to 1
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _viarecebimento.Update(_mockConnection.Object));
        ...
        _viarecebimento.AuditorQuem.Should().Be(1);
    }
    ...
    public void ConfigureAuditorFieldsNome_WhenAuditorQuemHasValue_ShouldPreserveValue(int auditorValue)
    {
        // Arrange
        _viarecebimento.ID = 0; // Insert scenario
        _viarecebimento.AuditorQuem = auditorValue;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _viarecebimento.Update(_mockConnection.Object));
        ...
        _viarecebimento.AuditorQuem.Should().Be(auditorValue);
    }
    ...
    {
        // Arrange
        _viarecebimento.ID = 0;
        _viarecebimento.AuditorQuem = 10;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _viarecebimento.Update(_mockConnection.Object));
        ...
        _viarecebimento.AuditorQuem.Should().Be(10);
    }
    ...
    {
        // Arrange
        _viarecebimento.ID = id;
        _viarecebimento.AuditorQuem = 15;
        SetFieldFlag("pFldFNome", true); // At least one field must change
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _viarecebimento.Update(_mockConnection.Object));
        ...
        _viarecebimento.AuditorQuem.Should().Be(15);
    }
    ...
    public void ConfigureMethodsNome_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        SetAllFieldValues();
        _viarecebimento.ID = 123;
        _viarecebimento.AuditorQuem = 99;
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _viarecebimento.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _viarecebimento.FNome.Should().Be("");
        _viarecebimento.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureFieldsNome_Integration_FieldChangeTracking_ShouldWorkCorrectly()
    {
        ...
        var result1 = _viarecebimento.Update(_mockConnection.Object);
