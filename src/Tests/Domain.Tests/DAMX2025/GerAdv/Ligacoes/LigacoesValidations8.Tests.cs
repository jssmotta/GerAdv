...
#region Class Structure Tests
    ...
    private static GerAdv.Models.Ligacoes CreateValidLigacoes()
    {
        return new GerAdv.Models.Ligacoes
        {
            Id = 1,
    ...
    private void SetupValidMocks()
    {
        ...
        _ = _mockRamalReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<RamalResponse?>(new RamalResponse { Id = id }));
    }
    ...
    private void SetupValidMocksInvalid()
    {
        ...
        _ = _mockRamalReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<RamalResponse?>(new RamalResponse { Id = 0 }));
    }
...
#region DataRealizada Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_DataRealizada_ShouldPass()
    {
        // Arrange
        var ligacoes = CreateValidLigacoes();
...
#region UltimoAviso Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_UltimoAviso_ShouldPass()
    {
        // Arrange
        var ligacoes = CreateValidLigacoes();
...
#region Foreign Key Validation Tests - Ramal
    ...
    public async Task ValidateReg_WithInvalidRamal_ShouldThrowSGValidationException()
    {
        ...
        var ligacoes = CreateValidLigacoes();
        ligacoes.Ramal = 999;
        _mockRamalReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.RamalResponse?>(null !));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(ligacoes, _mockLigacoesService.Object, _mockClientesReader.Object, _mockRamalReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithMismatchedRamalId_ShouldThrowSGValidationException()
    {
        ...
        var ligacoes = CreateValidLigacoes();
        ligacoes.Ramal = 999;
        var reg888 = new GerAdv.Models.Response.RamalResponse
        {
            Id = 888
        }; // Different ID
        _mockRamalReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.RamalResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(ligacoes, _mockLigacoesService.Object, _mockClientesReader.Object, _mockRamalReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidRamal_ShouldPass()
    {
        ...
        var ligacoes = CreateValidLigacoes();
        ligacoes.Ramal = 123;
        var reg123 = new GerAdv.Models.Response.RamalResponse
        {
            Id = 123
        };
        _mockRamalReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.RamalResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(ligacoes, _mockLigacoesService.Object, _mockClientesReader.Object, _mockRamalReader.Object, _validUri, _mockConnection.Object);
        // Assert
