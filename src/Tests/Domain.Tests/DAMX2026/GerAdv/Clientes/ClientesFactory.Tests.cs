...
public class FClientesFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FClientesFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FClientesFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FClientesFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FClientes>();
    }
    ...
    {
        // Arrange
        var factory = new FClientesFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["cliCodigo"] = 123;
        row["cliNome"] = "Test Clientes Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FClientes properties
        }
    }
