...
export interface IHorasTrabService {
  ...
  filterVoice: (filtro?: FilterHorasTrab, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class HorasTrabService implements IHorasTrabService {
  ...
  async filterVoice(filtro?: FilterHorasTrab, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
