 ...
 const addValorCidade = (e: any) => {
    ...
    if (!isSubmitting) {
      ...
      try {
        ...
        console.log('Erro ao submeter formulário de Fornecedores:');
  ...
  const handleDirectSave = () => {
    if (!isSubmitting) {
      ...
      try {        
        ...
        if (process.env.NEXT_PUBLIC_SHOW_LOG === '1')
            console.log('Erro ao salvar Fornecedores diretamente');
        setIsSubmitting(false);
        if (onError) onError();
      }
    }
  ...
  <>      
        ...
        <div className={isMobile ? 'form-container form-container-Fornecedores' : 'form-container form-container-Fornecedores'}>
            ...
            <form className='formInputCadInc' id={`FornecedoresForm-${fornecedoresData.id}`} onSubmit={onConfirm}>
                ...
                {!isMobile && (
                    <ButtonSalvarCrud isMobile={false} validationForm={validationForm} entity='Fornecedores' data={fornecedoresData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`FornecedoresForm-${fornecedoresData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                 )}
...
maxLength={2147483647}
            ...
            {isMobile && (
                <ButtonSalvarCrud isMobile={true} validationForm={validationForm} entity='Fornecedores' data={fornecedoresData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`FornecedoresForm-${fornecedoresData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                )}

                <FooterIncDocker>

                   <CopyButton
                    formId={`FornecedoresForm-${fornecedoresData.id}`}
                  />
                   ...
                   <AuditorButton
                        ...
                        coolName='Fornecedores'        
                        id={fornecedoresData.id}    
                      />

                    <DeleteButton page={'/pages/fornecedores'} id={fornecedoresData.id} dadoApi={dadoApi} />
