...
// useProcessOutputSourcesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProcessOutputSources
"use client";
...
interface UseProcessOutputSourcesGridProps {
...
export const useProcessOutputSourcesGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseProcessOutputSourcesGridProps) => {
  ...
  const filterLogic = useCallback(
    (data: IProcessOutputSources, filters: Record<string, any>) => {
