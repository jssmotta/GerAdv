...
interface UseBensClassificacaoFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterBensClassificacao | undefined | null,
  ) => Promise<void>;
}
...
interface UseBensClassificacaoFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterBensClassificacao>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterBensClassificacao>,
  ) => React.ReactNode;
...
export const useBensClassificacaoFilter = ({
  handleFetchWithFilter,
}: UseBensClassificacaoFilterProps): UseBensClassificacaoFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterBensClassificacao>(
