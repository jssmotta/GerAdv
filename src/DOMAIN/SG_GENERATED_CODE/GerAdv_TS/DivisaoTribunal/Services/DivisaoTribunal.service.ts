...
export interface IDivisaoTribunalService {
  ...
  filterVoice: (filtro?: FilterDivisaoTribunal, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class DivisaoTribunalService implements IDivisaoTribunalService {
  ...
  async filterVoice(filtro?: FilterDivisaoTribunal, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
