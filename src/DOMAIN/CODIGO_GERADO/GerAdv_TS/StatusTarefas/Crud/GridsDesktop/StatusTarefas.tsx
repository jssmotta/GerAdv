...
interface StatusTarefasGridProps {
  data: IStatusTarefas[];
  onRowClick: (statustarefas: IStatusTarefas) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const StatusTarefasGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IStatusTarefas, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-statustarefas'
