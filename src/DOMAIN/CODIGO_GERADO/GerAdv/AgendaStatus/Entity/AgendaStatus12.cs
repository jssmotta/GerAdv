...
public partial class FAgendaStatus : MenphisSI.SG.GerAdv.DBAgendaStatus, IDBAgendaStatus
{
    // DI-compatible default constructor
    public FAgendaStatus() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FAgendaStatus CreateFromReader(SqlDataReader? dbRec)
    {
        return new FAgendaStatus(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FAgendaStatus CreateFromDataRow(DataRow? dbRec)
    {
        return new FAgendaStatus(dbRec);
    }

    private FAgendaStatus(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FAgendaStatus(DataRow? dbRec) : base(dbRec)
    {
    }

    public async Task<FAgendaStatus> CreateFromIdAsync(int id, MsiSqlConnection oCnn)
    {
        var fAgendaStatus = new FAgendaStatus();
        await fAgendaStatus.CarregarAsync(id, oCnn);
        return fAgendaStatus;
    }

    private FAgendaStatus(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FAgendaStatus CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FAgendaStatus(parameters, oCnn, fullSql, sqlWhere, join);
    }
