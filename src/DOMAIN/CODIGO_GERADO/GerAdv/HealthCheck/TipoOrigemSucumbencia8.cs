                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tosCodigo) FROM {"TipoOrigemSucumbencia".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tosNome FROM {"TipoOrigemSucumbencia".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
