...
interface UseJusticaFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterJustica | undefined | null,
  ) => Promise<void>;
}
...
interface UseJusticaFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterJustica>,
  ) => React.ReactNode;
...
export const useJusticaFilter = ({
  handleFetchWithFilter,
}: UseJusticaFilterProps): UseJusticaFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterJustica>(
    {} as FilterJustica,
  );
  ...
  const clearFilter = () => {
    setWindowFilter({} as FilterJustica);
    sessionStorage.removeItem(btoa("JusticaFilter"));
    handleFetchWithFilter({} as FilterJustica);
  };
