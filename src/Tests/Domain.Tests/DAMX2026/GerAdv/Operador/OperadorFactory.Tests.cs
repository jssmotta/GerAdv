...
public class FOperadorFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FOperadorFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FOperadorFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FOperadorFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FOperador>();
    }
    ...
    {
        // Arrange
        var factory = new FOperadorFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["operCodigo"] = 123;
        row["operNome"] = "Test Operador Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FOperador properties
        }
    }
