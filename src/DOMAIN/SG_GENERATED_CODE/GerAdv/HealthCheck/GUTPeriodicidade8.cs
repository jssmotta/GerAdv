                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(pcgCodigo) FROM {"GUTPeriodicidade".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) pcgNome,pcgIntervaloDias,pcgGuid FROM {"GUTPeriodicidade".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
