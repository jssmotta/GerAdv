...
public partial class DBProcessOutputSources
{
    ...
    {
        if (pFldFNome)
            updateTool.Fields(DBProcessOutputSourcesDicInfo.Nome, m_FNome, ETiposCampos.FString);
        if (pFldFGUID)
            updateTool.Fields(DBProcessOutputSourcesDicInfo.GUID, m_FGUID, ETiposCampos.FString);
    }
