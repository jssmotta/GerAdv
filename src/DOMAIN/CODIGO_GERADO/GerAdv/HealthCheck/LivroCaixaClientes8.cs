                ...
                try
                {
                    ...
                    try
                    {
                        if (DBLivroCaixaClientesDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(lccCodigo) FROM dbo.LivroCaixaClientes (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) lccLivroCaixa,lccCliente,lccLancado FROM dbo.LivroCaixaClientes (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
