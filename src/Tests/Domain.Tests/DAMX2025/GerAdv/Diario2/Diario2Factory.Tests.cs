...
public class FDiario2FactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FDiario2>();
    }
    ...
    {
        // Arrange
        var factory = new FDiario2Factory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("diaCodigo", typeof(int));
        mockDataTable.Columns.Add("diaGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["diaCodigo"] = testId;
        row["diaGuid"] = "Test Diario2";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["diaCodigo"] = 123;
        row["diaGuid"] = "Test Diario2 Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FDiario2 properties
        }
    }
