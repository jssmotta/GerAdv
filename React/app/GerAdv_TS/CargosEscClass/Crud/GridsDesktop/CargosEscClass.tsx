...
export const CargosEscClassGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ICargosEscClass, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-cargosescclass'
