                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(gphCodigo) FROM {"Graph".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) gphTabela,gphTabelaId,gphImagem,gphGuid FROM {"Graph".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
