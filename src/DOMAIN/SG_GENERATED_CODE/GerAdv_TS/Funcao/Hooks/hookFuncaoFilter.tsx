...
interface UseFuncaoFilterProps {
    handleFetchWithFilter: (filtro?: FilterFuncao | undefined | null) => Promise<void>;
}
...
interface UseFuncaoFilterReturn {
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterFuncao>) => React.ReactNode;
...
export const useFuncaoFilter = ({ handleFetchWithFilter }: UseFuncaoFilterProps): UseFuncaoFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterFuncao>({} as FilterFuncao);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterFuncao;
