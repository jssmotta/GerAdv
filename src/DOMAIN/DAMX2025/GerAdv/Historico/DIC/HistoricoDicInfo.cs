...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem HisProcesso => new(0, PTabelaNome, CampoCodigo, Processo, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false)
    {
        Prefixo = "his"
    }; // DBI 11 
    public static DBInfoSystem HisPrecatoria => new(0, PTabelaNome, CampoCodigo, Precatoria, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBPrecatoriaDicInfo.CampoCodigo, DBPrecatoriaDicInfo.TabelaNome, new DBPrecatoriaODicInfo(), false)
    {
        Prefixo = "his"
    }; // DBI 11 
    public static DBInfoSystem HisApenso => new(0, PTabelaNome, CampoCodigo, Apenso, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBApensoDicInfo.CampoCodigo, DBApensoDicInfo.TabelaNome, new DBApensoODicInfo(), false)
    {
        Prefixo = "his"
    }; // DBI 11 
    ...
    public static DBInfoSystem HisFase => new(0, PTabelaNome, CampoCodigo, Fase, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBFaseDicInfo.CampoCodigo, DBFaseDicInfo.TabelaNome, new DBFaseODicInfo(), false)
    {
        Prefixo = "his"
    }; // DBI 11 
    ...
    public static DBInfoSystem HisStatusAndamento => new(0, PTabelaNome, CampoCodigo, StatusAndamento, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBStatusAndamentoDicInfo.CampoCodigo, DBStatusAndamentoDicInfo.TabelaNome, new DBStatusAndamentoODicInfo(), false)
    {
        Prefixo = "his"
    }; // DBI 11 
    ...
    public static DBInfoSystem HisQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false)
    {
        Prefixo = "his"
    }; // DBI 11 
    ...
    public static DBInfoSystem HisQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false)
    {
        Prefixo = "his"
    }; // DBI 11 
