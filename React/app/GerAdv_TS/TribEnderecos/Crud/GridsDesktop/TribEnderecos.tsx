...
interface TribEnderecosGridProps {
  data: ITribEnderecos[];
  onRowClick: (tribenderecos: ITribEnderecos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const TribEnderecosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ITribEnderecos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-tribenderecos'
