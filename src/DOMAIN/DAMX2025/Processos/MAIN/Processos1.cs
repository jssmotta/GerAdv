...
#region TableDefinition_Processos
...
#endregion
    public DBProcessos(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBProcessos(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBProcessos(in string? sqlWhere, SqlConnection? oCnn)
    {
