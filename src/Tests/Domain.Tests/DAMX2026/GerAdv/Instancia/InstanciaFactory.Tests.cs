...
public class FInstanciaFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FInstancia>();
    }
    ...
    {
        // Arrange
        var factory = new FInstanciaFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("insCodigo", typeof(int));
        mockDataTable.Columns.Add("insNroProcesso", typeof(string));
        var row = mockDataTable.NewRow();
        row["insCodigo"] = testId;
        row["insNroProcesso"] = "Test Instancia";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["insCodigo"] = 123;
        row["insNroProcesso"] = "Test Instancia Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FInstancia properties
        }
    }
