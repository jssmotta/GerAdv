                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(cidCodigo) FROM {"Cidade".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) cidDDD,cidTop,cidComarca,cidCapital,cidNome,cidUF,cidSigla,cidGuid FROM {"Cidade".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
