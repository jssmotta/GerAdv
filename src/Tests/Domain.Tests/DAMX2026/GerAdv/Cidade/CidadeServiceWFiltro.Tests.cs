...
public class CidadeServiceWFiltroTests : IDisposable
{
    ...
    public void WFiltro_QuandoFiltroEhNull_DeveRetornarResultadoVazio()
    {
        ...
        // Act
        var resultado = _serviceS.WFiltroCidade(filtro);
        // Assert
...
#region String Tests
    ...
    [Fact]
    public void WFiltro_GuidCidade_ComValorEWildcard_DeveUsarLIKEEIncluirWildcards()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    [Fact]
    public void WFiltro_GuidCidade_ComValorSemWildcard_DeveUsarIgualdade()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    public void WFiltro_Guid_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
    {
        ...
        // Act
        var result = _serviceS.WFiltroCidade(filtro);
        // Assert
        result.Should().NotBeNull();
        result.Value.where.Should().NotStartWith(TSql.And);
        result.Value.where.Should().StartWith($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.Guid}]");
    }
    ...
    [Fact]
    public void WFiltro_DDDCidade_ComValorEWildcard_DeveUsarLIKEEIncluirWildcards()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    [Fact]
    public void WFiltro_DDDCidade_ComValorSemWildcard_DeveUsarIgualdade()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    public void WFiltro_DDD_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
    {
        ...
        result.Should().NotBeNull();
        result.Value.where.Should().NotStartWith(TSql.And);
        result.Value.where.Should().StartWith($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.DDD}]");
    }
    ...
    [Fact]
    public void WFiltro_NomeCidade_ComValorEWildcard_DeveUsarLIKEEIncluirWildcards()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    [Fact]
    public void WFiltro_NomeCidade_ComValorSemWildcard_DeveUsarIgualdade()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    public void WFiltro_Nome_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
    {
        ...
        result.Should().NotBeNull();
        result.Value.where.Should().NotStartWith(TSql.And);
        result.Value.where.Should().StartWith($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.Nome}]");
    }
    ...
    [Fact]
    public void WFiltro_SiglaCidade_ComValorEWildcard_DeveUsarLIKEEIncluirWildcards()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    [Fact]
    public void WFiltro_SiglaCidade_ComValorSemWildcard_DeveUsarIgualdade()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    public void WFiltro_Sigla_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
    {
        ...
        result.Should().NotBeNull();
        result.Value.where.Should().NotStartWith(TSql.And);
        result.Value.where.Should().StartWith($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.Sigla}]");
    }
...
#region QuemCad Filter Tests
    ...
    public void WFiltro_QuemCadEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBCidadeDicInfo.QuemCad));
        result.Value.where.Should().NotContain(DBCidadeDicInfo.QuemCad);
    }
    ...
    public void WFiltro_QuemCadHasValidValue_ShouldAddParameterAndWhereClause()
    {
        ...
        result.Should().NotBeNull();
        // Check parameter
        var QuemCadParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.QuemCad}");
        QuemCadParameter.Should().NotBeNull();
        QuemCadParameter.Value.Should().Be(QuemCadValue);
        // Check where clause
        result.Value.where.Should().Contain($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.QuemCad}] = @{DBCidadeDicInfo.QuemCad}");
    }
    ...
    public void WFiltro_QuemCadWithDifferentValues_ShouldAddCorrectParameterValue()
    {
        ...
        var resultFemale = _serviceS.WFiltroCidade(filtroFemale);
        resultFemale.Should().NotBeNull();
        var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.QuemCad}");
        ...
        var resultMale = _serviceS.WFiltroCidade(filtroMale);
        resultMale.Should().NotBeNull();
        var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.QuemCad}");
    ...
    public void WFiltro_QuemCadAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        result.Value.where.Should().StartWith($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.QuemCad}] = @{DBCidadeDicInfo.QuemCad}");
...
#region QuemAtu Filter Tests
    ...
    public void WFiltro_QuemAtuEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBCidadeDicInfo.QuemAtu));
        result.Value.where.Should().NotContain(DBCidadeDicInfo.QuemAtu);
    }
    ...
    public void WFiltro_QuemAtuHasValidValue_ShouldAddParameterAndWhereClause()
    {
        ...
        result.Should().NotBeNull();
        // Check parameter
        var QuemAtuParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.QuemAtu}");
        QuemAtuParameter.Should().NotBeNull();
        QuemAtuParameter.Value.Should().Be(QuemAtuValue);
        // Check where clause
        result.Value.where.Should().Contain($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.QuemAtu}] = @{DBCidadeDicInfo.QuemAtu}");
    }
    ...
    public void WFiltro_QuemAtuWithDifferentValues_ShouldAddCorrectParameterValue()
    {
        ...
        var resultFemale = _serviceS.WFiltroCidade(filtroFemale);
        resultFemale.Should().NotBeNull();
        var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.QuemAtu}");
        femaleParam.Should().NotBeNull();
        femaleParam.Value.Should().Be(0);
        ...
        var resultMale = _serviceS.WFiltroCidade(filtroMale);
        resultMale.Should().NotBeNull();
        var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.QuemAtu}");
        maleParam.Should().NotBeNull();
        maleParam.Value.Should().Be(1);
    }
    ...
    public void WFiltro_QuemAtuAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
    {
        ...
        // Assert
        result.Should().NotBeNull();
        result.Value.where.Should().StartWith($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.QuemAtu}] = @{DBCidadeDicInfo.QuemAtu}");
        result.Value.where.Should().NotStartWith(" AND ");
    }
...
#endregion
#region UF Filter Tests
    [Fact]
    public void WFiltro_UFEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
    {
        // Arrange
        var filtro = new FilterCidade
        {
        ...
        // Assert
        result.Should().NotBeNull();
        result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBCidadeDicInfo.UF));
        result.Value.where.Should().NotContain(DBCidadeDicInfo.UF);
    }

    [Fact]
    public void WFiltro_UFHasValidValue_ShouldAddParameterAndWhereClause()
    {
        // Arrange
        var UFValue = 1;
        var filtro = new FilterCidade
        ...
        result.Should().NotBeNull();
        // Check parameter
        var UFParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.UF}");
        UFParameter.Should().NotBeNull();
        UFParameter.Value.Should().Be(UFValue);
        // Check where clause
        result.Value.where.Should().Contain($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.UF}] = @{DBCidadeDicInfo.UF}");
    }

    [Fact]
    public void WFiltro_UFWithDifferentValues_ShouldAddCorrectParameterValue()
    {
        // Arrange & Act & Assert for UF = 0 (typically female)
        var filtroFemale = new FilterCidade
        {
            UF = 0
        };
        var resultFemale = _serviceS.WFiltroCidade(filtroFemale);
        resultFemale.Should().NotBeNull();
        var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.UF}");
        femaleParam.Should().NotBeNull();
        femaleParam.Value.Should().Be(0);
        // Arrange & Act & Assert for UF = 1 (typically male)
        var filtroMale = new FilterCidade
        {
            UF = 1
        };
        var resultMale = _serviceS.WFiltroCidade(filtroMale);
        resultMale.Should().NotBeNull();
        var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBCidadeDicInfo.UF}");
        maleParam.Should().NotBeNull();
        maleParam.Value.Should().Be(1);
    }

    [Fact]
    public void WFiltro_UFAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
    {
        // Arrange
        var filtro = new FilterCidade
        {
        ...
        // Assert
        result.Should().NotBeNull();
        result.Value.where.Should().StartWith($"[{DBCidadeDicInfo.PTabelaNome}].[{DBCidadeDicInfo.UF}] = @{DBCidadeDicInfo.UF}");
        result.Value.where.Should().NotStartWith(" AND ");
    }

    [Fact]
    public void WFiltro_UFWithOtherFilters_ShouldIncludeLogicalOperatorInWhereClause()
    {
        // Arrange
        var filtro = new FilterCidade
        {
    ...
    [Fact]
    public void WFiltro_UFWithORLogicalOperator_ShouldUseORInWhereClause()
    {
        // Arrange
        var filtro = new FilterCidade
        {
...
#region DtCad Filter Tests
    ...
    public void WFiltro_DtCad_WhenValidDateProvided_ShouldAddParameterAndWhereClause()
    {
        ...
        result.Should().NotBeNull();
        result.Value.parametros.Should().HaveCount(1);
        var dateParam = result.Value.parametros.FirstOrDefault(p => p.ParameterName.Contains(DBCidadeDicInfo.DtCad));
        dateParam.Should().NotBeNull();
        // Verify the where clause contains the date field
        result.Value.where.Should().Contain(DBCidadeDicInfo.DtCad);
    }
...
#region DtAtu Filter Tests
    ...
    public void WFiltro_DtAtu_WhenValidDateProvided_ShouldAddParameterAndWhereClause()
    {
        ...
        result.Should().NotBeNull();
        result.Value.parametros.Should().HaveCount(1);
        var dateParam = result.Value.parametros.FirstOrDefault(p => p.ParameterName.Contains(DBCidadeDicInfo.DtAtu));
        dateParam.Should().NotBeNull();
        // Verify the where clause contains the date field
        result.Value.where.Should().Contain(DBCidadeDicInfo.DtAtu);
    }
