...
public class HonorariosDadosContratoServiceTests : IDisposable
{
    ...
    public HonorariosDadosContratoServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new HonorariosDadosContratoService(_mockAppSettings.Object, _mockHonorariosDadosContratoFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockClientesReader.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
