...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFAgenda.VerifySet(x => x.FHrFinal = TimeOnly.Parse(agenda.HrFinal), Times.Once);
        ...
        _mockFAgenda.VerifySet(x => x.FEventoData = DateOnly.Parse(agenda.EventoData), Times.Once);
        _mockFAgenda.VerifySet(x => x.FFuncionario = agenda.Funcionario, Times.Once);
        _mockFAgenda.VerifySet(x => x.FData = DateOnly.Parse(agenda.Data), Times.Once);
        _mockFAgenda.VerifySet(x => x.FEventoPrazo = agenda.EventoPrazo, Times.Once);
        _mockFAgenda.VerifySet(x => x.FHora = TimeOnly.Parse(agenda.Hora), Times.Once);
        ...
        _mockFAgenda.VerifySet(x => x.FDataInicioPrazo = DateOnly.Parse(agenda.DataInicioPrazo), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_EventoData_ShouldNotSetFEventoData()
    {
        // Arrange
        var agenda = CreateValidAgendaModel();
        ...
        // Assert
        _mockFAgenda.VerifySet(x => x.FEventoData = It.IsAny<DateOnly>(), Times.Never);
    }
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        await _agendaWriter.WriteAsync(agenda, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFAgenda.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DataInicioPrazo_ShouldNotSetFDataInicioPrazo()
    {
        // Arrange
        var agenda = CreateValidAgendaModel();
        ...
        await _agendaWriter.WriteAsync(agenda, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFAgenda.VerifySet(x => x.FDataInicioPrazo = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new AgendaWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Agenda CreateValidAgendaModel()
    {
