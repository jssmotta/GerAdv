                ...
                try
                {
                    ...
                    try
                    {
                        if (DBProPartesDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(oppCodigo) FROM {"ProPartes".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) oppParte,oppProcesso FROM {"ProPartes".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
