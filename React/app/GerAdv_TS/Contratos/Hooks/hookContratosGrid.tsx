...
// useContratosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Contratos
"use client";
...
interface UseContratosGridProps {
  data: IContratos[];
...
export const useContratosGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IContratos, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
