...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class TipoStatusBiuServiceWFiltroTests : IDisposable
    {
        ...
        public TipoStatusBiuServiceWFiltroTests()
        {
            ...
            _service = new TipoStatusBiuService(_mockAppSettings.Object, _mockTipoStatusBiuFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object);
        }
