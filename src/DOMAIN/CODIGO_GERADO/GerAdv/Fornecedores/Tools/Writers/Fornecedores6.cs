...
public class FornecedoresWriter(IFFornecedoresFactory fornecedoresFactory) : IFornecedoresWriter
{
    ...
    public async Task Delete(FornecedoresResponse fornecedores, int operadorId, MsiSqlConnection oCnn)
    {
        await _fornecedoresFactory.DeleteAsync(operadorId, fornecedores.Id, oCnn);
    }

    public async Task<FFornecedores> WriteAsync(Models.Fornecedores fornecedores, int auditorQuem, MsiSqlConnection oCnn)
    {
