...
#region Test Data Setup Helpers
    ...
    private void SetupMockFInstancia(string? LiminarPedida = "", string? Objeto = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", int? StatusResultado = 1, bool? LiminarPendente = false, bool? InterpusemosRecurso = true, bool? LiminarConcedida = false, bool? LiminarNegada = true, int? Processo = 1, string? Data = "24/04/1975", bool? LiminarParcial = false, string? LiminarResultado = "", string? NroProcesso = "AAAAAAAAAAAAAAAAAAAAAAA", int? Divisao = 1, bool? LiminarCliente = true, int? Comarca = 1, int? SubDivisao = 1, bool? Principal = false, int? Acao = 1, int? Foro = 1, int? TipoRecurso = 1, string? ZKey = "AAAAAAAAAAAAAAAAAAAAAAA", int? ZKeyQuem = 1, string? ZKeyQuando = "24/04/1975", string? NroAntigo = "AAAAAAAAAAAAAAAAAAAAAAA", string? AccessCode = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", int? Julgador = 1, string? ZKeyIA = "AAAAAAAAAAAAAAAAAAAAAAA")
    {
        ...
        {
            _mockFInstancia.Setup(f => f.FData).Returns((DateOnly? )null);
        }
        else
        {
            ...
            _mockFInstancia.Setup(f => f.FData).Returns(dateOnly);
        }
        ...
        if (string.IsNullOrEmpty(ZKeyQuando))
        {
            _mockFInstancia.Setup(f => f.FZKeyQuando).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(ZKeyQuando, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(ZKeyQuando, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFInstancia.Setup(f => f.FZKeyQuando).Returns(dateOnly);
        }
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_ZKeyQuando_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _instanciaWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.ZKeyQuando.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
#endregion
#endregion
}