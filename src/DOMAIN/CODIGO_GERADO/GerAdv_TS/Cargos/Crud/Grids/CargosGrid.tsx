...
const CargosGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <CargosGridMobileComponent data={cargos} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <CargosGridDesktopComponent data={cargos} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
