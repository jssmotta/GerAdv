...
if (getParamFromUrl("processos") > 0) {
 ...
 const addValorProcesso = (e: any) => {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-ProcessOutputRequest' : 'form-container5 form-container-ProcessOutputRequest'}>
       
            <form className='formInputCadInc' id={`ProcessOutputRequestForm-${processoutputrequestData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={processoutputrequestData} isSubmitting={isSubmitting} onClose={onClose} formId={`ProcessOutputRequestForm-${processoutputrequestData.id}`} preventPropagation={true} onSave={handleDirectSave} />
