...
public partial class DBToolWTable
{
    ...
    private class UpdateExecutor64
    {
        ...
        {
            var sqlBuilder = new SqlCommandBuilder64(_parent, _connection);
        ...
        private string ExecuteInsert(SqlCommandBuilder64 sqlBuilder, IdGenerator idGenerator, SqlTransaction? oTrans)
        {
        ...
        private string ExecuteUpdate(SqlCommandBuilder64 sqlBuilder, SqlTransaction? oTrans)
        {
            if (ShouldSkipUpdate())
                return "OK";
