...
// useOperadorEMailPopupGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de OperadorEMailPopup
"use client";
...
interface UseOperadorEMailPopupGridProps {
...
export const useOperadorEMailPopupGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseOperadorEMailPopupGridProps) => {
  // ===== GERENCIAMENTO DE REORDENAÇÃO DE COLUNAS =====
  const [columnsOrder, setColumnsOrder] = useState<string[]>([]);

  // Definir ordem padrão das colunas
  const defaultColumnsOrder = useMemo(() => ["nome", "rnomeoperador"], []);
  ...
  const filterLogic = useCallback(
    (data: IOperadorEMailPopup, filters: Record<string, any>) => {
