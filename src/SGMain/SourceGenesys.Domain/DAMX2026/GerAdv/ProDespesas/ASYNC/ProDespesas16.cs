...
public partial class DBProDespesas
{
    ...
    /// </summary>
    public static async Task<DBProDespesas> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBProDespesas();
