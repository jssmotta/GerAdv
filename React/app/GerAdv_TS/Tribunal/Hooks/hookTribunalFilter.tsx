...
interface UseTribunalFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterTribunal | undefined | null,
  ) => Promise<void>;
}
...
interface UseTribunalFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterTribunal>,
  ) => React.ReactNode;
...
export const useTribunalFilter = ({
  handleFetchWithFilter,
}: UseTribunalFilterProps): UseTribunalFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterTribunal>(
    {} as FilterTribunal,
  );
