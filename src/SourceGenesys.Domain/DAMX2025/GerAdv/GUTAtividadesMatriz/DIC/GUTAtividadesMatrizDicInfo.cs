...
public static partial class DBGUTAtividadesMatrizDicInfo
{
    ...
    public const string CampoNome = "amgGUID";
...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem AmgGUID => new(0, PTabelaNome, CampoCodigo, GUID, 50, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextNome, true, true, false)
    {
        IsRequired = true,
        Prefixo = "amg"
    };
