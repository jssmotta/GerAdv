...
const EMPClassRiscosInc: React.FC<IEMPClassRiscosFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedEMPClassRiscos =
        await empclassriscosService.saveEMPClassRiscos(data);
