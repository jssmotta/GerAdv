...
// useEscritoriosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Escritorios
"use client";
...
interface UseEscritoriosGridProps {
  data: IEscritorios[];
...
export const useEscritoriosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IEscritorios, filters: Record<string, any>) => {
