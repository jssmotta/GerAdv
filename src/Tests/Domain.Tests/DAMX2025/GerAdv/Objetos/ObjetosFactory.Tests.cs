...
public class FObjetosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FObjetos>();
    }
    ...
    {
        // Arrange
        var factory = new FObjetosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("ojtCodigo", typeof(int));
        mockDataTable.Columns.Add("ojtNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["ojtCodigo"] = testId;
        row["ojtNome"] = "Test Objetos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["ojtCodigo"] = 123;
        row["ojtNome"] = "Test Objetos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FObjetos properties
        }
    }
