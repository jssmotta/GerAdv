                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tacCodigo) FROM {"TiposAcao".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tacNome,tacInativo,tacBold,tacGuid FROM {"TiposAcao".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
