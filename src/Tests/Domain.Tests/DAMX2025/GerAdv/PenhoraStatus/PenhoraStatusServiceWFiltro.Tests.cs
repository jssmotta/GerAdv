...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class PenhoraStatusServiceWFiltroTests : IDisposable
    {
        ...
        private readonly PenhoraStatusServiceS _serviceS;
        public PenhoraStatusServiceWFiltroTests()
        {
            ...
            _serviceS = new PenhoraStatusServiceS();
            _service = new PenhoraStatusService(_mockAppSettings.Object, _mockPenhoraStatusFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockPenhoraService.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidPenhoraStatus_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomePenhoraStatus = "João Silva";
            var filtro = new FilterPenhoraStatus
            {
                Guid = nomePenhoraStatus,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidPenhoraStatus_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
        ...
        [Fact]
        public void WFiltro_GuidPenhoraStatus_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidPenhoraStatus_StringsVazias_NaoDeveIncluirNoFiltro(string? nomePenhoraStatus)
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
        ...
        [Fact]
        public void WFiltro_GuidPenhoraStatus_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
            ...
            resultado.Value.where.Should().Contain("@phsGuid");
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatus.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @phsGuid");
            resultado.Value.where.Should().Contain($"= @{DBPenhoraStatus.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidPenhoraStatus_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomePenhoraStatus = "João Silva";
            var filtro = new FilterPenhoraStatus
            ...
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @phsGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@phsGuid");
        ...
        [Fact]
        public void WFiltro_NomePenhoraStatus_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomePenhoraStatus = "João Silva";
            var filtro = new FilterPenhoraStatus
            {
                Nome = nomePenhoraStatus,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomePenhoraStatus_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
        ...
        [Fact]
        public void WFiltro_NomePenhoraStatus_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomePenhoraStatus_StringsVazias_NaoDeveIncluirNoFiltro(string? nomePenhoraStatus)
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
        ...
        [Fact]
        public void WFiltro_NomePenhoraStatus_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterPenhoraStatus
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@phsNome");
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatus.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @phsNome");
            resultado.Value.where.Should().Contain($"= @{DBPenhoraStatus.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomePenhoraStatus_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomePenhoraStatus = "João Silva";
            var filtro = new FilterPenhoraStatus
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @phsNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@phsNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemCad}] = @{DBPenhoraStatusDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBPenhoraStatusDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.QuemCad} BETWEEN @{DBPenhoraStatusDicInfo.QuemCad} AND @{DBPenhoraStatusDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.QuemCad} BETWEEN @{DBPenhoraStatusDicInfo.QuemCad} AND @{DBPenhoraStatusDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemCad}] = @{DBPenhoraStatusDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemCad}] = @phsQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@phsQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@phsQuemCad");
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemAtu}] = @{DBPenhoraStatusDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBPenhoraStatusDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.QuemAtu} BETWEEN @{DBPenhoraStatusDicInfo.QuemAtu} AND @{DBPenhoraStatusDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.QuemAtu} BETWEEN @{DBPenhoraStatusDicInfo.QuemAtu} AND @{DBPenhoraStatusDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemAtu}] = @{DBPenhoraStatusDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.QuemAtu}] = @phsQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@phsQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@phsQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.CampoCodigo}] = @{DBPenhoraStatusDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBPenhoraStatusDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.CampoCodigo} BETWEEN @{DBPenhoraStatusDicInfo.CampoCodigo} AND @{DBPenhoraStatusDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBPenhoraStatusDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.CampoCodigo} BETWEEN @{DBPenhoraStatusDicInfo.CampoCodigo} AND @{DBPenhoraStatusDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.CampoCodigo}] = @{DBPenhoraStatusDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBPenhoraStatusDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBPenhoraStatusDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.DtCad} BETWEEN @{DBPenhoraStatusDicInfo.DtCad} AND @{DBPenhoraStatusDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBPenhoraStatusDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBPenhoraStatusDicInfo.PTabelaNome}].[{DBPenhoraStatusDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBPenhoraStatusDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPenhoraStatusDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBPenhoraStatusDicInfo.PTabelaNome}].{DBPenhoraStatusDicInfo.DtAtu} BETWEEN @{DBPenhoraStatusDicInfo.DtAtu} AND @{DBPenhoraStatusDicInfo.DtAtu}_end");
        }
