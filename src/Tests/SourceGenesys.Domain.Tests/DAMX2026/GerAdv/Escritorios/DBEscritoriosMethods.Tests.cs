...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBEscritorios
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBEscritoriosUpdateAdvancedTests : IDisposable
{
    private readonly DBEscritorios _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBEscritoriosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBEscritorios
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBEscritorios).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBEscritorios).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBEscritorios instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBEscritorios).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBEscritorios.PTabelaNome.Should().Be("Escritorios");
        DBEscritorios.CampoCodigo.Should().Be("escCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBEscritorios();
        dbRec.ID = 1;
