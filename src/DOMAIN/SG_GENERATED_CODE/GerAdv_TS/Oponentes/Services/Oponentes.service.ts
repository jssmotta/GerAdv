...
export interface IOponentesService {
  ...
  filterVoice: (filtro?: FilterOponentes, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class OponentesService implements IOponentesService {
  ...
  async filterVoice(filtro?: FilterOponentes, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
