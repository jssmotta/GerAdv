...
public class TipoEnderecoServiceTests : IDisposable
{
    ...
    public TipoEnderecoServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new TipoEnderecoService(_mockAppSettings.Object, _mockTipoEnderecoFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
