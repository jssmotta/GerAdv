...
// usePosicaoOutrasPartesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de PosicaoOutrasPartes
"use client";
...
interface UsePosicaoOutrasPartesGridProps {
...
export const usePosicaoOutrasPartesGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IPosicaoOutrasPartes, filters: Record<string, any>) => {
