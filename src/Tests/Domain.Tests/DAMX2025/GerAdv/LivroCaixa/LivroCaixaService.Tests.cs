...
public class LivroCaixaServiceTests : IDisposable
{
    ...
    {
        // Arrange & Act
        var service = new LivroCaixaService(_mockAppSettings.Object, _mockLivroCaixaFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
