...
export const LivroCaixaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ILivroCaixa, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-livrocaixa'
