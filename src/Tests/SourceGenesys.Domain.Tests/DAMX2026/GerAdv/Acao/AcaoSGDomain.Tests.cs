...
/// DBAcao - Nome da classe (ex: DBClientes)
/// Acao - Nome da tabela (ex: Clientes)
/// aca - Prefixo dos campos (ex: cli)
/// acaCodigo - Nome do campo código (ex: cliCodigo)
/// acaDescricao - Nome do campo nome (ex: cliNome)
/// DBAcao.CadastroGuid - GUID do cadastro
/// </summary>
namespace MenphisSI.GerAdv.Tests;
public class DBAcaoTests : IDisposable
{
    ...
    private DataTable CreateTestDataTable()
    {
        ...
        dt.Columns.Add("acaCodigo", typeof(int));
        dt.Columns.Add("acaQuemCad", typeof(int));
        dt.Columns.Add("acaDtCad", typeof(DateTime));
        dt.Columns.Add("acaQuemAtu", typeof(int));
        dt.Columns.Add("acaDtAtu", typeof(DateTime));
        dt.Columns.Add("acaVisto", typeof(bool));
        dt.Columns.Add("acaJustica", typeof(int));
        dt.Columns.Add("acaArea", typeof(int));
        dt.Columns.Add("acaDescricao", typeof(string));
        dt.Columns.Add("acaGuid", typeof(string));
        return dt;
    }
    ...
    public void Constructor_WithValidDataRow_ShouldLoadData()
    {
        ...
        // Act
        var instance = new DBAcao(_testDataTable.Rows[0]);
        // Assert
...
#region Testes de Constantes e Propriedades Estáticas
    ...
    {
        Assert.Equal("Acao", DBAcao.PTabelaNome);
        Assert.Equal(" Acao.* ", DBAcao.CamposSqlX);
        Assert.Equal("acaCodigo", DBAcao.CampoCodigo);
        Assert.Equal("acaDescricao", DBAcao.CampoNome);
        Assert.Equal("aca", DBAcao.PTabelaPrefixo);
    }
...
#region Testes de Construtores
    ...
    {
        var instance = new DBAcao();
        Assert.Equal(0, instance.ID);
        Assert.Equal("Acao", instance.ITableName());
        Assert.Equal("aca", instance.Prefixo);
    }

    [Fact]
    public void Constructor_WithNullDataRow_ShouldNotThrow()
    {
        var instance = new DBAcao((DataRow)null !);
        Assert.Equal(0, instance.ID);
    }
    ...
    {
        var instance = new DBAcao((SqlDataReader)null !);
        Assert.Equal(0, instance.ID);
    }
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("Acao", cadastro.ITableName());
        Assert.Equal("acaCodigo", cadastro.IFieldId());
        Assert.Equal("acaDescricao", cadastro.IFieldNameDescription());
        Assert.Equal("aca", cadastro.IPrefix());
    }
...
#region Testes de Métodos Assíncronos
    ...
    {
        var instance = await DBAcao.CreateAsync(0, null);
        Assert.Equal(0, instance.ID);
    }
    ...
    {
        var exists = await DBAcao.ExisteAsync(1, null);
        Assert.False(exists);
    }
    ...
    {
        var result = await DBAcao.DeleteRecordAsync(1, 0, null);
        Assert.False(result);
    }
...
#region Testes de Propriedades Computadas
    ...
    public void Descricao_ShouldRespectMaxLength()
    {
        ...
        Assert.True(_instance.FDescricao.Length <= 255);
    }
