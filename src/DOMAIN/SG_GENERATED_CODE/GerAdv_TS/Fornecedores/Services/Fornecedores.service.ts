...
export interface IFornecedoresService {
  ...
  filterVoice: (filtro?: FilterFornecedores, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class FornecedoresService implements IFornecedoresService {
  ...
  async filterVoice(filtro?: FilterFornecedores, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
