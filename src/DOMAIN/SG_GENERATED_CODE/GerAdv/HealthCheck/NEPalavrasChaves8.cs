                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(npcCodigo) FROM {"NEPalavrasChaves".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) npcNome,npcBold FROM {"NEPalavrasChaves".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
