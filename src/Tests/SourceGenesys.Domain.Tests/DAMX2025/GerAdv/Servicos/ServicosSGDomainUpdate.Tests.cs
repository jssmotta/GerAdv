...
public class DBServicosUpdate : IDisposable
{
    private readonly DBServicos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBServicosUpdate()
    {
    ...
    {
        // Act
        var servicos = new DBServicos();
        // Assert
        servicos.Should().NotBeNull();
        servicos.ITableName().Should().Be("Servicos");
        servicos.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        var servicos = new DBServicos
        {
            FDescricao = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
            FGuid = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
        };
        // Assert - All properties should be set servicos.FDescricao.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        servicos.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        servicos.FDescricao = longString; // MAX: 200
        servicos.FGuid = longString; // MAX: 100
        // Assert - All properties should be set servicos.FDescricao.Should().HaveLength(200);
        servicos.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FDescricao_Property_ShouldAcceptValidNames(string Descricao)
    {
        ...
        // Assert
        servicos.FDescricao.Should().Be(Descricao);
    }
    ...
    public void FDescricao_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        servicos.FDescricao.Should().Be(string.Empty);
    }
    ...
    public void FDescricao_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        servicos.FDescricao = longName;
        // Assert
        servicos.FDescricao.Should().HaveLength(200);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBServicos).GetField("pFldFDescricao", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FDescricao = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var servicos = new DBServicos();
        // Act & Assert
        servicos.TabelaNome.Should().Be("Servicos");
    }
