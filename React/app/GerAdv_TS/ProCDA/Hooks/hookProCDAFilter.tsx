...
interface UseProCDAFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterProCDA | undefined | null,
  ) => Promise<void>;
}
...
interface UseProCDAFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterProCDA>,
  ) => React.ReactNode;
...
export const useProCDAFilter = ({
  handleFetchWithFilter,
}: UseProCDAFilterProps): UseProCDAFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterProCDA>(
    {} as FilterProCDA,
  );
