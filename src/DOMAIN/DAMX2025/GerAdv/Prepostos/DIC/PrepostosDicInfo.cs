...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem PreFuncao => new(0, PTabelaNome, CampoCodigo, Funcao, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBFuncaoDicInfo.CampoCodigo, DBFuncaoDicInfo.TabelaNome, new DBFuncaoODicInfo(), false)
    {
        Prefixo = "pre"
    }; // DBI 11 
    public static DBInfoSystem PreSetor => new(0, PTabelaNome, CampoCodigo, Setor, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBSetorDicInfo.CampoCodigo, DBSetorDicInfo.TabelaNome, new DBSetorODicInfo(), false)
    {
        Prefixo = "pre"
    }; // DBI 11 
    ...
    public static DBInfoSystem PreCidade => new(0, PTabelaNome, CampoCodigo, Cidade, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBCidadeDicInfo.CampoCodigo, DBCidadeDicInfo.TabelaNome, new DBCidadeODicInfo(), false)
    {
        Prefixo = "pre"
    }; // DBI 11 
