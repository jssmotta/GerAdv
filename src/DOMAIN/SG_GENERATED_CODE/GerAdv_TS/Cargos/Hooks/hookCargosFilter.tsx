...
interface UseCargosFilterProps {
    handleFetchWithFilter: (filtro?: FilterCargos | undefined | null) => Promise<void>;
}
...
interface UseCargosFilterReturn {
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterCargos>) => React.ReactNode;
...
export const useCargosFilter = ({ handleFetchWithFilter }: UseCargosFilterProps): UseCargosFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterCargos>({} as FilterCargos);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterCargos;
