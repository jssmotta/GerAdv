...
export interface IClientesSociosService {
  ...
  filterVoice: (filtro?: FilterClientesSocios, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ClientesSociosService implements IClientesSociosService {
  ...
  async filterVoice(filtro?: FilterClientesSocios, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
