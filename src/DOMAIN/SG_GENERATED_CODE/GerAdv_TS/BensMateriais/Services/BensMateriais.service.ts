...
export interface IBensMateriaisService {
  ...
  filterVoice: (filtro?: FilterBensMateriais, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class BensMateriaisService implements IBensMateriaisService {
  ...
  async filterVoice(filtro?: FilterBensMateriais, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
