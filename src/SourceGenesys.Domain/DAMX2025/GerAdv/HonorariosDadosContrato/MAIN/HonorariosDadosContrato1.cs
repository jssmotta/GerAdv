...
#region TableDefinition_HonorariosDadosContrato
...
#endregion
    public DBHonorariosDadosContrato(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        // Tracking: 250605-0
        if (oCnn is null)
            return;
    ...
    public DBHonorariosDadosContrato(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
