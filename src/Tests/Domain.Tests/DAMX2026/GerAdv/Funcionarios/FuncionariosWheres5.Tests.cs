...
#region Test Data Setup Helpers
    ...
    private void SetupMockFFuncionarios(string? EMailPro = "test@email.com", int? Cargo = 1, string? Nome = "João", int? Funcao = 1, bool? Sexo = false, string? Registro = "AAAAAAAAAAAAAAAAAA", string? CPF = "544.506.718-13", string? RG = "12.345.678-9", bool? Tipo = true, string? Observacao = "Observação teste", string? Endereco = "Rua das Flores, 123", string? Bairro = "Centro", int? Cidade = 1, string? CEP = "01234-567", string? Contato = "", string? Fax = "(11) 88888-9999", string? Fone = "(11) 99999-9999", string? EMail = "test@email.com", string? Periodo_Ini = "24/04/1975", string? Periodo_Fim = "24/04/1975", string? CTPSNumero = "AAAAAAAAAAAAA", string? CTPSSerie = "AAAAAAAA", string? PIS = "AAAAAAAAAAAAAAAAAA", decimal? Salario = 1m, string? CTPSDtEmissao = "24/04/1975", string? DtNasc = "24/04/1975", string? Data = "24/04/1975", bool? LiberaAgenda = false, string? Pasta = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? Class = "A")
    {
        ...
        if (string.IsNullOrEmpty(Periodo_Ini))
        {
            _mockFFuncionarios.Setup(f => f.FPeriodo_Ini).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(Periodo_Ini, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(Periodo_Ini, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFFuncionarios.Setup(f => f.FPeriodo_Ini).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(Periodo_Fim))
        {
            _mockFFuncionarios.Setup(f => f.FPeriodo_Fim).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(Periodo_Fim, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(Periodo_Fim, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFFuncionarios.Setup(f => f.FPeriodo_Fim).Returns(dateOnly);
        }
        ...
        if (string.IsNullOrEmpty(CTPSDtEmissao))
        {
            _mockFFuncionarios.Setup(f => f.FCTPSDtEmissao).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(CTPSDtEmissao, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(CTPSDtEmissao, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFFuncionarios.Setup(f => f.FCTPSDtEmissao).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(DtNasc))
        {
            _mockFFuncionarios.Setup(f => f.FDtNasc).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            ...
            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFFuncionarios.Setup(f => f.FDtNasc).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(Data))
        {
            _mockFFuncionarios.Setup(f => f.FData).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            ...
            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFFuncionarios.Setup(f => f.FData).Returns(dateOnly);
        }
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_Periodo_Ini_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _funcionariosWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.Periodo_Ini.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDate_Periodo_Fim_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _funcionariosWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.Periodo_Fim.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDate_CTPSDtEmissao_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _funcionariosWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.CTPSDtEmissao.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
