...
public partial class FApenso : MenphisSI.SG.GerAdv.DBApenso, IDBApenso
{
    ...
    public static FApenso CreateFromReader(SqlDataReader? dbRec)
    {
        return new FApenso(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FApenso CreateFromDataRow(DataRow? dbRec)
    {
        return new FApenso(dbRec);
    }

    private FApenso(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FApenso(DataRow? dbRec) : base(dbRec)
    {
    }

    public async Task<FApenso> CreateFromIdAsync(int id, MsiSqlConnection oCnn)
    {
        var fApenso = new FApenso();
        await fApenso.CarregarAsync(id, oCnn);
        return fApenso;
    }

    private FApenso(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FApenso CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FApenso(parameters, oCnn, fullSql, sqlWhere, join);
    }
