...
export const AgendaQuemGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAgendaQuem, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-agendaquem'
