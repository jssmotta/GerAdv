...
public partial class FContaCorrente : MenphisSI.SG.GerAdv.DBContaCorrente, IDBContaCorrente
{
    ...
    private FContaCorrente(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FContaCorrente CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FContaCorrente(parameters, oCnn, fullSql, sqlWhere, join);
    }
