...
public partial class DBNECompromissos
{
    ...
    /// </summary>
    public static async Task<DBNECompromissos> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBNECompromissos();
