...
// useGruposEmpresasCliGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GruposEmpresasCli
'use client';
...
interface UseGruposEmpresasCliGridProps {
...
export const useGruposEmpresasCliGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('gruposempresascli-columns-order'), JSON.stringify(reorderableFields));
