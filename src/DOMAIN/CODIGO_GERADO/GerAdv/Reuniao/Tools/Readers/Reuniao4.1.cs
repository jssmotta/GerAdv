...
public partial class ReuniaoReader
{
    private static string BuildSqlQuery(string campos, string whereClause, string orderClause, int max, MsiSqlConnection? oCnn = null)
    {
        ...
        var orderQuery = $"{TSql.OrderBy} {DBReuniaoDicInfo.CampoCodigo}";
        ...
        var query = $@"SELECT TOP ({max})
                   ...
                   LEFT JOIN {DBClientesDicInfo.PTabelaNome.dbo(oCnn)} ON [{DBClientesDicInfo.PTabelaNome}].[{DBClientes.CampoCodigo}]=[{DBReuniaoDicInfo.PTabelaNome}].[{DBReuniaoDicInfo.Cliente}]
