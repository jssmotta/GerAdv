...
public partial class DBTipoModeloDocumentoODicInfo : IODicInfo
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldId() => DBTipoModeloDocumentoDicInfo.CampoCodigo;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string ITypeFieldCode() => "int";
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IPrefix() => DBTipoModeloDocumentoDicInfo.TablePrefix;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldNameDescription() => DBTipoModeloDocumentoDicInfo.CampoNome;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
