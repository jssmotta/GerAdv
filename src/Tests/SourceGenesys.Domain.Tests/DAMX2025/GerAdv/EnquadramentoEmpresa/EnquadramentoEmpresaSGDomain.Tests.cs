...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("EnquadramentoEmpresa", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("EnquadramentoEmpresa", cadastro.ITableName());
        Assert.Equal("eqeCodigo", cadastro.IFieldId());
        Assert.Equal("eqeNome", cadastro.IFieldNameDescription());
        Assert.Equal("eqe", cadastro.IPrefix());
    }
