...
public partial class FPaises : MenphisSI.SG.GerAdv.DBPaises, IDBPaises
{
    ...
    public static FPaises CreateFromReader(SqlDataReader? dbRec)
    {
        return new FPaises(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FPaises CreateFromDataRow(DataRow? dbRec)
    {
        return new FPaises(dbRec);
    }

    private FPaises(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FPaises(DataRow? dbRec) : base(dbRec)
    {
    }

    private FPaises(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FPaises CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FPaises(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FPaises> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fPaises = new FPaises();
        await fPaises.CarregarAsync(id, oCnn);
        return fPaises;
    }
