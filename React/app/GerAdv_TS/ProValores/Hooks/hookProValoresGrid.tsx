...
// useProValoresGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProValores
"use client";
...
interface UseProValoresGridProps {
  data: IProValores[];
...
export const useProValoresGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("provalores-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IProValores, filters: Record<string, any>) => {
