...
const GUTPeriodicidadeGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <GUTPeriodicidadeGridMobileComponent data={gutperiodicidade} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <GUTPeriodicidadeGridDesktopComponent data={gutperiodicidade} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
