...
public class FilterProProcuradoresWithVoiceRequest
{
    /// <summary>
    /// Filtro de ProProcuradores padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterProProcuradores Filter { get; set; } = new();
...
public partial record FilterProProcuradores
{
    ...
    [Description("Substabelecimento -2147483648 para nada; 0 para não, 1 para sim")]
    public int Substabelecimento { get; set; } = int.MinValue;

    [JsonPropertyName("procuracao")]
    [Description("Procuracao -2147483648 para nada; 0 para não, 1 para sim")]
