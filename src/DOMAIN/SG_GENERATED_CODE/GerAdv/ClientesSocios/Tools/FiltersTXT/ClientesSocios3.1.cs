...
Instruções para preenchimento do FilterClientesSocios:

- O filter irá filtrar os ClientesSocios conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterClientesSocios:(Clientes Socios)
...
- Se ouvir "todos os ClientesSocios" ou similar, deixe todos os campos com valores padrão;
