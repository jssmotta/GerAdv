...
const ModelosDocumentosGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ModelosDocumentosGridMobileComponent data={modelosdocumentos} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <ModelosDocumentosGridDesktopComponent data={modelosdocumentos} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
