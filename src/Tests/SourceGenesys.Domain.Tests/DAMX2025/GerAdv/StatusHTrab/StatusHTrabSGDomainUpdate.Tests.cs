...
public class DBStatusHTrabUpdate : IDisposable
{
    private readonly DBStatusHTrab _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusHTrabUpdate()
    {
    ...
    // Assert - All properties should be set statushtrab.FDescricao.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        statushtrab.FDescricao = longString; // MAX: 50
    // Assert - All properties should be set statushtrab.FDescricao.Should().HaveLength(50);
    }
    ...
    public void FDescricao_Property_ShouldAcceptValidNames(string Descricao)
    {
        ...
        // Assert
        statushtrab.FDescricao.Should().Be(Descricao);
    }
    ...
    public void FDescricao_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        statushtrab.FDescricao.Should().Be(string.Empty);
    }
    ...
    public void FDescricao_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        statushtrab.FDescricao = longName;
        // Assert
        statushtrab.FDescricao.Should().HaveLength(50);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBStatusHTrab).GetField("pFldFDescricao", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FDescricao = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var statushtrab = new DBStatusHTrab();
        // Act & Assert
        statushtrab.TabelaNome.Should().Be("StatusHTrab");
    }
