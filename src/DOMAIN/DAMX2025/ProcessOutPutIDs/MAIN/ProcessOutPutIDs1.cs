...
public partial class DBProcessOutPutIDs : XCodeIdBase, ICadastros
{
#if (DEBUG)
#if (!shadowsDisabled && !shadows_MenphisSI_GerAdv && !shadows_MenphisSI_GerAdv_ProcessOutPutIDs)
#pragma warning disable CA1822 // Mark members as static

//public bool CertSignature() => DicionarioDeDadosManagedDatabaseCode.CodeSigntature_DBProcessOutPutIDs();
#pragma warning restore CA1822 // Mark members as static

#endif
#endif
#region TableDefinition_ProcessOutPutIDs
    [XmlIgnore]
    public string TabelaNome => "ProcessOutPutIDs";

    public DBProcessOutPutIDs()
    {
    }

#endregion
    public DBProcessOutPutIDs(in int nCodigo, MsiSqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBProcessOutPutIDs(in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBProcessOutPutIDs(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
...
#endif
#region GravarDados_ProcessOutPutIDs
#if (forWeb)
...
#endif
    {
        ...
        {
            throw new Exception("Campo 'poiNome' está vazio!");
        }
        ...
        if (pFldFNome)
            clsW.Fields(DBProcessOutPutIDsDicInfo.Nome, m_FNome, ETiposCampos.FString);
        if (pFldFGUID)
            clsW.Fields(DBProcessOutPutIDsDicInfo.GUID, m_FGUID, ETiposCampos.FString);
        if (insertId != 0)
            return GravaNewId();
