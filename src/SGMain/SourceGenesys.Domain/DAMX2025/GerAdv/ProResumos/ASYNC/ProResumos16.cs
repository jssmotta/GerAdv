...
public partial class DBProResumos
{
    ...
    /// </summary>
    public static async Task<DBProResumos> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBProResumos();
