                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(livCodigo) FROM {"LivroCaixa".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) livIDDes,livPessoal,livAjuste,livIDHon,livIDHonParc,livIDHonSuc,livData,livProcesso,livValor,livTipo,livHistorico,livPrevisto,livGrupo FROM {"LivroCaixa".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
