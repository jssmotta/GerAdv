...
public partial class DBContatoCRMView
{
    ...
    /// </summary>
    public static async Task<DBContatoCRMView> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBContatoCRMView();
    ...
    {
        if (pFldFCGUID)
            updateTool.Fields(DBContatoCRMViewDicInfo.CGUID, FCGUID, EGenericTypeFields.FString);
        if (pFldFData)
