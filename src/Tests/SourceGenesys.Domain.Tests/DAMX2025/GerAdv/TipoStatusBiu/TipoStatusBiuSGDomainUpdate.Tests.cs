...
public class DBTipoStatusBiuUpdate : IDisposable
{
    private readonly DBTipoStatusBiu _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoStatusBiuUpdate()
    {
    ...
    {
        // Act
        var tipostatusbiu = new DBTipoStatusBiu();
        // Assert
        tipostatusbiu.Should().NotBeNull();
        tipostatusbiu.ITableName().Should().Be("TipoStatusBiu");
        tipostatusbiu.ID.Should().Be(0);
    }
    ...
    // Assert - All properties should be set tipostatusbiu.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        tipostatusbiu.FNome = longString; // MAX: 150
    // Assert - All properties should be set tipostatusbiu.FNome.Should().HaveLength(150);
    }
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        tipostatusbiu.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        tipostatusbiu.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "tsbCodigo = 1";
        // Act & Assert
        var TipoStatusBiu = new DBTipoStatusBiu(sqlWhere, null);
        TipoStatusBiu.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var tipostatusbiu = new DBTipoStatusBiu(parameters, nome, null);
        // Assert
        tipostatusbiu.Should().NotBeNull();
        tipostatusbiu.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        tipostatusbiu.FNome = longName;
        // Assert
        tipostatusbiu.FNome.Should().HaveLength(150);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBTipoStatusBiu).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var tipostatusbiu = new DBTipoStatusBiu();
        // Act & Assert
        tipostatusbiu.TabelaNome.Should().Be("TipoStatusBiu");
    }
