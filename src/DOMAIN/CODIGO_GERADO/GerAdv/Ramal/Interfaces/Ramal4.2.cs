...
public partial interface IRamalReader
{
    ...
    Task<IEnumerable<RamalResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}