...
public class FPontoVirtualFactoryTests : IDisposable
{
    private FPontoVirtualFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FPontoVirtualFactoryTests()
    {
        _factory = new FPontoVirtualFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FPontoVirtual>();
    }
    ...
    {
        // Arrange
        var factory = new FPontoVirtualFactory();
        // Act
        factory.Dispose();
