...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBEnderecos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBEnderecosUpdateAdvancedTests : IDisposable
{
    private readonly DBEnderecos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBEnderecosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBEnderecos
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBEnderecos).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBEnderecos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBEnderecos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBEnderecos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBEnderecos.PTabelaNome.Should().Be("Enderecos");
        DBEnderecos.CampoCodigo.Should().Be("endCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBEnderecos();
        dbRec.ID = 1;
