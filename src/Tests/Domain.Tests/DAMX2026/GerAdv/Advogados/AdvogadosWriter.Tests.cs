...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFAdvogados.VerifySet(x => x.FDtInicio = DateOnly.Parse(advogados.DtInicio), Times.Once);
        _mockFAdvogados.VerifySet(x => x.FDtFim = DateOnly.Parse(advogados.DtFim), Times.Once);
        _mockFAdvogados.VerifySet(x => x.FDtNasc = DateOnly.Parse(advogados.DtNasc), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_DtInicio_ShouldNotSetFDtInicio()
    {
        // Arrange
        var advogados = CreateValidAdvogadosModel();
        ...
        // Assert
        _mockFAdvogados.VerifySet(x => x.FDtInicio = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DtFim_ShouldNotSetFDtFim()
    {
        // Arrange
        var advogados = CreateValidAdvogadosModel();
        ...
        await _advogadosWriter.WriteAsync(advogados, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFAdvogados.VerifySet(x => x.FDtFim = It.IsAny<DateOnly>(), Times.Never);
    }
    ...
    public async Task WriteAsync_WithNull_DtNasc_ShouldNotSetFDtNasc()
    {
        ...
        await _advogadosWriter.WriteAsync(advogados, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFAdvogados.VerifySet(x => x.FDtNasc = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new AdvogadosWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Advogados CreateValidAdvogadosModel()
    {
