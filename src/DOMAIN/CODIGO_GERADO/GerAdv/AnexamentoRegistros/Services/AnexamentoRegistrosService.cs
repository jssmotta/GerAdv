...
public partial class AnexamentoRegistrosService(IOptions<AppSettings> appSettings, IFAnexamentoRegistrosFactory anexamentoregistrosFactory, IAnexamentoRegistrosReader reader, IAnexamentoRegistrosValidation validation, IAnexamentoRegistrosWriter writer, IClientesReader clientesReader, IHttpContextAccessor httpContextAccessor, HybridCache cache, IMemoryCache memory) : IAnexamentoRegistrosService, IDisposable
{
    ...
    private readonly IFAnexamentoRegistrosFactory anexamentoregistrosFactory = anexamentoregistrosFactory;
    private readonly IAnexamentoRegistrosReader reader = reader;
    private readonly IAnexamentoRegistrosValidation validation = validation;
    private readonly IAnexamentoRegistrosWriter writer = writer;
    ...
    private async Task<AnexamentoRegistrosResponse?> GetDataByIdAsync(int id, MsiSqlConnection oCnn, CancellationToken token) => await reader.Read(id, oCnn);
    public async Task<AnexamentoRegistrosResponse?> AddAndUpdate([FromBody] Models.AnexamentoRegistros regAnexamentoRegistros, [FromRoute, Required] string uri)
    {
        ...
        using var saved = await writer.WriteAsync(regAnexamentoRegistros, operadorId, oCnn);
    ...
    public async Task<AnexamentoRegistrosResponse?> Validation([FromBody] Models.AnexamentoRegistros regAnexamentoRegistros, [FromRoute, Required] string uri)
    {
        ...
        return await reader.Read(regAnexamentoRegistros.Id, oCnn);
    }
    ...
    public async Task<AnexamentoRegistrosResponse?> Delete([FromQuery] int id, [FromRoute, Required] string uri)
    {
        ...
        var anexamentoregistros = await reader.Read(id, oCnn);
        try
        {
            if (anexamentoregistros != null)
            {
                await writer.Delete(anexamentoregistros, nOperador, oCnn);
