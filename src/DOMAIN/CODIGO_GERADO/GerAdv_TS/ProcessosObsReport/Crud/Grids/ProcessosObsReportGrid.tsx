...
const ProcessosObsReportGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ProcessosObsReportGridMobileComponent data={processosobsreport} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <ProcessosObsReportGridDesktopComponent data={processosobsreport} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
