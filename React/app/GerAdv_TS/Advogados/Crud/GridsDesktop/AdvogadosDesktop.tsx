  ...
  ({
    ...
    const SearchFromCellParceriaProc = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellParceriaProc(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Parceria Proc">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellProProcuradores = (props: any) => {
      return (
        <>
          <td>
            <div
              onClick={() => openSearchCellProProcuradores(props.dataItem.id)}
            >
              <span title="Pesquisar relacionados em Pro Procuradores">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const basicColumnMap: Record<string, React.ReactElement> = useMemo(
      () => ({
        ...
        id_edit_ProProcuradores: (
          <GridColumn
            key="ProProcuradores"
            field="ProProcuradores"
    ...
    const resetColumnsOrder = useCallback(() => {
      ...
      localStorage.removeItem(btoa("advogados-columns-order"));
    }, []);
