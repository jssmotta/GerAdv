...
// useAgendaRelatorioGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de AgendaRelatorio
"use client";
...
interface UseAgendaRelatorioGridProps {
...
export const useAgendaRelatorioGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IAgendaRelatorio, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
