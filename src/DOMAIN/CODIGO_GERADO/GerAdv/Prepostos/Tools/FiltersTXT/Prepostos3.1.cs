...
Instruções para preenchimento do FilterPrepostos:

- O filter irá filtrar os Prepostos conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
- filterSetor: filtro específico para Setor
...
- Se ouvir "todos os Prepostos" ou similar, deixe todos os campos com valores padrão;
