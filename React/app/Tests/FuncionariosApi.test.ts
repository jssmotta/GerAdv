...
import { FuncionariosApiError } from '@/app/GerAdv_TS/Funcionarios/Apis/FuncionariosApi';
...
import { FuncionariosTestEmpty } from '@/app/GerAdv_TS/Models/Funcionarios';
...
class: 'A'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterFuncionarios = { : 1 };
