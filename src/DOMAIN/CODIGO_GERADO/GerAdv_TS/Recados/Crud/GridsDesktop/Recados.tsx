...
export const RecadosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nomeligacoes' title='Ligacoes' sortable={false} filterable={false} />, /* Track G.01 */
  <GridColumn
  field='id'
  width={'55px'}
  title='Excluir'
...
{initialized && (
  ...
  className='grid-desktop-recados'
