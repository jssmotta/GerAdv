...
const OperadorEMailPopupInc: React.FC<IOperadorEMailPopupFormProps> = ({
  ...
  const { data, handleChange, loadOperadorEMailPopup } =
    useOperadorEMailPopupForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedOperadorEMailPopup =
        await operadoremailpopupService.saveOperadorEMailPopup(data);
