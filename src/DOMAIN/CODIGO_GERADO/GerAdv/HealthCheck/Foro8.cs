            ...
            foreach (var uri in uris)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) forEMail,forNome,forUnico,forCidade,forSite,forEndereco,forBairro,forFone,forFax,forCEP,forOBS,forUnicoConfirmado,forWeb FROM {"Foro".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
