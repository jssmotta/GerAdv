...
interface AndCompGridProps {
  data: IAndComp[];
  onRowClick: (andcomp: IAndComp) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AndCompGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAndComp, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-andcomp'
