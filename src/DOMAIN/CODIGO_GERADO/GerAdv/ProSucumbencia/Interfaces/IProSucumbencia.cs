...
public partial interface IProSucumbenciaService
{
    ...
    Task<Filters.FilterProSucumbencia> FilterVoice([FromBody] Filters.FilterProSucumbencia filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
