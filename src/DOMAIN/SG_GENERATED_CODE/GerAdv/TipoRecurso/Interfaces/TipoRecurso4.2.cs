...
public partial interface ITipoRecursoReader
{
    ...
    Task<IEnumerable<TipoRecursoResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string tenantKey, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}