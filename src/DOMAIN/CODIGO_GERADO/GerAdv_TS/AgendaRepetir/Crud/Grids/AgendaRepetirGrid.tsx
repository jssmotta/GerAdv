...
const {
  ...
  fetchData, 
  refreshData
} = useAgendaRepetirList(agendarepetirService);
...
const handleFetchWithFilter = async (filtro?: FilterAgendaRepetir | undefined | null) => {
  setCurrFilter(filtro);
  await fetchData(filtro ?? {} as FilterAgendaRepetir);
};
