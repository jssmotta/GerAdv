...
public class FEnderecosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FEnderecos>();
    }
    ...
    {
        // Arrange
        var factory = new FEnderecosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("endCodigo", typeof(int));
        mockDataTable.Columns.Add("endDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["endCodigo"] = testId;
        row["endDescricao"] = "Test Enderecos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["endCodigo"] = 123;
        row["endDescricao"] = "Test Enderecos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FEnderecos properties
        }
    }
