...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFContratos.VerifySet(x => x.FDataInicio = DateOnly.Parse(contratos.DataInicio), Times.Once);
        _mockFContratos.VerifySet(x => x.FDataTermino = DateOnly.Parse(contratos.DataTermino), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_DataInicio_ShouldNotSetFDataInicio()
    {
        // Arrange
        var contratos = CreateValidContratosModel();
        ...
        // Assert
        _mockFContratos.VerifySet(x => x.FDataInicio = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DataTermino_ShouldNotSetFDataTermino()
    {
        // Arrange
        var contratos = CreateValidContratosModel();
        ...
        await _contratosWriter.WriteAsync(contratos, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFContratos.VerifySet(x => x.FDataTermino = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ContratosWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Contratos CreateValidContratosModel()
    {
