...
export const AtividadesGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAtividades, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-atividades'
