...
const ColaboradoresGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ColaboradoresGridMobileComponent data={colaboradores} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <ColaboradoresGridDesktopComponent data={colaboradores} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
