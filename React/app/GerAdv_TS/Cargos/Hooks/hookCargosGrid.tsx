...
// useCargosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Cargos
"use client";
...
export const useCargosGrid = ({
  ...
  const filterLogic = useCallback(
    (data: ICargos, filters: Record<string, any>) => {
