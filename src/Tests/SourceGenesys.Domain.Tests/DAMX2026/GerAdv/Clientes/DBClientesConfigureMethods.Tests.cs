...
#region Fields_All
    ...
    public void ConfigureUpdateFields_Icone_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        _clientes.FIcone.Should().Be("");
        _clientes.FEmpresa.Should().Be(0);
    }
    ...
    public void ConfigureMethodsQuemIndicou_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientes.FQuemIndicou.Should().Be("");
        _clientes.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsNomeFantasia_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientes.FNomeFantasia.Should().Be("");
        _clientes.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsQualificacao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientes.FQualificacao.Should().Be("");
        _clientes.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsObservacao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientes.FObservacao.Should().Be("");
        _clientes.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_NomePai_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsRGOExpeditor_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientes.FRGOExpeditor.Should().Be("");
        _clientes.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_RGOExpeditor_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
    ...
    public void ConfigureMethodsPessoaContato_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _clientes.FPessoaContato.Should().Be("");
        _clientes.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_PessoaContato_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
