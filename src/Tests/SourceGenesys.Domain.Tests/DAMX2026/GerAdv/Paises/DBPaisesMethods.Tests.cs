...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBPaises
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBPaisesUpdateAdvancedTests : IDisposable
{
    private readonly DBPaises _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBPaisesUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBPaises
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBPaises).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBPaises).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBPaises instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBPaises).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBPaises.PTabelaNome.Should().Be("Paises");
        DBPaises.CampoCodigo.Should().Be("paiCodigo");
    }
