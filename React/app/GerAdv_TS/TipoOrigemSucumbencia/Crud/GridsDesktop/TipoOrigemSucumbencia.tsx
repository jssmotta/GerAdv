...
export const TipoOrigemSucumbenciaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ITipoOrigemSucumbencia, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  tableName: 'tipoorigemsucumbencia'
});
...
{initialized && (
  ...
  className='grid-desktop-tipoorigemsucumbencia'
