...
const ReuniaoPessoasGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ReuniaoPessoasGridMobileComponent data={reuniaopessoas} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <ReuniaoPessoasGridDesktopComponent data={reuniaopessoas} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
