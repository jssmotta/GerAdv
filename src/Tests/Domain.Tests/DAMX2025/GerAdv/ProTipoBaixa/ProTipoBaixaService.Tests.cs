...
public class ProTipoBaixaServiceTests : IDisposable
{
    ...
    public ProTipoBaixaServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new ProTipoBaixaService(_mockAppSettings.Object, _mockProTipoBaixaFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
