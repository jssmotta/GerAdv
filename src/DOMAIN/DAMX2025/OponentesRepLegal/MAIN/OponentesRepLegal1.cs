...
#region TableDefinition_OponentesRepLegal
...
#endregion
    public DBOponentesRepLegal(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBOponentesRepLegal(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBOponentesRepLegal(in string? sqlWhere, SqlConnection? oCnn)
    {
