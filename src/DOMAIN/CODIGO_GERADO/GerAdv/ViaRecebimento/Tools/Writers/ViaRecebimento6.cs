...
public class ViaRecebimentoWriter(IFViaRecebimentoFactory viarecebimentoFactory) : IViaRecebimentoWriter
{
    ...
    public async Task Delete(ViaRecebimentoResponse viarecebimento, int operadorId, MsiSqlConnection oCnn)
    {
        await _viarecebimentoFactory.DeleteAsync(operadorId, viarecebimento.Id, oCnn);
    }

    public async Task<FViaRecebimento> WriteAsync(Models.ViaRecebimento viarecebimento, MsiSqlConnection oCnn)
    {
