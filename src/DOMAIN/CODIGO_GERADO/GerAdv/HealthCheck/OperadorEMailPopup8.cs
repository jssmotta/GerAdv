                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(oepCodigo) FROM {"OperadorEMailPopup".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) oepOperador,oepNome,oepSenha,oepSMTP,oepPOP3,oepAutenticacao,oepDescricao,oepUsuario,oepPortaSmtp,oepPortaPop3,oepAssinatura,oepSenha256,oepGuid FROM {"OperadorEMailPopup".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
