...
interface GraphFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-Graph' : 'form-container5 form-container-Graph'}>
       
            <form className='formInputCadInc' id={`GraphForm-${graphData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={graphData} isSubmitting={isSubmitting} onClose={onClose} formId={`GraphForm-${graphData.id}`} preventPropagation={true} onSave={handleDirectSave} />
