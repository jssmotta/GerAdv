...
public partial class DBRegimeTributacaoODicInfo : IODicInfo
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldId() => DBRegimeTributacaoDicInfo.CampoCodigo;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string ITypeFieldCode() => "int";
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IPrefix() => DBRegimeTributacaoDicInfo.TablePrefix;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldNameDescription() => DBRegimeTributacaoDicInfo.CampoNome;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
