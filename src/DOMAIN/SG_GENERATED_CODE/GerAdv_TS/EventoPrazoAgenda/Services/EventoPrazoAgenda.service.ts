...
export interface IEventoPrazoAgendaService {
  ...
  filterVoice: (filtro?: FilterEventoPrazoAgenda, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class EventoPrazoAgendaService implements IEventoPrazoAgendaService {
  ...
  async filterVoice(filtro?: FilterEventoPrazoAgenda, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
