...
public partial interface IOponentesRepLegalService
{
    ...
    Task<Filters.FilterOponentesRepLegal> FilterVoice([FromBody] Filters.FilterOponentesRepLegal filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
