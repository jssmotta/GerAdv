                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(triCodigo) FROM {"Tribunal".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) triNome,triArea,triJustica,triDescricao,triInstancia,triSigla,triWeb,triEtiqueta,triBold,triGuid FROM {"Tribunal".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
