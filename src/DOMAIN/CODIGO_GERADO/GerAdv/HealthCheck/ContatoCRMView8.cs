                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ccwCodigo) FROM {"ContatoCRMView".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ccwCGUID,ccwData,ccwIP FROM {"ContatoCRMView".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
