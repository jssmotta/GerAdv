...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void GarantiaLoja_ShouldAcceptIntegerValues(int value)
{
    _instance.FGarantiaLoja = value;
    Assert.Equal(value, _instance.FGarantiaLoja);
}
...
[Fact]
public void GarantiaLoja_DefaultValue_ShouldBeZero()
{
    var instance = new DBBensMateriais();
    Assert.Equal(0, instance.GarantiaLoja);
}
*/
    /*
...
[InlineData("31/12/2023")]
[InlineData("15/08/2024")]
public void GarantiaLoja_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FGarantiaLoja = dateString;
    Assert.Equal(dateString, _instance.FGarantiaLoja);
}

[Fact]
public void GarantiaLoja_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBBensMateriais();
    Assert.Equal(string.Empty, instance.GarantiaLoja);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("", "")]
public void GarantiaLoja_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FGarantiaLoja = input;
        Assert.Equal(expected, _instance.FGarantiaLoja);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FGarantiaLoja = input);
    }
}
*/
    /*
...
public void GarantiaLoja_ValidEmail_ShouldAccept(string email)
{
    _instance.FGarantiaLoja = email;
    Assert.Equal(email, _instance.FGarantiaLoja);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void GarantiaLoja_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FGarantiaLoja = email);
}
*/
    [Theory]
    [InlineData("01/01/2000")]
