...
#region TableDefinition_DadosProcuracao
...
#endregion
    public DBDadosProcuracao(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        // Tracking: 250605-0
        if (oCnn is null)
            return;
    ...
    public DBDadosProcuracao(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
