...
interface PoderJudiciarioAssociadoGridProps {
  data: IPoderJudiciarioAssociado[];
  onRowClick: (poderjudiciarioassociado: IPoderJudiciarioAssociado) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const PoderJudiciarioAssociadoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
}: PoderJudiciarioAssociadoGridProps) => {
...
const gridColumns = useMemo(() => [
  ...
  tableName: 'poderjudiciarioassociado'
});
...
{initialized && (
  ...
  className='grid-desktop-poderjudiciarioassociado'
