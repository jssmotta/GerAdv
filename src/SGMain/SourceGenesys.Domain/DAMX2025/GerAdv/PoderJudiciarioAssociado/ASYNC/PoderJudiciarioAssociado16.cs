...
#if (!NOTSTORED_PoderJudiciarioAssociado)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFJustica || pFldFJusticaNome || pFldFArea || pFldFAreaNome || pFldFTribunal || pFldFTribunalNome || pFldFForo || pFldFForoNome || pFldFCidade || pFldFSubDivisaoNome || pFldFCidadeNome || pFldFSubDivisao || pFldFGUID || pFldFTipo;
