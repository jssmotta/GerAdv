...
public class EventoPrazoAgendaServiceTests : IDisposable
{
    ...
    public EventoPrazoAgendaServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new EventoPrazoAgendaService(_mockAppSettings.Object, _mockEventoPrazoAgendaFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
