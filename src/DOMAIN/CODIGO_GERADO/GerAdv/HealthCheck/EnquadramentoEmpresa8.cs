                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(eqeCodigo) FROM {"EnquadramentoEmpresa".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) eqeNome,eqeGuid FROM {"EnquadramentoEmpresa".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
