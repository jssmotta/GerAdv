  ...
  const renderInputFilters = (handlers: FilterHandlers<FilterReuniao>) => (
    <>
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("horainicial", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("horainicial_end", value)
        }
      />
      <InputDate
        type="text"
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("horasaida", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("horasaida_end", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("horaretorno", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("horaretorno_end", value)
        }
      />
      <InputInput
        type="text"
