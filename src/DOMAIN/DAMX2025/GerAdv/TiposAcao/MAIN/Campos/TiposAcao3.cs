...
{
    [XmlIgnore]
    private protected bool pFldFNome, pFldFInativo, pFldFBold;
    [XmlIgnore]
    private protected string? m_FNome;
    [XmlIgnore]
    private protected bool m_FInativo, m_FBold;
    [StringLength(80, ErrorMessage = "A propriedade FNome da tabela TiposAcao deve ter no máximo 80 caracteres.")]
    public string? FNome
    {
