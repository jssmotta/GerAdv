...
public partial class DBNEPalavrasChaves
{
    ...
    /// </summary>
    public static async Task<DBNEPalavrasChaves> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBNEPalavrasChaves();
