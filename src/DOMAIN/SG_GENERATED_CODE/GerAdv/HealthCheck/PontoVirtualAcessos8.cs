                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(pvaCodigo) FROM {"PontoVirtualAcessos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) pvaOperador,pvaDataHora,pvaTipo,pvaOrigem FROM {"PontoVirtualAcessos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
