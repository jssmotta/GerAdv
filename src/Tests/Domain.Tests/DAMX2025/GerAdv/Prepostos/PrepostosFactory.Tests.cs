...
public class FPrepostosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FPrepostos>();
    }
    ...
    {
        // Arrange
        var factory = new FPrepostosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("preCodigo", typeof(int));
        mockDataTable.Columns.Add("preNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["preCodigo"] = testId;
        row["preNome"] = "Test Prepostos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["preCodigo"] = 123;
        row["preNome"] = "Test Prepostos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FPrepostos properties
        }
    }
