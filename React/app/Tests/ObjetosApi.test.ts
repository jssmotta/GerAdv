...
import { ObjetosApiError } from '@/app/GerAdv_TS/Objetos/Apis/ApiObjetos';
...
import { ObjetosTestEmpty } from '@/app/GerAdv_TS/Models/Objetos';
...
nome: 'João'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterObjetos = { : 1 };
