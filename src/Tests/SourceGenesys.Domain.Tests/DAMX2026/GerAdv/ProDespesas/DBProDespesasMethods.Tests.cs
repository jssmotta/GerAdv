...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProDespesas
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProDespesasUpdateAdvancedTests : IDisposable
{
    private readonly DBProDespesas _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProDespesasUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProDespesas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProDespesas instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProDespesas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBProDespesas).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProDespesas.PTabelaNome.Should().Be("ProDespesas");
        DBProDespesas.CampoCodigo.Should().Be("desCodigo");
    }
