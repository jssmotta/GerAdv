...
public partial class FEnderecoSistema : MenphisSI.SG.GerAdv.DBEnderecoSistema, IDBEnderecoSistema
{
    ...
    private FEnderecoSistema(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FEnderecoSistema CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FEnderecoSistema(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
