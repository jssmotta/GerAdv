...
// useEnquadramentoEmpresaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de EnquadramentoEmpresa
"use client";
...
interface UseEnquadramentoEmpresaGridProps {
...
export const useEnquadramentoEmpresaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseEnquadramentoEmpresaGridProps) => {
  ...
  const filterLogic = useCallback(
    (data: IEnquadramentoEmpresa, filters: Record<string, any>) => {
