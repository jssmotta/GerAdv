                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tpdCodigo) FROM {"TipoModeloDocumento".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tpdNome,tpdGuid FROM {"TipoModeloDocumento".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
