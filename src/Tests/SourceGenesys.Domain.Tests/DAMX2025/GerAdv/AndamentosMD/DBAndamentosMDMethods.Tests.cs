...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBAndamentosMD
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBAndamentosMDUpdateAdvancedTests : IDisposable
{
    private readonly DBAndamentosMD _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBAndamentosMDUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBAndamentosMD
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBAndamentosMD).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBAndamentosMD).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBAndamentosMD instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBAndamentosMD).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBAndamentosMD.PTabelaNome.Should().Be("AndamentosMD");
        DBAndamentosMD.CampoCodigo.Should().Be("amdCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBAndamentosMD();
        dbRec.ID = 1;
