...
// useProTipoBaixaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProTipoBaixa
"use client";
...
interface UseProTipoBaixaGridProps {
  data: IProTipoBaixa[];
...
export const useProTipoBaixaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
      ...
      if (
        ...
        try {
          localStorage.setItem(
            btoa("protipobaixa-columns-order"),
  ...
  const filterLogic = useCallback(
    (data: IProTipoBaixa, filters: Record<string, any>) => {
  ...
  return {
    ...
    resetColumnsOrder: () => {
      setColumnsOrder(defaultColumnsOrder);
      localStorage.removeItem(btoa("protipobaixa-columns-order"));
    },
