...
// useFuncaoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Funcao
"use client";
...
export const useFuncaoGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IFuncao, filters: Record<string, any>) => {
