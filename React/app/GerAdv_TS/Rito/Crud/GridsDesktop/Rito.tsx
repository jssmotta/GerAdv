...
interface RitoGridProps {
  data: IRito[];
  onRowClick: (rito: IRito) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const RitoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IRito, filters: Record<string, any>) => {
...
const openConsultaProcessos = (id: number) => {
  router.push(`/pages/processos/?rito=${id}`);
};
