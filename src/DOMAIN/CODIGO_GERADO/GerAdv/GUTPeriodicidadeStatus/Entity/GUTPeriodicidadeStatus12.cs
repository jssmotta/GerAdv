...
public partial class FGUTPeriodicidadeStatus : MenphisSI.SG.GerAdv.DBGUTPeriodicidadeStatus, IDBGUTPeriodicidadeStatus
{
    ...
    private FGUTPeriodicidadeStatus(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FGUTPeriodicidadeStatus CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FGUTPeriodicidadeStatus(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
