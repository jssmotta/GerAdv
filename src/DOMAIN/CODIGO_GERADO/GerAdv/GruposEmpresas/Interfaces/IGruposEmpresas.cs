...
{
    Task<IEnumerable<GruposEmpresasResponseAll>> Filter([FromQuery] int max, [FromBody] Filters.FilterGruposEmpresas filter, [FromRoute, Required] string uri = "");
    Task<Filters.FilterGruposEmpresas> FilterVoice([FromBody] Filters.FilterGruposEmpresas filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
