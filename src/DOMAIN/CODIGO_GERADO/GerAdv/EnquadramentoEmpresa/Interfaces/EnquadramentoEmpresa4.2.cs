...
public partial interface IEnquadramentoEmpresaReader
{
    ...
    Task<IEnumerable<EnquadramentoEmpresaResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}