...
interface UseFaseFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterFase | undefined | null,
  ) => Promise<void>;
}
...
export const useFaseFilter = ({
  handleFetchWithFilter,
}: UseFaseFilterProps): UseFaseFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterFase>(
    {} as FilterFase,
  );
