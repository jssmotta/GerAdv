...
interface TipoModeloDocumentoFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-TipoModeloDocumento' : 'form-container5 form-container-TipoModeloDocumento'}>
       
            <form className='formInputCadInc' id={`TipoModeloDocumentoForm-${tipomodelodocumentoData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={tipomodelodocumentoData} isSubmitting={isSubmitting} onClose={onClose} formId={`TipoModeloDocumentoForm-${tipomodelodocumentoData.id}`} preventPropagation={true} onSave={handleDirectSave} />
