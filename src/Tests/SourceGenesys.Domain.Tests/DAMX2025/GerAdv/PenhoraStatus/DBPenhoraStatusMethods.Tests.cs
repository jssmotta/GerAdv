...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBPenhoraStatus
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBPenhoraStatusUpdateAdvancedTests : IDisposable
{
    private readonly DBPenhoraStatus _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBPenhoraStatusUpdateAdvancedTests()
    {
        _instance = new DBPenhoraStatus();
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBPenhoraStatus
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBPenhoraStatus).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBPenhoraStatus).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBPenhoraStatus instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBPenhoraStatus).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBPenhoraStatus.PTabelaNome.Should().Be("PenhoraStatus");
        DBPenhoraStatus.CampoCodigo.Should().Be("phsCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBPenhoraStatus();
        dbRec.ID = 1;
