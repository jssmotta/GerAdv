...
const FornecedoresGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <FornecedoresGridMobileComponent data={fornecedores} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <FornecedoresGridDesktopComponent data={fornecedores} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
