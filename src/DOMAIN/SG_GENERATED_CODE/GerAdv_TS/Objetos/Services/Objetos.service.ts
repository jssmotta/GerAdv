...
export interface IObjetosService {
  ...
  filterVoice: (filtro?: FilterObjetos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ObjetosService implements IObjetosService {
  ...
  async filterVoice(filtro?: FilterObjetos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
