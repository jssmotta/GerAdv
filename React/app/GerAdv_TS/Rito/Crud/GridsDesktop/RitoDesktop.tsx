...
export const RitoGridDesktopComponent = React.memo(
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(btoa("rito-columns-order"));
        if (savedOrder) {
      ...
      <>
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-rito"
          ...
          >
            <GridToolbar>
              ...
              <PageTitle
                title="Rito"
                helpButton={<RitoHelpCrudButton isMobile={false} />}
              />
            </GridToolbar>
            {finalGridColumns}
          </Grid>
