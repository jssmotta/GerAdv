    ...
    public async validation(regPenhoraStatus: IPenhoraStatus): Promise<{ isValid: boolean; message: string } | null> {
        ...
        try {
            await this.circuitBreaker.execute(async () => {
              return await axios.post(`${this.baseUrl}/validation`, regPenhoraStatus as PenhoraStatus, this.getHeaders());
            });
    ...
    public async addAndUpdate(regPenhoraStatus: IPenhoraStatus): Promise<AxiosResponse> {
        ...
        try {
            const result = await this.circuitBreaker.execute(async () => {
              return await axios.post(`${this.baseUrl}/AddAndUpdate`, regPenhoraStatus as PenhoraStatus, this.getHeaders());
            });
