...
interface UseServicosFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterServicos | undefined | null,
  ) => Promise<void>;
}
...
interface UseServicosFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterServicos>,
  ) => React.ReactNode;
...
export const useServicosFilter = ({
  handleFetchWithFilter,
}: UseServicosFilterProps): UseServicosFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterServicos>(
    {} as FilterServicos,
  );
