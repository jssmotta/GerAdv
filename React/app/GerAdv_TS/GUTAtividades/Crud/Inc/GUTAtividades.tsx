...
const GUTAtividadesInc: React.FC<IGUTAtividadesFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedGUTAtividades =
        await gutatividadesService.saveGUTAtividades(data);
