...
interface ProProcuradoresGridProps {
  data: IProProcuradores[];
  onRowClick: (proprocuradores: IProProcuradores) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProProcuradoresGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProProcuradores, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-proprocuradores'
