...
/// <summary>
/// Comprehensive unit tests for ConfigureUpdateFields and ConfigureAuditorFields methods in DBSetor class
...
/// </summary>
public class DBSetorConfigureMethodsTests : IDisposable
{
    private readonly DBSetor _setor;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBSetorConfigureMethodsTests()
    {
        _setor = new DBSetor();
    ...
    public void ConfigureUpdateFields_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        // Arrange
        ResetAllFieldFlags();
        _setor.ID = 1; // Update scenario
        // Act
        var result = _setor.Update(_mockConnection.Object);
    ...
    public async Task ConfigureUpdateFieldsAsync_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        ...
        try
        {
            var result = await _setor.UpdateAsync(_mockConnection.Object);
...
#region Helper Methods
    ...
    {
        var field = typeof(DBSetor).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
        field?.SetValue(_setor, value);
    }
    ...
    private void SetFieldValue(string fieldName, object? value)
    {
        ...
        {
            field?.SetValue(_setor, Convert.ToDateTime(value));
        }
    }
...
#region Fields_All
    ...
    public void ConfigureUpdateFields_WithDescricaoFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _setor.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _setor.Update(_mockConnection.Object));
    ...
    public async Task ConfigureUpdateFieldsAsync_WithDescricaoFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _setor.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _setor.UpdateAsync(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncDescricao_WithCancellationToken_ShouldRespectCancellation()
    {
        ...
        var exception = await Record.ExceptionAsync(async () => await _setor.UpdateAsync(_mockConnection.Object, cancellationToken: cts.Token));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncDescricao_WithTimeout_ShouldRespectTimeout()
    {
        ...
        _setor.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _setor.UpdateAsync(_mockConnection.Object, timeoutSeconds: 1));
        exception.Should().NotBeNull();
    }
    ...
    {
        // Arrange
        _setor.ID = 123; // Update scenario
        _setor.AuditorQuem = 7;
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection but audit fields should be set
        var exception = Record.Exception(() => _setor.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _setor.AuditorQuem.Should().Be(7);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WhenAuditorQuemIsZero_ShouldSetToDefaultValue()
    {
        // Arrange
        _setor.ID = 0; // Insert scenario
        _setor.AuditorQuem = 0; // Should be set to 1
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _setor.Update(_mockConnection.Object));
        ...
        _setor.AuditorQuem.Should().Be(1);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WhenAuditorQuemHasValue_ShouldPreserveValue(int auditorValue)
    {
        // Arrange
        _setor.ID = 0; // Insert scenario
        _setor.AuditorQuem = auditorValue;
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _setor.Update(_mockConnection.Object));
        ...
        _setor.AuditorQuem.Should().Be(auditorValue);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WithZeroID_ShouldBeConsideredInsert()
    {
        ...
        _setor.AuditorQuem.Should().Be(10);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WithNonZeroID_ShouldBeConsideredUpdate(int id)
    {
        ...
        _setor.AuditorQuem.Should().Be(15);
    }
    ...
    public void ConfigureMethodsDescricao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        SetAllFieldValues();
        _setor.ID = 123;
        _setor.AuditorQuem = 99;
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _setor.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _setor.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        _setor.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureFieldsDescricao_Integration_FieldChangeTracking_ShouldWorkCorrectly()
    {
        ...
        var result1 = _setor.Update(_mockConnection.Object);
    ...
    public void ConfigureMethodsGUID_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _setor.FGUID.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        _setor.AuditorQuem.Should().Be(99);
    }
