...
// useUFGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de UF
"use client";
...
export const useUFGrid = ({
  ...
  const defaultColumnsOrder = useMemo(() => ["id", "inomepaises"], []);
