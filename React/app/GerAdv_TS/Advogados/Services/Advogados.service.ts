...
import { AdvogadosApi, AdvogadosApiError } from "../Apis/AdvogadosApi";
...
export class AdvogadosValidator {
  static validateAdvogados(advogados: IAdvogados): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IAdvogadosService {
  ...
  validateAdvogados: (advogados: IAdvogados) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
