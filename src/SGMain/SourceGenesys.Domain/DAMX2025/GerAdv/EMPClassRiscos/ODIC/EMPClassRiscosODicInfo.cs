...
public partial class DBEMPClassRiscosODicInfo : IODicInfo
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldId() => DBEMPClassRiscosDicInfo.CampoCodigo;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string ITypeFieldCode() => "int";
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IPrefix() => DBEMPClassRiscosDicInfo.TablePrefix;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldNameDescription() => DBEMPClassRiscosDicInfo.CampoNome;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBEMPClassRiscosDicInfo.EcrNome, DBEMPClassRiscosDicInfo.EcrBold, DBEMPClassRiscosDicInfo.EcrGuid];
