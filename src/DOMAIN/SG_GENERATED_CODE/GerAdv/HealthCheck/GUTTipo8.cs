                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(gttCodigo) FROM {"GUTTipo".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) gttNome,gttOrdem,gttGuid FROM {"GUTTipo".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
