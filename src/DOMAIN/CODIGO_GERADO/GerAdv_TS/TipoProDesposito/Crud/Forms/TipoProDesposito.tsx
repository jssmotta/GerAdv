...
interface TipoProDespositoFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-TipoProDesposito' : 'form-container5 form-container-TipoProDesposito'}>
       
            <form className='formInputCadInc' id={`TipoProDespositoForm-${tipoprodespositoData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={tipoprodespositoData} isSubmitting={isSubmitting} onClose={onClose} formId={`TipoProDespositoForm-${tipoprodespositoData.id}`} preventPropagation={true} onSave={handleDirectSave} />
