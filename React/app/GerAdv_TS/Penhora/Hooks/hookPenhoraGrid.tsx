...
// usePenhoraGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Penhora
"use client";
...
export const usePenhoraGrid = ({
  ...
  const defaultColumnsOrder = useMemo(
    () => ["nome", "nropastaprocessos", "nomepenhorastatus"],
    [],
  );
  ...
  const filterLogic = useCallback(
    (data: IPenhora, filters: Record<string, any>) => {
