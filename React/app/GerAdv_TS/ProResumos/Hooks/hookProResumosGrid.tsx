...
// useProResumosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProResumos
"use client";
...
interface UseProResumosGridProps {
  data: IProResumos[];
...
export const useProResumosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("proresumos-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IProResumos, filters: Record<string, any>) => {
