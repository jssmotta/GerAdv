                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ultCodigo) FROM {"UltimosProcessos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ultProcesso,ultQuando,ultQuem FROM {"UltimosProcessos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
