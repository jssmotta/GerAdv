...
public partial interface IDBOperador
{
    ...
    public DateOnly? FUltimoLogoff { get; set; }
    ...
    public DateOnly? FDataLimiteReset { get; set; }
    public string? FSuporteSenha256 { get; set; }
    public DateOnly? FSuporteMaxAge { get; set; }
    public string? FSuporteNomeSolicitante { get; set; }
    public DateOnly? FSuporteUltimoAcesso { get; set; }
