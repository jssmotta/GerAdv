...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem OpoCidade => new(0, PTabelaNome, CampoCodigo, Cidade, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBCidadeDicInfo.CampoCodigo, DBCidadeDicInfo.TabelaNome, new DBCidadeODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem OpoQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem OpoQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    public static string EMPFuncaoDiff(int id) => EMPFuncao.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string EMPFuncaoSql(int id) => EMPFuncao.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string EMPFuncaoIsNull => EMPFuncao.SqlCmdIsNull() ?? string.Empty;
    public static string EMPFuncaoNotIsNull => EMPFuncao.SqlCmdNotIsNull() ?? string.Empty;
    ...
    public static string EMPClienteDiff(int id) => EMPCliente.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string EMPClienteSql(int id) => EMPCliente.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string EMPClienteIsNull => EMPCliente.SqlCmdIsNull() ?? string.Empty;
    public static string EMPClienteNotIsNull => EMPCliente.SqlCmdNotIsNull() ?? string.Empty;
