                ...
                try
                {
                    ...
                    try
                    {
                        if (DBStatusHTrabDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(shtCodigo) FROM dbo.StatusHTrab (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) shtDescricao,shtResID FROM dbo.StatusHTrab (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
