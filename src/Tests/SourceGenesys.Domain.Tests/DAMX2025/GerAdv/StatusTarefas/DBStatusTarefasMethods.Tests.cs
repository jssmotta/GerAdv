...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBStatusTarefas
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBStatusTarefasUpdateAdvancedTests : IDisposable
{
    private readonly DBStatusTarefas _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusTarefasUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBStatusTarefas
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBStatusTarefas).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBStatusTarefas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBStatusTarefas instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBStatusTarefas).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBStatusTarefas.PTabelaNome.Should().Be("StatusTarefas");
        DBStatusTarefas.CampoCodigo.Should().Be("sttCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBStatusTarefas();
        dbRec.ID = 1;
