...
// useAgendaRepetirDiasGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de AgendaRepetirDias
'use client';
...
interface UseAgendaRepetirDiasGridProps {
...
export const useAgendaRepetirDiasGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('agendarepetirdias-columns-order'), JSON.stringify(reorderableFields));
