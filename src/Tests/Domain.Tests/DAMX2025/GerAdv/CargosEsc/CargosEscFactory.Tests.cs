...
public class FCargosEscFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FCargosEsc>();
    }
    ...
    {
        // Arrange
        var factory = new FCargosEscFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("cgeCodigo", typeof(int));
        mockDataTable.Columns.Add("cgeNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["cgeCodigo"] = testId;
        row["cgeNome"] = "Test CargosEsc";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["cgeCodigo"] = 123;
        row["cgeNome"] = "Test CargosEsc Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FCargosEsc properties
        }
    }
