...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFHonorariosDadosContrato.VerifySet(x => x.FDataContrato = DateOnly.Parse(honorariosdadoscontrato.DataContrato), Times.Once);
    ...
    public async Task WriteAsync_WithNull_DataContrato_ShouldNotSetFDataContrato()
    {
        ...
        // Assert
        _mockFHonorariosDadosContrato.VerifySet(x => x.FDataContrato = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new HonorariosDadosContratoWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.HonorariosDadosContrato CreateValidHonorariosDadosContratoModel()
    {
