...
public static partial class DBGraphDicInfo
{
    ...
    public const string CampoNome = "gphGUID";
...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem GphGUID => new(0, PTabelaNome, CampoCodigo, GUID, 150, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextNome, true, true, false)
    {
        IsRequired = true,
        Prefixo = "gph"
    };
