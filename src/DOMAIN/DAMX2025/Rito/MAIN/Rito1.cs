...
#region TableDefinition_Rito
...
#endregion
    public DBRito(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBRito(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBRito(in string? sqlWhere, SqlConnection? oCnn)
    {
