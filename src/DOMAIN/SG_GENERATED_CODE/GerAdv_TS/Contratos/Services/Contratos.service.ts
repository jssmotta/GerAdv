...
export interface IContratosService {
  ...
  filterVoice: (filtro?: FilterContratos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ContratosService implements IContratosService {
  ...
  async filterVoice(filtro?: FilterContratos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
