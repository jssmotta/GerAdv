...
interface LivroCaixaClientesGridProps {
  data: ILivroCaixaClientes[];
  onRowClick: (livrocaixaclientes: ILivroCaixaClientes) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const LivroCaixaClientesGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ILivroCaixaClientes, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-livrocaixaclientes'
