...
public partial class DBFornecedores
{
    ...
    /// </summary>
    public static async Task<DBFornecedores> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBFornecedores();
