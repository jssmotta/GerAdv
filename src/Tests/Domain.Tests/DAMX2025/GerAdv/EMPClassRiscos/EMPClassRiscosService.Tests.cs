...
public class EMPClassRiscosServiceTests : IDisposable
{
    ...
    public EMPClassRiscosServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new EMPClassRiscosService(_mockAppSettings.Object, _mockEMPClassRiscosFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
