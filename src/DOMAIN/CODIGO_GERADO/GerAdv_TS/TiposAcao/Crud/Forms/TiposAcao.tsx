...
interface TiposAcaoFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-TiposAcao' : 'form-container5 form-container-TiposAcao'}>
       
            <form className='formInputCadInc' id={`TiposAcaoForm-${tiposacaoData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={tiposacaoData} isSubmitting={isSubmitting} onClose={onClose} formId={`TiposAcaoForm-${tiposacaoData.id}`} preventPropagation={true} onSave={handleDirectSave} />
