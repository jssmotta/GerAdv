...
// useTribunalGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Tribunal
"use client";
...
interface UseTribunalGridProps {
  data: ITribunal[];
...
export const useTribunalGrid = ({
  ...
  const filterLogic = useCallback(
    (data: ITribunal, filters: Record<string, any>) => {
