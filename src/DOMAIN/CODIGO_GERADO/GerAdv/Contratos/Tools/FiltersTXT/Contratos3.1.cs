...
public static class FilterContratosTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar Contratos em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterContratos:

- O filter irá filtrar os Contratos conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterContratos:(Contratos)
...
- percescritorio: valores monetários ou com decimais;
- valorconsultoria: valores monetários ou com decimais;
- tipocobranca: número ou IDs;
- protestar: Protestar;
- juros: Juros;
- valorrealizavel: valores monetários ou com decimais;
- documento: DOCUMENTO;
- email1: EMail1;
- email2: EMail2;
- email3: EMail3;
...
- pessoa3: Pessoa3;
- obs: OBS;
- clientecontrato: número ou IDs;
- idextrangeiro: número ou IDs;
...
- Se ouvir "todos os Contratos" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterContratos? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt Contratos length: {result.Length}");
#endif
