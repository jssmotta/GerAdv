...
public partial class FProResumos : MenphisSI.SG.GerAdv.DBProResumos, IDBProResumos
{
    ...
    private FProResumos(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FProResumos CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FProResumos(parameters, oCnn, fullSql, sqlWhere, join);
    }
