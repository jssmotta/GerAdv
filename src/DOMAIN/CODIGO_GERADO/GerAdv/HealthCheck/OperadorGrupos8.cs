                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(opgCodigo) FROM {"OperadorGrupos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) opgNome FROM {"OperadorGrupos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
