...
public class FTribunalFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTribunal>();
    }
    ...
    {
        // Arrange
        var factory = new FTribunalFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("triCodigo", typeof(int));
        mockDataTable.Columns.Add("triNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["triCodigo"] = testId;
        row["triNome"] = "Test Tribunal";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["triCodigo"] = 123;
        row["triNome"] = "Test Tribunal Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTribunal properties
        }
    }
