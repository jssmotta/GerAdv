...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem StbTipoStatusBiu => new(0, PTabelaNome, CampoCodigo, TipoStatusBiu, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBTipoStatusBiuDicInfo.CampoCodigo, DBTipoStatusBiuDicInfo.TabelaNome, new DBTipoStatusBiuODicInfo(), false)
    {
        IsRequired = true,
        Prefixo = "stb"
    }; // DBI 11 
    public static DBInfoSystem StbOperador => new(0, PTabelaNome, CampoCodigo, Operador, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false)
    {
        Prefixo = "stb"
    }; // DBI 11 
