...
import {
  useOutrasPartesClienteForm,
  useValidationsOutrasPartesCliente,
} from "../../Hooks/hookOutrasPartesCliente";
...
const OutrasPartesClienteInc: React.FC<IOutrasPartesClienteFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadOutrasPartesCliente } =
    useOutrasPartesClienteForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedOutrasPartesCliente =
        await outraspartesclienteService.saveOutrasPartesCliente(data);
