...
Instruções para preenchimento do FilterNENotas:

- O filter irá filtrar os NENotas conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterNENotas:(N E Notas)
- apenso: número ou IDs;
...
- data: não é a data de cadastramento é a data do NENotas;
...
- Se ouvir "todos os NENotas" ou similar, deixe todos os campos com valores padrão;
