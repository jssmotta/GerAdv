...
{
    Task<bool> ValidateReg(Models.ProObservacoes reg, IProObservacoesService service, IProcessosReader processosReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn);
...
public class ProObservacoesValidation : IProObservacoesValidation
{
    ...
    public async Task<bool> ValidateReg(Models.ProObservacoes reg, IProObservacoesService service, IProcessosReader processosReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn)
    {
        if (reg == null)
