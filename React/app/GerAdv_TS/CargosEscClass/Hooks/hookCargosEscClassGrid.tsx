...
// useCargosEscClassGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de CargosEscClass
"use client";
...
interface UseCargosEscClassGridProps {
...
export const useCargosEscClassGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ICargosEscClass, filters: Record<string, any>) => {
