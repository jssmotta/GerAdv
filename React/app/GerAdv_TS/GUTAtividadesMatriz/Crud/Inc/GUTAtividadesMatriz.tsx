...
import {
  useGUTAtividadesMatrizForm,
  useValidationsGUTAtividadesMatriz,
} from "../../Hooks/hookGUTAtividadesMatriz";
...
const GUTAtividadesMatrizInc: React.FC<IGUTAtividadesMatrizFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadGUTAtividadesMatriz } =
    useGUTAtividadesMatrizForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedGUTAtividadesMatriz =
        await gutatividadesmatrizService.saveGUTAtividadesMatriz(data);
