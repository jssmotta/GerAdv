...
public class FilterProResumosWithVoiceRequest
{
    /// <summary>
    /// Filtro de ProResumos padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterProResumos Filter { get; set; } = new();
...
[Serializable]
public partial record FilterProResumos
{
    ...
    [Description("TipoResumo -2147483648 para nada ou id")]
    public int TipoResumo { get; set; } = int.MinValue;

    [JsonPropertyName("tiporesumo_end")]
    [Description("TipoResumo -2147483648 para nada ou id para final do intervalo")]
    public int TipoResumo_end { get; set; } = int.MinValue;
