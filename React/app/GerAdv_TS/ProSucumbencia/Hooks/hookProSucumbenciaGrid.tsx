...
// useProSucumbenciaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProSucumbencia
"use client";
...
interface UseProSucumbenciaGridProps {
...
export const useProSucumbenciaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
      ...
      if (
        ...
        try {
          localStorage.setItem(
            btoa("prosucumbencia-columns-order"),
  ...
  const filterLogic = useCallback(
    (data: IProSucumbencia, filters: Record<string, any>) => {
