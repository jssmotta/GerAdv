...
public class FilterRegimeTributacaoWithVoiceRequest
{
    /// <summary>
    /// Filtro de RegimeTributacao padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterRegimeTributacao Filter { get; set; } = new();
...
[Serializable]
public partial record FilterRegimeTributacao
{
