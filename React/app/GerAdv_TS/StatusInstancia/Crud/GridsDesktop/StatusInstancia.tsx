...
interface StatusInstanciaGridProps {
  data: IStatusInstancia[];
  onRowClick: (statusinstancia: IStatusInstancia) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const StatusInstanciaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IStatusInstancia, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-statusinstancia'
