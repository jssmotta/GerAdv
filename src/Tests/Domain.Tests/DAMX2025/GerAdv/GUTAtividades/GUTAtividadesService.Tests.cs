...
public class GUTAtividadesServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task AddAndUpdate_WithValidGUTAtividades_ShouldExerciseWorkflow()
    {
        // Arrange
        var validGUTAtividades = new Models.GUTAtividades
        {
    ...
    {
        var method = typeof(GUTAtividadesService).GetMethod(methodName, BindingFlags.NonPublic | BindingFlags.Instance);
        if (method == null)
            return null;
