...
export const TipoStatusBiuGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ITipoStatusBiu, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-tipostatusbiu'
