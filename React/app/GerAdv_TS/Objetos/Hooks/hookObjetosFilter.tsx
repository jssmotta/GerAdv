...
interface UseObjetosFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterObjetos | undefined | null,
  ) => Promise<void>;
}
...
interface UseObjetosFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterObjetos>,
  ) => React.ReactNode;
...
export const useObjetosFilter = ({
  handleFetchWithFilter,
}: UseObjetosFilterProps): UseObjetosFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterObjetos>(
    {} as FilterObjetos,
  );
