...
export interface ICargosEscService {
  ...
  filterVoice: (filtro?: FilterCargosEsc, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class CargosEscService implements ICargosEscService {
  ...
  async filterVoice(filtro?: FilterCargosEsc, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
