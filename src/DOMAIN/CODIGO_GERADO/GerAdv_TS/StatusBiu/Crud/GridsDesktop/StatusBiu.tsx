...
export const StatusBiuGridDesktopComponent: React.FC<StatusBiuGridProps> = ({
	data,
	onRowClick,
	onDeleteClick
}) => {
...
const EditarCellOperador = (props: any) => {
    return (
      <>
        <td>
            <div onClick={() => openConsultaOperador(props.dataItem.id)}><img width='16' height='16' src='https://cdn.menphis.com.br/msi/v20/editar.webp' title='Editar Operador' />&nbsp;</div>
        </td>
      </>
    );
};
