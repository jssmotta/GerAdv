...
export const useClientesFilter = ({
  ...
  const renderInputFilters = (handlers: FilterHandlers<FilterClientes>) => (
    <>
      ...
      <EnquadramentoEmpresaComboBox
        ...
        setValue={(e: any) =>
          handlers.handleComboChange(e, "enquadramentoempresa")
        }
        className="inputSearch inputSearchComboboxTab"
      ...
      <FilterDialogButton
        // passa o objeto nested (pode ser undefined => cast para objeto vazio)
        filter={
          handlers.windowFilter.filterRegimeTributacao ?? ({} as any as any)
        }
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({
            ...prev,
            filterRegimeTributacao: f,
          }))
        }
        // ao confirmar, NÃO precisa fazer nada - o setFilter já atualizou
        onConfirm={async (f: any) => {}}
      ...
      <FilterDialogButton
        // passa o objeto nested (pode ser undefined => cast para objeto vazio)
        filter={
          handlers.windowFilter.filterEnquadramentoEmpresa ?? ({} as any as any)
        }
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({
            ...prev,
            filterEnquadramentoEmpresa: f,
          }))
        }
        // ao confirmar, NÃO precisa fazer nada - o setFilter já atualizou
        onConfirm={async (f: any) => {}}
  ...
  const { renderInputFilters: renderRegimeTributacaoInputs } =
    useRegimeTributacaoFilter({
      handleFetchWithFilter: async () => {},
    });
  const { renderInputFilters: renderEnquadramentoEmpresaInputs } =
