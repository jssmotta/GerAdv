...
Instruções para preenchimento do FilterOperadorEMailPopup:

- O filter irá filtrar os OperadorEMailPopup conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
- usuario: Usuario;
- portasmtp: número ou IDs;
- portapop3: número ou IDs;
...
- Se ouvir "todos os OperadorEMailPopup" ou similar, deixe todos os campos com valores padrão;
