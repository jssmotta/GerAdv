...
{
    Task<bool> ValidateReg(Models.AgendaFinanceiro reg, IAgendaFinanceiroService service, ICidadeReader cidadeReader, IAdvogadosReader advogadosReader, IFuncionariosReader funcionariosReader, ITipoCompromissoReader tipocompromissoReader, IClientesReader clientesReader, IAreaReader areaReader, IJusticaReader justicaReader, IProcessosReader processosReader, IOperadorReader operadorReader, IPrepostosReader prepostosReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn);
    Task<bool> CanDelete(int id, IAgendaFinanceiroService service, [FromRoute, Required] string uri, MsiSqlConnection oCnn);
}

public class AgendaFinanceiroValidation : IAgendaFinanceiroValidation
{
    public async Task<bool> CanDelete(int id, IAgendaFinanceiroService service, [FromRoute, Required] string uri, MsiSqlConnection oCnn)
    {
        if (id <= 0)
    ...
    private bool ValidSizes(Models.AgendaFinanceiro reg)
    {
    ...
    public async Task<bool> ValidateReg(Models.AgendaFinanceiro reg, IAgendaFinanceiroService service, ICidadeReader cidadeReader, IAdvogadosReader advogadosReader, IFuncionariosReader funcionariosReader, ITipoCompromissoReader tipocompromissoReader, IClientesReader clientesReader, IAreaReader areaReader, IJusticaReader justicaReader, IProcessosReader processosReader, IOperadorReader operadorReader, IPrepostosReader prepostosReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn)
    {
        if (reg == null)
