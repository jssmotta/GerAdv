...
interface TipoOrigemSucumbenciaFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-TipoOrigemSucumbencia' : 'form-container5 form-container-TipoOrigemSucumbencia'}>
       
            <form className='formInputCadInc' id={`TipoOrigemSucumbenciaForm-${tipoorigemsucumbenciaData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={tipoorigemsucumbenciaData} isSubmitting={isSubmitting} onClose={onClose} formId={`TipoOrigemSucumbenciaForm-${tipoorigemsucumbenciaData.id}`} preventPropagation={true} onSave={handleDirectSave} />
