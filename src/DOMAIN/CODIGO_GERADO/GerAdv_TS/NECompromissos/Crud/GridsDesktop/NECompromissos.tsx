...
interface NECompromissosGridProps {
  data: INECompromissos[];
  onRowClick: (necompromissos: INECompromissos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const NECompromissosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: INECompromissos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-necompromissos'
