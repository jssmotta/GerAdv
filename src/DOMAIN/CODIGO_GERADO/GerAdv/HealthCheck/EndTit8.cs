                ...
                try
                {
                    ...
                    try
                    {
                        if (DBEndTitDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(ettCodigo) FROM {"EndTit".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) ettEndereco,ettTitulo FROM {"EndTit".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
