...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("fasCodigo", typeof(int));
        mockDataTable.Columns.Add("fasDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["fasCodigo"] = testId;
        row["fasDescricao"] = "Test Fase";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["fasCodigo"] = 123;
        row["fasDescricao"] = "Test Fase Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FFase properties
        }
    }
