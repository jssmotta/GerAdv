            ...
            foreach (var uri in uris)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) escCNPJ,escCasa,escParceria,escNome,escOAB,escEndereco,escCidade,escBairro,escCEP,escFone,escFax,escSite,escEMail,escOBS,escAdvResponsavel,escSecretaria,escInscEst,escCorrespondente,escTop,escGUID FROM {"Escritorios".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
