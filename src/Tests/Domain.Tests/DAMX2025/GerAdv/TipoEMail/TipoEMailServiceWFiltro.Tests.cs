...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class TipoEMailServiceWFiltroTests : IDisposable
    {
        ...
        public TipoEMailServiceWFiltroTests()
        {
            ...
            _service = new TipoEMailService(_mockAppSettings.Object, _mockTipoEMailFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockSMSAliceService.Object, _mockCache.Object, _mockMemoryCache.Object);
        }
