...
public static class FilterTipoOrigemSucumbenciaTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar TipoOrigemSucumbencia em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterTipoOrigemSucumbencia:

- O filter irá filtrar os TipoOrigemSucumbencia conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
- Se ouvir "todos os TipoOrigemSucumbencia" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterTipoOrigemSucumbencia? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt TipoOrigemSucumbencia length: {result.Length}");
#endif
