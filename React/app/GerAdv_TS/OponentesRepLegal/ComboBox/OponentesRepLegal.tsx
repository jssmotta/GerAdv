...
const OponentesRepLegalComboBox: React.FC<DadosSelectProps> = ({
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await oponentesreplegalService.fetchOponentesRepLegalById(id);
  ...
  const handleSuccess = (newOponentesRepLegal?: IOponentesRepLegal) => {
    if (newOponentesRepLegal) {
      setValue({
        id: newOponentesRepLegal.id,
        nome: newOponentesRepLegal.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <OponentesRepLegalWindow
          ...
          selectedOponentesRepLegal={
            editRecord || addRecord || OponentesRepLegalEmpty()
          }
        />
      )}
