...
// useEMPClassRiscosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de EMPClassRiscos
"use client";
...
interface UseEMPClassRiscosGridProps {
...
export const useEMPClassRiscosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IEMPClassRiscos, filters: Record<string, any>) => {
