...
import { ProValoresApiError } from '@/app/GerAdv_TS/ProValores/Apis/ApiProValores';
...
import { ProValoresTestEmpty } from '@/app/GerAdv_TS/Models/ProValores';
...
dataultimacorrecao: '24/04/1975'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterProValores = { : 1 };
