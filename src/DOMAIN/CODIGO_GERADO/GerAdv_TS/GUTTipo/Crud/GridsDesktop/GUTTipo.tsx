...
export const GUTTipoGridDesktopComponent: React.FC<GUTTipoGridProps> = ({
	data,
	onRowClick,
	onDeleteClick
}) => {
...
const EditarCellGUTMatriz = (props: any) => {
    return (
      <>
        <td>
            <div onClick={() => openConsultaGUTMatriz(props.dataItem.id)}><img width='16' height='16' src='https://cdn.menphis.com.br/msi/v20/editar.webp' title='Editar G U T Matriz' />&nbsp;</div>
        </td>
      </>
    );
};
