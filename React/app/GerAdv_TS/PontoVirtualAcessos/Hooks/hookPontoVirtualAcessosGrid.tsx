...
// usePontoVirtualAcessosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de PontoVirtualAcessos
"use client";
...
interface UsePontoVirtualAcessosGridProps {
...
export const usePontoVirtualAcessosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IPontoVirtualAcessos, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
