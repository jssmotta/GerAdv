  ...
  <>
    ...
    <Input
          ...
          />
          							...
          							<div className='relacionamentosLinks' onClick={()=> router.push(`/pages/enderecosistema${process.env.NEXT_PUBLIC_PAGE_HTML ?? ''}?tipoenderecosistema=${tipoenderecosistemaData.id}`)}>Endereco Sistema</div>
