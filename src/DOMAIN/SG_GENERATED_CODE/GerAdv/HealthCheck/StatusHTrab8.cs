                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(shtCodigo) FROM {"StatusHTrab".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) shtDescricao,shtResID FROM {"StatusHTrab".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
