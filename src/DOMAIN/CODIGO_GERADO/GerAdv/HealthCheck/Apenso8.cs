                ...
                try
                {
                    ...
                    try
                    {
                        if (DBApensoDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(apeCodigo) FROM {"Apenso".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) apeProcesso,apeApenso,apeAcao,apeDtDist,apeOBS,apeValorCausa FROM {"Apenso".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
