...
export interface IPreClientesService {
  ...
  filterVoice: (filtro?: FilterPreClientes, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class PreClientesService implements IPreClientesService {
  ...
  async filterVoice(filtro?: FilterPreClientes, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
