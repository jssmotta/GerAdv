...
interface ParteClienteOutrasGridProps {
  data: IParteClienteOutras[];
  onRowClick: (parteclienteoutras: IParteClienteOutras) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ParteClienteOutrasGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IParteClienteOutras, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nomeoutraspartescliente' title='Outras Partes Cliente' sortable={false} filterable={false} />, /* Track G.01 */
...
{initialized && (
  ...
  className='grid-desktop-parteclienteoutras'
