...
// usePrepostosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Prepostos
"use client";
...
interface UsePrepostosGridProps {
  data: IPrepostos[];
...
export const usePrepostosGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("prepostos-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IPrepostos, filters: Record<string, any>) => {
