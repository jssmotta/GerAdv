...
const PenhoraStatusGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <PenhoraStatusGridMobileComponent data={penhorastatus} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <PenhoraStatusGridDesktopComponent data={penhorastatus} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
