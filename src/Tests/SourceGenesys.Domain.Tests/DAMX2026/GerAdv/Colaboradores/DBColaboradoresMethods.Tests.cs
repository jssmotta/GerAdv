...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBColaboradores
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBColaboradoresUpdateAdvancedTests : IDisposable
{
    private readonly DBColaboradores _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBColaboradoresUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBColaboradores
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBColaboradores).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBColaboradores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBColaboradores instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBColaboradores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBColaboradores.PTabelaNome.Should().Be("Colaboradores");
        DBColaboradores.CampoCodigo.Should().Be("colCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBColaboradores();
        dbRec.ID = 1;
