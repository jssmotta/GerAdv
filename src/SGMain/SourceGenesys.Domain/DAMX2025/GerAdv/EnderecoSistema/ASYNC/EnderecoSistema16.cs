...
#if (!NOTSTORED_EnderecoSistema)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFCadastro || pFldFCadastroExCod || pFldFTipoEnderecoSistema || pFldFGUID || pFldFProcesso || pFldFMotivo || pFldFContatoNoLocal || pFldFCidade || pFldFEndereco || pFldFBairro || pFldFCEP || pFldFFone || pFldFFax || pFldFObservacao;
