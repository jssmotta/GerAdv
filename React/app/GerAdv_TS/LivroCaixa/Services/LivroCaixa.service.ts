...
export class LivroCaixaValidator {
  static validateLivroCaixa(livrocaixa: ILivroCaixa): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface ILivroCaixaService {
  ...
  validateLivroCaixa: (livrocaixa: ILivroCaixa) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
