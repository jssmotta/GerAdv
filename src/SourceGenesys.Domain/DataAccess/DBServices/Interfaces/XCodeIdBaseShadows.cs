...
public class XCodeIdBaseShadows   //: StylesCad - Deixou o Sistema lento, muitas heranças.
{
    ...
    public string FShadowViewDataHoraTermino
    {
        ...
        set { var (setUpNow, changed, data) = DevourerOne.DateUp12(pFldFShadowViewDataHoraTermino, m_FShadowViewDataHoraTermino, value); if (!setUpNow) return; pFldFShadowViewDataHoraTermino = changed; m_FShadowViewDataHoraTermino = data; }
    }
