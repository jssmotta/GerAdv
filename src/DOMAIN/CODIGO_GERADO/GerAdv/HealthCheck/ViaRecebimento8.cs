                ...
                try
                {
                    ...
                    try
                    {
                        if (DBViaRecebimentoDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(vrbCodigo) FROM dbo.ViaRecebimento (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) vrbNome FROM dbo.ViaRecebimento (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
