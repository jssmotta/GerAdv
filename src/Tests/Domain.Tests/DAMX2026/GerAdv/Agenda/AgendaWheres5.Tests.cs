...
#region Test Data Setup Helpers
    ...
    private void SetupMockFAgenda(int? IDCOB = 1, bool? ClienteAvisado = false, bool? RevisarP2 = true, int? IDNE = 1, int? Cidade = 1, int? Oculto = 1, int? CartaPrecatoria = 1, bool? Revisar = false, string? HrFinal = "24/04/1975", int? Advogado = 1, int? EventoGerador = 1, string? EventoData = "24/04/1975", int? Funcionario = 1, string? Data = "24/04/1975", int? EventoPrazo = 1, string? Hora = "04:04", string? Compromisso = "", int? TipoCompromisso = 1, int? Cliente = 1, bool? Liberado = true, bool? Importante = false, bool? Concluido = true, int? Area = 1, int? Justica = 1, int? Processo = 1, int? IDHistorico = 1, int? IDInsProcesso = 1, int? Usuario = 1, int? Preposto = 1, int? QuemID = 1, int? QuemCodigo = 1, string? Status = "", decimal? Valor = 1m, string? Decisao = "", int? Sempre = 1, int? PrazoDias = 1, int? ProtocoloIntegrado = 1, string? DataInicioPrazo = "24/04/1975", bool? UsuarioCiente = false)
    {
        ...
        if (string.IsNullOrEmpty(HrFinal))
        {
            _mockFAgenda.Setup(f => f.FHrFinal).Returns((TimeOnly? )null);
        }
        else
        {
            TimeOnly horaValue;
            if (TimeOnly.TryParse(HrFinal, new CultureInfo("pt-BR"), out var t))
            {
                horaValue = t;
            }
            else
            {
                DateTime dt;
                if (!DateTime.TryParse(HrFinal, new CultureInfo("pt-BR"), DateTimeStyles.None, out dt))
                {
                    dt = DateTime.Parse(HrFinal, CultureInfo.InvariantCulture);
                }

                horaValue = TimeOnly.FromDateTime(dt);
            }

            _mockFAgenda.Setup(f => f.FHrFinal).Returns(horaValue);
        }
        ...
        {
            _mockFAgenda.Setup(f => f.FEventoData).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(EventoData, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(EventoData, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFAgenda.Setup(f => f.FEventoData).Returns(dateOnly);
        }

        _mockFAgenda.Setup(f => f.FFuncionario).Returns(Funcionario ?? 0);
        if (string.IsNullOrEmpty(Data))
        {
            _mockFAgenda.Setup(f => f.FData).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            ...
            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFAgenda.Setup(f => f.FData).Returns(dateOnly);
        }

        _mockFAgenda.Setup(f => f.FEventoPrazo).Returns(EventoPrazo ?? 0);
        if (string.IsNullOrEmpty(Hora))
        {
            _mockFAgenda.Setup(f => f.FHora).Returns((TimeOnly? )null);
        }
        else
        {
            TimeOnly horaValue;
            ...
            _mockFAgenda.Setup(f => f.FHora).Returns(horaValue);
        }
        ...
        if (string.IsNullOrEmpty(DataInicioPrazo))
        {
            _mockFAgenda.Setup(f => f.FDataInicioPrazo).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(DataInicioPrazo, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(DataInicioPrazo, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFAgenda.Setup(f => f.FDataInicioPrazo).Returns(dateOnly);
        }
...
#region Read Method - Happy Path Tests
    ...
    public void Read_WithValidParameters_ShouldReturnAgendaResponse()
    {
        ...
        result.HrFinal.Should().Be("24/04/1975");
...
#region Integration Tests
    ...
    public void Read_ShouldPassCorrectParametersToFactory()
    {
        ...
        var parameters = new List<SqlParameter>
        {
            new SqlParameter($"@{DBAgendaDicInfo.CampoNome}", TConstantes.TestData),
        };
        SetupMockFAgenda();
        _mockAgendaFactory.Setup(f => f.CreateFromParameters(parameters, _mockConnection.Object, "", "", where, "")).Returns(_mockFAgenda.Object);
        // Act
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_EventoData_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _agendaWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.EventoData.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDateDataFields_ShouldParseAndSetDateProperties()
    {
        ...
        SetupMockFAgenda(Data: testDate);
        _mockAgendaFactory.Setup(f => f.CreateFromParameters(parameters, _mockConnection.Object, "", "", where, "")).Returns(_mockFAgenda.Object);
        // Act
        var result = _agendaWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
    ...
    public void Read_WithValidDate_Data_Formats_ShouldParseCorrectly(string dateString)
    {
        ...
        var parameters = CreateTestParameters();
        var expectedDate = DateTime.Parse(dateString);
        SetupMockFAgenda(Data: dateString);
        _mockAgendaFactory.Setup(f => f.CreateFromParameters(parameters, _mockConnection.Object, "", "", where, "")).Returns(_mockFAgenda.Object);
        // Act
        var result = _agendaWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
    ...
    public void Read_WithValidDateDataInicioPrazoFields_ShouldParseAndSetDateProperties()
    {
        ...
        var result = _agendaWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DataInicioPrazo.Should().Be("02/01/2025");
    }
    ...
    public void Read_WithValidDate_DataInicioPrazo_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _agendaWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DataInicioPrazo.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
#endregion
#endregion
}