...
interface UseRitoFilterProps {
    handleFetchWithFilter: (filtro?: FilterRito | undefined | null) => Promise<void>;
}
...
export const useRitoFilter = ({ handleFetchWithFilter }: UseRitoFilterProps): UseRitoFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterRito>({} as FilterRito);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterRito;
