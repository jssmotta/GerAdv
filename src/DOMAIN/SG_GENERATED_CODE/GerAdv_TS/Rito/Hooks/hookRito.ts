...
export const useRitoList = (dataService: IRitoService, currentFilter?: FilterRito | undefined | null) => {
  ...
  const fetchData = useCallback(async (filtro?: FilterRito | undefined | null) => {
