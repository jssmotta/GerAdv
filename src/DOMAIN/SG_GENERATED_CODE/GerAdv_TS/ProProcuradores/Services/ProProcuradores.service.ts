...
export interface IProProcuradoresService {
  ...
  filterVoice: (filtro?: FilterProProcuradores, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ProProcuradoresService implements IProProcuradoresService {
  ...
  async filterVoice(filtro?: FilterProProcuradores, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
