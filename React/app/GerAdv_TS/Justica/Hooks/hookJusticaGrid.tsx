...
// useJusticaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Justica
"use client";
...
export const useJusticaGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IJustica, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
