...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBClientesSocios
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBClientesSociosUpdateAdvancedTests : IDisposable
{
    private readonly DBClientesSocios _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBClientesSociosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBClientesSocios
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBClientesSocios).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBClientesSocios).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBClientesSocios instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBClientesSocios).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBClientesSocios.PTabelaNome.Should().Be("ClientesSocios");
        DBClientesSocios.CampoCodigo.Should().Be("cscCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBClientesSocios();
        dbRec.ID = 1;
