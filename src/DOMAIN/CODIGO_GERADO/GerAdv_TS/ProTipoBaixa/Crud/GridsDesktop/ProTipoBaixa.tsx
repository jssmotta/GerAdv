...
export const ProTipoBaixaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProTipoBaixa, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-protipobaixa'
