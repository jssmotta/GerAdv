...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem InsProcesso => new(0, PTabelaNome, CampoCodigo, Processo, "Processo", "Processo", ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false)
    {
        Prefixo = "ins"
    }; // DBI 11 
    public static DBInfoSystem InsData => new(0, PTabelaNome, CampoCodigo, Data, "Data", "Data", ETipoDadosSysteminfo.SysteminfoDatetime)
    {
        Prefixo = "ins"
    };
    ...
    public static DBInfoSystem InsGUID => new(0, PTabelaNome, CampoCodigo, GUID, 100, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "ins"
    };
