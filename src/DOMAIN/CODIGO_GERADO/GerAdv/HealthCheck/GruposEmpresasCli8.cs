                ...
                try
                {
                    ...
                    try
                    {
                        if (DBGruposEmpresasCliDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(gecCodigo) FROM dbo.GruposEmpresasCli (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) gecGrupo,gecCliente,gecOculto FROM dbo.GruposEmpresasCli (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
