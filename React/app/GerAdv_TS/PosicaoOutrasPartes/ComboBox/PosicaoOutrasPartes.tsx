...
const PosicaoOutrasPartesComboBox: React.FC<DadosSelectProps> = ({
  ...
  const [editRecord, setEditRecord] = useState<IPosicaoOutrasPartes | null>(
    null,
  );
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await posicaooutraspartesService.fetchPosicaoOutrasPartesById(id);
  ...
  const handleSuccess = (newPosicaoOutrasPartes?: IPosicaoOutrasPartes) => {
    if (newPosicaoOutrasPartes) {
      setValue({
        id: newPosicaoOutrasPartes.id,
        nome: newPosicaoOutrasPartes.descricao,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <PosicaoOutrasPartesWindow
          ...
          selectedPosicaoOutrasPartes={
            editRecord || addRecord || PosicaoOutrasPartesEmpty()
          }
        />
      )}
