...
#region PropriedadesDaTabela
    public static DBInfoSystem ShtDescricao => new(0, PTabelaNome, CampoCodigo, Descricao, 50, "Descrição", "Descrição", EDataTypeSystemInfo.SystemInfoText, true, false, false, prefixo: "sht");
