...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBCargosEscClass
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBCargosEscClassUpdateAdvancedTests : IDisposable
{
    private readonly DBCargosEscClass _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBCargosEscClassUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBCargosEscClass
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBCargosEscClass).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBCargosEscClass).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBCargosEscClass instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBCargosEscClass).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBCargosEscClass.PTabelaNome.Should().Be("CargosEscClass");
        DBCargosEscClass.CampoCodigo.Should().Be("cecCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBCargosEscClass();
        dbRec.ID = 1;
