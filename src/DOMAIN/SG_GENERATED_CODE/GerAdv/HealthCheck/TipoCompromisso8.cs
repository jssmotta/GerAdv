                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tipCodigo) FROM {"TipoCompromisso".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tipIcone,tipDescricao,tipFinanceiro,tipBold,tipGuid FROM {"TipoCompromisso".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
