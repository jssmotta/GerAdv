...
// useAndamentosMDGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de AndamentosMD
"use client";
...
interface UseAndamentosMDGridProps {
  data: IAndamentosMD[];
...
export const useAndamentosMDGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IAndamentosMD, filters: Record<string, any>) => {
