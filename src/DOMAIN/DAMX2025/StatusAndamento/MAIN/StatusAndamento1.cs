...
#region TableDefinition_StatusAndamento
...
#endregion
    public DBStatusAndamento(in int nCodigo, MsiSqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBStatusAndamento(in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBStatusAndamento(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
