...
const openSearchCellDocsRecebidosItens = (id: number) => {
  router.push(`/pages/docsrecebidositens/?contatocrm=${id}`);
};
const SearchFromCellDocsRecebidosItens = (props: any) => {
  return (
  <>
  <td>
    <div onClick={() => openSearchCellDocsRecebidosItens(props.dataItem.id)}><span title='Pesquisar relacionados em Docs Recebidos Itens'><SvgIcon icon={searchIcon} /></span></div>
  </td>
</>
);
};
...
const gridColumns = useMemo(() => [
  ...
  />, 
  <GridColumn
  field='id_edit_DocsRecebidosItens'
  filterable={false}
  sortable={false}
  width={'65px'}
  title='Docs Recebidos Itens'
  cells={{ data: SearchFromCellDocsRecebidosItens }}
  />, 
  <GridColumn
...
{initialized && (
  ...
  className='grid-desktop-crud grid-desktop-contatocrm'
