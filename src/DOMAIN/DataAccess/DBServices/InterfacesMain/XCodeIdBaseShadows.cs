...
internal class XCodeIdBaseShadows   //: StylesCad - Deixou o Sistema lento, muitas heranças.
{
    ...
    public string FShadowViewDataHoraTermino
    {
        ...
        set { (var setUpNow, var changed, var data) = DevourerOne.DateUp7(pFldFShadowViewDataHoraTermino, m_FShadowViewDataHoraTermino, value); if (!setUpNow) return; pFldFShadowViewDataHoraTermino = changed; m_FShadowViewDataHoraTermino = data; }
    }
