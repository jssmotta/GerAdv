...
public class FilterCargosEscWithVoiceRequest
{
    /// <summary>
    /// Filtro de CargosEsc padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterCargosEsc Filter { get; set; } = new();
...
[Serializable]
public partial record FilterCargosEsc
{
    ...
    public decimal Percentual { get; set; } = int.MinValue;

    [JsonPropertyName("percentual_end")]
    [Description("Percentual final para o intervalo")]
    public decimal Percentual_end { get; set; } = int.MinValue;
    ...
    [Description("Classificacao -2147483648 para nada ou id")]
    public int Classificacao { get; set; } = int.MinValue;

    [JsonPropertyName("classificacao_end")]
    [Description("Classificacao -2147483648 para nada ou id para final do intervalo")]
    public int Classificacao_end { get; set; } = int.MinValue;
