...
// useProObservacoesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProObservacoes
"use client";
...
interface UseProObservacoesGridProps {
...
export const useProObservacoesGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IProObservacoes, filters: Record<string, any>) => {
