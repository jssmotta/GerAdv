...
public class DBTipoRecursoUpdate : IDisposable
{
    ...
    public void DefaultConstructor_ShouldCreateInstance_WithDefaultValues()
    {
        ...
        tiporecurso.ITableName().Should().Be("TipoRecurso");
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set tiporecurso.FDescricao.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        tiporecurso.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Assert - All properties should be set tiporecurso.FDescricao.Should().HaveLength(50);
        tiporecurso.FGuid.Should().HaveLength(100);
    }
