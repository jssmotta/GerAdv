...
public class RitoControllerTests
{
    ...
    public async Task GetById_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.GetById(id, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync((Resp.RitoResponse? )null);
        // Act
        var result = await _controller.GetById(id, "test-uri");
        // Assert
    ...
    public async Task AddAndUpdate_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Rito>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task AddAndUpdate_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Rito();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Rito>(), "test-uri")).ReturnsAsync((Resp.RitoResponse? )null);
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task Delete_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.Delete(id, "test-uri")).ReturnsAsync((Resp.RitoResponse? )null);
        // Act
        var result = await _controller.Delete(id, "test-uri");
        // Assert
        result.Should().BeOfType<NotFoundResult>();
    ...
    public async Task Validation_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Rito>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task Validation_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Rito();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Rito>(), "test-uri")).ReturnsAsync((Resp.RitoResponse? )null);
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<BadRequestResult>();
...
#region FilterVoice Tests
    ...
    {
        // Arrange
        var request = new Filters.FilterRitoWithVoiceRequest
        {
            Filter = new Filters.FilterRito
            {
                Descricao = "Test"
            },
            VoiceCommand = new CommandSpeakerRequest
            {
                Message = "buscar rito com _nome test"
            }
        };
        var expectedFilter = new Filters.FilterRito
        {
            Descricao = "Test"
        };
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterRito>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ReturnsAsync(expectedFilter);
        // Act
        ...
        _mockService.Verify(x => x.FilterVoice(It.IsAny<Filters.FilterRito>(), It.IsAny<CommandSpeakerRequest>(), "test-uri"), Times.Once);
    }
    ...
    public async Task FilterVoice_WithNullVoiceCommand_ReturnsOkWithOriginalFilter()
    {
        ...
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterRito>(), null, "test-uri")).ReturnsAsync(expectedFilter);
        // Act
        var result = await _controller.FilterVoice(request, "test-uri");
        // Assert
        result.Should().BeOfType<OkObjectResult>();
    ...
    public async Task FilterVoice_WithValidVoiceCommand_ProcessesCommand()
    {
        ...
        var request = new Filters.FilterRitoWithVoiceRequest
        {
            ...
            VoiceCommand = new CommandSpeakerRequest
            {
                Message = "buscar rito gerente"
            }
        };
        var processedFilter = new Filters.FilterRito
        {
            Descricao = "Gerente"
        };
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterRito>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ReturnsAsync(processedFilter);
        // Act
        var result = await _controller.FilterVoice(request, "test-uri");
        // Assert
        result.Should().BeOfType<OkObjectResult>();
    ...
    public async Task FilterVoice_WhenBulkheadRejects_ReturnsServiceUnavailable()
    {
        ...
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterRito>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ThrowsAsync(new Polly.Bulkhead.BulkheadRejectedException());
        // Act
        var result = await _controller.FilterVoice(request, "test-uri");
        // Assert
        result.Should().BeOfType<ObjectResult>();
    ...
    public async Task FilterVoice_WhenExceptionOccurs_Rethrows()
    {
        ...
        _mockService.Setup(x => x.FilterVoice(It.IsAny<Filters.FilterRito>(), It.IsAny<CommandSpeakerRequest>(), "test-uri")).ThrowsAsync(new Exception("Test exception"));
        // Act & Assert
