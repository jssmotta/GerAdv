...
export const useModelosDocumentosForm = (
  ...
  const loadModelosDocumentos = useCallback(
    async (id: number) => {
      if (!id || id === 0) {
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error
            ? err.message
            : "Erro ao carregar Modelos Documentos";
...
export const useModelosDocumentosList = (
  dataService: IModelosDocumentosService,
  currentFilter?: FilterModelosDocumentos | undefined | null,
) => {
  const [data, setData] = useState<IModelosDocumentos[]>([]);
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState<string | null>(null);
  const currentFilterRef = useRef<FilterModelosDocumentos | undefined | null>(
    currentFilter,
  );
    ...
    async (filtro?: FilterModelosDocumentos | undefined | null) => {
      ...
      try {
        ...
        const errorMessage =
          err instanceof Error
            ? err.message
            : "Erro ao carregar modelosdocumentos";
        setError(errorMessage);
        if (process.env.NEXT_PUBLIC_SHOW_LOG === "1")
...
export function useValidationsModelosDocumentos() {
  async function runValidation(
    ...
    const modelosdocumentosApi = new ModelosDocumentosApi(
      uri ?? "",
      token ?? "",
    );
  ...
  function validate(data: IModelosDocumentos): {
    isValid: boolean;
    message: string;
  } {
    ...
    try {
      ...
      if (data.remuneracao.length > 2147483647) {
        return {
          isValid: false,
          message:
            "O campo Remuneracao não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.assinatura.length > 2147483647) {
        return {
          isValid: false,
          message:
            "O campo Assinatura não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.header.length > 2147483647) {
        return {
          isValid: false,
          message: "O campo Header não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.footer.length > 2147483647) {
        return {
          isValid: false,
          message: "O campo Footer não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.extra1.length > 2147483647) {
        return {
          isValid: false,
          message: "O campo Extra1 não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.extra2.length > 2147483647) {
        return {
          isValid: false,
          message: "O campo Extra2 não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.extra3.length > 2147483647) {
        return {
          isValid: false,
          message: "O campo Extra3 não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.outorgante.length > 2147483647) {
        return {
          isValid: false,
          message:
            "O campo Outorgante não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.outorgados.length > 2147483647) {
        return {
          isValid: false,
          message:
            "O campo Outorgados não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.poderes.length > 2147483647) {
        return {
          isValid: false,
          message:
            "O campo Poderes não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.objeto.length > 2147483647) {
        return {
          isValid: false,
          message: "O campo Objeto não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.titulo.length > 2000) {
        return {
          isValid: false,
          message: "O campo Titulo não pode ter mais de 2000 caracteres.",
        };
      }
      if (data.testemunhas.length > 2147483647) {
        return {
          isValid: false,
          message:
            "O campo Testemunhas não pode ter mais de 2147483647 caracteres.",
        };
      }
      if (data.css.length > 2147483647) {
        return {
          isValid: false,
          message: "O campo CSS não pode ter mais de 2147483647 caracteres.",
        };
      }
