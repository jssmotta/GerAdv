...
interface OperadorEMailPopupGridProps {
  data: IOperadorEMailPopup[];
  onRowClick: (operadoremailpopup: IOperadorEMailPopup) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const OperadorEMailPopupGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IOperadorEMailPopup, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-operadoremailpopup'
