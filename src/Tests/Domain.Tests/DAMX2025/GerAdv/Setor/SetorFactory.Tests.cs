...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("setCodigo", typeof(int));
        mockDataTable.Columns.Add("setDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["setCodigo"] = testId;
        row["setDescricao"] = "Test Setor";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["setCodigo"] = 123;
        row["setDescricao"] = "Test Setor Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FSetor properties
        }
    }
