...
public partial class DBClientesSocios : VSexo, ICadastrosAuditor, IAuditor, IListagemCidade
{
#if (DEBUG)
#if (!shadowsDisabled && !shadows_MenphisSI_GerAdv && !shadows_MenphisSI_GerAdv_ClientesSocios)
#pragma warning disable CA1822 // Mark members as static

//public bool CertSignature() => DicionarioDeDadosManagedDatabaseCode.CodeSigntature_DBClientesSocios();
...
#region TableDefinition_ClientesSocios
...
#endregion
    public DBClientesSocios(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBClientesSocios(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBClientesSocios(in string? sqlWhere, SqlConnection? oCnn)
    {
