...
export class DocsRecebidosItensService implements IDocsRecebidosItensService {
  ...
  async saveDocsRecebidosItens(docsrecebidositens: IDocsRecebidosItens): Promise<IDocsRecebidosItens> {    
    ...
    try {
      ...
      console.log('Error fetching DocsRecebidosItens list');
      return [];
    }
  }
   ...
   async getAll(
    filtro?: FilterDocsRecebidosItens,
    onOnlineData?: (data: IDocsRecebidosItens[]) => void
  ): Promise<IDocsRecebidosItens[]> {
    try {
      ...
      if (onOnlineData) {
        ...
        this.api.filter(filtro ?? {})
          ...
          .catch(error => {
            console.log('Error fetching online DocsRecebidosItens');
          });
      ...
      console.log('Error fetching all DocsRecebidosItens:');
      return [];
    }
  }
