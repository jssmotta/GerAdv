...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void Estagiario_ShouldAcceptIntegerValues(int value)
{
    _instance.FEstagiario = value;
    Assert.Equal(value, _instance.FEstagiario);
}
...
[Fact]
public void Estagiario_DefaultValue_ShouldBeZero()
{
    var instance = new DBAdvogados();
    Assert.Equal(0, instance.Estagiario);
}
*/
    /*
TEMPLATE_DATETIME_FIELD:
...
[InlineData("31/12/2023")]
[InlineData("15/08/2024")]
public void Estagiario_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FEstagiario = dateString;
    Assert.Equal(dateString, _instance.FEstagiario);
}

[Fact]
public void Estagiario_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBAdvogados();
    Assert.Equal(string.Empty, instance.Estagiario);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("384.004.020-57", "38400402057")]
[InlineData("", "")]
public void Estagiario_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FEstagiario = input;
        Assert.Equal(expected, _instance.FEstagiario);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FEstagiario = input);
    }
}
*/
    /*
...
[InlineData("test@example.com")]
[InlineData("user.name@domain.co.uk")]
public void Estagiario_ValidEmail_ShouldAccept(string email)
{
    _instance.FEstagiario = email;
    Assert.Equal(email, _instance.FEstagiario);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void Estagiario_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FEstagiario = email);
}
*/
    [Theory]
    [InlineData("", "")]
...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void ParcTop_ShouldAcceptIntegerValues(int value)
{
    _instance.FParcTop = value;
    Assert.Equal(value, _instance.FParcTop);
}
...
[Fact]
public void ParcTop_DefaultValue_ShouldBeZero()
{
    var instance = new DBAdvogados();
    Assert.Equal(0, instance.ParcTop);
}
*/
    /*
TEMPLATE_DATETIME_FIELD:
...
[InlineData("31/12/2023")]
[InlineData("15/08/2024")]
public void ParcTop_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FParcTop = dateString;
    Assert.Equal(dateString, _instance.FParcTop);
}

[Fact]
public void ParcTop_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBAdvogados();
    Assert.Equal(string.Empty, instance.ParcTop);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("384.004.020-57", "38400402057")]
[InlineData("", "")]
public void ParcTop_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FParcTop = input;
        Assert.Equal(expected, _instance.FParcTop);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FParcTop = input);
    }
}
*/
    /*
...
[InlineData("test@example.com")]
[InlineData("user.name@domain.co.uk")]
public void ParcTop_ValidEmail_ShouldAccept(string email)
{
    _instance.FParcTop = email;
    Assert.Equal(email, _instance.FParcTop);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void ParcTop_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FParcTop = email);
}
*/
    [Theory]
    [InlineData("", "")]
