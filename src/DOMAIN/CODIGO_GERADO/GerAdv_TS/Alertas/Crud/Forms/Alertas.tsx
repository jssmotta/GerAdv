...
/>
							...
							<div className='relacionamentosLinks' onClick={()=> router.push(`/pages/alertasenviados${process.env.NEXT_PUBLIC_PAGE_HTML ?? ''}?alertas=${alertasData.id}`)}>Alertas Enviados</div>
