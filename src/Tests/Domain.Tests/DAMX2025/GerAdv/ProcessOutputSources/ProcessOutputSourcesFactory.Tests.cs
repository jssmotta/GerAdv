...
public class FProcessOutputSourcesFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FProcessOutputSourcesFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FProcessOutputSourcesFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FProcessOutputSourcesFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FProcessOutputSources>();
    }
    ...
    {
        // Arrange
        var factory = new FProcessOutputSourcesFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("posNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["posCodigo"] = testId;
        row["posNome"] = "Test ProcessOutputSources";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["posCodigo"] = 123;
        row["posNome"] = "Test ProcessOutputSources Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FProcessOutputSources properties
        }
    }
