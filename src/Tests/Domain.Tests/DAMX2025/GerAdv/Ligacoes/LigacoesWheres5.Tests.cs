...
#region Test Data Setup Helpers
    ...
    private void SetupMockFLigacoes(string? Assunto = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", int? AgeClienteAvisado = 1, bool? Celular = false, int? Cliente = 1, string? Contato = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? DataRealizada = "24/04/1975", int? QuemID = 1, int? Telefonista = 1, string? UltimoAviso = "24/04/1975", string? HoraFinal = "04:04", string? Nome = "João", int? QuemCodigo = 1, int? Solicitante = 1, string? Para = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", string? Fone = "(11) 99999-9999", int? Ramal = 1, bool? Particular = true, bool? Realizada = false, string? Status = "", string? Data = "24/04/1975", string? Hora = "04:04", bool? Urgente = true, string? LigarPara = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", int? Processo = 1, bool? StartScreen = false, int? Emotion = 1)
    {
        ...
        if (string.IsNullOrEmpty(DataRealizada))
        {
            _mockFLigacoes.Setup(f => f.FDataRealizada).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(DataRealizada, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(DataRealizada, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFLigacoes.Setup(f => f.FDataRealizada).Returns(dateOnly);
        }

        _mockFLigacoes.Setup(f => f.FQuemID).Returns(QuemID ?? 0);
        _mockFLigacoes.Setup(f => f.FTelefonista).Returns(Telefonista ?? 0);
        if (string.IsNullOrEmpty(UltimoAviso))
        {
            _mockFLigacoes.Setup(f => f.FUltimoAviso).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(UltimoAviso, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(UltimoAviso, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFLigacoes.Setup(f => f.FUltimoAviso).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(HoraFinal))
        {
            _mockFLigacoes.Setup(f => f.FHoraFinal).Returns((TimeOnly? )null);
        }
        else
        {
            TimeOnly horaValue;
            ...
            _mockFLigacoes.Setup(f => f.FHoraFinal).Returns(horaValue);
        }
        ...
        {
            _mockFLigacoes.Setup(f => f.FData).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            ...
            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFLigacoes.Setup(f => f.FData).Returns(dateOnly);
        }

        if (string.IsNullOrEmpty(Hora))
        {
            _mockFLigacoes.Setup(f => f.FHora).Returns((TimeOnly? )null);
        }
        else
        {
            TimeOnly horaValue;
            ...
            _mockFLigacoes.Setup(f => f.FHora).Returns(horaValue);
        }
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_DataRealizada_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _ligacoesWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DataRealizada.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
    ...
    public void Read_WithValidDate_UltimoAviso_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _ligacoesWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.UltimoAviso.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
