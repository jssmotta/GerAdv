...
public partial class DBPenhoraStatusODicInfo : IODicInfo
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldId() => DBPenhoraStatusDicInfo.CampoCodigo;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string ITypeFieldCode() => "int";
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IPrefix() => DBPenhoraStatusDicInfo.TablePrefix;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public string IFieldNameDescription() => DBPenhoraStatusDicInfo.CampoNome;
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
