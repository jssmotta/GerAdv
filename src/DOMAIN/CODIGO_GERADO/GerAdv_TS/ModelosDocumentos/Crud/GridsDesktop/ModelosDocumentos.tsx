...
interface ModelosDocumentosGridProps {
  data: IModelosDocumentos[];
  onRowClick: (modelosdocumentos: IModelosDocumentos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ModelosDocumentosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IModelosDocumentos, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nometipomodelodocumento' title='Tipo Modelo Documento' sortable={false} filterable={false} />, /* Track G.01 */
  <GridColumn
  field='id'
  width={'55px'}
  title='Excluir'
...
{initialized && (
  ...
  className='grid-desktop-modelosdocumentos'
