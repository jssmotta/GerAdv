...
#region Test Data Setup Helpers
    ...
    private void SetupMockFAgenda(int? IDCOB = 1, bool? ClienteAvisado = false, bool? RevisarP2 = true, int? IDNE = 1, int? Cidade = 1, int? Oculto = 1, int? CartaPrecatoria = 1, bool? Revisar = false, string? HrFinal = "27/05/2022", int? Advogado = 1, int? EventoGerador = 1, string? EventoData = "24/04/1975", int? Funcionario = 1, string? Data = "27/05/2022", int? EventoPrazo = 1, string? Hora = "04:04", string? Compromisso = "", int? TipoCompromisso = 1, int? Cliente = 1, bool? Liberado = true, bool? Importante = false, bool? Concluido = true, int? Area = 1, int? Justica = 1, int? Processo = 1, int? IDHistorico = 1, int? IDInsProcesso = 1, int? Usuario = 1, int? Preposto = 1, int? QuemID = 1, int? QuemCodigo = 1, string? Status = "", decimal? Valor = 0m, string? Decisao = "", int? Sempre = 1, int? PrazoDias = 1, int? ProtocoloIntegrado = 1, string? DataInicioPrazo = "24/04/1975", bool? UsuarioCiente = false)
    {
...
#region Integration Tests
    ...
    public void Read_WithCompleteRealWorldScenario_ShouldMapAllFieldsCorrectly()
    {
        ...
        SetupMockFAgenda(IDCOB: 1, ClienteAvisado: false, RevisarP2: true, IDNE: 1, Cidade: 1, Oculto: 1, CartaPrecatoria: 1, Revisar: false, HrFinal: "27/05/2022", Advogado: 1, EventoGerador: 1, EventoData: "24/04/1975", Funcionario: 1, Data: "27/05/2022", EventoPrazo: 1, Hora: "04:04", Compromisso: "", TipoCompromisso: 1, Cliente: 1, Liberado: true, Importante: false, Concluido: true, Area: 1, Justica: 1, Processo: 1, IDHistorico: 1, IDInsProcesso: 1, Usuario: 1, Preposto: 1, QuemID: 1, QuemCodigo: 1, Status: "", Valor: 0m, Decisao: "", Sempre: 1, PrazoDias: 1, ProtocoloIntegrado: 1, DataInicioPrazo: "24/04/1975", UsuarioCiente: false);
        _mockAgendaFactory.Setup(f => f.CreateFromParameters(parameters, _mockConnection.Object, "", "", where, "")).Returns(_mockFAgenda.Object);
        // Act
        var result = _agendaWhere.Read(where, parameters, _mockConnection.Object);
