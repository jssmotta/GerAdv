...
/>
							...
							<div className='relacionamentosLinks' onClick={()=> router.push(`/pages/historico${process.env.NEXT_PUBLIC_PAGE_HTML ?? ''}?statusandamento=${statusandamentoData.id}`)}>Historico</div>
