...
public class DBCargosEscClassUpdate : IDisposable
{
    private readonly DBCargosEscClass _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBCargosEscClassUpdate()
    {
    ...
    {
        // Act
        var cargosescclass = new DBCargosEscClass();
        // Assert
        cargosescclass.Should().NotBeNull();
        cargosescclass.ITableName().Should().Be("CargosEscClass");
        cargosescclass.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set cargosescclass.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        cargosescclass.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        cargosescclass.FNome = longString; // MAX: 80
        cargosescclass.FGuid = longString; // MAX: 100
        // Assert - All properties should be set cargosescclass.FNome.Should().HaveLength(80);
        cargosescclass.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        cargosescclass.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        cargosescclass.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "cecCodigo = 1";
        // Act & Assert
        var CargosEscClass = new DBCargosEscClass(sqlWhere, null);
        CargosEscClass.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var cargosescclass = new DBCargosEscClass(parameters, nome, null);
        // Assert
        cargosescclass.Should().NotBeNull();
        cargosescclass.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        cargosescclass.FNome = longName;
        // Assert
        cargosescclass.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBCargosEscClass).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var cargosescclass = new DBCargosEscClass();
        // Act & Assert
        cargosescclass.TabelaNome.Should().Be("CargosEscClass");
    }
