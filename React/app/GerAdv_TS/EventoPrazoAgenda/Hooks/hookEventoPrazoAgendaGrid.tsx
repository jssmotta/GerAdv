...
// useEventoPrazoAgendaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de EventoPrazoAgenda
"use client";
...
interface UseEventoPrazoAgendaGridProps {
...
export const useEventoPrazoAgendaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IEventoPrazoAgenda, filters: Record<string, any>) => {
