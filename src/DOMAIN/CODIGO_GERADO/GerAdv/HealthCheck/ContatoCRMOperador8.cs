                ...
                try
                {
                    ...
                    try
                    {
                        if (DBContatoCRMOperadorDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(ccoCodigo) FROM {"ContatoCRMOperador".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) ccoContatoCRM,ccoCargoEsc,ccoOperador FROM {"ContatoCRMOperador".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
