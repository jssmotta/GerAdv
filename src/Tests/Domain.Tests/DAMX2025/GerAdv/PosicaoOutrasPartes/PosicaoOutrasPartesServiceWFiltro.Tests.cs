...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class PosicaoOutrasPartesServiceWFiltroTests : IDisposable
    {
        ...
        private readonly PosicaoOutrasPartesServiceS _serviceS;
        public PosicaoOutrasPartesServiceWFiltroTests()
        {
            ...
            _serviceS = new PosicaoOutrasPartesServiceS();
            _service = new PosicaoOutrasPartesService(_mockAppSettings.Object, _mockPosicaoOutrasPartesFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockTerceirosService.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidPosicaoOutrasPartes_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomePosicaoOutrasPartes = "João Silva";
            var filtro = new FilterPosicaoOutrasPartes
            {
                Guid = nomePosicaoOutrasPartes,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidPosicaoOutrasPartes_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
        ...
        [Fact]
        public void WFiltro_GuidPosicaoOutrasPartes_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidPosicaoOutrasPartes_StringsVazias_NaoDeveIncluirNoFiltro(string? nomePosicaoOutrasPartes)
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
        ...
        [Fact]
        public void WFiltro_GuidPosicaoOutrasPartes_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
            ...
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartes.CampoCodigo}");
        ...
        [Fact]
        public void WFiltro_GuidPosicaoOutrasPartes_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomePosicaoOutrasPartes = "João Silva";
            var filtro = new FilterPosicaoOutrasPartes
            ...
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @posGuid");
        ...
        [Fact]
        public void WFiltro_DescricaoPosicaoOutrasPartes_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomePosicaoOutrasPartes = "João Silva";
            var filtro = new FilterPosicaoOutrasPartes
            {
                Descricao = nomePosicaoOutrasPartes,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_DescricaoPosicaoOutrasPartes_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
        ...
        [Fact]
        public void WFiltro_DescricaoPosicaoOutrasPartes_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_DescricaoPosicaoOutrasPartes_StringsVazias_NaoDeveIncluirNoFiltro(string? nomePosicaoOutrasPartes)
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
        ...
        [Fact]
        public void WFiltro_DescricaoPosicaoOutrasPartes_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterPosicaoOutrasPartes
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@posDescricao");
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartes.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @posDescricao");
            resultado.Value.where.Should().Contain($"= @{DBPosicaoOutrasPartes.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_DescricaoPosicaoOutrasPartes_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomePosicaoOutrasPartes = "João Silva";
            var filtro = new FilterPosicaoOutrasPartes
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.Descricao}]");
            resultado.Value.where.Should().Contain("like @posDescricao");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@posDescricao");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemCad}] = @{DBPosicaoOutrasPartesDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBPosicaoOutrasPartesDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.QuemCad} BETWEEN @{DBPosicaoOutrasPartesDicInfo.QuemCad} AND @{DBPosicaoOutrasPartesDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.QuemCad} BETWEEN @{DBPosicaoOutrasPartesDicInfo.QuemCad} AND @{DBPosicaoOutrasPartesDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemCad}] = @{DBPosicaoOutrasPartesDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemCad}] = @posQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@posQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@posQuemCad");
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemAtu}] = @{DBPosicaoOutrasPartesDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBPosicaoOutrasPartesDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.QuemAtu} BETWEEN @{DBPosicaoOutrasPartesDicInfo.QuemAtu} AND @{DBPosicaoOutrasPartesDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.QuemAtu} BETWEEN @{DBPosicaoOutrasPartesDicInfo.QuemAtu} AND @{DBPosicaoOutrasPartesDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemAtu}] = @{DBPosicaoOutrasPartesDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.QuemAtu}] = @posQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@posQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@posQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.CampoCodigo}] = @{DBPosicaoOutrasPartesDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBPosicaoOutrasPartesDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.CampoCodigo} BETWEEN @{DBPosicaoOutrasPartesDicInfo.CampoCodigo} AND @{DBPosicaoOutrasPartesDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBPosicaoOutrasPartesDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.CampoCodigo} BETWEEN @{DBPosicaoOutrasPartesDicInfo.CampoCodigo} AND @{DBPosicaoOutrasPartesDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.CampoCodigo}] = @{DBPosicaoOutrasPartesDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBPosicaoOutrasPartesDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBPosicaoOutrasPartesDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.DtCad} BETWEEN @{DBPosicaoOutrasPartesDicInfo.DtCad} AND @{DBPosicaoOutrasPartesDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBPosicaoOutrasPartesDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].[{DBPosicaoOutrasPartesDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBPosicaoOutrasPartesDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBPosicaoOutrasPartesDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBPosicaoOutrasPartesDicInfo.PTabelaNome}].{DBPosicaoOutrasPartesDicInfo.DtAtu} BETWEEN @{DBPosicaoOutrasPartesDicInfo.DtAtu} AND @{DBPosicaoOutrasPartesDicInfo.DtAtu}_end");
        }
