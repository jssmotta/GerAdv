...
import { ProcessOutputRequestApiError } from '../GerAdv_TS/ProcessOutputRequest/Apis/ApiProcessOutputRequest';
import { ProcessOutputRequestApi } from '@/app/GerAdv_TS/ProcessOutputRequest/Apis/ApiProcessOutputRequest';
import { FilterProcessOutputRequest } from '../GerAdv_TS/ProcessOutputRequest/Filters/ProcessOutputRequest';
...
describe('ProcessOutputRequestApi', () => {
  let processoutputrequestApi: ProcessOutputRequestApi;
  ...
  beforeEach(() => {
    ...
    processoutputrequestApi = new ProcessOutputRequestApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(processoutputrequestApi).toBeInstanceOf(ProcessOutputRequestApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new ProcessOutputRequestApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(ProcessOutputRequestApi);
    });
  });
  ...
  describe('getAll', () => {
    const mockResponse: AxiosResponse = {
      data: [ProcessOutputRequestTestEmpty()],
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch all processoutputrequest items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await processoutputrequestApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(processoutputrequestApi.getAll()).rejects.toThrow(ProcessOutputRequestApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await processoutputrequestApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-ProcessOutputRequest_last_getAll_${200}`)));
    });
    ...
    it('should throw ProcessOutputRequestApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockProcessOutputRequest = ProcessOutputRequestTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockProcessOutputRequest,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch processoutputrequest by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await processoutputrequestApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockProcessOutputRequest));
      ...
      expect(result.data).toEqual(mockProcessOutputRequest);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'ProcessOutputRequest',
          id: 1,
  ...
  describe('filter', () => {
    const mockFilter: FilterProcessOutputRequest = {
      funcionario: 1,
      data: '2024-01-01',
    };
    ...
    it('should filter processoutputrequest items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await processoutputrequestApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    const mockProcessOutputRequest: IProcessOutputRequest = {
      id: 0,
      funcionario: 1,
      tipocompromisso: 1,
      fornecedor: 1,
    ...
    it('should add new processoutputrequest successfully', async () => {
      const responseProcessOutputRequest = { ...mockProcessOutputRequest, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responseProcessOutputRequest,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await processoutputrequestApi.addAndUpdate(mockProcessOutputRequest);

      expect(mockedAxios.post).toHaveBeenCalledWith(
        expect.stringContaining('/AddAndUpdate'),
        mockProcessOutputRequest,
        expect.any(Object)
      );
      expect(result).toEqual(mockResponse);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
    ...
    it('should update existing processoutputrequest successfully', async () => {
      const existingProcessOutputRequest = { ...mockProcessOutputRequest, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingProcessOutputRequest,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await processoutputrequestApi.addAndUpdate(existingProcessOutputRequest);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(processoutputrequestApi.addAndUpdate(mockProcessOutputRequest)).rejects.toThrow(ProcessOutputRequestApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'ProcessOutputRequest',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete processoutputrequest successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await processoutputrequestApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(processoutputrequestApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'ProcessOutputRequest',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(processoutputrequestApi.delete(1)).rejects.toThrow(ProcessOutputRequestApiError);
    });
  });

  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterProcessOutputRequest = { funcionario: 1 };
      
      const result = processoutputrequestApi.useFilter(mockFilter);
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await processoutputrequestApi.delete(1);
  ...
  describe('ProcessOutputRequestApiError', () => {
    it('should create error with correct properties', () => {
      const error = new ProcessOutputRequestApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('ProcessOutputRequestApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new ProcessOutputRequestApiError('Test message', 500);
