...
export interface IGUTPeriodicidadeStatusService {
  ...
  filterVoice: (filtro?: FilterGUTPeriodicidadeStatus, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class GUTPeriodicidadeStatusService implements IGUTPeriodicidadeStatusService {
  ...
  async filterVoice(filtro?: FilterGUTPeriodicidadeStatus, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
