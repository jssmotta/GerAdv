...
import { StatusHTrabApiError } from '@/app/GerAdv_TS/StatusHTrab/Apis/ApiStatusHTrab';
...
import { StatusHTrabTestEmpty } from '@/app/GerAdv_TS/Models/StatusHTrab';
...
resid: 0
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterStatusHTrab = { : 1 };
