...
export interface IAndamentosMDService {
  ...
  filterVoice: (filtro?: FilterAndamentosMD, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class AndamentosMDService implements IAndamentosMDService {
  ...
  async filterVoice(filtro?: FilterAndamentosMD, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
