...
import {
  useOperadorGruposAgendaForm,
  useValidationsOperadorGruposAgenda,
} from "../../Hooks/hookOperadorGruposAgenda";
...
const OperadorGruposAgendaInc: React.FC<IOperadorGruposAgendaFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadOperadorGruposAgenda } =
    useOperadorGruposAgendaForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedOperadorGruposAgenda =
        await operadorgruposagendaService.saveOperadorGruposAgenda(data);
