...
#region TableDefinition_GUTAtividadesMatriz
...
#endregion
    public DBGUTAtividadesMatriz(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        // Tracking: 250605-0
        if (oCnn is null)
            return;
    ...
    public DBGUTAtividadesMatriz(in string? sqlWhere, MsiSqlConnection? oCnn)
    {
