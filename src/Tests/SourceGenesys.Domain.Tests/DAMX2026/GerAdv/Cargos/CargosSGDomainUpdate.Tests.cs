...
public class DBCargosUpdate : IDisposable
{
    private readonly DBCargos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBCargosUpdate()
    {
    ...
    {
        // Act
        var cargos = new DBCargos();
        // Assert
        cargos.Should().NotBeNull();
        cargos.ITableName().Should().Be("Cargos");
        cargos.ID.Should().Be(0);
    }
    ...
    // Assert - All properties should be set cargos.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        cargos.FNome = longString; // MAX: 80
    // Assert - All properties should be set cargos.FNome.Should().HaveLength(80);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        cargos.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "carCodigo = 1";
        // Act & Assert
        var Cargos = new DBCargos(sqlWhere, null);
        Cargos.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var cargos = new DBCargos(parameters, nome, null);
        // Assert
        cargos.Should().NotBeNull();
        cargos.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        cargos.FNome = longName;
        // Assert
        cargos.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBCargos).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var cargos = new DBCargos();
        // Act & Assert
        cargos.TabelaNome.Should().Be("Cargos");
    }
