...
import { Diario2ApiError } from '@/app/GerAdv_TS/Diario2/Apis/ApiDiario2';
...
import { Diario2TestEmpty } from '@/app/GerAdv_TS/Models/Diario2';
...
cliente: 0
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterDiario2 = { : 1 };
