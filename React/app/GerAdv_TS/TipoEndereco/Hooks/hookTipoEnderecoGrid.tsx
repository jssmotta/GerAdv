...
// useTipoEnderecoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoEndereco
"use client";
...
interface UseTipoEnderecoGridProps {
  data: ITipoEndereco[];
...
export const useTipoEnderecoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ITipoEndereco, filters: Record<string, any>) => {
