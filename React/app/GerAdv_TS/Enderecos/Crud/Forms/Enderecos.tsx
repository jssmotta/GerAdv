...
export const EnderecosForm: React.FC<EnderecosFormProps> = ({
  ...
  const dadoApi = new EnderecosApi(
    systemContext?.Uri ?? "",
    systemContext?.Token ?? "",
  );
  ...
  useEffect(() => {
    ...
    if (el) {
      el.textContent =
        enderecosData?.id == 0 ? "Editar Enderecos" : "Adicionar Endereço";
    }
  }, [enderecosData.id]);
  ...
  return (
    <>
      <div
        className={
          isMobile
            ? "form-container form-container-Enderecos"
            : "form-container form-container-Enderecos"
        }
      >
        <form
          className="formInputCadInc"
          id={`EnderecosForm-${enderecosData.id}`}
          onSubmit={onConfirm}
        >
          {!isMobile && (
            <ButtonSalvarCrud
              ...
              onClose={onClose}
              formId={`EnderecosForm-${enderecosData.id}`}
          ...
          <div className="grid-container">
            <InputDescription
              ...
              placeholder={`Digite _nome endereço`}
              onChange={onChange}
              required
            />
            ...
            <InputCheckbox
              ...
              label="TopIndex"
              name="topindex"
              checked={enderecosData.topindex}
              onChange={onChange}
            />
            ...
            <InputCheckbox
              ...
              label="Privativo"
              name="privativo"
              checked={enderecosData.privativo}
              onChange={onChange}
            />
            <InputCheckbox
              dataForm={enderecosData}
              label="AddContato"
              name="addcontato"
              checked={enderecosData.addcontato}
              onChange={onChange}
            />
          ...
          <div className="grid-container">
            ...
            <InputCheckbox
              ...
              label="ReportECBOnly"
              name="reportecbonly"
              checked={enderecosData.reportecbonly}
              onChange={onChange}
            />
            <InputCheckbox
              dataForm={enderecosData}
        ...
        <FooterIncDocker>
          <CopyButton formId={`EnderecosForm-${enderecosData.id}`} />

          <PrintButton formId={`EnderecosForm-${enderecosData.id}`} />
