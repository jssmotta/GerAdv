...
interface AgendaFinanceiroGridProps {
  data: IAgendaFinanceiro[];
  onRowClick: (agendafinanceiro: IAgendaFinanceiro) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AgendaFinanceiroGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAgendaFinanceiro, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-agendafinanceiro'
