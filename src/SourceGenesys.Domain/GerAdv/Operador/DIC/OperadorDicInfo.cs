...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem OperGUID => new(0, PTabelaNome, CampoCodigo, GUID, 50, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "oper"
    };
