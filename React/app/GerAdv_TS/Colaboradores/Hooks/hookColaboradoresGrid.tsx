...
// useColaboradoresGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Colaboradores
"use client";
...
interface UseColaboradoresGridProps {
  data: IColaboradores[];
...
export const useColaboradoresGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IColaboradores, filters: Record<string, any>) => {
