...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class NEPalavrasChavesServiceWFiltroTests : IDisposable
    {
        ...
        private readonly NEPalavrasChavesServiceS _serviceS;
        public NEPalavrasChavesServiceWFiltroTests()
        {
            ...
            _serviceS = new NEPalavrasChavesServiceS();
            _service = new NEPalavrasChavesService(_mockAppSettings.Object, _mockNEPalavrasChavesFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_NomeNEPalavrasChaves_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeNEPalavrasChaves = "João Silva";
            var filtro = new FilterNEPalavrasChaves
            {
                Nome = nomeNEPalavrasChaves,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeNEPalavrasChaves_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterNEPalavrasChaves
            {
        ...
        [Fact]
        public void WFiltro_NomeNEPalavrasChaves_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterNEPalavrasChaves
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeNEPalavrasChaves_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeNEPalavrasChaves)
        {
            // Arrange
            var filtro = new FilterNEPalavrasChaves
            {
        ...
        [Fact]
        public void WFiltro_NomeNEPalavrasChaves_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterNEPalavrasChaves
            {
            ...
            resultado.Value.where.Should().Contain("@npcNome");
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChaves.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @npcNome");
            resultado.Value.where.Should().Contain($"= @{DBNEPalavrasChaves.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeNEPalavrasChaves_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeNEPalavrasChaves = "João Silva";
            var filtro = new FilterNEPalavrasChaves
            ...
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @npcNome");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@npcNome");
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemCad}] = @{DBNEPalavrasChavesDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBNEPalavrasChavesDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.QuemCad} BETWEEN @{DBNEPalavrasChavesDicInfo.QuemCad} AND @{DBNEPalavrasChavesDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.Nome}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.QuemCad} BETWEEN @{DBNEPalavrasChavesDicInfo.QuemCad} AND @{DBNEPalavrasChavesDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemCad}] = @{DBNEPalavrasChavesDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemCad}] = @npcQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@npcQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@npcQuemCad");
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.Nome}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemAtu}] = @{DBNEPalavrasChavesDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBNEPalavrasChavesDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.QuemAtu} BETWEEN @{DBNEPalavrasChavesDicInfo.QuemAtu} AND @{DBNEPalavrasChavesDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.Nome}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.QuemAtu} BETWEEN @{DBNEPalavrasChavesDicInfo.QuemAtu} AND @{DBNEPalavrasChavesDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemAtu}] = @{DBNEPalavrasChavesDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.QuemAtu}] = @npcQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@npcQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@npcQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.Nome}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.CampoCodigo}] = @{DBNEPalavrasChavesDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBNEPalavrasChavesDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.CampoCodigo} BETWEEN @{DBNEPalavrasChavesDicInfo.CampoCodigo} AND @{DBNEPalavrasChavesDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBNEPalavrasChavesDicInfo.Nome}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.CampoCodigo} BETWEEN @{DBNEPalavrasChavesDicInfo.CampoCodigo} AND @{DBNEPalavrasChavesDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.CampoCodigo}] = @{DBNEPalavrasChavesDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBNEPalavrasChavesDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBNEPalavrasChavesDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.DtCad} BETWEEN @{DBNEPalavrasChavesDicInfo.DtCad} AND @{DBNEPalavrasChavesDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBNEPalavrasChavesDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBNEPalavrasChavesDicInfo.PTabelaNome}].[{DBNEPalavrasChavesDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBNEPalavrasChavesDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBNEPalavrasChavesDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBNEPalavrasChavesDicInfo.PTabelaNome}].{DBNEPalavrasChavesDicInfo.DtAtu} BETWEEN @{DBNEPalavrasChavesDicInfo.DtAtu} AND @{DBNEPalavrasChavesDicInfo.DtAtu}_end");
        }
