                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(sitCodigo) FROM {"Situacao".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) sitParte_Int,sitParte_Opo,sitTop,sitBold,sitGuid FROM {"Situacao".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
