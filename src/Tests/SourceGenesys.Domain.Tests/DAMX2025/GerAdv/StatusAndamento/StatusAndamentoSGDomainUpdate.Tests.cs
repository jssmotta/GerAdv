...
public class DBStatusAndamentoUpdate : IDisposable
{
    private readonly DBStatusAndamento _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusAndamentoUpdate()
    {
    ...
    {
        // Act
        var statusandamento = new DBStatusAndamento();
        // Assert
        statusandamento.Should().NotBeNull();
        statusandamento.ITableName().Should().Be("StatusAndamento");
        statusandamento.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set statusandamento.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        statusandamento.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        statusandamento.FNome = longString; // MAX: 80
        statusandamento.FGuid = longString; // MAX: 100
        // Assert - All properties should be set statusandamento.FNome.Should().HaveLength(80);
        statusandamento.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        statusandamento.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        statusandamento.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "sanCodigo = 1";
        // Act & Assert
        var StatusAndamento = new DBStatusAndamento(sqlWhere, null);
        StatusAndamento.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var statusandamento = new DBStatusAndamento(parameters, nome, null);
        // Assert
        statusandamento.Should().NotBeNull();
        statusandamento.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        statusandamento.FNome = longName;
        // Assert
        statusandamento.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBStatusAndamento).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var statusandamento = new DBStatusAndamento();
        // Act & Assert
        statusandamento.TabelaNome.Should().Be("StatusAndamento");
    }
