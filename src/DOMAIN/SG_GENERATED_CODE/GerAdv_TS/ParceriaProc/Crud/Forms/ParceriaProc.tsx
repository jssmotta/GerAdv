...
maxLength={2048}
            ...
            {isMobile && (
                ...
                <FooterIncDocker>
                   ...
                   <CopyButton
                    formId={`ParceriaProcForm-${parceriaprocData.id}`}
                  />
                   ...
                   <AuditorButton
                        ...
                        coolName='Parceria Proc'        
                        id={parceriaprocData.id}    
                      />

                    <DeleteButton page={'/pages/parceriaproc'} id={parceriaprocData.id} dadoApi={dadoApi} />
