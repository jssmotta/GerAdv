...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBViaRecebimento
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBViaRecebimentoUpdateAdvancedTests : IDisposable
{
    private readonly DBViaRecebimento _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBViaRecebimentoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBViaRecebimento
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBViaRecebimento).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBViaRecebimento).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBViaRecebimento instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBViaRecebimento).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBViaRecebimento.PTabelaNome.Should().Be("ViaRecebimento");
        DBViaRecebimento.CampoCodigo.Should().Be("vrbCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBViaRecebimento();
        dbRec.ID = 1;
