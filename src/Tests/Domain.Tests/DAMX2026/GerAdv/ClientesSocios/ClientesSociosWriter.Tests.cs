...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFClientesSocios.VerifySet(x => x.FDtNasc = DateOnly.Parse(clientessocios.DtNasc), Times.Once);
        ...
        _mockFClientesSocios.VerifySet(x => x.FDataContrato = DateOnly.Parse(clientessocios.DataContrato), Times.Once);
        ...
        _mockFClientesSocios.VerifySet(x => x.FRGDataExp = DateOnly.Parse(clientessocios.RGDataExp), Times.Once);
    ...
    public async Task WriteAsync_WithNull_DtNasc_ShouldNotSetFDtNasc()
    {
        ...
        // Assert
        _mockFClientesSocios.VerifySet(x => x.FDtNasc = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DataContrato_ShouldNotSetFDataContrato()
    {
        // Arrange
        var clientessocios = CreateValidClientesSociosModel();
        ...
        await _clientessociosWriter.WriteAsync(clientessocios, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFClientesSocios.VerifySet(x => x.FDataContrato = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_RGDataExp_ShouldNotSetFRGDataExp()
    {
        // Arrange
        var clientessocios = CreateValidClientesSociosModel();
        ...
        await _clientessociosWriter.WriteAsync(clientessocios, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFClientesSocios.VerifySet(x => x.FRGDataExp = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ClientesSociosWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.ClientesSocios CreateValidClientesSociosModel()
    {
