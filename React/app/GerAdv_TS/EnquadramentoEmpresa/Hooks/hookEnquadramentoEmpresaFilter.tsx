...
interface UseEnquadramentoEmpresaFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterEnquadramentoEmpresa | undefined | null,
  ) => Promise<void>;
}
...
interface UseEnquadramentoEmpresaFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterEnquadramentoEmpresa>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterEnquadramentoEmpresa>,
  ) => React.ReactNode;
...
export const useEnquadramentoEmpresaFilter = ({
  handleFetchWithFilter,
}: UseEnquadramentoEmpresaFilterProps): UseEnquadramentoEmpresaFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterEnquadramentoEmpresa>(
