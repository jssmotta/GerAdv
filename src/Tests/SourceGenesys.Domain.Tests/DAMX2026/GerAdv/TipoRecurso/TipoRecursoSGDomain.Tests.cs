...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("TipoRecurso", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("TipoRecurso", cadastro.ITableName());
        Assert.Equal("trcCodigo", cadastro.IFieldId());
        Assert.Equal("trcDescricao", cadastro.IFieldNameDescription());
        Assert.Equal("trc", cadastro.IPrefix());
    }
