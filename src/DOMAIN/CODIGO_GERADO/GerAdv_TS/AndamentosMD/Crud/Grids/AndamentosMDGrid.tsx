...
const AndamentosMDGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <AndamentosMDGridMobileComponent data={andamentosmd} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <AndamentosMDGridDesktopComponent data={andamentosmd} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
