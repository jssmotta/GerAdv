...
public partial class DBStatusHTrab
{
    ...
    /// </summary>
    public static async Task<DBStatusHTrab> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBStatusHTrab();
...
#if (!NOTSTORED_StatusHTrab)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFDescricao || pFldFResID;
