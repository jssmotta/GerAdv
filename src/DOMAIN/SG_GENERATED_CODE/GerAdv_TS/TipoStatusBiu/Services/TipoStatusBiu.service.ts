...
export interface ITipoStatusBiuService {
  ...
  filterVoice: (filtro?: FilterTipoStatusBiu, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class TipoStatusBiuService implements ITipoStatusBiuService {
  ...
  async filterVoice(filtro?: FilterTipoStatusBiu, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
