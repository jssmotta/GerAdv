...
public partial class DBStatusBiu
{
    ...
    [StringLength(1024, ErrorMessage = "A propriedade FNome da tabela StatusBiu deve ter no máximo 1024 caracteres.")]
    public string? FNome
    {
        ...
        set
        {
            ...
            if (pFldFNome)
            {
                ...
                m_FNome = trimmed.Length > 1024 ? trimmed.AsSpan(0, 1024).ToString() : trimmed;
            }
        }
    }
