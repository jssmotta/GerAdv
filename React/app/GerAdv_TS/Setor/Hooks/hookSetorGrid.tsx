...
// useSetorGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Setor
"use client";
...
export const useSetorGrid = ({
  ...
  const filterLogic = useCallback(
    (data: ISetor, filters: Record<string, any>) => {
