...
<style jsx global>{`
  .enquadramentoempresa-dropdown-popup-msi {
  ...
  .enquadramentoempresa-dropdown-popup-msi .k-list {
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
    background: white !important;
  ...
  .enquadramentoempresa-dropdown-popup-msi .k-list-item {
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
  ...
  .enquadramentoempresa-dropdown-popup-msi .k-list-item: hover {
    ...
    <div className={`${cssDado} inputCombobox input-container`}>
      <div className='comboboxLabel'>
        ...
        <div className='comboboxBox'>
          ...
          suggest={true}
          popupSettings={{
            className: 'enquadramentoempresa-dropdown-popup-msi'
          }}
          />
