...
interface EnquadramentoEmpresaFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-EnquadramentoEmpresa' : 'form-container5 form-container-EnquadramentoEmpresa'}>
       
            <form className='formInputCadInc' id={`EnquadramentoEmpresaForm-${enquadramentoempresaData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={enquadramentoempresaData} isSubmitting={isSubmitting} onClose={onClose} formId={`EnquadramentoEmpresaForm-${enquadramentoempresaData.id}`} preventPropagation={true} onSave={handleDirectSave} />
