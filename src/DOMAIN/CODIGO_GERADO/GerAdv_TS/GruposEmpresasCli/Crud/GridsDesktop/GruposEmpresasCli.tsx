...
interface GruposEmpresasCliGridProps {
  data: IGruposEmpresasCli[];
  onRowClick: (gruposempresascli: IGruposEmpresasCli) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const GruposEmpresasCliGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IGruposEmpresasCli, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='descricaogruposempresas' title='Grupos Empresas' sortable={false} filterable={false} />, /* Track G.01 */
...
{initialized && (
  ...
  className='grid-desktop-gruposempresascli'
