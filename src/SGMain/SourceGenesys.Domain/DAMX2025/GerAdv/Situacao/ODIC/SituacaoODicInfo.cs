...
public partial class DBSituacaoODicInfo : IODicInfo
{
    ...
    public static ImmutableArray<DBInfoSystem> List => [DBSituacaoDicInfo.SitParte_Int, DBSituacaoDicInfo.SitGUID, DBSituacaoDicInfo.SitParte_Opo, DBSituacaoDicInfo.SitTop, DBSituacaoDicInfo.SitBold, DBSituacaoDicInfo.SitQuemCad, DBSituacaoDicInfo.SitDtCad, DBSituacaoDicInfo.SitQuemAtu, DBSituacaoDicInfo.SitDtAtu, DBSituacaoDicInfo.SitVisto];
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBSituacaoDicInfo.SitParte_Int, DBSituacaoDicInfo.SitGUID, DBSituacaoDicInfo.SitParte_Opo, DBSituacaoDicInfo.SitTop];
