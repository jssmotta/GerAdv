...
interface ProcessOutPutIDsGridProps {
  data: IProcessOutPutIDs[];
  onRowClick: (processoutputids: IProcessOutPutIDs) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProcessOutPutIDsGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProcessOutPutIDs, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-processoutputids'
