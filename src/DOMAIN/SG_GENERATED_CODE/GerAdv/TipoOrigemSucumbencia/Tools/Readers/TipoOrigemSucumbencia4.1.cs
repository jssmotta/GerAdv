...
public partial class TipoOrigemSucumbenciaReader
{
    private static string BuildSqlQuery(string campos, string whereClause, string orderClause, int max, MsiSqlConnection? oCnn = null)
    {
        ...
        var orderQuery = $"{TSql.OrderBy} {DBTipoOrigemSucumbenciaDicInfo.CampoNome}";
        ...
        var query = $@"SELECT TOP ({max})
                   {campos}
                   FROM {DBTipoOrigemSucumbencia.PTabelaNome.dbo(oCnn)}
