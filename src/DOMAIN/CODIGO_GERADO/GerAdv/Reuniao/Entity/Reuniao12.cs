...
public partial class FReuniao : MenphisSI.SG.GerAdv.DBReuniao, IDBReuniao
{
    ...
    private FReuniao(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FReuniao CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FReuniao(parameters, oCnn, fullSql, sqlWhere, join);
    }
