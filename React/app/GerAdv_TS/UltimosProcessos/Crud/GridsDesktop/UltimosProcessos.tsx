...
interface UltimosProcessosGridProps {
  data: IUltimosProcessos[];
  onRowClick: (ultimosprocessos: IUltimosProcessos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const UltimosProcessosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IUltimosProcessos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-ultimosprocessos'
