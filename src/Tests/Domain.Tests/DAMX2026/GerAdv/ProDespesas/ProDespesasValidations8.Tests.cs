...
#region Class Structure Tests
    ...
    private void SetupValidMocks()
    {
        ...
        _mockProDespesasService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterProDespesas>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<ProDespesasResponseAll>>.Ok([]));
...
#region DataCorrecao Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithEmpty_DataCorrecao_ShouldPass()
    {
        // Arrange
        var prodespesas = CreateValidProDespesas();
