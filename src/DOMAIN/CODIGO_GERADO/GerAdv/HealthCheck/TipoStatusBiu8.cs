                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tsbCodigo) FROM {"TipoStatusBiu".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tsbNome FROM {"TipoStatusBiu".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
