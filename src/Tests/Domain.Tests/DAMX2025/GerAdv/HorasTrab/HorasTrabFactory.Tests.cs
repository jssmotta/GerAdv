...
public class FHorasTrabFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FHorasTrab>();
    }
    ...
    {
        // Arrange
        var factory = new FHorasTrabFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("htbCodigo", typeof(int));
        mockDataTable.Columns.Add("htbGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["htbCodigo"] = testId;
        row["htbGuid"] = "Test HorasTrab";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["htbCodigo"] = 123;
        row["htbGuid"] = "Test HorasTrab Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FHorasTrab properties
        }
    }
