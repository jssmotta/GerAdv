...
#region Tests Generics
    ...
    public void Read_WhenWhereIsNullOrEmptyOrWhitespace_ReturnsNull(string? where)
    {
        ...
        _mockAgendaFactory.Setup(f => f.CreateFromParameters(It.IsAny<List<SqlParameter>?>(), It.IsAny<MsiSqlConnection?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string>(), It.IsAny<string>())).Returns(new FAgenda { ID = 0, FData = null });
        // Act
        var result = _agendaReader.Read(where!, null, null);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FAgenda_NullInput_ReturnsNull()
    {
        // Act
        var result = _agendaReader.Read((FAgenda)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FAgenda_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
    ...
    [Fact]
    public void Read_DBAgenda_NullInput_ReturnsNull()
    {
        // Act
        var result = _agendaReader.Read((SG.GerAdv.DBAgenda)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_DBAgenda_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBAgenda
        {
            ID = 20,
            FData = null
        };
    ...
    [Fact]
    public void ReadAll_FAgenda_NullInput_ReturnsNull()
    {
        // Act
        var result = _agendaReader.ReadAll((FAgenda)null !, (IDataRecord)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_FAgenda_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
        var dbRec = new FAgenda
        {
        ...
        // Act
        var result = _agendaReader.ReadAll(dbRec, (IDataRecord)new Mock<IDataRecord>().Object);
        // Assert
        result.Should().NotBeNull();
    ...
    [Fact]
    public void ReadAll_DBAgenda_NullInput_ReturnsNull()
    {
        // Act
        var result = _agendaReader.ReadAll((SG.GerAdv.DBAgenda)null !, (DataRow)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_DBAgenda_WithNullData_MapsDataToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBAgenda
        {
        ...
        // Act
        var result = _agendaReader.ReadAll(dbRec, (DataRow)null !);
        // Assert
        result.Should().NotBeNull();
...
#region ListarN Tests
    ...
    public async Task ListarN_WithEmptyParameters_ShouldThrowInvalidOperationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => _agendaReader.ListarNAsync(max, uri, cWhere, parameters, order));
    }
