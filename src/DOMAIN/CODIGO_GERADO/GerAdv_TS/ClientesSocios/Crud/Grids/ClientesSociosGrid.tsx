...
const ClientesSociosGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <ClientesSociosGridMobileComponent data={clientessocios} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <ClientesSociosGridDesktopComponent data={clientessocios} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
