...
export const Apenso2GridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IApenso2, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-apenso2'
