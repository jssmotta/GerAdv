...
public class TipoProDespositoServiceTests : IDisposable
{
    ...
    public TipoProDespositoServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new TipoProDespositoService(_mockAppSettings.Object, _mockTipoProDespositoFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
