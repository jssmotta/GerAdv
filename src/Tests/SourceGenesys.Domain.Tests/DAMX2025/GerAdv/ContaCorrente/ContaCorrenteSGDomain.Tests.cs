...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FDtOriginal = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDtOriginal?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBContaCorrente();
        Assert.Equal(null !, instance.FDtOriginal);
    }
    ...
    {
        _instance.FDataPgto = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataPgto?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBContaCorrente();
        Assert.Equal(null !, instance.FDataPgto);
    }
