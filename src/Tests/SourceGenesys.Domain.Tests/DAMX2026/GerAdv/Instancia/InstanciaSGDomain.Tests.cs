...
public class DBInstanciaTests : IDisposable
{
    ...
    private DataTable CreateTestDataTable()
    {
        ...
        dt.Columns.Add("insData", typeof(DateTime));
...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("Instancia", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("Instancia", cadastro.ITableName());
        Assert.Equal("insCodigo", cadastro.IFieldId());
        Assert.Equal("insNroProcesso", cadastro.IFieldNameDescription());
        Assert.Equal("ins", cadastro.IPrefix());
    }
...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FZKeyQuando = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FZKeyQuando?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBInstancia();
        Assert.Equal(null !, instance.FZKeyQuando);
    }
