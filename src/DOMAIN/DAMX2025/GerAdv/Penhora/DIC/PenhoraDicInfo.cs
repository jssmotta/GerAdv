...
#region PropriedadesDaTabela
    public static DBInfoSystem PhrProcesso => new(0, PTabelaNome, CampoCodigo, Processo, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false)
    {
        Prefixo = "phr"
    }; // DBI 11 
    ...
    public static DBInfoSystem PhrPenhoraStatus => new(0, PTabelaNome, CampoCodigo, PenhoraStatus, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBPenhoraStatusDicInfo.CampoCodigo, DBPenhoraStatusDicInfo.TabelaNome, new DBPenhoraStatusODicInfo(), false)
    {
        Prefixo = "phr"
    }; // DBI 11 
    ...
    public static DBInfoSystem PhrQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false)
    {
        Prefixo = "phr"
    }; // DBI 11 
    ...
    public static DBInfoSystem PhrQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false)
    {
        Prefixo = "phr"
    }; // DBI 11 
