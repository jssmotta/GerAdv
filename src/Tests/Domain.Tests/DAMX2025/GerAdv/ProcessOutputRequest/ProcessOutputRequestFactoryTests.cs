...
public class FProcessOutputRequestFactoryTests : IDisposable
{
    private FProcessOutputRequestFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FProcessOutputRequestFactoryTests()
    {
        _factory = new FProcessOutputRequestFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FProcessOutputRequest>();
    }
    ...
    {
        // Arrange
        var factory = new FProcessOutputRequestFactory();
        // Act
        factory.Dispose();
