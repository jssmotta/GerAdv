...
export interface IOponentesRepLegalService {
  ...
  filterVoice: (filtro?: FilterOponentesRepLegal, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class OponentesRepLegalService implements IOponentesRepLegalService {
  ...
  async filterVoice(filtro?: FilterOponentesRepLegal, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
