...
// useStatusTarefasGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de StatusTarefas
"use client";
...
interface UseStatusTarefasGridProps {
  data: IStatusTarefas[];
...
export const useStatusTarefasGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IStatusTarefas, filters: Record<string, any>) => {
