...
interface ClientesSociosGridProps {
  ...
  onRowClick: (clientessocios: IClientesSocios) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ClientesSociosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IClientesSocios, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-clientessocios'
