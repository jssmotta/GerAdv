...
#region TableDefinition_TipoStatusBiu
...
#endregion
    public DBTipoStatusBiu(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBTipoStatusBiu(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBTipoStatusBiu(in string? sqlWhere, SqlConnection? oCnn)
    {
