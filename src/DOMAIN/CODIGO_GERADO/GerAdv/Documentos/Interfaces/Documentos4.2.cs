...
public partial interface IDocumentosReader
{
    ...
    Task<IEnumerable<DocumentosResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}