...
export const PenhoraGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IPenhora, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nomepenhorastatus' title='Penhora Status' sortable={false} filterable={false} />, /* Track G.01 */
  <GridColumn
  field='id'
  width={'55px'}
  title='Excluir'
...
{initialized && (
  ...
  className='grid-desktop-penhora'
