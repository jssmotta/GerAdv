...
public class DBBensClassificacaoUpdate : IDisposable
{
    private readonly DBBensClassificacao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBBensClassificacaoUpdate()
    {
    ...
    {
        // Act
        var bensclassificacao = new DBBensClassificacao();
        // Assert
        bensclassificacao.Should().NotBeNull();
        bensclassificacao.ITableName().Should().Be("BensClassificacao");
        bensclassificacao.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set bensclassificacao.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        bensclassificacao.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        bensclassificacao.FNome = longString; // MAX: 80
        bensclassificacao.FGuid = longString; // MAX: 100
        // Assert - All properties should be set bensclassificacao.FNome.Should().HaveLength(80);
        bensclassificacao.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        bensclassificacao.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        bensclassificacao.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "bcsCodigo = 1";
        // Act & Assert
        var BensClassificacao = new DBBensClassificacao(sqlWhere, null);
        BensClassificacao.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var bensclassificacao = new DBBensClassificacao(parameters, nome, null);
        // Assert
        bensclassificacao.Should().NotBeNull();
        bensclassificacao.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        bensclassificacao.FNome = longName;
        // Assert
        bensclassificacao.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBBensClassificacao).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var bensclassificacao = new DBBensClassificacao();
        // Act & Assert
        bensclassificacao.TabelaNome.Should().Be("BensClassificacao");
    }
