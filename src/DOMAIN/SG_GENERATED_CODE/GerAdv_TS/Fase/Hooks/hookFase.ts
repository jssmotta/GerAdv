...
export const useFaseList = (dataService: IFaseService, currentFilter?: FilterFase | undefined | null) => {
  ...
  const fetchData = useCallback(async (filtro?: FilterFase | undefined | null) => {
