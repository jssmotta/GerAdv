...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFLigacoes.VerifySet(x => x.FDataRealizada = DateOnly.Parse(ligacoes.DataRealizada), Times.Once);
        ...
        _mockFLigacoes.VerifySet(x => x.FUltimoAviso = DateOnly.Parse(ligacoes.UltimoAviso), Times.Once);
        _mockFLigacoes.VerifySet(x => x.FHoraFinal = TimeOnly.Parse(ligacoes.HoraFinal), Times.Once);
        ...
        _mockFLigacoes.VerifySet(x => x.FData = DateOnly.Parse(ligacoes.Data), Times.Once);
        _mockFLigacoes.VerifySet(x => x.FHora = TimeOnly.Parse(ligacoes.Hora), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_DataRealizada_ShouldNotSetFDataRealizada()
    {
        // Arrange
        var ligacoes = CreateValidLigacoesModel();
        ...
        // Assert
        _mockFLigacoes.VerifySet(x => x.FDataRealizada = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_UltimoAviso_ShouldNotSetFUltimoAviso()
    {
        // Arrange
        var ligacoes = CreateValidLigacoesModel();
        ...
        await _ligacoesWriter.WriteAsync(ligacoes, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFLigacoes.VerifySet(x => x.FUltimoAviso = It.IsAny<DateOnly>(), Times.Never);
    }
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        await _ligacoesWriter.WriteAsync(ligacoes, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFLigacoes.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new LigacoesWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Ligacoes CreateValidLigacoesModel()
    {
