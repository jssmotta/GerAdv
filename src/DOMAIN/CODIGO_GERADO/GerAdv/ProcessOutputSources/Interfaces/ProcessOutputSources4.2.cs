...
public partial interface IProcessOutputSourcesReader
{
    ...
    Task<IEnumerable<ProcessOutputSourcesResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}