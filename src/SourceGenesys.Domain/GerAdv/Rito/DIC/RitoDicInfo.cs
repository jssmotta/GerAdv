...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem RitGUID => new(0, PTabelaNome, CampoCodigo, GUID, 100, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "rit"
    };
