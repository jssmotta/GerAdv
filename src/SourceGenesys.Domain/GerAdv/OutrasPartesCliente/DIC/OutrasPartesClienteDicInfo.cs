...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem OpcGUID => new(0, PTabelaNome, CampoCodigo, GUID, 150, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "opc"
    };
