                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(terCodigo) FROM {"Terceiros".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) terProcesso,terNome,terSituacao,terCidade,terEndereco,terBairro,terCEP,terFone,terFax,terOBS,terEMail,terClass,terVaraForoComarca,terSexo,terBold,terGuid FROM {"Terceiros".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
