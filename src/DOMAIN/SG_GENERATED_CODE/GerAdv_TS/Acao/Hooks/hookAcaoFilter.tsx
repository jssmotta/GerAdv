...
interface UseAcaoFilterProps {
    handleFetchWithFilter: (filtro?: FilterAcao | undefined | null) => Promise<void>;
}
...
export const useAcaoFilter = ({ handleFetchWithFilter }: UseAcaoFilterProps): UseAcaoFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterAcao>({} as FilterAcao);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterAcao;
