...
export interface IProResumosService {
  ...
  filterVoice: (filtro?: FilterProResumos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ProResumosService implements IProResumosService {
  ...
  async filterVoice(filtro?: FilterProResumos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
