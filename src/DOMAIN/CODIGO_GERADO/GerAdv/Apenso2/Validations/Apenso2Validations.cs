...
{
    public async Task<bool> CanDelete(int id, IApenso2Service service, [FromRoute, Required] string uri, MsiSqlConnection oCnn)
    {
        if (id <= 0)
    ...
    private bool ValidSizes(Models.Apenso2 reg)
    {
        return true;
    }
