...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBOperadorGrupos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBOperadorGruposUpdateAdvancedTests : IDisposable
{
    private readonly DBOperadorGrupos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBOperadorGruposUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBOperadorGrupos
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBOperadorGrupos).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBOperadorGrupos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBOperadorGrupos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBOperadorGrupos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBOperadorGrupos.PTabelaNome.Should().Be("OperadorGrupos");
        DBOperadorGrupos.CampoCodigo.Should().Be("opgCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBOperadorGrupos();
        dbRec.ID = 1;
