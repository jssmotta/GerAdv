  ...
  ({
    ...
    const SearchFromCellFase = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellFase(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Fase">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const SearchFromCellObjetos = (props: any) => {
      return (
        <>
          <td>
            <div onClick={() => openSearchCellObjetos(props.dataItem.id)}>
              <span title="Pesquisar relacionados em Objetos">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const resetColumnsOrder = useCallback(() => {
      ...
      localStorage.removeItem(btoa("area-columns-order-mobile"));
    }, []);
