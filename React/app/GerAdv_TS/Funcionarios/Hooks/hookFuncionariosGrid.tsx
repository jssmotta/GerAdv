...
// useFuncionariosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Funcionarios
"use client";
...
interface UseFuncionariosGridProps {
  data: IFuncionarios[];
...
export const useFuncionariosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IFuncionarios, filters: Record<string, any>) => {
