                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAndCompDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(acpCodigo) FROM dbo.AndComp (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) acpAndamento,acpCompromisso FROM dbo.AndComp (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
