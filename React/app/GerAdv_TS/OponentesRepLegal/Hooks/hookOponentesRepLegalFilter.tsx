...
interface UseOponentesRepLegalFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterOponentesRepLegal | undefined | null,
  ) => Promise<void>;
}
...
interface UseOponentesRepLegalFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterOponentesRepLegal>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterOponentesRepLegal>,
  ) => React.ReactNode;
...
export const useOponentesRepLegalFilter = ({
  handleFetchWithFilter,
}: UseOponentesRepLegalFilterProps): UseOponentesRepLegalFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterOponentesRepLegal>(
