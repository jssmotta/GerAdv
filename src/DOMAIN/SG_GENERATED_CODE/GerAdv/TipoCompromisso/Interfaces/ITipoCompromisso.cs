...
public partial interface ITipoCompromissoService
{
    ...
    Task<Filters.FilterTipoCompromisso> FilterVoice([FromBody] Filters.FilterTipoCompromisso filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
