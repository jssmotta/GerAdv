...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem BmtFornecedor => new(0, PTabelaNome, CampoCodigo, Fornecedor, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBFornecedoresDicInfo.CampoCodigo, DBFornecedoresDicInfo.TabelaNome, new DBFornecedoresODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem BmtCidade => new(0, PTabelaNome, CampoCodigo, Cidade, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBCidadeDicInfo.CampoCodigo, DBCidadeDicInfo.TabelaNome, new DBCidadeODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem BmtQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem BmtQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string BensClassificacaoDiff(int id) => BensClassificacao.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string BensClassificacaoSql(int id) => BensClassificacao.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string BensClassificacaoIsNull => BensClassificacao.SqlCmdIsNull() ?? string.Empty;
    public static string BensClassificacaoNotIsNull => BensClassificacao.SqlCmdNotIsNull() ?? string.Empty;
    ...
    public static string FornecedorDiff(int id) => Fornecedor.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string FornecedorSql(int id) => Fornecedor.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string FornecedorIsNull => Fornecedor.SqlCmdIsNull() ?? string.Empty;
    public static string FornecedorNotIsNull => Fornecedor.SqlCmdNotIsNull() ?? string.Empty;
