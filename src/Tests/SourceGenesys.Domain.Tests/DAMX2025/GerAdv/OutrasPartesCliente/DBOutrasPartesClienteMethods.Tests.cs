...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBOutrasPartesCliente
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBOutrasPartesClienteUpdateAdvancedTests : IDisposable
{
    private readonly DBOutrasPartesCliente _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBOutrasPartesClienteUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBOutrasPartesCliente
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBOutrasPartesCliente).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBOutrasPartesCliente).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBOutrasPartesCliente instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBOutrasPartesCliente).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBOutrasPartesCliente.PTabelaNome.Should().Be("OutrasPartesCliente");
        DBOutrasPartesCliente.CampoCodigo.Should().Be("opcCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBOutrasPartesCliente();
        dbRec.ID = 1;
