...
#region Class Structure Tests
    ...
    private static GerAdv.Models.Foro CreateValidForo()
    {
        return new GerAdv.Models.Foro
        {
            Id = 1,
    ...
    private void SetupValidMocks()
    {
        ...
        _mockForoService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterForo>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<ForoResponseAll>>.Ok([]));
