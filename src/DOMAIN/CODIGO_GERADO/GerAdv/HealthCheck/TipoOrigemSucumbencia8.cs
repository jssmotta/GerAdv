                ...
                try
                {
                    ...
                    try
                    {
                        if (DBTipoOrigemSucumbenciaDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(tosCodigo) FROM dbo.TipoOrigemSucumbencia (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) tosNome FROM dbo.TipoOrigemSucumbencia (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
