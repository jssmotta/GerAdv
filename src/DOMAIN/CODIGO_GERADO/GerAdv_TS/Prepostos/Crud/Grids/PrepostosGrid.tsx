...
const PrepostosGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <PrepostosGridMobileComponent data={prepostos} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <PrepostosGridDesktopComponent data={prepostos} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
