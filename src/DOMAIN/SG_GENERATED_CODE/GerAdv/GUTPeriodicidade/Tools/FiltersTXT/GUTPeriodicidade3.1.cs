...
public static class FilterGUTPeriodicidadeTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar GUTPeriodicidade em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterGUTPeriodicidade:

- O filter irá filtrar os GUTPeriodicidade conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
- Se ouvir "todos os GUTPeriodicidade" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterGUTPeriodicidade? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt GUTPeriodicidade length: {result.Length}");
#endif
