...
public partial class DBViaRecebimento
{
    ...
    /// </summary>
    public static async Task<DBViaRecebimento> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBViaRecebimento();
    ...
    {
        if (pFldFNome)
            updateTool.Fields(DBViaRecebimentoDicInfo.Nome, FNome, EGenericTypeFields.FString);
    }
