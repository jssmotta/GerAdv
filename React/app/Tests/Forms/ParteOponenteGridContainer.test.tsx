...
// ParteOponenteGridContainer.test.tsx
import React from 'react';
import { render, screen } from '@testing-library/react';
import { IGridComponent } from '@/app/interfaces/IGridComponent';
import ParteOponenteGridContainer from '@/app/GerAdv_TS/ParteOponente/Components/ParteOponenteGridContainer';
describe('ParteOponenteGridContainer', () => {
  it('renders the grid component output', () => {
    ...
    render(<ParteOponenteGridContainer grid={mockGrid} />);
