                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(sanCodigo) FROM {"StatusAndamento".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) sanNome,sanIcone,sanBold,sanGuid FROM {"StatusAndamento".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
