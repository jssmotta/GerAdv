...
public class GUTPeriodicidadeReaderTests : IDisposable
{
    ...
    public GUTPeriodicidadeReaderTests(ITestOutputHelper output)
    {
        _output = output;
        ...
        _gutperiodicidadeReader = new GUTPeriodicidadeReader(_mockGUTPeriodicidadeFactory.Object); //, _mockConnectionService.Object);
    }
...
#region Tests Generics
    ...
    public void Read_WhenWhereIsNullOrEmptyOrWhitespace_ReturnsNull(string? where)
    {
        ...
        _mockGUTPeriodicidadeFactory.Setup(f => f.CreateFromParameters(It.IsAny<List<SqlParameter>?>(), It.IsAny<MsiSqlConnection?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<string>(), It.IsAny<string>())).Returns(new FGUTPeriodicidade { ID = 0, FNome = null });
        // Act
        var result = _gutperiodicidadeReader.Read(where!, null, null);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FGUTPeriodicidade_NullInput_ReturnsNull()
    {
        // Act
        var result = _gutperiodicidadeReader.Read((FGUTPeriodicidade)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_FGUTPeriodicidade_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
    ...
    [Fact]
    public void Read_DBGUTPeriodicidade_NullInput_ReturnsNull()
    {
        // Act
        var result = _gutperiodicidadeReader.Read((SG.GerAdv.DBGUTPeriodicidade)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void Read_DBGUTPeriodicidade_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBGUTPeriodicidade
        {
            ID = 20,
            FNome = null
        };
    ...
    [Fact]
    public void ReadAll_FGUTPeriodicidade_NullInput_ReturnsNull()
    {
        // Act
        var result = _gutperiodicidadeReader.ReadAll((FGUTPeriodicidade)null !, (IDataRecord)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_FGUTPeriodicidade_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
        var dbRec = new FGUTPeriodicidade
        {
        ...
        // Act
        var result = _gutperiodicidadeReader.ReadAll(dbRec, (IDataRecord)new Mock<IDataRecord>().Object);
        // Assert
        result.Should().NotBeNull();
    ...
    [Fact]
    public void ReadAll_DBGUTPeriodicidade_NullInput_ReturnsNull()
    {
        // Act
        var result = _gutperiodicidadeReader.ReadAll((SG.GerAdv.DBGUTPeriodicidade)null !, (DataRow)null !);
        // Assert
        result.Should().BeNull();
    }

    [Fact]
    public void ReadAll_DBGUTPeriodicidade_WithNullNome_MapsNomeToEmptyString()
    {
        // Arrange
        var dbRec = new SG.GerAdv.DBGUTPeriodicidade
        {
        ...
        // Act
        var result = _gutperiodicidadeReader.ReadAll(dbRec, (DataRow)null !);
        // Assert
        result.Should().NotBeNull();
...
#region ListarN Tests
    ...
    public async Task ListarN_WithValidParameters_ShouldReturnResults()
    {
        ...
        try
        {
            var result = await _gutperiodicidadeReader.ListarNAsync(max, uri, cWhere, parameters, order);
    ...
    public async Task ListarN_WithEmptyParameters_ShouldThrowInvalidOperationException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => _gutperiodicidadeReader.ListarNAsync(max, uri, cWhere, parameters, order));
    }
...
#region Read Tests with ID and Connection
    ...
    public async Task Read_WithValidId_ShouldReturnGUTPeriodicidadeResponse()
    {
        ...
        // Act
        var result = await _gutperiodicidadeReader.ReadAsync(id, _mockConnection.Object);
        // Assert
        result.Should().NotBeNull();
...
#region ReadM Tests
    ...
    public async Task ReadM_WithValidId_ShouldReturnGUTPeriodicidadeModel()
    {
        ...
        // Act
        var result = await _gutperiodicidadeReader.ReadMAsync(id, _mockConnection.Object);
        // Assert
        result.Should().NotBeNull();
        result?.Id.Should().Be(id);
        result?.Nome.Should().Be("AAAAAAAAAAAAAAAAAA");
...
#region Edge Cases and Error Handling Tests
    ...
    public async Task Read_WithFactoryException_ShouldPropagateException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() => _gutperiodicidadeReader.ReadAsync(id, _mockConnection.Object));
    ...
    public async Task ReadM_WithFactoryException_ShouldPropagateException()
    {
        ...
        _mockGUTPeriodicidadeFactory.Setup(x => x.CreateFromIdAsync(id, _mockConnection.Object)).ThrowsAsync(expectedException);
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() => _gutperiodicidadeReader.ReadMAsync(id, _mockConnection.Object));
        exception.Should().Be(expectedException);
    }
...
#region Async Behavior Tests
    ...
    public async Task AsyncMethods_ShouldCompleteWithoutBlocking()
    {
        ...
        var readTask = _gutperiodicidadeReader.ReadAsync(id, _mockConnection.Object);
        var readMTask = _gutperiodicidadeReader.ReadMAsync(id, _mockConnection.Object);
...
#region Parameter Validation Tests
    ...
    public async Task Read_WithNullConnection_ShouldHandleGracefully()
    {
        ...
        try
        {
            await _gutperiodicidadeReader.ReadAsync(id, null !);
        }
        catch (Exception ex)
        {
            ex.Should().NotBeNull();
    ...
    public async Task ReadM_WithNullConnection_ShouldHandleGracefully()
    {
        ...
        try
        {
            await _gutperiodicidadeReader.ReadMAsync(id, null !);
        }
        catch (Exception ex)
        {
            ex.Should().NotBeNull();
