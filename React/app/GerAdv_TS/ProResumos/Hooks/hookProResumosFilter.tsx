...
interface UseProResumosFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterProResumos | undefined | null,
  ) => Promise<void>;
}
...
interface UseProResumosFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterProResumos>,
  ) => React.ReactNode;
...
export const useProResumosFilter = ({
  handleFetchWithFilter,
}: UseProResumosFilterProps): UseProResumosFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterProResumos>(
    {} as FilterProResumos,
  );
