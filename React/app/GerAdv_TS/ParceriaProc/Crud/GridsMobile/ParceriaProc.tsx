...
export const ParceriaProcGridMobileComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IParceriaProc, filters: Record<string, any>) => {
...
<>
<Grid
className='grid-mobile-parceriaproc'
