...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='nometipoorigemsucumbencia' title='Tipo Origem Sucumbencia' sortable={false} filterable={false} />, /* Track G.01 */
  <GridColumn
  field='id'
  width={'55px'}
  title='Excluir'
...
{initialized && (
  ...
  className='grid-desktop-prosucumbencia'
