...
export const useAreaList = (dataService: IAreaService, currentFilter?: FilterArea | undefined | null) => {
  ...
  const fetchData = useCallback(async (filtro?: FilterArea | undefined | null) => {
