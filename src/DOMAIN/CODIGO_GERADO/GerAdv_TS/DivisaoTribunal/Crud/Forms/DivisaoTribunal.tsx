...
if (getParamFromUrl("tribunal") > 0) {
 ...
 const addValorTribunal = (e: any) => {
  ...
  const onPressSalvar = (e: any) => {
    e.preventDefault();
    if (!isSubmitting) {
      const formElement = document.getElementById('DivisaoTribunalForm');
  ...
  <>
        ...
        <div className="form-container">
            ...
            <form id={`DivisaoTribunalForm-${divisaotribunalData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={divisaotribunalData} isSubmitting={isSubmitting} onClose={onClose} formId={`DivisaoTribunalForm-${divisaotribunalData.id}`} />
