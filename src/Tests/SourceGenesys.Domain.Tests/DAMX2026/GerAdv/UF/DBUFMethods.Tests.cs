...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBUF
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBUFUpdateAdvancedTests : IDisposable
{
    private readonly DBUF _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBUFUpdateAdvancedTests()
    {
        _instance = new DBUF();
...
#region Business Logic Tests
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBUF
            {
                ID = 0,
                FID = $"N{i}"};
            var fieldInfo = typeof(DBUF).GetField("pFldFID", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void Update_WithValid_ID_Values_ShouldNotThrow(string nome)
    {
        // Arrange
        _instance.ID = 0;
        _instance.FID = nome;
    ...
    [Fact]
    public void Update_BusinessRule_Empty_ID_ShouldEnforceValidation()
    {
        // Arrange
        _instance.ID = 1;
        _instance.FID = "";
    ...
    public void Update_WithMinimumValidData_ShouldWork()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FID = "A"; // Minimum valid name
    ...
    [Fact]
    public void Update_BusinessRule_ValidID_ShouldPassValidation()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FID = "AA";
        SetFieldChanged("pFldFID", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBUF).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBUF instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBUF).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#endregion
#region Empty ID Validation Tests
#endregion
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        _instance.ID = 1;
        _instance.FID = "AA";
        // Ensure pFldFID is false (no changes)
        var fieldInfo = typeof(DBUF).GetField("pFldFID", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBUF.PTabelaNome.Should().Be("UF");
        DBUF.CampoCodigo.Should().Be("ufCodigo");
    }
...
#region Integration-like Tests
...
#endregion
    [Fact]
    public void Update_Boundary_MaxLengthID()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FID = new string ('A', 4); // Maximum length
        SetFieldChanged("pFldFID", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FID.Length.Should().Be(4);
    }

    [Fact]
    public void Update_Boundary_MinimumValidID()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FID = "A"; // Minimum valid length
        SetFieldChanged("pFldFID", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FID.Should().Be("A");
    }
    ...
    [InlineData("\t", null)]
    [InlineData("\n", null)]
    public void Update_ErrorScenario_InvalidIDValues_ShouldThrowException(string? invalidID, int? retValue)
    {
        // Arrange
        using var dbRec = new DBUF();
        dbRec.ID = 1;
        dbRec.FID = invalidID;
        int? result = null;
        // Act & Assert
    ...
    [Fact]
    public void Update_WithMaxLengthID_ShouldBeHandledCorrectly()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FID = new string ('A', 4); // Max length for ID
        int? result = null;
        // Act
        var exception = Record.Exception(() => result = _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    ...
    [Fact]
    public void Update_WithWhitespaceOnlyID_ShouldThrowException()
    {
        // Arrange
        _instance.FID = "   ";
        _instance.ID = 1;
    ...
    [Fact]
    public void Update_WithEmptyID_ShouldThrowException()
    {
        // Arrange
        _instance.FID = "";
        _instance.ID = 1;
