                ...
                try
                {
                    ...
                    try
                    {
                        if (DBApensoDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(apeCodigo) FROM dbo.Apenso (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) apeProcesso,apeApenso,apeAcao,apeDtDist,apeOBS,apeValorCausa FROM dbo.Apenso (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
