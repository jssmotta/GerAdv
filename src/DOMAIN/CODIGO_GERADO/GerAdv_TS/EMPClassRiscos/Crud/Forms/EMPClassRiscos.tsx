...
interface EMPClassRiscosFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-EMPClassRiscos' : 'form-container5 form-container-EMPClassRiscos'}>
       
            <form className='formInputCadInc' id={`EMPClassRiscosForm-${empclassriscosData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={empclassriscosData} isSubmitting={isSubmitting} onClose={onClose} formId={`EMPClassRiscosForm-${empclassriscosData.id}`} preventPropagation={true} onSave={handleDirectSave} />
