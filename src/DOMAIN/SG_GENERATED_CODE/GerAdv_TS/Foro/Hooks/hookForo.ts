...
export const useForoList = (dataService: IForoService, currentFilter?: FilterForo | undefined | null) => {
  ...
  const fetchData = useCallback(async (filtro?: FilterForo | undefined | null) => {
