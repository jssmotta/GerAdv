...
public partial interface IProTipoBaixaService
{
    ...
    Task<Filters.FilterProTipoBaixa> FilterVoice([FromBody] Filters.FilterProTipoBaixa filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
