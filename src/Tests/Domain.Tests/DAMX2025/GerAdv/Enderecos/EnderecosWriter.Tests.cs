...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFEnderecos.VerifySet(x => x.FDtNasc = DateOnly.Parse(enderecos.DtNasc), Times.Once);
    ...
    public async Task WriteAsync_WithNull_DtNasc_ShouldNotSetFDtNasc()
    {
        ...
        // Assert
        _mockFEnderecos.VerifySet(x => x.FDtNasc = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new EnderecosWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Enderecos CreateValidEnderecosModel()
    {
