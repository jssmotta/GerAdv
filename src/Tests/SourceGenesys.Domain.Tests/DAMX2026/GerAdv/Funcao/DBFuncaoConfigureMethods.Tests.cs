...
/// <summary>
/// Comprehensive unit tests for ConfigureUpdateFields and ConfigureAuditorFields methods in DBFuncao class
...
/// </summary>
public class DBFuncaoConfigureMethodsTests : IDisposable
{
    private readonly DBFuncao _funcao;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBFuncaoConfigureMethodsTests()
    {
        _funcao = new DBFuncao();
    ...
    public void ConfigureUpdateFields_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        // Arrange
        ResetAllFieldFlags();
        _funcao.ID = 1; // Update scenario
        // Act
        var result = _funcao.Update(_mockConnection.Object);
    ...
    public async Task ConfigureUpdateFieldsAsync_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        ...
        try
        {
            var result = await _funcao.UpdateAsync(_mockConnection.Object);
...
#region Helper Methods
    ...
    {
        var field = typeof(DBFuncao).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
        field?.SetValue(_funcao, value);
    }
    ...
    private void SetFieldValue(string fieldName, object? value)
    {
        ...
        {
            field?.SetValue(_funcao, Convert.ToDateTime(value));
        }
    }
...
#region Fields_All
    ...
    public void ConfigureUpdateFields_WithDescricaoFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _funcao.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _funcao.Update(_mockConnection.Object));
    ...
    public async Task ConfigureUpdateFieldsAsync_WithDescricaoFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _funcao.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _funcao.UpdateAsync(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncDescricao_WithCancellationToken_ShouldRespectCancellation()
    {
        ...
        var exception = await Record.ExceptionAsync(async () => await _funcao.UpdateAsync(_mockConnection.Object, cancellationToken: cts.Token));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncDescricao_WithTimeout_ShouldRespectTimeout()
    {
        ...
        _funcao.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _funcao.UpdateAsync(_mockConnection.Object, timeoutSeconds: 1));
        exception.Should().NotBeNull();
    }
    ...
    {
        // Arrange
        _funcao.ID = 123; // Update scenario
        _funcao.AuditorQuem = 7;
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection but audit fields should be set
        var exception = Record.Exception(() => _funcao.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _funcao.AuditorQuem.Should().Be(7);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WhenAuditorQuemIsZero_ShouldSetToDefaultValue()
    {
        // Arrange
        _funcao.ID = 0; // Insert scenario
        _funcao.AuditorQuem = 0; // Should be set to 1
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _funcao.Update(_mockConnection.Object));
        ...
        _funcao.AuditorQuem.Should().Be(1);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WhenAuditorQuemHasValue_ShouldPreserveValue(int auditorValue)
    {
        // Arrange
        _funcao.ID = 0; // Insert scenario
        _funcao.AuditorQuem = auditorValue;
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _funcao.Update(_mockConnection.Object));
        ...
        _funcao.AuditorQuem.Should().Be(auditorValue);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WithZeroID_ShouldBeConsideredInsert()
    {
        ...
        _funcao.AuditorQuem.Should().Be(10);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WithNonZeroID_ShouldBeConsideredUpdate(int id)
    {
        ...
        _funcao.AuditorQuem.Should().Be(15);
    }
    ...
    public void ConfigureMethodsDescricao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        SetAllFieldValues();
        _funcao.ID = 123;
        _funcao.AuditorQuem = 99;
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _funcao.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _funcao.FDescricao.Should().Be("");
        _funcao.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureFieldsDescricao_Integration_FieldChangeTracking_ShouldWorkCorrectly()
    {
        ...
        var result1 = _funcao.Update(_mockConnection.Object);
