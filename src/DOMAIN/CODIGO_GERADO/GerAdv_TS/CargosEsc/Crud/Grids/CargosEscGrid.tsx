...
const CargosEscGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <CargosEscGridMobileComponent data={cargosesc} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> :
           <CargosEscGridDesktopComponent data={cargosesc} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} setSelectedId={setSelectedId}  /> }       
