...
public partial class FHonorariosDadosContrato : MenphisSI.SG.GerAdv.DBHonorariosDadosContrato, IDBHonorariosDadosContrato
{
    // DI-compatible default constructor
    public FHonorariosDadosContrato() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FHonorariosDadosContrato CreateFromReader(SqlDataReader? dbRec)
    {
        return new FHonorariosDadosContrato(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FHonorariosDadosContrato CreateFromDataRow(DataRow? dbRec)
    {
        return new FHonorariosDadosContrato(dbRec);
    }

    private FHonorariosDadosContrato(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FHonorariosDadosContrato(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    private FHonorariosDadosContrato(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FHonorariosDadosContrato CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FHonorariosDadosContrato(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
