...
public class DBStatusTarefasUpdate : IDisposable
{
    private readonly DBStatusTarefas _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusTarefasUpdate()
    {
    ...
    {
        // Act
        var statustarefas = new DBStatusTarefas();
        // Assert
        statustarefas.Should().NotBeNull();
        statustarefas.ITableName().Should().Be("StatusTarefas");
        statustarefas.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set statustarefas.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        statustarefas.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        statustarefas.FNome = longString; // MAX: 80
        statustarefas.FGuid = longString; // MAX: 100
        // Assert - All properties should be set statustarefas.FNome.Should().HaveLength(80);
        statustarefas.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        statustarefas.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        statustarefas.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "sttCodigo = 1";
        // Act & Assert
        var StatusTarefas = new DBStatusTarefas(sqlWhere, null);
        StatusTarefas.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var statustarefas = new DBStatusTarefas(parameters, nome, null);
        // Assert
        statustarefas.Should().NotBeNull();
        statustarefas.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        statustarefas.FNome = longName;
        // Assert
        statustarefas.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBStatusTarefas).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var statustarefas = new DBStatusTarefas();
        // Act & Assert
        statustarefas.TabelaNome.Should().Be("StatusTarefas");
    }
