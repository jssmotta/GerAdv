                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAgendaRepetirDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(rptCodigo) FROM {"AgendaRepetir".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) rptAdvogado,rptCliente,rptDataFinal,rptFuncionario,rptHoraFinal,rptProcesso,rptPessoal,rptFrequencia,rptDia,rptMes,rptHora,rptIDQuem,rptIDQuem2,rptMensagem,rptIDTipo,rptID1,rptID2,rptID3,rptID4,rptSegunda,rptQuarta,rptQuinta,rptSexta,rptSabado,rptDomingo,rptTerca FROM {"AgendaRepetir".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
