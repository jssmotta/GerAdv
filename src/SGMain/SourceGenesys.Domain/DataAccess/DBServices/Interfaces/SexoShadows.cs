...
/// </summary>
[Serializable]
public class VSexoShadows : XCodeIdBaseShadows
{
    ...
    private protected string? m_FCPF, m_FClass, m_FNome, m_FBairro, m_FEndereco, m_FCEP;
    ...
    public string FDtNasc
    {
        ...
        set { (var setUpNow, var changed, var data) = DevourerOne.DateUp12(pFldFDtNasc, m_FDtNasc, value); if (!setUpNow) return; pFldFDtNasc = changed; m_FDtNasc = data; }
    }
    /// <summary>
    /// Campo: advSexo
    /// </summary>
    ...
    public string FBairro
    {
        ...
        set
        {
            ...
            if (pFldFBairro) m_FBairro = value.FixAbc(50); // ABC_FIND_CODE
                                                           //if (string.IsNullOrEmpty(value))
                                                           //{
    ...
    public string NomeNegritarWeb => m_FBold ? $"<b>{m_FNome}</b>" : m_FNome ?? string.Empty;
}
