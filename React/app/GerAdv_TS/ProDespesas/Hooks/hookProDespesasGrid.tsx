...
// useProDespesasGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProDespesas
"use client";
...
interface UseProDespesasGridProps {
  data: IProDespesas[];
...
export const useProDespesasGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IProDespesas, filters: Record<string, any>) => {
