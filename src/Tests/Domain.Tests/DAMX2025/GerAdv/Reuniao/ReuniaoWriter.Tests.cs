...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFReuniao.VerifySet(x => x.FData = DateOnly.Parse(reuniao.Data), Times.Once);
        _mockFReuniao.VerifySet(x => x.FPauta = reuniao.Pauta, Times.Once);
        _mockFReuniao.VerifySet(x => x.FATA = reuniao.ATA, Times.Once);
        _mockFReuniao.VerifySet(x => x.FHoraInicial = TimeOnly.Parse(reuniao.HoraInicial), Times.Once);
        _mockFReuniao.VerifySet(x => x.FHoraFinal = TimeOnly.Parse(reuniao.HoraFinal), Times.Once);
        _mockFReuniao.VerifySet(x => x.FExterna = reuniao.Externa, Times.Once);
        _mockFReuniao.VerifySet(x => x.FHoraSaida = TimeOnly.Parse(reuniao.HoraSaida), Times.Once);
        _mockFReuniao.VerifySet(x => x.FHoraRetorno = TimeOnly.Parse(reuniao.HoraRetorno), Times.Once);
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        // Assert
        _mockFReuniao.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ReuniaoWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Reuniao CreateValidReuniaoModel()
    {
