...
// useTipoProDespositoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoProDesposito
"use client";
...
interface UseTipoProDespositoGridProps {
...
export const useTipoProDespositoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ITipoProDesposito, filters: Record<string, any>) => {
