...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem HdcProcesso => new(0, PTabelaNome, CampoCodigo, Processo, "Processo", "Processo", ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false)
    {
        Prefixo = "hdc"
    }; // DBI 11 
    ...
    public static DBInfoSystem HdcGUID => new(0, PTabelaNome, CampoCodigo, GUID, 150, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "hdc"
    };
