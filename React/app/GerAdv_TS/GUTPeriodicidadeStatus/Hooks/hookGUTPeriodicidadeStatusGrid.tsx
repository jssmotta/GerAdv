...
// useGUTPeriodicidadeStatusGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GUTPeriodicidadeStatus
"use client";
...
interface UseGUTPeriodicidadeStatusGridProps {
...
export const useGUTPeriodicidadeStatusGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseGUTPeriodicidadeStatusGridProps) => {
  // ===== GERENCIAMENTO DE REORDENAÇÃO DE COLUNAS =====
  const [columnsOrder, setColumnsOrder] = useState<string[]>([]);

  // Definir ordem padrão das colunas
  const defaultColumnsOrder = useMemo(() => ["nomegutatividades"], []);
  ...
  const filterLogic = useCallback(
    (data: IGUTPeriodicidadeStatus, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
