...
interface UseAtividadesFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterAtividades | undefined | null,
  ) => Promise<void>;
}
...
interface UseAtividadesFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterAtividades>,
  ) => React.ReactNode;
...
export const useAtividadesFilter = ({
  handleFetchWithFilter,
}: UseAtividadesFilterProps): UseAtividadesFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterAtividades>(
    {} as FilterAtividades,
  );
