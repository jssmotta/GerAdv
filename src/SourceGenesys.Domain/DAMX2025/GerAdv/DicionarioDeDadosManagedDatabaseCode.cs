...
public class DicionarioDeDadosManagedDatabaseCode : IDicManager
{
    ...
    public enum DicionarioDeDadosTabelas
    {
        ...
        TipoEMail = 118,
        TipoEndereco = 119,
        TipoEnderecoSistema = 120,
        TipoModeloDocumento = 121,
        TipoOrigemSucumbencia = 122,
        TipoProDesposito = 123,
        TipoRecurso = 124,
        TiposAcao = 125,
        TipoStatusBiu = 126,
        TipoValorProcesso = 127,
        TribEnderecos = 128,
        Tribunal = 129,
        UF = 130,
        UltimosProcessos = 131,
        ViaRecebimento = 132,
        AgendaRelatorio = 133,
        AgendaSemana = 134
    }
    ...
    public int IdTabelaByNome(string nome) => nome switch
    {
        ...
        DBStatusHTrab.PTabelaNome => 112,
        DBStatusInstancia.PTabelaNome => 113,
        DBStatusTarefas.PTabelaNome => 114,
        DBTerceiros.PTabelaNome => 115,
        DBTipoCompromisso.PTabelaNome => 116,
        DBTipoContatoCRM.PTabelaNome => 117,
        DBTipoEMail.PTabelaNome => 118,
        DBTipoEndereco.PTabelaNome => 119,
        DBTipoEnderecoSistema.PTabelaNome => 120,
        DBTipoModeloDocumento.PTabelaNome => 121,
        DBTipoOrigemSucumbencia.PTabelaNome => 122,
        DBTipoProDesposito.PTabelaNome => 123,
        DBTipoRecurso.PTabelaNome => 124,
        DBTiposAcao.PTabelaNome => 125,
        DBTipoStatusBiu.PTabelaNome => 126,
        DBTipoValorProcesso.PTabelaNome => 127,
        DBTribEnderecos.PTabelaNome => 128,
        DBTribunal.PTabelaNome => 129,
        DBUF.PTabelaNome => 130,
        DBUltimosProcessos.PTabelaNome => 131,
        DBViaRecebimento.PTabelaNome => 132,
        DBAgendaRelatorio.PTabelaNome => 133,
        DBAgendaSemana.PTabelaNome => 134,
        _ => 0
    };
    public string NomeTabelaByEnum(int idTable) => idTable switch
    {
        ...
        112 => DBStatusHTrab.PTabelaNome,
        113 => DBStatusInstancia.PTabelaNome,
        114 => DBStatusTarefas.PTabelaNome,
        115 => DBTerceiros.PTabelaNome,
        116 => DBTipoCompromisso.PTabelaNome,
        117 => DBTipoContatoCRM.PTabelaNome,
        118 => DBTipoEMail.PTabelaNome,
        119 => DBTipoEndereco.PTabelaNome,
        120 => DBTipoEnderecoSistema.PTabelaNome,
        121 => DBTipoModeloDocumento.PTabelaNome,
        122 => DBTipoOrigemSucumbencia.PTabelaNome,
        123 => DBTipoProDesposito.PTabelaNome,
        124 => DBTipoRecurso.PTabelaNome,
        125 => DBTiposAcao.PTabelaNome,
        126 => DBTipoStatusBiu.PTabelaNome,
        127 => DBTipoValorProcesso.PTabelaNome,
        128 => DBTribEnderecos.PTabelaNome,
        129 => DBTribunal.PTabelaNome,
        130 => DBUF.PTabelaNome,
        131 => DBUltimosProcessos.PTabelaNome,
        132 => DBViaRecebimento.PTabelaNome,
        133 => DBAgendaRelatorio.PTabelaNome,
        134 => DBAgendaSemana.PTabelaNome,
        _ => string.Empty
    };
