...
import { HonorariosDadosContratoApiError } from '@/app/GerAdv_TS/HonorariosDadosContrato/Apis/ApiHonorariosDadosContrato';
...
import { HonorariosDadosContratoTestEmpty } from '@/app/GerAdv_TS/Models/HonorariosDadosContrato';
...
datacontrato: '24/04/1975'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterHonorariosDadosContrato = { : 1 };
