...
public partial class FOperadorGrupos : MenphisSI.SG.GerAdv.DBOperadorGrupos, IDBOperadorGrupos
{
    // DI-compatible default constructor
    public FOperadorGrupos() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FOperadorGrupos CreateFromReader(SqlDataReader? dbRec)
    {
        return new FOperadorGrupos(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FOperadorGrupos CreateFromDataRow(DataRow? dbRec)
    {
        return new FOperadorGrupos(dbRec);
    }

    private FOperadorGrupos(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FOperadorGrupos(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FOperadorGrupos> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
