...
import { OperadorApiError } from '@/app/GerAdv_TS/Operador/Apis/ApiOperador';
...
import { OperadorTestEmpty } from '@/app/GerAdv_TS/Models/Operador';
...
suporteipultimoacesso: 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterOperador = { : 1 };
