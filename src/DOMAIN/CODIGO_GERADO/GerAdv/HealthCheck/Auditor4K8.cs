                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAuditor4KDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(audCodigo) FROM {"Auditor4K".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) audNome,audGUID FROM {"Auditor4K".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
