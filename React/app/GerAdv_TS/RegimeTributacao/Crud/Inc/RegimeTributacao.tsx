...
const RegimeTributacaoInc: React.FC<IRegimeTributacaoFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedRegimeTributacao =
        await regimetributacaoService.saveRegimeTributacao(data);
