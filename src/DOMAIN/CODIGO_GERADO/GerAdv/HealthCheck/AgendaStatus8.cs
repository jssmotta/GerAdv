                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAgendaStatusDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(astCodigo) FROM {"AgendaStatus".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) astAgenda,astCompleted FROM {"AgendaStatus".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
