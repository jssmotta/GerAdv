                ...
                try
                {
                    ...
                    try
                    {
                        if (DBReuniaoPessoasDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(rnpCodigo) FROM {"ReuniaoPessoas".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) rnpReuniao,rnpOperador FROM {"ReuniaoPessoas".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
