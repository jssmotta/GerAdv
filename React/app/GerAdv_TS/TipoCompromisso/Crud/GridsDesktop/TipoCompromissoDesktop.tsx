  ...
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("tipocompromisso-columns-order"),
        );
        if (savedOrder) {
    ...
    const SearchFromCellNECompromissos = (props: any) => {
      return (
        <>
          <td>
            <div
              onClick={() => openSearchCellNECompromissos(props.dataItem.id)}
            >
              <span title="Pesquisar relacionados em N E Compromissos">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
    ...
    const basicColumnMap: Record<string, React.ReactElement> = useMemo(
      () => ({
        ...
        id_edit_NECompromissos: (
          <GridColumn
            key="NECompromissos"
            field="NECompromissos"
    ...
    const resetColumnsOrder = useCallback(() => {
      ...
      localStorage.removeItem(btoa("tipocompromisso-columns-order"));
    }, []);
      ...
      <>
        ...
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-tipocompromisso"
