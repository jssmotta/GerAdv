...
/// <summary>
/// Comprehensive unit tests for ConfigureUpdateFields and ConfigureAuditorFields methods in DBRito class
...
/// </summary>
public class DBRitoConfigureMethodsTests : IDisposable
{
    private readonly DBRito _rito;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBRitoConfigureMethodsTests()
    {
        _rito = new DBRito();
    ...
    public void ConfigureUpdateFields_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        // Arrange
        ResetAllFieldFlags();
        _rito.ID = 1; // Update scenario
        // Act
        var result = _rito.Update(_mockConnection.Object);
    ...
    public async Task ConfigureUpdateFieldsAsync_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        ...
        try
        {
            var result = await _rito.UpdateAsync(_mockConnection.Object);
...
#region Helper Methods
    ...
    {
        var field = typeof(DBRito).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
        field?.SetValue(_rito, value);
    }
    ...
    private void SetFieldValue(string fieldName, object? value)
    {
        ...
        {
            field?.SetValue(_rito, Convert.ToDateTime(value));
        }
    }
    ...
    {
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAA");
...
#region Fields_All
    ...
    public void ConfigureUpdateFields_WithDescricaoFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _rito.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _rito.Update(_mockConnection.Object));
    ...
    public async Task ConfigureUpdateFieldsAsync_WithDescricaoFieldChanged_ShouldProcessUpdate(string value)
    {
        ...
        _rito.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _rito.UpdateAsync(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncDescricao_WithCancellationToken_ShouldRespectCancellation()
    {
        ...
        var exception = await Record.ExceptionAsync(async () => await _rito.UpdateAsync(_mockConnection.Object, cancellationToken: cts.Token));
        exception.Should().NotBeNull();
    }
    ...
    public async Task ConfigureUpdateFieldsAsyncDescricao_WithTimeout_ShouldRespectTimeout()
    {
        ...
        _rito.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _rito.UpdateAsync(_mockConnection.Object, timeoutSeconds: 1));
        exception.Should().NotBeNull();
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WhenAuditorQuemIsZero_ShouldSetToDefaultValue()
    {
        // Arrange
        _rito.ID = 0; // Insert scenario
        _rito.AuditorQuem = 0; // Should be set to 1
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _rito.Update(_mockConnection.Object));
    ...
    public void ConfigureAuditorFieldsDescricao_WhenAuditorQuemHasValue_ShouldPreserveValue(int auditorValue)
    {
        // Arrange
        _rito.ID = 0; // Insert scenario
        _rito.AuditorQuem = auditorValue;
        SetFieldFlag("pFldFDescricao", true); // At least one field must change
        SetFieldValue("m_FDescricao", "AAAAAAAAAAAAAAAAAA");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _rito.Update(_mockConnection.Object));
        ...
        _rito.AuditorQuem.Should().Be(auditorValue);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WithZeroID_ShouldBeConsideredInsert()
    {
        ...
        _rito.AuditorQuem.Should().Be(10);
    }
    ...
    public void ConfigureAuditorFieldsDescricao_WithNonZeroID_ShouldBeConsideredUpdate(int id)
    {
        ...
        _rito.AuditorQuem.Should().Be(15);
    }
    ...
    public void ConfigureMethodsDescricao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        SetAllFieldValues();
        _rito.ID = 123;
        _rito.AuditorQuem = 99;
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _rito.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _rito.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAA");
        _rito.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureFieldsDescricao_Integration_FieldChangeTracking_ShouldWorkCorrectly()
    {
        ...
        var result1 = _rito.Update(_mockConnection.Object);
    ...
    public void ConfigureMethodsGUID_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _rito.FGUID.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        _rito.AuditorQuem.Should().Be(99);
    }
