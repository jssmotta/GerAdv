                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAgendaStatusDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(astCodigo) FROM dbo.AgendaStatus (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) astAgenda,astCompleted FROM dbo.AgendaStatus (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
