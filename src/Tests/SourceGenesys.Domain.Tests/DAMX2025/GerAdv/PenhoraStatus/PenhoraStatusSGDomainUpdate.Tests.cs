...
public class DBPenhoraStatusUpdate : IDisposable
{
    private readonly DBPenhoraStatus _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBPenhoraStatusUpdate()
    {
    ...
    {
        // Act
        var penhorastatus = new DBPenhoraStatus();
        // Assert
        penhorastatus.Should().NotBeNull();
        penhorastatus.ITableName().Should().Be("PenhoraStatus");
        penhorastatus.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set penhorastatus.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        penhorastatus.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        penhorastatus.FNome = longString; // MAX: 80
        penhorastatus.FGuid = longString; // MAX: 100
        // Assert - All properties should be set penhorastatus.FNome.Should().HaveLength(80);
        penhorastatus.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        penhorastatus.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        penhorastatus.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "phsCodigo = 1";
        // Act & Assert
        var PenhoraStatus = new DBPenhoraStatus(sqlWhere, null);
        PenhoraStatus.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var penhorastatus = new DBPenhoraStatus(parameters, nome, null);
        // Assert
        penhorastatus.Should().NotBeNull();
        penhorastatus.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        penhorastatus.FNome = longName;
        // Assert
        penhorastatus.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBPenhoraStatus).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var penhorastatus = new DBPenhoraStatus();
        // Act & Assert
        penhorastatus.TabelaNome.Should().Be("PenhoraStatus");
    }
