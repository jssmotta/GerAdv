...
interface UseContratosFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterContratos | undefined | null,
  ) => Promise<void>;
}
...
interface UseContratosFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterContratos>,
  ) => React.ReactNode;
...
export const useContratosFilter = ({
  handleFetchWithFilter,
}: UseContratosFilterProps): UseContratosFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterContratos>(
    {} as FilterContratos,
  );
  ...
  const clearFilter = () => {
    setWindowFilter({} as FilterContratos);
    sessionStorage.removeItem(btoa("ContratosFilter"));
    handleFetchWithFilter({} as FilterContratos);
  };
    ...
    <>
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datainicio", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datainicio_end", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datatermino", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datatermino_end", value)
        }
      />
