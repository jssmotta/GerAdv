...
<InputGuid
                      ...
                      handlers.handleInputChange({ target: { name: 'guid', value } } as any)
                        ...
                        />
<FilterDialogButton        
        filter={handlers.windowFilter.filterGUTPeriodicidade ?? ({} as any) as any}
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({ ...prev, filterGUTPeriodicidade: f }))
        }        
...
<InputInput
    ...
    const { renderInputFilters: renderGUTPeriodicidadeInputs } = useGUTPeriodicidadeFilter({
