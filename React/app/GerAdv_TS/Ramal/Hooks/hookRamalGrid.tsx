...
// useRamalGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Ramal
"use client";
...
export const useRamalGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IRamal, filters: Record<string, any>) => {
