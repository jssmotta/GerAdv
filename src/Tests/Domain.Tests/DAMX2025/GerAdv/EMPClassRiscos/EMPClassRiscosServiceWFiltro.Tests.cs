...
{
    public class EMPClassRiscosServiceWFiltroTests : IDisposable
    {
        ...
        private readonly EMPClassRiscosServiceS _serviceS;
        public EMPClassRiscosServiceWFiltroTests()
        {
            ...
            _serviceS = new EMPClassRiscosServiceS();
            _service = new EMPClassRiscosService(_mockAppSettings.Object, _mockEMPClassRiscosFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
        ...
        {
            // Arrange
            FilterEMPClassRiscos? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidEMPClassRiscos_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_GuidEMPClassRiscos_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_GuidEMPClassRiscos_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeEMPClassRiscos = "João Silva";
            var filtro = new FilterEMPClassRiscos
            {
                Guid = nomeEMPClassRiscos,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidEMPClassRiscos_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_GuidEMPClassRiscos_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidEMPClassRiscos_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeEMPClassRiscos)
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_GuidEMPClassRiscos_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
            ...
            resultado.Value.where.Should().Contain("@ecrGuid");
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscos.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @ecrGuid");
            resultado.Value.where.Should().Contain($"= @{DBEMPClassRiscos.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidEMPClassRiscos_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeEMPClassRiscos = "João Silva";
            var filtro = new FilterEMPClassRiscos
            ...
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @ecrGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@ecrGuid");
        ...
        [Fact]
        public void WFiltro_NomeEMPClassRiscos_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_NomeEMPClassRiscos_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_NomeEMPClassRiscos_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeEMPClassRiscos = "João Silva";
            var filtro = new FilterEMPClassRiscos
            {
                Nome = nomeEMPClassRiscos,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeEMPClassRiscos_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_NomeEMPClassRiscos_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeEMPClassRiscos_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeEMPClassRiscos)
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
        ...
        [Fact]
        public void WFiltro_NomeEMPClassRiscos_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterEMPClassRiscos
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@ecrNome");
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscos.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @ecrNome");
            resultado.Value.where.Should().Contain($"= @{DBEMPClassRiscos.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeEMPClassRiscos_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeEMPClassRiscos = "João Silva";
            var filtro = new FilterEMPClassRiscos
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @ecrNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@ecrNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemCad}] = @{DBEMPClassRiscosDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBEMPClassRiscosDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.QuemCad} BETWEEN @{DBEMPClassRiscosDicInfo.QuemCad} AND @{DBEMPClassRiscosDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.QuemCad} BETWEEN @{DBEMPClassRiscosDicInfo.QuemCad} AND @{DBEMPClassRiscosDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemCad}] = @{DBEMPClassRiscosDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemCad}] = @ecrQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@ecrQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@ecrQuemCad");
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemAtu}] = @{DBEMPClassRiscosDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBEMPClassRiscosDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.QuemAtu} BETWEEN @{DBEMPClassRiscosDicInfo.QuemAtu} AND @{DBEMPClassRiscosDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.QuemAtu} BETWEEN @{DBEMPClassRiscosDicInfo.QuemAtu} AND @{DBEMPClassRiscosDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemAtu}] = @{DBEMPClassRiscosDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.QuemAtu}] = @ecrQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@ecrQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@ecrQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.CampoCodigo}] = @{DBEMPClassRiscosDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBEMPClassRiscosDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.CampoCodigo} BETWEEN @{DBEMPClassRiscosDicInfo.CampoCodigo} AND @{DBEMPClassRiscosDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBEMPClassRiscosDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.CampoCodigo} BETWEEN @{DBEMPClassRiscosDicInfo.CampoCodigo} AND @{DBEMPClassRiscosDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.CampoCodigo}] = @{DBEMPClassRiscosDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBEMPClassRiscosDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBEMPClassRiscosDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.DtCad} BETWEEN @{DBEMPClassRiscosDicInfo.DtCad} AND @{DBEMPClassRiscosDicInfo.DtCad}_end");
        }
        ...
        public void WFiltro_DtCad_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.DtCad}], 103)");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBEMPClassRiscosDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBEMPClassRiscosDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].{DBEMPClassRiscosDicInfo.DtAtu} BETWEEN @{DBEMPClassRiscosDicInfo.DtAtu} AND @{DBEMPClassRiscosDicInfo.DtAtu}_end");
        }
        ...
        public void WFiltro_DtAtu_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.DtAtu}], 103)");
        }
...
#region Visto Filter Tests
        ...
        public void WFiltro_VistoEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBEMPClassRiscosDicInfo.Visto));
            result.Value.where.Should().NotContain(DBEMPClassRiscosDicInfo.Visto);
        }
        ...
        public void WFiltro_VistoHasValidValue_ShouldAddParameterAndWhereClause()
        {
            ...
            result.Should().NotBeNull();
            // Check parameter
            var VistoParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.Visto}");
            VistoParameter.Should().NotBeNull();
            VistoParameter.Value.Should().Be(VistoValue);
            // Check where clause
            result.Value.where.Should().Contain($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.Visto}] = @{DBEMPClassRiscosDicInfo.Visto}");
        }
        ...
        public void WFiltro_VistoWithDifferentValues_ShouldAddCorrectParameterValue()
        {
            ...
            var filtroFemale = new FilterEMPClassRiscos
            {
                Visto = 0
            };
            var resultFemale = _serviceS.WFiltro(filtroFemale);
            resultFemale.Should().NotBeNull();
            var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.Visto}");
            femaleParam.Should().NotBeNull();
            femaleParam.Value.Should().Be(0);
            // Arrange & Act & Assert for Visto = 1 (typically male)
            var filtroMale = new FilterEMPClassRiscos
            {
                Visto = 1
            };
            var resultMale = _serviceS.WFiltro(filtroMale);
            resultMale.Should().NotBeNull();
            var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEMPClassRiscosDicInfo.Visto}");
        ...
        public void WFiltro_VistoAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.where.Should().StartWith($"[{DBEMPClassRiscosDicInfo.PTabelaNome}].[{DBEMPClassRiscosDicInfo.Visto}] = @{DBEMPClassRiscosDicInfo.Visto}");
