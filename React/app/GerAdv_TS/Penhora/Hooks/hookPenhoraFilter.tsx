...
export const usePenhoraFilter = ({
    ...
    <>
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datapenhora", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datapenhora_end", value)
        }
      />
  ...
  const { renderInputFilters: renderPenhoraStatusInputs } =
