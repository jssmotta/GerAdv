...
import { GUTAtividadesMatrizApiError } from '@/app/GerAdv_TS/GUTAtividadesMatriz/Apis/ApiGUTAtividadesMatriz';
...
import { GUTAtividadesMatrizTestEmpty } from '@/app/GerAdv_TS/Models/GUTAtividadesMatriz';
...
gutatividade: 1
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterGUTAtividadesMatriz = { : 1 };
