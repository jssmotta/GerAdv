...
public partial class FStatusInstancia : MenphisSI.SG.GerAdv.DBStatusInstancia, IDBStatusInstancia
{
    // DI-compatible default constructor
    public FStatusInstancia() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FStatusInstancia CreateFromReader(SqlDataReader? dbRec)
    {
        return new FStatusInstancia(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FStatusInstancia CreateFromDataRow(DataRow? dbRec)
    {
        return new FStatusInstancia(dbRec);
    }

    private FStatusInstancia(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FStatusInstancia(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FStatusInstancia> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
