...
#region Class Structure Tests
    ...
    private static GerAdv.Models.Clientes CreateValidClientes()
    {
        return new GerAdv.Models.Clientes
        {
            Id = 1,
            Empresa = 0,
    ...
    private void SetupValidMocks()
    {
        ...
        _ = _mockRegimeTributacaoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<RegimeTributacaoResponse?>(new RegimeTributacaoResponse { Id = id }));
        _ = _mockEnquadramentoEmpresaReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<EnquadramentoEmpresaResponse?>(new EnquadramentoEmpresaResponse { Id = id }));
    }
    ...
    private void SetupValidMocksInvalid()
    {
        ...
        _ = _mockRegimeTributacaoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<RegimeTributacaoResponse?>(new RegimeTributacaoResponse { Id = 0 }));
        _ = _mockEnquadramentoEmpresaReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<EnquadramentoEmpresaResponse?>(new EnquadramentoEmpresaResponse { Id = 0 }));
    }
...
#region CPF Validation Tests
    ...
    public async Task ValidateReg_WithDuplicateCPF_ShouldThrowSGValidationException()
    {
        ...
        _mockClientesService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterClientes>(), It.IsAny<string>())).ReturnsAsync([existingClientes]);
        // Setup other mocks but don't override the Clientess service mock
        _ = _mockCidadeReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<CidadeResponse?>(new CidadeResponse { Id = id }));
        _ = _mockRegimeTributacaoReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<RegimeTributacaoResponse?>(new RegimeTributacaoResponse { Id = id }));
        _ = _mockEnquadramentoEmpresaReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<EnquadramentoEmpresaResponse?>(new EnquadramentoEmpresaResponse { Id = id }));
...
#region Foreign Key Validation Tests - RegimeTributacao
    ...
    public async Task ValidateReg_WithInvalidRegimeTributacao_ShouldThrowSGValidationException()
    {
        ...
        _mockRegimeTributacaoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.RegimeTributacaoResponse?>(null !));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _mockRegimeTributacaoReader.Object, _mockEnquadramentoEmpresaReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithMismatchedRegimeTributacaoId_ShouldThrowSGValidationException()
    {
        ...
        var clientes = CreateValidClientes();
        clientes.RegimeTributacao = 999;
        var reg888 = new GerAdv.Models.Response.RegimeTributacaoResponse
        {
            Id = 888
        }; // Different ID
        _mockRegimeTributacaoReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.RegimeTributacaoResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _mockRegimeTributacaoReader.Object, _mockEnquadramentoEmpresaReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidRegimeTributacao_ShouldPass()
    {
        ...
        var reg123 = new GerAdv.Models.Response.RegimeTributacaoResponse
        {
            Id = 123
        };
        _mockRegimeTributacaoReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.RegimeTributacaoResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _mockRegimeTributacaoReader.Object, _mockEnquadramentoEmpresaReader.Object, _validUri, _mockConnection.Object);
        // Assert
    ...
    public async Task ValidateReg_WithEmptyRegimeTributacao_ShouldPass()
    {
        ...
        // Assert
        result.Should().BeTrue();
        _mockRegimeTributacaoReader.Verify(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>()), Times.Never);
    }
...
#region Foreign Key Validation Tests - EnquadramentoEmpresa
    ...
    public async Task ValidateReg_WithInvalidEnquadramentoEmpresa_ShouldThrowSGValidationException()
    {
        ...
        _mockEnquadramentoEmpresaReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.EnquadramentoEmpresaResponse?>(null !));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _mockRegimeTributacaoReader.Object, _mockEnquadramentoEmpresaReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithMismatchedEnquadramentoEmpresaId_ShouldThrowSGValidationException()
    {
        ...
        var clientes = CreateValidClientes();
        clientes.EnquadramentoEmpresa = 999;
        var reg888 = new GerAdv.Models.Response.EnquadramentoEmpresaResponse
        {
            Id = 888
        }; // Different ID
        _mockEnquadramentoEmpresaReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.EnquadramentoEmpresaResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _mockRegimeTributacaoReader.Object, _mockEnquadramentoEmpresaReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidEnquadramentoEmpresa_ShouldPass()
    {
        ...
        var reg123 = new GerAdv.Models.Response.EnquadramentoEmpresaResponse
        {
            Id = 123
        };
        _mockEnquadramentoEmpresaReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.EnquadramentoEmpresaResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(clientes, _mockClientesService.Object, _mockCidadeReader.Object, _mockRegimeTributacaoReader.Object, _mockEnquadramentoEmpresaReader.Object, _validUri, _mockConnection.Object);
        // Assert
    ...
    public async Task ValidateReg_WithEmptyEnquadramentoEmpresa_ShouldPass()
    {
        ...
        // Assert
        result.Should().BeTrue();
        _mockEnquadramentoEmpresaReader.Verify(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>()), Times.Never);
    }
