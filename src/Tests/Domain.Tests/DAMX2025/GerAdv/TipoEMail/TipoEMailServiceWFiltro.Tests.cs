...
{
    public class TipoEMailServiceWFiltroTests : IDisposable
    {
        ...
        private readonly TipoEMailServiceS _serviceS;
        public TipoEMailServiceWFiltroTests()
        {
            ...
            _serviceS = new TipoEMailServiceS();
        ...
        {
            // Arrange
            var filtro = new FilterTipoEMail(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_NomeTipoEMail_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoEMail
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoEMail_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoEMail
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoEMail_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoEMail = "João Silva";
            var filtro = new FilterTipoEMail
            {
                Nome = nomeTipoEMail,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeTipoEMail_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoEMail
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoEMail_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoEMail
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeTipoEMail_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoEMail)
        {
            // Arrange
            var filtro = new FilterTipoEMail
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoEMail_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoEMail
            {
            ...
            resultado.Value.where.Should().Contain("@tmlNome");
            resultado.Value.where.Should().Contain($"@{DBTipoEMail.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @tmlNome");
            resultado.Value.where.Should().Contain($"= @{DBTipoEMail.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeTipoEMail_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoEMail = "João Silva";
            var filtro = new FilterTipoEMail
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoEMailDicInfo.PTabelaNome}].[{DBTipoEMailDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @tmlNome");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@tmlNome");
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoEMailDicInfo.PTabelaNome}].[{DBTipoEMailDicInfo.CampoCodigo}] = @{DBTipoEMailDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoEMailDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoEMailDicInfo.PTabelaNome}].{DBTipoEMailDicInfo.CampoCodigo} BETWEEN @{DBTipoEMailDicInfo.CampoCodigo} AND @{DBTipoEMailDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoEMailDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoEMailDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoEMailDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoEMailDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoEMailDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBTipoEMailDicInfo.Nome}");
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoEMailDicInfo.PTabelaNome}].{DBTipoEMailDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoEMailDicInfo.PTabelaNome}].{DBTipoEMailDicInfo.CampoCodigo} BETWEEN @{DBTipoEMailDicInfo.CampoCodigo} AND @{DBTipoEMailDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoEMailDicInfo.PTabelaNome}].[{DBTipoEMailDicInfo.CampoCodigo}] = @{DBTipoEMailDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoEMailDicInfo.PTabelaNome}].[{DBTipoEMailDicInfo.CampoCodigo}]");
        }
