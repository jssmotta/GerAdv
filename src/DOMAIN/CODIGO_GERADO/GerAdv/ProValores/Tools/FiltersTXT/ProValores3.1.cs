...
public static class FilterProValoresTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar ProValores em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterProValores:

- O filter irá filtrar os ProValores conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterProValores:(Pro Valores)
- processo: número ou IDs;
- tipovalorprocesso: número ou IDs;
- indice: Indice;
- ignorar: Ignorar;
- data: não é a data de cadastramento é a data do ProValores;
- valororiginal: valores monetários ou com decimais;
- percmulta: valores monetários ou com decimais;
- valormulta: valores monetários ou com decimais;
- percjuros: valores monetários ou com decimais;
- valororiginalcorrigidoindice: valores monetários ou com decimais;
- valormultacorrigido: valores monetários ou com decimais;
- valorjuroscorrigido: valores monetários ou com decimais;
- valorfinal: valores monetários ou com decimais;
...
- Se ouvir "todos os ProValores" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterProValores? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt ProValores length: {result.Length}");
#endif
