...
/// <summary>
/// Comprehensive unit tests for ConfigureUpdateFields and ConfigureAuditorFields methods in DBOperadorGruposAgenda class
...
/// </summary>
public class DBOperadorGruposAgendaConfigureMethodsTests : IDisposable
{
    private readonly DBOperadorGruposAgenda _operadorgruposagenda;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBOperadorGruposAgendaConfigureMethodsTests()
    {
        _operadorgruposagenda = new DBOperadorGruposAgenda();
    ...
    public void ConfigureUpdateFields_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        // Arrange
        ResetAllFieldFlags();
        _operadorgruposagenda.ID = 1; // Update scenario
        // Act
        var result = _operadorgruposagenda.Update(_mockConnection.Object);
    ...
    public async Task ConfigureUpdateFieldsAsync_WhenNoFieldsChanged_ShouldNotUpdateDatabase()
    {
        ...
        try
        {
            var result = await _operadorgruposagenda.UpdateAsync(_mockConnection.Object);
...
#region Helper Methods
    ...
    {
        var field = typeof(DBOperadorGruposAgenda).GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
        field?.SetValue(_operadorgruposagenda, value);
    }
    ...
    private void SetFieldValue(string fieldName, object? value)
    {
        ...
        {
            field?.SetValue(_operadorgruposagenda, Convert.ToDateTime(value));
        }
    }
    ...
    {
        SetFieldValue("m_FSQLWhere", "");
        SetFieldValue("m_FNome", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
#region Fields_All
    ...
    public void ConfigureUpdateFields_WithSQLWhereFieldChanged_ShouldProcessUpdate(string value)
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
        SetFieldValue("m_FSQLWhere", value);
        _operadorgruposagenda.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    }

    [Fact]
    public void ConfigureUpdateFieldsSQLWhere_OnInsert_ShouldConfigureBooleanFieldsAutomatically()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true); // At least one field must change
        SetFieldValue("m_FSQLWhere", "");
        _operadorgruposagenda.ID = 0; // Insert scenario
    ...
    [Fact]
    public void ConfigureUpdateFieldsSQLWhere_WithMultipleFieldsChanged_ShouldProcessAllChanges()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
    ...
    [InlineData("Another Client")]
    [InlineData("Valid Client")]
    public async Task ConfigureUpdateFieldsAsync_WithSQLWhereFieldChanged_ShouldProcessUpdate(string value)
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
        ...
        _operadorgruposagenda.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _operadorgruposagenda.UpdateAsync(_mockConnection.Object));
        exception.Should().NotBeNull();
    }

    [Fact]
    public async Task ConfigureUpdateFieldsAsync_WithMultipleFieldsSQLWhereChanged_ShouldProcessAllChanges()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
    ...
    [Fact]
    public async Task ConfigureUpdateFieldsAsyncSQLWhere_WithCancellationToken_ShouldRespectCancellation()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
        ...
        var exception = await Record.ExceptionAsync(async () => await _operadorgruposagenda.UpdateAsync(_mockConnection.Object, cancellationToken: cts.Token));
        exception.Should().NotBeNull();
    }

    [Fact]
    public async Task ConfigureUpdateFieldsAsyncSQLWhere_WithTimeout_ShouldRespectTimeout()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
        ...
        _operadorgruposagenda.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = await Record.ExceptionAsync(async () => await _operadorgruposagenda.UpdateAsync(_mockConnection.Object, timeoutSeconds: 1));
        exception.Should().NotBeNull();
    }

    [Fact]
    public void ConfigureAuditorFields_WhenInsertSQLWhere_ShouldSetInsertAuditFields()
    {
        // Arrange
        _operadorgruposagenda.ID = 0; // Insert scenario
        _operadorgruposagenda.AuditorQuem = 5;
        SetFieldFlag("pFldFSQLWhere", true); // At least one field must change
        SetFieldValue("m_FSQLWhere", "");
        // Act & Assert - Should throw exception due to mocked connection but audit fields should be set
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _operadorgruposagenda.AuditorQuem.Should().Be(5);
    }

    [Fact]
    public void ConfigureAuditorFieldsSQLWhere_WhenUpdate_ShouldSetUpdateAuditFields()
    {
        // Arrange
        _operadorgruposagenda.ID = 123; // Update scenario
        _operadorgruposagenda.AuditorQuem = 7;
        SetFieldFlag("pFldFSQLWhere", true); // At least one field must change
        SetFieldValue("m_FSQLWhere", "");
        // Act & Assert - Should throw exception due to mocked connection but audit fields should be set
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _operadorgruposagenda.AuditorQuem.Should().Be(7);
    }

    [Fact]
    public void ConfigureAuditorFieldsSQLWhere_WhenAuditorQuemIsZero_ShouldSetToDefaultValue()
    {
        // Arrange
        _operadorgruposagenda.ID = 0; // Insert scenario
        _operadorgruposagenda.AuditorQuem = 0; // Should be set to 1
        SetFieldFlag("pFldFSQLWhere", true); // At least one field must change
        SetFieldValue("m_FSQLWhere", "");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        ...
        _operadorgruposagenda.AuditorQuem.Should().Be(1);
    }
    ...
    [InlineData(5)]
    [InlineData(999)]
    public void ConfigureAuditorFieldsSQLWhere_WhenAuditorQuemHasValue_ShouldPreserveValue(int auditorValue)
    {
        // Arrange
        _operadorgruposagenda.ID = 0; // Insert scenario
        _operadorgruposagenda.AuditorQuem = auditorValue;
        SetFieldFlag("pFldFSQLWhere", true); // At least one field must change
        SetFieldValue("m_FSQLWhere", "");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        ...
        _operadorgruposagenda.AuditorQuem.Should().Be(auditorValue);
    }

    [Fact]
    public void ConfigureAuditorFieldsSQLWhere_WithZeroID_ShouldBeConsideredInsert()
    {
        // Arrange
        _operadorgruposagenda.ID = 0;
        _operadorgruposagenda.AuditorQuem = 10;
        SetFieldFlag("pFldFSQLWhere", true); // At least one field must change
        SetFieldValue("m_FSQLWhere", "");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        ...
        _operadorgruposagenda.AuditorQuem.Should().Be(10);
    }
    ...
    [InlineData(100)]
    [InlineData(999)]
    public void ConfigureAuditorFieldsSQLWhere_WithNonZeroID_ShouldBeConsideredUpdate(int id)
    {
        // Arrange
        _operadorgruposagenda.ID = id;
        _operadorgruposagenda.AuditorQuem = 15;
        SetFieldFlag("pFldFSQLWhere", true); // At least one field must change
        SetFieldValue("m_FSQLWhere", "");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        ...
        _operadorgruposagenda.AuditorQuem.Should().Be(15);
    }

    [Fact]
    public async Task ConfigureAuditorFieldsAsyncSQLWhere_WhenInsert_ShouldSetInsertAuditFields()
    {
        // Arrange
        _operadorgruposagenda.ID = 0; // Insert scenario
        _operadorgruposagenda.AuditorQuem = 5;
    ...
    [Fact]
    public async Task ConfigureAuditorFieldsAsyncSQLWhere_WhenAuditorQuemIsZero_ShouldSetToDefaultValue()
    {
        // Arrange
        _operadorgruposagenda.ID = 0; // Insert scenario
        _operadorgruposagenda.AuditorQuem = 0; // Should be set to 1
    ...
    [Fact]
    public void ConfigureMethodsSQLWhere_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
        _operadorgruposagenda.ID = 123;
        _operadorgruposagenda.AuditorQuem = 99;
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _operadorgruposagenda.FSQLWhere.Should().Be("");
        _operadorgruposagenda.AuditorQuem.Should().Be(99);
    }

    [Fact]
    public void ConfigureFieldsSQLWhere_Integration_FieldChangeTracking_ShouldWorkCorrectly()
    {
        // Arrange
        _operadorgruposagenda.ID = 1; // Update scenario
        // Initially no changes
        var result1 = _operadorgruposagenda.Update(_mockConnection.Object);
        result1.Should().Be(0, "No fields changed, should return 0");
        // Now change a field
        SetFieldFlag("pFldFSQLWhere", true);
        SetFieldValue("m_FSQLWhere", "New Client Name");
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    }
    ...
    [Fact]
    public void ConfigureFieldsSQLWhere_EdgeCase_EmptyStringValues_ShouldBeHandled()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
        SetFieldValue("m_FSQLWhere", "");
        _operadorgruposagenda.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    ...
    [Fact]
    public void ConfigureFieldsSQLWhere_EdgeCase_NullStringValues_ShouldBeHandled()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
        SetFieldValue("m_FSQLWhere", null);
        _operadorgruposagenda.ID = 0; // Insert scenario
        // Act & Assert - Should throw exception due to mocked connection
        var exception = Record.Exception(() => _operadorgruposagenda.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
    ...
    [Fact]
    public async Task ConfigureFieldsAsyncSQLWhere_EdgeCase_EmptyStringValues_ShouldBeHandled()
    {
        // Arrange
        ResetAllFieldFlags();
        SetFieldFlag("pFldFSQLWhere", true);
    ...
    [Fact]
    public void ConfigureUpdateFieldsSQLWhere_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
        ...
        _operadorgruposagenda.FSQLWhere.Should().Be("");
        _operadorgruposagenda.FOperador.Should().Be(123);
    }
    ...
    public void ConfigureMethodsNome_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _operadorgruposagenda.FNome.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        _operadorgruposagenda.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsGUID_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _operadorgruposagenda.FGUID.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        _operadorgruposagenda.AuditorQuem.Should().Be(99);
    }
