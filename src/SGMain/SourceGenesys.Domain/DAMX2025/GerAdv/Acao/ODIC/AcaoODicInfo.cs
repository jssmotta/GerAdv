...
public partial class DBAcaoODicInfo : IODicInfo
{
    ...
    public static ImmutableArray<DBInfoSystem> List => [DBAcaoDicInfo.AcaGUID, DBAcaoDicInfo.AcaJustica, DBAcaoDicInfo.AcaArea, DBAcaoDicInfo.AcaDescricao, DBAcaoDicInfo.AcaQuemCad, DBAcaoDicInfo.AcaDtCad, DBAcaoDicInfo.AcaQuemAtu, DBAcaoDicInfo.AcaDtAtu, DBAcaoDicInfo.AcaVisto];
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBAcaoDicInfo.AcaGUID, DBAcaoDicInfo.AcaJustica, DBAcaoDicInfo.AcaArea, DBAcaoDicInfo.AcaDescricao];
