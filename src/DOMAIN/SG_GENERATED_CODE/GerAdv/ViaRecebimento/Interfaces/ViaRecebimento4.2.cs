...
public partial interface IViaRecebimentoReader
{
    ...
    Task<IEnumerable<ViaRecebimentoResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}