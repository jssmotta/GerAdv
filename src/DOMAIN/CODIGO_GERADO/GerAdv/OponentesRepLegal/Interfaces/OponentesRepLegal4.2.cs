...
public partial interface IOponentesRepLegalReader
{
    ...
    Task<IEnumerable<OponentesRepLegalResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}