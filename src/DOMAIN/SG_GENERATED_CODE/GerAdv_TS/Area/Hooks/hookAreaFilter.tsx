...
interface UseAreaFilterProps {
    handleFetchWithFilter: (filtro?: FilterArea | undefined | null) => Promise<void>;
}
...
export const useAreaFilter = ({ handleFetchWithFilter }: UseAreaFilterProps): UseAreaFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterArea>({} as FilterArea);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterArea;
