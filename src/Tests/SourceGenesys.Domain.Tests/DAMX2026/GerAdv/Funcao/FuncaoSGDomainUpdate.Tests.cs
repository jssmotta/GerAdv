...
public class DBFuncaoUpdate : IDisposable
{
    private readonly DBFuncao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBFuncaoUpdate()
    {
    ...
    {
        // Act
        var funcao = new DBFuncao();
        // Assert
        funcao.Should().NotBeNull();
        funcao.ITableName().Should().Be("Funcao");
        funcao.ID.Should().Be(0);
    }
    ...
    // Assert - All properties should be set funcao.FDescricao.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        funcao.FDescricao = longString; // MAX: 40
    // Assert - All properties should be set funcao.FDescricao.Should().HaveLength(40);
    }
    ...
    public void FDescricao_Property_ShouldAcceptValidNames(string Descricao)
    {
        ...
        // Assert
        funcao.FDescricao.Should().Be(Descricao);
    }
    ...
    public void FDescricao_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        funcao.FDescricao.Should().Be(string.Empty);
    }
    ...
    public void FDescricao_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        funcao.FDescricao = longName;
        // Assert
        funcao.FDescricao.Should().HaveLength(40);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBFuncao).GetField("pFldFDescricao", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FDescricao = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var funcao = new DBFuncao();
        // Act & Assert
        funcao.TabelaNome.Should().Be("Funcao");
    }
