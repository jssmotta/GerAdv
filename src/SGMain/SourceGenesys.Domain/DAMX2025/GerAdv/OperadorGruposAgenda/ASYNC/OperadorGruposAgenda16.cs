...
public partial class DBOperadorGruposAgenda
{
    ...
    /// </summary>
    public static async Task<DBOperadorGruposAgenda> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBOperadorGruposAgenda();
