...
interface HonorariosDadosContratoGridProps {
  data: IHonorariosDadosContrato[];
  onRowClick: (honorariosdadoscontrato: IHonorariosDadosContrato) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const HonorariosDadosContratoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
}: HonorariosDadosContratoGridProps) => {
...
const filterLogic = useCallback((data: IHonorariosDadosContrato, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  tableName: 'honorariosdadoscontrato'
});
...
{initialized && (
  ...
  className='grid-desktop-honorariosdadoscontrato'
