...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBStatusInstancia
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBStatusInstanciaUpdateAdvancedTests : IDisposable
{
    private readonly DBStatusInstancia _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusInstanciaUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBStatusInstancia
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBStatusInstancia).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBStatusInstancia).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBStatusInstancia instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBStatusInstancia).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBStatusInstancia.PTabelaNome.Should().Be("StatusInstancia");
        DBStatusInstancia.CampoCodigo.Should().Be("istCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBStatusInstancia();
        dbRec.ID = 1;
