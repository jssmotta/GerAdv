...
const TipoCompromissoComboBox: React.FC<DadosSelectProps> = ({ name, value, setValue, label }) => {
    ...
    const handleAddDado = async (descricao: string) => {
        ...
        const nova = { id: 0, descricao: (UpperCaseDefault ? descricao.toUpperCase() : descricao) } as TipoCompromisso;
        const novoDado = await dadoApi.addAndUpdate(nova as ITipoCompromisso);
