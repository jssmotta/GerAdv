...
public class DBOperadorTests : IDisposable
{
    ...
    private DataTable CreateTestDataTable()
    {
        ...
        dt.Columns.Add("operCadID", typeof(int));
...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("Operador", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("Operador", cadastro.ITableName());
...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FUltimoLogoff = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FUltimoLogoff?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBOperador();
        Assert.Equal(null !, instance.FUltimoLogoff);
    }
    ...
    {
        _instance.FDataLimiteReset = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataLimiteReset?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBOperador();
        Assert.Equal(null !, instance.FDataLimiteReset);
    }
    ...
    {
        _instance.FSuporteMaxAge = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FSuporteMaxAge?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBOperador();
        Assert.Equal(null !, instance.FSuporteMaxAge);
    }
    ...
    {
        _instance.FSuporteUltimoAcesso = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FSuporteUltimoAcesso?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBOperador();
        Assert.Equal(null !, instance.FSuporteUltimoAcesso);
    }
