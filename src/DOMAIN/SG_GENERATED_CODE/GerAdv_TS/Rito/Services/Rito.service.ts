...
export interface IRitoService {
  ...
  filterVoice: (filtro?: FilterRito, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class RitoService implements IRitoService {
  ...
  async filterVoice(filtro?: FilterRito, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
