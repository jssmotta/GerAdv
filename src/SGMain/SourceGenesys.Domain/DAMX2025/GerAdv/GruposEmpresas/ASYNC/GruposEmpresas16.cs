...
public partial class DBGruposEmpresas
{
    ...
    /// </summary>
    public static async Task<DBGruposEmpresas> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBGruposEmpresas();
