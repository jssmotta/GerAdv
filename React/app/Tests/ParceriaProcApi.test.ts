...
import { ParceriaProcApiError } from '@/app/GerAdv_TS/ParceriaProc/Apis/ApiParceriaProc';
...
import { ParceriaProcTestEmpty } from '@/app/GerAdv_TS/Models/ParceriaProc';
...
processo: 0
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterParceriaProc = { : 1 };
