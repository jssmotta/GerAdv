...
const openSearchCellOperador = (id: number) => {
  router.push(`/pages/operador/?statusbiu=${id}`);
};
const SearchFromCellOperador = (props: any) => {
  return (
  <>
  <td>
    <div onClick={() => openSearchCellOperador(props.dataItem.id)}><span title='Pesquisar relacionados em Operador'><SvgIcon icon={searchIcon} /></span></div>
  </td>
</>
);
};
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn
  field='id_edit_Operador'
  filterable={false}
  sortable={false}
  width={'65px'}
  title='Operador'
  cells={{ data: SearchFromCellOperador }}
  />, 
...
{initialized && (
  ...
  className='grid-desktop-crud grid-desktop-statusbiu'
