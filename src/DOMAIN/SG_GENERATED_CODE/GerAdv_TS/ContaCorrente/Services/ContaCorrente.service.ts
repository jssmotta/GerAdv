...
export interface IContaCorrenteService {
  ...
  filterVoice: (filtro?: FilterContaCorrente, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ContaCorrenteService implements IContaCorrenteService {
  ...
  async filterVoice(filtro?: FilterContaCorrente, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
