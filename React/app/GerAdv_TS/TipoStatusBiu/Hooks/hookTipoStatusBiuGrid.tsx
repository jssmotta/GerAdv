...
// useTipoStatusBiuGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoStatusBiu
"use client";
...
interface UseTipoStatusBiuGridProps {
  data: ITipoStatusBiu[];
...
export const useTipoStatusBiuGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ITipoStatusBiu, filters: Record<string, any>) => {
