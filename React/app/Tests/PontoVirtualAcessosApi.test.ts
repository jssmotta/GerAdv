...
import { PontoVirtualAcessosApiError } from '@/app/GerAdv_TS/PontoVirtualAcessos/Apis/ApiPontoVirtualAcessos';
...
import { PontoVirtualAcessosTestEmpty } from '@/app/GerAdv_TS/Models/PontoVirtualAcessos';
...
origem: 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterPontoVirtualAcessos = { : 1 };
