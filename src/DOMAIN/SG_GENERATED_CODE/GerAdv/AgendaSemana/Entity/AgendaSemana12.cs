...
public partial class FAgendaSemana : MenphisSI.SG.GerAdv.DBAgendaSemana, IDBAgendaSemana
{
    // DI-compatible default constructor
    public FAgendaSemana() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FAgendaSemana CreateFromReader(SqlDataReader? dbRec)
    {
        return new FAgendaSemana(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FAgendaSemana CreateFromDataRow(DataRow? dbRec)
    {
        return new FAgendaSemana(dbRec);
    }

    private FAgendaSemana(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FAgendaSemana(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static FAgendaSemana CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FAgendaSemana(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
