...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFProValores.VerifySet(x => x.FData = DateOnly.Parse(provalores.Data), Times.Once);
        ...
        _mockFProValores.VerifySet(x => x.FDataUltimaCorrecao = DateOnly.Parse(provalores.DataUltimaCorrecao), Times.Once);
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        // Assert
        _mockFProValores.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DataUltimaCorrecao_ShouldNotSetFDataUltimaCorrecao()
    {
        // Arrange
        var provalores = CreateValidProValoresModel();
        ...
        await _provaloresWriter.WriteAsync(provalores, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFProValores.VerifySet(x => x.FDataUltimaCorrecao = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ProValoresWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.ProValores CreateValidProValoresModel()
    {
        return new GerAdv.Models.ProValores
        {
            Id = 0,
