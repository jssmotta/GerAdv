...
import {useRegimeTributacaoFilter} from '@/app/GerAdv_TS/RegimeTributacao/Hooks/hookRegimeTributacaoFilter';
import {useEnquadramentoEmpresaFilter} from '@/app/GerAdv_TS/EnquadramentoEmpresa/Hooks/hookEnquadramentoEmpresaFilter';
...
<FilterDialogButton        
      ...
      />
<FilterDialogButton        
        filter={handlers.windowFilter.filterRegimeTributacao ?? ({} as any) as any}
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({ ...prev, filterRegimeTributacao: f }))
        }        
        onConfirm={async (f: any) => {          
        }}
        title='Filtrar Regime Tributacao'
        buttonText='Regime Tributacao'
        renderInputFilters={renderRegimeTributacaoInputs}
      />
<FilterDialogButton        
        filter={handlers.windowFilter.filterEnquadramentoEmpresa ?? ({} as any) as any}
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({ ...prev, filterEnquadramentoEmpresa: f }))
        }        
        onConfirm={async (f: any) => {          
        }}
        title='Filtrar Enquadramento Empresa'
        buttonText='Enquadramento Empresa'
        renderInputFilters={renderEnquadramentoEmpresaInputs}
      />
...
const { renderInputFilters: renderRegimeTributacaoInputs } = useRegimeTributacaoFilter({
    handleFetchWithFilter: async () => {},
  });
const { renderInputFilters: renderEnquadramentoEmpresaInputs } = useEnquadramentoEmpresaFilter({
    handleFetchWithFilter: async () => {},
  });
