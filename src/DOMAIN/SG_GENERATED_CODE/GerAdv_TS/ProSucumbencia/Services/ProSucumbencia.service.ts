...
export interface IProSucumbenciaService {
  ...
  filterVoice: (filtro?: FilterProSucumbencia, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ProSucumbenciaService implements IProSucumbenciaService {
  ...
  async filterVoice(filtro?: FilterProSucumbencia, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
