...
// useOponentesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Oponentes
"use client";
...
interface UseOponentesGridProps {
  data: IOponentes[];
...
export const useOponentesGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("oponentes-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IOponentes, filters: Record<string, any>) => {
