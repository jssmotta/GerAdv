...
// useGUTPeriodicidadeGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GUTPeriodicidade
"use client";
...
interface UseGUTPeriodicidadeGridProps {
...
export const useGUTPeriodicidadeGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IGUTPeriodicidade, filters: Record<string, any>) => {
