...
export const CargosEscGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ICargosEsc, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-cargosesc'
