                ...
                try
                {
                    ...
                    try
                    {
                        if (DBPrecatoriaDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(preCodigo) FROM {"Precatoria".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) preDtDist,preProcesso,prePrecatoria,preDeprecante,preDeprecado,preOBS,preGUID FROM {"Precatoria".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
