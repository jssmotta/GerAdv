...
const ProcessOutputEngineComboBox: React.FC<DadosSelectProps> = ({
  ...
  const [editRecord, setEditRecord] = useState<IProcessOutputEngine | null>(
    null,
  );
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await processoutputengineService.fetchProcessOutputEngineById(id);
  ...
  const handleSuccess = (newProcessOutputEngine?: IProcessOutputEngine) => {
    if (newProcessOutputEngine) {
      setValue({
        id: newProcessOutputEngine.id,
        nome: newProcessOutputEngine.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <ProcessOutputEngineWindow
          ...
          selectedProcessOutputEngine={
            editRecord || addRecord || ProcessOutputEngineEmpty()
          }
        />
      )}
