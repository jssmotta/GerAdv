...
public partial interface IStatusHTrabReader
{
    ...
    Task<IEnumerable<StatusHTrabResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}