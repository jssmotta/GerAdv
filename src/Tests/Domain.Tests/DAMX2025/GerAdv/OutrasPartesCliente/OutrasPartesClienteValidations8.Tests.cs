...
#region Class Structure Tests
    ...
    private static GerAdv.Models.OutrasPartesCliente CreateValidOutrasPartesCliente()
    {
        return new GerAdv.Models.OutrasPartesCliente
        {
            Id = 1,
            Nome = "João",
            Terceirizado = false,
...
#region CPF Validation Tests
    ...
    public async Task ValidateReg_WithDuplicateCPF_ShouldThrowSGValidationException()
    {
        ...
        _mockOutrasPartesClienteService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterOutrasPartesCliente>(), It.IsAny<string>())).ReturnsAsync([existingOutrasPartesCliente]);
        // Setup other mocks but don't override the OutrasPartesClientes service mock
        _ = _mockCidadeReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<CidadeResponse?>(new CidadeResponse { Id = id }));
        // Act & Assert
