...
#if (!NOTSTORED_Escritorios)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFCNPJ || pFldFCasa || pFldFParceria || pFldFNome || pFldFOAB || pFldFEndereco || pFldFCidade || pFldFBairro || pFldFCEP || pFldFFone || pFldFFax || pFldFSite || pFldFEMail || pFldFOBS || pFldFAdvResponsavel || pFldFSecretaria || pFldFInscEst || pFldFCorrespondente || pFldFTop || pFldFGUID;
