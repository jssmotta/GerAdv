...
public class JusticaValidation : IJusticaValidation
{
    public async Task<bool> CanDelete(int? id, IJusticaService service, IAcaoService acaoService, IAgendaService agendaService, IDivisaoTribunalService divisaotribunalService, IFaseService faseService, IObjetosService objetosService, IPoderJudiciarioAssociadoService poderjudiciarioassociadoService, ITipoRecursoService tiporecursoService, ITribunalService tribunalService, [FromRoute, Required] string uri, MsiSqlConnection oCnn)
    {
        ...
        var poderjudiciarioassociadoExists5 = await poderjudiciarioassociadoService.Filter(BaseConsts.DefaultCheckValidation, new Filters.FilterPoderJudiciarioAssociado { Justica = id ?? default }, uri);
        ...
        var tiporecursoExists6 = await tiporecursoService.Filter(BaseConsts.DefaultCheckValidation, new Filters.FilterTipoRecurso { Justica = id ?? default }, uri);
        ...
        var tribunalExists7 = await tribunalService.Filter(BaseConsts.DefaultCheckValidation, new Filters.FilterTribunal { Justica = id ?? default }, uri);
