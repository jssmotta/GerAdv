...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBJustica
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBJusticaUpdateAdvancedTests : IDisposable
{
    private readonly DBJustica _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBJusticaUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBJustica
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBJustica).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBJustica).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBJustica instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBJustica).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBJustica.PTabelaNome.Should().Be("Justica");
        DBJustica.CampoCodigo.Should().Be("jusCodigo");
    }
