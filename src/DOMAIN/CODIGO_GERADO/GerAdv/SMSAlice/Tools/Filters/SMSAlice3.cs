...
public class FilterSMSAliceWithVoiceRequest
{
    /// <summary>
    /// Filtro de SMSAlice padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterSMSAlice Filter { get; set; } = new();
...
[Serializable]
public partial record FilterSMSAlice
{
    ...
    [JsonPropertyName("filterTipoEMail")]
    [Description("Filtro para a _tabela TipoEMail")]
    public FilterTipoEMail? FilterTipoEMail { get; set; } = new();
    ...
    [Description("TipoEMail -2147483648 para nada ou id")]
    public int TipoEMail { get; set; } = int.MinValue;

    [JsonPropertyName("tipoemail_end")]
    [Description("TipoEMail -2147483648 para nada ou id para final do intervalo")]
    public int TipoEMail_end { get; set; } = int.MinValue;
