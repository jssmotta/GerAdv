...
{
    Task<bool> ValidateReg(Models.Documentos reg, IDocumentosService service, IProcessosReader processosReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn);
...
public class DocumentosValidation : IDocumentosValidation
{
    ...
    public async Task<bool> ValidateReg(Models.Documentos reg, IDocumentosService service, IProcessosReader processosReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn)
    {
        if (reg == null)
