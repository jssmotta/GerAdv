...
export const StatusHTrabGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IStatusHTrab, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-statushtrab'
