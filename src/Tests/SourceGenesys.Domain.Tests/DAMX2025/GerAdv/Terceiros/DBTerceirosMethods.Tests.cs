...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTerceiros
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTerceirosUpdateAdvancedTests : IDisposable
{
    private readonly DBTerceiros _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTerceirosUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTerceiros
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTerceiros).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTerceiros).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTerceiros instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTerceiros).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTerceiros.PTabelaNome.Should().Be("Terceiros");
        DBTerceiros.CampoCodigo.Should().Be("terCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTerceiros();
        dbRec.ID = 1;
