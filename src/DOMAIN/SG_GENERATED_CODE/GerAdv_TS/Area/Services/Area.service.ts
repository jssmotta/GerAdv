...
export interface IAreaService {
  ...
  filterVoice: (filtro?: FilterArea, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class AreaService implements IAreaService {
  ...
  async filterVoice(filtro?: FilterArea, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
