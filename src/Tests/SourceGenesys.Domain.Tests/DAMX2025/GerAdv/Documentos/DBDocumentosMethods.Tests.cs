...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBDocumentos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBDocumentosUpdateAdvancedTests : IDisposable
{
    private readonly DBDocumentos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBDocumentosUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBDocumentos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBDocumentos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBDocumentos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBDocumentos).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBDocumentos.PTabelaNome.Should().Be("Documentos");
        DBDocumentos.CampoCodigo.Should().Be("docCodigo");
    }
