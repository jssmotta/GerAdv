                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(fasCodigo) FROM {"Fase".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) fasDescricao,fasJustica,fasArea,fasGuid FROM {"Fase".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
