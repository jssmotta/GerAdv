...
// copyright © 2000-2026 Menphis - Sistemas Inteligentes
// This file is part of the Source Genesys project
// Tracking: ComboBoxTipoCompromisso.tsx.txt
"use client";
...
import * as Icons from "../../../components/svg/IconsAppointments";
const TipoCompromissoComboBox: React.FC<DadosSelectProps> = ({
  ...
  const handleComboChange = (e: any) => {
    ...
    if (
      ...
      const matchingItem = filteredDados.find(
        (item: ITipoCompromisso) =>
  ...
  const renderComboBoxItem = (li: any, itemProps: any) => {
    ...
    const icone = item.icone || "0";
    const iconeIndex = parseInt(String(icone), 10) || 0;
    const iconKey = `Icone${iconeIndex}`;
  ...
  const renderComboBoxValue = (paramValue: any) => {
    ...
    if (typeof currentValue === "object" && currentValue.id) {
      selectedValueForRender = dados?.find(
        (item: ITipoCompromisso) => item.id === currentValue.id,
      );
    ...
    const icone = selectedValueForRender.icone || "0";
    const iconeIndex = parseInt(String(icone), 10) || 0;
    const iconKey = `Icone${iconeIndex}`;
    const svgIcon = (Icons as any)[iconKey] || (Icons as any).Icone0 || "";
    return (
  ...
  return (
    <>
      <style jsx global>{`
        ...
        /* Estilos para o campo de input com ícone */
        ...
        /* Estilos para ícones SVG (substitui rules que antes miravam <img>) */
        .tipocompromisso-dropdown-popup-msi .k-list-item .svg-icon,
        .tipocompromisso-dropdown-popup-msi .k-list-item .svg-icon svg {
        ...
        /* Também estilizar o valueRender e input */
        .${cssDado} .svg-icon,
        .${cssDado} .svg-icon svg {
          width: 18px !important;
          height: 18px !important;
          display: inline-block !important;
          vertical-align: middle !important;
        ...
        /* avoid forcing all descendants to block; keep SVG and layout rules specific above */
      `}</style>
      {(editRecord || addRecord) && isOpen && (
        <TipoCompromissoWindow
          ...
          selectedTipoCompromisso={
            editRecord || addRecord || TipoCompromissoEmpty()
          }
        />
      )}
