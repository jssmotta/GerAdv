...
#region Class Structure Tests
    ...
    private static GerAdv.Models.ProValores CreateValidProValores()
    {
...
#region ValidateReg Required Indice Method Tests 
    ...
    [Fact]
    public async Task ValidateReg_WithNull_Indice_ShouldThrowSGValidationException()
    {
        // Arrange
        var provalores = CreateValidProValores();
    ...
    [Fact]
    public async Task ValidateReg_WithValidData_Indice_ShouldReturnTrue()
    {
        // Arrange
        var provalores = CreateValidProValores();
        SetupValidMocks();
    ...
    [Fact]
    public async Task ValidateReg_WithWhitespace_Indice_ShouldThrowSGValidationException()
    {
        // Arrange
        var provalores = CreateValidProValores();
        provalores.Indice = " ";
...
#region DataUltimaCorrecao Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_DataUltimaCorrecao_ShouldPass()
    {
        // Arrange
        var provalores = CreateValidProValores();
