...
export interface IReuniaoService {
  ...
  filterVoice: (filtro?: FilterReuniao, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ReuniaoService implements IReuniaoService {
  ...
  async filterVoice(filtro?: FilterReuniao, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
