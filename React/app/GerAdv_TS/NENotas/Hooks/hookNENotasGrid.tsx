...
// useNENotasGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de NENotas
"use client";
...
export const useNENotasGrid = ({
  ...
  const defaultColumnsOrder = useMemo(
    () => ["nome", "nroprocessoinstancia", "nropastaprocessos"],
    [],
  );
  ...
  const filterLogic = useCallback(
    (data: INENotas, filters: Record<string, any>) => {
