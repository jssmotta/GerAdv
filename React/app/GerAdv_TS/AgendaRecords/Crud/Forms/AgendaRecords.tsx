...
const addValorAgenda = (e: any) => {
  ...
  const addValorClientesSocios = (e: any) => {
    if (e?.id>0)
      onChange({ target: { name: 'clientessocios', value: e.id } });
    };
    const addValorColaborador = (e: any) => {
      if (e?.id>0)
        onChange({ target: { name: 'colaborador', value: e.id } });
      };
      const addValorForo = (e: any) => {
        ...
        const onConfirm = (e: React.FormEvent) => {
          ...
          if (e.stopPropagation) e.stopPropagation();
            ...
            if (!isSubmitting) {
              ...
              console.log('Erro ao submeter formulário de AgendaRecords:');
        ...
        const handleDirectSave = () => {
          if (!isSubmitting) {
            ...
            console.log('Erro ao salvar AgendaRecords diretamente');
            setIsSubmitting(false);
            if (onError) onError();
            }
          }
