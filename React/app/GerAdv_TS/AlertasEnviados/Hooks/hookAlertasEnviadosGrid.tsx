...
// useAlertasEnviadosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de AlertasEnviados
'use client';
...
interface UseAlertasEnviadosGridProps {
...
export const useAlertasEnviadosGrid = ({
  data, 
  onRowClick, 
  onDeleteClick, 
  setSelectedId, 
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('alertasenviados-columns-order'), JSON.stringify(reorderableFields));
