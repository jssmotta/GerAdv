...
public class FilterGUTTipoWithVoiceRequest
{
    /// <summary>
    /// Filtro de GUTTipo padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterGUTTipo Filter { get; set; } = new();
...
[Serializable]
public partial record FilterGUTTipo
{
    ...
    [Description("Ordem -2147483648 para nada ou id")]
    public int Ordem { get; set; } = int.MinValue;

    [JsonPropertyName("ordem_end")]
    [Description("Ordem -2147483648 para nada ou id para final do intervalo")]
    public int Ordem_end { get; set; } = int.MinValue;
