...
interface EnderecosGridProps {
  data: IEnderecos[];
  onRowClick: (enderecos: IEnderecos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const EnderecosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IEnderecos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-enderecos'
