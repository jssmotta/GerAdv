                ...
                try
                {
                    ...
                    try
                    {
                        if (DBStatusBiuDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(stbCodigo) FROM {"StatusBiu".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) stbNome,stbTipoStatusBiu,stbOperador,stbIcone FROM {"StatusBiu".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
