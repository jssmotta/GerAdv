...
public partial class DBPrepostos
{
    ...
    public virtual int FSetor
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => field;
        set
        {
            pFldFSetor = pFldFSetor || value != field;
            if (pFldFSetor)
                field = value;
        }
    }
    ...
    public virtual string? FPai
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => field ?? string.Empty;
        set
        {
            pFldFPai = pFldFPai || !(field ?? string.Empty).Equals(value);
            if (pFldFPai)
            {
                var trimmed = value?.Trim() ?? string.Empty;
                field = trimmed.Length > 50 ? trimmed.AsSpan(0, 50).ToString() : trimmed;
    ...
    public virtual string? FMae
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => field ?? string.Empty;
        set
        {
            pFldFMae = pFldFMae || !(field ?? string.Empty).Equals(value);
            if (pFldFMae)
            {
                var trimmed = value?.Trim() ?? string.Empty;
                field = trimmed.Length > 50 ? trimmed.AsSpan(0, 50).ToString() : trimmed;
    ...
    // Tracking Code: 20250503
    [StringLength(150, ErrorMessage = "A propriedade FGuid da tabela 'Prepostos' deve ter no máximo 150 caracteres.")]
