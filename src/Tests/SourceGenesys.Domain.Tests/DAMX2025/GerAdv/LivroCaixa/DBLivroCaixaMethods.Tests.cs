...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBLivroCaixa
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBLivroCaixaUpdateAdvancedTests : IDisposable
{
    private readonly DBLivroCaixa _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBLivroCaixaUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBLivroCaixa).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBLivroCaixa instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBLivroCaixa).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBLivroCaixa).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBLivroCaixa.PTabelaNome.Should().Be("LivroCaixa");
        DBLivroCaixa.CampoCodigo.Should().Be("livCodigo");
    }
