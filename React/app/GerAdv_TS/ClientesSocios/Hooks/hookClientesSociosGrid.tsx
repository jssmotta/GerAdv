...
// useClientesSociosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ClientesSocios
"use client";
...
interface UseClientesSociosGridProps {
...
export const useClientesSociosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IClientesSocios, filters: Record<string, any>) => {
