...
import {
  useTipoOrigemSucumbenciaForm,
  useValidationsTipoOrigemSucumbencia,
} from "../../Hooks/hookTipoOrigemSucumbencia";
...
const TipoOrigemSucumbenciaInc: React.FC<ITipoOrigemSucumbenciaFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadTipoOrigemSucumbencia } =
    useTipoOrigemSucumbenciaForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedTipoOrigemSucumbencia =
        await tipoorigemsucumbenciaService.saveTipoOrigemSucumbencia(data);
