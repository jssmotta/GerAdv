...
const TipoValorProcessoGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <TipoValorProcessoGridMobileComponent data={tipovalorprocesso} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <TipoValorProcessoGridDesktopComponent data={tipovalorprocesso} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
