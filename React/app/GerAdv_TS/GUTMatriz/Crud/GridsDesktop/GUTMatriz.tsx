...
export const GUTMatrizGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IGUTMatriz, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  />, 
  <GridColumn field='nomeguttipo' title='G U T Tipo' sortable={false} filterable={false} />, /* Track G.01 */
  <GridColumn
  field='id'
  width={'55px'}
  title='Excluir'
...
{initialized && (
  ...
  className='grid-desktop-gutmatriz'
