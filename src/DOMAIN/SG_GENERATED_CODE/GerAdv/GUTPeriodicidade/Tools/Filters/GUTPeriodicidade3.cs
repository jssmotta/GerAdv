...
public class FilterGUTPeriodicidadeWithVoiceRequest
{
    /// <summary>
    /// Filtro de GUTPeriodicidade padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterGUTPeriodicidade Filter { get; set; } = new();
...
[Serializable]
public partial record FilterGUTPeriodicidade
{
    ...
    [Description("IntervaloDias -2147483648 para nada ou id")]
    public int IntervaloDias { get; set; } = int.MinValue;

    [JsonPropertyName("intervalodias_end")]
    [Description("IntervaloDias -2147483648 para nada ou id para final do intervalo")]
    public int IntervaloDias_end { get; set; } = int.MinValue;
