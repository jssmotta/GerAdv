                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(posCodigo) FROM {"ProcessOutputSources".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) posNome,posGuid FROM {"ProcessOutputSources".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
