...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBStatusHTrab
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBStatusHTrabUpdateAdvancedTests : IDisposable
{
    private readonly DBStatusHTrab _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBStatusHTrabUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBStatusHTrab
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBStatusHTrab).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBStatusHTrab).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBStatusHTrab instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBStatusHTrab).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBStatusHTrab.PTabelaNome.Should().Be("StatusHTrab");
        DBStatusHTrab.CampoCodigo.Should().Be("shtCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBStatusHTrab();
        dbRec.ID = 1;
