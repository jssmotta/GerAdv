...
export interface IProValoresService {
  ...
  filterVoice: (filtro?: FilterProValores, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class ProValoresService implements IProValoresService {
  ...
  async filterVoice(filtro?: FilterProValores, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
