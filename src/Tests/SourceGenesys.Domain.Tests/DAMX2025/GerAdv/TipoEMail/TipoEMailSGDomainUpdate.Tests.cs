...
public class DBTipoEMailUpdate : IDisposable
{
    private readonly DBTipoEMail _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoEMailUpdate()
    {
    ...
    {
        // Act
        var tipoemail = new DBTipoEMail();
        // Assert
        tipoemail.Should().NotBeNull();
        tipoemail.ITableName().Should().Be("TipoEMail");
        tipoemail.ID.Should().Be(0);
    }
    ...
    // Assert - All properties should be set tipoemail.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        tipoemail.FNome = longString; // MAX: 50
    // Assert - All properties should be set tipoemail.FNome.Should().HaveLength(50);
    }
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        tipoemail.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        tipoemail.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "tmlCodigo = 1";
        // Act & Assert
        var TipoEMail = new DBTipoEMail(sqlWhere, null);
        TipoEMail.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var tipoemail = new DBTipoEMail(parameters, nome, null);
        // Assert
        tipoemail.Should().NotBeNull();
        tipoemail.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        tipoemail.FNome = longName;
        // Assert
        tipoemail.FNome.Should().HaveLength(50);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBTipoEMail).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var tipoemail = new DBTipoEMail();
        // Act & Assert
        tipoemail.TabelaNome.Should().Be("TipoEMail");
    }
