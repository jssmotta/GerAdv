...
// useCargosEscGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de CargosEsc
"use client";
...
interface UseCargosEscGridProps {
  data: ICargosEsc[];
...
export const useCargosEscGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("cargosesc-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: ICargosEsc, filters: Record<string, any>) => {
