...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTipoModeloDocumento
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTipoModeloDocumentoUpdateAdvancedTests : IDisposable
{
    private readonly DBTipoModeloDocumento _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoModeloDocumentoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTipoModeloDocumento
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTipoModeloDocumento).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTipoModeloDocumento).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTipoModeloDocumento instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTipoModeloDocumento).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTipoModeloDocumento.PTabelaNome.Should().Be("TipoModeloDocumento");
        DBTipoModeloDocumento.CampoCodigo.Should().Be("tpdCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTipoModeloDocumento();
        dbRec.ID = 1;
