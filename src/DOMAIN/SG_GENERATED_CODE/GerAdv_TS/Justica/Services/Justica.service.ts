...
export interface IJusticaService {
  ...
  filterVoice: (filtro?: FilterJustica, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class JusticaService implements IJusticaService {
  ...
  async filterVoice(filtro?: FilterJustica, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
