...
public class FDadosProcuracaoFactoryTests : IDisposable
{
    private FDadosProcuracaoFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FDadosProcuracaoFactoryTests()
    {
        _factory = new FDadosProcuracaoFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FDadosProcuracao>();
    }
    ...
    {
        // Arrange
        var factory = new FDadosProcuracaoFactory();
        // Act
        factory.Dispose();
