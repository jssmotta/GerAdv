...
if (getParamFromUrl('tiporecurso') > 0) {
 ...
 const addValorAcao = (e: any) => {
                        if (e?.id>0) 
                        onChange({ target: { name: 'acao', value: e.id } });
                      };
 ...
 const addValorTipoRecurso = (e: any) => {
                        if (e?.id>0) 
                        onChange({ target: { name: 'tiporecurso', value: e.id } });
                      };
  ...
  <>      
        ...
        <div className={isMobile ? 'form-container form-container-Instancia' : 'form-container form-container-Instancia'}>
            ...
            <form className='formInputCadInc' id={`InstanciaForm-${instanciaData.id}`} onSubmit={onConfirm}>
                ...
                {!isMobile && (
                    <ButtonSalvarCrud isMobile={false} validationForm={validationForm} entity='Instancia' data={instanciaData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`InstanciaForm-${instanciaData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                 )}
...
maxLength={25}
            ...
            {isMobile && (
                <ButtonSalvarCrud isMobile={true} validationForm={validationForm} entity='Instancia' data={instanciaData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`InstanciaForm-${instanciaData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                )}
                ...
                <FooterIncDocker>
                  ...
                  />
                   ...
                   <AuditorButton
                    ...
                    <DeleteButton page={'/pages/instancia'} id={instanciaData.id} dadoApi={dadoApi} />
