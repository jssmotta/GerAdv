...
#region TableDefinition_TipoEMail
...
#endregion
    public DBTipoEMail(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBTipoEMail(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBTipoEMail(in string? sqlWhere, SqlConnection? oCnn)
    {
