...
public partial class FTipoProDesposito : MenphisSI.SG.GerAdv.DBTipoProDesposito, IDBTipoProDesposito
{
    // DI-compatible default constructor
    public FTipoProDesposito() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FTipoProDesposito CreateFromReader(SqlDataReader? dbRec)
    {
        return new FTipoProDesposito(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FTipoProDesposito CreateFromDataRow(DataRow? dbRec)
    {
        return new FTipoProDesposito(dbRec);
    }

    private FTipoProDesposito(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FTipoProDesposito(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FTipoProDesposito> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
