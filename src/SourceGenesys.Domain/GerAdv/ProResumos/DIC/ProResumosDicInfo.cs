...
#region PropriedadesDaTabela
    public static DBInfoSystem PrsProcesso => new(0, PTabelaNome, CampoCodigo, Processo, "Processo", "Processo", ETipoDadosSysteminfo.SysteminfoForeingkey, DBProcessosDicInfo.CampoCodigo, DBProcessosDicInfo.TabelaNome, new DBProcessosODicInfo(), false)
    {
        Prefixo = "prs"
    }; // DBI 11 
    public static DBInfoSystem PrsData => new(0, PTabelaNome, CampoCodigo, Data, "Data", "Data", ETipoDadosSysteminfo.SysteminfoDatetime)
    {
        Prefixo = "prs"
    };
    ...
    public static DBInfoSystem PrsGUID => new(0, PTabelaNome, CampoCodigo, GUID, 100, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "prs"
    };
