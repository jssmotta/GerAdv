                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(atvCodigo) FROM {"Atividades".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) atvDescricao,atvGuid FROM {"Atividades".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
