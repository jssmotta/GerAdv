...
interface UseProProcuradoresFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterProProcuradores | undefined | null,
  ) => Promise<void>;
}
...
interface UseProProcuradoresFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterProProcuradores>,
  ) => React.ReactNode;
...
export const useProProcuradoresFilter = ({
  handleFetchWithFilter,
}: UseProProcuradoresFilterProps): UseProProcuradoresFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterProProcuradores>(
