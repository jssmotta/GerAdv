...
public class ContatoCRMViewServiceTests : IDisposable
{
    ...
    public ContatoCRMViewServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new ContatoCRMViewService(_mockAppSettings.Object, _mockContatoCRMViewFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
