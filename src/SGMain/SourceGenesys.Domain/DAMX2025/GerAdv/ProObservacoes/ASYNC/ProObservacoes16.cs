...
public partial class DBProObservacoes
{
    ...
    /// </summary>
    public static async Task<DBProObservacoes> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBProObservacoes();
