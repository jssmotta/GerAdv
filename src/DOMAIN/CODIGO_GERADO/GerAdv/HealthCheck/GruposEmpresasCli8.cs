                ...
                try
                {
                    ...
                    try
                    {
                        if (DBGruposEmpresasCliDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(gecCodigo) FROM {"GruposEmpresasCli".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) gecGrupo,gecCliente,gecOculto FROM {"GruposEmpresasCli".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
