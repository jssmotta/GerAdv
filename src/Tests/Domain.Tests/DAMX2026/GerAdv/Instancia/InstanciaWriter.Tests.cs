...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFInstancia.VerifySet(x => x.FData = DateOnly.Parse(instancia.Data), Times.Once);
        ...
        _mockFInstancia.VerifySet(x => x.FZKeyQuando = DateOnly.Parse(instancia.ZKeyQuando), Times.Once);
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        // Assert
        _mockFInstancia.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_ZKeyQuando_ShouldNotSetFZKeyQuando()
    {
        // Arrange
        var instancia = CreateValidInstanciaModel();
        ...
        await _instanciaWriter.WriteAsync(instancia, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFInstancia.VerifySet(x => x.FZKeyQuando = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new InstanciaWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Instancia CreateValidInstanciaModel()
    {
