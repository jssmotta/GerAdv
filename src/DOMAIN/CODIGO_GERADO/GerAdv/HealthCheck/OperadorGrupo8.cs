                ...
                try
                {
                    ...
                    try
                    {
                        if (DBOperadorGrupoDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(ogrCodigo) FROM {"OperadorGrupo".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) ogrOperador,ogrGrupo,ogrInativo FROM {"OperadorGrupo".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
