...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        // Assert
        result.Should().Be(_mockFProcessosObsReport.Object);
        _mockFProcessosObsReport.VerifySet(x => x.FData = DateOnly.Parse(processosobsreport.Data), Times.Once);
    ...
    public async Task WriteAsync_WithNull_Data_ShouldNotSetFData()
    {
        ...
        // Assert
        _mockFProcessosObsReport.VerifySet(x => x.FData = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new ProcessosObsReportWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.ProcessosObsReport CreateValidProcessosObsReportModel()
    {
