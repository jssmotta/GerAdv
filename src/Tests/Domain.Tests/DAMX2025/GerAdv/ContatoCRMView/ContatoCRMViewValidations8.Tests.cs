...
#region Class Structure Tests
    ...
    private static GerAdv.Models.ContatoCRMView CreateValidContatoCRMView()
    {
...
#region ValidateReg Required IP Method Tests 
    ...
    [Fact]
    public async Task ValidateReg_WithNull_IP_ShouldThrowSGValidationException()
    {
        // Arrange
        var contatocrmview = CreateValidContatoCRMView();
    ...
    [Fact]
    public async Task ValidateReg_WithValidData_IP_ShouldReturnTrue()
    {
        // Arrange
        var contatocrmview = CreateValidContatoCRMView();
        SetupValidMocks();
    ...
    [Fact]
    public async Task ValidateReg_WithWhitespace_IP_ShouldThrowSGValidationException()
    {
        // Arrange
        var contatocrmview = CreateValidContatoCRMView();
        contatocrmview.IP = " ";
