                ...
                try
                {
                    ...
                    try
                    {
                        if (DBCargosEscDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(cgeCodigo) FROM dbo.CargosEsc (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) cgePercentual,cgeNome,cgeClassificacao,cgeGUID FROM dbo.CargosEsc (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
