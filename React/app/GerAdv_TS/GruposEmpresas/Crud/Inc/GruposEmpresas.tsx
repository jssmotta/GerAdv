...
const GruposEmpresasInc: React.FC<IGruposEmpresasFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedGruposEmpresas =
        await gruposempresasService.saveGruposEmpresas(data);
