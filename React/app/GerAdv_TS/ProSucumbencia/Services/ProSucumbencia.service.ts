...
import {
  ProSucumbenciaApi,
  ProSucumbenciaApiError,
} from "../Apis/ApiProSucumbencia";
...
export class ProSucumbenciaValidator {
  static validateProSucumbencia(prosucumbencia: IProSucumbencia): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IProSucumbenciaService {
  ...
  saveProSucumbencia: (
    prosucumbencia: IProSucumbencia,
  ...
  validateProSucumbencia: (prosucumbencia: IProSucumbencia) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
...
export class ProSucumbenciaService implements IProSucumbenciaService {
  ...
  async deleteProSucumbencia(id: number): Promise<void> {
    ...
    try {
      ...
      throw new ProSucumbenciaApiError(
        "Erro ao excluir prosucumbencia",
        500,
        "DELETE_ERROR",
        error,
      );
