...
if (getParamFromUrl("foro") > 0) {
 ...
 const addValorForo = (e: any) => {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-AgendaRecords' : 'form-container form-container-AgendaRecords'}>
       
            <form className='formInputCadInc' id={`AgendaRecordsForm-${agendarecordsData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={agendarecordsData} isSubmitting={isSubmitting} onClose={onClose} formId={`AgendaRecordsForm-${agendarecordsData.id}`} preventPropagation={true} onSave={handleDirectSave} />
