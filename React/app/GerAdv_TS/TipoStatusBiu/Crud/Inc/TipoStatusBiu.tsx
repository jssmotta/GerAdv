...
const TipoStatusBiuInc: React.FC<ITipoStatusBiuFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedTipoStatusBiu =
        await tipostatusbiuService.saveTipoStatusBiu(data);
