                ...
                try
                {
                    ...
                    try
                    {
                        if (DBGUTPeriodicidadeStatusDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(pgsCodigo) FROM dbo.GUTPeriodicidadeStatus (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) pgsGUTAtividade,pgsDataRealizado,pgsGUID FROM dbo.GUTPeriodicidadeStatus (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
