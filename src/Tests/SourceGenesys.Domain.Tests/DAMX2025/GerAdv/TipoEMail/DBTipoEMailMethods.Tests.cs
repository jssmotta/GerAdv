...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTipoEMail
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTipoEMailUpdateAdvancedTests : IDisposable
{
    private readonly DBTipoEMail _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoEMailUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTipoEMail
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTipoEMail).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTipoEMail).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTipoEMail instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTipoEMail).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTipoEMail.PTabelaNome.Should().Be("TipoEMail");
        DBTipoEMail.CampoCodigo.Should().Be("tmlCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTipoEMail();
        dbRec.ID = 1;
