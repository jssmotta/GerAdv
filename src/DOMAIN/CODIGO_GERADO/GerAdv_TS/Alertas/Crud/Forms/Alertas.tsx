...
if (getParamFromUrl("operador") > 0) {
 ...
 const addValorOperador = (e: any) => {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-Alertas' : 'form-container5 form-container-Alertas'}>
       
            <form className='formInputCadInc' id={`AlertasForm-${alertasData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={alertasData} isSubmitting={isSubmitting} onClose={onClose} formId={`AlertasForm-${alertasData.id}`} preventPropagation={true} onSave={handleDirectSave} />
