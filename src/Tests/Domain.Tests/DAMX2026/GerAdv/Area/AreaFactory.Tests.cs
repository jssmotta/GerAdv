...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("areCodigo", typeof(int));
        mockDataTable.Columns.Add("areDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["areCodigo"] = testId;
        row["areDescricao"] = "Test Area";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["areCodigo"] = 123;
        row["areDescricao"] = "Test Area Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FArea properties
        }
    }
