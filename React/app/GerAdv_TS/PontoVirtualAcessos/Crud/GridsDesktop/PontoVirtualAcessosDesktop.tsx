...
export const PontoVirtualAcessosGridDesktopComponent = React.memo(
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("pontovirtualacessos-columns-order"),
        );
        if (savedOrder) {
    ...
    const resetColumnsOrder = useCallback(() => {
      ...
      localStorage.removeItem(btoa("pontovirtualacessos-columns-order"));
    }, []);
      ...
      <>
        ...
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-pontovirtualacessos"
