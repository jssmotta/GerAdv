...
public partial class DBProcessOutPutIDs
{
    ...
    /// </summary>
    public static async Task<DBProcessOutPutIDs> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBProcessOutPutIDs();
