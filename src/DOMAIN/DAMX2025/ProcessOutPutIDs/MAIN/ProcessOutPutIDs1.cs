...
#region TableDefinition_ProcessOutPutIDs
...
#endregion
    public DBProcessOutPutIDs(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBProcessOutPutIDs(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBProcessOutPutIDs(in string? sqlWhere, SqlConnection? oCnn)
    {
