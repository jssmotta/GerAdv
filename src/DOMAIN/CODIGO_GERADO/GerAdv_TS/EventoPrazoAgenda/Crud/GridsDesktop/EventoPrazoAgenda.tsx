...
interface EventoPrazoAgendaGridProps {
  data: IEventoPrazoAgenda[];
  onRowClick: (eventoprazoagenda: IEventoPrazoAgenda) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const EventoPrazoAgendaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IEventoPrazoAgenda, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-eventoprazoagenda'
