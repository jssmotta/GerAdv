...
const TipoContatoCRMInc: React.FC<ITipoContatoCRMFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedTipoContatoCRM =
        await tipocontatocrmService.saveTipoContatoCRM(data);
