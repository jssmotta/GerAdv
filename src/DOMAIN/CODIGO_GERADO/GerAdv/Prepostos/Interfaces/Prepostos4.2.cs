...
public partial interface IPrepostosReader
{
    ...
    Task<IEnumerable<PrepostosResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}