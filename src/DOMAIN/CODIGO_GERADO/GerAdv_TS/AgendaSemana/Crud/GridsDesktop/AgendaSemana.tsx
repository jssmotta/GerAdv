...
export const AgendaSemanaGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='paranome' title='ParaNome' sortable={true} filterable={true} />, /* Track G.02 */
...
{initialized && (
  ...
  className='grid-desktop-agendasemana'
