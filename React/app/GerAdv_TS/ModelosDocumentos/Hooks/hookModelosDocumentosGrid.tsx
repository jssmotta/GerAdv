...
// useModelosDocumentosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ModelosDocumentos
"use client";
...
interface UseModelosDocumentosGridProps {
...
export const useModelosDocumentosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IModelosDocumentos, filters: Record<string, any>) => {
