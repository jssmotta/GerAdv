...
public partial record FilterPreClientes
{
    ...
    [JsonPropertyName("assistido_end")]
    public string? Assistido_end { get; set; } = string.Empty;
    ...
    [JsonPropertyName("assendereco_end")]
    public string? AssEndereco_end { get; set; } = string.Empty;
