...
public class FFuncaoFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FFuncao>();
    }
    ...
    {
        // Arrange
        var factory = new FFuncaoFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("funCodigo", typeof(int));
        mockDataTable.Columns.Add("funDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["funCodigo"] = testId;
        row["funDescricao"] = "Test Funcao";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["funCodigo"] = 123;
        row["funDescricao"] = "Test Funcao Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FFuncao properties
        }
    }
