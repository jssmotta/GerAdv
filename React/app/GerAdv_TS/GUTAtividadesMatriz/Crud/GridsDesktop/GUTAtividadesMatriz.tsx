...
interface GUTAtividadesMatrizGridProps {
  data: IGUTAtividadesMatriz[];
  onRowClick: (gutatividadesmatriz: IGUTAtividadesMatriz) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const GUTAtividadesMatrizGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IGUTAtividadesMatriz, filters: Record<string, any>) => {
...
const gridColumns = useMemo(() => [
  ...
  <GridColumn field='descricaogutmatriz' title='G U T Matriz' sortable={false} filterable={false} />, /* Track G.01 */
...
{initialized && (
  ...
  className='grid-desktop-gutatividadesmatriz'
