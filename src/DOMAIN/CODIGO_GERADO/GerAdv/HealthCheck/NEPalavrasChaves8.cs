                ...
                try
                {
                    ...
                    try
                    {
                        if (DBNEPalavrasChavesDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(npcCodigo) FROM dbo.NEPalavrasChaves (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) npcNome,npcBold FROM dbo.NEPalavrasChaves (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
