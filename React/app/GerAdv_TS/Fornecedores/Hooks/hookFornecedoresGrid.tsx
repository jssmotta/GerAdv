...
// useFornecedoresGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Fornecedores
"use client";
...
interface UseFornecedoresGridProps {
  data: IFornecedores[];
...
export const useFornecedoresGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IFornecedores, filters: Record<string, any>) => {
