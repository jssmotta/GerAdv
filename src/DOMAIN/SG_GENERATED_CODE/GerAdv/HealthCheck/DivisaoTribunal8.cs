                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(divCodigo) FROM {"DivisaoTribunal".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) divNumCodigo,divJustica,divNomeEspecial,divArea,divCidade,divForo,divTribunal,divCodigoDiv,divEndereco,divFone,divFax,divCEP,divObs,divEMail,divAndar,divEtiqueta,divBold,divGuid FROM {"DivisaoTribunal".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
