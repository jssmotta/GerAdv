...
public partial class TipoValorProcessoReader
{
    private static string BuildSqlQuery(string campos, string whereClause, string orderClause, int max, MsiSqlConnection? oCnn = null)
    {
        ...
        var orderQuery = $"{TSql.OrderBy} {DBTipoValorProcessoDicInfo.CampoNome}";
        ...
        var query = $@"SELECT TOP ({max})
                   {campos}
                   FROM {DBTipoValorProcesso.PTabelaNome.dbo(oCnn)}
