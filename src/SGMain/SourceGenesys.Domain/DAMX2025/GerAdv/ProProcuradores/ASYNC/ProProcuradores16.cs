...
public partial class DBProProcuradores
{
    ...
    /// </summary>
    public static async Task<DBProProcuradores> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBProProcuradores();
