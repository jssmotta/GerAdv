...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem OperSituacao => new(0, PTabelaNome, CampoCodigo, Situacao, "Situacao", "Situação do usuário no sistema, indicando se ele está ativo ou inativo, isso pode ser usado para controlar o acesso ao sistema, por exemplo, inativando o usuário quando ele está de licença.", EDataTypeSystemInfo.SystemInfoBoolean, prefixo: "oper", isRequired: true);
