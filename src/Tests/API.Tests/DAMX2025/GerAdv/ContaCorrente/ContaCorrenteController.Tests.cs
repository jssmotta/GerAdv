...
public class ContaCorrenteControllerTests
{
    ...
    public async Task GetAll_WithValidParameters_ReturnsOkWithData()
    {
        // Arrange
        var max = 10;
        var expectedData = new List<RespAll.ContaCorrenteResponseAll>
        {
            new()
            {
                Id = 1
    ...
    public async Task GetById_WithExistingId_ReturnsOkWithData()
    {
        // Arrange
        int id = 1;
        var expectedData = new Resp.ContaCorrenteResponse
        {
            Id = id
        };
    ...
    public async Task GetById_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.GetById(id, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync((Resp.ContaCorrenteResponse? )null);
        // Act
        var result = await _controller.GetById(id, "test-uri");
        // Assert
    ...
    {
        // Arrange
        var model = new Models.ContaCorrente
        {
            Id = 0,
        // Set other required properties
        };
        var expectedResult = new Resp.ContaCorrenteResponse
        {
            Id = 1
        };
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.ContaCorrente>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task AddAndUpdate_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.ContaCorrente();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.ContaCorrente>(), "test-uri")).ReturnsAsync((Resp.ContaCorrenteResponse? )null);
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task AddAndUpdate_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.ContaCorrente();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.ContaCorrente>(), "test-uri")).ThrowsAsync(new Exception("Test exception"));
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task Delete_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.Delete(id, "test-uri")).ReturnsAsync((Resp.ContaCorrenteResponse? )null);
        // Act
        var result = await _controller.Delete(id, "test-uri");
        // Assert
        result.Should().BeOfType<NotFoundResult>();
    ...
    public async Task Validation_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Validation(It.IsAny<Models.ContaCorrente>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task Validation_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.ContaCorrente();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.ContaCorrente>(), "test-uri")).ReturnsAsync((Resp.ContaCorrenteResponse? )null);
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<BadRequestResult>();
    ...
    public async Task Validation_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.ContaCorrente();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.ContaCorrente>(), "test-uri")).ThrowsAsync(new Exception("Validation error"));
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<ObjectResult>();
