...
public class FilterProTipoBaixaWithVoiceRequest
{
    /// <summary>
    /// Filtro de ProTipoBaixa padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterProTipoBaixa Filter { get; set; } = new();
...
[Serializable]
public partial record FilterProTipoBaixa
{
