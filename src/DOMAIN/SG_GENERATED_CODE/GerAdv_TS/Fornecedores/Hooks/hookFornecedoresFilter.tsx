...
interface UseFornecedoresFilterProps {
    handleFetchWithFilter: (filtro?: FilterFornecedores | undefined | null) => Promise<void>;
}
...
interface UseFornecedoresFilterReturn {
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterFornecedores>) => React.ReactNode;
...
export const useFornecedoresFilter = ({ handleFetchWithFilter }: UseFornecedoresFilterProps): UseFornecedoresFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterFornecedores>({} as FilterFornecedores);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterFornecedores;
