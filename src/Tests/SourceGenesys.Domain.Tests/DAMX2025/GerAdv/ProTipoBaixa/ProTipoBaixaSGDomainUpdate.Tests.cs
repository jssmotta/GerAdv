...
public class DBProTipoBaixaUpdate : IDisposable
{
    private readonly DBProTipoBaixa _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProTipoBaixaUpdate()
    {
    ...
    {
        // Act
        var protipobaixa = new DBProTipoBaixa();
        // Assert
        protipobaixa.Should().NotBeNull();
        protipobaixa.ITableName().Should().Be("ProTipoBaixa");
        protipobaixa.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set protipobaixa.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        protipobaixa.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        protipobaixa.FNome = longString; // MAX: 80
        protipobaixa.FGuid = longString; // MAX: 100
        // Assert - All properties should be set protipobaixa.FNome.Should().HaveLength(80);
        protipobaixa.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        protipobaixa.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        protipobaixa.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "ptxCodigo = 1";
        // Act & Assert
        var ProTipoBaixa = new DBProTipoBaixa(sqlWhere, null);
        ProTipoBaixa.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var protipobaixa = new DBProTipoBaixa(parameters, nome, null);
        // Assert
        protipobaixa.Should().NotBeNull();
        protipobaixa.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        protipobaixa.FNome = longName;
        // Assert
        protipobaixa.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBProTipoBaixa).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var protipobaixa = new DBProTipoBaixa();
        // Act & Assert
        protipobaixa.TabelaNome.Should().Be("ProTipoBaixa");
    }
