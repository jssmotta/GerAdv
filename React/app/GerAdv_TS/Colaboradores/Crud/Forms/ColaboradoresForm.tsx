...
import HelpColaboradores from "../../Help/HelpColaboradores";
  ...
  return (
    <>
      ...
      >
        ...
        <FooterIncDocker>
          <CrudButton title="Colaboradores" windowCrud={ColaboradoresPage} />
          ...
          <HelpButton
            title="Colaboradores"
            page={(onClose) => <HelpColaboradores onClose={onClose} />}
          />
        </FooterIncDocker>
      </div>
