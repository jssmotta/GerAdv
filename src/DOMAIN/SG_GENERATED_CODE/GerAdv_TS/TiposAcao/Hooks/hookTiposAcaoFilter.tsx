...
interface UseTiposAcaoFilterProps {
    handleFetchWithFilter: (filtro?: FilterTiposAcao | undefined | null) => Promise<void>;
}
...
interface UseTiposAcaoFilterReturn {
    ...
    // Render function
    renderInputFilters: (handlers: FilterHandlers<FilterTiposAcao>) => React.ReactNode;
...
export const useTiposAcaoFilter = ({ handleFetchWithFilter }: UseTiposAcaoFilterProps): UseTiposAcaoFilterReturn => {
    const [showSearch, setShowSearch] = useState(false);
    const [windowFilter, setWindowFilter] = useState<FilterTiposAcao>({} as FilterTiposAcao);

    // Handlers do Dialog
    const handleSearch = () => {
        setShowSearch(true);
        const filterWildechar = {...windowFilter, wildcardChar: '%' } as FilterTiposAcao;
