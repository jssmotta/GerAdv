...
public partial class DBProSucumbencia
{
    ...
    /// </summary>
    public static async Task<DBProSucumbencia> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBProSucumbencia();
