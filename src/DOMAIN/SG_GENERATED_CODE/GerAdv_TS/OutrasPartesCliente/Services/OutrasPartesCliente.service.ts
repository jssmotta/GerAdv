...
export interface IOutrasPartesClienteService {
  ...
  filterVoice: (filtro?: FilterOutrasPartesCliente, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class OutrasPartesClienteService implements IOutrasPartesClienteService {
  ...
  async filterVoice(filtro?: FilterOutrasPartesCliente, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
