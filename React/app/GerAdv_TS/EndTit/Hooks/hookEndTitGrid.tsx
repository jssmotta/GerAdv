...
// useEndTitGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de EndTit
'use client';
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('endtit-columns-order'), JSON.stringify(reorderableFields));
