...
// useTipoEnderecoSistemaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoEnderecoSistema
"use client";
...
interface UseTipoEnderecoSistemaGridProps {
...
export const useTipoEnderecoSistemaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseTipoEnderecoSistemaGridProps) => {
  ...
  const filterLogic = useCallback(
    (data: ITipoEnderecoSistema, filters: Record<string, any>) => {
