                ...
                try
                {
                    ...
                    try
                    {
                        if (DBGruposEmpresasDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) grpEMail,grpInativo,grpOponente,grpDescricao,grpObservacoes,grpCliente,grpGUID,grpIcone,grpDespesaUnificada FROM {"GruposEmpresas".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
