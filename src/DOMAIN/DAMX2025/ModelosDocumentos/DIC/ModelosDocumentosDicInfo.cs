...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem MdcQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem MdcQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string TipoModeloDocumentoDiff(int id) => TipoModeloDocumento.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string TipoModeloDocumentoSql(int id) => TipoModeloDocumento.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string TipoModeloDocumentoIsNull => TipoModeloDocumento.SqlCmdIsNull() ?? string.Empty;
    public static string TipoModeloDocumentoNotIsNull => TipoModeloDocumento.SqlCmdNotIsNull() ?? string.Empty;
