...
interface SetorFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-Setor' : 'form-container5 form-container-Setor'}>
       
            <form className='formInputCadInc' id={`SetorForm-${setorData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={setorData} isSubmitting={isSubmitting} onClose={onClose} formId={`SetorForm-${setorData.id}`} preventPropagation={true} onSave={handleDirectSave} />
