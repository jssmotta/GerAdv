                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(agqCodigo) FROM {"AgendaQuem".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) agqIDAgenda,agqAdvogado,agqFuncionario,agqPreposto FROM {"AgendaQuem".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
