...
const TipoModeloDocumentoComboBox: React.FC<DadosSelectProps> = ({
  ...
  const [editRecord, setEditRecord] = useState<ITipoModeloDocumento | null>(
    null,
  );
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await tipomodelodocumentoService.fetchTipoModeloDocumentoById(id);
  ...
  const handleSuccess = (newTipoModeloDocumento?: ITipoModeloDocumento) => {
    if (newTipoModeloDocumento) {
      setValue({
        id: newTipoModeloDocumento.id,
        nome: newTipoModeloDocumento.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <TipoModeloDocumentoWindow
          ...
          selectedTipoModeloDocumento={
            editRecord || addRecord || TipoModeloDocumentoEmpty()
          }
        />
      )}
