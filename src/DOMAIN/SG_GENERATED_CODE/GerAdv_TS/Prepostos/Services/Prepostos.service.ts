...
export interface IPrepostosService {
  ...
  filterVoice: (filtro?: FilterPrepostos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class PrepostosService implements IPrepostosService {
  ...
  async filterVoice(filtro?: FilterPrepostos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
