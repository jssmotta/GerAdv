...
public partial class FTipoValorProcesso : MenphisSI.SG.GerAdv.DBTipoValorProcesso, IDBTipoValorProcesso
{
    // DI-compatible default constructor
    public FTipoValorProcesso() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FTipoValorProcesso CreateFromReader(SqlDataReader? dbRec)
    {
        return new FTipoValorProcesso(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FTipoValorProcesso CreateFromDataRow(DataRow? dbRec)
    {
        return new FTipoValorProcesso(dbRec);
    }

    private FTipoValorProcesso(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FTipoValorProcesso(DataRow? dbRec) : base(dbRec)
    {
    }

    public async Task<FTipoValorProcesso> CreateFromIdAsync(int id, MsiSqlConnection oCnn)
    {
        var fTipoValorProcesso = new FTipoValorProcesso();
        await fTipoValorProcesso.CarregarAsync(id, oCnn);
        return fTipoValorProcesso;
    }

    private FTipoValorProcesso(List<SqlParameter> parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FTipoValorProcesso CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FTipoValorProcesso(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }
