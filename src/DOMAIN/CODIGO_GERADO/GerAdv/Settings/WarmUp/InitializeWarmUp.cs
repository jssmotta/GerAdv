...
public class InitializeWarmUp
{
    public static async Task WarmUpAuditor(IOptions<AppSettings> appSettings)
    {
        ...
        await new Agenda2AgendaWarmUp().WarmReadStringAuditor(uri, oCnn);
        await new AgendaFinanceiroWarmUp().WarmReadStringAuditor(uri, oCnn);
        await new AgendaRepetirWarmUp().WarmReadStringAuditor(uri, oCnn);
        await new AgendaStatusWarmUp().WarmReadStringAuditor(uri, oCnn);
        await new AlarmSMSWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new ApensoWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new ContatoCRMWarmUp().WarmReadStringAuditor(uri, oCnn);
        await new ContatoCRMOperadorWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new DocsRecebidosItensWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new HistoricoWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new LivroCaixaClientesWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new OperadorGruposAgendaOperadoresWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new PrecatoriaWarmUp().WarmReadStringAuditor(uri, oCnn);
        ...
        await new ProcessosWarmUp().WarmReadStringAuditor(uri, oCnn);
