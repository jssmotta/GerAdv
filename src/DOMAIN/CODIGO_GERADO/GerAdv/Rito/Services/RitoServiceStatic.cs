...
public partial class RitoService
{
    private (string where, List<SqlParameter> parametros)? WFiltro(Filters.FilterRito filtro)
    {
        ...
        {
            parameters.Add(new($"@{nameof(DBRitoDicInfo.Descricao)}", ApplyWildCard(filtro.WildcardChar, filtro.Descricao)));
        }

        if (filtro.Top != int.MinValue)
        {
            parameters.Add(new($"@{nameof(DBRitoDicInfo.Top)}", filtro.Top));
        }

        if (!string.IsNullOrEmpty(filtro.GUID))
        {
            parameters.Add(new($"@{nameof(DBRitoDicInfo.GUID)}", ApplyWildCard(filtro.WildcardChar, filtro.GUID)));
        }

        if (filtro.Codigo_filtro != int.MinValue)
        {
            parameters.Add(new($"@{nameof(DBRitoDicInfo.CampoCodigo)}", filtro.Codigo_filtro));
        }
