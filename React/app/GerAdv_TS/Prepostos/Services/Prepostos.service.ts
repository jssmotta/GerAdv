...
export class PrepostosValidator {
  static validatePrepostos(prepostos: IPrepostos): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
...
export interface IPrepostosService {
  ...
  validatePrepostos: (prepostos: IPrepostos) => {
    isValid: boolean;
    errors: string[];
  };
  filterVoice: (
