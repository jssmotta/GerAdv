                ...
                try
                {
                    ...
                    try
                    {
                        if (DBColaboradoresDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) colCargo,colCliente,colSexo,colNome,colCPF,colRG,colDtNasc,colIdade,colEndereco,colBairro,colCEP,colCidade,colFone,colObservacao,colEMail,colCNH,colClass FROM {"Colaboradores".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
