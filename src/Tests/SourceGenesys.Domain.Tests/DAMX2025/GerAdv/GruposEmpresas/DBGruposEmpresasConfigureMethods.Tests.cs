...
#region Fields_All
    ...
    public void ConfigureUpdateFields_EMail_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        ...
        _gruposempresas.FEMail.Should().Be("");
        _gruposempresas.FOponente.Should().Be(0);
    }
    ...
    public void ConfigureMethodsDescricao_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        _gruposempresas.FDescricao.Should().Be("");
    ...
    public void ConfigureMethodsObservacoes_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _gruposempresas.FObservacoes.Should().Be("");
        _gruposempresas.AuditorQuem.Should().Be(99);
    }
    ...
    public void ConfigureMethodsIcone_Integration_BothMethodsWorkTogether_ShouldNotInterfere()
    {
        ...
        exception.Should().NotBeNull();
        // Assert - Both update and audit configuration should work
        _gruposempresas.FIcone.Should().Be("");
        _gruposempresas.AuditorQuem.Should().Be(99);
    }
    ...
    [Fact]
    public void ConfigureUpdateFields_Icone_Integration_WithAllFieldsChanged_ShouldProcessAllFields()
    {
        // Arrange
        SetAllFieldFlags(true);
        SetAllFieldValues();
