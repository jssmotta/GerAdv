                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(tccCodigo) FROM {"TipoContatoCRM".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) tccNome,tccBold,tccGuid FROM {"TipoContatoCRM".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
