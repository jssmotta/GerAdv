...
// Source:SGMethodsTests
namespace MenphisSI.GerAdv.Tests;
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBAcao
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBAcaoUpdateAdvancedTests : IDisposable
{
    private readonly DBAcao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBAcaoUpdateAdvancedTests()
    {
...
#region Business Logic Tests
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBAcao
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBAcao).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
    ...
    public void Update_WithValid_Descricao_Values_ShouldNotThrow(string nome)
    {
        // Arrange
        _instance.ID = 0;
    ...
    [Fact]
    public void Update_BusinessRule_Empty_Descricao_ShouldEnforceValidation()
    {
        // Arrange
        _instance.ID = 1;
    ...
    public void Update_AfterMultiplePropertyChanges_ShouldTrackChangesCorrectly()
    {
        ...
        _instance.FDescricao = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
        _instance.FDescricao = "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB";
        _instance.FDescricao = "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCc";
        // Act & Assert
...
#region State Management Tests
    ...
    public void Update_StateManagement_ShouldPreserveInstanceState()
    {
        ...
        // Assert
        _instance.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBAcao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBAcao instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBAcao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBAcao.PTabelaNome.Should().Be("Acao");
        DBAcao.CampoCodigo.Should().Be("acaCodigo");
    }
...
#region Integration-like Tests
    ...
    public void Update_CompleteWorkflow_Insert_ShouldExecuteAllSteps()
    {
        ...
        // Assert
        result.Should().Be(null);
        dbRec.FDescricao.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    ...
    public void Update_Boundary_MaxLengthDescricao()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FDescricao = new string ('A', 255); // Maximum length
        SetFieldChanged("pFldFDescricao", true);
        // Act & Assert
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FDescricao.Length.Should().Be(255);
    }
    ...
    public void Update_ComplexScenario_MultipleChangesInSequence()
    {
        ...
        var exception = Record.Exception(() => _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
        _instance.FDescricao.Should().Be("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCc");
    }
    ...
    public void Update_WithMaxLengthDescricao_ShouldBeHandledCorrectly()
    {
        // Arrange
        _instance.ID = 0;
        _instance.FDescricao = new string ('A', 255); // Max length for Descricao
        int? result = null;
        // Act
        var exception = Record.Exception(() => result = _instance.Update(_mockConnection.Object));
        exception.Should().NotBeNull();
...
#region Integration-Style Tests
    ...
    public void Update_Integration_FullCRUDCycle()
    {
        ...
        exception.Should().NotBeNull();
        // UPDATE
        dbRec.FDescricao = "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB";
        dbRec.ID = 1;
        ...
        dbRec.FDescricao.Should().Be("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB");
    }
