...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProCDA
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProCDAUpdateAdvancedTests : IDisposable
{
    private readonly DBProCDA _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProCDAUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBProCDA
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBProCDA).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProCDA).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProCDA instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProCDA).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProCDA.PTabelaNome.Should().Be("ProCDA");
        DBProCDA.CampoCodigo.Should().Be("pcdCodigo");
    }
