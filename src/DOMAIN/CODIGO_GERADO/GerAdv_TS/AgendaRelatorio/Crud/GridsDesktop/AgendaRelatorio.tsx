...
interface AgendaRelatorioGridProps {
  ...
  onRowClick: (agendarelatorio: IAgendaRelatorio) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AgendaRelatorioGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAgendaRelatorio, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-agendarelatorio'
