...
public partial class DBGUTPeriodicidadeStatus
{
    ...
    /// </summary>
    public static async Task<DBGUTPeriodicidadeStatus> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBGUTPeriodicidadeStatus();
