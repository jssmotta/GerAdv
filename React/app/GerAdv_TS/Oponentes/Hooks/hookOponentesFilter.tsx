...
interface UseOponentesFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterOponentes | undefined | null,
  ) => Promise<void>;
}
...
interface UseOponentesFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterOponentes>,
  ) => React.ReactNode;
...
export const useOponentesFilter = ({
  handleFetchWithFilter,
}: UseOponentesFilterProps): UseOponentesFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterOponentes>(
    {} as FilterOponentes,
  );
  ...
  const clearFilter = () => {
    setWindowFilter({} as FilterOponentes);
    sessionStorage.removeItem(btoa("OponentesFilter"));
    handleFetchWithFilter({} as FilterOponentes);
  };
