...
{
    Task<string> ValidateReg(Models.AgendaRepetir reg, IAgendaRepetirService service, IAdvogadosReader advogadosReader, IClientesReader clientesReader, IFuncionariosReader funcionariosReader, IProcessosReader processosReader, [FromRoute, Required] string uri, SqlConnection oCnn);
}

public class AgendaRepetirValidation : IAgendaRepetirValidation
{
    public async Task<string> ValidateReg(Models.AgendaRepetir reg, IAgendaRepetirService service, IAdvogadosReader advogadosReader, IClientesReader clientesReader, IFuncionariosReader funcionariosReader, IProcessosReader processosReader, [FromRoute, Required] string uri, SqlConnection oCnn)
    {
        if (reg == null)
