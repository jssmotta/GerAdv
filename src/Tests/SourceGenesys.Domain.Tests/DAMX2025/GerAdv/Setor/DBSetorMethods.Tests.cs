...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBSetor
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBSetorUpdateAdvancedTests : IDisposable
{
    private readonly DBSetor _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBSetorUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBSetor
            {
                ID = 0,
                FDescricao = $"N{i}"};
            var fieldInfo = typeof(DBSetor).GetField("pFldFDescricao", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBSetor).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBSetor instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBSetor).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBSetor.PTabelaNome.Should().Be("Setor");
        DBSetor.CampoCodigo.Should().Be("setCodigo");
    }
