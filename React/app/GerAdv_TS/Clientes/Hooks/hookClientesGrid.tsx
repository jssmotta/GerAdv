...
// useClientesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Clientes
"use client";
...
interface UseClientesGridProps {
  data: IClientes[];
...
export const useClientesGrid = ({
  ...
  const filterLogic = useCallback(
    (data: IClientes, filters: Record<string, any>) => {
