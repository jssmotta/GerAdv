...
public partial interface IEventoPrazoAgendaReader
{
    ...
    Task<IEnumerable<EventoPrazoAgendaResponseAll>> ListarAsync(MsiSqlConnection oCnn, int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}