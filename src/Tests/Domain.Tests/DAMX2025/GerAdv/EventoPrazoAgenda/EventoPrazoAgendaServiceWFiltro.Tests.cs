...
#region String Tests
        ...
        [Fact]
        public void WFiltro_NomeEventoPrazoAgenda_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeEventoPrazoAgenda = "João Silva";
            var filtro = new FilterEventoPrazoAgenda
            {
                Nome = nomeEventoPrazoAgenda,
        ...
        [Fact]
        public void WFiltro_NomeEventoPrazoAgenda_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterEventoPrazoAgenda
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeEventoPrazoAgenda_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeEventoPrazoAgenda)
        {
            // Arrange
            var filtro = new FilterEventoPrazoAgenda
            {
        ...
        [Fact]
        public void WFiltro_NomeEventoPrazoAgenda_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterEventoPrazoAgenda
            {
            ...
            resultado.Value.where.Should().Contain("@epaNome");
            resultado.Value.where.Should().Contain($"@{DBEventoPrazoAgenda.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @epaNome");
            resultado.Value.where.Should().Contain($"= @{DBEventoPrazoAgenda.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeEventoPrazoAgenda_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeEventoPrazoAgenda = "João Silva";
            var filtro = new FilterEventoPrazoAgenda
            ...
            resultado.Value.where.Should().Contain($"[{DBEventoPrazoAgendaDicInfo.PTabelaNome}].[{DBEventoPrazoAgendaDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @epaNome");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@epaNome");
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEventoPrazoAgendaDicInfo.PTabelaNome}].[{DBEventoPrazoAgendaDicInfo.CampoCodigo}] = @{DBEventoPrazoAgendaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBEventoPrazoAgendaDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEventoPrazoAgendaDicInfo.PTabelaNome}].{DBEventoPrazoAgendaDicInfo.CampoCodigo} BETWEEN @{DBEventoPrazoAgendaDicInfo.CampoCodigo} AND @{DBEventoPrazoAgendaDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEventoPrazoAgendaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBEventoPrazoAgendaDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEventoPrazoAgendaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBEventoPrazoAgendaDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEventoPrazoAgendaDicInfo.PTabelaNome}].{DBEventoPrazoAgendaDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEventoPrazoAgendaDicInfo.PTabelaNome}].{DBEventoPrazoAgendaDicInfo.CampoCodigo} BETWEEN @{DBEventoPrazoAgendaDicInfo.CampoCodigo} AND @{DBEventoPrazoAgendaDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBEventoPrazoAgendaDicInfo.PTabelaNome}].[{DBEventoPrazoAgendaDicInfo.CampoCodigo}] = @{DBEventoPrazoAgendaDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBEventoPrazoAgendaDicInfo.PTabelaNome}].[{DBEventoPrazoAgendaDicInfo.CampoCodigo}]");
        }
