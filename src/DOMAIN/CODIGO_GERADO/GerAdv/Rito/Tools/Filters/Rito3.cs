...
[Serializable]
public class FilterRitoWithVoiceRequest
{
    /// <summary>
    /// Filtro de Rito padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterRito Filter { get; set; } = new();
...
[Serializable]
public partial record FilterRito
{
    ...
    [Description("ritDescricao")]
    public string? Descricao { get; set; } = string.Empty;

    [JsonPropertyName("top")]
    [Description("ritTop -2147483648 para nada; 0 para não, 1 para sim")]
    public int Top { get; set; } = int.MinValue;

    [JsonPropertyName("bold")]
    [Description("ritBold -2147483648 para nada; 0 para não, 1 para sim")]
