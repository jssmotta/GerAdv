...
interface ContatoCRMOperadorGridProps {
  data: IContatoCRMOperador[];
  onRowClick: (contatocrmoperador: IContatoCRMOperador) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ContatoCRMOperadorGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IContatoCRMOperador, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-contatocrmoperador'
