                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(colCodigo) FROM {"Colaboradores".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) colCargo,colCliente,colSexo,colNome,colCPF,colRG,colDtNasc,colIdade,colEndereco,colBairro,colCEP,colCidade,colFone,colObservacao,colEMail,colCNH,colClass,colEtiqueta,colAni,colBold FROM {"Colaboradores".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
