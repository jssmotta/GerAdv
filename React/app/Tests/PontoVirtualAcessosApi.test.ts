...
import { PontoVirtualAcessosApiError } from '../GerAdv_TS/PontoVirtualAcessos/Apis/ApiPontoVirtualAcessos';
import { PontoVirtualAcessosApi } from '@/app/GerAdv_TS/PontoVirtualAcessos/Apis/ApiPontoVirtualAcessos';
import { FilterPontoVirtualAcessos } from '../GerAdv_TS/PontoVirtualAcessos/Filters/PontoVirtualAcessos';
...
describe('PontoVirtualAcessosApi', () => {
  let pontovirtualacessosApi: PontoVirtualAcessosApi;
  ...
  beforeEach(() => {
    ...
    pontovirtualacessosApi = new PontoVirtualAcessosApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(pontovirtualacessosApi).toBeInstanceOf(PontoVirtualAcessosApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new PontoVirtualAcessosApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(PontoVirtualAcessosApi);
    });
  });
  ...
  describe('getAll', () => {
    const mockResponse: AxiosResponse = {
      data: [PontoVirtualAcessosTestEmpty()],
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch all pontovirtualacessos items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await pontovirtualacessosApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(pontovirtualacessosApi.getAll()).rejects.toThrow(PontoVirtualAcessosApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await pontovirtualacessosApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-PontoVirtualAcessos_last_getAll_${200}`)));
    });
    ...
    it('should throw PontoVirtualAcessosApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockPontoVirtualAcessos = PontoVirtualAcessosTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockPontoVirtualAcessos,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch pontovirtualacessos by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await pontovirtualacessosApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockPontoVirtualAcessos));
      ...
      expect(result.data).toEqual(mockPontoVirtualAcessos);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'PontoVirtualAcessos',
          id: 1,
  ...
  describe('filter', () => {
    const mockFilter: FilterPontoVirtualAcessos = {
      funcionario: 1,
      data: '2024-01-01',
    };
    ...
    it('should filter pontovirtualacessos items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await pontovirtualacessosApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    const mockPontoVirtualAcessos: IPontoVirtualAcessos = {
      id: 0,
      funcionario: 1,
      tipocompromisso: 1,
      fornecedor: 1,
    ...
    it('should add new pontovirtualacessos successfully', async () => {
      const responsePontoVirtualAcessos = { ...mockPontoVirtualAcessos, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responsePontoVirtualAcessos,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await pontovirtualacessosApi.addAndUpdate(mockPontoVirtualAcessos);

      expect(mockedAxios.post).toHaveBeenCalledWith(
        expect.stringContaining('/AddAndUpdate'),
        mockPontoVirtualAcessos,
        expect.any(Object)
      );
      expect(result).toEqual(mockResponse);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
    ...
    it('should update existing pontovirtualacessos successfully', async () => {
      const existingPontoVirtualAcessos = { ...mockPontoVirtualAcessos, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingPontoVirtualAcessos,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await pontovirtualacessosApi.addAndUpdate(existingPontoVirtualAcessos);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(pontovirtualacessosApi.addAndUpdate(mockPontoVirtualAcessos)).rejects.toThrow(PontoVirtualAcessosApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'PontoVirtualAcessos',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete pontovirtualacessos successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await pontovirtualacessosApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(pontovirtualacessosApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'PontoVirtualAcessos',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(pontovirtualacessosApi.delete(1)).rejects.toThrow(PontoVirtualAcessosApiError);
    });
  });

  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterPontoVirtualAcessos = { funcionario: 1 };
      
      const result = pontovirtualacessosApi.useFilter(mockFilter);
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await pontovirtualacessosApi.delete(1);
  ...
  describe('PontoVirtualAcessosApiError', () => {
    it('should create error with correct properties', () => {
      const error = new PontoVirtualAcessosApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('PontoVirtualAcessosApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new PontoVirtualAcessosApiError('Test message', 500);
