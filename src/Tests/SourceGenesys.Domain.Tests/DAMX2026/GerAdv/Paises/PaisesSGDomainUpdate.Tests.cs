...
public class DBPaisesUpdate : IDisposable
{
    private readonly DBPaises _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBPaisesUpdate()
    {
    ...
    {
        // Act
        var paises = new DBPaises();
        // Assert
        paises.Should().NotBeNull();
        paises.ITableName().Should().Be("Paises");
        paises.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set paises.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        paises.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        paises.FNome = longString; // MAX: 80
        paises.FGuid = longString; // MAX: 100
        // Assert - All properties should be set paises.FNome.Should().HaveLength(80);
        paises.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        paises.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "paiCodigo = 1";
        // Act & Assert
        var Paises = new DBPaises(sqlWhere, null);
        Paises.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var paises = new DBPaises(parameters, nome, null);
        // Assert
        paises.Should().NotBeNull();
        paises.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        paises.FNome = longName;
        // Assert
        paises.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBPaises).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var paises = new DBPaises();
        // Act & Assert
        paises.TabelaNome.Should().Be("Paises");
    }
