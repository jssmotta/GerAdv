...
[Serializable]
public partial record FilterAgendaStatus
{
    ...
    public int Completed { get; set; } = int.MinValue;

    [JsonPropertyName("completed_end")]
    public int Completed_end { get; set; } = int.MinValue;
