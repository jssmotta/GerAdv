...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBContatoCRMView
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBContatoCRMViewUpdateAdvancedTests : IDisposable
{
    private readonly DBContatoCRMView _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBContatoCRMViewUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBContatoCRMView).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBContatoCRMView instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBContatoCRMView).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBContatoCRMView).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBContatoCRMView.PTabelaNome.Should().Be("ContatoCRMView");
        DBContatoCRMView.CampoCodigo.Should().Be("ccwCodigo");
    }
