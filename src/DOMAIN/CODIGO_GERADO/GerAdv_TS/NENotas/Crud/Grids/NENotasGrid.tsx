...
const NENotasGrid: React.FC = () => {
    ...
    return (
      <>
        ...
        {isMobile ?
           <NENotasGridMobileComponent data={nenotas} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> :
           <NENotasGridDesktopComponent data={nenotas} onRowClick={handleRowClick} onDeleteClick={onDeleteClick} /> }       
