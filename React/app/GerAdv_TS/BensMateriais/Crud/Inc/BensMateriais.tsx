...
const BensMateriaisInc: React.FC<IBensMateriaisFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedBensMateriais =
        await bensmateriaisService.saveBensMateriais(data);
