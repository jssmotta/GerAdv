    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("gutatividades-columns-order"),
        );
        if (savedOrder) {
      ...
      return (
        <>
          <td>
            <div
              onClick={() =>
                openSearchCellGUTAtividadesMatriz(props.dataItem.id)
              }
            >
              <span title="Pesquisar relacionados em G U T Atividades Matriz">
      ...
      return (
        <>
          <td>
            <div
              onClick={() =>
                openSearchCellGUTPeriodicidadeStatus(props.dataItem.id)
              }
            >
              <span title="Pesquisar relacionados em G U T Periodicidade Status">
                <SvgIcon icon={searchIcon} />
              </span>
            </div>
          </td>
