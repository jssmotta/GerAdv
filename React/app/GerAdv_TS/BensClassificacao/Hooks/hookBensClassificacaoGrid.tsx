...
// useBensClassificacaoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de BensClassificacao
"use client";
...
interface UseBensClassificacaoGridProps {
...
export const useBensClassificacaoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IBensClassificacao, filters: Record<string, any>) => {
