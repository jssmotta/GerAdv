...
interface DocumentosGridProps {
  data: IDocumentos[];
  onRowClick: (documentos: IDocumentos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const DocumentosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IDocumentos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-documentos'
