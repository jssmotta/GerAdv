...
public partial interface IAgendaRelatorioReader
{
    ...
    Task<IEnumerable<AgendaRelatorioResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}