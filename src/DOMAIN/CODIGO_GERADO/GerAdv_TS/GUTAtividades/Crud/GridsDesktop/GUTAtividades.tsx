...
export const GUTAtividadesGridDesktopComponent: React.FC<GUTAtividadesGridProps> = ({
	data,
	onRowClick,
	onDeleteClick,
	setSelectedId,
...
const EditarCellGUTAtividadesMatriz = (props: any) => {
    return (
      <>
        <td>
            <div onClick={() => openConsultaGUTAtividadesMatriz(props.dataItem.id)}><img width='16' height='16' src='https://cdn.menphis.com.br/msi/v20/editar.webp' title='Editar G U T Atividades Matriz' />&nbsp;</div>
        </td>
      </>
    );
}; 
...
const EditarCellGUTPeriodicidadeStatus = (props: any) => {
    return (
      <>
        <td>
            <div onClick={() => openConsultaGUTPeriodicidadeStatus(props.dataItem.id)}><img width='16' height='16' src='https://cdn.menphis.com.br/msi/v20/editar.webp' title='Editar G U T Periodicidade Status' />&nbsp;</div>
        </td>
      </>
    );
};
