...
const FornecedoresInc: React.FC<IFornecedoresFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedFornecedores =
        await fornecedoresService.saveFornecedores(data);
