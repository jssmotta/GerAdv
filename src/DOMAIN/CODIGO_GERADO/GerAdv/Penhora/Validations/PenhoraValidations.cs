...
{
    Task<bool> ValidateReg(Models.Penhora reg, IPenhoraService service, IProcessosReader processosReader, IPenhoraStatusReader penhorastatusReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn);
...
public class PenhoraValidation : IPenhoraValidation
{
    ...
    public async Task<bool> ValidateReg(Models.Penhora reg, IPenhoraService service, IProcessosReader processosReader, IPenhoraStatusReader penhorastatusReader, [FromRoute, Required] string uri, MsiSqlConnection oCnn)
    {
        if (reg == null)
