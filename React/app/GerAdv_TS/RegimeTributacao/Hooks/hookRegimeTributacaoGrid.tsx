...
// useRegimeTributacaoGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de RegimeTributacao
"use client";
...
interface UseRegimeTributacaoGridProps {
...
export const useRegimeTributacaoGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IRegimeTributacao, filters: Record<string, any>) => {
