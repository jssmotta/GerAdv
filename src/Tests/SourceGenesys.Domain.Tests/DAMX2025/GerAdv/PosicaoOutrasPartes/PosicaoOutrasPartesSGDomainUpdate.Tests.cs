...
public class DBPosicaoOutrasPartesUpdate : IDisposable
{
    private readonly DBPosicaoOutrasPartes _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBPosicaoOutrasPartesUpdate()
    {
...
#region Testes de Guid
    ...
    public void FDescricao_Property_ShouldAcceptValidNames(string Descricao)
    {
        ...
        // Assert
        posicaooutraspartes.FDescricao.Should().Be(Descricao);
    }
    ...
    public void FDescricao_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        posicaooutraspartes.FDescricao.Should().Be(string.Empty);
    }
    ...
    public void FDescricao_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        posicaooutraspartes.FDescricao = longName;
        // Assert
        posicaooutraspartes.FDescricao.Should().HaveLength(30);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBPosicaoOutrasPartes).GetField("pFldFDescricao", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FDescricao = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var posicaooutraspartes = new DBPosicaoOutrasPartes();
        // Act & Assert
        posicaooutraspartes.TabelaNome.Should().Be("PosicaoOutrasPartes");
    }
