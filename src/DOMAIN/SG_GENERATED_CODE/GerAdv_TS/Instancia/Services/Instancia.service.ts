...
export interface IInstanciaService {
  ...
  filterVoice: (filtro?: FilterInstancia, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class InstanciaService implements IInstanciaService {
  ...
  async filterVoice(filtro?: FilterInstancia, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
