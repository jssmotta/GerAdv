...
// useAgendaSemanaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de AgendaSemana
"use client";
...
interface UseAgendaSemanaGridProps {
  data: IAgendaSemana[];
...
export const useAgendaSemanaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IAgendaSemana, filters: Record<string, any>) => {
