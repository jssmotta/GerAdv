...
const StatusAndamentoInc: React.FC<IStatusAndamentoFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedStatusAndamento =
        await statusandamentoService.saveStatusAndamento(data);
