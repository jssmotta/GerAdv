...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new OperadorEMailPopupWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.OperadorEMailPopup CreateValidOperadorEMailPopupModel()
    {
        return new GerAdv.Models.OperadorEMailPopup
        {
            Id = 0,
