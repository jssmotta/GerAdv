...
// useDivisaoTribunalGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de DivisaoTribunal
"use client";
...
interface UseDivisaoTribunalGridProps {
...
export const useDivisaoTribunalGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IDivisaoTribunal, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
