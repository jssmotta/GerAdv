...
const BensClassificacaoInc: React.FC<IBensClassificacaoFormProps> = ({
  ...
  const { data, handleChange, loadBensClassificacao } =
    useBensClassificacaoForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedBensClassificacao =
        await bensclassificacaoService.saveBensClassificacao(data);
