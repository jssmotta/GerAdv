...
public partial class FTipoEMail : MenphisSI.SG.GerAdv.DBTipoEMail, IDBTipoEMail
{
    // DI-compatible default constructor
    public FTipoEMail() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FTipoEMail CreateFromReader(SqlDataReader? dbRec)
    {
        return new FTipoEMail(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FTipoEMail CreateFromDataRow(DataRow? dbRec)
    {
        return new FTipoEMail(dbRec);
    }

    private FTipoEMail(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FTipoEMail(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FTipoEMail> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
