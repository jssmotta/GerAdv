...
public partial interface IDBClientes
{
    public int ID { get; set; }
    public int FEmpresa { get; set; }
    public string? FIcone { get; set; }
    public string? FNomeMae { get; set; }
    public DateOnly? FRGDataExp { get; set; }
    ...
    public bool FObito { get; set; }
    public string? FNomePai { get; set; }
    public string? FRGOExpeditor { get; set; }
    public int FRegimeTributacao { get; set; }
    public int FEnquadramentoEmpresa { get; set; }
