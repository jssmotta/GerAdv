...
public partial interface IRecadosService
{
    ...
    Task<IEnumerable<NomeID>> GetListN([FromQuery] int max, [FromBody] Filters.FilterRecados? filter, [FromRoute, Required] string uri = "", CancellationToken token = default);
}