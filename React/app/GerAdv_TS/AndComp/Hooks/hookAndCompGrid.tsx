...
// useAndCompGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de AndComp
'use client';
  ...
  const handleColumnsReorder = useCallback((event: any) => {
    ...
    .filter((col: any) =>
      ...
      if (reorderableFields.length > 0 && JSON.stringify(reorderableFields) !== JSON.stringify(columnsOrder)) {
        ...
        try {
          localStorage.setItem(btoa('andcomp-columns-order'), JSON.stringify(reorderableFields));
