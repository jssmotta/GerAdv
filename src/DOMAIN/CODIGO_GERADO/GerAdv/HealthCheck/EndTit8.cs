                ...
                try
                {
                    ...
                    try
                    {
                        if (DBEndTitDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(ettCodigo) FROM dbo.EndTit (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) ettEndereco,ettTitulo FROM dbo.EndTit (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
