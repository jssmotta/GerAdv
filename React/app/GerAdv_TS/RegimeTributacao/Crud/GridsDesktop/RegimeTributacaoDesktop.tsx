...
export const RegimeTributacaoGridDesktopComponent = React.memo(
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("regimetributacao-columns-order"),
        );
        if (savedOrder) {
    ...
    const resetColumnsOrder = useCallback(() => {
      ...
      localStorage.removeItem(btoa("regimetributacao-columns-order"));
    }, []);
      ...
      <>
        ...
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-regimetributacao"
