...
export interface IAgendaService {
  ...
  filterVoice: (filtro?: FilterAgenda, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class AgendaService implements IAgendaService {
  ...
  async filterVoice(filtro?: FilterAgenda, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
