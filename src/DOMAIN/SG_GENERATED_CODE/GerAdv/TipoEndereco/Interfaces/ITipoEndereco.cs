...
public partial interface ITipoEnderecoService
{
    ...
    Task<Filters.FilterTipoEndereco> FilterVoice([FromBody] Filters.FilterTipoEndereco filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
