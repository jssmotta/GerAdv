...
const addValorAdvOpo = (e: any) => {
  if (e?.id>0)
    onChange({ target: { name: 'advopo', value: e.id } });
  };
              ...
              const addValorCidade = (e: any) => {
                ...
                const addValorSituacao = (e: any) => {
                  ...
                  const addValorRito = (e: any) => {
                    if (e?.id>0)
                      onChange({ target: { name: 'rito', value: e.id } });
                    };
                    const addValorAtividade = (e: any) => {
                      if (e?.id>0)
                        onChange({ target: { name: 'atividade', value: e.id } });
                      };
                      const onConfirm = (e: React.FormEvent) => {
                        ...
                        if (e.stopPropagation) e.stopPropagation();
                          ...
                          if (!isSubmitting) {
                            ...
                            console.log('Erro ao submeter formulário de Processos:');
                      ...
                      const handleDirectSave = () => {
                        if (!isSubmitting) {
                          ...
                          console.log('Erro ao salvar Processos diretamente');
                          setIsSubmitting(false);
                          if (onError) onError();
                          }
                        }
