...
public partial class FGUTPeriodicidade : MenphisSI.SG.GerAdv.DBGUTPeriodicidade, IDBGUTPeriodicidade
{
    // DI-compatible default constructor
    public FGUTPeriodicidade() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FGUTPeriodicidade CreateFromReader(SqlDataReader? dbRec)
    {
        return new FGUTPeriodicidade(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FGUTPeriodicidade CreateFromDataRow(DataRow? dbRec)
    {
        return new FGUTPeriodicidade(dbRec);
    }

    private FGUTPeriodicidade(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FGUTPeriodicidade(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FGUTPeriodicidade> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
