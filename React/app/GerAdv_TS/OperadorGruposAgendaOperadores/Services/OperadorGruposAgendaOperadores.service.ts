...
export class OperadorGruposAgendaOperadoresService implements IOperadorGruposAgendaOperadoresService {
  ...
  async saveOperadorGruposAgendaOperadores(operadorgruposagendaoperadores: IOperadorGruposAgendaOperadores): Promise<IOperadorGruposAgendaOperadores> {    
   ...
   async getAll(
    filtro?: FilterOperadorGruposAgendaOperadores,
    onOnlineData?: (data: IOperadorGruposAgendaOperadores[]) => void
  ): Promise<IOperadorGruposAgendaOperadores[]> {
    try {
      ...
      if (onOnlineData) {
        ...
        this.api.filter(filtro ?? {})
          ...
          .catch(error => {
            console.log('Error fetching online OperadorGruposAgendaOperadores');
          });
      ...
      console.log('Error fetching all OperadorGruposAgendaOperadores:');
      return [];
    }
  }
