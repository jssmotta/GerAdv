...
interface ProTipoBaixaFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-ProTipoBaixa' : 'form-container5 form-container-ProTipoBaixa'}>
       
            <form className='formInputCadInc' id={`ProTipoBaixaForm-${protipobaixaData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={protipobaixaData} isSubmitting={isSubmitting} onClose={onClose} formId={`ProTipoBaixaForm-${protipobaixaData.id}`} preventPropagation={true} onSave={handleDirectSave} />
