...
public class FTipoOrigemSucumbenciaFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FTipoOrigemSucumbenciaFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FTipoOrigemSucumbenciaFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FTipoOrigemSucumbenciaFactory();
        _mockConnection = new Mock<MsiSqlConnection>();
        _mockReader = new Mock<SqlDataReader>();
        // Prepare a real DataRow with the expected schema (at minimum CampoCodigo: "tosCodigo")
        var dt = new DataTable();
        dt.Columns.Add("tosCodigo", typeof(int));
        var row = dt.NewRow();
        // Set as DBNull to allow constructor to return early without requiring all columns
        row["tosCodigo"] = DBNull.Value;
        dt.Rows.Add(row);
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTipoOrigemSucumbencia>();
    }
    ...
    {
        // Arrange
        var factory = new FTipoOrigemSucumbenciaFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("tosCodigo", typeof(int));
        mockDataTable.Columns.Add("tosNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["tosCodigo"] = testId;
        row["tosNome"] = "Test TipoOrigemSucumbencia";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["tosCodigo"] = 123;
        row["tosNome"] = "Test TipoOrigemSucumbencia Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTipoOrigemSucumbencia properties
        }
    }
