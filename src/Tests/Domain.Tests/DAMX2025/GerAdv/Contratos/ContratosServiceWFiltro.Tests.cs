...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class ContratosServiceWFiltroTests : IDisposable
    {
        ...
        private readonly ContratosServiceS _serviceS;
        public ContratosServiceWFiltroTests()
        {
            ...
            _serviceS = new ContratosServiceS();
...
#region String Tests
        ...
        public void WFiltro_GuidContratos_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBContratos.CampoCodigo}");
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemCad}] = @{DBContratosDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBContratosDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.QuemCad} BETWEEN @{DBContratosDicInfo.QuemCad} AND @{DBContratosDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBContratosDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBContratosDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBContratosDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBContratosDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.QuemCad} BETWEEN @{DBContratosDicInfo.QuemCad} AND @{DBContratosDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemCad}] = @{DBContratosDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemCad}] = @cttQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@cttQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@cttQuemCad");
            resultado.Value.where.Should().Contain($"@{DBContratosDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemAtu}] = @{DBContratosDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBContratosDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.QuemAtu} BETWEEN @{DBContratosDicInfo.QuemAtu} AND @{DBContratosDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBContratosDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBContratosDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBContratosDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBContratosDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.QuemAtu} BETWEEN @{DBContratosDicInfo.QuemAtu} AND @{DBContratosDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemAtu}] = @{DBContratosDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.QuemAtu}] = @cttQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@cttQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@cttQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBContratosDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.PercEscritorio_end Tests
        ...
        public void WFiltro_PercEscritorio_end_QuandoDecimalMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                PercEscritorio_end = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_PercEscritorio_end_QuandoTemValorPositivo_SemPercEscritorioInicial_DeveAdicionarParametroMasNaoCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                PercEscritorio = int.MinValue, // Não define salário inicial
        ...
        public void WFiltro_PercEscritorio_end_QuandoSomenteValorInicial_SemPercEscritorioEnd_DeveUsarOperadorIgualdade()
        {
            ...
            var filtro = new FilterContratos
            {
                ...
                PercEscritorio_end = int.MinValue, // Não define salário final
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_PercEscritorio_QuandoSomenteZeroInicial_DeveUsarIgualdade()
        {
            ...
            {
                PercEscritorio = 0m,
                PercEscritorio_end = int.MinValue,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_PercEscritorio_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Assert
            resultado.Should().NotBeNull();
            // Verifica a lógica exata: !(filtro.PercEscritorio == int.MinValue) && !(filtro.PercEscritorio_end == int.MinValue)
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
...
#region filtro.PercEscritorio Isolated Tests
        ...
        public void WFiltro_PercEscritorio_QuandoIntMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                PercEscritorio = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_PercEscritorio_QuandoValorMinValue_NaoDeveIncluirNoFiltro()
        {
            ...
            var filtro = new FilterContratos
            {
                PercEscritorio = int.MinValue, // Valor que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
...
#region filtro.ValorConsultoria_end Tests
        ...
        public void WFiltro_ValorConsultoria_end_QuandoDecimalMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorConsultoria_end = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorConsultoria_end_QuandoTemValorPositivo_SemValorConsultoriaInicial_DeveAdicionarParametroMasNaoCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorConsultoria = int.MinValue, // Não define salário inicial
        ...
        public void WFiltro_ValorConsultoria_end_QuandoSomenteValorInicial_SemValorConsultoriaEnd_DeveUsarOperadorIgualdade()
        {
            ...
            var filtro = new FilterContratos
            {
                ...
                ValorConsultoria_end = int.MinValue, // Não define salário final
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorConsultoria_QuandoSomenteZeroInicial_DeveUsarIgualdade()
        {
            ...
            {
                ValorConsultoria = 0m,
                ValorConsultoria_end = int.MinValue,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorConsultoria_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Assert
            resultado.Should().NotBeNull();
            // Verifica a lógica exata: !(filtro.ValorConsultoria == int.MinValue) && !(filtro.ValorConsultoria_end == int.MinValue)
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
...
#region filtro.ValorConsultoria Isolated Tests
        ...
        public void WFiltro_ValorConsultoria_QuandoIntMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorConsultoria = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorConsultoria_QuandoValorMinValue_NaoDeveIncluirNoFiltro()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorConsultoria = int.MinValue, // Valor que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
...
#region filtro.ValorRealizavel_end Tests
        ...
        public void WFiltro_ValorRealizavel_end_QuandoDecimalMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorRealizavel_end = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorRealizavel_end_QuandoTemValorPositivo_SemValorRealizavelInicial_DeveAdicionarParametroMasNaoCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorRealizavel = int.MinValue, // Não define salário inicial
        ...
        public void WFiltro_ValorRealizavel_end_QuandoSomenteValorInicial_SemValorRealizavelEnd_DeveUsarOperadorIgualdade()
        {
            ...
            var filtro = new FilterContratos
            {
                ...
                ValorRealizavel_end = int.MinValue, // Não define salário final
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorRealizavel_QuandoSomenteZeroInicial_DeveUsarIgualdade()
        {
            ...
            {
                ValorRealizavel = 0m,
                ValorRealizavel_end = int.MinValue,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorRealizavel_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Assert
            resultado.Should().NotBeNull();
            // Verifica a lógica exata: !(filtro.ValorRealizavel == int.MinValue) && !(filtro.ValorRealizavel_end == int.MinValue)
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
...
#region filtro.ValorRealizavel Isolated Tests
        ...
        public void WFiltro_ValorRealizavel_QuandoIntMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorRealizavel = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        public void WFiltro_ValorRealizavel_QuandoValorMinValue_NaoDeveIncluirNoFiltro()
        {
            ...
            var filtro = new FilterContratos
            {
                ValorRealizavel = int.MinValue, // Valor que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBContratosDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBContratosDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.DtCad} BETWEEN @{DBContratosDicInfo.DtCad} AND @{DBContratosDicInfo.DtCad}_end");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBContratosDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBContratosDicInfo.PTabelaNome}].[{DBContratosDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBContratosDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBContratosDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBContratosDicInfo.PTabelaNome}].{DBContratosDicInfo.DtAtu} BETWEEN @{DBContratosDicInfo.DtAtu} AND @{DBContratosDicInfo.DtAtu}_end");
        }
