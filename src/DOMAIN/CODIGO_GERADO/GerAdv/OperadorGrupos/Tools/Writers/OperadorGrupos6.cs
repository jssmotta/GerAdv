...
public class OperadorGruposWriter(IFOperadorGruposFactory operadorgruposFactory) : IOperadorGruposWriter
{
    ...
    public async Task Delete(OperadorGruposResponse operadorgrupos, int operadorId, MsiSqlConnection oCnn)
    {
        await _operadorgruposFactory.DeleteAsync(operadorId, operadorgrupos.Id, oCnn);
    }

    public async Task<FOperadorGrupos> WriteAsync(Models.OperadorGrupos operadorgrupos, int auditorQuem, MsiSqlConnection oCnn)
    {
