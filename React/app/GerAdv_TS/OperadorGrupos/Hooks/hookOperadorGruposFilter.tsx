...
interface UseOperadorGruposFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterOperadorGrupos | undefined | null,
  ) => Promise<void>;
}
...
interface UseOperadorGruposFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterOperadorGrupos>,
  ) => React.ReactNode;
...
export const useOperadorGruposFilter = ({
  handleFetchWithFilter,
}: UseOperadorGruposFilterProps): UseOperadorGruposFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterOperadorGrupos>(
