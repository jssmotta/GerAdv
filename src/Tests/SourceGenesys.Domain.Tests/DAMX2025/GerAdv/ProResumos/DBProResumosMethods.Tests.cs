...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProResumos
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProResumosUpdateAdvancedTests : IDisposable
{
    private readonly DBProResumos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProResumosUpdateAdvancedTests()
    {
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProResumos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProResumos instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProResumos).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Update Operation Tests
    ...
    public void Update_ForUpdate_WithNonZeroId_AndNoChanges_ShouldReturnZero()
    {
        ...
        var fieldInfo = typeof(DBProResumos).GetField("pFldFData", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProResumos.PTabelaNome.Should().Be("ProResumos");
        DBProResumos.CampoCodigo.Should().Be("prsCodigo");
    }
