...
// useGruposEmpresasGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GruposEmpresas
"use client";
...
interface UseGruposEmpresasGridProps {
...
export const useGruposEmpresasGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IGruposEmpresas, filters: Record<string, any>) => {
