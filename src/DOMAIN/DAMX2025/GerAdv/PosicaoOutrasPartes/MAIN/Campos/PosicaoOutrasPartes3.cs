...
{
    [XmlIgnore]
    private protected bool pFldFDescricao, pFldFBold;
    [XmlIgnore]
    private protected string? m_FDescricao;
    [XmlIgnore]
    private protected bool m_FBold;
    [StringLength(30, ErrorMessage = "A propriedade FDescricao da tabela PosicaoOutrasPartes deve ter no máximo 30 caracteres.")]
    public string? FDescricao
    {
        ...
        set
        {
            ...
            if (pFldFDescricao)
            {
                ...
                m_FDescricao = trimmed.Length > 30 ? trimmed.AsSpan(0, 30).ToString() : trimmed;
            }
        }
    }
