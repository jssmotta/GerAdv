...
public class FFuncionariosFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FFuncionariosFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FFuncionariosFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FFuncionariosFactory();
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FFuncionarios>();
    }
    ...
    {
        // Arrange
        var factory = new FFuncionariosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("funNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["funCodigo"] = testId;
        row["funNome"] = "Test Funcionarios";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["funCodigo"] = 123;
        row["funNome"] = "Test Funcionarios Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FFuncionarios properties
        }
    }
