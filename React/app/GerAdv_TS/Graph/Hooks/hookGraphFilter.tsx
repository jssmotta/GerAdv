...
interface UseGraphFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterGraph | undefined | null,
  ) => Promise<void>;
}
...
interface UseGraphFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterGraph>,
  ) => React.ReactNode;
...
export const useGraphFilter = ({
  handleFetchWithFilter,
}: UseGraphFilterProps): UseGraphFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterGraph>(
    {} as FilterGraph,
  );
