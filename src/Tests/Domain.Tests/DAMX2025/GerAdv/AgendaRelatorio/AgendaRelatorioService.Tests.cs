...
public class AgendaRelatorioServiceTests : IDisposable
{
    ...
    public AgendaRelatorioServiceTests(ITestOutputHelper output)
    {
        ...
        _service = new AgendaRelatorioService(_mockAppSettings.Object, _mockAgendaRelatorioFactory.Object, _mockReader.Object, _mockValidation.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
    }
    ...
    {
        // Arrange & Act
        var service = new AgendaRelatorioService(_mockAppSettings.Object, _mockAgendaRelatorioFactory.Object, _mockReader.Object, _mockValidation.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        // Assert
