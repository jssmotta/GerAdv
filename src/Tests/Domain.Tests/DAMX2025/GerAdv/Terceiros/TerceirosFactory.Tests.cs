...
public class FTerceirosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTerceiros>();
    }
    ...
    {
        // Arrange
        var factory = new FTerceirosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("terCodigo", typeof(int));
        mockDataTable.Columns.Add("terNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["terCodigo"] = testId;
        row["terNome"] = "Test Terceiros";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["terCodigo"] = 123;
        row["terNome"] = "Test Terceiros Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTerceiros properties
        }
    }
