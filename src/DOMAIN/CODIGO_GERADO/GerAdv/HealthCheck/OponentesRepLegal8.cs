                ...
                try
                {
                    ...
                    try
                    {
                        if (DBOponentesRepLegalDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) oprNome,oprFone,oprOponente,oprSexo,oprCPF,oprRG,oprEndereco,oprBairro,oprCEP,oprCidade,oprFax,oprEMail,oprSite,oprObservacao FROM {"OponentesRepLegal".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
