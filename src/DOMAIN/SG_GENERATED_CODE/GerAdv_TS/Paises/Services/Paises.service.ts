...
export interface IPaisesService {
  ...
  filterVoice: (filtro?: FilterPaises, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class PaisesService implements IPaisesService {
  ...
  async filterVoice(filtro?: FilterPaises, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
