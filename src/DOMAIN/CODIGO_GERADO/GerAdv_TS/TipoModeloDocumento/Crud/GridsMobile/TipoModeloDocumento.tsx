...
export const TipoModeloDocumentoGridMobileComponent: React.FC<TipoModeloDocumentoGridProps> = ({
	data,
	onRowClick,
	onDeleteClick,
	setSelectedId,
...
const EditarCellModelosDocumentos = (props: any) => {
    return (
      <>
        <td>
            <div onClick={() => openConsultaModelosDocumentos(props.dataItem.id)}><img width='16' height='16' src='https://cdn.menphis.com.br/msi/v20/editar.webp' title='Editar Modelos Documentos' />&nbsp;</div>
        </td>
      </>
    );
};	
