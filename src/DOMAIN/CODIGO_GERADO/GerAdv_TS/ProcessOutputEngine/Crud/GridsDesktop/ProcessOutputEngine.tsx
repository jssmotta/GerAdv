...
interface ProcessOutputEngineGridProps {
  data: IProcessOutputEngine[];
  onRowClick: (processoutputengine: IProcessOutputEngine) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProcessOutputEngineGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProcessOutputEngine, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-processoutputengine'
