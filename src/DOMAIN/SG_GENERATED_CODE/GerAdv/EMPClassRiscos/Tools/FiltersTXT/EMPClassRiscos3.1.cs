...
public static class FilterEMPClassRiscosTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar EMPClassRiscos em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterEMPClassRiscos:

- O filter irá filtrar os EMPClassRiscos conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
CAMPOS filterEMPClassRiscos:(E M P Class Riscos)
- nome: _nome ou descrição para E M P Class Riscos;
- bold: Bold;
...
- Se ouvir "todos os EMPClassRiscos" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterEMPClassRiscos? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt EMPClassRiscos length: {result.Length}");
#endif
