...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("gphCodigo", typeof(int));
        mockDataTable.Columns.Add("gphGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["gphCodigo"] = testId;
        row["gphGuid"] = "Test Graph";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["gphCodigo"] = 123;
        row["gphGuid"] = "Test Graph Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FGraph properties
        }
    }
