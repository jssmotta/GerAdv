...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBPreClientes
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBPreClientesUpdateAdvancedTests : IDisposable
{
    private readonly DBPreClientes _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBPreClientesUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBPreClientes
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBPreClientes).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBPreClientes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBPreClientes instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBPreClientes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBPreClientes.PTabelaNome.Should().Be("PreClientes");
        DBPreClientes.CampoCodigo.Should().Be("cliCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBPreClientes();
        dbRec.ID = 1;
