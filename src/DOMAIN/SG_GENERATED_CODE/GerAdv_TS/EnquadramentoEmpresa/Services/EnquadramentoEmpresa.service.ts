...
export interface IEnquadramentoEmpresaService {
  ...
  filterVoice: (filtro?: FilterEnquadramentoEmpresa, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class EnquadramentoEmpresaService implements IEnquadramentoEmpresaService {
  ...
  async filterVoice(filtro?: FilterEnquadramentoEmpresa, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
