...
#pragma warning restore CA1822 // Mark members as static
    ...
    public static ImmutableArray<DBInfoSystem> List => [DBPontoVirtualAcessosDicInfo.PvaOperador, DBPontoVirtualAcessosDicInfo.PvaDataHora, DBPontoVirtualAcessosDicInfo.PvaTipo, DBPontoVirtualAcessosDicInfo.PvaOrigem];
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBPontoVirtualAcessosDicInfo.PvaOperador, DBPontoVirtualAcessosDicInfo.PvaDataHora, DBPontoVirtualAcessosDicInfo.PvaTipo, DBPontoVirtualAcessosDicInfo.PvaOrigem];

    public static ImmutableArray<DBInfoSystem> ListPk()
    {
        ImmutableArray<string> campos = ImmutableArray.CreateRange(["pvaCodigo"]);
