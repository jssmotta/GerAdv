...
public class DBEMPClassRiscosUpdate : IDisposable
{
    private readonly DBEMPClassRiscos _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBEMPClassRiscosUpdate()
    {
    ...
    {
        // Act
        var empclassriscos = new DBEMPClassRiscos();
        // Assert
        empclassriscos.Should().NotBeNull();
        empclassriscos.ITableName().Should().Be("EMPClassRiscos");
        empclassriscos.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set empclassriscos.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        empclassriscos.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        empclassriscos.FNome = longString; // MAX: 80
        empclassriscos.FGuid = longString; // MAX: 100
        // Assert - All properties should be set empclassriscos.FNome.Should().HaveLength(80);
        empclassriscos.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        empclassriscos.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        empclassriscos.FNome.Should().Be(string.Empty);
    }
    ...
    {
        // Arrange
        var sqlWhere = "ecrCodigo = 1";
        // Act & Assert
        var EMPClassRiscos = new DBEMPClassRiscos(sqlWhere, null);
        EMPClassRiscos.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var empclassriscos = new DBEMPClassRiscos(parameters, nome, null);
        // Assert
        empclassriscos.Should().NotBeNull();
        empclassriscos.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        empclassriscos.FNome = longName;
        // Assert
        empclassriscos.FNome.Should().HaveLength(80);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBEMPClassRiscos).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var empclassriscos = new DBEMPClassRiscos();
        // Act & Assert
        empclassriscos.TabelaNome.Should().Be("EMPClassRiscos");
    }
