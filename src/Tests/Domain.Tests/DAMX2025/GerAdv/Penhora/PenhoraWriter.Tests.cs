...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFPenhora.VerifySet(x => x.FDataPenhora = DateOnly.Parse(penhora.DataPenhora), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_DataPenhora_ShouldNotSetFDataPenhora()
    {
        // Arrange
        var penhora = CreateValidPenhoraModel();
        ...
        // Assert
        _mockFPenhora.VerifySet(x => x.FDataPenhora = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Delete Tests
    ...
    public async Task Delete_ShouldCallFactoryDeleteAsync()
    {
        ...
        // Act
        await _penhoraWriter.DeleteAsync(penhoraResponse, operadorId, _mockConnection.Object);
        // Assert
    ...
    public async Task Delete_WithValidParameters_ShouldCompleteSuccessfully()
    {
        ...
        _mockPenhoraFactory.Setup(x => x.DeleteAsync(operadorId, penhoraResponse.Id, _mockConnection.Object)).Returns(Task.CompletedTask);
        // Act
        Func<Task> act = async () => await _penhoraWriter.DeleteAsync(penhoraResponse, operadorId, _mockConnection.Object);
        // Assert
    ...
    public async Task Delete_WhenFactoryDeleteAsyncFails_ShouldPropagateException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() => _penhoraWriter.DeleteAsync(penhoraResponse, operadorId, _mockConnection.Object));
        exception.Should().Be(expectedException);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new PenhoraWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Penhora CreateValidPenhoraModel()
    {
