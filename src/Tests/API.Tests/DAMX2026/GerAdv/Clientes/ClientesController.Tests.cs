...
public class ClientesControllerTests
{
    ...
    public async Task GetAll_WithValidParameters_ReturnsOkWithData()
    {
        ...
        _mockService.Setup(x => x.GetAll(max, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync(ResultApi<IEnumerable<RespAll.ClientesResponseAll>>.Ok(expectedData));
        // Act
    ...
    public async Task Filter_WithValidFilter_ReturnsFilteredData()
    {
        ...
        _mockService.Setup(x => x.Filter(max, filter, "test-uri")).ReturnsAsync(ResultApi<IEnumerable<RespAll.ClientesResponseAll>>.Ok(expectedData));
        // Act
    ...
    public async Task GetById_WithExistingId_ReturnsOkWithData()
    {
        ...
        _mockService.Setup(x => x.GetById(id, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Ok(expectedData));
        // Act
    ...
    public async Task GetById_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.GetById(id, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync(ResultApi<Resp.ClientesResponse>.NotFound($"Registro não encontrado para id {id}"));
        // Act
        var actionResult = await _controller.GetById(id, "test-uri");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task AddAndUpdate_WithValidData_ReturnsCreatedWithResult()
    {
        ...
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Clientes>(), "test-uri")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Created(expectedResult));
        // Act
    ...
    public async Task AddAndUpdate_WhenServiceReturnsFail_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Clientes();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.Clientes>(), "test-uri")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Fail("Falha ao processar", 400));
        // Act
        var actionResult = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task Delete_WithExistingId_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Delete(id, "test-uri")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Ok(expectedResult));
        // Act
    ...
    public async Task Delete_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.Delete(id, "test-uri")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.NotFound("Registro não encontrado"));
        // Act
        var actionResult = await _controller.Delete(id, "test-uri");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
    ...
    public async Task Validation_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Clientes>(), "test-uri")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Ok(expectedResult));
        // Act
    ...
    public async Task Validation_WhenServiceReturnsFail_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.Clientes();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.Clientes>(), "test-uri")).ReturnsAsync(ResultApi<Resp.ClientesResponse>.Fail("Falha na validação", 400));
        // Act
        var actionResult = await _controller.Validation(model, "test-uri");
        // Assert
        var objectResult = actionResult.Result as ObjectResult;
