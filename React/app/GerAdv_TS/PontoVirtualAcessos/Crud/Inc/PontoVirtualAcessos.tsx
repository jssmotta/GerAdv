...
import {
  usePontoVirtualAcessosForm,
  useValidationsPontoVirtualAcessos,
} from "../../Hooks/hookPontoVirtualAcessos";
...
const PontoVirtualAcessosInc: React.FC<IPontoVirtualAcessosFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadPontoVirtualAcessos } =
    usePontoVirtualAcessosForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedPontoVirtualAcessos =
        await pontovirtualacessosService.savePontoVirtualAcessos(data);
