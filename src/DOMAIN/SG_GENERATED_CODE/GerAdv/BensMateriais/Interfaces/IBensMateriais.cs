...
public partial interface IBensMateriaisService
{
    ...
    Task<Filters.FilterBensMateriais> FilterVoice([FromBody] Filters.FilterBensMateriais filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
