...
public class FilterTipoOrigemSucumbenciaWithVoiceRequest
{
    /// <summary>
    /// Filtro de TipoOrigemSucumbencia padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterTipoOrigemSucumbencia Filter { get; set; } = new();
...
[Serializable]
public partial record FilterTipoOrigemSucumbencia
{
