...
#region Class Structure Tests
    ...
    private static GerAdv.Models.Reuniao CreateValidReuniao()
    {
        return new GerAdv.Models.Reuniao
        {
            Id = 1,
            Cliente = 0,
            IDAgenda = 0,
...
#region HoraInicial Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_HoraInicial_ShouldPass()
    {
        // Arrange
        var reuniao = CreateValidReuniao();
...
#region HoraSaida Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_HoraSaida_ShouldPass()
    {
        // Arrange
        var reuniao = CreateValidReuniao();
...
#region HoraRetorno Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_HoraRetorno_ShouldPass()
    {
        // Arrange
        var reuniao = CreateValidReuniao();
