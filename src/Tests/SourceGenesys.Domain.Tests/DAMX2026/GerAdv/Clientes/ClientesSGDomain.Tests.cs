...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("Clientes", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("Clientes", cadastro.ITableName());
...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FRGDataExp = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FRGDataExp?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBClientes();
        Assert.Equal(null !, instance.FRGDataExp);
    }
