                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(pdsCodigo) FROM {"ProDepositos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) pdsProcesso,pdsFase,pdsData,pdsValor,pdsTipoProDesposito FROM {"ProDepositos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
