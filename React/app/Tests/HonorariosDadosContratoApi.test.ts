...
import { HonorariosDadosContratoApiError } from '../GerAdv_TS/HonorariosDadosContrato/Apis/ApiHonorariosDadosContrato';
import { HonorariosDadosContratoApi } from '@/app/GerAdv_TS/HonorariosDadosContrato/Apis/ApiHonorariosDadosContrato';
import { FilterHonorariosDadosContrato } from '../GerAdv_TS/HonorariosDadosContrato/Filters/HonorariosDadosContrato';
...
describe('HonorariosDadosContratoApi', () => {
  let honorariosdadoscontratoApi: HonorariosDadosContratoApi;
  ...
  beforeEach(() => {
    ...
    honorariosdadoscontratoApi = new HonorariosDadosContratoApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(honorariosdadoscontratoApi).toBeInstanceOf(HonorariosDadosContratoApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new HonorariosDadosContratoApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(HonorariosDadosContratoApi);
    });
  });
  ...
  describe('getAll', () => {
    const mockResponse: AxiosResponse = {
      data: [HonorariosDadosContratoTestEmpty()],
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch all honorariosdadoscontrato items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await honorariosdadoscontratoApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(honorariosdadoscontratoApi.getAll()).rejects.toThrow(HonorariosDadosContratoApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await honorariosdadoscontratoApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-HonorariosDadosContrato_last_getAll_${200}`)));
    });
    ...
    it('should throw HonorariosDadosContratoApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockHonorariosDadosContrato = HonorariosDadosContratoTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockHonorariosDadosContrato,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch honorariosdadoscontrato by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await honorariosdadoscontratoApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockHonorariosDadosContrato));
      ...
      expect(result.data).toEqual(mockHonorariosDadosContrato);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'HonorariosDadosContrato',
          id: 1,
  ...
  describe('filter', () => {
    const mockFilter: FilterHonorariosDadosContrato = {
      funcionario: 1,
      data: '2024-01-01',
    };
    ...
    it('should filter honorariosdadoscontrato items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await honorariosdadoscontratoApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    const mockHonorariosDadosContrato: IHonorariosDadosContrato = {
      id: 0,
      funcionario: 1,
      tipocompromisso: 1,
      fornecedor: 1,
    ...
    it('should add new honorariosdadoscontrato successfully', async () => {
      const responseHonorariosDadosContrato = { ...mockHonorariosDadosContrato, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responseHonorariosDadosContrato,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await honorariosdadoscontratoApi.addAndUpdate(mockHonorariosDadosContrato);

      expect(mockedAxios.post).toHaveBeenCalledWith(
        expect.stringContaining('/AddAndUpdate'),
        mockHonorariosDadosContrato,
        expect.any(Object)
      );
      expect(result).toEqual(mockResponse);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
    ...
    it('should update existing honorariosdadoscontrato successfully', async () => {
      const existingHonorariosDadosContrato = { ...mockHonorariosDadosContrato, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingHonorariosDadosContrato,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await honorariosdadoscontratoApi.addAndUpdate(existingHonorariosDadosContrato);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(honorariosdadoscontratoApi.addAndUpdate(mockHonorariosDadosContrato)).rejects.toThrow(HonorariosDadosContratoApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'HonorariosDadosContrato',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete honorariosdadoscontrato successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await honorariosdadoscontratoApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(honorariosdadoscontratoApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'HonorariosDadosContrato',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(honorariosdadoscontratoApi.delete(1)).rejects.toThrow(HonorariosDadosContratoApiError);
    });
  });

  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterHonorariosDadosContrato = { funcionario: 1 };
      
      const result = honorariosdadoscontratoApi.useFilter(mockFilter);
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await honorariosdadoscontratoApi.delete(1);
  ...
  describe('HonorariosDadosContratoApiError', () => {
    it('should create error with correct properties', () => {
      const error = new HonorariosDadosContratoApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('HonorariosDadosContratoApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new HonorariosDadosContratoApiError('Test message', 500);
