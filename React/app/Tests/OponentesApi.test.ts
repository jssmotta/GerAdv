...
import { OponentesApiError } from '@/app/GerAdv_TS/Oponentes/Apis/OponentesApi';
import { OponentesApi } from '@/app/GerAdv_TS/Oponentes/Apis/OponentesApi';
...
import { OponentesTestEmpty } from '@/app/GerAdv_TS/Models/Oponentes';
...
top: true
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterOponentes = { : 1 };
