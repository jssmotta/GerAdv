...
public partial class FEscritorios : MenphisSI.SG.GerAdv.DBEscritorios, IDBEscritorios
{
    // DI-compatible default constructor
    public FEscritorios() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FEscritorios CreateFromReader(SqlDataReader? dbRec)
    {
        return new FEscritorios(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FEscritorios CreateFromDataRow(DataRow? dbRec)
    {
        return new FEscritorios(dbRec);
    }

    private FEscritorios(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FEscritorios(DataRow? dbRec) : base(dbRec)
    {
    }

    private FEscritorios(List<SqlParameter>? parameters, in string? cNome = "", MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, cNome, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FEscritorios CreateFromParameters(List<SqlParameter>? parameters, MsiSqlConnection? oCnn, in string? cNome = "", string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FEscritorios(parameters, cNome, oCnn, fullSql, sqlWhere, join);
    }

    public static async Task<FEscritorios> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
        var fEscritorios = new FEscritorios();
        await fEscritorios.CarregarAsync(id, oCnn);
        return fEscritorios;
    }
