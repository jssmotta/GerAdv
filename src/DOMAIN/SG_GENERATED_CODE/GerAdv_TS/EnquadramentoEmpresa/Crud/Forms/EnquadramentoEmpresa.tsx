  ...
  <>      
        ...
        <div className={isMobile ? 'form-container form-container-EnquadramentoEmpresa' : 'form-container5 form-container-EnquadramentoEmpresa'}>
            ...
            <form className='formInputCadInc' id={`EnquadramentoEmpresaForm-${enquadramentoempresaData.id}`} onSubmit={onConfirm}>
                ...
                {!isMobile && (
                    <ButtonSalvarCrud isMobile={false} validationForm={validationForm} entity='EnquadramentoEmpresa' data={enquadramentoempresaData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`EnquadramentoEmpresaForm-${enquadramentoempresaData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                 )}
                ...
                <FooterIncDocker>
                  ...
                  />
                   ...
                   <AuditorButton
                    ...
                    <DeleteButton page={'/pages/enquadramentoempresa'} id={enquadramentoempresaData.id} dadoApi={dadoApi} />
