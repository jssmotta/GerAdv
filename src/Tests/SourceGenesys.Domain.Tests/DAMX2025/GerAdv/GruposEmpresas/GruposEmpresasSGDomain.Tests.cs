...
[InlineData(int.MaxValue)]
[InlineData(int.MinValue)]
public void DespesaUnificada_ShouldAcceptIntegerValues(int value)
{
    _instance.FDespesaUnificada = value;
    Assert.Equal(value, _instance.FDespesaUnificada);
}
...
[Fact]
public void DespesaUnificada_DefaultValue_ShouldBeZero()
{
    var instance = new DBGruposEmpresas();
    Assert.Equal(0, instance.DespesaUnificada);
}
*/
    /*
TEMPLATE_DATETIME_FIELD:
...
[InlineData("31/12/2023")]
[InlineData("15/08/2024")]
public void DespesaUnificada_ShouldFormatDateCorrectly(string dateString)
{
    _instance.FDespesaUnificada = dateString;
    Assert.Equal(dateString, _instance.FDespesaUnificada);
}

[Fact]
public void DespesaUnificada_EmptyDate_ShouldReturnEmptyString()
{
    var instance = new DBGruposEmpresas();
    Assert.Equal(string.Empty, instance.DespesaUnificada);
}
*/
    /*
TEMPLATE_CPF_FIELD:
...
[InlineData("384.004.020-57", "38400402057")]
[InlineData("", "")]
public void DespesaUnificada_ShouldValidateCPF(string input, string expected)
{
    if (input == "" || IsValidCPF(input))
    {
        _instance.FDespesaUnificada = input;
        Assert.Equal(expected, _instance.FDespesaUnificada);
    }
    else
    {
        Assert.Throws<ArgumentException>(() => _instance.FDespesaUnificada = input);
    }
}
*/
    /*
...
[InlineData("test@example.com")]
[InlineData("user.name@domain.co.uk")]
public void DespesaUnificada_ValidEmail_ShouldAccept(string email)
{
    _instance.FDespesaUnificada = email;
    Assert.Equal(email, _instance.FDespesaUnificada);
}

[Theory]
[InlineData("invalid-email")]
[InlineData("@domain.com")]
public void DespesaUnificada_InvalidEmail_ShouldThrow(string email)
{
    Assert.Throws<ArgumentException>(() => _instance.FDespesaUnificada = email);
}
*/
