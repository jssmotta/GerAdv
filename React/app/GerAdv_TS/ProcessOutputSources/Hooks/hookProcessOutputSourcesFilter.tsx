...
interface UseProcessOutputSourcesFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterProcessOutputSources | undefined | null,
  ) => Promise<void>;
}
...
interface UseProcessOutputSourcesFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterProcessOutputSources>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterProcessOutputSources>,
  ) => React.ReactNode;
...
export const useProcessOutputSourcesFilter = ({
  handleFetchWithFilter,
}: UseProcessOutputSourcesFilterProps): UseProcessOutputSourcesFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterProcessOutputSources>(
