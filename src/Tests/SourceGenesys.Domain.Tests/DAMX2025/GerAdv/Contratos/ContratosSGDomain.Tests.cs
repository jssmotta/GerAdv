...
public class DBContratosTests : IDisposable
{
    ...
    private DataTable CreateTestDataTable()
    {
        ...
        dt.Columns.Add("cttBold", typeof(string));
...
#region Testes de Construtores
    ...
    public void Constructor_Default_ShouldInitializeCorrectly()
    {
        ...
        Assert.Equal("Contratos", instance.ITableName());
...
#region Testes de Interfaces
    ...
    public void ICrud_Implementation_ShouldWork()
    {
        ...
        Assert.Equal("Contratos", cadastro.ITableName());
        Assert.Equal("cttCodigo", cadastro.IFieldId());
        Assert.Equal("", cadastro.IFieldNameDescription());
        Assert.Equal("ctt", cadastro.IPrefix());
    }
...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FDataInicio = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataInicio?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBContratos();
        Assert.Equal(null !, instance.FDataInicio);
    }
    ...
    {
        _instance.FDataTermino = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataTermino?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBContratos();
        Assert.Equal(null !, instance.FDataTermino);
    }
