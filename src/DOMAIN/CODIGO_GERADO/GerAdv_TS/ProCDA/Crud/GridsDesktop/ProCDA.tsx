...
interface ProCDAGridProps {
  data: IProCDA[];
  onRowClick: (procda: IProCDA) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProCDAGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProCDA, filters: Record<string, any>) => {
