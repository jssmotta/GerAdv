...
public class FTipoRecursoFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTipoRecurso>();
    }
    ...
    {
        // Arrange
        var factory = new FTipoRecursoFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("trcCodigo", typeof(int));
        mockDataTable.Columns.Add("trcDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["trcCodigo"] = testId;
        row["trcDescricao"] = "Test TipoRecurso";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["trcCodigo"] = 123;
        row["trcDescricao"] = "Test TipoRecurso Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTipoRecurso properties
        }
    }
