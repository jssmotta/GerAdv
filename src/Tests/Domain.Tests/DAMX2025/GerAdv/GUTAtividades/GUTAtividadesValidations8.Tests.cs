...
#region Class Structure Tests
    ...
    private static GerAdv.Models.GUTAtividades CreateValidGUTAtividades()
    {
        return new GerAdv.Models.GUTAtividades
        {
            Id = 1,
            Nome = "João",
    ...
    private void SetupValidMocks()
    {
        ...
        _ = _mockGUTPeriodicidadeReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<GUTPeriodicidadeResponse?>(new GUTPeriodicidadeResponse { Id = id }));
    ...
    private void SetupValidMocksInvalid()
    {
        ...
        _mockGUTAtividadesService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterGUTAtividades>(), It.IsAny<string>())).ReturnsAsync([]);
        // Setup other mocks but don't override the GUTAtividadess service mock
        _ = _mockGUTPeriodicidadeReader.Setup(x => x.ReadAsync(It.IsAny<int>(), It.IsAny<MsiSqlConnection>())).Returns<int, MsiSqlConnection>(valueFunction: static async (id, conn) => await Task.FromResult<GUTPeriodicidadeResponse?>(new GUTPeriodicidadeResponse { Id = 0 }));
...
#region DataConcluido Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithNull_DataConcluido_ShouldPass()
    {
        // Arrange
        var gutatividades = CreateValidGUTAtividades();
...
#region Foreign Key Validation Tests - GUTPeriodicidade
    ...
    public async Task ValidateReg_WithInvalidGUTPeriodicidade_ShouldThrowSGValidationException()
    {
        ...
        _mockGUTPeriodicidadeReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.GUTPeriodicidadeResponse?>(null !));
    ...
    public async Task ValidateReg_WithMismatchedGUTPeriodicidadeId_ShouldThrowSGValidationException()
    {
        ...
        var gutatividades = CreateValidGUTAtividades();
        gutatividades.GUTPeriodicidade = 999;
        var reg888 = new GerAdv.Models.Response.GUTPeriodicidadeResponse
        {
            Id = 888
        }; // Different ID
        _mockGUTPeriodicidadeReader.Setup(x => x.ReadAsync(999, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.GUTPeriodicidadeResponse?>(reg888));
        SetupValidMocksInvalid();
        // Act & Assert
        var exception = await Assert.ThrowsAsync<SGValidationException>(() => _validation.ValidateReg(gutatividades, _mockGUTAtividadesService.Object, _mockGUTPeriodicidadeReader.Object, _mockOperadorReader.Object, _validUri, _mockConnection.Object));
        exception.Message.Should().Contain("não encontrado");
    ...
    public async Task ValidateReg_WithValidGUTPeriodicidade_ShouldPass()
    {
        ...
        var reg123 = new GerAdv.Models.Response.GUTPeriodicidadeResponse
        {
            Id = 123
        };
        _mockGUTPeriodicidadeReader.Setup(x => x.ReadAsync(123, _mockConnection.Object)).Returns(Task.FromResult<GerAdv.Models.Response.GUTPeriodicidadeResponse?>(reg123));
        SetupValidMocks();
        // Act
        var result = await _validation.ValidateReg(gutatividades, _mockGUTAtividadesService.Object, _mockGUTPeriodicidadeReader.Object, _mockOperadorReader.Object, _validUri, _mockConnection.Object);
        // Assert
