...
public class StatusTarefasServiceTests : IDisposable
{
    ...
    public StatusTarefasServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new StatusTarefasService(_mockAppSettings.Object, _mockStatusTarefasFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
