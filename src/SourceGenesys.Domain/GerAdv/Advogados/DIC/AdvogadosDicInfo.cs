...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem AdvGUID => new(0, PTabelaNome, CampoCodigo, GUID, 150, "Global ID", "Global ID", ETipoDadosSysteminfo.SysteminfoTextGuid, true, false, false)
    {
        Prefixo = "adv"
    };
