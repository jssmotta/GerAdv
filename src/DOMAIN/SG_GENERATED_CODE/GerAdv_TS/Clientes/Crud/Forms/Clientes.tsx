  ...
  <>      
        ...
        <div className={isMobile ? 'form-container form-container-Clientes' : 'form-container form-container-Clientes'}>
            ...
            <form className='formInputCadInc' id={`ClientesForm-${clientesData.id}`} onSubmit={onConfirm}>
                ...
                {!isMobile && (
                    <ButtonSalvarCrud isMobile={false} validationForm={validationForm} entity='Clientes' data={clientesData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`ClientesForm-${clientesData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                 )}
...
<InputCheckbox dataForm={clientesData} label='Ani' name='ani' checked={clientesData.ani} onChange={onChange} />
            ...
            {isMobile && (
                <ButtonSalvarCrud isMobile={true} validationForm={validationForm} entity='Clientes' data={clientesData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`ClientesForm-${clientesData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                )}
                ...
                <FooterIncDocker>
                  ...
                  />
                   ...
                   <AuditorButton
                    ...
                    <DeleteButton page={'/pages/clientes'} id={clientesData.id} dadoApi={dadoApi} />
