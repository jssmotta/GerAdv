...
export const OperadorEMailPopupGridDesktopComponent = React.memo(
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("operadoremailpopup-columns-order"),
        );
        if (savedOrder) {
    ...
    const resetColumnsOrder = useCallback(() => {
      ...
      localStorage.removeItem(btoa("operadoremailpopup-columns-order"));
    }, []);
      ...
      <>
        ...
        {initialized && (
          <Grid
            ...
            className="grid-desktop-crud grid-desktop-operadoremailpopup"
