...
public class DBFaseUpdate : IDisposable
{
    ...
    public void DefaultConstructor_ShouldCreateInstance_WithDefaultValues()
    {
        ...
        var fase = new DBFase();
        // Assert
        fase.Should().NotBeNull();
        fase.ITableName().Should().Be("Fase");
        fase.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set fase.FDescricao.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        fase.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        fase.FDescricao = longString; // MAX: 50
        fase.FGuid = longString; // MAX: 100
        // Assert - All properties should be set fase.FDescricao.Should().HaveLength(50);
        fase.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FDescricao_Property_ShouldAcceptValidNames(string Descricao)
    {
        ...
        // Assert
        fase.FDescricao.Should().Be(Descricao);
    }
    ...
    public void FDescricao_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        fase.FDescricao.Should().Be(string.Empty);
    }
    ...
    public void FDescricao_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        fase.FDescricao = longName;
        // Assert
        fase.FDescricao.Should().HaveLength(50);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBFase).GetField("pFldFDescricao", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FDescricao = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var fase = new DBFase();
        // Act & Assert
        fase.TabelaNome.Should().Be("Fase");
    }
