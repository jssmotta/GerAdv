...
public partial class DBPontoVirtualAcessos
{
    ...
    /// </summary>
    public static async Task<DBPontoVirtualAcessos> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBPontoVirtualAcessos();
...
#if (!NOTSTORED_PontoVirtualAcessos)
    // Helper methods
    private bool HasAnyFieldChanged() => pFldFOperador || pFldFDataHora || pFldFTipo || pFldFOrigem;
