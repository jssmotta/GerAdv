...
public partial class DBTipoCompromisso
{
    ...
    private protected bool pFldFIcone, pFldFDescricao, pFldFFinanceiro, pFldFBold, pFldFGuid;
    public virtual int FIcone
    {
        ...
        set
        {
            pFldFIcone = pFldFIcone || value != field;
            if (pFldFIcone)
                field = value;
        }
    }
    ...
    public virtual bool FFinanceiro
    {
        ...
        set
        {
            pFldFFinanceiro = pFldFFinanceiro || value != field;
            if (pFldFFinanceiro)
                field = value;
        }
    }
