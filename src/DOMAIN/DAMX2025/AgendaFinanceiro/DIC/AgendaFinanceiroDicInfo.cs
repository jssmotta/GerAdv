...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem AgeCidade => new(0, PTabelaNome, CampoCodigo, Cidade, DevourerOne.PSemDescricao, Captions.PCaption_Semdica, ETipoDadosSysteminfo.SysteminfoForeingkey, DBCidadeDicInfo.CampoCodigo, DBCidadeDicInfo.TabelaNome, new DBCidadeODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string PrazoProvisionadoDiff(int id) => PrazoProvisionado.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string PrazoProvisionadoSql(int id) => PrazoProvisionado.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string PrazoProvisionadoIsNull => PrazoProvisionado.SqlCmdIsNull() ?? string.Empty;
    public static string PrazoProvisionadoNotIsNull => PrazoProvisionado.SqlCmdNotIsNull() ?? string.Empty;
    ...
    public static string RepetirDiasDiff(int id) => RepetirDias.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string RepetirDiasSql(int id) => RepetirDias.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string RepetirDiasIsNull => RepetirDias.SqlCmdIsNull() ?? string.Empty;
    public static string RepetirDiasNotIsNull => RepetirDias.SqlCmdNotIsNull() ?? string.Empty;
    ...
    public static string RepetirDiff(int id) => Repetir.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string RepetirSql(int id) => Repetir.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string RepetirIsNull => Repetir.SqlCmdIsNull() ?? string.Empty;
    public static string RepetirNotIsNull => Repetir.SqlCmdNotIsNull() ?? string.Empty;
    ...
    public static string DiasDiff(int id) => Dias.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string DiasSql(int id) => Dias.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string DiasIsNull => Dias.SqlCmdIsNull() ?? string.Empty;
    public static string DiasNotIsNull => Dias.SqlCmdNotIsNull() ?? string.Empty;
