...
#region TableDefinition_Penhora
...
#endregion
    public DBPenhora(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBPenhora(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBPenhora(in string? sqlWhere, SqlConnection? oCnn)
    {
