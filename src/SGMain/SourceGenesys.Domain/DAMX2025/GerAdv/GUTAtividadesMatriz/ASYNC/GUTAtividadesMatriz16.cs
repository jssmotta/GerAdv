...
public partial class DBGUTAtividadesMatriz
{
    ...
    /// </summary>
    public static async Task<DBGUTAtividadesMatriz> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBGUTAtividadesMatriz();
