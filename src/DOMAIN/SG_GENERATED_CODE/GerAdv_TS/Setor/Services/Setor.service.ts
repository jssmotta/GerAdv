...
export interface ISetorService {
  ...
  filterVoice: (filtro?: FilterSetor, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class SetorService implements ISetorService {
  ...
  async filterVoice(filtro?: FilterSetor, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
