...
export interface IGraphService {
  ...
  filterVoice: (filtro?: FilterGraph, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class GraphService implements IGraphService {
  ...
  async filterVoice(filtro?: FilterGraph, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
