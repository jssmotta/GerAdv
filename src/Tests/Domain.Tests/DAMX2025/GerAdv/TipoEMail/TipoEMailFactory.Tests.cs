...
public class FTipoEMailFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FTipoEMail>();
    }
    ...
    {
        // Arrange
        var factory = new FTipoEMailFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("tmlCodigo", typeof(int));
        mockDataTable.Columns.Add("tmlNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["tmlCodigo"] = testId;
        row["tmlNome"] = "Test TipoEMail";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["tmlCodigo"] = 123;
        row["tmlNome"] = "Test TipoEMail Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FTipoEMail properties
        }
    }
