...
public partial class DBTipoValorProcesso : XCodeIdBase, ICadastros
{
#if (DEBUG)
#if (!shadowsDisabled && !shadows_MenphisSI_GerAdv && !shadows_MenphisSI_GerAdv_TipoValorProcesso)
#pragma warning disable CA1822 // Mark members as static

//public bool CertSignature() => DicionarioDeDadosManagedDatabaseCode.CodeSigntature_DBTipoValorProcesso();
#pragma warning restore CA1822 // Mark members as static

#endif
#endif
#region TableDefinition_TipoValorProcesso
    [XmlIgnore]
    public string TabelaNome => "TipoValorProcesso";

    public DBTipoValorProcesso()
    {
    }

#endregion
    public DBTipoValorProcesso(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBTipoValorProcesso(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBTipoValorProcesso(in string? sqlWhere, SqlConnection? oCnn)
    {
...
#endif
#region GravarDados_TipoValorProcesso
#if (forWeb)
...
#endif
    {
        ...
        {
            throw new Exception("Campo 'ptvDescricao' está vazio!");
        }
        ...
        if (pFldFDescricao)
            clsW.Fields(DBTipoValorProcessoDicInfo.Descricao, m_FDescricao, ETiposCampos.FString);
        if (pFldFGUID)
            clsW.Fields(DBTipoValorProcessoDicInfo.GUID, m_FGUID, ETiposCampos.FString);
        if (insertId != 0)
            return GravaNewId();
