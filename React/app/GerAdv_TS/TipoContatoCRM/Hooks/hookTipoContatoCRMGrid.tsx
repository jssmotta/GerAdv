...
// useTipoContatoCRMGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoContatoCRM
"use client";
...
interface UseTipoContatoCRMGridProps {
...
export const useTipoContatoCRMGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: ITipoContatoCRM, filters: Record<string, any>) => {
