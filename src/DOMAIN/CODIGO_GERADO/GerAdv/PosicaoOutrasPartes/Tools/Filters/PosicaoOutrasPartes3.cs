...
public class FilterPosicaoOutrasPartesWithVoiceRequest
{
    /// <summary>
    /// Filtro de PosicaoOutrasPartes padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterPosicaoOutrasPartes Filter { get; set; } = new();
...
[Serializable]
public partial record FilterPosicaoOutrasPartes
{
