                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(ramCodigo) FROM {"Ramal".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) ramNome,ramObs FROM {"Ramal".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
