...
import {
  useProcessOutputSourcesForm,
  useValidationsProcessOutputSources,
} from "../../Hooks/hookProcessOutputSources";
...
const ProcessOutputSourcesInc: React.FC<IProcessOutputSourcesFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadProcessOutputSources } =
    useProcessOutputSourcesForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedProcessOutputSources =
        await processoutputsourcesService.saveProcessOutputSources(data);
