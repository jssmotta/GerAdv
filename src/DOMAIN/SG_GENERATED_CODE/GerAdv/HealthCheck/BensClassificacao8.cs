                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(bcsCodigo) FROM {"BensClassificacao".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) bcsNome,bcsBold,bcsGuid FROM {"BensClassificacao".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
