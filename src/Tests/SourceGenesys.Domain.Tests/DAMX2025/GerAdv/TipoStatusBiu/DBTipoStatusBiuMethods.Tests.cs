...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTipoStatusBiu
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTipoStatusBiuUpdateAdvancedTests : IDisposable
{
    private readonly DBTipoStatusBiu _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoStatusBiuUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTipoStatusBiu
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTipoStatusBiu).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTipoStatusBiu).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTipoStatusBiu instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTipoStatusBiu).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTipoStatusBiu.PTabelaNome.Should().Be("TipoStatusBiu");
        DBTipoStatusBiu.CampoCodigo.Should().Be("tsbCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTipoStatusBiu();
        dbRec.ID = 1;
