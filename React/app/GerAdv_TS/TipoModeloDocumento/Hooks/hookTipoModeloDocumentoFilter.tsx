...
interface UseTipoModeloDocumentoFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterTipoModeloDocumento | undefined | null,
  ) => Promise<void>;
}
...
interface UseTipoModeloDocumentoFilterReturn {
  ...
  setWindowFilter: React.Dispatch<
    React.SetStateAction<FilterTipoModeloDocumento>
  >;
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterTipoModeloDocumento>,
  ) => React.ReactNode;
...
export const useTipoModeloDocumentoFilter = ({
  handleFetchWithFilter,
}: UseTipoModeloDocumentoFilterProps): UseTipoModeloDocumentoFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterTipoModeloDocumento>(
