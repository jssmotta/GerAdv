...
#region Class Structure Tests
    ...
    private static GerAdv.Models.HonorariosDadosContrato CreateValidHonorariosDadosContrato()
    {
        return new GerAdv.Models.HonorariosDadosContrato
        {
            Id = 1,
            Cliente = 1,
            Fixo = false,
