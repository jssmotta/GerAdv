...
public partial interface IAtividadesService
{
    ...
    Task<Filters.FilterAtividades> FilterVoice([FromBody] Filters.FilterAtividades filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
