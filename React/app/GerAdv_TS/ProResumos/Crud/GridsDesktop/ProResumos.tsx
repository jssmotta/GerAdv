...
interface ProResumosGridProps {
  data: IProResumos[];
  onRowClick: (proresumos: IProResumos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ProResumosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IProResumos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-proresumos'
