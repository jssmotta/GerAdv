...
public class FEscritoriosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FEscritorios>();
    }
    ...
    {
        // Arrange
        var factory = new FEscritoriosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("escCodigo", typeof(int));
        mockDataTable.Columns.Add("escNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["escCodigo"] = testId;
        row["escNome"] = "Test Escritorios";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["escCodigo"] = 123;
        row["escNome"] = "Test Escritorios Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FEscritorios properties
        }
    }
