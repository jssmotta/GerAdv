...
// useLivroCaixaGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de LivroCaixa
"use client";
...
interface UseLivroCaixaGridProps {
  data: ILivroCaixa[];
...
export const useLivroCaixaGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("livrocaixa-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: ILivroCaixa, filters: Record<string, any>) => {
