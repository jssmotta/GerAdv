...
interface CargosEscFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-CargosEsc' : 'form-container5 form-container-CargosEsc'}>
       
            <form className='formInputCadInc' id={`CargosEscForm-${cargosescData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={cargosescData} isSubmitting={isSubmitting} onClose={onClose} formId={`CargosEscForm-${cargosescData.id}`} preventPropagation={true} onSave={handleDirectSave} />
