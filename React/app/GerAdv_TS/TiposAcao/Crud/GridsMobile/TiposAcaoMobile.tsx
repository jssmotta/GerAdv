  ...
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("tiposacao-columns-order-mobile"),
        );
        if (savedOrder) {
    ...
    useEffect(() => {
      const cleanup = useIOSScrollFallback({
        scrollSelector:
          ".grid-mobile-crud.grid-mobile-tiposacao .k-grid-content",
        waitForDOM: true,
        retryDelay: 100,
      ...
      <>
        {initialized && (
          <>
            <PageTitle
              title="Tipos Acao"
              helpButton={<TiposAcaoHelpCrudButton isMobile={true} />}
            />
            ...
            >
              {(typeView) => (
                <>
                  ...
                  {typeView === "grid" && (
                    <Grid
                      className="grid-mobile-crud grid-mobile-tiposacao"
