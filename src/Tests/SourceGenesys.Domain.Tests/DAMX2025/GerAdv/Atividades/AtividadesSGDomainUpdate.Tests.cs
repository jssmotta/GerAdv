...
public class DBAtividadesUpdate : IDisposable
{
    private readonly DBAtividades _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBAtividadesUpdate()
    {
    ...
    {
        // Act
        var atividades = new DBAtividades();
        // Assert
        atividades.Should().NotBeNull();
        atividades.ITableName().Should().Be("Atividades");
        atividades.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set atividades.FDescricao.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        atividades.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        atividades.FDescricao = longString; // MAX: 50
        atividades.FGuid = longString; // MAX: 100
        // Assert - All properties should be set atividades.FDescricao.Should().HaveLength(50);
        atividades.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FDescricao_Property_ShouldAcceptValidNames(string Descricao)
    {
        ...
        // Assert
        atividades.FDescricao.Should().Be(Descricao);
    }
    ...
    public void FDescricao_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        atividades.FDescricao.Should().Be(string.Empty);
    }
    ...
    public void FDescricao_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        atividades.FDescricao = longName;
        // Assert
        atividades.FDescricao.Should().HaveLength(50);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBAtividades).GetField("pFldFDescricao", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FDescricao = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var atividades = new DBAtividades();
        // Act & Assert
        atividades.TabelaNome.Should().Be("Atividades");
    }
