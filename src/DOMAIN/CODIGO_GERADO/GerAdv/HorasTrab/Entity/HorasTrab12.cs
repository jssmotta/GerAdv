...
public partial class FHorasTrab : MenphisSI.SG.GerAdv.DBHorasTrab, IDBHorasTrab
{
    // DI-compatible default constructor
    public FHorasTrab() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FHorasTrab CreateFromReader(SqlDataReader? dbRec)
    {
        return new FHorasTrab(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FHorasTrab CreateFromDataRow(DataRow? dbRec)
    {
        return new FHorasTrab(dbRec);
    }

    private FHorasTrab(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FHorasTrab(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    private FHorasTrab(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "") : base(parameters, oCnn, fullSql, sqlWhere, join)
    {
    }

    // Factory method for creating instances with parameters
    public static FHorasTrab CreateFromParameters(List<SqlParameter> parameters, MsiSqlConnection oCnn, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        return new FHorasTrab(parameters, oCnn, fullSql, sqlWhere, join);
    }
