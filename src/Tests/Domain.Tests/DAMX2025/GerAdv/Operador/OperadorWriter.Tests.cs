...
#region WriteAsync Tests
    ...
    public async Task WriteAsync_ShouldMapAllPropertiesCorrectly()
    {
        ...
        _mockFOperador.VerifySet(x => x.FUltimoLogoff = DateOnly.Parse(operador.UltimoLogoff), Times.Once);
        ...
        _mockFOperador.VerifySet(x => x.FDataLimiteReset = DateOnly.Parse(operador.DataLimiteReset), Times.Once);
        _mockFOperador.VerifySet(x => x.FSuporteMaxAge = DateOnly.Parse(operador.SuporteMaxAge), Times.Once);
        _mockFOperador.VerifySet(x => x.FSuporteNomeSolicitante = operador.SuporteNomeSolicitante, Times.Once);
        _mockFOperador.VerifySet(x => x.FSuporteUltimoAcesso = DateOnly.Parse(operador.SuporteUltimoAcesso), Times.Once);
    ...
    [Fact]
    public async Task WriteAsync_WithNull_UltimoLogoff_ShouldNotSetFUltimoLogoff()
    {
        // Arrange
        var operador = CreateValidOperadorModel();
        ...
        // Assert
        _mockFOperador.VerifySet(x => x.FUltimoLogoff = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_DataLimiteReset_ShouldNotSetFDataLimiteReset()
    {
        // Arrange
        var operador = CreateValidOperadorModel();
        ...
        await _operadorWriter.WriteAsync(operador, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFOperador.VerifySet(x => x.FDataLimiteReset = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_SuporteMaxAge_ShouldNotSetFSuporteMaxAge()
    {
        // Arrange
        var operador = CreateValidOperadorModel();
        ...
        await _operadorWriter.WriteAsync(operador, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFOperador.VerifySet(x => x.FSuporteMaxAge = It.IsAny<DateOnly>(), Times.Never);
    }

    [Fact]
    public async Task WriteAsync_WithNull_SuporteUltimoAcesso_ShouldNotSetFSuporteUltimoAcesso()
    {
        // Arrange
        var operador = CreateValidOperadorModel();
        ...
        await _operadorWriter.WriteAsync(operador, auditorQuem, _mockConnection.Object);
        // Assert
        _mockFOperador.VerifySet(x => x.FSuporteUltimoAcesso = It.IsAny<DateOnly>(), Times.Never);
    }
...
#region Delete Tests
    ...
    public async Task Delete_ShouldCallFactoryDeleteAsync()
    {
        ...
        // Act
        await _operadorWriter.DeleteAsync(operadorResponse, operadorId, _mockConnection.Object);
        // Assert
    ...
    public async Task Delete_WithValidParameters_ShouldCompleteSuccessfully()
    {
        ...
        _mockOperadorFactory.Setup(x => x.DeleteAsync(operadorId, operadorResponse.Id, _mockConnection.Object)).Returns(Task.CompletedTask);
        // Act
        Func<Task> act = async () => await _operadorWriter.DeleteAsync(operadorResponse, operadorId, _mockConnection.Object);
        // Assert
    ...
    public async Task Delete_WhenFactoryDeleteAsyncFails_ShouldPropagateException()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<InvalidOperationException>(() => _operadorWriter.DeleteAsync(operadorResponse, operadorId, _mockConnection.Object));
        exception.Should().Be(expectedException);
    }
...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new OperadorWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.Operador CreateValidOperadorModel()
    {
