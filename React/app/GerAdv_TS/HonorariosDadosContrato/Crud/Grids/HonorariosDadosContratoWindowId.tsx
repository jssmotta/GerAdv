...
const HonorariosDadosContratoWindowId: React.FC<
  HonorariosDadosContratoWindowIdProps
> = ({ isOpen, onClose, id, onSuccess, onError }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (id) {
        const response =
          await honorariosdadoscontratoService.fetchHonorariosDadosContratoById(
            id ?? 0,
          );
        setData(response);
      }
