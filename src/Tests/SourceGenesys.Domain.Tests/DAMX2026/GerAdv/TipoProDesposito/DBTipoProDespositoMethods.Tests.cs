...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBTipoProDesposito
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBTipoProDespositoUpdateAdvancedTests : IDisposable
{
    private readonly DBTipoProDesposito _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoProDespositoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBTipoProDesposito
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBTipoProDesposito).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBTipoProDesposito).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBTipoProDesposito instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBTipoProDesposito).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBTipoProDesposito.PTabelaNome.Should().Be("TipoProDesposito");
        DBTipoProDesposito.CampoCodigo.Should().Be("tpdCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBTipoProDesposito();
        dbRec.ID = 1;
