...
#region SMART_SQLServices 
    public static string ProcessOutputEngineDiff(int id) => ProcessOutputEngine.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string ProcessOutputEngineSql(int id) => ProcessOutputEngine.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string ProcessOutputEngineIsNull => ProcessOutputEngine.SqlCmdIsNull() ?? string.Empty;
    public static string ProcessOutputEngineNotIsNull => ProcessOutputEngine.SqlCmdNotIsNull() ?? string.Empty;
    ...
    public static string UltimoIdTabelaExoDiff(int id) => UltimoIdTabelaExo.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string UltimoIdTabelaExoSql(int id) => UltimoIdTabelaExo.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string UltimoIdTabelaExoIsNull => UltimoIdTabelaExo.SqlCmdIsNull() ?? string.Empty;
    public static string UltimoIdTabelaExoNotIsNull => UltimoIdTabelaExo.SqlCmdNotIsNull() ?? string.Empty;
