  ...
  ({
    ...
    useEffect(() => {
      const cleanup = useIOSScrollFallback({
        scrollSelector: ".grid-mobile-crud.grid-mobile-uf .k-grid-content",
        waitForDOM: true,
        retryDelay: 100,
      ...
      <>
        {initialized && (
          <>
            <PageTitle
              title="UF"
              helpButton={<UFHelpCrudButton isMobile={true} />}
            />
            ...
            >
              {(typeView) => (
                <>
                        ...
                        <>
                          {sortedData.map((data) => (
                            <ViewMobile
                              ...
                              name={data.iduf}
                              data={data}
                              related={SearchFromCellCidadeMobile({
                                dataItem: data,
                              })}
                            />
                          ))}
                  ...
                  {typeView === "grid" && (
                    <Grid
                      className="grid-mobile-crud grid-mobile-uf"
