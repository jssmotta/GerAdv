...
import { GUTMatrizApiError } from '@/app/GerAdv_TS/GUTMatriz/Apis/ApiGUTMatriz';
...
import { GUTMatrizTestEmpty } from '@/app/GerAdv_TS/Models/GUTMatriz';
...
valor: 1
  ...
  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterGUTMatriz = { : 1 };
