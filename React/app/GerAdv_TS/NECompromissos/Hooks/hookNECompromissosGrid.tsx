...
// useNECompromissosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de NECompromissos
"use client";
...
interface UseNECompromissosGridProps {
...
export const useNECompromissosGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseNECompromissosGridProps) => {
  // ===== GERENCIAMENTO DE REORDENAÇÃO DE COLUNAS =====
  const [columnsOrder, setColumnsOrder] = useState<string[]>([]);

  // Definir ordem padrão das colunas
  const defaultColumnsOrder = useMemo(() => ["descricaotipocompromisso"], []);
  ...
  const filterLogic = useCallback(
    (data: INECompromissos, filters: Record<string, any>) => {
      return true;
    },
    [],
  );
