...
public class DBToolWTable64Async : DBToolWTable
{
    public DBToolWTable64Async(string tabelaName, string campoCodigoNome, bool isInsert)
    ...
    private static async Task<long> GetIdentityAsync(MsiSqlConnection oCnn, SqlTransaction oTrans, CancellationToken cancellationToken, int timeoutSeconds)
    {
        try
        {
            ...
            if (result == null || result == DBNull.Value)
            {
                ...
                return fallbackResult != null && fallbackResult != DBNull.Value ? Convert.ToInt64(fallbackResult) : 0;
            }
