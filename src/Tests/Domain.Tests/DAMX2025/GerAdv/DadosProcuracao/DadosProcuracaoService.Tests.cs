...
public class DadosProcuracaoServiceTests : IDisposable
{
    ...
    public DadosProcuracaoServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new DadosProcuracaoService(_mockAppSettings.Object, _mockDadosProcuracaoFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockClientesReader.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
