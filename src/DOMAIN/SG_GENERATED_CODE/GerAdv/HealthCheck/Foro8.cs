                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(forCodigo) FROM {"Foro".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) forEMail,forNome,forUnico,forCidade,forSite,forEndereco,forBairro,forFone,forFax,forCEP,forOBS,forUnicoConfirmado,forWeb,forEtiqueta,forBold FROM {"Foro".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
