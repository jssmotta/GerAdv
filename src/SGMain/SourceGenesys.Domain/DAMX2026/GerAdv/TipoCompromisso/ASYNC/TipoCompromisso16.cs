...
public partial class DBTipoCompromisso
{
    ...
    /// </summary>
    public static async Task<DBTipoCompromisso> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBTipoCompromisso();
