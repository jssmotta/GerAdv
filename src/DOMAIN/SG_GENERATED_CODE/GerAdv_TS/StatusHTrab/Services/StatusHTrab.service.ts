...
export interface IStatusHTrabService {
  ...
  filterVoice: (filtro?: FilterStatusHTrab, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class StatusHTrabService implements IStatusHTrabService {
  ...
  async filterVoice(filtro?: FilterStatusHTrab, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
