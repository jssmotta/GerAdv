...
public class FJusticaFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FJustica>();
    }
    ...
    {
        // Arrange
        var factory = new FJusticaFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("jusCodigo", typeof(int));
        mockDataTable.Columns.Add("jusNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["jusCodigo"] = testId;
        row["jusNome"] = "Test Justica";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["jusCodigo"] = 123;
        row["jusNome"] = "Test Justica Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FJustica properties
        }
    }
