                ...
                try
                {
                    ...
                    try
                    {
                        if (DBAgendaRepetirDiasDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = $"SELECT TOP (1) MAX(rpdCodigo) FROM {"AgendaRepetirDias".dbo(connection)};";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = $"SELECT TOP (1) rpdHoraFinal,rpdMaster,rpdDia,rpdHora FROM {"AgendaRepetirDias".dbo(connection)};";
                            tableCheck.CommandTimeout = 5;
