...
// useAdvogadosGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de Advogados
"use client";
...
interface UseAdvogadosGridProps {
  data: IAdvogados[];
...
export const useAdvogadosGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("advogados-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: IAdvogados, filters: Record<string, any>) => {
