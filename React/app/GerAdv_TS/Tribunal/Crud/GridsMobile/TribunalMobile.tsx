...
import TribunalHelpCrudButton from "../../Help/TribunalHelpCrudButton";
  ...
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("tribunal-columns-order-mobile"),
        );
        if (savedOrder) {
    ...
    useEffect(() => {
      const cleanup = useIOSScrollFallback({
        scrollSelector:
          ".grid-mobile-crud.grid-mobile-tribunal .k-grid-content",
        waitForDOM: true,
        retryDelay: 100,
      ...
      <>
        {initialized && (
          <>
            <PageTitle
              title="Tribunal"
              helpButton={<TribunalHelpCrudButton isMobile={true} />}
            />
