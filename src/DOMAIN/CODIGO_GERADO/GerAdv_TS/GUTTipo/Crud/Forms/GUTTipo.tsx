...
interface GUTTipoFormProps {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-GUTTipo' : 'form-container5 form-container-GUTTipo'}>
       
            <form className='formInputCadInc' id={`GUTTipoForm-${guttipoData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={guttipoData} isSubmitting={isSubmitting} onClose={onClose} formId={`GUTTipoForm-${guttipoData.id}`} preventPropagation={true} onSave={handleDirectSave} />
