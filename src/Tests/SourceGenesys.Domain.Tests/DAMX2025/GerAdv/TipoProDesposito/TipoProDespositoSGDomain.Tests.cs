...
/// DBTipoProDesposito - Nome da classe (ex: DBClientes)
/// TipoProDesposito - Nome da tabela (ex: Clientes)
/// tpd - Prefixo dos campos (ex: cli)
/// tpdCodigo - Nome do campo código (ex: cliCodigo)
/// tpdNome - Nome do campo nome (ex: cliNome)
/// DBTipoProDesposito.CadastroGuid - GUID do cadastro
/// </summary>
namespace MenphisSI.GerAdv.Tests;
public class DBTipoProDespositoTests : IDisposable
{
    private readonly DBTipoProDesposito _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    private readonly DataTable _testDataTable;
    public DBTipoProDespositoTests()
    {
...
#region Testes de Constantes e Propriedades Estáticas
    ...
    {
        Assert.Equal("TipoProDesposito", DBTipoProDesposito.PTabelaNome);
        Assert.Equal(" TipoProDesposito.* ", DBTipoProDesposito.CamposSqlX);
        Assert.Equal("tpdCodigo", DBTipoProDesposito.CampoCodigo);
        Assert.Equal("tpdNome", DBTipoProDesposito.CampoNome);
        Assert.Equal("tpd", DBTipoProDesposito.PTabelaPrefixo);
    }
...
#region Testes de Construtores
    ...
    {
        var instance = new DBTipoProDesposito((DataRow)null !);
        Assert.Equal(0, instance.ID);
    }
    ...
    {
        var instance = new DBTipoProDesposito((SqlDataReader)null !);
        Assert.Equal(0, instance.ID);
    }
...
#region Testes de Métodos Assíncronos
    ...
    {
        var instance = await DBTipoProDesposito.CreateAsync(0, null);
        Assert.Equal(0, instance.ID);
    }
    ...
    {
        var exists = await DBTipoProDesposito.ExisteAsync(1, null);
        Assert.False(exists);
    }
    ...
    {
        var result = await DBTipoProDesposito.DeleteRecordAsync(1, 0, null);
        Assert.False(result);
    }
