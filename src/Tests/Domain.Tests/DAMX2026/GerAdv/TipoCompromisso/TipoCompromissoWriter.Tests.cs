...
#region Constructor Tests
    ...
    {
        // Act & Assert
        var act = () => new TipoCompromissoWriter(null !);
        act.Should().Throw<ArgumentNullException>();
    }

#endregion
#region Helper Methods
    private static GerAdv.Models.TipoCompromisso CreateValidTipoCompromissoModel()
    {
        return new GerAdv.Models.TipoCompromisso
        {
            Id = 0,
