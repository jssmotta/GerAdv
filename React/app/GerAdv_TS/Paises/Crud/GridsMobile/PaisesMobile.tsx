  ...
  ({
    ...
    useEffect(() => {
      try {
        const savedOrder = localStorage.getItem(
          btoa("paises-columns-order-mobile"),
        );
        if (savedOrder) {
    ...
    useEffect(() => {
      const cleanup = useIOSScrollFallback({
        scrollSelector: ".grid-mobile-crud.grid-mobile-paises .k-grid-content",
        waitForDOM: true,
        retryDelay: 100,
            ...
            >
              {(typeView) => (
                <>
                        ...
                        <>
                          {sortedData.map((data) => (
                            <ViewMobile
                              ...
                              name={data.nome}
                              data={data}
                              related={SearchFromCellUFMobile({
                                dataItem: data,
                              })}
                            />
                          ))}
                  ...
                  {typeView === "grid" && (
                    <Grid
                      className="grid-mobile-crud grid-mobile-paises"
