...
interface AndamentosMDGridProps {
  data: IAndamentosMD[];
  onRowClick: (andamentosmd: IAndamentosMD) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const AndamentosMDGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IAndamentosMD, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-andamentosmd'
