...
<style jsx global>{`
  .tipoprodesposito-dropdown-popup-msi {
  ...
  .tipoprodesposito-dropdown-popup-msi .k-list {
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
    background: white !important;
  ...
  .tipoprodesposito-dropdown-popup-msi .k-list-item {
    display: block !important;
    visibility: visible !important;
    opacity: 1 !important;
  ...
  .tipoprodesposito-dropdown-popup-msi .k-list-item: hover {
    ...
    <div className={`${cssDado} inputCombobox input-container`}>
      <div className='comboboxLabel'>
        ...
        <div className='comboboxBox'>
          ...
          suggest={true}
          popupSettings={{
            className: 'tipoprodesposito-dropdown-popup-msi'
          }}
          />
