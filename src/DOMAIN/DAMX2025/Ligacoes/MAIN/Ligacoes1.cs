...
#region TableDefinition_Ligacoes
...
#endregion
    public DBLigacoes(in int nCodigo, SqlConnection? oCnn) => Carregar(id: nCodigo, oCnn: oCnn);
    public DBLigacoes(in string? cNome = "", SqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        if (oCnn is null)
            return;
    ...
    public DBLigacoes(in string? sqlWhere, SqlConnection? oCnn)
    {
