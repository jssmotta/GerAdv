...
if (getParamFromUrl("prepostos") > 0) {
 ...
 const addValorPreposto = (e: any) => {
  ...
  <>
        ...
        <div className={isMobile ? 'form-container-AgendaFinanceiro' : 'form-container form-container-AgendaFinanceiro'}>
       
            <form className='formInputCadInc' id={`AgendaFinanceiroForm-${agendafinanceiroData.id}`} onSubmit={onConfirm}>

                <ButtonsCrud data={agendafinanceiroData} isSubmitting={isSubmitting} onClose={onClose} formId={`AgendaFinanceiroForm-${agendafinanceiroData.id}`} preventPropagation={true} onSave={handleDirectSave} />
