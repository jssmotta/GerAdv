// OperadorGruposAgendaOperadoresGridContainer.test.tsx
...
describe('OperadorGruposAgendaOperadoresGridContainer', () => {
  it('renders the grid component output', () => {
    ...
    render(<OperadorGruposAgendaOperadoresGridContainer grid={mockGrid} />);
