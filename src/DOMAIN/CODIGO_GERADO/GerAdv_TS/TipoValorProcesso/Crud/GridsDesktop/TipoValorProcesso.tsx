...
export const TipoValorProcessoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ITipoValorProcesso, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-tipovalorprocesso'
