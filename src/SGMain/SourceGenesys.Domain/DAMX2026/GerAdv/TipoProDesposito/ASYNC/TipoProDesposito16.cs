...
public partial class DBTipoProDesposito
{
    ...
    /// </summary>
    public static async Task<DBTipoProDesposito> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBTipoProDesposito();
    ...
    {
        if (pFldFNome)
            updateTool.Fields(DBTipoProDespositoDicInfo.Nome, FNome, EGenericTypeFields.FString);
    }
