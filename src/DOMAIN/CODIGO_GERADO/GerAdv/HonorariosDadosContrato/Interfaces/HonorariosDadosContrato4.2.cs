...
public partial interface IHonorariosDadosContratoReader
{
    ...
    Task<IEnumerable<HonorariosDadosContratoResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}