...
export interface ITipoEnderecoService {
  ...
  filterVoice: (filtro?: FilterTipoEndereco, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class TipoEnderecoService implements ITipoEnderecoService {
  ...
  async filterVoice(filtro?: FilterTipoEndereco, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
