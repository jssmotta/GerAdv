...
import { TipoOrigemSucumbenciaApiError } from '../GerAdv_TS/TipoOrigemSucumbencia/Apis/ApiTipoOrigemSucumbencia';
import { TipoOrigemSucumbenciaApi } from '@/app/GerAdv_TS/TipoOrigemSucumbencia/Apis/ApiTipoOrigemSucumbencia';
import { FilterTipoOrigemSucumbencia } from '../GerAdv_TS/TipoOrigemSucumbencia/Filters/TipoOrigemSucumbencia';
...
describe('TipoOrigemSucumbenciaApi', () => {
  let tipoorigemsucumbenciaApi: TipoOrigemSucumbenciaApi;
  ...
  beforeEach(() => {
    ...
    tipoorigemsucumbenciaApi = new TipoOrigemSucumbenciaApi(mockUri, mockToken);
  });

  describe('Constructor', () => {
    it('should initialize with correct baseUrl and authorization', () => {
      expect(tipoorigemsucumbenciaApi).toBeInstanceOf(TipoOrigemSucumbenciaApi);
    ...
    it('should use custom version when provided', () => {
      ...
      const customApi = new TipoOrigemSucumbenciaApi(mockUri, mockToken, customVersion);
      expect(customApi).toBeInstanceOf(TipoOrigemSucumbenciaApi);
    });
  });
  ...
  describe('getAll', () => {
    const mockResponse: AxiosResponse = {
      data: [TipoOrigemSucumbenciaTestEmpty()],
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch all tipoorigemsucumbencia items successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await tipoorigemsucumbenciaApi.getAll();
    ...
    it('should return null when localStorage has no offline data', async () => {
      ...
      await expect(tipoorigemsucumbenciaApi.getAll()).rejects.toThrow(TipoOrigemSucumbenciaApiError);
    ...
    it('should call localStorage.getItem with correct key on failure', async () => {
      ...
      await tipoorigemsucumbenciaApi.getAll();

      expect(global.localStorage.getItem).toHaveBeenCalledWith(expect.stringContaining(btoa(`${process.env.NEXT_PUBLIC_APP_ID}-${mockUri}-TipoOrigemSucumbencia_last_getAll_${200}`)));
    });
    ...
    it('should decode and return offline data if present in localStorage', async () => {
      ...
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'TipoOrigemSucumbencia',
          action: NotifySystemActions.INFO,
        })
      );
    });

    it('should throw TipoOrigemSucumbenciaApiError when request fails and no offline data', async () => {
  ...
  describe('getById', () => {
    const mockTipoOrigemSucumbencia = TipoOrigemSucumbenciaTestEmpty();

    const mockResponse: AxiosResponse = {
      data: mockTipoOrigemSucumbencia,
      status: 200,
      statusText: 'OK',
      headers: {},
      config: {},
    ...
    it('should fetch tipoorigemsucumbencia by id successfully', async () => {
      mockedAxios.get.mockResolvedValue(mockResponse);

      const result = await tipoorigemsucumbenciaApi.getById(1);
    ...
    it('should use offline data when request fails', async () => {
      const encodedData = btoa(JSON.stringify(mockTipoOrigemSucumbencia));
      ...
      expect(result.data).toEqual(mockTipoOrigemSucumbencia);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'TipoOrigemSucumbencia',
          id: 1,
  ...
  describe('filter', () => {
    const mockFilter: FilterTipoOrigemSucumbencia = {
      funcionario: 1,
      data: '2024-01-01',
    };
    ...
    it('should filter tipoorigemsucumbencia items successfully', async () => {
      mockedAxios.post.mockResolvedValue(mockResponse);

      const result = await tipoorigemsucumbenciaApi.filter(mockFilter);
  ...
  describe('addAndUpdate', () => {
    const mockTipoOrigemSucumbencia: ITipoOrigemSucumbencia = {
      id: 0,
      funcionario: 1,
      tipocompromisso: 1,
      fornecedor: 1,
    ...
    it('should add new tipoorigemsucumbencia successfully', async () => {
      const responseTipoOrigemSucumbencia = { ...mockTipoOrigemSucumbencia, id: 1 };
      const mockResponse: AxiosResponse = {
        data: responseTipoOrigemSucumbencia,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await tipoorigemsucumbenciaApi.addAndUpdate(mockTipoOrigemSucumbencia);

      expect(mockedAxios.post).toHaveBeenCalledWith(
        expect.stringContaining('/AddAndUpdate'),
        mockTipoOrigemSucumbencia,
        expect.any(Object)
      );
      expect(result).toEqual(mockResponse);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
    ...
    it('should update existing tipoorigemsucumbencia successfully', async () => {
      const existingTipoOrigemSucumbencia = { ...mockTipoOrigemSucumbencia, id: 1 };
      const mockResponse: AxiosResponse = {
        data: existingTipoOrigemSucumbencia,
        status: 200,
        statusText: 'OK',
        headers: {},
        config: {},
      ...
      const result = await tipoorigemsucumbenciaApi.addAndUpdate(existingTipoOrigemSucumbencia);
    ...
    it('should handle conflict error (409)', async () => {
      ...
      await expect(tipoorigemsucumbenciaApi.addAndUpdate(mockTipoOrigemSucumbencia)).rejects.toThrow(TipoOrigemSucumbenciaApiError);
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'TipoOrigemSucumbencia',
          action: NotifySystemActions.ERROR,
  ...
  describe('delete', () => {
    it('should delete tipoorigemsucumbencia successfully', async () => {
      const mockResponse: AxiosResponse = {
        data: { success: true },
        status: 200,
        statusText: 'OK',
      ...
      const result = await tipoorigemsucumbenciaApi.delete(1);
    ...
    it('should handle conflict error on delete (409)', async () => {
      ...
      await expect(tipoorigemsucumbenciaApi.delete(1)).rejects.toThrow();
      expect(mockNotificationService.notify).toHaveBeenCalledWith(
        expect.objectContaining({
          entity: 'TipoOrigemSucumbencia',
          id: 1,
    ...
    it('should handle general delete error', async () => {
      ...
      await expect(tipoorigemsucumbenciaApi.delete(1)).rejects.toThrow(TipoOrigemSucumbenciaApiError);
    });
  });

  describe('useFilter', () => {
    it('should create SWR hook with correct parameters', () => {
      const mockFilter: FilterTipoOrigemSucumbencia = { funcionario: 1 };
      
      const result = tipoorigemsucumbenciaApi.useFilter(mockFilter);
  ...
  describe('Error Handling', () => {
    it('should create proper notification entity for delete', async () => {
      ...
      await tipoorigemsucumbenciaApi.delete(1);
  ...
  describe('TipoOrigemSucumbenciaApiError', () => {
    it('should create error with correct properties', () => {
      const error = new TipoOrigemSucumbenciaApiError('Test message', 400, 'TEST_CODE', 'original');

      expect(error.message).toBe('Test message');
      expect(error.status).toBe(400);
      expect(error.code).toBe('TEST_CODE');
      expect(error.originalError).toBe('original');
      expect(error.name).toBe('TipoOrigemSucumbenciaApiError');
    });

    it('should create error without optional parameters', () => {
      const error = new TipoOrigemSucumbenciaApiError('Test message', 500);
