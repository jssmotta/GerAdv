...
public class FGUTMatrizFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FGUTMatriz>();
    }
    ...
    {
        // Arrange
        var factory = new FGUTMatrizFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("gutCodigo", typeof(int));
        mockDataTable.Columns.Add("gutDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["gutCodigo"] = testId;
        row["gutDescricao"] = "Test GUTMatriz";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["gutCodigo"] = 123;
        row["gutDescricao"] = "Test GUTMatriz Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FGUTMatriz properties
        }
    }
