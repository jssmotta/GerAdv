...
// useSMSAliceGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de SMSAlice
"use client";
...
interface UseSMSAliceGridProps {
  data: ISMSAlice[];
...
export const useSMSAliceGrid = ({
  ...
  const filterLogic = useCallback(
    (data: ISMSAlice, filters: Record<string, any>) => {
