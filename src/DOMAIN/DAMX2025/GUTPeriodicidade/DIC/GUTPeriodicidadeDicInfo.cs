...
#region PropriedadesDaTabela
    ...
    public static DBInfoSystem PcgQuemCad => new(0, PTabelaNome, CampoCodigo, QuemCad, DevourerOne.PCaptionFieldQuemCad, DevourerOne.PTooltipQuemCad, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemCad, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
    ...
    public static DBInfoSystem PcgQuemAtu => new(0, PTabelaNome, CampoCodigo, QuemAtu, DevourerOne.PCaptionFieldQuemAtu, DevourerOne.PTooltipQuemAtu, ETipoDadosSysteminfo.SysteminfoForeingkeyQuemAtu, DBOperadorDicInfo.CampoCodigo, DBOperadorDicInfo.TabelaNome, new DBOperadorODicInfo(), false); // DBI 11 
...
#region SMART_SQLServices 
    ...
    public static string IntervaloDiasDiff(int id) => IntervaloDias.SqlCmdNumberDiff(id) ?? string.Empty;
    public static string IntervaloDiasSql(int id) => IntervaloDias.SqlCmdNumberIgual(id) ?? string.Empty;
    public static string IntervaloDiasIsNull => IntervaloDias.SqlCmdIsNull() ?? string.Empty;
    public static string IntervaloDiasNotIsNull => IntervaloDias.SqlCmdNotIsNull() ?? string.Empty;
