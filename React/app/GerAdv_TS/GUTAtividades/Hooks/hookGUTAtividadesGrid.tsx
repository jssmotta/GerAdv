...
// useGUTAtividadesGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de GUTAtividades
"use client";
...
interface UseGUTAtividadesGridProps {
  data: IGUTAtividades[];
...
export const useGUTAtividadesGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IGUTAtividades, filters: Record<string, any>) => {
