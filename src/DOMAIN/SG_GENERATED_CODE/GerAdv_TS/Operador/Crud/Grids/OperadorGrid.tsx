    ...
    []
        ...
        if (isInitialized) return; // Evita múltiplas chamadas    
         ...
         const filtro = {} as FilterOperador; 
              ...
              const filtroMem = sessionStorage.getItem(btoa('OperadorFilter')) ? JSON.parse(atob(sessionStorage.getItem(btoa('OperadorFilter')) ?? '') || '{}') : {} as FilterOperador;
      ...
      try {
        ...
        if (response.data) {
          ...
          if (response.data.items && Array.isArray(response.data.items)) {
            ...
            processedFilter = response.data.filter || response.data as FilterOperador;
