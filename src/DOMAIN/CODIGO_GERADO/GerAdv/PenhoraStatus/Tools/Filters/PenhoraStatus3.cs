...
public class FilterPenhoraStatusWithVoiceRequest
{
    /// <summary>
    /// Filtro de PenhoraStatus padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterPenhoraStatus Filter { get; set; } = new();
...
[Serializable]
public partial record FilterPenhoraStatus
{
