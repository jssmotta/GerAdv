...
public class FForoFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FForoFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FForoFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FForoFactory();
...
#region Helper Methods    
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["forCodigo"] = 123;
        row["forNome"] = "Test Foro Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FForo properties
        }
    }
