...
public class TipoStatusBiuServiceTests : IDisposable
{
    ...
    public TipoStatusBiuServiceTests()
    {
    ...
    {
        // Arrange & Act
        var service = new TipoStatusBiuService(_mockAppSettings.Object, _mockTipoStatusBiuFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object);
        // Assert
