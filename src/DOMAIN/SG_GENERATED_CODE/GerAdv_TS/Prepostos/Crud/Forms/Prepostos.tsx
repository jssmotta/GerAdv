...
const [_nomeSetor, setNomeSetor] = useState('');
...
if (getParamFromUrl('cidade') > 0) {
 ...
 const addValorSetor = (e: any) => {
                        if (e?.id>0) 
                        onChange({ target: { name: 'setor', value: e.id } });
                      };
  ...
  <>      
        ...
        <div className={isMobile ? 'form-container form-container-Prepostos' : 'form-container form-container-Prepostos'}>
            ...
            <form className='formInputCadInc' id={`PrepostosForm-${prepostosData.id}`} onSubmit={onConfirm}>
                ...
                {!isMobile && (
                    <ButtonSalvarCrud isMobile={false} validationForm={validationForm} entity='Prepostos' data={prepostosData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`PrepostosForm-${prepostosData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                 )}
...
<InputCheckbox dataForm={prepostosData} label='Ani' name='ani' checked={prepostosData.ani} onChange={onChange} />
            ...
            {isMobile && (
                <ButtonSalvarCrud isMobile={true} validationForm={validationForm} entity='Prepostos' data={prepostosData} isSubmitting={isSubmitting} setIsSubmitting={setIsSubmitting} onClose={onClose} formId={`PrepostosForm-${prepostosData.id}`} preventPropagation={true} onSave={handleDirectSave} onCancel={handleCancel} />
                )}
                ...
                <FooterIncDocker>
                  ...
                  />
                   ...
                   <AuditorButton
                    ...
                    <DeleteButton page={'/pages/prepostos'} id={prepostosData.id} dadoApi={dadoApi} />
