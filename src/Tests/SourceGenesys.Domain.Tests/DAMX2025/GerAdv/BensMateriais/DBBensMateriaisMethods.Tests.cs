...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBBensMateriais
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBBensMateriaisUpdateAdvancedTests : IDisposable
{
    private readonly DBBensMateriais _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBBensMateriaisUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBBensMateriais
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBBensMateriais).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBBensMateriais).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBBensMateriais instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBBensMateriais).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBBensMateriais.PTabelaNome.Should().Be("BensMateriais");
        DBBensMateriais.CampoCodigo.Should().Be("bmtCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBBensMateriais();
        dbRec.ID = 1;
