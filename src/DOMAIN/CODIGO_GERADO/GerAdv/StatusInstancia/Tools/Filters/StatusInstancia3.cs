...
public class FilterStatusInstanciaWithVoiceRequest
{
    /// <summary>
    /// Filtro de StatusInstancia padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterStatusInstancia Filter { get; set; } = new();
...
[Serializable]
public partial record FilterStatusInstancia
{
