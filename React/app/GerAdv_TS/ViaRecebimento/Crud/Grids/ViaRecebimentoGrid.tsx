...
const {
  ...
  fetchData, 
  refreshData
} = useViaRecebimentoList(viarecebimentoService);
...
const handleFetchWithFilter = async (filtro?: FilterViaRecebimento | undefined | null) => {
  setCurrFilter(filtro);
  await fetchData(filtro ?? {} as FilterViaRecebimento);
};
