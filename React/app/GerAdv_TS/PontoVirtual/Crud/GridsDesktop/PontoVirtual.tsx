...
interface PontoVirtualGridProps {
  data: IPontoVirtual[];
  onRowClick: (pontovirtual: IPontoVirtual) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const PontoVirtualGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IPontoVirtual, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-pontovirtual'
