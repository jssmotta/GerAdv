...
const ProTipoBaixaInc: React.FC<IProTipoBaixaFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedProTipoBaixa =
        await protipobaixaService.saveProTipoBaixa(data);
