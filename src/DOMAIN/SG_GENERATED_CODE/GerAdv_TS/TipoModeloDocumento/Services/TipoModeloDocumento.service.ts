...
export interface ITipoModeloDocumentoService {
  ...
  filterVoice: (filtro?: FilterTipoModeloDocumento, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class TipoModeloDocumentoService implements ITipoModeloDocumentoService {
  ...
  async filterVoice(filtro?: FilterTipoModeloDocumento, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
