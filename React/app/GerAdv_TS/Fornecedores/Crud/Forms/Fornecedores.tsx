...
export const FornecedoresForm: React.FC<FornecedoresFormProps> = ({
  ...
  const dadoApi = new FornecedoresApi(
    systemContext?.Uri ?? "",
    systemContext?.Token ?? "",
  );
      ...
      try {
        const syntheticEvent = {
          ...
          target: document.getElementById(
            `FornecedoresForm-${fornecedoresData.id}`,
          ),
  ...
  return (
    <>
      <div
        className={
          isMobile
            ? "form-container form-container-Fornecedores"
            : "form-container form-container-Fornecedores"
        }
      >
        <form
          className="formInputCadInc"
          id={`FornecedoresForm-${fornecedoresData.id}`}
          onSubmit={onConfirm}
        >
          {!isMobile && (
            <ButtonSalvarCrud
        ...
        <FooterIncDocker>
          <CopyButton formId={`FornecedoresForm-${fornecedoresData.id}`} />

          <PrintButton formId={`FornecedoresForm-${fornecedoresData.id}`} />
