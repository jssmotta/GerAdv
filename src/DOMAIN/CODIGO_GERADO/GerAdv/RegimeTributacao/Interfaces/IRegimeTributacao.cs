...
public partial interface IRegimeTributacaoService
{
    ...
    Task<Filters.FilterRegimeTributacao> FilterVoice([FromBody] Filters.FilterRegimeTributacao filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
