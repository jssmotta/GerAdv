...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("ritCodigo", typeof(int));
        mockDataTable.Columns.Add("ritDescricao", typeof(string));
        var row = mockDataTable.NewRow();
        row["ritCodigo"] = testId;
        row["ritDescricao"] = "Test Rito";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["ritCodigo"] = 123;
        row["ritDescricao"] = "Test Rito Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FRito properties
        }
    }
