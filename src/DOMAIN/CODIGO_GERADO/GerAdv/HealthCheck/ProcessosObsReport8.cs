                ...
                try
                {
                    ...
                    try
                    {
                        if (DBProcessosObsReportDicInfo.CampoCodigo.NotIsEmpty())
                        {
                            ...
                            tableCheck.CommandText = "SELECT TOP (1) MAX(prrCodigo) FROM dbo.ProcessosObsReport (NOLOCK);";
                        ...
                        {
                            await using var tableCheck = connection.CreateCommand();
                            tableCheck.CommandText = "SELECT TOP (1) prrData,prrProcesso,prrObservacao,prrHistorico FROM dbo.ProcessosObsReport (NOLOCK);";
                            tableCheck.CommandTimeout = 5;
