...
export const DivisaoTribunalGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IDivisaoTribunal, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-divisaotribunal'
