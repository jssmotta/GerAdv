...
export interface IOperadorGruposService {
  ...
  filterVoice: (filtro?: FilterOperadorGrupos, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class OperadorGruposService implements IOperadorGruposService {
  ...
  async filterVoice(filtro?: FilterOperadorGrupos, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
