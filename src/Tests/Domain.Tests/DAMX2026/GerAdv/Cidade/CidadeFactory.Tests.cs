...
public class FCidadeFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FCidade>();
    }
    ...
    {
        // Arrange
        var factory = new FCidadeFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("cidCodigo", typeof(int));
        mockDataTable.Columns.Add("cidNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["cidCodigo"] = testId;
        row["cidNome"] = "Test Cidade";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["cidCodigo"] = 123;
        row["cidNome"] = "Test Cidade Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FCidade properties
        }
    }
