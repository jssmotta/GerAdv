...
export interface IPenhoraStatusService {
  ...
  filterVoice: (filtro?: FilterPenhoraStatus, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class PenhoraStatusService implements IPenhoraStatusService {
  ...
  async filterVoice(filtro?: FilterPenhoraStatus, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
