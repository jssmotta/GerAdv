...
#region Class Structure Tests
    ...
    private void SetupValidMocks()
    {
        ...
        _mockOperadorService.Setup(x => x.Filter(It.IsAny<int>(), It.IsAny<FilterOperador>(), It.IsAny<string>())).ReturnsAsync(ResultApi<IEnumerable<OperadorResponseAll>>.Ok([]));
...
#region EMailNet Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithEmpty_EMailNet_ShouldPass()
    {
        // Arrange
        var operador = CreateValidOperador();
        operador.EMailNet = "";
...
#region DataLimiteReset Validation Tests
    ...
    [Fact]
    public async Task ValidateReg_WithEmpty_DataLimiteReset_ShouldPass()
    {
        // Arrange
        var operador = CreateValidOperador();
