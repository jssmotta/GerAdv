...
// useProcessOutputEngineGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ProcessOutputEngine
"use client";
...
interface UseProcessOutputEngineGridProps {
...
export const useProcessOutputEngineGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  useCustomSort = false,
}: UseProcessOutputEngineGridProps) => {
  ...
  const filterLogic = useCallback(
    (data: IProcessOutputEngine, filters: Record<string, any>) => {
