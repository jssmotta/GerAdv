...
public class FilterTipoRecursoWithVoiceRequest
{
    /// <summary>
    /// Filtro de TipoRecurso padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterTipoRecurso Filter { get; set; } = new();
}

[Serializable]
public partial record FilterTipoRecurso
{
