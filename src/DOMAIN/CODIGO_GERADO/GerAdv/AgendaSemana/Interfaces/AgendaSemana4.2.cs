...
public partial interface IAgendaSemanaReader
{
    ...
    Task<IEnumerable<AgendaSemanaResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}