                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(jusCodigo) FROM {"Justica".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) jusNome,jusBold,jusGuid FROM {"Justica".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
