...
namespace MenphisSI.GerAdv.WFiltro.Tests
{
    public class ProcessOutPutIDsServiceWFiltroTests : IDisposable
    {
        ...
        public ProcessOutPutIDsServiceWFiltroTests()
        {
            ...
            _service = new ProcessOutPutIDsService(_mockAppSettings.Object, _mockProcessOutPutIDsFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockCache.Object, _mockMemoryCache.Object);
        }
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBProcessOutPutIDsDicInfo.GUID}");
