...
public class DadosProcuracaoControllerTests
{
    private readonly Mock<IDadosProcuracaoService> _mockService;
    private readonly DadosProcuracaoController _controller;
    public DadosProcuracaoControllerTests()
    {
        _mockService = new Mock<IDadosProcuracaoService>();
        _controller = new DadosProcuracaoController(_mockService.Object);
    ...
    public async Task GetAll_WithValidParameters_ReturnsOkWithData()
    {
        // Arrange
        var max = 10;
        var expectedData = new List<RespAll.DadosProcuracaoResponseAll>
        {
            new RespAll.DadosProcuracaoResponseAll
            {
                Id = 1
            },
            new RespAll.DadosProcuracaoResponseAll
    ...
    public async Task Filter_WithValidFilter_ReturnsFilteredData()
    {
        // Arrange
        var max = 10;
        var filter = new Filters.FilterDadosProcuracao
    ...
    public async Task GetById_WithExistingId_ReturnsOkWithData()
    {
        // Arrange
        int id = 1;
        var expectedData = new Resp.DadosProcuracaoResponse
        {
            Id = id
        };
    ...
    public async Task GetById_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.GetById(id, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync((Resp.DadosProcuracaoResponse? )null);
        // Act
        var result = await _controller.GetById(id, "test-uri");
        // Assert
    ...
    {
        // Arrange
        var model = new Models.DadosProcuracao
        {
            Id = 0,
        // Set other required properties
        };
        var expectedResult = new Resp.DadosProcuracaoResponse
        {
            Id = 1
        };
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.DadosProcuracao>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task AddAndUpdate_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.DadosProcuracao();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.DadosProcuracao>(), "test-uri")).ReturnsAsync((Resp.DadosProcuracaoResponse? )null);
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task AddAndUpdate_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.DadosProcuracao();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.DadosProcuracao>(), "test-uri")).ThrowsAsync(new Exception("Test exception"));
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task Delete_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.Delete(id, "test-uri")).ReturnsAsync((Resp.DadosProcuracaoResponse? )null);
        // Act
        var result = await _controller.Delete(id, "test-uri");
        // Assert
        result.Should().BeOfType<NotFoundResult>();
    ...
    public async Task Validation_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Validation(It.IsAny<Models.DadosProcuracao>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task Validation_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.DadosProcuracao();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.DadosProcuracao>(), "test-uri")).ReturnsAsync((Resp.DadosProcuracaoResponse? )null);
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<BadRequestResult>();
    ...
    public async Task Validation_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.DadosProcuracao();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.DadosProcuracao>(), "test-uri")).ThrowsAsync(new Exception("Validation error"));
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<ObjectResult>();
