...
public partial interface IRitoReader
{
    ...
    Task<IEnumerable<RitoResponseAll>> ListarAsync(int max, string uri, string cWhere, List<SqlParameter>? parameters, string order, CancellationToken cancellationToken);
}