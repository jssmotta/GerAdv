...
export interface IRegimeTributacaoService {
  ...
  filterVoice: (filtro?: FilterRegimeTributacao, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class RegimeTributacaoService implements IRegimeTributacaoService {
  ...
  async filterVoice(filtro?: FilterRegimeTributacao, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
