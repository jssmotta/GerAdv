...
#region Constructor Tests
    ...
    {
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new OperadorEMailPopupReader(null !, null !));
    }
...
#region ListarN Tests
    ...
    public async Task ListarN_WithEmptyParameters_ShouldThrowException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<Exception>(() => _operadoremailpopupReader.ListarNAsync(max, uri, cWhere, parameters, order));
    }
