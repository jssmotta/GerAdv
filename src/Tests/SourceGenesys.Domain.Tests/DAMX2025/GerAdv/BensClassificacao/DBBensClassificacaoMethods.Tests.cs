...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBBensClassificacao
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBBensClassificacaoUpdateAdvancedTests : IDisposable
{
    private readonly DBBensClassificacao _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBBensClassificacaoUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBBensClassificacao
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBBensClassificacao).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBBensClassificacao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBBensClassificacao instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBBensClassificacao).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBBensClassificacao.PTabelaNome.Should().Be("BensClassificacao");
        DBBensClassificacao.CampoCodigo.Should().Be("bcsCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBBensClassificacao();
        dbRec.ID = 1;
