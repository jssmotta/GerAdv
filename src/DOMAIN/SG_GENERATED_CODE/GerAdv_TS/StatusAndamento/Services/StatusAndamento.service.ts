...
export interface IStatusAndamentoService {
  ...
  filterVoice: (filtro?: FilterStatusAndamento, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class StatusAndamentoService implements IStatusAndamentoService {
  ...
  async filterVoice(filtro?: FilterStatusAndamento, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
