...
export const TipoProDespositoGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: ITipoProDesposito, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-tipoprodesposito'
