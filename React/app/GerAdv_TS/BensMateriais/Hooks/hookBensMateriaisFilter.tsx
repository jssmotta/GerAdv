...
interface UseBensMateriaisFilterProps {
  handleFetchWithFilter: (
    filtro?: FilterBensMateriais | undefined | null,
  ) => Promise<void>;
}
...
interface UseBensMateriaisFilterReturn {
  ...
  // Render function
  renderInputFilters: (
    handlers: FilterHandlers<FilterBensMateriais>,
  ) => React.ReactNode;
...
export const useBensMateriaisFilter = ({
  handleFetchWithFilter,
}: UseBensMateriaisFilterProps): UseBensMateriaisFilterReturn => {
  const [showSearch, setShowSearch] = useState(false);
  const [windowFilter, setWindowFilter] = useState<FilterBensMateriais>(
  ...
  const renderInputFilters = (
    ...
    <>
      ...
      <BensClassificacaoComboBox
        ...
        setValue={(e: any) =>
          handlers.handleComboChange(e, "bensclassificacao")
        }
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datacompra", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datacompra_end", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datafimdagarantia", value)
        }
      />
      <InputDate
        type="text"
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("datafimdagarantia_end", value)
        }
      />
      <InputInput
        type="text"
      ...
      <InputDate
        ...
        onChange={(value: string) =>
          handlers.handleDateChange("dataterminodagarantiadaloja", value)
        }
      />
      <InputDate
        type="text"
        ...
        disabled={
          handlers.windowFilter?.dataterminodagarantiadaloja ? false : true
        }
        onChange={(value: string) =>
          handlers.handleDateChange("dataterminodagarantiadaloja_end", value)
        }
      />
      <InputInput
        type="text"
      ...
      <FilterDialogButton
        ...
        filter={
          handlers.windowFilter.filterBensClassificacao ?? ({} as any as any)
        }
        setFilter={(f: any) =>
          handlers.setWindowFilter((prev) => ({
            ...prev,
            filterBensClassificacao: f,
          }))
        }
  ...
  const { renderInputFilters: renderBensClassificacaoInputs } =
    useBensClassificacaoFilter({
      handleFetchWithFilter: async () => {},
    });
  const { renderInputFilters: renderFornecedoresInputs } =
