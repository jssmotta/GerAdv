...
public class FProSucumbenciaFactoryTests : IDisposable
{
    private readonly ITestOutputHelper _output;
    private FProSucumbenciaFactory _factory;
    private Mock<MsiSqlConnection> _mockConnection;
    private Mock<SqlDataReader> _mockReader;
    private DataRow _validDataRow;
    public FProSucumbenciaFactoryTests(ITestOutputHelper output)
    {
        _output = output;
        _factory = new FProSucumbenciaFactory();
        _mockConnection = new Mock<MsiSqlConnection>();
        _mockReader = new Mock<SqlDataReader>();
        // Prepare a real DataRow with the expected schema (at minimum CampoCodigo: "scbCodigo")
        var dt = new DataTable();
        dt.Columns.Add("scbCodigo", typeof(int));
        var row = dt.NewRow();
        // Set as DBNull to allow constructor to return early without requiring all columns
        row["scbCodigo"] = DBNull.Value;
        dt.Rows.Add(row);
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FProSucumbencia>();
    }
    ...
    {
        // Arrange
        var factory = new FProSucumbenciaFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("scbCodigo", typeof(int));
        mockDataTable.Columns.Add("scbGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["scbCodigo"] = testId;
        row["scbGuid"] = "Test ProSucumbencia";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["scbCodigo"] = 123;
        row["scbGuid"] = "Test ProSucumbencia Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FProSucumbencia properties
        }
    }
