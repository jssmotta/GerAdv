...
import {
  useTipoEnderecoSistemaForm,
  useValidationsTipoEnderecoSistema,
} from "../../Hooks/hookTipoEnderecoSistema";
...
const TipoEnderecoSistemaInc: React.FC<ITipoEnderecoSistemaFormProps> = ({
  id,
  onClose,
  onError,
  onSuccess,
  ...
  const { data, handleChange, loadTipoEnderecoSistema } =
    useTipoEnderecoSistemaForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const savedTipoEnderecoSistema =
        await tipoenderecosistemaService.saveTipoEnderecoSistema(data);
