...
public class DBTipoModeloDocumentoUpdate : IDisposable
{
    private readonly DBTipoModeloDocumento _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBTipoModeloDocumentoUpdate()
    {
    ...
    {
        // Act
        var tipomodelodocumento = new DBTipoModeloDocumento();
        // Assert
        tipomodelodocumento.Should().NotBeNull();
        tipomodelodocumento.ITableName().Should().Be("TipoModeloDocumento");
        tipomodelodocumento.ID.Should().Be(0);
    }
    ...
    public void AllProperties_WithValidValues_ShouldSetCorrectly()
    {
        ...
        // Assert - All properties should be set tipomodelodocumento.FNome.Should().Be( "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        tipomodelodocumento.FGuid.Should().Be("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
    }
    ...
    public void StringProperties_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        tipomodelodocumento.FNome = longString; // MAX: 50
        tipomodelodocumento.FGuid = longString; // MAX: 100
        // Assert - All properties should be set tipomodelodocumento.FNome.Should().HaveLength(50);
        tipomodelodocumento.FGuid.Should().HaveLength(100);
    }
...
#region Testes de Guid
    ...
    public void FNome_Property_ShouldAcceptValidNames(string Nome)
    {
        ...
        // Assert
        tipomodelodocumento.FNome.Should().Be(Nome);
    }
    ...
    public void FNome_WithNullValue_ShouldReturnEmptyString()
    {
        ...
        // Assert
        tipomodelodocumento.FNome.Should().Be(string.Empty);
    }
    ...
    public void SqlWhereConstructor_WithNullConnection_ShouldNotThrow()
    {
        ...
        // Act & Assert
        var TipoModeloDocumento = new DBTipoModeloDocumento(sqlWhere, null);
        TipoModeloDocumento.Should().NotBeNull();
    }
    ...
    public void ParameterizedConstructor_WithNullConnection_ShouldReturnEarly()
    {
        ...
        var nome = "TesteNome";
        // Act
        var tipomodelodocumento = new DBTipoModeloDocumento(parameters, nome, null);
        // Assert
        tipomodelodocumento.Should().NotBeNull();
        tipomodelodocumento.ID.Should().Be(0); // Should not have loaded any data
    }
    ...
    public void FNome_WithExcessiveLength_ShouldTruncateToMaxLength()
    {
        ...
        // Act
        tipomodelodocumento.FNome = longName;
        // Assert
        tipomodelodocumento.FNome.Should().HaveLength(50);
    }
    ...
    {
        // Arrange
        var fieldInfo = typeof(DBTipoModeloDocumento).GetField("pFldFNome", BindingFlags.NonPublic | BindingFlags.Instance);
        // Act
        _instance.FNome = null;
        // Assert
    ...
    public void TabelaNome_Property_ShouldReturnCorrectTableName()
    {
        ...
        var tipomodelodocumento = new DBTipoModeloDocumento();
        // Act & Assert
        tipomodelodocumento.TabelaNome.Should().Be("TipoModeloDocumento");
    }
