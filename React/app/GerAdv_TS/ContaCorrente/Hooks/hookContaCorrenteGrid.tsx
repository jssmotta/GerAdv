...
// useContaCorrenteGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de ContaCorrente
"use client";
...
interface UseContaCorrenteGridProps {
  data: IContaCorrente[];
...
export const useContaCorrenteGrid = ({
  data,
  onRowClick,
  onDeleteClick,
  setSelectedId,
  ...
  const filterLogic = useCallback(
    (data: IContaCorrente, filters: Record<string, any>) => {
