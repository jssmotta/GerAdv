...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("ramCodigo", typeof(int));
        mockDataTable.Columns.Add("ramNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["ramCodigo"] = testId;
        row["ramNome"] = "Test Ramal";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["ramCodigo"] = 123;
        row["ramNome"] = "Test Ramal Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FRamal properties
        }
    }
