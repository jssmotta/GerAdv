...
public partial class FProcessOutputSources : MenphisSI.SG.GerAdv.DBProcessOutputSources, IDBProcessOutputSources
{
    // DI-compatible default constructor
    public FProcessOutputSources() : base()
    {
    }

    // Factory method for creating instances with SqlDataReader
    public static FProcessOutputSources CreateFromReader(SqlDataReader? dbRec)
    {
        return new FProcessOutputSources(dbRec);
    }

    // Factory method for creating instances with DataRow
    public static FProcessOutputSources CreateFromDataRow(DataRow? dbRec)
    {
        return new FProcessOutputSources(dbRec);
    }

    private FProcessOutputSources(SqlDataReader? dbRec) : base(dbRec)
    {
    }

    private FProcessOutputSources(DataRow? dbRec) : base(dbRec)
    {
    }
    ...
    public static async Task<FProcessOutputSources> CreateFromIdAsync(int id, MsiSqlConnection? oCnn)
    {
