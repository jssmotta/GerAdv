...
// useTipoEMailGrid.ts
// Hook centralizado para lógicas compartilhadas dos grids de TipoEMail
"use client";
...
interface UseTipoEMailGridProps {
  data: ITipoEMail[];
...
export const useTipoEMailGrid = ({
  ...
  useEffect(() => {
    try {
      const savedOrder = localStorage.getItem(btoa("tipoemail-columns-order"));
      if (savedOrder) {
  ...
  const filterLogic = useCallback(
    (data: ITipoEMail, filters: Record<string, any>) => {
