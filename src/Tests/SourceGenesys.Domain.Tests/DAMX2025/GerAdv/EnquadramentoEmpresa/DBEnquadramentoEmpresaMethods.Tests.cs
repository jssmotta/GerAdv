...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBEnquadramentoEmpresa
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBEnquadramentoEmpresaUpdateAdvancedTests : IDisposable
{
    private readonly DBEnquadramentoEmpresa _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBEnquadramentoEmpresaUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBEnquadramentoEmpresa
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBEnquadramentoEmpresa).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBEnquadramentoEmpresa).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBEnquadramentoEmpresa instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBEnquadramentoEmpresa).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBEnquadramentoEmpresa.PTabelaNome.Should().Be("EnquadramentoEmpresa");
        DBEnquadramentoEmpresa.CampoCodigo.Should().Be("eqeCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBEnquadramentoEmpresa();
        dbRec.ID = 1;
