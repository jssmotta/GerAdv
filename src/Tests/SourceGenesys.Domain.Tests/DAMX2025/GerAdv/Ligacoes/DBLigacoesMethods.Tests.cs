...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBLigacoes
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBLigacoesUpdateAdvancedTests : IDisposable
{
    private readonly DBLigacoes _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBLigacoesUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBLigacoes
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBLigacoes).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBLigacoes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBLigacoes instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBLigacoes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBLigacoes.PTabelaNome.Should().Be("Ligacoes");
        DBLigacoes.CampoCodigo.Should().Be("ligCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBLigacoes();
        dbRec.ID = 1;
