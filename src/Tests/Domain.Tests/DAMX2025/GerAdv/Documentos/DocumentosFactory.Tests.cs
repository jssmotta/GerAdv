...
public class FDocumentosFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FDocumentos>();
    }
    ...
    {
        // Arrange
        var factory = new FDocumentosFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("docCodigo", typeof(int));
        mockDataTable.Columns.Add("docGuid", typeof(string));
        var row = mockDataTable.NewRow();
        row["docCodigo"] = testId;
        row["docGuid"] = "Test Documentos";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["docCodigo"] = 123;
        row["docGuid"] = "Test Documentos Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FDocumentos properties
        }
    }
