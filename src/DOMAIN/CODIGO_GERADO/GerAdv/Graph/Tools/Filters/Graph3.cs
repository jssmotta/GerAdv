...
public class FilterGraphWithVoiceRequest
{
    /// <summary>
    /// Filtro de Graph padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterGraph Filter { get; set; } = new();
...
public partial record FilterGraph
{
    ...
    [Description("TabelaId -2147483648 para nada ou id")]
    public int TabelaId { get; set; } = int.MinValue;

    [JsonPropertyName("tabelaid_end")]
    [Description("TabelaId -2147483648 para nada ou id para final do intervalo")]
