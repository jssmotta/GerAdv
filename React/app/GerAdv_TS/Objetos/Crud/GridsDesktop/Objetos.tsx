...
interface ObjetosGridProps {
  data: IObjetos[];
  onRowClick: (objetos: IObjetos) => void;
  onDeleteClick: (e: any) => void;
  setSelectedId: (id: number | null) => void;
}
export const ObjetosGridDesktopComponent = React.memo(
({
  data, 
  onRowClick, 
  onDeleteClick, 
...
const filterLogic = useCallback((data: IObjetos, filters: Record<string, any>) => {
...
{initialized && (
  ...
  className='grid-desktop-objetos'
