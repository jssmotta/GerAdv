                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(groCodigo) FROM {"OperadorGruposAgenda".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) groSQLWhere,groNome,groOperador,groGuid FROM {"OperadorGruposAgenda".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
