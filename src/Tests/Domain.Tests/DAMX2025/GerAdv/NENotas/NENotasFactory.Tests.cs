...
public class FNENotasFactoryTests : IDisposable
{
    ...
    public void Create_ShouldReturnNewInstance()
    {
        ...
        result.Should().BeOfType<FNENotas>();
    }
    ...
    {
        // Arrange
        var factory = new FNENotasFactory();
        // Act
        factory.Dispose();
...
#region Helper Methods    
    ...
    public async Task CreateFromIdAsync_WithValidId_ShouldReturnInstanceWithData()
    {
        ...
        mockDataTable.Columns.Add("nepCodigo", typeof(int));
        mockDataTable.Columns.Add("nepNome", typeof(string));
        var row = mockDataTable.NewRow();
        row["nepCodigo"] = testId;
        row["nepNome"] = "Test NENotas";
    ...
    public void CreateFromDataRow_WithCompleteDataRow_ShouldPopulateAllProperties()
    {
        ...
        var row = dt.NewRow();
        row["nepCodigo"] = 123;
        row["nepNome"] = "Test NENotas Description";
        dt.Rows.Add(row);
        // Act
        ...
        // Add more property assertions based on FNENotas properties
        }
    }
