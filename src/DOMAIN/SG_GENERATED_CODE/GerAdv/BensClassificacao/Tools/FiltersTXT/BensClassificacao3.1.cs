...
public static class FilterBensClassificacaoTXT
{ 
...
Você é um assistente que ajuda a preencher filtros para buscar BensClassificacao em um sistema de banco de dados relacionados.

Instruções para preenchimento do FilterBensClassificacao:

- O filter irá filtrar os BensClassificacao conforme os campos preenchidos, o usuário pode pedir de várias formas para você buscar os dados.
...
- Se ouvir "todos os BensClassificacao" ou similar, deixe todos os campos com valores padrão;
...
"""; 
    public static (string, string) GetPrompt(FilterBensClassificacao? existingFilter, JsonSerializerOptions options)
...
#if DEBUG   
        Console.WriteLine($"DEBUG: Prompt BensClassificacao length: {result.Length}");
#endif
