...
#endregion
    // REF. 250325
    public DBProBarCODE(List<SqlParameter> parameters, MsiSqlConnection? oCnn = null, string? fullSql = "", string sqlWhere = "", in string join = "")
    {
        // Tracking: 250605-3
        if (oCnn is null)
            return;
        if (string.IsNullOrEmpty(fullSql))
        {
            ...
            {
                throw new Exception("Erro de parâmetros sqlWhere: ProBarCODE");
            }
        }
        else
        {
