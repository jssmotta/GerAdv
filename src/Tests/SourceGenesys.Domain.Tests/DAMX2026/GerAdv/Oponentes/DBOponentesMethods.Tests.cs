...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBOponentes
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBOponentesUpdateAdvancedTests : IDisposable
{
    private readonly DBOponentes _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBOponentesUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBOponentes
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBOponentes).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBOponentes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBOponentes instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBOponentes).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBOponentes.PTabelaNome.Should().Be("Oponentes");
        DBOponentes.CampoCodigo.Should().Be("opoCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBOponentes();
        dbRec.ID = 1;
