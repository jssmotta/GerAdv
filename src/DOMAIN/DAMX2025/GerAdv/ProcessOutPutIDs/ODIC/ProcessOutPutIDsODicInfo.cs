...
#pragma warning restore CA1822 // Mark members as static
    ...
    public static ImmutableArray<DBInfoSystem> List => [DBProcessOutPutIDsDicInfo.PoiNome, DBProcessOutPutIDsDicInfo.PoiGUID];
    public static ImmutableArray<DBInfoSystem> ListWithoutAuditor => [DBProcessOutPutIDsDicInfo.PoiNome, DBProcessOutPutIDsDicInfo.PoiGUID];

    public static ImmutableArray<DBInfoSystem> ListPk()
    {
        ImmutableArray<string> campos = ImmutableArray.CreateRange(["poiCodigo"]);
