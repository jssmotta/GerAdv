...
public class ProValoresControllerTests
{
    private readonly Mock<IProValoresService> _mockService;
    private readonly ProValoresController _controller;
    public ProValoresControllerTests()
    {
        _mockService = new Mock<IProValoresService>();
        _controller = new ProValoresController(_mockService.Object);
    ...
    public async Task GetAll_WithValidParameters_ReturnsOkWithData()
    {
        // Arrange
        var max = 10;
        var expectedData = new List<RespAll.ProValoresResponseAll>
        {
            new()
            {
                Id = 1
    ...
    public async Task GetById_WithExistingId_ReturnsOkWithData()
    {
        // Arrange
        int id = 1;
        var expectedData = new Resp.ProValoresResponse
        {
            Id = id
        };
    ...
    public async Task GetById_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.GetById(id, "test-uri", It.IsAny<CancellationToken>())).ReturnsAsync((Resp.ProValoresResponse? )null);
        // Act
        var result = await _controller.GetById(id, "test-uri");
        // Assert
    ...
    {
        // Arrange
        var model = new Models.ProValores
        {
            Id = 0,
        // Set other required properties
        };
        var expectedResult = new Resp.ProValoresResponse
        {
            Id = 1
        };
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.ProValores>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task AddAndUpdate_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.ProValores();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.ProValores>(), "test-uri")).ReturnsAsync((Resp.ProValoresResponse? )null);
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task AddAndUpdate_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.ProValores();
        _mockService.Setup(x => x.AddAndUpdate(It.IsAny<Models.ProValores>(), "test-uri")).ThrowsAsync(new Exception("Test exception"));
        // Act
        var result = await _controller.AddAndUpdate(model, "test-uri");
        // Assert
    ...
    public async Task Delete_WithNonExistingId_ReturnsNotFound()
    {
        // Arrange
        int id = 999;
        _mockService.Setup(x => x.Delete(id, "test-uri")).ReturnsAsync((Resp.ProValoresResponse? )null);
        // Act
        var result = await _controller.Delete(id, "test-uri");
        // Assert
        result.Should().BeOfType<NotFoundResult>();
    ...
    public async Task Validation_WithValidData_ReturnsOkWithResult()
    {
        ...
        _mockService.Setup(x => x.Validation(It.IsAny<Models.ProValores>(), "test-uri")).ReturnsAsync(expectedResult);
        // Act
    ...
    public async Task Validation_WhenServiceReturnsNull_ReturnsBadRequest()
    {
        // Arrange
        var model = new Models.ProValores();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.ProValores>(), "test-uri")).ReturnsAsync((Resp.ProValoresResponse? )null);
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<BadRequestResult>();
    ...
    public async Task Validation_WhenExceptionOccurs_ReturnsInternalServerError()
    {
        // Arrange
        var model = new Models.ProValores();
        _mockService.Setup(x => x.Validation(It.IsAny<Models.ProValores>(), "test-uri")).ThrowsAsync(new Exception("Validation error"));
        // Act
        var result = await _controller.Validation(model, "test-uri");
        // Assert
        result.Should().BeOfType<ObjectResult>();
