...
public partial class DBStatusAndamento
{
    ...
    /// </summary>
    public static async Task<DBStatusAndamento> CreateAsync(int nCodigo, MsiSqlConnection? oCnn, CancellationToken cancellationToken = default)
    {
        var registro = new DBStatusAndamento();
