...
{
    public class GUTPeriodicidadeServiceWFiltroTests : IDisposable
    {
        ...
        private readonly GUTPeriodicidadeServiceS _serviceS;
        public GUTPeriodicidadeServiceWFiltroTests()
        {
            ...
            _serviceS = new GUTPeriodicidadeServiceS();
            _service = new GUTPeriodicidadeService(_mockAppSettings.Object, _mockGUTPeriodicidadeFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockGUTAtividadesService.Object, _mockHttpContextAccessor.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
        ...
        {
            // Arrange
            FilterGUTPeriodicidade? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_GuidGUTPeriodicidade_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_GuidGUTPeriodicidade_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_GuidGUTPeriodicidade_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeGUTPeriodicidade = "João Silva";
            var filtro = new FilterGUTPeriodicidade
            {
                Guid = nomeGUTPeriodicidade,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_GuidGUTPeriodicidade_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_GuidGUTPeriodicidade_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_GuidGUTPeriodicidade_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeGUTPeriodicidade)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_GuidGUTPeriodicidade_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
            ...
            resultado.Value.where.Should().Contain("@pcgGuid");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidade.CampoCodigo}");
            ...
            resultado.Value.where.Should().Contain("like @pcgGuid");
            resultado.Value.where.Should().Contain($"= @{DBGUTPeriodicidade.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_GuidGUTPeriodicidade_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeGUTPeriodicidade = "João Silva";
            var filtro = new FilterGUTPeriodicidade
            ...
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.Guid}]");
            resultado.Value.where.Should().Contain("like @pcgGuid");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@pcgGuid");
        ...
        [Fact]
        public void WFiltro_NomeGUTPeriodicidade_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_NomeGUTPeriodicidade_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_NomeGUTPeriodicidade_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeGUTPeriodicidade = "João Silva";
            var filtro = new FilterGUTPeriodicidade
            {
                Nome = nomeGUTPeriodicidade,
                WildcardChar = '\0', // Sem wildcard
                LogicalOperator = " AND "
            };
            // Act
        ...
        [InlineData('\0', "João Silva", "%João%Silva%")]
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeGUTPeriodicidade_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_NomeGUTPeriodicidade_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeGUTPeriodicidade_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeGUTPeriodicidade)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_NomeGUTPeriodicidade_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain("@pcgNome");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidade.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @pcgNome");
            resultado.Value.where.Should().Contain($"= @{DBGUTPeriodicidade.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeGUTPeriodicidade_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeGUTPeriodicidade = "João Silva";
            var filtro = new FilterGUTPeriodicidade
            ...
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição com LIKE
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @pcgNome");
            resultado.Value.where.Should().Contain(DevourerConsts.MsiCollate);
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico (com wildcard aplicado)
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@pcgNome");
            parametro.Value.ToString().Should().Be("%João%Silva%"); // ApplyWildCard aplicado
        }
...
#region filtro.QuemCad_end Tests
        ...
        public void WFiltro_QuemCad_end_QuandoSomenteValorInicial_SemQuemCadEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemCad}] = @{DBGUTPeriodicidadeDicInfo.QuemCad}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBGUTPeriodicidadeDicInfo.QuemCad}");
        ...
        public void WFiltro_QuemCad_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.QuemCad} BETWEEN @{DBGUTPeriodicidadeDicInfo.QuemCad} AND @{DBGUTPeriodicidadeDicInfo.QuemCad}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemCad}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemCad}_end");
        ...
        public void WFiltro_QuemCad_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.QuemCad}");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.Guid}");
        ...
        public void WFiltro_QuemCad_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.QuemCad} BETWEEN");
        }
        ...
        public void WFiltro_QuemCad_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.QuemCad} BETWEEN @{DBGUTPeriodicidadeDicInfo.QuemCad} AND @{DBGUTPeriodicidadeDicInfo.QuemCad}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemCad_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemCad}] = @{DBGUTPeriodicidadeDicInfo.QuemCad}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemCad Isolated Tests
        ...
        public void WFiltro_QuemCad_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemCad}]");
        }
        ...
        public void WFiltro_QuemCad_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemCad}] = @pcgQuemCad");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@pcgQuemCad");
            parametro.Value.Should().Be(valorQuemCad);
        }
        ...
        public void WFiltro_QuemCad_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@pcgQuemCad");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.QuemAtu_end Tests
        ...
        public void WFiltro_QuemAtu_end_QuandoSomenteValorInicial_SemQuemAtuEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemAtu}] = @{DBGUTPeriodicidadeDicInfo.QuemAtu}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBGUTPeriodicidadeDicInfo.QuemAtu}");
        ...
        public void WFiltro_QuemAtu_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.QuemAtu} BETWEEN @{DBGUTPeriodicidadeDicInfo.QuemAtu} AND @{DBGUTPeriodicidadeDicInfo.QuemAtu}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemAtu}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_QuemAtu_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemAtu}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.QuemAtu}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_QuemAtu_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.QuemAtu}");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_QuemAtu_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.QuemAtu} BETWEEN");
        }
        ...
        public void WFiltro_QuemAtu_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.QuemAtu} BETWEEN @{DBGUTPeriodicidadeDicInfo.QuemAtu} AND @{DBGUTPeriodicidadeDicInfo.QuemAtu}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_QuemAtu_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemAtu}] = @{DBGUTPeriodicidadeDicInfo.QuemAtu}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.QuemAtu Isolated Tests
        ...
        public void WFiltro_QuemAtu_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemAtu}]");
        }
        ...
        public void WFiltro_QuemAtu_QuandoTemValor_DeveIncluirNoFiltro()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.QuemAtu}] = @pcgQuemAtu");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@pcgQuemAtu");
            parametro.Value.Should().Be(valorQuemAtu);
        }
        ...
        public void WFiltro_QuemAtu_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@pcgQuemAtu");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
...
#region filtro.IntervaloDias_end Tests
        [Fact]
        public void WFiltro_IntervaloDias_end_QuandoDecimalMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias_end = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_IntervaloDias_end_QuandoTemValorPositivo_SemIntervaloDiasInicial_DeveAdicionarParametroMasNaoCondicionaWhere()
        {
            // Arrange
            var valorIntervaloDiasEnd = 5000;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = int.MinValue, // Não define salário inicial
                IntervaloDias_end = valorIntervaloDiasEnd,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
            resultado.Should().NotBeNull();
            // Como não há IntervaloDias inicial válido, não deve incluir condição WHERE, mas o parâmetro IntervaloDias_end é adicionado
            resultado.Value.where.Should().BeEmpty();
            resultado.Value.parametros.Should().HaveCount(0); // IntervaloDias_end parameter is added
            var parametro = resultado.Value.parametros?.FirstOrDefault();
            parametro.Should().BeNull();
        }

        [Fact]
        public void WFiltro_IntervaloDias_end_QuandoSomenteValorInicial_SemIntervaloDiasEnd_DeveUsarOperadorIgualdade()
        {
            // Arrange
            var valorIntervaloDias = 2500;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorIntervaloDias,
                IntervaloDias_end = int.MinValue, // Não define salário final
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.IntervaloDias}] = @{DBGUTPeriodicidadeDicInfo.IntervaloDias}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBGUTPeriodicidadeDicInfo.IntervaloDias}");
            parametro.Value.Should().Be(valorIntervaloDias);
        }

        [Fact]
        public void WFiltro_IntervaloDias_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            // Arrange
            var valorIntervaloDiasInicial = 1000;
            var valorIntervaloDiasFinal = 5000;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorIntervaloDiasInicial,
                IntervaloDias_end = valorIntervaloDiasFinal,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.IntervaloDias} BETWEEN @{DBGUTPeriodicidadeDicInfo.IntervaloDias} AND @{DBGUTPeriodicidadeDicInfo.IntervaloDias}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.IntervaloDias}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.IntervaloDias}_end");
            parametroInicial.Should().NotBeNull();
            parametroInicial!.Value.Should().Be(valorIntervaloDiasInicial);
            parametroFinal.Should().NotBeNull();
            parametroFinal!.Value.Should().Be(valorIntervaloDiasFinal);
        }
        ...
        [InlineData(2500, 7500)]
        [InlineData(10000, 50000)]
        public void WFiltro_IntervaloDias_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorInicial,
                IntervaloDias_end = valorFinal,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.IntervaloDias}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.IntervaloDias}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }

        [Fact]
        public void WFiltro_IntervaloDias_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = 1000,
                IntervaloDias_end = 5000,
                Guid = "A", // Outro campo para testar o LogicalOperator
                LogicalOperator = " AND "
            };
            // Act
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.IntervaloDias}");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        [Fact]
        public void WFiltro_IntervaloDias_Range_ComLogicalOperatorOR_DeveUsarOperadorCorreto()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_Range_QuandoLogicalOperatorVazio_DeveUsarAndPorPadrao()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.IntervaloDias} BETWEEN");
        }

        [Fact]
        public void WFiltro_IntervaloDias_Range_NaoDeveUsarMsiCollate()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_Range_ComoUnicoCampo_DeveNaoTerOperadorLogico()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_Range_ParametrosDevemTerTipoCorreto()
        {
            // Arrange
            var valorIntervaloDiasInicial = 2500;
            var valorIntervaloDiasFinal = 4750;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorIntervaloDiasInicial,
                IntervaloDias_end = valorIntervaloDiasFinal,
        ...
        [Fact]
        public void WFiltro_IntervaloDias_QuandoAmbosZero_DeveUsarBETWEEN()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_QuandoSomenteZeroInicial_DeveUsarIgualdade()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = 0,
                IntervaloDias_end = int.MinValue,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_IntervaloDias_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = 1500,
                IntervaloDias_end = 4500,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
            resultado.Should().NotBeNull();
            // Verifica a lógica exata: !(filtro.IntervaloDias == int.MinValue) && !(filtro.IntervaloDias_end == int.MinValue)
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.IntervaloDias} BETWEEN @{DBGUTPeriodicidadeDicInfo.IntervaloDias} AND @{DBGUTPeriodicidadeDicInfo.IntervaloDias}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }

        [Fact]
        public void WFiltro_IntervaloDias_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
            ...
            resultado.Should().NotBeNull();
            // Verifica a lógica exata: !(filtro.IntervaloDias == int.MinValue) && filtro.IntervaloDias_end == int.MinValue
            // Deve resultar em igualdade quando apenas IntervaloDias tem valor válido
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.IntervaloDias}] = @{DBGUTPeriodicidadeDicInfo.IntervaloDias}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
        ...
        [InlineData(0)]
        [InlineData(-1)]
        public void WFiltro_IntervaloDias_ComValoresExtremos_DeveProcessarCorretamente(int valorExtremo)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorExtremo,
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
...
#region filtro.IntervaloDias Isolated Tests
        [Fact]
        public void WFiltro_IntervaloDias_QuandoIntMinValue_NaoDeveIncluirParametroOuCondicionaWhere()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = int.MinValue, // Valor padrão que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_IntervaloDias_QuandoTemValorPositivo_DeveIncluirParametroECondicionaWhere()
        {
            // Arrange
            var valorIntervaloDias = 5;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorIntervaloDias,
                LogicalOperator = " AND "
        ...
        [Fact]
        public void WFiltro_IntervaloDias_QuandoValorZero_DeveIncluirParametroECondicionaWhere()
        {
            // Arrange
            var valorIntervaloDias = 0;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorIntervaloDias,
                LogicalOperator = " AND "
            ...
            resultado.Value.where.Should().Contain($"= @{DBGUTPeriodicidadeDicInfo.IntervaloDias}");
            resultado.Value.parametros.Should().HaveCount(1);
            resultado.Value.parametros.First().Value.Should().Be(valorIntervaloDias);
        }
        ...
        [InlineData(999)]
        [InlineData(2147483647)]
        public void WFiltro_IntervaloDias_DiferentesValoresValidos_DeveProcessarCorretamente(int valorIntervaloDias)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_ComLogicalOperatorOR_DeveUsarOperadorCorreto()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_QuandoLogicalOperatorVazio_DeveUsarAndPorPadrao()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_QuandoLogicalOperatorNull_DeveUsarAndPorPadrao()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.IntervaloDias}]");
        }

        [Fact]
        public void WFiltro_IntervaloDias_DeveUsarOperadorIgualdade()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_NaoDeveUsarMsiCollate()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_ComoUnicoCampo_DeveNaoTerOperadorLogico()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
        ...
        [Fact]
        public void WFiltro_IntervaloDias_ParametroDeveTerTipoCorreto()
        {
            // Arrange
            int valorIntervaloDias = 42;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorIntervaloDias,
                LogicalOperator = " AND "
...
#endregion
        [Fact]
        public void WFiltro_IntervaloDias_QuandoValorMinValue_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = int.MinValue, // Valor que indica "não filtrar"
                LogicalOperator = " AND "
            };
            // Act
            var resultado = _serviceS.WFiltro(filtro);
        ...
        [Fact]
        public void WFiltro_IntervaloDias_QuandoTemValor_DeveIncluirNoFiltro()
        {
            // Arrange
            var valorIntervaloDias = 1;
            var filtro = new FilterGUTPeriodicidade
            {
                IntervaloDias = valorIntervaloDias,
                LogicalOperator = " AND "
            ...
            // Assert
            resultado.Should().NotBeNull();
            // Verifica se o WHERE contém a condição do IntervaloDias
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.IntervaloDias}] = @pcgIntervaloDias");
            // Verifica se tem exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@pcgIntervaloDias");
            parametro.Value.Should().Be(valorIntervaloDias);
        }

        [Fact]
        public void WFiltro_IntervaloDias_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos com AND entre eles
            resultado.Value.where.Should().Contain($"@pcgIntervaloDias");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.Guid}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetro(s)
            resultado.Value.parametros.Should().HaveCount(2);
        ...
        [InlineData(1)]
        [InlineData(999)]
        public void WFiltro_IntervaloDias_DiferentesValores_DeveFuncionar(int valorIntervaloDias)
        {
            // Arrange
            var filtro = new FilterGUTPeriodicidade
            {
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador de igualdade, não BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.CampoCodigo}] = @{DBGUTPeriodicidadeDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBGUTPeriodicidadeDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve usar operador BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.CampoCodigo} BETWEEN @{DBGUTPeriodicidadeDicInfo.CampoCodigo} AND @{DBGUTPeriodicidadeDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.CampoCodigo}_end");
            parametroInicial.Should().NotBeNull();
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            resultado.Value.parametros.Should().HaveCount(2);
            resultado.Value.where.Should().Contain("BETWEEN");
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.CampoCodigo}_end");
            parametroInicial.Value.Should().Be(valorInicial);
            parametroFinal.Value.Should().Be(valorFinal);
        }
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Deve conter ambos os campos
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBGUTPeriodicidadeDicInfo.Guid}");
            // Deve usar o operador lógico entre eles
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 3 parâmetros (2 para salário + 1 para nome)
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto no BETWEEN
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            // Deve resultar em BETWEEN quando ambos os valores não são MinValue
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.CampoCodigo} BETWEEN @{DBGUTPeriodicidadeDicInfo.CampoCodigo} AND @{DBGUTPeriodicidadeDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.CampoCodigo}] = @{DBGUTPeriodicidadeDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Should().NotBeNull();
            // Verifica se usa o nome da tabela correto
            resultado.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.CampoCodigo}]");
        }
...
#region DtCad Tests
        ...
        public void WFiltro_DtCad_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            parameter.ParameterName.Should().Be($"@{DBGUTPeriodicidadeDicInfo.DtCad}");
            ...
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.DtCad}], 103) = CONVERT(DATE, @{DBGUTPeriodicidadeDicInfo.DtCad}, 103)");
        }
        ...
        public void WFiltro_DtCad_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.DtCad}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.DtCad}_end");
            ...
            result.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.DtCad} BETWEEN @{DBGUTPeriodicidadeDicInfo.DtCad} AND @{DBGUTPeriodicidadeDicInfo.DtCad}_end");
        }
        ...
        public void WFiltro_DtCad_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.DtCad}], 103)");
        }
...
#region DtAtu Tests
        ...
        public void WFiltro_DtAtu_WhenValidSingleDate_ShouldAddParameterAndGenerateWhereClause()
        {
            ...
            result.Value.parametros.Should().HaveCount(1);
            var parameter = result.Value.parametros.First();
            parameter.ParameterName.Should().Be($"@{DBGUTPeriodicidadeDicInfo.DtAtu}");
            parameter.Value.Should().BeOfType<DateTime>();
            var expectedDate = DateTime.Parse(testDate);
            ((DateTime)parameter.Value).Should().Be(expectedDate);
            result.Value.where.Should().Contain($"CONVERT(DATE,[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.DtAtu}], 103) = CONVERT(DATE, @{DBGUTPeriodicidadeDicInfo.DtAtu}, 103)");
        }
        ...
        public void WFiltro_DtAtu_WhenValidDateRange_ShouldAddBothParametersAndGenerateBetweenClause()
        {
            ...
            result.Should().NotBeNull();
            result.Value.parametros.Should().HaveCount(2);
            var startParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.DtAtu}");
            var endParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.DtAtu}_end");
            startParameter.Should().NotBeNull();
            endParameter.Should().NotBeNull();
            startParameter!.Value.Should().BeOfType<DateTime>();
            endParameter!.Value.Should().BeOfType<DateTime>();
            ((DateTime)startParameter.Value).Should().Be(DateTime.Parse(startDate));
            ((DateTime)endParameter.Value).Should().Be(DateTime.Parse(endDate));
            result.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].{DBGUTPeriodicidadeDicInfo.DtAtu} BETWEEN @{DBGUTPeriodicidadeDicInfo.DtAtu} AND @{DBGUTPeriodicidadeDicInfo.DtAtu}_end");
        }
        ...
        public void WFiltro_DtAtu_AsFirstFilter_ShouldNotIncludeLogicalOperatorAtStart()
        {
            ...
            result.Should().NotBeNull();
            result.Value.where.Should().NotStartWith(TSql.And);
            result.Value.where.Should().StartWith($"CONVERT(DATE,[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.DtAtu}], 103)");
        }
...
#region Visto Filter Tests
        ...
        public void WFiltro_VistoEqualsIntMinValue_ShouldNotAddParameterOrWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.parametros.Should().NotContain(p => p.ParameterName.Contains(DBGUTPeriodicidadeDicInfo.Visto));
            result.Value.where.Should().NotContain(DBGUTPeriodicidadeDicInfo.Visto);
        }
        ...
        public void WFiltro_VistoHasValidValue_ShouldAddParameterAndWhereClause()
        {
            ...
            result.Should().NotBeNull();
            // Check parameter
            var VistoParameter = result.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.Visto}");
            VistoParameter.Should().NotBeNull();
            VistoParameter.Value.Should().Be(VistoValue);
            // Check where clause
            result.Value.where.Should().Contain($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.Visto}] = @{DBGUTPeriodicidadeDicInfo.Visto}");
        }
        ...
        public void WFiltro_VistoWithDifferentValues_ShouldAddCorrectParameterValue()
        {
            ...
            var filtroFemale = new FilterGUTPeriodicidade
            {
                Visto = 0
            };
            var resultFemale = _serviceS.WFiltro(filtroFemale);
            resultFemale.Should().NotBeNull();
            var femaleParam = resultFemale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.Visto}");
            femaleParam.Should().NotBeNull();
            femaleParam.Value.Should().Be(0);
            // Arrange & Act & Assert for Visto = 1 (typically male)
            var filtroMale = new FilterGUTPeriodicidade
            {
                Visto = 1
            };
            var resultMale = _serviceS.WFiltro(filtroMale);
            resultMale.Should().NotBeNull();
            var maleParam = resultMale.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBGUTPeriodicidadeDicInfo.Visto}");
        ...
        public void WFiltro_VistoAsFirstFilter_ShouldNotIncludeLogicalOperatorInWhereClause()
        {
            ...
            // Assert
            result.Should().NotBeNull();
            result.Value.where.Should().StartWith($"[{DBGUTPeriodicidadeDicInfo.PTabelaNome}].[{DBGUTPeriodicidadeDicInfo.Visto}] = @{DBGUTPeriodicidadeDicInfo.Visto}");
