...
public class FilterTipoModeloDocumentoWithVoiceRequest
{
    /// <summary>
    /// Filtro de TipoModeloDocumento padrão
    /// </summary>
    [JsonPropertyName("filter")]
    public Filters.FilterTipoModeloDocumento Filter { get; set; } = new();
...
[Serializable]
public partial record FilterTipoModeloDocumento
{
