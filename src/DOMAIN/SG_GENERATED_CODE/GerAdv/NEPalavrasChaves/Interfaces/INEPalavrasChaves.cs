...
public partial interface INEPalavrasChavesService
{
    ...
    Task<Filters.FilterNEPalavrasChaves> FilterVoice([FromBody] Filters.FilterNEPalavrasChaves filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
