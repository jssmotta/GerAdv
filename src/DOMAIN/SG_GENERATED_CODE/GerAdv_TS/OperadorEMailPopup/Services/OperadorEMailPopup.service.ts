...
export interface IOperadorEMailPopupService {
  ...
  filterVoice: (filtro?: FilterOperadorEMailPopup, voiceCommand?: ICommandSpeakerRequest) => Promise<AxiosResponse>;
}
...
export class OperadorEMailPopupService implements IOperadorEMailPopupService {
  ...
  async filterVoice(filtro?: FilterOperadorEMailPopup, voiceCommand?: ICommandSpeakerRequest): Promise<AxiosResponse> {
    try {
