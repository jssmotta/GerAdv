...
import { FuncaoApi, FuncaoApiError } from "../Apis/FuncaoApi";
...
export class FuncaoValidator {
  static validateFuncao(funcao: IFuncao): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
