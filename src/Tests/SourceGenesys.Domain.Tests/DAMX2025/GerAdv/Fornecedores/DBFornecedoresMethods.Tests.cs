...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBFornecedores
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBFornecedoresUpdateAdvancedTests : IDisposable
{
    private readonly DBFornecedores _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBFornecedoresUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBFornecedores
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBFornecedores).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBFornecedores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBFornecedores instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBFornecedores).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBFornecedores.PTabelaNome.Should().Be("Fornecedores");
        DBFornecedores.CampoCodigo.Should().Be("forCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBFornecedores();
        dbRec.ID = 1;
