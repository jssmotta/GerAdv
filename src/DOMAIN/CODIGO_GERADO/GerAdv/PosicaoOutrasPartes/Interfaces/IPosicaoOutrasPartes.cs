...
public partial interface IPosicaoOutrasPartesService
{
    ...
    Task<Filters.FilterPosicaoOutrasPartes> FilterVoice([FromBody] Filters.FilterPosicaoOutrasPartes filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
