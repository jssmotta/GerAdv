...
{
    public class TipoOrigemSucumbenciaServiceWFiltroTests : IDisposable
    {
        ...
        private readonly TipoOrigemSucumbenciaServiceS _serviceS;
        public TipoOrigemSucumbenciaServiceWFiltroTests()
        {
            ...
            _serviceS = new TipoOrigemSucumbenciaServiceS();
            _service = new TipoOrigemSucumbenciaService(_mockAppSettings.Object, _mockTipoOrigemSucumbenciaFactory.Object, _mockReader.Object, _mockValidation.Object, _mockWriter.Object, _mockProSucumbenciaService.Object, _mockCache.Object, _mockMemoryCache.Object, _mockConnectionService.Object);
        }
        ...
        {
            // Arrange
            FilterTipoOrigemSucumbencia? filtro = null;
            // Act
        ...
        {
            // Arrange
            var filtro = new FilterTipoOrigemSucumbencia(); // Todos os valores padrão
            // Act
            var resultado = _serviceS.WFiltro(filtro);
            // Assert
...
#region String Tests
        ...
        [Fact]
        public void WFiltro_NomeTipoOrigemSucumbencia_QuandoStringVazia_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoOrigemSucumbencia
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoOrigemSucumbencia_QuandoStringNull_NaoDeveIncluirNoFiltro()
        {
            // Arrange
            var filtro = new FilterTipoOrigemSucumbencia
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoOrigemSucumbencia_SemWildcard_DeveRetornarValorOriginal()
        {
            // Arrange
            var nomeTipoOrigemSucumbencia = "João Silva";
            var filtro = new FilterTipoOrigemSucumbencia
            {
                Nome = nomeTipoOrigemSucumbencia,
        ...
        [InlineData(' ', "João Silva", "%João%Silva%")]
        public void WFiltro_NomeTipoOrigemSucumbencia_DiferentesWildcards_DeveAplicarCorretamente(char wildcardChar, string nomeOriginal, string esperado)
        {
            // Arrange
            var filtro = new FilterTipoOrigemSucumbencia
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoOrigemSucumbencia_StringComEspacos_DeveSubstituirEspacosPorWildcard()
        {
            // Arrange
            var filtro = new FilterTipoOrigemSucumbencia
            {
        ...
        [InlineData("   ")]
        [InlineData(null)]
        public void WFiltro_NomeTipoOrigemSucumbencia_StringsVazias_NaoDeveIncluirNoFiltro(string? nomeTipoOrigemSucumbencia)
        {
            // Arrange
            var filtro = new FilterTipoOrigemSucumbencia
            {
        ...
        [Fact]
        public void WFiltro_NomeTipoOrigemSucumbencia_ComOutrosCampos_DeveUsarLogicalOperator()
        {
            // Arrange
            var filtro = new FilterTipoOrigemSucumbencia
            {
            ...
            resultado.Value.where.Should().Contain("@tosNome");
            resultado.Value.where.Should().Contain($"@{DBTipoOrigemSucumbencia.CampoCodigo}");
            resultado.Value.where.Should().Contain(" AND ");
            // Deve ter 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica se um usa LIKE e outro usa =
            resultado.Value.where.Should().Contain("like @tosNome");
            resultado.Value.where.Should().Contain($"= @{DBTipoOrigemSucumbencia.CampoCodigo}");
        }

        [Fact]
        public void WFiltro_NomeTipoOrigemSucumbencia_QuandoTemValor_DeveIncluirNoFiltroComLike()
        {
            // Arrange
            var nomeTipoOrigemSucumbencia = "João Silva";
            var filtro = new FilterTipoOrigemSucumbencia
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoOrigemSucumbenciaDicInfo.PTabelaNome}].[{DBTipoOrigemSucumbenciaDicInfo.Nome}]");
            resultado.Value.where.Should().Contain("like @tosNome");
            ...
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be("@tosNome");
...
#region filtro.Codigo_filtro_end Tests
        ...
        public void WFiltro_Codigo_filtro_end_QuandoSomenteValorInicial_SemCodigo_filtroEnd_DeveUsarOperadorIgualdade()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoOrigemSucumbenciaDicInfo.PTabelaNome}].[{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}] = @{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().NotContain("BETWEEN");
            // Deve ter exatamente 1 parâmetro
            resultado.Value.parametros.Should().HaveCount(1);
            // Verifica o parâmetro específico
            var parametro = resultado.Value.parametros.First();
            parametro.ParameterName.Should().Be($"@{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}");
        ...
        public void WFiltro_Codigo_filtro_end_QuandoTemAmbosValores_DeveUsarOperadorBETWEEN()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoOrigemSucumbenciaDicInfo.PTabelaNome}].{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo} BETWEEN @{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo} AND @{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}_end");
            resultado.Value.where.Should().NotContain(" = ");
            // Deve ter exatamente 2 parâmetros
            resultado.Value.parametros.Should().HaveCount(2);
            // Verifica os parâmetros específicos
            var parametroInicial = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.FirstOrDefault(p => p.ParameterName == $"@{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_RangeDiferentesValores_DeveProcessarCorretamente(int valorInicial, int valorFinal)
        {
            ...
            var parametroInicial = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}");
            var parametroFinal = resultado.Value.parametros.First(p => p.ParameterName == $"@{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}_end");
        ...
        public void WFiltro_Codigo_filtro_Range_ComOutrosCampos_DeveUsarLogicalOperatorCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"@{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}");
            resultado.Value.where.Should().Contain($"@{DBTipoOrigemSucumbenciaDicInfo.Nome}");
        ...
        public void WFiltro_Codigo_filtro_Range_CondicaoWhereDeveUsarTabelaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoOrigemSucumbenciaDicInfo.PTabelaNome}].{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo} BETWEEN");
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_BETWEEN_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoOrigemSucumbenciaDicInfo.PTabelaNome}].{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo} BETWEEN @{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo} AND @{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}_end");
            resultado.Value.parametros.Should().HaveCount(2);
        }
        ...
        public void WFiltro_Codigo_filtro_Logica_Igualdade_Verifica_Condicoes_Exatas()
        {
            ...
            resultado.Value.where.Should().Be($"[{DBTipoOrigemSucumbenciaDicInfo.PTabelaNome}].[{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}] = @{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}");
            resultado.Value.parametros.Should().HaveCount(1);
        }
...
#region filtro.Codigo_filtro Isolated Tests
        ...
        public void WFiltro_Codigo_filtro_CondicaoWhereDeveUsarTabelnaNomeCorreto()
        {
            ...
            resultado.Value.where.Should().Contain($"[{DBTipoOrigemSucumbenciaDicInfo.PTabelaNome}].[{DBTipoOrigemSucumbenciaDicInfo.CampoCodigo}]");
        }
