...
const EventoPrazoAgendaComboBox: React.FC<DadosSelectProps> = ({
  ...
  const loadRecordForEdit = async (id: number) => {
    try {
      const record =
        await eventoprazoagendaService.fetchEventoPrazoAgendaById(id);
  ...
  const handleSuccess = (newEventoPrazoAgenda?: IEventoPrazoAgenda) => {
    if (newEventoPrazoAgenda) {
      setValue({
        id: newEventoPrazoAgenda.id,
        nome: newEventoPrazoAgenda.nome,
      });
      ...
      {(editRecord || addRecord) && isOpen && (
        <EventoPrazoAgendaWindow
          ...
          selectedEventoPrazoAgenda={
            editRecord || addRecord || EventoPrazoAgendaEmpty()
          }
        />
      )}
