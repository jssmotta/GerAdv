...
/// <summary>
/// Testes unitários xUnit avançados para o método Update da classe DBProTipoBaixa
/// Incluindo mocking e cenários complexos
/// </summary>
public class DBProTipoBaixaUpdateAdvancedTests : IDisposable
{
    private readonly DBProTipoBaixa _instance;
    private readonly Mock<MsiSqlConnection> _mockConnection;
    public DBProTipoBaixaUpdateAdvancedTests()
    {
    ...
    public void Update_ResourceManagement_ShouldNotLeakMemory()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            var dbRec = new DBProTipoBaixa
            {
                ID = 0,
                FNome = $"N{i}"};
            var fieldInfo = typeof(DBProTipoBaixa).GetField("pFldFNome", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Helper Methods
    ...
    {
        var fieldInfo = typeof(DBProTipoBaixa).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
        fieldInfo?.SetValue(_instance, value);
    }

    private void SetFieldChanged(DBProTipoBaixa instance, string fieldName, bool value)
    {
        var fieldInfo = typeof(DBProTipoBaixa).GetField(fieldName, System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
...
#region Error Handling Tests
    ...
    public void Update_ShouldSetCorrectTableInformation()
    {
        ...
        DBProTipoBaixa.PTabelaNome.Should().Be("ProTipoBaixa");
        DBProTipoBaixa.CampoCodigo.Should().Be("ptxCodigo");
    }
...
#region Integration-like Tests
    ...
    {
        // Arrange
        using var dbRec = new DBProTipoBaixa();
        dbRec.ID = 1;
