...
{
    Task<IEnumerable<PenhoraResponseAll>> Filter([FromQuery] int max, [FromBody] Filters.FilterPenhora filter, [FromRoute, Required] string uri = "");
    Task<Filters.FilterPenhora> FilterVoice([FromBody] Filters.FilterPenhora filter, [FromBody] CommandSpeakerRequest? message, [FromRoute, Required] string uri = "");
