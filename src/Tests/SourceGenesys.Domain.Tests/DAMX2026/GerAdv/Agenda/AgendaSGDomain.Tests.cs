...
#region Testes de Propriedades Computadas
    ...
    {
        _instance.FHrFinal = TimeOnly.Parse(DateTime.Parse(dateString).ToString("HH:mm"));
        ;
        _instance?.FHrFinal?.ToString().Equals(expected).Should().BeTrue();
    }
    ...
    {
        var instance = new DBAgenda();
        Assert.Equal(null !, instance.FHrFinal);
    }
    ...
    {
        _instance.FEventoData = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FEventoData?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBAgenda();
        Assert.Equal(null !, instance.FEventoData);
    }
    ...
    {
        _instance.FDataInicioPrazo = DateOnly.Parse(DateTime.Parse(dateString).ToString("dd/MM/yyyy"));
        DateTime.Parse(_instance?.FDataInicioPrazo?.ToString() ?? "").ToString("dd/MM/yyyy").Equals(dateString.Split(' ')[0]).Should().BeTrue();
    }
    ...
    {
        var instance = new DBAgenda();
        Assert.Equal(null !, instance.FDataInicioPrazo);
    }
