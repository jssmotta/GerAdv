                        ...
                        {
                            {
                                ...
                                tableCheck.CommandText = $"SELECT TOP (1) MAX(endCodigo) FROM {"Enderecos".dbo(connection)};";
                            ...
                            {
                                await using var tableCheck = connection.CreateCommand();
                                tableCheck.CommandText = $"SELECT TOP (1) endTopIndex,endDescricao,endContato,endDtNasc,endEndereco,endBairro,endPrivativo,endAddContato,endCEP,endOAB,endOBS,endFone,endFax,endTratamento,endCidade,endSite,endEMail,endQuem,endQuemIndicou,endReportECBOnly,endEtiqueta,endAni,endBold,endGuid FROM {"Enderecos".dbo(connection)};";
                                tableCheck.CommandTimeout = 5;
