...
#region Test Data Setup Helpers
    ...
    private void SetupMockFPenhora(int? Processo = 1, string? Nome = "João", string? Descricao = "", string? DataPenhora = "04:04", int? PenhoraStatus = 1, int? Master = 1)
    {
        ...
        if (string.IsNullOrEmpty(DataPenhora))
        {
            _mockFPenhora.Setup(f => f.FDataPenhora).Returns((DateOnly? )null);
        }
        else
        {
            DateTime parsedDateTime;
            if (!DateTime.TryParse(DataPenhora, new CultureInfo("pt-BR"), DateTimeStyles.None, out parsedDateTime))
            {
                parsedDateTime = DateTime.Parse(DataPenhora, CultureInfo.InvariantCulture);
            }

            var dateOnly = DateOnly.FromDateTime(parsedDateTime);
            _mockFPenhora.Setup(f => f.FDataPenhora).Returns(dateOnly);
        }
...
#region Read Method - Happy Path Tests
    ...
    public void Read_WithValidParameters_ShouldReturnPenhoraResponse()
    {
        ...
        result.DataPenhora.Should().Be("04:04");
...
#region DateTime Tests
    ...
    public void Read_WithValidDate_DataPenhora_Formats_ShouldParseCorrectly(string dateString)
    {
        // Arrange
        var where = "Id = @Id";
        var parameters = CreateTestParameters();
        ...
        var result = _penhoraWhere.Read(where, parameters, _mockConnection.Object);
        // Assert
        result.DataPenhora.Should().Be(expectedDate.ToString("dd/MM/yyyy"));
    }
#endregion
#endregion
}